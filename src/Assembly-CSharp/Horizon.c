...

{
  ...
  if (pTVar1 != (Transform *)0x0) {
    ...
    pcRam_? = pcVar3;
    (*pcRam_?)(pvVar2);
    (this->fields).offset.x = 0.0;
    (this->fields).offset.y = 0.0;
    (this->fields).offset.z = 0.0;
    pTVar1 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_transform
                       ((Component *)this,(MethodInfo *)0x0);
    if (pTVar1 != (Transform *)0x0) {
      ...
      if (bVar5) {
        uVar6 = (uint)((ulonglong)&(this->fields).parent >> 0xc);
...

{
  ...
  pcRam_? = pcVar1;
  (*pcRam_?)(pvVar2);
  uStack_4._0_4_ = (this->fields).offset.x;
  uStack_4._4_4_ = (this->fields).offset.y;
  fStack_5 = (this->fields).offset.z + 0.0;
  ...
  uStack_4 = CONCAT44((float)uStack_4._4_4_ + 0.0,(float)(undefined4)uStack_4 + 0.0);
  if (cRam_? == '\0') {
    FUN_?(&
                  void__MethodInfo__UnityEngine__Object__MarshalledUnityObject__MarshalNotNull<UnityEngine::Transform>_UnityEngine__Transform_
                 );
