...

{
  ...
  pMVar3 = 
  MethodInfo__System__Collections__Generic__List<UnityEngine::Vector2>__Add_UnityEngine__Vector2_;
  VStack_4.y = VStack_2.y;
  VStack_4.x = VStack_2.x;
  if (this != (List_1_UnityEngine_Vector2_ *)0x0) {
    piVar5 = &(this->fields)._version;
    *piVar5 = *piVar5 + 1;
    pVVar6 = (this->fields)._items;
    if (pVVar6 != (Vector2__Array *)0x0) {
      uVar7 = (this->fields)._size;
      if (uVar7 < pVVar6->max_length) {
        (this->fields)._size = uVar7 + 1;
        if (pVVar6->max_length <= uVar7) goto code_?;
        pVVar6->vector[uVar7].x = VStack_2.x;
        pVVar6->vector[uVar7].y = VStack_2.y;
      }
      else {
        item.y = VStack_2.y;
        item.x = VStack_2.x;
      ...
      *piVar5 = *piVar5 + 1;
      ...
      if (pVVar6 != (Vector2__Array *)0x0) {
        ...
        if (uVar7 < pVVar6->max_length) {
          ...
          if (pVVar6->max_length <= uVar7) goto code_?;
          pVVar6->vector[uVar7].x = VStack_2.x;
          pVVar6->vector[uVar7].y = VStack_1.y;
        }
        else {
        ...
        *piVar5 = *piVar5 + 1;
        ...
        if (pVVar6 != (Vector2__Array *)0x0) {
          ...
          if (uVar7 < pVVar6->max_length) {
            (this->fields)._size = uVar7 + 1;
            if (pVVar6->max_length <= uVar7) goto code_?;
            pVVar6->vector[uVar7].x = VStack_1.x;
            pVVar6->vector[uVar7].y = VStack_1.y;
          }
          else {
            mscorlib.dll::System::Collections::Generic::List`1[UnityEngine::Vector2]::
          ...
          *piVar5 = *piVar5 + 1;
          ...
          if (pVVar6 != (Vector2__Array *)0x0) {
            ...
            if (uVar7 < pVVar6->max_length) {
              ...
              item_02.y = VStack_2.y;
              item_02.x = VStack_1.x;
              mscorlib.dll::System::Collections::Generic::List`1[UnityEngine::Vector2]::
              List_1_UnityEngine_Vector2__AddWithResize
                        (this,item_02,pMVar3->klass->rgctx_data[0xe].method);
            }
            ...
            while( true ) {
              ...
              MathFunctions::MathFunctions_Vector2ToVector3
                        (&VStack_10,(Vector3 *)&stack0xffffffc4,ignoreAxis,localIgnoreAxisValue,
                         (MethodInfo *)0x0);
              if (t == (Transform *)0x0) break;
              position.y = fVar9;
              position.x = fVar8;
              position.z = 0.0;
              pPVar11 = (PlaneIdHelper_PlaneQuadrantInfo *)
                        UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_TransformPoint
                                  (&VStack_12,t,position,(MethodInfo *)0x0);
              pMVar3 = 
              MethodInfo__System__Collections__Generic__List<UnityEngine::Vector3>__Add_UnityEngine__Vector3_
              ;
              iVar13 = pPVar11->Quadrant;
              iVar14 = pPVar11->FirstAxisSign;
              fStack_15 = (float)pPVar11->SecondAxisSign;
              item_01 = *pPVar11;
              if (this_00 == (List_1_RTG_PlaneIdHelper_PlaneQuadrantInfo_ *)0x0) break;
              piVar5 = &(this_00->fields)._version;
              *piVar5 = *piVar5 + 1;
              pPVar16 = (this_00->fields)._items;
              if (pPVar16 == (PlaneIdHelper_PlaneQuadrantInfo__Array *)0x0) break;
              uVar7 = (this_00->fields)._size;
              if (uVar7 < pPVar16->max_length) {
                (this_00->fields)._size = uVar7 + 1;
                if (pPVar16->max_length <= uVar7) goto code_?;
                pPVar16->vector[uVar7].Quadrant = iVar13;
                pPVar16->vector[uVar7].FirstAxisSign = iVar14;
                pPVar16->vector[uVar7].SecondAxisSign = (int32_t)fStack_15;
              }
              else {
                ...
                List_1_RTG_PlaneIdHelper_PlaneQuadrantInfo__AddWithResize
                          (this_00,item_01,pMVar3->klass->rgctx_data[0xe].method);
              }
              index_00 = index_00 + 1;
              if (3 < index_00) {
                uVar7 = 0;
                do {
                  index_01 = uVar7 & 3;
                  pVVar17 = mscorlib.dll::System::Collections::Generic::List`1[UnityEngine::
                            UIElements::VisualTreeAsset+UsingEntry]::
                            List_1_UnityEngine_UIElements_VisualTreeAsset_UsingEntry__get_Item
                                      ((VisualTreeAsset_UsingEntry *)&stack0xffffff84,
                                       (List_1_UnityEngine_UIElements_VisualTreeAsset_UsingEntry_ *)
                                       this_00,index_01,
                                       MethodInfo__System__Collections__Generic__List<UnityEngine::Vector3>__get_Item_int_
                                      );
                  uVar18 = pVVar17->alias;
                  uVar19 = pVVar17->path;
                  start.y = (float)uVar19;
                  start.x = (float)uVar18;
                  VStack_4.y = (float)pVVar17->asset;
                  pVVar17 = mscorlib.dll::System::Collections::Generic::List`1[UnityEngine::
                            UIElements::VisualTreeAsset+UsingEntry]::
                            List_1_UnityEngine_UIElements_VisualTreeAsset_UsingEntry__get_Item
                                      ((VisualTreeAsset_UsingEntry *)&stack0xffffff78,
                                       (List_1_UnityEngine_UIElements_VisualTreeAsset_UsingEntry_ *)
                                       this_00,index_01,
                                       MethodInfo__System__Collections__Generic__List<UnityEngine::Vector3>__get_Item_int_
                                      );
                  ...
                  fVar8 = (float)pVVar17->path;
                  pVVar21 = pVVar17->asset;
                  index = uVar7 & 0x80000003;
                  if ((int)index < 0) {
                    index = (index - 1 | 0xfffffffc) + 1;
                  }
                  puStack_22 = (undefined *)uVar20;
                  pVVar17 = mscorlib.dll::System::Collections::Generic::List`1[UnityEngine::
                            UIElements::VisualTreeAsset+UsingEntry]::
                            List_1_UnityEngine_UIElements_VisualTreeAsset_UsingEntry__get_Item
                                      ((VisualTreeAsset_UsingEntry *)&stack0xffffff6c,
                                       (List_1_UnityEngine_UIElements_VisualTreeAsset_UsingEntry_ *)
                                       this_00,index,
                                       MethodInfo__System__Collections__Generic__List<UnityEngine::Vector3>__get_Item_int_
                                      );
                  ...
                  uVar24 = pVVar17->path;
                  fVar9 = (float)uVar23 + (float)puStack_22;
                  fStack_15 = (float)uVar24 + fVar8;
                  fStack_25 = (float)pVVar17->asset + (float)pVVar21;
                  pVVar17 = mscorlib.dll::System::Collections::Generic::List`1[UnityEngine::
                            UIElements::VisualTreeAsset+UsingEntry]::
                            List_1_UnityEngine_UIElements_VisualTreeAsset_UsingEntry__get_Item
                                      ((VisualTreeAsset_UsingEntry *)&stack0xffffff60,
                                       (List_1_UnityEngine_UIElements_VisualTreeAsset_UsingEntry_ *)
                                       this_00,index_01,
                                       MethodInfo__System__Collections__Generic__List<UnityEngine::Vector3>__get_Item_int_
                                      );
                  uStack_26._0_4_ = pVVar17->alias;
                  uStack_26._4_4_ = pVVar17->path;
                  pVStack_27 = pVVar17->asset;
                  VStack_12.x = fVar9 - (float)(undefined4)uStack_26;
                  VStack_12.y = fStack_15 - (float)uStack_26._4_4_;
                  VStack_12.z = fStack_25 - (float)pVStack_27;
          ...
          if (3 < pVVar14->max_length) {
            ...
            while( true ) {
              ...
              *(ulonglong *)((int)&pRVar19->vector[0].m_Origin.x + iVar17) =
                   CONCAT44((float)&stack0xffffffec + (float)uVar21,(float)uVar20 + 3.2818565e-29);
...

{
  ...
  if (axisAlignedRect != (Vector3__Array *)0x0) {
    ...
    while( true ) {
      ...
      if (cRam_? == '\0') {
        VStack_3.x = 3.287589e-29;
        VStack_3.y = 2.8253883e-28;
        func_?();
        cRam_? = '\x01';
        uVar10 = _UNK_?;
      }
