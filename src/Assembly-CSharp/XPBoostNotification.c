...
code_?:
      ...
      *pbVar4 = bVar7 + bVar8;
      *(char *)(unaff_EBX + -0x5aefb829) =
           *(char *)(unaff_EBX + -0x5aefb829) + bVar3 + bVar6 +
           (CARRY1(bVar5,(byte)unaff_EBX) || CARRY1(bVar7,bVar8));
      pcVar9 = (code *)swi(3);
      (*pcVar9)();
      return;
    }
