...
code_?:
      func_?();
      *(byte *)(extraout_ECX + 0x10) =
           *(byte *)(extraout_ECX + 0x10) & (byte)((uint)extraout_ECX >> 8);
      pcVar13 = (code *)swi(3);
      (*pcVar13)();
      return;
    }
...

{
  ...
  func_?();
  pbVar8 = (byte *)(extraout_ECX + (int)&stack0xfffffffc * 2);
  *pbVar8 = *pbVar8 | extraout_AH;
  *(char *)&unaff_EDI->x = *(char *)&unaff_EDI->x + (char)extraout_ECX;
  *pcVar3 = *pcVar3 + (char)pVVar4;
  cRam_? = cRam_? + (char)((uint)extraout_ECX >> 8);
  if (cRam_? == '\0') {
    func_?(&TypeInfo__ChunkInstances,unaff_EDI,pcVar3,pVVar4);
    func_?(0x8328);
  ...
  if (unaff_EBX != (ChunkInstances *)0x0) {
    pCVar18 = unaff_EBX->klass;
    if (((pCVar18->_1).naturalAligment < (TypeInfo__MVCubeModelBase->_1).naturalAligment) ||
       ((MVCubeModelBase__Class *)
        (pCVar18->_1).typeHierarchy[(TypeInfo__MVCubeModelBase->_1).naturalAligment - 1] !=
        TypeInfo__MVCubeModelBase)) {
      if (((pCVar18->_1).naturalAligment < (TypeInfo__ChunkInstances->_1).naturalAligment) ||
         (this_00 = (EventHandler_1_ChunkInstancesChanged_ *)unaff_EBX,
         (pCVar18->_1).typeHierarchy[(TypeInfo__ChunkInstances->_1).naturalAligment - 1] !=
...
code_?:
        pTVar19 = mscorlib.dll::System::Object::Object_GetType
                            ((Object *)unaff_EBX,(MethodInfo *)0x0);
        pSVar20 = StringLiteral_CubeModelChunk___ChunkInstanceCh;
        if (pTVar19 == (Type *)0x0) {
          str1 = (String *)0x0;
        }
        else {
          str1 = (String *)
                 (*(code *)(pTVar19->klass->vtable).ToString.method)
                           (pTVar19,(pTVar19->klass->vtable).GetCustomAttributes.methodPtr);
        }
    ...
    fVar7 = VStack_5.x;
    if (VStack_5.x != 0.0) {
      uVar21 = *(undefined4 *)((int)VStack_5.x + 0xc);
      iVar22 = *(int16_t *)((int)VStack_5.x + 0x10);
      ...
      a.z = iVar22;
      a._0_4_ = uVar21;
      bVar23 = MVWorldObject.dll::MV::WorldObject::IntVector::IntVector_op_Inequality
                         (a,b,(MethodInfo *)0x0);
      if (bVar23 != 0) {
        return bVar23;
      }
      if (*(int *)((int)fVar7 + 8) == 0) {
        pCVar24 = ChunkInstances::ChunkInstances_GetChunk
                            ((ChunkInstances_ChunkInstanceVariables *)&stack0xfffffef8,
                             (ChunkInstances *)this_00,*(IntVector *)((int)fVar7 + 0xc),
                             (MethodInfo *)0x0);
        uVar10 = *(undefined4 *)&pCVar24->transparent;
        GVar25 = pCVar24->guid;
        GVar26 = pCVar24->guid;
        uVar27 = (pCVar24->guid)._f;
        uVar28 = (pCVar24->guid)._g;
        GVar29._g = uVar28;
        GVar29._f = uVar27;
        uVar30 = (pCVar24->guid)._a;
        uVar31 = (pCVar24->guid)._b;
        uVar32 = (pCVar24->guid)._c;
        uVar33 = (pCVar24->guid)._d;
        uVar34 = (pCVar24->guid)._e;
        GVar29._e = uVar34;
        GVar29._d = uVar33;
        GVar29._c = uVar32;
        GVar29._b = uVar31;
        GVar29._a = uVar30;
        uVar35 = (pCVar24->guid)._h;
        uVar36 = (pCVar24->guid)._i;
        uVar37 = (pCVar24->guid)._j;
        uVar38 = (pCVar24->guid)._k;
        GVar29._k = uVar38;
        GVar29._j = uVar37;
        GVar29._i = uVar36;
        GVar29._h = uVar35;
        pGVar39 = pCVar24->gameObject;
        pBVar40 = pCVar24->collider;
        pMVar41 = pCVar24->renderer;
        pMVar42 = pCVar24->filter;
        if (unaff_ESI[2].klass != (Object__Class *)0x0) {
          uVar43 = (pCVar24->guid)._j;
          uVar44 = (pCVar24->guid)._k;
          value_00.guid._k = uVar44;
          value_00.guid._j = uVar43;
          uVar45 = (pCVar24->guid)._a;
          uVar46 = (pCVar24->guid)._b;
          uVar47 = (pCVar24->guid)._c;
          uVar48 = (pCVar24->guid)._d;
          uVar49 = (pCVar24->guid)._e;
          uVar50 = (pCVar24->guid)._f;
          uVar51 = (pCVar24->guid)._g;
          uVar52 = (pCVar24->guid)._h;
          uVar53 = (pCVar24->guid)._i;
          value_00.guid._i = uVar53;
          value_00.guid._h = uVar52;
          value_00.guid._g = uVar51;
          value_00.guid._f = uVar50;
          value_00.guid._e = uVar49;
          value_00.guid._d = uVar48;
          value_00.guid._c = uVar47;
          value_00.guid._b = uVar46;
          value_00.guid._a = uVar45;
          value_00.gameObject = pCVar24->gameObject;
          value_00.collider = pCVar24->collider;
          value_00.renderer = pCVar24->renderer;
          value_00.filter._0_2_ = (short)pCVar24->filter;
          value_00.filter._2_2_ = (short)((uint)pCVar24->filter >> 0x10);
          value_00._32_4_ = uVar10;
          bVar23 = mscorlib.dll::System::Collections::Generic::Dictionary`2[System::
                   ...
                   Dictionary_2_System_Guid_ChunkInstances_ChunkInstanceVariables__TryAdd
                             ((Dictionary_2_System_Guid_ChunkInstances_ChunkInstanceVariables_ *)
                              unaff_ESI[2].klass,GVar29,value_00,
                              MethodInfo__System__Collections__Generic__Dictionary<System::Guid,_ChunkInstances::ChunkInstanceVariables>__TryAdd_System__Guid__ChunkInstances__ChunkInstanceVariables_
                             );
          if (bVar23 != 0) {
            return bVar23;
          ...
          if (unaff_ESI[2].klass != (Object__Class *)0x0) {
            value_01.gameObject = pGVar39;
            value_01.guid = GVar25;
            value_01.collider = pBVar40;
            value_01.renderer = pMVar41;
            value_01.filter = pMVar42;
            value_01._32_4_ = uVar10;
            mscorlib.dll::System::Collections::Generic::Dictionary`2[System::
            Guid,ChunkInstances+ChunkInstanceVariables]::
            Dictionary_2_System_Guid_ChunkInstances_ChunkInstanceVariables__set_Item
                      ((Dictionary_2_System_Guid_ChunkInstances_ChunkInstanceVariables_ *)
                       unaff_ESI[2].klass,GVar26,value_01,
                       MethodInfo__System__Collections__Generic__Dictionary<System::Guid,_ChunkInstances::ChunkInstanceVariables>__set_Item_System__Guid__ChunkInstances__ChunkInstanceVariables_
                      );
      ...
      else if (*(int *)((int)fVar7 + 8) == 1) {
        bVar23 = ChunkInstances::ChunkInstances_Contains
                           ((ChunkInstances *)this_00,*(IntVector *)((int)fVar7 + 0xc),
                            (MethodInfo *)0x0);
        if (bVar23 == 0) {
          if ((TypeInfo__UnityEngine__Debug->_1).cctor_finished_or_no_cctor == 0) {
        ...
        pCVar24 = ChunkInstances::ChunkInstances_GetChunk
                            ((ChunkInstances_ChunkInstanceVariables *)&stack0xfffffef8,
                             (ChunkInstances *)this_00,*(IntVector *)((int)fVar7 + 0xc),
                             (MethodInfo *)0x0);
        uVar54 = (pCVar24->guid)._c;
        uVar55 = (pCVar24->guid)._a;
        uVar56 = (pCVar24->guid)._b;
        GVar26._b = uVar56;
        GVar26._a = uVar55;
        uVar57 = (pCVar24->guid)._d;
        uVar58 = (pCVar24->guid)._e;
        uVar59 = (pCVar24->guid)._f;
        uVar60 = (pCVar24->guid)._g;
        GVar26._g = uVar60;
        GVar26._f = uVar59;
        GVar26._e = uVar58;
        GVar26._d = uVar57;
        uVar10._0_1_ = (pCVar24->guid)._h;
        uVar10._1_1_ = (pCVar24->guid)._i;
        uVar10._2_1_ = (pCVar24->guid)._j;
        uVar10._3_1_ = (pCVar24->guid)._k;
        pUVar61 = (UnityAction_2_System_Object_System_Object_ *)func_?();
        ...
        ChunkInstances::ChunkInstances_remove_Changed
                  ((ChunkInstances *)this_00,(EventHandler_1_ChunkInstancesChanged_ *)pUVar61,
                   (MethodInfo *)0x0);
        if (unaff_ESI[2].klass != (Object__Class *)0x0) {
          GVar26._c = uVar54;
          GVar26._h = (char)(short)uVar10;
          GVar26._i = (char)((ushort)(short)uVar10 >> 8);
          GVar26._j = uVar10._2_1_;
          GVar26._k = uVar10._3_1_;
          bVar23 = mscorlib.dll::System::Collections::Generic::Dictionary`2[System::
                   Guid,ChunkInstances+ChunkInstanceVariables]::
                   Dictionary_2_System_Guid_ChunkInstances_ChunkInstanceVariables__Remove
                             ((Dictionary_2_System_Guid_ChunkInstances_ChunkInstanceVariables_ *)
                              unaff_ESI[2].klass,GVar26,
                              MethodInfo__System__Collections__Generic__Dictionary<System::Guid,_ChunkInstances::ChunkInstanceVariables>__Remove_System__Guid_
                             );
          return bVar23;
        }
      }
      else if (*(int *)((int)fVar7 + 8) == 2) {
        pUVar61 = (UnityAction_2_System_Object_System_Object_ *)func_?();
        UnityEngine.CoreModule.dll::UnityEngine::Events::UnityAction`2[System::Object,System::
        Object]::UnityAction_2_System_Object_System_Object___ctor
                  (pUVar61,unaff_ESI,
        ...
        if (*(int *)((int)fVar7 + 8) != 3) {
          bVar23 = 0;
          if (*(int *)((int)fVar7 + 8) == 4) {
            ChunkInstances::ChunkInstances_GetChunk
                      ((ChunkInstances_ChunkInstanceVariables *)&stack0xfffffef8,
                       (ChunkInstances *)this_00,*(IntVector *)((int)fVar7 + 0xc),(MethodInfo *)0x0
                      );
        ...
        if (unaff_ESI[2].klass != (Object__Class *)0x0) {
          ...
          func_?();
          func_?();
          uStack_6._4_4_ = uVar17;
          func_?();
          uStack_6 = CONCAT44(uStack_6._4_4_,uVar16);
          func_?(&uStack_6);
          if (this != (Object__Class *)0x0) {
            value.guid._b = (short)uVar11;
            value.guid._c = (short)((uint)uVar11 >> 0x10);
            value.guid._a = uVar10;
            value.guid._d = (char)uVar12;
            value.guid._e = (char)((uint)uVar12 >> 8);
            value.guid._f = (char)((uint)uVar12 >> 0x10);
            value.guid._g = (char)((uint)uVar12 >> 0x18);
            value.guid._h = (char)uVar13;
            value.guid._i = (char)((uint)uVar13 >> 8);
            value.guid._j = (char)((uint)uVar13 >> 0x10);
            value.guid._k = (char)((uint)uVar13 >> 0x18);
            value.gameObject = (GameObject *)uVar14;
            value.collider = (BoxCollider *)uVar15;
            value.renderer._0_2_ = (short)uStack_6;
            value.renderer._2_2_ = (short)((ulonglong)uStack_6 >> 0x10);
            value.filter = (MeshFilter *)uStack_6._4_4_;
            value._32_2_ = (short)CONCAT31((int3)((uint)uVar21 >> 8),1);
            value._34_2_ = (short)((uint)uVar21 >> 0x10);
            mscorlib.dll::System::Collections::Generic::Dictionary`2[System::
            Guid,ChunkInstances+ChunkInstanceVariables]::
            Dictionary_2_System_Guid_ChunkInstances_ChunkInstanceVariables__set_Item
                      ((Dictionary_2_System_Guid_ChunkInstances_ChunkInstanceVariables_ *)this,
                       GVar29,value,
                       MethodInfo__System__Collections__Generic__Dictionary<System::Guid,_ChunkInstances::ChunkInstanceVariables>__set_Item_System__Guid__ChunkInstances__ChunkInstanceVariables_
                      );
            return extraout_AL;
...

{
  ...
  DStack_3._getEnumeratorRetType = (int32_t)TypeInfo__UnityEngine__Vector2;
  DStack_3._current.value = (Object *)&UNK_?;
...
code_?:
  ...
  case Face__Enum_Front:
    ...
    goto code_?;
    if (faceVertices->max_length != 0) {
      fVar8 = faceVertices->vector[0].y;
      if (pVVar4->max_length != 0) {
        pVVar4->vector[0].x = faceVertices->vector[0].x;
        pVVar4->vector[0].y = fVar8;
        if (1 < faceVertices->max_length) {
          fVar8 = faceVertices->vector[1].y;
          if (1 < pVVar4->max_length) {
            pVVar4->vector[1].x = faceVertices->vector[1].x;
            pVVar4->vector[1].y = fVar8;
            if (2 < faceVertices->max_length) {
              fVar8 = faceVertices->vector[2].y;
              if (2 < pVVar4->max_length) {
                pVVar4->vector[2].x = faceVertices->vector[2].x;
                pVVar4->vector[2].y = fVar8;
                if (3 < faceVertices->max_length) {
                  fVar8 = faceVertices->vector[3].y;
                  if (3 < pVVar4->max_length) {
                    pVVar4->vector[3].x = faceVertices->vector[3].x;
                    pVVar4->vector[3].y = fVar8;
                    goto code_?;
...
code_?:
    if (pVVar4->max_length != 0) {
      ...
      if (1 < pVVar4->max_length) {
        fVar8 = pVVar4->vector[1].y;
        pVVar4->vector[1].x = fVar7 + pVVar4->vector[1].x;
        pVVar4->vector[1].y = fVar6 + fVar8;
        if (2 < pVVar4->max_length) {
          fVar8 = pVVar4->vector[2].y;
          pVVar4->vector[2].x = fVar7 + pVVar4->vector[2].x;
          pVVar4->vector[2].y = fVar6 + fVar8;
          if (3 < pVVar4->max_length) {
            fVar8 = pVVar4->vector[3].y;
            pVVar4->vector[3].x = fVar7 + pVVar4->vector[3].x;
            pVVar4->vector[3].y = fVar6 + fVar8;
            fVar6 = scale * fVar6;
            if (pVVar4->max_length != 0) {
  ...
  uVar9 = func_?();
  piVar10 = (int *)uVar9;
  lVar11 = (longlong)*piVar10 * 0xADDR;
  pppVVar12 = &ppVStack_2;
  cVar13 = '\x0f';
  do {
    puVar1 = puVar1 + -1;
    pppVVar12 = pppVVar12 + -1;
    *pppVVar12 = (Vector2__Array__Class **)*puVar1;
    cVar13 = cVar13 + -1;
  } while ('\0' < cVar13);
  if (((int)lVar11 != lVar11) == (int)((ulonglong)uVar9 >> 0x20) + 1 < 0) {
    uVar14 = in((short)lVar11);
    *unaff_EDI = uVar14;
    out((short)lVar11,piVar10);
  }
  else {
    bVar15 = in((short)*piVar10 * -0x74ab);
    piVar10 = (int *)CONCAT31((int3)((ulonglong)uVar9 >> 8),bVar15);
    *(byte *)((int)piVar10 + -0x44dc03c3) = *(byte *)((int)piVar10 + -0x44dc03c3) & bVar15;
    *piVar10 = *piVar10 + (int)piVar10;
    ppVStack_2 = (Vector2__Array__Class **)&stack0xfffffffc;
    if (*piVar10 != 0) goto code_?;
  }
  ppVStack_2 = (Vector2__Array__Class **)&stack0xfffffffc;
  func_?(&TypeInfo__UnityEngine__Debug);
  func_?(&
...
code_?:
  if (*(Dictionary_2_UnityEngine_UIElements_StyleSheets_StyleSheetCache_SheetHandleKey_System_Object_
      ...
      (Dictionary_2_UnityEngine_UIElements_StyleSheets_StyleSheetCache_SheetHandleKey_System_Object_
       *)0x0) {
    iVar16 = mscorlib.dll::System::Collections::Generic::Dictionary`2[UnityEngine::UIElements::
             StyleSheets::StyleSheetCache+SheetHandleKey,System::Object]::
             Dictionary_2_UnityEngine_UIElements_StyleSheets_StyleSheetCache_SheetHandleKey_System_Object__get_Count
                       (*(Dictionary_2_UnityEngine_UIElements_StyleSheets_StyleSheetCache_SheetHandleKey_System_Object_
                          **)(unaff_retaddr + 0x44),
    ...
    if (iVar16 < 1) {
      ...
      pIVar17 = TypeInfo__MV__WorldObject__IntVector->static_fields;
      unaff_EBP->klass = *(Vector2__Array__Class **)&pIVar17->One;
      *(int16_t *)&unaff_EBP->monitor = (pIVar17->One).z;
      return unaff_EBP;
    }
        ...
        (Dictionary_2_System_Text_RegularExpressions_Regex_CachedCodeEntryKey_System_Object_ *)0x0)
    {
      ...
      uVar19 = *(undefined2 *)&(pDVar18->_current).key._cultureKey;
      unaff_EBP->klass = (Vector2__Array__Class *)(pDVar18->_current).key._options;
      *(undefined2 *)&unaff_EBP->monitor = uVar19;
      return unaff_EBP;
    }
  }
  func_?();
  pcVar20 = (code *)swi(3);
  pVVar4 = (Vector2__Array *)(*pcVar20)();
  return pVVar4;
}
