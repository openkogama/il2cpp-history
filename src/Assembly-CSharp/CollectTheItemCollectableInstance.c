    ...
    if (pMVar1 != (MVWorldObjectClientManager *)0x0) {
      ...
      if (pLVar3 != (List_1_MV_WorldObject_Link_ *)0x0) {
        ...
        if (x != (Object_1 *)0x0) {
          ...
          if ((bVar4 <= (x->klass->_1).naturalAligment) &&
             ((x->klass->_1).typeHierarchy[bVar4 - 1] == (Il2CppClass *)TypeInfo__VehiclePickupOwner
             )) {
            return 1;
          }
        }
        ...
        if (bVar5 == 0) {
          ...
          if ((MVJetPack__Class *)(pMVar2->klass->_1).typeHierarchy[bVar4 - 1] !=
              TypeInfo__MVJetPack) {
            return 0;
          }
          pLVar3 = pMVar2[1].fields.inputLinkRefs;
        ...
        if (x != (Object_1 *)0x0) {
          ...
          bVar5 = UnityEngine.CoreModule.dll::UnityEngine::Object::Object_1_op_Inequality
                            (pOVar6,(Object_1 *)0x0,(MethodInfo *)0x0);
          if (bVar5 != 0) {
            if (x[4].fields.m_CachedPtr == (void *)0x0) goto code_?;
            iVar7 = func_?();
            if (iVar7 == 5) {
              return 1;
            }
...
code_?:
      ...
      if (pMVar10 != (MVWorldObjectClientManager *)0x0) {
        ...
        pDVar3 = (Delegate *)pMVar15[3].monitor;
        ppMVar16 = &pMVar15[3].monitor;
          ...
          if (pCVar4 != (CollectTheItemObject *)0x0) {
            ...
            if (pGVar5 != (GameObject *)0x0) {
              ...
              if (pCVar6 != (CollectTheItemBlinker *)0x0) {
                ppMVar8 = &(pCVar6->fields)._.meshFilters;
                *ppMVar8 = pMVar7;
  ...
  if (this_00 != (HashSet_1_System_UInt32_ *)0x0) {
    ...
    while( true ) {
      ...
      if (pMVar6 != (MVWorldObject *)0x0) {
        ...
        if ((bVar7 <= (pMVar6->klass->_1).naturalAligment) &&
           ((MVCubeModelInstance__Class *)(pMVar6->klass->_1).typeHierarchy[bVar7 - 1] ==
          ...
          LayerUtil::LayerUtil_SetLayerRecursively_4
                    ((GameObject *)gameObject,iVar8,(MethodInfo *)0x0);
        }
      }
    }
    mscorlib.dll::System::ThrowHelper::ThrowHelper_1_IfNullAndNullsAreIllegalThenThrow_55
    ...
    if (this_01 != (MVWorldObjectClientManager *)0x0) {
      ...
      if ((pMVar6 != (MVWorldObject *)0x0) && (pMVar5 != (MVWorldObjectClientManager *)0x0)) {
        ...
        if (((((this_02->klass->_1).naturalAligment < bVar7) ||
             ((CollectTheItemCollectable__Class *)(this_02->klass->_1).typeHierarchy[bVar7 - 1] !=
              TypeInfo__CollectTheItemCollectable)) ||
            (pCVar10 = (this_02->fields).controller, pCVar10 == (CollectTheItem *)0x0)) ||
           ((pCVar10->fields).dropOff == (CollectTheItemDropOff *)0x0)) goto code_?;
        pMVar5 = MVGameControllerBase::MVGameControllerBase_get_WOCM((MethodInfo *)0x0);
        iVar8 = CollectTheItemCollectable::CollectTheItemCollectable_get_DropOffId
                          (this_02,(MethodInfo *)0x0);
        if (pMVar5 == (MVWorldObjectClientManager *)0x0) goto code_?;
        pMVar6 = MVWorldObjectClientManager::MVWorldObjectClientManager_GetWorldObject
                           (pMVar5,iVar8,(MethodInfo *)0x0);
        if (pMVar6 == (MVWorldObject *)0x0) goto code_?;
        bVar7 = (TypeInfo__CollectTheItemDropOff->_1).naturalAligment;
        if (((pMVar6->klass->_1).naturalAligment < bVar7) ||
           ((CollectTheItemDropOff__Class *)(pMVar6->klass->_1).typeHierarchy[bVar7 - 1] !=
        ...
        if (this_04 != (CollectTheItemObject *)0x0) {
          UnityEngine.CoreModule.dll::UnityEngine::Behaviour::Behaviour_set_enabled
                    ((Behaviour *)this_04,bVar3 == 0,(MethodInfo *)0x0);
          pDVar12 = (Delegate *)pMVar6[3].monitor;
          ...
          pDVar12 = mscorlib.dll::System::Delegate::Delegate_Combine
                             (pDVar12,(Delegate *)this_03,(MethodInfo *)0x0);
          if (pDVar12 == (Delegate *)0x0) {
            pMVar11[3].monitor = (MonitorData *)0x0;
          }
          else {
