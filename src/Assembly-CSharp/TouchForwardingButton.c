...

{
  ...
  if (pTVar1 != (TouchPadAbsolute *)0x0) {
    uVar2 = (uint)((this->fields).horizontalEnabled != 0);
    uVar3 = uVar2 | 2;
    if ((this->fields).verticalEnabled == 0) {
      uVar3 = uVar2;
    }
    (pTVar1->fields).state = uVar3;
    pTVar1 = (this->fields).touchPadAbsolute;
    if (pTVar1 != (TouchPadAbsolute *)0x0) {
      if ((pTVar1->fields).dragging == 0) {
        (pTVar1->fields).dragging = 1;
        UnityStandardAssets::CrossPlatformInput::TouchPadAbsolute::TouchPadAbsolute_SetOnPointButton
                  (pTVar1,1,(MethodInfo *)0x0);
        if (eventData == (PointerEventData *)0x0) goto DAT_?;
        (pTVar1->fields).fingerId = (eventData->fields)._pointerId_k__BackingField;
        fVar4 = (eventData->fields)._position_k__BackingField.y;
        (pTVar1->fields).previousInputPosition.x = (eventData->fields)._position_k__BackingField.x;
        (pTVar1->fields).previousInputPosition.y = fVar4;
      }
      return;
    }
  }
...

{
  ...
  (this_00->fields).state = 3;
  (this_00->fields).dragging = 0;
  UnityStandardAssets::CrossPlatformInput::TouchPadAbsolute::TouchPadAbsolute_SetOnPointButton
            (this_00,0,(MethodInfo *)0x0);
  bVar2 = cRam_? == '\0';
  (this_00->fields).fingerId = -1;
  if (bVar2) {
  ...
  if (((this_00->fields).state & 1) != 0) {
    pCVar5 = (this_00->fields).horizontalVirtualAxis;
    if (pCVar5 == (CrossPlatformInputManager_VirtualAxis *)0x0) goto code_?;
    (pCVar5->fields).m_Value = (float)uVar3;
  }
  if (((this_00->fields).state & 2) != 0) {
    pCVar5 = (this_00->fields).verticalVirtualAxis;
...

{
  ...
  if (pTVar1 != (TouchPadAbsolute *)0x0) {
    ...
    (this->fields).initialized = (pTVar1->fields)._._._._.m_CachedPtr != (void *)0x0;
    return;
  }
