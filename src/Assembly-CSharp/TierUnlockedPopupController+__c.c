...

{
  ...
  pTVar1 = (TierUnlockedPopupController_c *)
           FUN_?(TypeInfo__TierUnlockedPopupController____c);
  TypeInfo__TierUnlockedPopupController____c->static_fields->__9 = pTVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__TierUnlockedPopupController____c->static_fields >> 0xc);
