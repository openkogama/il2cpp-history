...

{
  ...
  if (*(int *)&(TypeInfo__EnterCubeModelTutorial____c->_1).field_0x1c == 0) {
    FUN_?(TypeInfo__EnterCubeModelTutorial____c);
  }
  this_01 = TypeInfo__EnterCubeModelTutorial____c->static_fields->__9__0_0;
  if (this_01 == (ExecuteEvents_EventFunction_1_IEditStateCommands_ *)0x0) {
    if (*(int *)&(TypeInfo__EnterCubeModelTutorial____c->_1).field_0x1c == 0) {
      FUN_?(TypeInfo__EnterCubeModelTutorial____c);
    }
    object = TypeInfo__EnterCubeModelTutorial____c->static_fields->__9;
    this_01 = (ExecuteEvents_EventFunction_1_IEditStateCommands_ *)
              FUN_?(
                           TypeInfo__UnityEngine__EventSystems__ExecuteEvents__EventFunction<IEditStateCommands>
                           );
    ...
    ExecuteEvents_EventFunction_1_System_Object___ctor
              ((ExecuteEvents_EventFunction_1_System_Object_ *)this_01,(Object *)object,
               MethodInfo__EnterCubeModelTutorial____c___OnClick_b__0_0_IEditStateCommands__UnityEngine__EventSystems__BaseEventData_
               ,(MethodInfo *)0x0);
    TypeInfo__EnterCubeModelTutorial____c->static_fields->__9__0_0 = this_01;
    if (iRam_? != 0) {
      uVar2 = (uint)((ulonglong)&TypeInfo__EnterCubeModelTutorial____c->static_fields->__9__0_0 >>
                     0xc);
