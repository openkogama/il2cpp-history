...

{
  ...
  KogamaSettingsCollectionBase__ctor
            ((KogamaSettingsCollectionBase *)values,StringLiteral_GameOptionsRoot,
             (KogamaSettingsCollectionBase *)0x0,(MethodInfo *)0x0);
  this_00 = (KogamaSettingBoolBase *)
            func_?(
                           TypeInfo__MV__WorldObject__KogamaSettings__KogamaSettingsCore__KogamaSettingTypes__KogamaSettingBoolBase
                           );
  KogamaSettingsCore::KogamaSettingTypes::KogamaSettingBoolBase::KogamaSettingBoolBase__ctor
            (this_00,StringLiteral_AllowRevive,1,(KogamaSettingsCollectionBase *)values,
             (MethodInfo *)0x0);
  if (values != (Dictionary_2_System_Object_System_Object_ *)0x0) {
    pOStack1 =
         (Object__Class *)
         (values->klass->vtable).System_Collections_Generic_IDictionary_TKey_TValue__get_Keys.
         methodPtr;
    (*(code *)(values->klass->vtable).set_Item.method)();
    ...
    Func_4_System_Collections_Generic_KeyValuePair_2_System_Object_System_Object_Object_Object_Object___ctor
              (this_01,(Object *)0x0,this_01,(MethodInfo *)0x0);
    ...
    KogamaSettingsCore::KogamaSettingTools::KogamaSettingTools_KogamaSettingsToDictionary_1
              ((KogamaSettingWrapperBase *)values,
