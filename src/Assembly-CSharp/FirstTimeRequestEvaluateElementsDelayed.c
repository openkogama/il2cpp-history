...

{
  if (cRam_? == '\0') {
    ...
    LOCK();
    UNLOCK();
    FUN_?(&TypeInfo__FirstTimeRequestEvaluateElementsDelayed____c);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
  ...
  if (*(int *)&(TypeInfo__FirstTimeRequestEvaluateElementsDelayed____c->_1).field_0x1c == 0) {
    FUN_?(TypeInfo__FirstTimeRequestEvaluateElementsDelayed____c);
  }
  this_01 = TypeInfo__FirstTimeRequestEvaluateElementsDelayed____c->static_fields->__9__0_0;
  if (this_01 == (ExecuteEvents_EventFunction_1_IFirstTimeElementActivator_ *)0x0) {
    ...
    ExecuteEvents_EventFunction_1_System_Object___ctor
              ((ExecuteEvents_EventFunction_1_System_Object_ *)this_01,(Object *)object,
               MethodInfo__FirstTimeRequestEvaluateElementsDelayed____c___OnEnable_b__0_0_UnityEngine__EventSystems__IFirstTimeElementActivator__UnityEngine__EventSystems__BaseEventData_
               ,(MethodInfo *)0x0);
    TypeInfo__FirstTimeRequestEvaluateElementsDelayed____c->static_fields->__9__0_0 = this_01;
    if (iRam_? != 0) {
      uVar2 = (uint)((ulonglong)
                      &TypeInfo__FirstTimeRequestEvaluateElementsDelayed____c->static_fields->
                       __9__0_0 >> 0xc);
