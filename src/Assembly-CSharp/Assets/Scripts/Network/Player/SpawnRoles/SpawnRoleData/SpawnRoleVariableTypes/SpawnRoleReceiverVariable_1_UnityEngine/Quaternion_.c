...

{
  ...
  if (this_00 != (SubscribableVariable_1_UnityEngine_Quaternion_ *)0x0) {
  ...
  *ppSVar1 = subscribableVariableExternal;
  ...
  if (subscribableVariableExternal != (SubscribableVariable_1_UnityEngine_Quaternion_ *)0x0) {
    ...
    *ppSVar1 = this_01;
    ...
    this_00 = (SubscribableVariableBase_1_UnityEngine_Quaternion_ *)*ppSVar1;
    pIVar2 = method->klass->rgctx_data[8].klass;
    if (((uint)pIVar2->vtable[0].methodPtr & 0x100) == 0) {
      pIVar2 = (Il2CppClass *)func_?(pIVar2);
    }
    this_02 = (UnityAction_1_UnityEngine_Color_ *)func_?(pIVar2);
