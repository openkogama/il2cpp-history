...
code_?:
  ...
  if ((this_00 == (MVWorldObjectClientManager *)0x0) ||
    ...
    pcVar6 = (char *)((int)uVar4 + -0x20 + iVar5);
    *pcVar6 = *pcVar6 + '\x01';
    bVar7 = (byte)((ulonglong)uVar4 >> 8);
    pcVar6 = (char *)((int)&this->klass + unaff_FS_OFFSET);
    *pcVar6 = *pcVar6 + (char)((ulonglong)uVar4 >> 0x20) +
              (CARRY1(extraout_CH,bVar7) || CARRY1(extraout_CH + bVar7,bVar3));
    pcVar6 = (char *)((int)uVar4 + -0x34 + iVar5);
    *pcVar6 = *pcVar6 + '\x01';
    pcVar8 = (code *)swi(3);
