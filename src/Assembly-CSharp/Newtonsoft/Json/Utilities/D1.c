...
Object * Assembly-CSharp.dll::Newtonsoft::Json::Utilities::D1::D1_Invoke
                   (D1 *this,MethodInfo *method)

{
  this_00 = (D1 *)(this->fields)._.prev;
  if (this_00 != (D1 *)0x0) {
    D1_Invoke(this_00,method);
  }
  ...
  if (cVar4 == '\0') {
    ...
    if (cVar4 == '\0') {
      if (cVar7 == '\0') {
        pOVar2 = (Object *)func_?(this_01->flags,pOVar2);
        return pOVar2;
      }
      ...
      pOVar2 = (Object *)func_?(this_01->flags,pOVar3,pOVar2);
      return pOVar2;
    }
    ...
    if (cVar7 == '\0') {
      ...
      pOVar2 = (Object *)(*(code *)*puVar9)(pOVar2,puVar9);
      return pOVar2;
    }
...
code_?:
    ...
    pOVar2 = (Object *)(*(code *)*puVar9)(pOVar3,puVar9);
    return pOVar2;
  }
  pOVar2 = (Object *)(*pcVar1)(pOVar2,this_01);
  return pOVar2;
}
