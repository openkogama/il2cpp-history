          ...
          if (_UNK_? < (float)pVStack_25 - (this->fields).prevMouseUpTime) {
            ...
            if ((this->fields).prevSelectedCube != (CubePickingInfo *)0x0) {
              ...
              fVar29 = MVInputWrapper::MVInputWrapper_GetAxisWithoutSensitivity
                                (StringLiteral_Mouse_X,(MethodInfo *)0x0);
              pVStack_25 = (Vector3__Array *)((uint)fVar29 & _UNK_?);
              pVStack_28 = (Vector3__Array *)
                           MVInputWrapper::MVInputWrapper_GetAxisWithoutSensitivity
                                     (StringLiteral_Mouse_Y,(MethodInfo *)0x0);
              if (((float)pVStack_25 != 0.0) || ((float)((uint)pVStack_28 & _UNK_?) != 0.0))
              {
...
code_?:
                      ...
                      if (pVVar56 != (Vector3__Array *)0x0) {
                        ...
                        fVar29 = VStack_45.x + (float)uVar61;
                        fVar35 = VStack_45.y + (float)uVar62;
                        ...
                        pVVar64 = (Vector3__Array *)((VStack_45.y + fVar35) * _UNK_?);
                        ...
                        if (pVVar52->vector[0].x == 0.0) {
                          ...
                          VStack_45.z = (float)pMStack_33 + (pVVar66->upVector).z;
                          VStack_45.y = (float)pVStack_28 + (float)uVar68;
                          VStack_45.x = (float)pVStack_25 + (float)uVar67;
                            ...
                            if (pVVar56 != (Vector3__Array *)0x0) {
                              if (*(bool *)((int)&pVVar52->vector[0].y + 1) == 0) {
                                ...
                                fVar29 = (pVVar56->vector[1].z + pVVar56->vector[0].z) *
                                        _UNK_?;
                                VStack_23.x = (VStack_45.x + (float)uVar69) * _UNK_?;
                                pVVar22 = (Vector3__Array *)
...
code_?:
                            ...
                            if (pVVar56 != (Vector3__Array *)0x0) {
                              ...
                              VStack_23.y._0_2_ = (short)uVar73;
                              VStack_23.y._2_2_ = (undefined2)((uint)uVar73 >> 0x10);
                              IStack_21.x = (int16_t)uVar72;
                              IStack_21.y = (int16_t)((uint)uVar72 >> 0x10);
              ...
              if ((pCVar43 != (Cube *)0x0) &&
                ...
                pCVar14 = pCStack_32;
                pFVar76 = (FaceCursor *)(pCStack_32->fields).cube;
                pVVar22 = (Vector3__Array *)CONCAT22(VStack_23.y._2_2_,VStack_23.y._0_2_);
                if (pFVar76 != (FaceCursor *)0x0) {
                  FaceCursor::FaceCursor_UpdateCursor
                            (pFVar76,(CubePickingInfo *)pVStack_25,(GameObject *)pMStack_33,
                             (MethodInfo *)0x0);
                  goto code_?;
                }
              }
            ...
            pIVar77 = (IndentArea *)(pCStack_32->fields).pickedEdge;
            pVVar22 = (Vector3__Array *)CONCAT22(VStack_23.y._2_2_,VStack_23.y._0_2_);
            if (pIVar77 != (IndentArea *)0x0) {
              IndentArea::IndentArea_UpdateIndentArea
                        (pIVar77,(CubePickingInfo *)pVVar52,(GameObject *)pMStack_33,
                         (MethodInfo *)0x0);
              pCVar14 = pCStack_32;
              pCVar43 = (pCStack_32->fields).cube;
              pVVar22 = (Vector3__Array *)CONCAT22(VStack_23.y._2_2_,VStack_23.y._0_2_);
                        ...
                        if (this_02 !=
                          ...
                          *piVar78 = *piVar78 + 1;
                          ...
                          if (pMVar79 !=
                            ...
                            if (uVar34 < pMVar79->max_length) {
                              (this_02->fields)._size = uVar34 + 1;
                              if (pMVar79->max_length <= uVar34) goto code_?;
                              (&pMVar79->vector[0].index)[uVar34] = 0;
                            }
                            else {
                            ...
                            *piVar78 = *piVar78 + 1;
                            ...
                            if (pMVar79 !=
                              ...
                              if (uVar34 < pMVar79->max_length) {
                                (this_02->fields)._size = uVar34 + 1;
                                if (pMVar79->max_length <= uVar34) goto code_?;
                                (&pMVar79->vector[0].index)[uVar34] = 3;
                              }
                              else {
                                mscorlib.dll::System::Collections::Generic::List`1[System::Int32]::
                                List_1_System_Int32__AddWithResize
                              ...
                              *piVar78 = *piVar78 + 1;
                              ...
                              if (pMVar79 !=
                                ...
                                if (uVar34 < pMVar79->max_length) {
                                  (this_02->fields)._size = uVar34 + 1;
                                  if (pMVar79->max_length <= uVar34) goto code_?;
                                  (&pMVar79->vector[0].index)[uVar34] = 2;
                                }
                                else {
                                  mscorlib.dll::System::Collections::Generic::List`1[System::Int32]
                                  ::List_1_System_Int32__AddWithResize
                                  ...
                                  *piVar78 = *piVar78 + 1;
                                  ...
                                  if (pMVar79 !=
                                    ...
                                    if (uVar34 < pMVar79->max_length) {
                                      (this_02->fields)._size = uVar34 + 1;
                                      if (pMVar79->max_length <= uVar34) goto code_?;
                                      (&pMVar79->vector[0].index)[uVar34] = 1;
                                    }
                                    else {
                                      mscorlib.dll::System::Collections::Generic::List`1[System::
                                      Int32]::List_1_System_Int32__AddWithResize
                                    ...
                                    *piVar78 = *piVar78 + 1;
                                    ...
                                    if (pMVar79 !=
                                      ...
                                      pMVar36 = uStack_31;
                                      UnityEngine.CoreModule.dll::UnityEngine::Mesh::
                                      Mesh_set_triangles((Mesh *)uStack_31,(Int32__Array *)pMVar79,
                                                         (MethodInfo *)0x0);
                                      UnityEngine.CoreModule.dll::UnityEngine::Mesh::
                                      ...
                                      if (pVVar52->vector[0].x == 0.0) {
                                        ...
                                        if (pGVar54 != (GameObject *)0x0) {
                                          ...
                                          if (this_04 != (Renderer *)0x0) {
                                            pBVar42 = (Byte__Array *)(pFVar76->fields).materialNone;
                                        ...
                                        if (pGVar54 != (GameObject *)0x0) {
                                          ...
                                          pVVar22 = (Vector3__Array *)
                                                    CONCAT22(VStack_23.y._2_2_,VStack_23.y._0_2_);
                                          if (this_04 != (Renderer *)0x0) {
                                            pBVar42 = (Byte__Array *)(pFVar76->fields).materialEdge;
                                            uVar46 = SUB41(pBVar42,0);
                                            uVar47 = (undefined1)((uint)pBVar42 >> 8);
                                            uVar6 = (undefined2)((uint)pBVar42 >> 0x10);
code_?:
                                            ...
                                            if (pGVar54 != (GameObject *)0x0) {
                                              ...
                                              VStack_23.z._0_1_ = (bool)pTVar80;
                                              VStack_23.z._1_1_ = (undefined1)((uint)pTVar80 >> 8);
                                              VStack_23.z._2_2_ =
                                                  ...
                                                  if (pGVar54 != (GameObject *)0x0) {
                                                    ...
                                                    if (pTVar80 != (Transform *)0x0) {
                                                      ...
                                                      if (pVStack_28 != (Vector3__Array *)0x0) {
                                                        ...
                                                        goto code_?;
                                                        uVar81 = pVStack_28->vector[0].x;
                                                        uVar82 = pVStack_28->vector[0].y;
                                                        fVar83 = ((Vector3 *)
                                                                 &pVStack_28->vector[0].z)->x;
                                                        VStack_23.y._0_2_ = (short)uVar82;
                                                        VStack_23.y._2_2_ =
                                                             (undefined2)((uint)uVar82 >> 0x10);
                                                        VStack_23.z._0_1_ = SUB41(fVar83,0);
                                                        VStack_23.z._1_1_ =
      ...
      if (e != (CubeModelingStateMachine *)0x0) {
        ...
        if ((pMVar36 != (MVCubeModelBase *)0x0) &&
          ...
          IndentArea::IndentArea_UpdateIndentArea
                    (pIVar77,pCVar87,(pMVar36->fields)._.gameObject,(MethodInfo *)0x0);
          pMVar19 = (this->fields).modelCursor;
          IStack_21._0_4_ = CONCAT22(IStack_21.y,IStack_21.x);
          pVVar22 = (Vector3__Array *)CONCAT22(VStack_23.y._2_2_,VStack_23.y._0_2_);
          if ((pMVar19 != (ModelCursor3D *)0x0) &&
...
code_?:
  bVar88 = func_?();
  pcVar89 = (char *)((int)&pVVar52[-0x1e0a11].vector[9].z + 3);
  *pcVar89 = *pcVar89 + (bVar88 ^ 0xe2);
  pcVar90 = (code *)swi(3);
  (*pcVar90)();
  return;
}
