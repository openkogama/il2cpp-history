...
code_?:
    ...
    if (iVar4 == 1) {
      uVar8 = 0;
      pPVar9 = PlayerListsHold_CreatePlayerList(this,MVTeam__Enum_None,0,(MethodInfo *)0x0);
    ...
    while (LStack_1._list != (List_1_System_Object_ *)0x0) {
      if ((LStack_1._version != ((LStack_1._list)->fields)._version) ||
        ...
        PlayerListsHold_SortPlayerListsAfterScore
                  (this,(Dictionary_2_MV_WorldObject_MVTeam_PlayerListHold_ *)this_01,teams,
      ...
      uVar8 = 0;
      pPVar9 = PlayerListsHold_CreatePlayerList(this,IVar27,score,(MethodInfo *)0x0);
      if (this_01 == (Dictionary_2_System_Int32Enum_GamePassesHighScoreList_HighScoreListData_ *)0x0
         ) goto code_?;
      mscorlib.dll::System::Collections::Generic::Dictionary`2[System::Int32Enum,System::Object]::
      Dictionary_2_System_Int32Enum_System_Object__TryInsert
...

{
  if (cRam_? == '\0') {
    ...
    LOCK();
    UNLOCK();
    FUN_?(&TypeInfo__PlayerListsHold__ScoreSorter);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
    ...
    if (cVar25 == '\0') {
      ...
      if (this_00 != (Dictionary_2_System_Int32Enum_GamePassesHighScoreList_HighScoreListData_ *)0x0
        ...
        while( true ) {
          ...
          uVar30 = FUN_?(TypeInfo__PlayerListsHold__ScoreSorter);
...
code_?:
    ...
    if ((*(char *)(lVar8 + 0x80) != '\x03') && (*(Int32Enum__Enum *)(lVar8 + 0x84) != 5)) {
      if (this_00 == (Dictionary_2_System_Int32Enum_GamePassesHighScoreList_HighScoreListData_ *)0x0
         ) goto code_?;
...

{
  if (cRam_? == '\0') {
    ...
    LOCK();
    UNLOCK();
    FUN_?(&MethodInfo__PlayerListsHold__ReCreate__);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
...

{
  if (cRam_? == '\0') {
    ...
    LOCK();
    UNLOCK();
    FUN_?(&TypeInfo__PlayerListsHold____c__DisplayClass10_0);
    LOCK();
    UNLOCK();
    FUN_?(&TypeInfo__PlayerListsHold____c);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
  object = (Object *)FUN_?(TypeInfo__PlayerListsHold____c__DisplayClass10_0);
  pGVar1 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_gameObject
                      ((Component *)this,(MethodInfo *)0x0);
  if (*(int *)&(TypeInfo__PlayerListsHold____c->_1).field_0x1c == 0) {
    FUN_?(TypeInfo__PlayerListsHold____c);
  }
  ...
  if (pEVar2 == (ExecuteEvents_EventFunction_1_IUIStack_ *)0x0) {
    ...
    if (iRam_? != 0) {
      uVar4 = (uint)((ulonglong)&TypeInfo__PlayerListsHold____c->static_fields->__9__10_0 >> 0xc);
    ...
    if (pOVar9 != (Object__Class *)0x0) {
      ...
      *(uint8_t *)&(pOVar9->_0).declaringType = uVar11;
      ...
      if (pEVar2 == (ExecuteEvents_EventFunction_1_IUIStack_ *)0x0) {
        ...
        if (iRam_? != 0) {
          uVar4 = (uint)((ulonglong)&TypeInfo__PlayerListsHold____c->static_fields->__9__10_1 >>
                         0xc);
          lVar5 = (ulonglong)((uVar4 & 0x1fffff) >> 6) * 8;
          do {
            uVar6 = *(ulonglong *)(lVar5 + 0xADDR);
...

{
  if (cRam_? == '\0') {
    ...
    LOCK();
    UNLOCK();
    FUN_?(&MethodInfo__System__Collections__Generic__List<PlayerListHold>__List__);
    LOCK();
    UNLOCK();
    FUN_?(&MethodInfo__System__Collections__Generic__List<PlayerListHold>__get_Count__);
    LOCK();
    UNLOCK();
    FUN_?(&MethodInfo__System__Collections__Generic__List<PlayerListHold>__get_Item_int_);
    LOCK();
    UNLOCK();
    FUN_?(&TypeInfo__System__Collections__Generic__List<PlayerListHold>);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
