...
code_?:
    ...
    if (bVar12 == 0) {
      ...
      if (bVar12 == 0) {
        if (pOVar13 == (Object_1 *)0x0) goto code_?;
        pOVar13 = pOVar13[4].fields.m_CachedPtr;
        if ((TypeInfo__UnityEngine__Object->_1).cctor_finished_or_no_cctor == 0) {
          func_?();
        }
        bVar12 = UnityEngine.CoreModule.dll::UnityEngine::Object::Object_1_op_Equality
                          (pOVar13,(Object_1 *)0x0,(MethodInfo *)0x0);
        if ((bVar12 == 0) && (pOVar13 != (Object_1 *)0x0)) {
          bVar14 = (TypeInfo__PickupItemCollectTheItem->_1).naturalAligment;
          if ((bVar14 <= (pOVar13->klass->_1).naturalAligment) &&
             ((pOVar13->klass->_1).typeHierarchy[bVar14 - 1] ==
            ...
            if (x != (Object_1 *)0x0) {
              ...
              iVar15 = func_?();
              if (iVar15 != 0) {
                original_00 = *(Object **)(iVar15 + 0x22c);
                if ((TypeInfo__UnityEngine__Object->_1).cctor_finished_or_no_cctor == 0) {
                  func_?();
                }
                this_00 = (Component *)
