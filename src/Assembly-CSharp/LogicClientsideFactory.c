...
code_?:
    ...
    InputSignalReceiverClient::InputSignalReceiverClient__ctor
              (this,worldObject,logicEvaluateSignalComponentBase,defaultInput,logicObjectManager,
               (MethodInfo *)0x0);
    if (this == (InputSignalReceiverClient *)0x0) goto code_?;
    ppAVar2 = &(this->fields)._.OnSignal;
    pDVar3 = mscorlib.dll::System::Delegate::Delegate_Combine
                       ((Delegate *)*ppAVar2,(Delegate *)signalCallback,(MethodInfo *)0x0);
    if (pDVar3 == (Delegate *)0x0) {
      *ppAVar2 = (Action_3_Boolean_Boolean_LogicObjectManager_ *)0x0;
      func_?();
      return (IInputSignalReceiver *)this;
    }
    pAVar4 = (Action_3_Boolean_Boolean_LogicObjectManager_ *)func_?();
    if (pAVar4 == (Action_3_Boolean_Boolean_LogicObjectManager_ *)0x0) goto code_?;
    *ppAVar2 = pAVar4;
    iVar5 = func_?();
    if (iVar5 != 0) {
      func_?();
...
code_?:
    ...
    if (this_00 == (InputSignalReceiverClient *)0x0) goto code_?;
    ppAVar2 = &(this_00->fields)._.OnSignal;
    pDVar3 = mscorlib.dll::System::Delegate::Delegate_Combine
                       ((Delegate *)*ppAVar2,(Delegate *)signalCallback,(MethodInfo *)0x0);
    if (pDVar3 == (Delegate *)0x0) {
      *ppAVar2 = (Action_3_Boolean_Boolean_LogicObjectManager_ *)0x0;
...
code_?:
    ...
    if (signalCallback != (Action_3_Boolean_Boolean_LogicObjectManager_ *)0x0) {
      ...
      ppAVar2 = &(this_00->fields).OnSignal;
      pDVar3 = mscorlib.dll::System::Delegate::Delegate_Combine
...
code_?:
    ...
    if (this_00 == (SignalReceiverStateChangeCallbacks *)0x0) goto code_?;
    ppAVar6 = &(this_00->fields).OnInputStateUpdate;
    pDVar3 = mscorlib.dll::System::Delegate::Delegate_Combine
                       ((Delegate *)(this_00->fields).OnInputStateUpdate,
                        (Delegate *)inputStateUpdateCallback,(MethodInfo *)0x0);
    if (pDVar3 == (Delegate *)0x0) {
      *ppAVar6 = (Action_2_LogicInputState_LogicObjectManager_ *)0x0;
      func_?();
      return (IInputSignalReceiver *)this_00;
    }
    pAVar7 = (Action_2_LogicInputState_LogicObjectManager_ *)func_?();
    if (pAVar7 != (Action_2_LogicInputState_LogicObjectManager_ *)0x0) {
      *ppAVar6 = pAVar7;
      iVar5 = func_?();
      if (iVar5 != 0) {
        func_?();
...
code_?:
  func_?();
  pcVar8 = (code *)swi(3);
  pIVar9 = (IInputSignalReceiver *)(*pcVar8)();
  return pIVar9;
}
