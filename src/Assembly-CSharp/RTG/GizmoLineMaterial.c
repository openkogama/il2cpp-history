...
{
  obj = GizmoLineMaterial_get_Material(this,(MethodInfo *)0x0);
  if (obj == (Material *)0x0) {
    FUN_?();
    pcVar1 = (code *)swi(3);
    (*pcVar1)();
...
{
  if (cRam_? == '\0') {
    FUN_?(&MethodInfo__RTG__Singleton<RTG::GizmoLineMaterial>__Singleton__);
    LOCK();
    UNLOCK();
  ...
  pSVar1 = TypeInfo__RTG__Singleton<RTG::GizmoLineMaterial>;
