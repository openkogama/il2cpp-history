...
/* Void Invoke(XPProgressData) */

void Assembly-CSharp.dll::XPProgress+OnXPProgressDataDelegate::
     XPProgress_OnXPProgressDataDelegate_Invoke
               (XPProgress_OnXPProgressDataDelegate *this,XPProgressData *xpProgress,
               MethodInfo *method)

{
  this_00 = (XPProgress_OnXPProgressDataDelegate *)(this->fields)._.prev;
  if (this_00 != (XPProgress_OnXPProgressDataDelegate *)0x0) {
    XPProgress_OnXPProgressDataDelegate_Invoke(this_00,xpProgress,method);
  }
...
code_?:
    (*(code *)pMVar1)(pOVar2,xpProgress,this_01);
    return;
  }
  if (cVar6 == '\x01') {
    if (((this_01->flags == 0xffff) ||
      ...
      if (cVar6 == '\0') {
        if (cVar5 == '\0') {
          (*(code *)(&(pOVar2->klass->vtable).Equals)[this_01->flags].method)
                    (pOVar2,xpProgress,(&(pOVar2->klass->vtable).Finalize)[this_01->flags].methodPtr
                    );
          return;
        }
        pIVar9 = (Il2CppClass *)
...
code_?:
        (*(code *)*ppMVar13)(pOVar2,xpProgress,ppMVar13[1]);
        return;
      }
...
code_?:
      ...
      (*(code *)*puVar17)(pOVar2,xpProgress,puVar17);
      return;
    }
  }
    ...
    if (cVar6 == '\0') {
      if (cVar5 == '\0') {
        (*(code *)(&(xpProgress->klass->vtable).Equals)[this_01->flags].method)
                  (xpProgress,(&(xpProgress->klass->vtable).Finalize)[this_01->flags].methodPtr);
        return;
      }
      pIVar9 = (Il2CppClass *)
                mscorlib.dll::System::Collections::Generic::
                ...
                KeyValuePair_2_WinningConditionType_System_Object__get_Value
                          ((KeyValuePair_2_WinningConditionType_System_Object_ *)this_01,pMVar1);
      uVar18 = 0;
      pXVar19 = xpProgress->klass;
      uVar10._0_1_ = (pXVar19->_1).rank;
      uVar10._1_1_ = (pXVar19->_1).minimumAlignment;
      if (uVar10 != 0) {
        do {
          if (pXVar19->interfaceOffsets[uVar18].interfaceType == pIVar9) {
            iVar20 = pXVar19->interfaceOffsets[uVar18].offset + (uint)this_01->flags;
            (*(code *)(&(xpProgress->klass->vtable).Equals)[iVar20].method)
                      (xpProgress,(&(xpProgress->klass->vtable).Finalize)[iVar20].methodPtr);
            return;
          }
          uVar18 = uVar18 + 1;
        } while (uVar18 < uVar10);
      }
      puVar17 = (undefined4 *)func_?(xpProgress,pIVar9,(uint)this_01->flags);
      (*(code *)*puVar17)(xpProgress,puVar17[1]);
      return;
    }
    uVar14 = (uint)this_01->flags;
    if (cVar5 == '\0') {
      puVar17 = (undefined4 *)
               func_?((&(xpProgress->klass->vtable).Finalize)[uVar14].methodPtr,this_01);
      (*(code *)*puVar17)(xpProgress,puVar17);
      return;
    }
    pXVar19 = xpProgress->klass;
    uVar10 = 0;
    uVar18._0_1_ = (pXVar19->_1).rank;
    uVar18._1_1_ = (pXVar19->_1).minimumAlignment;
    pMVar1 = this_01;
    if (uVar18 != 0) {
      do {
        if (pXVar19->interfaceOffsets[uVar10].interfaceType == (Il2CppClass *)this_01->name) {
          ppMVar13 = &(&(xpProgress->klass->vtable).Equals)
                     [(uint)pMVar4->flags + xpProgress->klass->interfaceOffsets[uVar10].offset].
                     method;
          goto code_?;
        }
        uVar10 = uVar10 + 1;
    ...
    pMVar4 = pMVar1;
    ppMVar13 = (MethodInfo **)func_?(xpProgress,(Il2CppClass *)this_01->name,uVar14);
code_?:
    puVar17 = (undefined4 *)func_?(ppMVar13[1],pMVar4);
    (*(code *)*puVar17)(xpProgress,puVar17);
    return;
  }
  (*(code *)pMVar1)(xpProgress,this_01);
  return;
}
