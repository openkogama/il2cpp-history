...

{
  ...
  if ((error == (LoadAdError *)0x0) && (ad != (InterstitialAd *)0x0)) {
    ...
    if (pRVar2 == (ResponseInfo *)0x0) {
      ...
      pSVar3 = (String *)
               (*(pRVar2->klass->vtable).ToString.methodPtr)
                         (pRVar2,(pRVar2->klass->vtable).ToString.method);
    }
  ...
  if (pNVar2 != (NavMesh_OnNavMeshPreUpdate *)0x0) {
    ...
    if (pIVar1 != (InterstitialAd *)0x0) {
      ...
      if (pNVar2 != (NavMesh_OnNavMeshPreUpdate *)0x0) {
        ...
        if (pIVar1 != (InterstitialAd *)0x0) {
          GoogleMobileAds.dll::GoogleMobileAds::Api::InterstitialAd::
          InterstitialAd_remove_OnAdFullScreenContentClosed
          ...
          if (pNVar2 != (NavMesh_OnNavMeshPreUpdate *)0x0) {
            ...
            if (pIVar1 != (InterstitialAd *)0x0) {
              GoogleMobileAds.dll::GoogleMobileAds::Api::InterstitialAd::
              InterstitialAd_remove_OnAdClicked(pIVar1,(Action *)pNVar2,(MethodInfo *)0x0);
              pIVar1 = (this->fields).interstitial;
              ...
              if (pAVar3 != (Action_1_Object_ *)0x0) {
                ...
                if (pIVar1 != (InterstitialAd *)0x0) {
                  GoogleMobileAds.dll::GoogleMobileAds::Api::InterstitialAd::
                  InterstitialAd_remove_OnAdPaid
                            (pIVar1,(Action_1_GoogleMobileAds_Api_AdValue_ *)pAVar3,
                             (MethodInfo *)0x0);
                  pIVar1 = (this->fields).interstitial;
                  pNVar2 = (NavMesh_OnNavMeshPreUpdate *)func_?();
                  if (pNVar2 != (NavMesh_OnNavMeshPreUpdate *)0x0) {
                    ...
                    if (pIVar1 != (InterstitialAd *)0x0) {
                      GoogleMobileAds.dll::GoogleMobileAds::Api::InterstitialAd::
                      InterstitialAd_remove_OnAdImpressionRecorded
                                (pIVar1,(Action *)pNVar2,(MethodInfo *)0x0);
                      pIVar1 = (this->fields).interstitial;
                      pAVar3 = (Action_1_Object_ *)func_?();
                      if (pAVar3 != (Action_1_Object_ *)0x0) {
                        ...
                        if (pIVar1 != (InterstitialAd *)0x0) {
                          ...
                          InterstitialAd_remove_OnAdFullScreenContentFailed
                                    (pIVar1,(Action_1_GoogleMobileAds_Api_AdError_ *)pAVar3,
                                     (MethodInfo *)0x0);
                          return;
                        }
                      }
  ...
  if (((this->fields).interstitial == (InterstitialAd *)0x0) ||
     (bVar1 = GoogleMobileAds.dll::GoogleMobileAds::Api::RewardedInterstitialAd::
              RewardedInterstitialAd_CanShowAd
                        ((RewardedInterstitialAd *)(this->fields).interstitial,(MethodInfo *)0x0),
     bVar1 == 0)) {
      ...
      if (pNVar2 != (NavMesh_OnNavMeshPreUpdate *)0x0) {
        ...
        if (pIVar1 != (InterstitialAd *)0x0) {
          ...
          if (pNVar2 != (NavMesh_OnNavMeshPreUpdate *)0x0) {
            ...
            if (pIVar1 != (InterstitialAd *)0x0) {
              GoogleMobileAds.dll::GoogleMobileAds::Api::InterstitialAd::
              InterstitialAd_add_OnAdClicked(pIVar1,(Action *)pNVar2,(MethodInfo *)0x0);
              pIVar1 = (this->fields).interstitial;
              pAVar3 = (Action_1_Object_ *)func_?();
              if (pAVar3 != (Action_1_Object_ *)0x0) {
                mscorlib.dll::System::Action`1[Object]::Action_1_Object___ctor
                ...
                if (pIVar1 != (InterstitialAd *)0x0) {
                  ...
                  if (pNVar2 != (NavMesh_OnNavMeshPreUpdate *)0x0) {
                    ...
                    if (pIVar1 != (InterstitialAd *)0x0) {
                      GoogleMobileAds.dll::GoogleMobileAds::Api::InterstitialAd::
                      InterstitialAd_add_OnAdImpressionRecorded
                                (pIVar1,(Action *)pNVar2,(MethodInfo *)0x0);
                      pIVar1 = (this->fields).interstitial;
                      pAVar3 = (Action_1_Object_ *)func_?();
                      if (pAVar3 != (Action_1_Object_ *)0x0) {
...

{
  ...
  if (this_00 != (RewardedInterstitialAd *)0x0) {
    this._3_1_ = GoogleMobileAds.dll::GoogleMobileAds::Api::RewardedInterstitialAd::
                 RewardedInterstitialAd_CanShowAd(this_00,(MethodInfo *)0x0);
  }
