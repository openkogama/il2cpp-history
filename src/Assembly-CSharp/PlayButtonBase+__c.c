...

{
  ...
  pPVar1 = (PlayButtonBase_c *)FUN_?(TypeInfo__PlayButtonBase____c);
  TypeInfo__PlayButtonBase____c->static_fields->__9 = pPVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__PlayButtonBase____c->static_fields >> 0xc);
