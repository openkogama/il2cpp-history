...

{
  ...
  pPVar1 = (PlayerRepository_c *)FUN_?(TypeInfo__PlayerRepository____c);
  TypeInfo__PlayerRepository____c->static_fields->__9 = pPVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__PlayerRepository____c->static_fields >> 0xc);
