          ...
          if (pGVar3 != (GameObject *)0x0) {
            ...
            if (pGVar1 != (GameObject *)0x0) {
              ...
              if (pTVar9 != (Transform *)0x0) {
                ...
                fVar2 = pVVar5->z;
                in_stack_8 = (undefined2)((uint)uVar10._4_4_ >> 0x10);
                if ((((uint)(TypeInfo__UnityEngine__Vector3->vtable).Equals.methodPtr & 0x2000000)
                  ...
                  func_?();
                  uVar10 = CONCAT26(in_stack_8,(int6)uVar10);
                }
                a.z = fVar2;
                ...
                pVVar5 = UnityEngine.CoreModule.dll::UnityEngine::Vector3::Vector3_op_Multiply
                                   ((Vector3 *)&puStack_6,a,0.99,(MethodInfo *)0x0);
                if (pTVar4 != (Transform *)0x0) {
    ...
    if (pGVar1 != (GameObject *)0x0) {
      ...
      if (pGVar1 != (GameObject *)0x0) {
        ...
        if (this_02 != (PrefabPool *)0x0) {
          value_00 = PrefabPool::PrefabPool_get_ModelCubeSpaceMaterial(this_02,(MethodInfo *)0x0);
...
IntVector Assembly-CSharp.dll::CellCursorCubeMesh::CellCursorCubeMesh_get_LocalPos
                    (CellCursorCubeMesh *this,MethodInfo *method)

{
  IVar1.z = (int16_t)method;
  IVar1._0_4_ = this;
  this->klass = (CellCursorCubeMesh__Class *)method->invoker_method;
