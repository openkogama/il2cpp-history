...

{
  ...
  if (pAVar3 != (AvatarModifierPackages *)0x0) {
    ...
    pMVar6 = (pMVar2->fields).runtimeDataModifiers;
        ...
        if (pSVar7 != (String__Array *)0x0) {
          ...
          case ModifierActions__Enum_Add:
            if (this_00 != (Dictionary_2_System_Object_UnityEngine_UIElements_TextureId_ *)0x0) {
              ...
              pAVar3 = (pMVar4->fields).modifierPackages;
              if (pAVar3 != (AvatarModifierPackages *)0x0) {
                ...
                pMVar6 = (pMVar4->fields).runtimeDataModifiers;
joined_?:
                if (pMVar6 != (MVRuntimeDataVariable *)0x0) {
...
code_?:
                  ...
                  this_01 = (Enum *)AvatarModifierPackages::
                                    AvatarModifierPackages_GetPackageToActWith
                                              (pAVar3,AVar1,ModifierActions__Enum_Replace,
                                               (MethodInfo *)0x0);
                  (*(code *)(pMVar4->klass->vtable).RemoveModifier.method)();
          ...
          case ModifierActions__Enum_CancelOut:
            ...
            if (pAVar3 != (AvatarModifierPackages *)0x0) {
              ...
              (*(code *)(pMVar4->klass->vtable).RemoveModifier.method)
                        (pMVar4,AVar1,id,(pMVar4->klass->vtable).HasModifierEffect.methodPtr);
              return;
            }
            break;
          default:
...
code_?:
  ...
  *pbVar17 = *pbVar17 - bVar18;
  ...
  pcVar19[0x43] = pcVar19[0x43] + (char)((uint)pMVar4 >> 8) + (bVar16 < bVar18);
