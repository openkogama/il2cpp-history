...

{
  ...
  func_?();
  *(int *)(extraout_ECX + 0x10) = (int)(extraout_EDX + *(int *)(extraout_ECX + 0x10));
  puVar1 = (uint *)(extraout_ECX + 0x10);
  uVar2 = *puVar1;
  *puVar1 = (uint)(extraout_EDX + *puVar1);
  *extraout_EDX = *extraout_EDX + unaff_DI + CARRY4(uVar2,(uint)extraout_EDX);
  pcVar3 = (code *)swi(3);
  (*pcVar3)();
  return;
}
