...

{
  ...
  value = (GameEventManager_AvatarCommandsBuildModeManager_LaserCommandsManager *)
          func_?(
                         TypeInfo__GameEventManager_AvatarCommandsBuildModeManager__LaserCommandsManager
                         );
  if (value != (GameEventManager_AvatarCommandsBuildModeManager_LaserCommandsManager *)0x0) {
