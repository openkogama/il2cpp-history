...

{
  ...
  if (((pMVar1 != (MVGameControllerBase *)0x0) &&
    ...
    if (pOVar4 == (Object *)0x0) {
      ...
      message = (String *)func_?(&StringLiteral_Couldn_t_find_killLimitClient_wi);
      mscorlib.dll::System::Exception::Exception__ctor_1(this_00,message,(MethodInfo *)0x0);
      uVar5 = func_?(&MethodInfo__MVKillLimit__Destroy__);
      FUN_?(this_00,uVar5);
      pcVar6 = (code *)swi(3);
      (*pcVar6)();
      return;
...

{
  ...
  if ((pMVar1 != (MVGameControllerBase *)0x0) &&
    ...
    aiStackX_18[0] = MVKillLimit_get_KillLimit(this,(MethodInfo *)0x0);
...

{
  ...
  if (((pMVar1 != (MVGameControllerBase *)0x0) &&
    ...
    if (pOVar3 != (Object *)0x0) {
      iVar4 = MVKillLimit_get_KillLimit(this,(MethodInfo *)0x0);
    ...
    uVar6 = func_?(&MethodInfo__MVKillLimit__OnDataUpdate__);
    FUN_?(this_01,uVar6);
    pcVar7 = (code *)swi(3);
    (*pcVar7)();
    return;
