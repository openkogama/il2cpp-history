...

{
  ...
  case MVTeam__Enum_Blue:
    (*(this->klass->vtable).Tint_1.methodPtr)
              (this,0x3c23d70a,0x3f0a3d71,0x3f800000,0x3f800000,(this->klass->vtable).Tint_1.method)
    ;
    return;
  case MVTeam__Enum_Red:
    (*(this->klass->vtable).Tint_1.methodPtr)
              (this,0x3f5ae148,0,0,0x3f800000,(this->klass->vtable).Tint_1.method);
    return;
  case MVTeam__Enum_Green:
    (*(this->klass->vtable).Tint_1.methodPtr)
              (this,0,0x3f27ae14,0,0x3f800000,(this->klass->vtable).Tint_1.method);
    return;
  case MVTeam__Enum_Yellow:
    (*(this->klass->vtable).Tint_1.methodPtr)
              (this,0x3f800000,0x3f800000,0,0x3f800000,(this->klass->vtable).Tint_1.method);
    return;
  default:
