    ...
    if (uVar4 != 0) {
      do {
        if (pIVar2->interfaceOffsets[uVar3].interfaceType ==
          ...
          (*(code *)(&(pIVar2->vtable).InitializeCallbackManager)[iVar5].method)
                    (pIVar1,this,(&(pIVar2->vtable).InitializeAdConfigSettings)[iVar5].methodPtr);
          return;
        }
        uVar3 = uVar3 + 1;
      } while (uVar3 < uVar4);
  ...
  if (pOVar1 != (Object *)0x0) {
    *(undefined1 *)&pOVar1[1].klass = 0;
    ...
    pSVar4 = mscorlib.dll::System::Boolean::Boolean_ToString
                       ((Boolean *)(pOVar1 + 1),(MethodInfo *)0x0);
    ...
    pOVar1 = (Object *)func_?();
    mscorlib.dll::System::ThrowHelper::ThrowHelper_1_IfNullAndNullsAreIllegalThenThrow_55
              (pOVar1,ExceptionArgument__Enum_obj,(MethodInfo *)pEVar3);
    ...
    if (pOVar1 != (Object *)0x0) {
      ...
      if (pOVar5 != (Object__Class *)0x0) {
        *(NavMesh_OnNavMeshPreUpdate **)&(pOVar5->_0).this_arg.attrs = this_00;
        func_?(&(pOVar5->_0).this_arg.attrs,this_00);
        fVar6 = UnityEngine.CoreModule.dll::UnityEngine::Time::Time_1_get_time((MethodInfo *)0x0);
        *(float *)&(pOVar5->_0).byval_arg.attrs = fVar6;
        (pOVar5->_0).this_arg.data.dummy = (void *)0x41200000;
        if (pOVar1[1].klass != (Object__Class *)0x0) {
          pGVar2 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_gameObject
                             ((Component *)pOVar1[1].klass,(MethodInfo *)0x0);
          (this->fields).overlayPushedToStack = pGVar2;
          func_?(&(this->fields).overlayPushedToStack,pGVar2);
          pGVar2 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_gameObject
                             ((Component *)this,(MethodInfo *)0x0);
...

{
  ...
  if (iRam_? == 0) {
    ...
    pSVar3 = mscorlib.dll::System::Boolean::Boolean_ToString
                       ((Boolean *)&in_stack_4[1].fields,(MethodInfo *)0x0);
    ...
    if (*(char *)&in_stack_4[1].fields._.m_CachedPtr != '\0') {
      *(undefined1 *)&in_stack_4[1].fields._.m_CachedPtr = 0;
...

{
  ...
  pSVar1 = mscorlib.dll::System::Boolean::Boolean_ToString
                     ((Boolean *)&(this->fields).popupShowing,(MethodInfo *)0x0);
