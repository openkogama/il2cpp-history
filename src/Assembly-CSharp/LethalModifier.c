...

{
  ...
  if (pGVar4 != (GameObject *)0x0) {
    pvVar2 = (pGVar4->fields)._.m_CachedPtr;
  }
  if (*(int *)&(TypeInfo__UnityEngine__Object->_1).field_0x1c == 0) {
    FUN_?();
  }
...
{
  if (cRam_? == '\0') {
    FUN_?(&TypeInfo__LethalModifier___DoFadeAndDestroy_d__7);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
  pIVar1 = (IEnumerator *)FUN_?(TypeInfo__LethalModifier___DoFadeAndDestroy_d__7);
  bVar2 = iRam_? != 0;
    ...
    if (this_02 != (Transform *)0x0) {
      ...
      if (((pMVar1 != (MVAvatar *)0x0) && (pMVar2 = (pMVar1->fields).body, pMVar2 != (MVBody *)0x0))
        ...
        BlinkerBase::BlinkerBase_StartBlinking
                  ((BlinkerBase *)this_00,BlinkType__Enum_Lethal,_UNK_?,(MethodInfo *)0x0);
    ...
    if (pGVar1 != (GameObject *)0x0) {
      ...
      if (cVar5 == '\0') {
        ...
        if (this_01 != (Transform *)0x0) {
          ...
          lVar6 = FUN_?(TypeInfo__LethalModifier___DoFadeAndDestroy_d__7);
          bVar7 = iRam_? != 0;
          *(undefined4 *)(lVar6 + 0x10) = 0;
          *(LethalModifier **)(lVar6 + 0x20) = this;
          if (bVar7) {
