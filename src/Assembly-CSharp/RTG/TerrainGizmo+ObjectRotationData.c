...
/* TerrainGizmo+ObjectRotationData() */

void Assembly-CSharp.dll::RTG::TerrainGizmo+ObjectRotationData::
     TerrainGizmo_ObjectRotationData__ctor(TerrainGizmo_ObjectRotationData *this,MethodInfo *method)
