...

{
  ...
  pTVar1 = (TouchEditModeController_c *)FUN_?(TypeInfo__TouchEditModeController____c);
  TypeInfo__TouchEditModeController____c->static_fields->__9 = pTVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__TouchEditModeController____c->static_fields >> 0xc);
