    ...
    if (this_00 != (PurchasedAccessoryPreviewer *)0x0) {
      ...
      if (pAVar5 != (AccessoryDataClient__Array *)0x0) {
        if ((int)(pAVar5->max_length - 1) <= (this_00->fields).currentStreamingAssetIndex) {
          pPVar6 = (PurchasedAccessoryPreviewer_DisplayAndFadeImages_d_17 *)
          ...
          ExecuteEvents_ExecuteHierarchy
                    ((GameObject *)pPVar6,(BaseEventData *)0x0,
                     (ExecuteEvents_EventFunction_1_System_Object_ *)callbackFunction,
                     UnityEngine__GameObject_MethodInfo__UnityEngine__EventSystems__ExecuteEvents__ExecuteHierarchy<UnityEngine::EventSystems::IUIStack>_UnityEngine__GameObject__UnityEngine__EventSystems__BaseEventData__UnityEngine__EventSystems__ExecuteEvents__EventFunction<UnityEngine::EventSystems::IUIStack>_
                    );
code_?:
          pPVar6 = (PurchasedAccessoryPreviewer_DisplayAndFadeImages_d_17 *)&this;
          goto code_?;
        }
        PurchasedAccessoryPreviewer::PurchasedAccessoryPreviewer_EvaluateImageAtTime
        ...
        uVar2 = (POPCOUNT((uint)pAVar5 & 0xff) & 1U) == 0;
        if (pAVar5 != (AccessoryDataClient__Array *)0x0) {
          uVar2 = (POPCOUNT(uVar8 - pAVar5->max_length & 0xff) & 1U) == 0;
          if (uVar8 < pAVar5->max_length) {
            pAVar9 = pAVar5->vector[iVar7 + 1];
            ...
            if (pAVar9 != (AccessoryDataClient *)0x0) {
              if (((pAVar9->fields)._.lvl == 0) ||
                ...
                if (pAVar5 != (AccessoryDataClient__Array *)0x0) {
                  uVar2 = (POPCOUNT(uVar8 - pAVar5->max_length & 0xff) & 1U) == 0;
                  if (pAVar5->max_length <= uVar8) goto code_?;
                  iVar10 = (pAVar5->vector[iVar7 + 1]->fields)._.cost;
...
code_?:
  ...
  pPVar6 = (PurchasedAccessoryPreviewer_DisplayAndFadeImages_d_17 *)func_?();
  if ((bool)uVar2) {
    pcVar14 = (code *)swi(3);
    bVar15 = (*pcVar14)();
    return bVar15;
