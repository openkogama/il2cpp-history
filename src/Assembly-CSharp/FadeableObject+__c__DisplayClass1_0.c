...
/* Void <Start>b__0(IFadeParent, BaseEventData) */

void Assembly-CSharp.dll::FadeableObject+<>c__DisplayClass1_0::
     FadeableObject_c_DisplayClass1_0__Start_b__0
               (FadeableObject_c_DisplayClass1_0 *this,IFadeParent *x,BaseEventData *y,
               MethodInfo *method)
