              ...
              if (pMVar1 != (MvCharacterController *)0x0) {
                ...
                if (this_00 != (Transform *)0x0) {
                  ...
                  if (pTVar2 != (Transform *)0x0) {
                    ...
                    value.x = (float)puStack_4 + 3.3174637e-29;
...
code_?:
  ...
  if (pMVar7 != (MvCharacterController *)0x0) {
    ...
    (pMVar7->fields).elipsoidRadius.x = (pMVar7->fields).radiusBase.x * (float)this;
    (pMVar7->fields).elipsoidRadius.y = fVar13 * (float)this;
    (pMVar7->fields).elipsoidRadius.z = fVar6 * (float)this;
    (pMVar7->fields).offsetFactor = fVar14 * (float)this;
    pEVar15 = (pSVar1->fields).CameraScaleEvent;
    if (pEVar15 != (EventHandler_1_ScaleArgs_ *)0x0) {
      this = (SizeState *)func_?();
      ScaleArgs::ScaleArgs__ctor((ScaleArgs *)this,3.3177023e-29,(MethodInfo *)0x0);
