...

{
  ...
  goto code_?;
  if (((this_03->klass->_1).naturalAligment < (TypeInfo__MVBlueprintBase->_1).naturalAligment) ||
     ((MVBlueprintBase__Class *)
      (this_03->klass->_1).typeHierarchy[(TypeInfo__MVBlueprintBase->_1).naturalAligment - 1] !=
...
code_?:
    ...
    SettingsBase::SettingsBase_Initialize
              (_UNK_?,0xADDR,(GameObject *)TVar2.m_Index,
    ...
    if (*(Il2CppClass **)(*(int *)TVar2.m_Index + 0x20) ==
      ...
      SettingsToggle::SettingsToggle_Initialize
                (this_01,StringLiteral_hasIndicator,*pbVar3,(MethodInfo *)0x0);
      return;
    }
  }
  func_?();
