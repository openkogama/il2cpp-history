...

{
  ...
  pLVar1 = (LobbyFlowMenu_c *)FUN_?(TypeInfo__LobbyFlowMenu____c);
  TypeInfo__LobbyFlowMenu____c->static_fields->__9 = pLVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__LobbyFlowMenu____c->static_fields >> 0xc);
