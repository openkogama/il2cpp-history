...
code_?:
  ...
  iVar17 = (int)uVar15;
  out(0xef,iVar17);
  pbVar18 = (byte *)(iVar17 + -0x11 + (int)&stack0xfffffffc * 8);
  bVar19 = *pbVar18;
  bVar20 = *pbVar18 + (byte)uVar1;
  *pbVar18 = bVar20 + bVar13;
  pcVar21 = (char *)(iVar2 + (int)&stack0xfffffffc * 8);
  *pcVar21 = *pcVar21 + (char)((ushort)uVar1 >> 8) +
            (CARRY1(bVar19,(byte)uVar1) || CARRY1(bVar20,bVar13));
  out((short)((uint6)uVar15 >> 0x20),iVar17);
