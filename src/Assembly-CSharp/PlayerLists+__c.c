...

{
  ...
  pPVar1 = (PlayerLists_c *)FUN_?(TypeInfo__PlayerLists____c);
  TypeInfo__PlayerLists____c->static_fields->__9 = pPVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__PlayerLists____c->static_fields >> 0xc);
