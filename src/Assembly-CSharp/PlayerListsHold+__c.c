...
void Assembly-CSharp.dll::PlayerListsHold+<>c::PlayerListsHold_c__ReCreate_b__10_0
               (PlayerListsHold_c *this,IUIStack *x,BaseEventData *y,MethodInfo *method)
...
void Assembly-CSharp.dll::PlayerListsHold+<>c::PlayerListsHold_c__ReCreate_b__10_1
               (PlayerListsHold_c *this,IUIStack *x,BaseEventData *y,MethodInfo *method)
...
void Assembly-CSharp.dll::PlayerListsHold+<>c::PlayerListsHold_c__cctor(MethodInfo *method)

{
  ...
  pPVar1 = (PlayerListsHold_c *)FUN_?(TypeInfo__PlayerListsHold____c);
  TypeInfo__PlayerListsHold____c->static_fields->__9 = pPVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__PlayerListsHold____c->static_fields >> 0xc);
