...

{
  ...
  pCVar1 = (CloseApp_c *)FUN_?(TypeInfo__CloseApp____c);
  TypeInfo__CloseApp____c->static_fields->__9 = pCVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__CloseApp____c->static_fields >> 0xc);
