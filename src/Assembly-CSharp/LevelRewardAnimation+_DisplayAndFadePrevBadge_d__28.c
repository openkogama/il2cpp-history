...
code_?:
  bVar15 = 0;
  uVar16 = func_?();
  *(char *)(extraout_ECX + 0x40) = (char)((uint6)uVar16 >> 8);
  pbVar17 = (byte *)((int)uVar16 + 99);
  bVar18 = (byte)((uint6)uVar16 >> 0x28);
  bVar19 = *pbVar17 + bVar18;
  bVar20 = CARRY1(*pbVar17,bVar18) || CARRY1(bVar19,bVar15);
  *pbVar17 = bVar19 + bVar15;
  pbVar17 = (byte *)((int)uVar16 + 1);
  bVar19 = *pbVar17;
  bVar15 = (byte)((uint6)uVar16 >> 0x20);
  bVar18 = *pbVar17 + bVar15;
  *pbVar17 = bVar18 + bVar20;
  *(char *)&pLVar1->klass =
       *(char *)&pLVar1->klass + (char)&stack0xfffffffc +
       (CARRY1(bVar19,bVar15) || CARRY1(bVar18,bVar20));
  pcVar21 = (code *)swi(3);
  bVar22 = (*pcVar21)();
  return bVar22;
}
