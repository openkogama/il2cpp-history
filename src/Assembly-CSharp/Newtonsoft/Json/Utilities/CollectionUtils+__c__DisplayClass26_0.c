...
/* Object <CreateListWrapper>b__0(Type, IList`1[System.Object]) */

Object * Assembly-CSharp.dll::Newtonsoft::Json::Utilities::CollectionUtils+<>c__DisplayClass26_0::
         CollectionUtils_c_DisplayClass26_0__CreateListWrapper_b__0
                   (CollectionUtils_c_DisplayClass26_0 *this,Type *t,IList_1_System_Object_ *a,
                   MethodInfo *method)

{
  ...
  pTVar1 = (this->fields).listDefinition;
