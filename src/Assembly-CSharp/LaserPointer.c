...
code_?:
  bVar10 = 0;
  bVar11 = func_?();
  pbVar12 = (byte *)(unaff_EBX + -0x24ef9905);
  bVar13 = *pbVar12;
  bVar14 = *pbVar12;
  *pbVar12 = bVar14 + bVar11 + bVar10;
  *(char *)(extraout_EDX + -0x47ef9906) =
       *(char *)(extraout_EDX + -0x47ef9906) + extraout_CH +
       (CARRY1(bVar13,bVar11) || CARRY1(bVar14 + bVar11,bVar10));
  pcVar15 = (code *)swi(3);
  (*pcVar15)();
  return;
}
