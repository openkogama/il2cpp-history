...
code_?:
  uVar5 = func_?();
  pfVar6 = (float *)CONCAT31((int3)((uint)uVar5 >> 8),(char)uVar5 + '\f');
  *pfVar6 = (float)extraout_ST0;
  *pfVar6 = (float)extraout_ST0;
  *(float *)CONCAT22((short)((uint)uVar5 >> 0x10),
                     CONCAT11((char)((ushort)pfVar6 % (ushort)extraout_CH),
                              (char)((ushort)pfVar6 / (ushort)extraout_CH))) = (float)extraout_ST0;
  return;
}
