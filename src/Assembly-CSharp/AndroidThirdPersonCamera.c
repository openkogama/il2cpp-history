...

{
  ...
  (this->fields).currentDistanceToAvatar = (this->fields).currentDistanceToAvatar + fVar4;
  return;
}
...

{
  ...
  (this->fields).desiredDistanceToAvatar = (this->fields).distanceToAvatarBase * scale;
  ...
  (this->fields)._.cameraRadius = fVar1 * scale;
