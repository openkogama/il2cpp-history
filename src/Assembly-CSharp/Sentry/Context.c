...
code_?:
  bVar11 = 0;
  iVar12 = func_?();
  *(char *)&a->klass = (char)unaff_EBX;
  pbVar13 = (byte *)(iVar12 + -0x5cefb1e2);
  bVar14 = *pbVar13;
  bVar15 = *pbVar13;
  *pbVar13 = bVar15 + extraout_CL + bVar11;
  *(char *)(unaff_EBX + -0x37efb1e2) =
       *(char *)(unaff_EBX + -0x37efb1e2) + (char)((uint)iVar12 >> 8) +
       (CARRY1(bVar14,extraout_CL) || CARRY1(bVar15 + extraout_CL,bVar11));
  pcVar16 = (code *)swi(3);
  (*pcVar16)();
  return;
}
