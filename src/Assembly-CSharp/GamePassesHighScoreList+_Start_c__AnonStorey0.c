...
void Assembly-CSharp.dll::GamePassesHighScoreList+<Start>c__AnonStorey0::
     GamePassesHighScoreList_Start_c_AnonStorey0___m__0
               (GamePassesHighScoreList_Start_c_AnonStorey0 *this,IUIStack *x,BaseEventData *y,
               MethodInfo *method)
