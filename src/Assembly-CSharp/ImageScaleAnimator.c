...

{
  ...
  if (pRVar1 != (RectTransform *)0x0) {
    ...
    if (pRVar1 != (RectTransform *)0x0) {
      ...
      (this->fields).startSize.x = 0.0;
      (this->fields).startSize.y = uStack_6._4_4_;
      return;
    }
  }
  FUN_?();
...

{
  ...
  if (obj != (AnimationCurve *)0x0) {
    ...
    obj_00 = (this->fields).scaleTarget;
    if (obj_00 != (RectTransform *)0x0) {
      auStack_6[0] =
           CONCAT44(fVar3 * (this->fields).startSize.y + (this->fields).startSize.y,
                    fVar3 * (this->fields).startSize.x + (this->fields).startSize.x);
      if (cRam_? == '\0') {
        FUN_?(&
                      void__MethodInfo__UnityEngine__Object__MarshalledUnityObject__MarshalNotNull<UnityEngine::RectTransform>_UnityEngine__RectTransform_
                      ,auStack_6[0],0);
