...
{
  if (cRam_? == '\0') {
    FUN_?(&StringLiteral_regularUserVat__0___subscribedUs);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
  afStackX_8[0] = (this->fields).regularUserVat;
  arg0 = (Object *)FUN_?(uRam_?,afStackX_8);
  afStackX_8[0] = (this->fields).subscribedUserVat;
  arg1 = (Object *)FUN_?(uRam_?,afStackX_8);
  pSVar1 = StringLiteral_regularUserVat__0___subscribedUs;
