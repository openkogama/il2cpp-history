...
code_?:
        ...
        if ((String *)DStack_14._current.key != (String *)0x0) {
          if ((String__Class *)(DStack_14._current.key)->klass == pSRam0000000182db2520) {
        ...
        if ((String__Class *)pOVar16->klass == pSRam0000000182db2520) {
...
code_?:
    ...
    while (pDStack_2 !=
      ...
      if (pOStack_13 != (Object *)0x0) {
        if (pOStack_13->klass == pORam0000000182db2520) {
          item = pOStack_13;
        }
