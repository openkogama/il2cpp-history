                            ...
                            ((Component *)this_00,(MethodInfo *)0x0), pGVar4 != (GameObject *)0x0))
    {
      ...
      if ((pBVar5 != (Button *)0x0) &&
        ...
        if ((pBVar5 != (Button *)0x0) &&
          ...
          pMVar1 = MVGameControllerBase::MVGameControllerBase_get_Game((MethodInfo *)0x0);
          if (pMVar1 != (MVNetworkGame *)0x0) {
            pMVar11 = MVNetworkGame::MVNetworkGame_get_LocalPlayer(pMVar1,(MethodInfo *)0x0);
            bVar9 = (bool)((uint)iVar8 >> 0x18);
            if ((MVLocalPlayer *)player == pMVar11) {
              index = 0;
              pLVar12 = (this->fields).backgrounds;
              while (pLVar12 != (List_1_UnityEngine_UI_Image_ *)0x0) {
                bVar9 = (bool)((uint)iVar8 >> 0x18);
                player = (MVPlayer *)pMVar6;
                if ((pLVar12->fields)._size <= index) goto code_?;
                this_02 = (List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)
                          (this->fields).backgrounds;
                if (this_02 ==
