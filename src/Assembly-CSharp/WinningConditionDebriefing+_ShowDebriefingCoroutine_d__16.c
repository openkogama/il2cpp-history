...

{
    ...
    if (((this_00 != (Object__Class *)0x0) &&
      ...
      pCVar4 = UnityEngine.CoreModule.dll::UnityEngine::MonoBehaviour::
                MonoBehaviour_StartCoroutine_Auto
                          ((MonoBehaviour *)this_00,pIVar3,(MethodInfo *)0x0);
  ...
  bVar5 = 0;
  bVar6 = func_?();
  *(byte *)&this->klass = bVar6;
  pbVar7 = (byte *)((int)&unaff_ESI[-2].fields._._.m_target + 3);
  bVar8 = *pbVar7;
  bVar9 = *pbVar7 + (extraout_CL - 1U);
  *pbVar7 = bVar9 + bVar5;
  puVar10 = &this_00[-1]._1.cctor_started;
  *(char *)puVar10 =
       (char)*puVar10 + (char)this_00 +
       (CARRY1(bVar6,extraout_CL - 2U) ||
       CARRY1(bVar6 + (extraout_CL - 2U),CARRY1(bVar8,extraout_CL - 1U) || CARRY1(bVar9,bVar5)));
  pcVar11 = (code *)swi(3);
  bVar12 = (*pcVar11)();
  return bVar12;
}
