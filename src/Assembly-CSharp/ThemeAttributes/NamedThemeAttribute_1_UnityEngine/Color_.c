...

{
  ...
  if (this != (NamedThemeAttribute_1_UnityEngine_Color_ *)0x0) {
    ThemeAttribute`1[UnityEngine::Color]::ThemeAttribute_1_UnityEngine_Color__Initialize
              ((ThemeAttribute_1_UnityEngine_Color_ *)this,settings,key,groups,onChange,
