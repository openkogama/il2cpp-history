...

{
  ...
  *piVar1 = *piVar1 + (newGamePointsAmount - (this->fields).currentGamePoints);
  ...
  pfVar4 = &(this->fields).createGamePointTime;
...

{
  ...
  while (pLVar1 != (List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)0x0) {
    ...
    if (*(int *)((int)RVar2 + 0x38) == id) {
      ...
      if (pLVar3 == (List_1_GamePointGainEffect_ *)0x0) break;
      ...
      List_1_System_Object__RemoveAt
                ((List_1_System_Object_ *)pLVar3,index_00,
                 MethodInfo__System__Collections__Generic__List<GamePointGainEffect>__RemoveAt_int_)
      ;
...

{
  ...
  if (((TypeInfo__GamePassesManager->static_fields->_GamePassesActive_k__BackingField != 0) &&
      ...
      pPVar1 != (PlayerTierStateCalculator *)0x0)) &&
        ...
        if (this_00 != (RegexCharClass_SingleRange)0x0) {
          ...
          if (this_01 != (Transform *)0x0) {
            UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_set_localPosition
                      (this_01,TypeInfo__UnityEngine__Vector3->static_fields->zeroVector,
                       (MethodInfo *)0x0);
            if (cRam_? == '\0') {
              func_?();
              func_?(&
            ...
            if (pGVar3 != (GameTierProgressBar *)0x0) {
              fVar4 = (pGVar3->fields).previousProgressValue;
              if (cRam_? == '\0') {
              ...
              if (pLVar2 != (List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)0x0
                ...
                fVar5 = (float10)func_?((double)fVar4);
                iVar6 = (byte)((char)(int)fVar5 + 1) - 1;
                if (iVar6 < 0) {
                  index = 0;
                }
                else {
                ...
                if (RVar7 != (RegexCharClass_SingleRange)0x0) {
                  GamePointGainEffect::GamePointGainEffect_StartEffect
                            ((GamePointGainEffect *)this_00,*(Transform **)((int)RVar7 + 8),
                  ...
                  if (this_02 != (GameObject *)0x0) {
                    ...
                    if (pLVar1 != (List_1_GamePointGainEffect_ *)0x0) {
                      ...
                      piVar8 = &(this->fields).gamePointsToInstantiate;
                      *piVar8 = *piVar8 + -1;
                      ...
                      (this->fields).createGamePointTime = fVar9 + fVar4;
                      return;
                    }
                  }
                }
...

{
  ...
  ppLVar1 = &(this->fields).targetDataList;
  *ppLVar1 = this_00;
