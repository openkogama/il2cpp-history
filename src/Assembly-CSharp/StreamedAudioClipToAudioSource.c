...

{
  ...
  if (pAVar1 != (AudioSource *)0x0) {
    ...
    if (cVar5 == '\0') {
      ...
      bVar6 = UnityEngine.AudioModule.dll::UnityEngine::AudioSource::AudioSource_get_loop
    ...
    if (pAVar1 != (AudioSource *)0x0) {
      ...
      if (cVar5 == '\0') {
        ...
        pAVar1 = (this->fields).audioSource;
        if (pAVar1 == (AudioSource *)0x0) goto code_?;
        pAVar8 = UnityEngine.AudioModule.dll::UnityEngine::AudioSource::AudioSource_get_clip
                           (pAVar1,(MethodInfo *)0x0);
        ...
        if (pAVar8 == (AudioClip *)0x0) {
          ...
          bVar7 = (pAVar8->fields)._._.m_CachedPtr == (void *)0x0;
        }
      }
      pAVar1 = (this->fields).audioSource;
      if (pAVar1 != (AudioSource *)0x0) {
        UnityEngine.AudioModule.dll::UnityEngine::AudioSource::AudioSource_set_resource
                  (pAVar1,(AudioResource *)(this->fields)._.asset,(MethodInfo *)0x0);
        pAVar1 = (this->fields).audioSource;
        if (pAVar1 != (AudioSource *)0x0) {
          if (cRam_? == '\0') {
            FUN_?(&
