...

{
  ...
  pTVar1 = (TeamMenuQuadrant_c *)FUN_?(TypeInfo__TeamMenuQuadrant____c);
  TypeInfo__TeamMenuQuadrant____c->static_fields->__9 = pTVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__TeamMenuQuadrant____c->static_fields >> 0xc);
