...
Object * Assembly-CSharp.dll::Newtonsoft::Json::Utilities::
         ConvertUtils+<TryConvertOrCast>c__AnonStorey3`1[System::Object]::
         ConvertUtils_TryConvertOrCast_c_AnonStorey3_1_System_Object____m__0
                   (ConvertUtils_TryConvertOrCast_c_AnonStorey3_1_System_Object_ *this,
                   MethodInfo *method)

{
  ...
  ConvertUtils::ConvertUtils_TryConvertOrCast
            (pOVar1,culture,targetType,&pOStack_2,(MethodInfo *)0x0);
  pOVar1 = pOStack_2;
