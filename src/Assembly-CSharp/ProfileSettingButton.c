...
code_?:
  fVar9 = (float10)func_?(unaff_ESI,unaff_EDI);
  (unaff_EDI->_0).image = (Il2CppImage *)(int)(longlong)ROUND(fVar9);
  (unaff_EDI->_0).gc_desc = (void *)(int)((ulonglong)(longlong)ROUND(fVar9) >> 0x20);
  pcVar10 = (code *)swi(3);
  (*pcVar10)();
  return;
}
