...
void Assembly-CSharp.dll::ToggleDrawPlaneHandlerTerrain::
     ToggleDrawPlaneHandlerTerrain_ExecuteToggleState
               (ToggleDrawPlaneHandlerTerrain *this,bool toggleState,
