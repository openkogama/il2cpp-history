  ...
  if (((pGVar1 != (GizmoCap2DControllerData *)0x0) &&
    ...
    if (pGVar1 != (GizmoCap2DControllerData *)0x0) {
      ...
      if (((pGVar1 != (GizmoCap2DControllerData *)0x0) &&
        ...
        fVar7 = (pGVar6->fields)._circleRadius *
  ...
  if (pGVar1 != (GizmoCap2DControllerData *)0x0) {
    ...
    if ((pGVar2 != (GizmoCap2D *)0x0) &&
      ...
      if (pCVar3 != (CircleShape2D *)0x0) {
        ...
        pGVar1 = (this->fields)._._data;
        if (pGVar1 != (GizmoCap2DControllerData *)0x0) {
          pGVar5 = (pGVar2->fields)._transform;
          pCVar3 = (pGVar1->fields).Circle;
          if (pGVar5 != (GizmoTransform *)0x0) {
            fVar6 = (pGVar5->fields)._position2D.y;
            if (pCVar3 != (CircleShape2D *)0x0) {
              (pCVar3->fields)._center.x = (pGVar5->fields)._position2D.x;
              (pCVar3->fields)._center.y = fVar6;
              return;
            }
          }
        }
