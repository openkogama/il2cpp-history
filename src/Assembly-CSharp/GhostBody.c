...

{
  ...
  pcRam_? = pcVar2;
  fVar4 = (float)(*pcRam_?)();
  fVar4 = fVar4 / (this->fields).timeBeforeTargetRotation;
  if (fVar4 < 0.0) {
    fVar4 = 0.0;
  }
  else if (_UNK_? < fVar4) {
  ...
  return (desiredAngularRotation - fVar1) * fVar4 + fVar1;
}
...

{
  ...
  pcRam_? = pcVar3;
  fVar5 = (float)(*pcRam_?)();
  fVar5 = fVar5 / (this->fields).timeBeforeTargetRotation;
  if (fVar5 < 0.0) {
    fVar5 = 0.0;
  }
  else if (_UNK_? < fVar5) {
  ...
  (this->fields).currentAngularRotation = (fVar1 - fVar2) * fVar5 + fVar2;
  ...
  uVar4._0_4_ = (pVVar6->upVector).x;
  uVar4._4_4_ = (pVVar6->upVector).y;
  ...
  aVStack_7[0]._0_8_ = uVar4;
  aVStack_7[0].z = fVar2;
  UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_Rotate_4
            (this_00,aVStack_7,fVar5 * fVar1 * _UNK_?,Space__Enum_Self,(MethodInfo *)0x0);
  return;
}
