...
code_?:
      ...
      if (pTVar8 != (Transform *)0x0) {
        ...
        if (pCVar3 != (CameraRotationSwitchSettings *)0x0) {
          fVar13 = (pCVar3->fields)._smoothValue * fVar13;
          a.y = fStack_5;
          a.x = fVar7;
          ...
          pTVar8 = (this_00->fields)._targetTransform;
          if (pTVar8 != (Transform *)0x0) {
            fVar7 = (this->fields).targetRotation.x;
            fVar6 = (this->fields).targetRotation.y;
            fVar11 = (this->fields).targetRotation.z;
            fVar12 = (this->fields).targetRotation.w;
            pQVar9 = UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_get_rotation
                               ((Quaternion *)&stack0xffffffd8,pTVar8,(MethodInfo *)0x0);
            fVar7 = (float)((uint)(fVar6 * pQVar9->y + fVar7 * pQVar9->x + fVar11 * pQVar9->z +
                                   fVar12 * pQVar9->w) & _UNK_?);
            if (_UNK_? <= fVar7) {
              fVar7 = _UNK_?;
            }
            if (fVar7 <= _UNK_?) {
  ...
  if (pCVar3 != (CameraRotationSwitchSettings *)0x0) {
    ...
    if (pTVar8 != (Transform *)0x0) {
      ...
      if (pTVar8 != (Transform *)0x0) {
        ...
        value.y = (float)puStack_10 - (float)uVar16 * fVar6;
        value.x = fStack_5 - (float)uVar15 * fVar6;
        value.z = fVar7 - pVVar4->z * fVar6;
        UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_set_position
                  (pTVar8,value,(MethodInfo *)0x0);
        pTVar8 = (this_00->fields)._targetTransform;
        if (pTVar8 != (Transform *)0x0) {
          fVar7 = (pRVar1->fields).targetRotation.x;
          fVar6 = (pRVar1->fields).targetRotation.y;
          fVar11 = (pRVar1->fields).targetRotation.z;
          fVar12 = (pRVar1->fields).targetRotation.w;
          pQVar9 = UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_get_rotation
                             ((Quaternion *)&stack0xffffffd8,pTVar8,(MethodInfo *)0x0);
          fVar7 = (float)((uint)(fVar6 * pQVar9->y + fVar7 * pQVar9->x + fVar11 * pQVar9->z +
                                 fVar12 * pQVar9->w) & _UNK_?);
