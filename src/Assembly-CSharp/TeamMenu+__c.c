...

{
  ...
  pTVar1 = (TeamMenu_c *)FUN_?(TypeInfo__TeamMenu____c);
  TypeInfo__TeamMenu____c->static_fields->__9 = pTVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__TeamMenu____c->static_fields >> 0xc);
