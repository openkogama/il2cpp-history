...
Object * Assembly-CSharp.dll::Newtonsoft::Json::Utilities::
         CollectionUtils+<CreateListWrapper>c__AnonStorey2::
         CollectionUtils_CreateListWrapper_c_AnonStorey2___m__0
                   (CollectionUtils_CreateListWrapper_c_AnonStorey2 *this,Type *t,
