...
Object * Assembly-CSharp.dll::Newtonsoft::Json::Utilities::
         CollectionUtils+<CreateCollectionWrapper>c__AnonStorey1::
         CollectionUtils_CreateCollectionWrapper_c_AnonStorey1___m__0
                   (CollectionUtils_CreateCollectionWrapper_c_AnonStorey1 *this,Type *t,
