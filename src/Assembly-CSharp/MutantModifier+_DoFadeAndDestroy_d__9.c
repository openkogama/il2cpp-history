...

{
  ...
  if (iVar1 == 0) {
    ...
    ParticleSystem_EmissionModule_set_enabled_Injected
              ((ParticleSystem_EmissionModule *)&stack0xfffffff8,0,(MethodInfo *)0x0);
    pPVar2 = (this_00->fields).fireParticles;
    if (pPVar2 == (ParticleSystem *)0x0) goto code_?;
    UnityEngine.ParticleSystemModule.dll::UnityEngine::ParticleSystem::ParticleSystem_get_collision
              (pPVar2,(MethodInfo *)0x0);
    UnityEngine.ParticleSystemModule.dll::UnityEngine::ParticleSystem+MainModule::
    ParticleSystem_MainModule_set_loop_Injected
              ((ParticleSystem_MainModule *)&stack0xfffffff4,0,(MethodInfo *)0x0);
  }
  else {
    if (iVar1 != 1) {
      return 0;
    ...
    (this->fields).__1__state = -1;
    if (this_00 == (MutantModifier *)0x0) goto code_?;
  }
  pPVar2 = (this_00->fields).fireParticles;
