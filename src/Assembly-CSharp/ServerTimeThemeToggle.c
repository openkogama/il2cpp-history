...

{
  ...
  if (bVar1) {
    uVar2 = (uint)((ulonglong)&(this->fields)._.onChange >> 0xc);
  ...
  if ((attrib != (BoolAttribute *)0x0) && (pTVar6 = (this->fields)._.label, pTVar6 != (Text *)0x0))
  {
    ...
    if (this_00 != (SettingsToggle *)0x0) {
      SettingsToggle::SettingsToggle_Initialize
                (this_00,(attrib->fields)._._._._Key_k__BackingField,(attrib->fields)._._.value,
                 (MethodInfo *)0x0);
      pTVar6 = (this->fields)._.label;
      if (pTVar6 != (Text *)0x0) {
        pSVar7 = (String *)
                 (*(pTVar6->klass->vtable).get_text.methodPtr)
                           (pTVar6,(pTVar6->klass->vtable).get_text.method);
        bVar1 = iRam_? != 0;
        (this->fields).labelText = pSVar7;
        if (bVar1) {
          uVar2 = (uint)((ulonglong)&(this->fields).labelText >> 0xc);
          lVar3 = (ulonglong)((uVar2 & 0x1fffff) >> 6) * 8;
          do {
            uVar4 = *(ulonglong *)(lVar3 + 0xADDR);
            puVar5 = (ulonglong *)(lVar3 + 0xADDR);
        ...
        if (this == (ServerTimeThemeToggle *)0x0) {
          FUN_?();
          pcVar8 = (code *)swi(3);
          (*pcVar8)();
          return;
        }
        OVar9.m_CachedPtr = (this->fields)._._._._._._.m_CachedPtr;
        if (OVar9.m_CachedPtr == (void *)0x0) {
...

{
  ...
  DStackX_18 = mscorlib.dll::System::DateTime::DateTime_get_UtcNow((MethodInfo *)0x0);
  if (cRam_? == '\0') {
  ...
  if ((pMVar1 != (MVGameControllerBase *)0x0) &&
    ...
    dateTime = mscorlib.dll::System::DateTime::DateTime_Add_1
                         (&DStackX_18,(double)fVar2,3600000,(MethodInfo *)0x0);
    pSVar3 = StringLiteral_HH_mm_ss;
    pTVar4 = (this->fields)._.label;
    pSVar5 = (this->fields).labelText;
    if (cRam_? == '\0') {
    ...
    arg1 = mscorlib.dll::System::DateTimeFormat::DateTimeFormat_Format
                     (dateTime,pSVar3,(IFormatProvider *)0x0,(MethodInfo *)0x0);
    pSVar3 = StringLiteral__0___1_;
    ...
    mscorlib.dll::System::ParamsArray::ParamsArray__ctor_1
              (&PStack_6,(Object *)pSVar5,(Object *)arg1,(MethodInfo *)0x0);
    ...
    pSVar5 = mscorlib.dll::System::String::String_FormatHelper
                       ((IFormatProvider *)0x0,pSVar3,&PStack_7,(MethodInfo *)0x0);
    if (pTVar4 != (Text *)0x0) {
