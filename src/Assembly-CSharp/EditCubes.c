...
code_?:
                                ...
                                if (pVVar68 != (Vector3__Array *)0x0) {
                                  ...
                                  if (pVVar47->vector[0].x == 0.0) {
                                    ...
                                    VStack_28.z = (pVVar78->upVector).z + (float)pVStack_21;
                                    VStack_28.y = (float)uVar80 + (float)pVStack_23;
                                    VStack_28.x = (float)uVar79 + fVar3;
                                      ...
                                      if (pVVar67 != (Vector3__Array *)0x0) {
                                        if (*(bool *)((int)&pVVar47->vector[0].y + 1) == 0) {
                                          ...
                                          fVar84 = (pVVar67->vector[1].z + pVVar67->vector[0].z) *
                                                   _UNK_?;
                                          fStack_77 = (VStack_28.x + (float)uVar82) * _UNK_?;
                                          fVar85 = (VStack_28.y + (float)uVar83) * _UNK_?;
                                        }
                                        else {
...
code_?:
                                        pVVar68 = (Vector3__Array *)
                                                  (((float)pVStack_21 - fVar84) * _UNK_? +
                                                  fVar84);
                                        fStack_77 = (fVar3 - fStack_77) * _UNK_? + fStack_77
                                        ;
                                        pVVar76 = (Vector3__Array *)
                                                  (((float)pVStack_23 - fVar85) * _UNK_? +
                                                  fVar85);
                                        VStack_28.z = (float)pVVar68;
                                        goto code_?;
                                      }
                                      ...
                                      VStack_28.z = (pVVar78->upVector).z + fVar90;
                                      VStack_28.y = (float)uVar92 + fVar70;
                                      VStack_28.x = (float)uVar91 + fVar38;
                                      if ((TypeInfo__UnityEngine__Debug->_1).
                                          cctor_finished_or_no_cctor == 0) {
                                        func_?();
                                      }
...
code_?:
  ...
  *extraout_ECX =
       *extraout_ECX + (char)((uint)&stack0xfffffffc >> 8) +
       ((byte)(bRam_? + 0xbb + extraout_DH + (bRam_? < 0x45)) < 0x45);
  pcVar111 = (code *)swi(3);
  (*pcVar111)();
  return;
}
