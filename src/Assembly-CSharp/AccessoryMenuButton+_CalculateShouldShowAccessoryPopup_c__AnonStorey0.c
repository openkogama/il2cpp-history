...
void Assembly-CSharp.dll::AccessoryMenuButton+<CalculateShouldShowAccessoryPopup>c__AnonStorey0::
     AccessoryMenuButton_CalculateShouldShowAccessoryPopup_c_AnonStorey0___m__0
               (AccessoryMenuButton_CalculateShouldShowAccessoryPopup_c_AnonStorey0 *this,
