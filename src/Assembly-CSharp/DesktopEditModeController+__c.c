...
void Assembly-CSharp.dll::DesktopEditModeController+<>c::
     DesktopEditModeController_c__DeleteWoid_b__61_1
...

{
  ...
  value = (DesktopEditModeController_c *)func_?(TypeInfo__DesktopEditModeController____c);
  if (value != (DesktopEditModeController_c *)0x0) {
