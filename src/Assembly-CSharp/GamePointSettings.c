...
void Assembly-CSharp.dll::GamePointSettings::GamePointSettings_Initialize
               (GamePointSettings *this,int32_t woID,GameObject *root,MethodInfo *method)
        ...
        if (TVar3.m_Index != 0) {
          ...
          if (this_02 != (SettingsSlider *)0x0) {
            ...
            SettingsSlider::SettingsSlider_Initialize_1
                      (this_02,StringLiteral_gamePointAmount,value,0,1000,(MethodInfo *)0x0);
...
void Assembly-CSharp.dll::GamePointSettings::GamePointSettings_OnDestroy
               (GamePointSettings *this,MethodInfo *method)

{
  ...
  if (this_00 != (SettingsSlider *)0x0) {
    this = (GamePointSettings *)SettingsSlider::SettingsSlider_get_Value(this_00,(MethodInfo *)0x0);
    if (cRam_? == '\0') {
...
void Assembly-CSharp.dll::GamePointSettings::GamePointSettings_OnSettingChanged
               (GamePointSettings *this,String *key,Object *value,MethodInfo *method)
