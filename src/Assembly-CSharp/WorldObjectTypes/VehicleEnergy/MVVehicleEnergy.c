  ...
  if (pDVar12 != (Dictionary_2_System_Object_System_Object_ *)0x0) {
    ...
    if (pDVar12 != (Dictionary_2_System_Object_System_Object_ *)0x0) {
      ...
      if ((bVar13 != 0) && (pSStackX_10 != (String *)0x0)) {
        pSVar4 = pSVar1;
        if (pSStackX_10->klass == pSRam0000000182db2418) {
          pSVar4 = pSStackX_10;
        }
        if (pSVar4 != (String *)0x0) {
          if ((pSStackX_10->klass->_0).element_class != (pSRam0000000182db2418->_0).element_class) {
            FUN_?(pSStackX_10);
            pcVar14 = (code *)swi(3);
      ...
      if (pDVar12 != (Dictionary_2_System_Object_System_Object_ *)0x0) {
        ...
        if ((bVar13 != 0) && (pSStackX_20 != (String *)0x0)) {
          pSVar4 = pSVar1;
          if (pSStackX_20->klass == pSRam0000000182db2418) {
            pSVar4 = pSStackX_20;
          }
          if (pSVar4 != (String *)0x0) {
            if ((pSStackX_20->klass->_0).element_class != (pSRam0000000182db2418->_0).element_class)
            {
              FUN_?(pSStackX_20);
              pcVar14 = (code *)swi(3);
              pMVar15 = (MVVehicleEnergy_VehicleEnergyConfiguration *)(*pcVar14)();
        ...
        if (pDVar12 != (Dictionary_2_System_Object_System_Object_ *)0x0) {
          ...
          if ((bVar13 != 0) && (pSStack_3 != (String *)0x0)) {
            if (pSStack_3->klass == pSRam0000000182db2418) {
              pSVar1 = pSStack_3;
            }
            if (pSVar1 != (String *)0x0) {
              if ((pSStack_3->klass->_0).element_class != (pSRam0000000182db2418->_0).element_class
                 ) {
                FUN_?(pSStack_3);
                pcVar14 = (code *)swi(3);
                pMVar15 = (MVVehicleEnergy_VehicleEnergyConfiguration *)(*pcVar14)();
