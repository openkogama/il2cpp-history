...
bool Assembly-CSharp.dll::Assets::Scripts::Pickups::PickupItemCustomGun+<FetchFOV>d__51::
     PickupItemCustomGun_FetchFOV_d_51_MoveNext
               (PickupItemCustomGun_FetchFOV_d_51 *this,MethodInfo *method)
...
void Assembly-CSharp.dll::Assets::Scripts::Pickups::PickupItemCustomGun+<FetchFOV>d__51::
     PickupItemCustomGun_FetchFOV_d_51_System_Collections_IEnumerator_Reset
               (PickupItemCustomGun_FetchFOV_d_51 *this,MethodInfo *method)

{
  ...
  func_?(&
                  MethodInfo__Assets__Scripts__Pickups__PickupItemCustomGun___FetchFOV_d__51__System_Collections_IEnumerator_Reset__
                 );
  func_?(this_00);
  pcVar2 = (code *)swi(3);
  (*pcVar2)();
