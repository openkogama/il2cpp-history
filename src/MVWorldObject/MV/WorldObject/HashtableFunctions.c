...
code_?:
  ...
  this_00 = (Int32__Array__Class *)uVar11;
  pIStack_7 = this_00;
  if (this_00 == (Int32__Array__Class *)0x0) goto code_?;
  pOVar13 = key;
      ...
      if (bVar12 == 0) {
        ...
        bVar12 = UnityEngine.CoreModule.dll::Unity::Collections::LowLevel::Unsafe::UnsafeUtility::
                UnsafeUtility_EnumEquals
                          ((Int32Enum__Enum)from,(Int32Enum__Enum)pTVar15,(MethodInfo *)0x0);
        if (bVar12 == 0) {
          unaff_ESI = (Int32__Array__Class *)from;
          if ((Int32__Array__Class *)from == (Int32__Array__Class *)0x0) goto code_?;
          ...
          if (bVar12 == 0) {
            ...
            bVar12 = UnityEngine.CoreModule.dll::Unity::Collections::LowLevel::Unsafe::UnsafeUtility
                    ::UnsafeUtility_EnumEquals
                              ((Int32Enum__Enum)from,(Int32Enum__Enum)pTVar15,(MethodInfo *)0x0);
            unaff_ESI = (Int32__Array__Class *)pIVar14;
            if (bVar12 == 0) {
              func_?();
              ...
              func_?();
              unaff_ESI = (Int32__Array__Class *)func_?();
...
code_?:
        ...
        else if (this_00 == (Int32__Array__Class *)0x0) {
      ...
      pIStack_7 = (Int32__Array__Class *)TypeInfo__System__Byte;
      if (from == (Dictionary_2_System_Object_System_Object_ *)0x0) {
      ...
      pIVar20 = (Int32__Array__Class *)TypeInfo__System__Byte;
      ...
      pIVar6 = TypeInfo__System__Int32;
      pIStack_7 = TypeInfo__System__Int32;
      if ((Int32__Array__Class *)from == (Int32__Array__Class *)0x0) {
        pAStack_19 = (Array *)0x0;
        pIVar20 = pIStack_7;
      }
      else {
...
code_?:
    pIStack_7 = pIVar20;
    sourceArray = (Array *)func_?(this_00,pIStack_7);
    unaff_ESI = this_00;
    pIVar6 = pIStack_7;
  ...
  from = (Dictionary_2_System_Object_System_Object_ *)TypeInfo__System__Single;
  iVar17 = func_?(this_00,TypeInfo__System__Single);
  pIVar6 = (Int32__Array__Class *)pSVar21;
  if (iVar17 == 0) goto code_?;
  iStack_18 = *(int32_t *)(iVar17 + 0xc);
  from = (Dictionary_2_System_Object_System_Object_ *)
         func_?(TypeInfo__System__Single,iStack_18);
  pIVar6 = (Int32__Array__Class *)TypeInfo__System__Single;
  pIStack_7 = (Int32__Array__Class *)TypeInfo__System__Single;
  if ((Int32__Array__Class *)from == (Int32__Array__Class *)0x0) {
    pAStack_19 = (Array *)0x0;
  }
  else {
