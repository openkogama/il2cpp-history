...
void Assembly-CSharp.dll::AdUIWithTimeout+<PopRewardedVideo>c__AnonStorey2::
     AdUIWithTimeout_PopRewardedVideo_c_AnonStorey2___m__0
               (AdUIWithTimeout_PopRewardedVideo_c_AnonStorey2 *this,IUIStack *x,BaseEventData *y,
               MethodInfo *method)
