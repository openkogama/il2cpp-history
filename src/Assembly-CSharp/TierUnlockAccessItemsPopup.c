...
code_?:
  ...
  cVar16 = '\0';
  iVar17 = func_?();
  *(char *)&unaff_ESI->klass = *(char *)&unaff_ESI->klass + extraout_DL + cVar16;
  pbVar18 = (byte *)(extraout_ECX + 0x47 + (int)&stack0xfffffffc * 4);
  bVar19 = *pbVar18;
  bVar20 = (byte)((uint)extraout_ECX >> 8);
  *pbVar18 = *pbVar18 + bVar20;
  *(char *)(iVar17 + -0x57) = *(char *)(iVar17 + -0x57) + extraout_DL + CARRY1(bVar19,bVar20);
  pcVar21 = (code *)swi(3);
  (*pcVar21)();
  return;
}
