...
code_?:
    ...
    if (pickupItem[2].klass != (PickupItem__Class *)(pMVar5->fields).cubeModelPid) {
      return 0;
    }
    ...
    if (unaff_EDI.m_Index == 0) {
      unaff_EDI.m_Index = 0;
code_?:
      bVar8 = (*(code *)pickupItem->klass[1]._0.events)
                        (pickupItem,unaff_EDI.m_Index,pickupItem->klass[1]._0.properties);
      return bVar8;
    }
