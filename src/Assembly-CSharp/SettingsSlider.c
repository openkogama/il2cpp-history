...

{
  ...
  method_00 = TypeInfo__SettingsSlider____c__DisplayClass8_0;
  value = (Object *)func_?();
...
code_?:
      ...
      if (pSVar1 != (Slider *)0x0) {
        ...
        if (pSVar1 != (Slider *)0x0) {
          (*(code *)(pSVar1->klass->vtable).set_value.method)
                    (pSVar1,pMVar3,(pSVar1->klass->vtable).SetValueWithoutNotify.methodPtr);
          goto code_?;
        }
      }
    }
...

{
  ...
  if (pSStack_2 != (Slider *)0x0) {
    pIStack_1 = (pSStack_2->klass->vtable).set_value.methodPtr;
    fVar3 = (float10)(*(code *)(pSStack_2->klass->vtable).get_value.method)();
    return (float)fVar3;
  }
