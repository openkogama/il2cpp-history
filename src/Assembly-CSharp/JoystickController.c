...

{
  ...
  if (pJVar1 != (JoystickBase *)0x0) {
    ...
    (*(pJVar1->klass->vtable).__unknown.methodPtr)
              (pJVar1,eventData,(pJVar1->klass->vtable).__unknown.method);
    return;
  }
  FUN_?();
  pcVar2 = (code *)swi(3);
...

{
  ...
  if (this_00 != (CanvasGroup *)0x0) {
    ...
    if (pJVar1 != (JoystickBase *)0x0) {
      ...
      obj = (this->fields).startPosVisulization;
      if (eventData != (PointerEventData *)0x0) {
        ...
        uStack_3 = CONCAT44((eventData->fields)._position_k__BackingField.y,
