...

{
  ...
  pSVar1 = (SettingsBase_c *)FUN_?(TypeInfo__SettingsBase____c);
  TypeInfo__SettingsBase____c->static_fields->__9 = pSVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__SettingsBase____c->static_fields >> 0xc);
