...
code_?:
  ...
  uVar8 = func_?();
  pcVar9 = (char *)uVar8;
  pbVar10 = (byte *)(extraout_ECX + -0x5860ef9a);
  bVar11 = *pbVar10;
  bVar12 = (byte)((uint)extraout_ECX >> 8);
  bVar13 = *pbVar10 - bVar12;
  *pbVar10 = bVar13 - bVar7;
  pbVar10 = (byte *)CONCAT31((int3)((ulonglong)uVar8 >> 0x28),
                             (char)((ulonglong)uVar8 >> 0x20) * '\x02' +
                             (bVar11 < bVar12 || bVar13 < bVar7));
  bVar11 = *pbVar10;
  *pbVar10 = *pbVar10 + (byte)unaff_EBX;
  cVar14 = (char)uVar8;
  *(char *)&((Dictionary_2_System_Byte_System_Object_ *)returnCode)->klass = cVar14;
  *pcVar9 = *pcVar9 + cVar14 + CARRY1(bVar11,(byte)unaff_EBX);
