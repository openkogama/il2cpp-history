  ...
  pPVar1 = (PlayerElementHold *)
           UnityEngine.CoreModule.dll::UnityEngine::Object::Object_1_Instantiate_251
                     ((XpBoostParticlePreviewer *)pPVar1,
                      PlayerElementHold_MethodInfo__UnityEngine__Object__Instantiate<PlayerElementHold>_PlayerElementHold_
                     );
...

{
  ...
  if (this_00 != (TeamTab *)0x0) {
    ...
    (this->fields).playerElementList = (List_1_PlayerListHold_PlayerElementHoldData_ *)this_02;
    index = 0;
...

{
  ...
  while (pLVar4 != (List_1_PlayerListHold_PlayerElementHoldData_ *)0x0) {
    ...
    if ((int)pOVar5 <= iVar2) {
      if (cVar6 == '\0') {
        ...
        item.callback = (UnityAction *)playerElementHoldData.playerElement;
        item.order = playerElementHoldData.score;
    ...
    if (cVar6 == '\0') {
      ...
      PVar8 = mscorlib.dll::System::Collections::Generic::
               List`1[PlayerListHold+PlayerElementHoldData]::
               List_1_PlayerListHold_PlayerElementHoldData__get_Item
                         (pLVar4,iVar2,
                          MethodInfo__System__Collections__Generic__List<PlayerListHold::PlayerElementHoldData>__get_Item_int_
                         );
      iVar9 = playerElementHoldData.score;
      ...
      bVar10 = WinningConditionControl::WinningConditionControl_IsNewScoreBetter
                        (playerElementHoldData.score,PVar8.score,(GameStatCounterType__Enum)this,
                         (MethodInfo *)0x0);
      if (bVar10 != 0) {
        pLVar7 = (List_1_UnityEngine_BeforeRenderHelper_OrderBlock_ *)
                 (pPVar1->fields).playerElementList;
        ...
        ;
        item_00.callback = (UnityAction *)playerElementHoldData.playerElement;
        item_00.order = iVar9;
        mscorlib.dll::System::Collections::Generic::List`1[UnityEngine::
      ...
      if ((PVar8.playerElement == (PlayerElementHold *)0x0) ||
  ...
  while( true ) {
    ...
    if (this_01 == (PlayerElementHold *)0x0) break;
