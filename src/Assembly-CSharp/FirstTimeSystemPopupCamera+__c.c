...

{
  ...
  pFVar1 = (FirstTimeSystemPopupCamera_c *)FUN_?(TypeInfo__FirstTimeSystemPopupCamera____c);
  TypeInfo__FirstTimeSystemPopupCamera____c->static_fields->__9 = pFVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__FirstTimeSystemPopupCamera____c->static_fields >> 0xc);
