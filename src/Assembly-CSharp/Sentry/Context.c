...
code_?:
  bVar16 = 0;
  func_?();
  pbVar17 = (byte *)(extraout_EDX + -0x60);
  bVar18 = *pbVar17;
  bVar19 = *pbVar17;
  *pbVar17 = bVar19 + extraout_CH + bVar16;
  *(char *)(extraout_EDX + -0x60) =
       *(char *)(extraout_EDX + -0x60) + extraout_CH +
       (CARRY1(bVar18,extraout_CH) || CARRY1(bVar19 + extraout_CH,bVar16));
  pcVar20 = (code *)swi(3);
  (*pcVar20)();
  return;
}
