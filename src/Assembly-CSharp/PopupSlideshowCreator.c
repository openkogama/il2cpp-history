...
void Assembly-CSharp.dll::PopupSlideshowCreator::PopupSlideshowCreator_OnClick
               (PopupSlideshowCreator *this,MethodInfo *method)

{
  if (cRam_? == '\0') {
    ...
    UNLOCK();
    FUN_?(&
                  PopupSlideshowController_MethodInfo__UnityEngine__Object__Instantiate<PopupSlideshowController>_PopupSlideshowController_
                 );
    LOCK();
    UNLOCK();
    ...
    UNLOCK();
    FUN_?(&
                  MethodInfo__PopupSlideshowCreator____c__DisplayClass1_0___OnClick_b__0_UnityEngine__EventSystems__IUIStack__UnityEngine__EventSystems__BaseEventData_
                 );
    LOCK();
    UNLOCK();
    FUN_?(&TypeInfo__PopupSlideshowCreator____c__DisplayClass1_0);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
  object = (Object *)FUN_?(TypeInfo__PopupSlideshowCreator____c__DisplayClass1_0);
