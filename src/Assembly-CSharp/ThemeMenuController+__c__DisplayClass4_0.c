...

{
  if (cRam_? == '\0') {
    ...
    LOCK();
    UNLOCK();
    FUN_?(&MethodInfo__ThemeMenuController____c___OpenSelection_b__4_1__);
    LOCK();
    UNLOCK();
  ...
  if (this_00 != (ThemeSelection *)0x0) {
    ...
    if (TypeInfo__ThemeMenuController____c->static_fields->__9__4_1 == (UnityAction *)0x0) {
      if (*(int *)&(TypeInfo__ThemeMenuController____c->_1).field_0x1c == 0) {
        FUN_?(TypeInfo__ThemeMenuController____c);
      }
      ...
      TypeInfo__ThemeMenuController____c->static_fields->__9__4_1 = (UnityAction *)this_01;
      if (iRam_? != 0) {
        uVar1 = (uint)((ulonglong)&TypeInfo__ThemeMenuController____c->static_fields->__9__4_1 >>
                      0xc);
