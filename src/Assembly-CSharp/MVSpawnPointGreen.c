...
Assembly-CSharp.dll::MVSpawnPointGreen::MVSpawnPointGreen_get_DocumentationType
          (MVSpawnPointGreen *this,MethodInfo *method)

{
  return MVWorldObjectDocumentationType__Enum_SpawnPointGreen;
}
