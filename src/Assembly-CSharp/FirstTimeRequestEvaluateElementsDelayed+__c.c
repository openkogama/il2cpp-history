...

{
  ...
  pFVar1 = (FirstTimeRequestEvaluateElementsDelayed_c *)
           FUN_?(TypeInfo__FirstTimeRequestEvaluateElementsDelayed____c);
  TypeInfo__FirstTimeRequestEvaluateElementsDelayed____c->static_fields->__9 = pFVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__FirstTimeRequestEvaluateElementsDelayed____c->static_fields
                  >> 0xc);
