...
void Assembly-CSharp.dll::RequirementNotification+<>c__DisplayClass12_0::
     RequirementNotification_c_DisplayClass12_0__ShowGameCoinRequirement_b__0
               (RequirementNotification_c_DisplayClass12_0 *this,INotificationRequirementPanel *x,
...

{
  ...
  pRVar1 = this;
  this = (RequirementNotification_c_DisplayClass12_0 *)(this->fields).gameCoins;
