...
code_?:
  ...
  if ((this_00->fields).isUsingSM3Shader == 0) {
    pMVar4 = (this_00->fields).cubeModelMaterialSM2;
  }
  else if (bVar1 == 0) {
    pMVar4 = (this_00->fields).cubeModelMaterialSM3;
  }
  else {
  ...
  *ppMVar5 = (Material *)this;
  func_?();
  if ((this_00->fields).isUsingSM3Shader == 0) {
    method = (MethodInfo *)(this_00->fields).cubeModelMaterialSM2Transp;
  }
  else if ((this_00->fields).isUsingMobileShader == 0) {
    method = (MethodInfo *)(this_00->fields).cubeModelMaterialSM3Transp;
  }
  else {
