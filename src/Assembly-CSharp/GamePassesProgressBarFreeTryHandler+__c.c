...

{
  ...
  pGVar1 = (GamePassesProgressBarFreeTryHandler_c *)
           FUN_?(TypeInfo__GamePassesProgressBarFreeTryHandler____c);
  TypeInfo__GamePassesProgressBarFreeTryHandler____c->static_fields->__9 = pGVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__GamePassesProgressBarFreeTryHandler____c->static_fields >>
                  0xc);
