...
code_?:
  ...
  if ((int)pSVar7->max_length <= iVar8) {
    ...
    pfVar20 = (float *)func_?();
    SettingsSlider::SettingsSlider_Initialize
              (pSVar17,StringLiteral_RecoilStrength,*pfVar20,fStack_19,4.008457e-29,(MethodInfo *)0x0
              );
    ...
    pfVar20 = (float *)func_?();
    SettingsSlider::SettingsSlider_Initialize
              (pSVar17,StringLiteral_AttackCooldown,*pfVar20,4.0084428e-29,(float)pDVar2,
               (MethodInfo *)0x0);
