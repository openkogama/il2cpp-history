...
/* Void <Update>b__15_0(IEditModeController, BaseEventData) */

void Assembly-CSharp.dll::SpawnRoleEditorMenu+<>c::SpawnRoleEditorMenu_c__Update_b__15_0
...
/* Void <Update>b__15_1(IUIStack, BaseEventData) */

void Assembly-CSharp.dll::SpawnRoleEditorMenu+<>c::SpawnRoleEditorMenu_c__Update_b__15_1
...

{
  ...
  pSVar1 = (SpawnRoleEditorMenu_c *)FUN_?(TypeInfo__SpawnRoleEditorMenu____c);
  TypeInfo__SpawnRoleEditorMenu____c->static_fields->__9 = pSVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__SpawnRoleEditorMenu____c->static_fields >> 0xc);
