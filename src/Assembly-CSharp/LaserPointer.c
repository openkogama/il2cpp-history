...
code_?:
  cVar10 = '\0';
  iVar11 = func_?();
  puVar12 = (ushort *)(iVar11 + 0x66);
  sVar13 = ((ushort)unaff_EBX & 3) - (*puVar12 & 3);
  *puVar12 = *puVar12 + (ushort)(0 < sVar13) * sVar13;
  *(char *)(unaff_EBX + -0x4ef99a8) =
       *(char *)(unaff_EBX + -0x4ef99a8) + (char)((uint)iVar11 >> 8) + cVar10;
  pcVar14 = (code *)swi(3);
  (*pcVar14)();
  return;
}
