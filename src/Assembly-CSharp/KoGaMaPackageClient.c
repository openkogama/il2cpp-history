...
code_?:
  ...
  bVar14 = (byte)uVar13 & 0xf9;
  puVar15 = (ushort *)((uint)uVar13 & 0xfffffff9);
  uVar16 = (ushort)((ulonglong)uVar13 >> 0x20);
  sVar17 = (uVar16 & 3) - (*puVar15 & 3);
  *puVar15 = *puVar15 + (ushort)(0 < sVar17) * sVar17;
  sVar17 = (uVar16 & 3) - (*(ushort *)&worldObjectData->klass & 3);
  *(ushort *)&worldObjectData->klass =
       *(short *)&worldObjectData->klass + (ushort)(0 < sVar17) * sVar17;
  sVar17 = (uVar16 & 3) - (*(ushort *)&worldObjectData->klass & 3);
  *(ushort *)&worldObjectData->klass =
       *(short *)&worldObjectData->klass + (ushort)(0 < sVar17) * sVar17;
  uVar18 = (undefined2)((uint)worldObjectData >> 0x10);
  uVar19 = SUB41(worldObjectData,0);
  puVar15 = (ushort *)
            (CONCAT22(uVar18,CONCAT11(((char)bVar14 < '\0') << 7 | (0 < sVar17) << 6 | in_AF << 4 |
                                      ((POPCOUNT(bVar14) & 1U) == 0) << 2,uVar19)) | 0x200);
  puVar20 = (uint *)((int)puVar15 + iVar7 + -0x61);
  *puVar20 = *puVar20 | (uint)&stack0xffffffe4;
  puVar20 = (uint *)((int)puVar15 + iVar7 + -0x61);
  *puVar20 = *puVar20 | (uint)&stack0xffffffe4;
  puVar20 = (uint *)((int)puVar15 + iVar7 + 9);
  *puVar20 = *puVar20 | (uint)&stack0xffffffe4;
  sVar17 = (uVar16 & 3) - (*puVar15 & 3);
  *puVar15 = *puVar15 + (ushort)(0 < sVar17) * sVar17;
  do {
  ...
  *puVar15 = *puVar15 + (ushort)(0 < sVar17) * sVar17;
  puVar15 = (ushort *)
            (CONCAT22(uVar18,CONCAT11((0 < sVar17) << 6 | 0x80U | in_AF << 4,uVar19)) | 0x600);
  puVar20 = (uint *)((int)puVar15 + iVar7 + -0x61);
  *puVar20 = *puVar20 | (uint)&stack0xffffffe4;
  puVar20 = (uint *)((int)puVar15 + iVar7 + -0x61);
  *puVar20 = *puVar20 | (uint)&stack0xffffffe4;
  puVar20 = (uint *)((int)puVar15 + iVar7 + -100);
  *puVar20 = *puVar20 | (uint)&stack0xffffffe4;
  uVar21 = *puVar20;
  uVar22 = *puVar20;
  sVar17 = (uVar16 & 3) - (*puVar15 & 3);
  *puVar15 = *puVar15 + (ushort)(0 < sVar17) * sVar17;
  puVar15 = (ushort *)
            (CONCAT22(uVar18,CONCAT11(((int)uVar21 < 0) << 7 | (0 < sVar17) << 6 | in_AF << 4 |
                                      ((POPCOUNT(uVar22 & 0xff) & 1U) == 0) << 2,uVar19)) | 0x200);
  puVar20 = (uint *)((int)puVar15 + iVar7 + -0x61);
  *puVar20 = *puVar20 | (uint)&stack0xffffffe4;
  puVar20 = (uint *)((int)puVar15 + iVar7 + -0x61);
  *puVar20 = *puVar20 | (uint)&stack0xffffffe4;
  puVar20 = (uint *)((int)puVar15 + iVar7 + -0x3f);
  *puVar20 = *puVar20 | (uint)&stack0xffffffe4;
  uVar21 = *puVar20;
  uVar22 = *puVar20;
  sVar17 = (uVar16 & 3) - (*puVar15 & 3);
  *puVar15 = *puVar15 + (ushort)(0 < sVar17) * sVar17;
  puVar15 = (ushort *)
            (CONCAT22(uVar18,CONCAT11(((int)uVar21 < 0) << 7 | (0 < sVar17) << 6 | in_AF << 4 |
                                      ((POPCOUNT(uVar22 & 0xff) & 1U) == 0) << 2,uVar19)) | 0x200);
  puVar20 = (uint *)((int)puVar15 + iVar7 + -0x1a);
  *puVar20 = *puVar20 | (uint)&stack0xffffffe4;
  sVar17 = (uVar16 & 3) - (*puVar15 & 3);
  *puVar15 = *puVar15 + (ushort)(0 < sVar17) * sVar17;
  sVar17 = (uVar16 & 3) - (*puVar15 & 3);
  *puVar15 = *puVar15 + (ushort)(0 < sVar17) * sVar17;
  bVar14 = (byte)((uint)puVar15 >> 8) ^ (byte)((uint)unaff_EBX >> 8);
  puVar15 = (ushort *)CONCAT22(uVar18,CONCAT11(bVar14,uVar19));
  sVar17 = (uVar16 & 3) - (*puVar15 & 3);
  *puVar15 = *puVar15 + (ushort)(0 < sVar17) * sVar17;
  do {
    sVar17 = (uVar16 & 3) - (*puVar15 & 3);
