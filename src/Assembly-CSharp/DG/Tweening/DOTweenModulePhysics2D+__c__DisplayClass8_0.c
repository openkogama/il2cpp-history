...
void Assembly-CSharp.dll::DG::Tweening::DOTweenModulePhysics2D+<>c__DisplayClass8_0::
     DOTweenModulePhysics2D_c_DisplayClass8_0__DOLocalPath_b__1
               (DOTweenModulePhysics2D_c_DisplayClass8_0 *this,Vector3 *x,MethodInfo *method)
