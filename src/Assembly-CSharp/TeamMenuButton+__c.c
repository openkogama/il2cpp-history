...

{
  ...
  pTVar1 = (TeamMenuButton_c *)FUN_?(TypeInfo__TeamMenuButton____c);
  TypeInfo__TeamMenuButton____c->static_fields->__9 = pTVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__TeamMenuButton____c->static_fields >> 0xc);
