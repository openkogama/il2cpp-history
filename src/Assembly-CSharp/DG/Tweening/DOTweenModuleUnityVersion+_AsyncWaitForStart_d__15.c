...
void Assembly-CSharp.dll::DG::Tweening::DOTweenModuleUnityVersion+<AsyncWaitForStart>d__15::
     DOTweenModuleUnityVersion_AsyncWaitForStart_d_15_MoveNext
               (DOTweenModuleUnityVersion_AsyncWaitForStart_d_15 *this,MethodInfo *method)

{
  pDStackX_20 = this;
  if (cRam_? == '\0') {
    FUN_?(&
                  void_MethodInfo__System__Runtime__CompilerServices__AsyncTaskMethodBuilder__AwaitUnsafeOnCompleted<System::Runtime::CompilerServices::YieldAwaitable::YieldAwaiter,_DG::Tweening::DOTweenModuleUnityVersion::_AsyncWaitForStart_d__15>_System__Runtime__CompilerServices__YieldAwaitable__YieldAwaiter___DG__Tweening__DOTweenModuleUnityVersion___AsyncWaitForStart_d__15__
                 );
    LOCK();
    UNLOCK();
...
void Assembly-CSharp.dll::DG::Tweening::DOTweenModuleUnityVersion+<AsyncWaitForStart>d__15::
     DOTweenModuleUnityVersion_AsyncWaitForStart_d_15_SetStateMachine
               (DOTweenModuleUnityVersion_AsyncWaitForStart_d_15 *this,
