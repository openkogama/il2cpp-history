...

{
  ...
  pCVar2 = (CollectTheItemDropOff__Class *)0x0;
  ...
  *(undefined1 *)&(in_stack_1->vtable).get_Scale.methodPtr = 1;
  ...
  pCVar5 = (CollectTheItemDropOff__Class *)
            TypeInfo__System__Collections__Generic__Dictionary<System::Object,_System::Object>;
  if ((*(byte *)(*(int *)TVar3.m_Index + 0xb8) < bVar4) ||
     (*(Dictionary_2_System_Object_System_Object___Class **)
       (*(int *)(*(int *)TVar3.m_Index + 100) + -4 + (uint)bVar4 * 4) !=
      TypeInfo__System__Collections__Generic__Dictionary<System::Object,_System::Object>)) {
code_?:
    func_?(TVar3.m_Index,pCVar5);
code_?:
    func_?(pCVar5,pCVar2);
  }
  else {
    ...
    if (cRam_? == '\0') {
      func_?();
      ppCStack_6 = &TypeInfo__CollectTheItemDropOff;
      func_?();
      ppMStack_7 = &
...
code_?:
        ...
        pCVar2 = (CollectTheItemDropOff__Class *)TVar3.m_Index;
        if ((bVar4 <= (pMVar11->klass->_1).naturalAligment) &&
           ((CollectTheItemDropOff__Class *)(pMVar11->klass->_1).typeHierarchy[bVar4 - 1] ==
            TypeInfo__CollectTheItemDropOff)) {
          (in_stack_1->vtable).get_Rotation.method = (MethodInfo *)pMVar11;
          bVar4 = (TypeInfo__CollectTheItemDropOff->_1).naturalAligment;
          unaff_EBX = (CollectTheItemDropOff__Class *)
                      &(in_stack_1->vtable).get_Rotation.method;
          if ((bVar4 <= (pMVar11->klass->_1).naturalAligment) &&
             ((CollectTheItemDropOff__Class *)(pMVar11->klass->_1).typeHierarchy[bVar4 - 1] ==
...
code_?:
        uVar9 = func_?(pMVar11,unaff_EBX);
      }
code_?:
      func_?(uVar9);
      TVar3.m_Index = (int32_t)extraout_EDX_01;
code_?:
      func_?(TVar3.m_Index,this_01);
      TVar3.m_Index = (int32_t)extraout_EDX_02;
      pCVar5 = (CollectTheItemDropOff__Class *)unaff_ESI.m_Index;
      goto code_?;
    }
code_?:
...
code_?:
    unaff_EBX = (CollectTheItemDropOff__Class *)&(in_stack_1->vtable).get_Rotation.method;
    func_?(unaff_EBX,pMVar11);
    key = StringLiteral_CollectTheItemCollectable;
    if (cRam_? == '\0') {
      func_?(&TypeInfo__CollectTheItemCollectable);
      func_?(&TypeInfo__CollectTheItemDropOff);
      func_?(&
    ...
    if (bVar8 != 0) {
      ...
      unaff_ESI.m_Index = (int32_t)pCVar2;
      uVar9 = CONCAT44(TypeInfo__System__Int32,TVar3.m_Index);
      ...
      piVar10 = (int32_t *)func_?(TVar3.m_Index);
      TVar3.m_Index =
           (int32_t)MVWorldObjectClientManager::MVWorldObjectClientManager_GetWorldObject
                              (unaff_ESI.m_Index,*piVar10,(MethodInfo *)0x0);
      if ((MVWorldObject *)TVar3.m_Index == (MVWorldObject *)0x0) goto code_?;
      pMVar12 = ((MVWorldObject *)TVar3.m_Index)->klass;
      bVar4 = (TypeInfo__CollectTheItemDropOff->_1).naturalAligment;
      if ((pMVar12->_1).naturalAligment < bVar4) {
code_?:
        bVar4 = (TypeInfo__CollectTheItemCollectable->_1).naturalAligment;
      ...
      bVar4 = (TypeInfo__CollectTheItemCollectable->_1).naturalAligment;
      pCVar5 = (CollectTheItemDropOff__Class *)TypeInfo__CollectTheItemCollectable;
      if (((((MVWorldObject *)TVar3.m_Index)->klass->_1).naturalAligment < bVar4) ||
         (pCVar5 = (CollectTheItemDropOff__Class *)TypeInfo__CollectTheItemCollectable,
         (CollectTheItemCollectable__Class *)
         (((MVWorldObject *)TVar3.m_Index)->klass->_1).typeHierarchy[bVar4 - 1] !=
         TypeInfo__CollectTheItemCollectable)) goto code_?;
      unaff_ESI.m_Index = (int32_t)&(in_stack_1->vtable).set_Rotation;
      ((VirtualInvokeData *)unaff_ESI.m_Index)->methodPtr = (Il2CppMethodPointer)TVar3.m_Index;
      bVar4 = (TypeInfo__CollectTheItemCollectable->_1).naturalAligment;
      this_01 = (CollectTheItemDropOff__Class *)TypeInfo__CollectTheItemCollectable;
      if ((bVar4 <= (((MVWorldObject *)TVar3.m_Index)->klass->_1).naturalAligment) &&
         ((CollectTheItemCollectable__Class *)
          (((MVWorldObject *)TVar3.m_Index)->klass->_1).typeHierarchy[bVar4 - 1] ==
          TypeInfo__CollectTheItemCollectable)) goto code_?;
      goto code_?;
...
code_?:
    unaff_ESI.m_Index = (int32_t)&(in_stack_1->vtable).set_Rotation;
    func_?(unaff_ESI.m_Index,TVar3.m_Index);
    pCVar2 = *(CollectTheItemDropOff__Class **)unaff_EBX;
    if (pCVar2 != (CollectTheItemDropOff__Class *)0x0) {
      pDVar13 = (Delegate *)(pCVar2->_1).initializationExceptionGCHandle;
      ...
      ::UnityAction_2_System_Object_System_Object___ctor
                (pUVar14,(Object *)in_stack_1,
                 MethodInfo__CollectTheItem__OnDropOffPositionChanged_MVWorldObjectClient__PositionChangedEventArgs_
                 ,(MethodInfo *)0x0);
      pCVar5 = (CollectTheItemDropOff__Class *)
                mscorlib.dll::System::Delegate::Delegate_Combine
                          (pDVar13,(Delegate *)pUVar14,(MethodInfo *)0x0);
      this_01 = (CollectTheItemDropOff__Class *)
                TypeInfo__UnityEngine__Events__UnityAction<MVWorldObjectClient,_PositionChangedEventArgs>
      ;
      if (pCVar5 == (CollectTheItemDropOff__Class *)0x0) {
        this_01 = (CollectTheItemDropOff__Class *)&(pCVar2->_1).initializationExceptionGCHandle;
        *(uint32_t *)this_01 = 0;
        iVar15 = 0;
code_?:
        func_?(this_01,iVar15);
        pMVar16 = (in_stack_1->vtable).set_Rotation.method;
        this_01 = in_stack_1;
        if (pMVar16 != (MethodInfo *)0x0) {
          pCVar2 = (CollectTheItemDropOff__Class *)pMVar16->parameters;
          if (((*(MethodInfo **)unaff_EBX != (MethodInfo *)0x0) &&
              (pTVar17 = (Transform *)(*(MethodInfo **)unaff_EBX)[3].methodPointer,
              pTVar17 != (Transform *)0x0)) &&
             (pVVar18 = UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_get_position
                                  ((Vector3 *)&ppMStack_7,pTVar17,(MethodInfo *)0x0),
             pCVar2 != (CollectTheItemDropOff__Class *)0x0)) {
            UnityEngine.CoreModule.dll::UnityEngine::LineRenderer::LineRenderer_SetPosition
                      ((LineRenderer *)pCVar2,0,*pVVar18,(MethodInfo *)0x0);
            if (*(MethodInfo **)unaff_EBX != (MethodInfo *)0x0) {
              ppcVar19 = &(*(MethodInfo **)unaff_EBX)[5].name;
              *ppcVar19 = (char *)in_stack_1;
              func_?(ppcVar19,in_stack_1);
              goto code_?;
            }
          }
        }
...
code_?:
    pCVar2 = (CollectTheItemDropOff__Class *)((VirtualInvokeData *)unaff_ESI.m_Index)->methodPtr;
    if (pCVar2 == (CollectTheItemDropOff__Class *)0x0) {
      return;
    }
    pDVar13 = (Delegate *)(pCVar2->_1).initializationExceptionGCHandle;
...
code_?:
      func_?(this_01,iVar15);
      pMVar16 = (controller->vtable).set_Rotation.method;
      unaff_EBX = controller;
      if (pMVar16 != (MethodInfo *)0x0) {
        this_01 = (CollectTheItemDropOff__Class *)pMVar16->parameters;
        if (((((VirtualInvokeData *)unaff_ESI.m_Index)->methodPtr != (Il2CppMethodPointer)0x0) &&
            (pTVar17 = *(Transform **)(((VirtualInvokeData *)unaff_ESI.m_Index)->methodPtr + 0x90),
            pTVar17 != (Transform *)0x0)) &&
           (pVVar18 = UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_get_position
                                ((Vector3 *)&ppMStack_7,pTVar17,(MethodInfo *)0x0),
           this_01 != (CollectTheItemDropOff__Class *)0x0)) {
          UnityEngine.CoreModule.dll::UnityEngine::LineRenderer::LineRenderer_SetPosition
                    ((LineRenderer *)this_01,1,*pVVar18,(MethodInfo *)0x0);
          if ((CollectTheItemCollectable *)((VirtualInvokeData *)unaff_ESI.m_Index)->methodPtr !=
              (CollectTheItemCollectable *)0x0) {
            CollectTheItemCollectable::CollectTheItemCollectable_InitializeWithController
                      ((CollectTheItemCollectable *)
                       ((VirtualInvokeData *)unaff_ESI.m_Index)->methodPtr,
                       (CollectTheItem *)controller,(MethodInfo *)0x0);
            return;
          }
        }
      }
...
code_?:
      func_?(pMVar11,TypeInfo__CollectTheItemDropOff);
...
code_?:
  func_?(pCVar5,this_01);
code_?:
  func_?(pCVar5,in_stack_1);
  pcVar21 = (code *)swi(3);
  (*pcVar21)();
  return;
}
