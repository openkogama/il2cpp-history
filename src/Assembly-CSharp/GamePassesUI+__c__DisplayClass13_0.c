...
void Assembly-CSharp.dll::GamePassesUI+<>c__DisplayClass13_0::
     GamePassesUI_c_DisplayClass13_0__ShowHighScore_b__0
               (GamePassesUI_c_DisplayClass13_0 *this,IUIStack *x,BaseEventData *y,
               MethodInfo *method)
