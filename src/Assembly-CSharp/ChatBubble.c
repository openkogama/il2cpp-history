      ...
      if (pTVar1 != (Transform *)0x0) {
        ...
        if ((pCVar2 != (ChatAnchor *)0x0) &&
          ...
          if (pTVar1 != (Transform *)0x0) {
            ...
            uVar7 = pVVar3->x;
            uVar8 = pVVar3->y;
            fVar9 = (float)uVar4 - (3.5430247e-29 - (float)uVar7);
            fVar10 = SUB84(uVar4,4) - (3.5430316e-29 - (float)uVar8);
            ...
            if ((pCVar2 != (ChatAnchor *)0x0) &&
              ...
              if (pTVar1 != (Transform *)0x0) {
                ...
                uVar14 = pVVar3->x;
                uVar15 = pVVar3->y;
                fVar9 = (float)uVar13 - ((float)uVar14 + 3.5430247e-29);
                fVar10 = SUB84(uVar13,4) - ((float)uVar15 + 3.5430316e-29);
                fVar5 = fVar5 - ((float)puVar6 + pVVar3->z);
                pCVar2 = (this->fields).anchor;
                ...
                if ((pCVar2 != (ChatAnchor *)0x0) &&
                  ...
                  if (pTVar1 != (Transform *)0x0) {
                    ...
                    uVar17 = pVVar3->x;
                    uVar18 = pVVar3->y;
                    fVar10 = (float)uVar16 - (3.5430247e-29 - (float)uVar17);
                    fVar19 = SUB84(uVar16,4) - (3.5430316e-29 - (float)uVar18);
          ...
          if (pRVar2 != (RectTransform *)0x0) {
            ...
            RectTransform_SetSizeWithCurrentAnchors
                      (pRVar2,RectTransform_Axis__Enum_Vertical,
                       (fVar5 - 3.5435943e-29) + pRVar3->m_Height,(MethodInfo *)0x0);
            return 1;
          }
        }
      }
          ...
          if (pRVar3 != (RectTransform *)0x0) {
            ...
            RectTransform_SetSizeWithCurrentAnchors
                      (pRVar3,RectTransform_Axis__Enum_Horizontal,
                       ((float)&stack0xffffffd4 - 3.5436834e-29) + pRVar7->m_Width,(MethodInfo *)0x0
                      );
            ChatBubble_PerformAutoHeight(this,(MethodInfo *)0x0);
            return;
          }
          ...
          if (pRVar2 != (RectTransform *)0x0) {
            ...
            RectTransform_SetSizeWithCurrentAnchors
                      (pRVar2,RectTransform_Axis__Enum_Horizontal,
                       (fVar5 - 3.543783e-29) + pRVar3->m_Width,(MethodInfo *)0x0);
            return 1;
          }
        }
      }
...
code_?:
  func_?();
  *(char *)(extraout_EDX + 0x171033b5) =
       *(char *)(extraout_EDX + 0x171033b5) + extraout_CL +
       ((byte)((uint)extraout_EDX >> 8) < (byte)(&stack0x33b4c00c)[(int)this]);
  pcVar13 = (code *)swi(3);
  (*pcVar13)();
  return;
}
