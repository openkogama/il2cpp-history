...
void Assembly-CSharp.dll::InGameMenu+<OnEnable>c__AnonStorey0::
     InGameMenu_OnEnable_c_AnonStorey0___m__0
               (InGameMenu_OnEnable_c_AnonStorey0 *this,IUIStack *x,BaseEventData *y,
               MethodInfo *method)
