...
void Assembly-CSharp.dll::FirstTimeActivatableEditToolPopup+<Update>c__AnonStorey1::
     FirstTimeActivatableEditToolPopup_Update_c_AnonStorey1___m__0
               (FirstTimeActivatableEditToolPopup_Update_c_AnonStorey1 *this,IUIStack *x,
