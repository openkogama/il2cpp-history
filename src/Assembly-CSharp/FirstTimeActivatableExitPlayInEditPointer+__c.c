...

{
  ...
  pFVar1 = (FirstTimeActivatableExitPlayInEditPointer_c *)
           FUN_?(TypeInfo__FirstTimeActivatableExitPlayInEditPointer____c);
  TypeInfo__FirstTimeActivatableExitPlayInEditPointer____c->static_fields->__9 = pFVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)
                   TypeInfo__FirstTimeActivatableExitPlayInEditPointer____c->static_fields >> 0xc);
