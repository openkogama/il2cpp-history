...

{
  ...
  case Face__Enum_Top:
    ...
    bVar5 = 0;
    cVar6 = '\0';
    cVar2 = (int)pVVar4->max_length < 0;
    uVar3 = 1;
    if (pVVar4->max_length == 0) goto code_?;
    bVar5 = 0;
    cVar6 = '\0';
    cVar2 = (int)pVVar1->max_length < 0;
    fVar7 = pVVar4->vector[0].y;
    fVar8 = pVVar4->vector[0].z;
    uVar3 = 1;
    if (pVVar1->max_length == 0) goto code_?;
    pVVar1->vector[0].x = pVVar4->vector[0].x;
    pVVar1->vector[0].y = fVar7;
    pVVar1->vector[0].z = fVar8;
    pVVar1 = *faceVertices;
    cVar2 = (int)pVVar1 < 0;
    uVar3 = true;
    if (pVVar1 == (Vector3__Array *)0x0) goto code_?;
    ...
    uVar3 = true;
    if (pVVar4 == (Vector3__Array *)0x0) goto code_?;
    uVar9._4_4_ = pVVar4->max_length;
    bVar5 = uVar9._4_4_ == 0;
    cVar6 = SBORROW4(uVar9._4_4_,1);
    cVar2 = (int)(uVar9._4_4_ - 1) < 0;
    uVar3 = uVar9._4_4_ == 1;
    if (uVar9._4_4_ < 2) goto code_?;
    uVar9._4_4_ = pVVar1->max_length;
    bVar5 = uVar9._4_4_ == 0;
    cVar6 = SBORROW4(uVar9._4_4_,1);
    cVar2 = (int)(uVar9._4_4_ - 1) < 0;
    uVar3 = uVar9._4_4_ == 1;
    ...
    if (uVar9._4_4_ < 2) goto code_?;
    pVVar1->vector[1].x = pVVar4->vector[1].x;
    pVVar1->vector[1].y = fVar7;
    pVVar1->vector[1].z = fVar8;
    pVVar1 = *faceVertices;
    cVar2 = (int)pVVar1 < 0;
    uVar3 = true;
    if (pVVar1 == (Vector3__Array *)0x0) goto code_?;
    ...
    uVar9._4_4_ = pVVar4->max_length;
    bVar5 = uVar9._4_4_ < 2;
    cVar6 = SBORROW4(uVar9._4_4_,2);
    cVar2 = (int)(uVar9._4_4_ - 2) < 0;
    uVar3 = uVar9._4_4_ == 2;
    if (uVar9._4_4_ < 3) goto code_?;
    uVar9._4_4_ = pVVar1->max_length;
    bVar5 = uVar9._4_4_ < 2;
    cVar6 = SBORROW4(uVar9._4_4_,2);
    cVar2 = (int)(uVar9._4_4_ - 2) < 0;
    ...
    if (uVar9._4_4_ < 3) goto code_?;
    pVVar1->vector[2].x = pVVar4->vector[2].x;
    pVVar1->vector[2].y = fVar7;
    pVVar1->vector[2].z = fVar8;
    pVVar1 = *faceVertices;
    cVar2 = (int)pVVar1 < 0;
    uVar3 = true;
    if (pVVar1 == (Vector3__Array *)0x0) goto code_?;
    ...
    uVar9._4_4_ = pVVar4->max_length;
    bVar5 = uVar9._4_4_ < 3;
    cVar6 = SBORROW4(uVar9._4_4_,3);
    cVar2 = (int)(uVar9._4_4_ - 3) < 0;
    uVar3 = uVar9._4_4_ == 3;
    if (uVar9._4_4_ < 4) goto code_?;
    uVar9._0_4_ = pVVar4->vector[3].x;
    uVar9._4_4_ = pVVar4->vector[3].y;
  ...
  case Face__Enum_Bottom:
    ...
    uVar9._4_4_ = pVVar4->max_length;
    bVar5 = uVar9._4_4_ < 4;
    cVar6 = SBORROW4(uVar9._4_4_,4);
    cVar2 = (int)(uVar9._4_4_ - 4) < 0;
    uVar3 = uVar9._4_4_ == 4;
    if (uVar9._4_4_ < 5) goto code_?;
    bVar5 = 0;
    cVar6 = '\0';
    cVar2 = (int)pVVar1->max_length < 0;
    fVar7 = pVVar4->vector[4].y;
    fVar8 = pVVar4->vector[4].z;
    uVar3 = 1;
    if (pVVar1->max_length == 0) goto code_?;
    pVVar1->vector[0].x = pVVar4->vector[4].x;
    pVVar1->vector[0].y = fVar7;
    pVVar1->vector[0].z = fVar8;
    pVVar1 = *faceVertices;
    cVar2 = (int)pVVar1 < 0;
    ...
    uVar9._4_4_ = pVVar4->max_length;
    bVar5 = uVar9._4_4_ < 5;
    cVar6 = SBORROW4(uVar9._4_4_,5);
    cVar2 = (int)(uVar9._4_4_ - 5) < 0;
    uVar3 = uVar9._4_4_ == 5;
    if (uVar9._4_4_ < 6) goto code_?;
    uVar9._4_4_ = pVVar1->max_length;
    bVar5 = uVar9._4_4_ == 0;
    cVar6 = SBORROW4(uVar9._4_4_,1);
    cVar2 = (int)(uVar9._4_4_ - 1) < 0;
    uVar3 = uVar9._4_4_ == 1;
    fVar7 = pVVar4->vector[5].y;
    fVar8 = pVVar4->vector[5].z;
    if (uVar9._4_4_ < 2) goto code_?;
    pVVar1->vector[1].x = pVVar4->vector[5].x;
    pVVar1->vector[1].y = fVar7;
    pVVar1->vector[1].z = fVar8;
    pVVar1 = *faceVertices;
    cVar2 = (int)pVVar1 < 0;
    ...
    uVar9._4_4_ = pVVar4->max_length;
    bVar5 = uVar9._4_4_ < 6;
    cVar6 = SBORROW4(uVar9._4_4_,6);
    cVar2 = (int)(uVar9._4_4_ - 6) < 0;
    uVar3 = uVar9._4_4_ == 6;
    if (uVar9._4_4_ < 7) goto code_?;
    uVar9._4_4_ = pVVar1->max_length;
    bVar5 = uVar9._4_4_ < 2;
    cVar6 = SBORROW4(uVar9._4_4_,2);
    cVar2 = (int)(uVar9._4_4_ - 2) < 0;
    uVar3 = uVar9._4_4_ == 2;
    fVar7 = pVVar4->vector[6].y;
    fVar8 = pVVar4->vector[6].z;
    if (uVar9._4_4_ < 3) goto code_?;
    pVVar1->vector[2].x = pVVar4->vector[6].x;
    pVVar1->vector[2].y = fVar7;
    pVVar1->vector[2].z = fVar8;
    pVVar1 = *faceVertices;
    cVar2 = (int)pVVar1 < 0;
    ...
    uVar9._4_4_ = pVVar4->max_length;
    bVar5 = uVar9._4_4_ < 7;
    cVar6 = SBORROW4(uVar9._4_4_,7);
    cVar2 = (int)(uVar9._4_4_ - 7) < 0;
    uVar3 = uVar9._4_4_ == 7;
    if (uVar9._4_4_ < 8) goto code_?;
    uVar9._0_4_ = pVVar4->vector[7].x;
    uVar9._4_4_ = pVVar4->vector[7].y;
  ...
  case Face__Enum_Front:
    ...
    cVar6 = '\0';
    cVar2 = (int)pVVar1->max_length < 0;
    fVar7 = pVVar4->vector[7].y;
    fVar8 = pVVar4->vector[7].z;
    uVar3 = 1;
    if (pVVar1->max_length == 0) goto code_?;
    pVVar1->vector[0].x = pVVar4->vector[7].x;
    pVVar1->vector[0].y = fVar7;
    pVVar1->vector[0].z = fVar8;
    pVVar1 = *faceVertices;
    cVar2 = (int)pVVar1 < 0;
    ...
    fVar8 = pVVar4->vector[6].z;
    if (uVar9._4_4_ < 2) goto code_?;
    pVVar1->vector[1].x = pVVar4->vector[6].x;
    pVVar1->vector[1].y = fVar7;
    pVVar1->vector[1].z = fVar8;
    pVVar1 = *faceVertices;
    cVar2 = (int)pVVar1 < 0;
    ...
    fVar8 = pVVar4->vector[1].z;
    if (uVar9._4_4_ < 3) goto code_?;
    pVVar1->vector[2].x = pVVar4->vector[1].x;
    pVVar1->vector[2].y = fVar7;
    pVVar1->vector[2].z = fVar8;
    pVVar1 = *faceVertices;
    cVar2 = (int)pVVar1 < 0;
    ...
    uVar3 = 1;
    if (pVVar4->max_length == 0) goto code_?;
    uVar9._0_4_ = pVVar4->vector[0].x;
    uVar9._4_4_ = pVVar4->vector[0].y;
    fVar8 = pVVar4->vector[0].z;
    break;
  case Face__Enum_Back:
    pVVar1 = *faceVertices;
    ...
    uVar3 = 1;
    if (pVVar1->max_length == 0) goto code_?;
    pVVar1->vector[0].x = pVVar4->vector[5].x;
    pVVar1->vector[0].y = fVar7;
    pVVar1->vector[0].z = fVar8;
    pVVar1 = *faceVertices;
    cVar2 = (int)pVVar1 < 0;
    ...
    fVar8 = pVVar4->vector[4].z;
    if (uVar9._4_4_ < 2) goto code_?;
    pVVar1->vector[1].x = pVVar4->vector[4].x;
    pVVar1->vector[1].y = fVar7;
    pVVar1->vector[1].z = fVar8;
    pVVar1 = *faceVertices;
    cVar2 = (int)pVVar1 < 0;
    ...
    fVar8 = pVVar4->vector[3].z;
    if (uVar9._4_4_ < 3) goto code_?;
    pVVar1->vector[2].x = pVVar4->vector[3].x;
    pVVar1->vector[2].y = fVar7;
    pVVar1->vector[2].z = fVar8;
    pVVar1 = *faceVertices;
    cVar2 = (int)pVVar1 < 0;
    ...
    uVar3 = uVar9._4_4_ == 2;
    if (uVar9._4_4_ < 3) goto code_?;
    uVar9._0_4_ = pVVar4->vector[2].x;
    uVar9._4_4_ = pVVar4->vector[2].y;
    fVar8 = pVVar4->vector[2].z;
    break;
  case Face__Enum_Left:
    pVVar1 = *faceVertices;
    ...
    fVar8 = pVVar4->vector[7].z;
    if (uVar9._4_4_ < 2) goto code_?;
    pVVar1->vector[1].x = pVVar4->vector[7].x;
    pVVar1->vector[1].y = fVar7;
    pVVar1->vector[1].z = fVar8;
    pVVar1 = *faceVertices;
    cVar2 = (int)pVVar1 < 0;
    ...
    fVar8 = pVVar4->vector[0].z;
    if (uVar9._4_4_ < 3) goto code_?;
    pVVar1->vector[2].x = pVVar4->vector[0].x;
    pVVar1->vector[2].y = fVar7;
    pVVar1->vector[2].z = fVar8;
    pVVar1 = *faceVertices;
    cVar2 = (int)pVVar1 < 0;
  ...
  case Face__Enum_Right:
    pVVar1 = *faceVertices;
    cVar2 = (int)pVVar1 < 0;
    uVar3 = pVVar1 == (Vector3__Array *)0x0;
    if (!(bool)uVar3) {
      pVVar4 = *corners;
      cVar2 = (int)pVVar4 < 0;
      uVar3 = pVVar4 == (Vector3__Array *)0x0;
      if (!(bool)uVar3) {
        uVar9._4_4_ = pVVar4->max_length;
        bVar5 = uVar9._4_4_ < 6;
        cVar6 = SBORROW4(uVar9._4_4_,6);
        ...
        uVar3 = 1;
        if (pVVar1->max_length == 0) goto code_?;
        pVVar1->vector[0].x = pVVar4->vector[6].x;
        pVVar1->vector[0].y = fVar7;
        pVVar1->vector[0].z = fVar8;
        pVVar1 = *faceVertices;
        cVar2 = (int)pVVar1 < 0;
...
code_?:
  ...
  while( true ) {
    ...
    cVar2 = (int)(uVar9._4_4_ - 3) < 0;
    uVar3 = uVar9._4_4_ == 3;
    if (3 < uVar9._4_4_) break;
code_?:
    pVVar4 = unaff_EDI;
    uVar9 = func_?();
    uVar9._4_4_ = (uint)((ulonglong)uVar9 >> 0x20);
    unaff_EDI = (Vector3__Array *)uVar9;
    if ((bool)uVar3 || cVar6 != cVar2) {
      pfVar10 = &pVVar4[-1].vector[0x15].y;
      bVar11 = *(byte *)pfVar10;
      bVar12 = (byte)((ulonglong)uVar9 >> 0x28);
      bVar13 = *(char *)pfVar10 + bVar12;
      *(byte *)pfVar10 = bVar13 + bVar5;
      uVar14 = 0;
      if (*(int *)(unaff_EBP + 0xc) == 0) goto code_?;
      uVar15 = *(uint *)(*(int *)(unaff_EBP + 0xc) + 0xc);
      goto code_?;
    }
    pVVar4->vector[1].x = extraout_MM0_Da;
    pVVar1 = extraout_ECX;
code_?:
    uVar9._0_4_ = pVVar4->vector[1].x;
    uVar9._4_4_ = pVVar4->vector[1].y;
    fVar8 = pVVar4->vector[1].z;
  }
  pVVar1->vector[3].x = (float)(int)uVar9;
  pVVar1->vector[3].y = (float)(int)((ulonglong)uVar9 >> 0x20);
  pVVar1->vector[3].z = fVar8;
code_?:
  return;
code_?:
...
code_?:
      func_?(unaff_EDI,faceVertices,
                      (char)unaff_EBX + (char)((uint)unaff_EBX >> 8) +
                      (uVar9._4_4_ < 0xda822210 ||
                      uVar9._4_4_ + 0x257dddf0 <
                      (uint)(CARRY1(bVar11,bVar12) || CARRY1(bVar13,bVar5))),&stack0xfffffffc);
    }
    else {
      uVar9._4_4_ = *(uint *)(*(int *)(unaff_EBP + 0x10) + 0xc);
      while( true ) {
        if ((int)uVar9._4_4_ <= (int)uVar14) {
          return;
        }
        if (uVar9._4_4_ <= uVar14) break;
        uVar14 = uVar14 + 1;
      }
    }
code_?:
...

{
  if (cRam_? == '\0') {
    ...
    func_?(&__method0x60003ed_1_Field);
    cRam_? = '\x01';
  }
  array = (Byte__Array *)func_?(TypeInfo__System__Byte,8);
  mscorlib.dll::System::Runtime::CompilerServices::RuntimeHelpers::RuntimeHelpers_InitializeArray_1
            ((Array *)array,___method0x60003ed_1_Field,(MethodInfo *)0x0);
