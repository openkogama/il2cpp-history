    ...
    if (pMVar3 != (MVWorldObject *)0x0) {
      ...
      if ((bVar4 <= (pMVar3->klass->_1).naturalAligment) &&
        ...
        edge = Cube::Cube_GetEdge_1
                         ((GameObject *)pLVar5,voxelHit.cube,voxelHit.face,voxelHit.point,
                          voxelHit.cubePos,(MethodInfo *)0x0);
        pLVar5 = pMVar3[1].fields.inputLinkRefs;
        pVVar7 = (Vector3__Array *)voxelHit.cube;
        edge_00 = Cube::Cube_GetEdgeVerticesWorld
                            ((GameObject *)pLVar5,voxelHit.cube,voxelHit.face,edge,voxelHit.cubePos
                             ,(MethodInfo *)0x0);
        if (edge_00 != (Vector3__Array *)0x0) {
          if ((edge_00->max_length == 0) || (edge_00->max_length < 2)) {
            ...
            puVar8 = &UNK_?;
            point.z._0_2_ = SUB42(fVar6,0);
            point.x = (float)(int)voxelHit.point._0_8_;
            point.y = (float)(int)((ulonglong)voxelHit.point._0_8_ >> 0x20);
            point.z._2_2_ = (short)((uint)fVar6 >> 0x10);
            bVar9 = MathFunctions::MathFunctions_DistancePointLine
                              (point,edge_00->vector[0],edge_00->vector[1],(float *)&stack0xffffffd4
                               ,(MethodInfo *)0x0);
            pIVar10 = TypeRef__MV__WorldObject__Face;
            if ((bVar9 == 0) || (maxDistanceToEdge <= fVar2)) goto code_?;
            ...
            pAVar12 = mscorlib.dll::System::Enum::Enum_GetValues(pTVar11,(MethodInfo *)0x0);
            if (pAVar12 != (Array *)0x0) {
              pIVar13 = mscorlib.dll::System::Array::Array_GetEnumerator(pAVar12,(MethodInfo *)0x0);
              uVar14 = SUB42(pIVar13,0);
              uStack_15 = (undefined2)((uint)pIVar13 >> 0x10);
              piVar16 = (int *)&stack0xffffffd0;
              uVar17 = voxelHit._28_4_;
              iVar18 = voxelHit.cubePos.y;
              method_01 = (MethodInfo *)voxelHit.normal.y;
              fVar2 = voxelHit.normal.z;
              iVar19 = voxelHit.cubePos.x;
              iVar20 = voxelHit.face;
              uVar21 = voxelHit._36_4_;
              iVar22 = voxelHit.woId;
              pCVar23 = voxelHit.cube;
              fVar6 = voxelHit.distance;
              pCVar24 = voxelHit.collider;
              pTVar25 = voxelHit.transform;
              while (CONCAT22(uStack_15,uVar14) != 0) {
                uVar14 = SUB42(TypeInfo__System__Collections__IEnumerator,0);
                uStack_15 = (undefined2)((uint)TypeInfo__System__Collections__IEnumerator >> 0x10);
                cVar26 = func_?();
                if (cVar26 == '\0') {
                  iVar27 = func_?();
                  *piVar16 = iVar27;
                ...
                if (method_00 != (MethodInfo *)voxelHit.face) {
                  ...
                  pAVar12 = mscorlib.dll::System::Enum::Enum_GetValues(pTVar11,(MethodInfo *)0x0);
                  if (pAVar12 == (Array *)0x0) break;
                  pIVar13 = mscorlib.dll::System::Array::Array_GetEnumerator
                                     (pAVar12,(MethodInfo *)0x0);
                  while( true ) {
                    if (pIVar13 == (IEnumerator *)0x0) goto code_?;
                    uVar14 = SUB42(TypeInfo__System__Collections__IEnumerator,0);
                    uStack_15 = (undefined2)
                                ((uint)TypeInfo__System__Collections__IEnumerator >> 0x10);
                    cVar26 = func_?();
                    if (cVar26 == '\0') break;
                    if (pIVar13 == (IEnumerator *)0x0) goto code_?;
                    this_00 = (MVCubeModelBase *)0x1;
                    pIVar13 = (IEnumerator *)func_?();
                    if (pIVar13 == (IEnumerator *)0x0) goto code_?;
                    if ((pIVar13->klass->_0).element_class != (TypeInfo__Edge->_0).element_class)
                    goto code_?;
                    puVar29 = (undefined4 *)func_?();
                    face = (List_1_MV_WorldObject_Link_ *)*puVar29;
                    if (face != (List_1_MV_WorldObject_Link_ *)0x0) {
                      puVar32 = (undefined *)0x0;
                      voxelHit_00.normal.z._2_2_ = iVar18;
                      voxelHit_00.normal.z._0_2_ = iVar19;
                      voxelHit_00.point.y = (float)pVVar7;
                      voxelHit_00.point.x = (float)pLVar5;
                      voxelHit_00.point.z = (float)puVar8;
                      voxelHit_00.normal.x = (float)method_01;
                      voxelHit_00.normal.y = fVar2;
                      voxelHit_00.cubePos.x = (short)uVar17;
                      voxelHit_00.cubePos.y = (short)((uint)uVar17 >> 0x10);
                      voxelHit_00._28_4_ = iVar20;
                      voxelHit_00.face = uVar21;
                      voxelHit_00._36_4_ = iVar22;
                      voxelHit_00.woId = (int32_t)pCVar23;
                      voxelHit_00.cube = (Cube *)fVar6;
                      voxelHit_00.distance = (float)pCVar24;
                      voxelHit_00.collider = (Collider *)pTVar25;
                      ...
                      pVVar7 = edge_00;
                      iVar33 = PickupItemCubeGun_GetEdgeVertexMatchCount
                      ...
                      if (iVar33 == 2) {
                        ...
                        IVar34.z = voxelHit.cubePos.x;
                        IVar34._0_4_ = &stack0xffffff60;
                        IVar34 = Cube::Cube_GetCubePosAboveFace
                                           (IVar34,CONCAT22((short)((uint)wo >> 0x10),
                                                            voxelHit.cubePos.z),method_00);
                        pIVar35 = IVar34._0_4_;
                        iVar18 = pIVar35->y;
                        iVar19 = pIVar35->z;
                        IVar34 = *pIVar35;
                        pos->x = pIVar35->x;
                  ...
                  func_?();
                  piVar16 = (int *)CONCAT22(uVar31,uVar30);
                }
              }
            }
          }
...
joined_?:
    ...
    if (*(Il2CppClass **)(*(int *)TVar10.m_Index + 0x20) ==
      ...
      *(undefined1 *)((int)this + 0x100) = *puVar11;
