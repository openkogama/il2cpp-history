...

{
  ...
  cVar16 = func_?();
  *(char *)&this_03->klass = *(char *)&this_03->klass + cVar16 + cVar3;
  pcVar17 = (code *)swi(3);
  (*pcVar17)();
  return;
}
...

{
  ...
  *(undefined1 *)((int)&unaff_EDI->klass + 1) = uVar8;
  pbVar9 = (byte *)((int)&stack0x00000000 * 3 + 0x36);
  bVar10 = *pbVar9 + (byte)extraout_ECX;
  bVar11 = CARRY1(*pbVar9,(byte)extraout_ECX) || CARRY1(bVar10,bVar3);
  *pbVar9 = bVar10 + bVar3;
  pbVar9 = (byte *)(extraout_ECX + 0x6c);
  bVar3 = *pbVar9;
  bVar12 = (byte)extraout_DX;
  bVar10 = *pbVar9;
  *pbVar9 = bVar10 + bVar12 + bVar11;
  ppSVar13 = &pTVar1[1].fields.buttonTeamRed;
  *(byte *)ppSVar13 =
       *(char *)ppSVar13 + bVar12 + (CARRY1(bVar3,bVar12) || CARRY1(bVar10 + bVar12,bVar11));
  pcVar14 = (code *)swi(3);
  (*pcVar14)();
  return;
}
