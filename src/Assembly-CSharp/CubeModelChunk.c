...
code_?:
      ...
      *(char *)(extraout_EDX + -0x5defa85d) =
           *(char *)(extraout_EDX + -0x5defa85d) + (char)((uint)uRam_? >> 8) +
           (CARRY1((byte)unaff_EBX,bVar13) || CARRY1((byte)unaff_EBX + bVar13,bVar6));
      pcVar14 = (code *)swi(3);
      pVStack7 = pVVar2;
      (*pcVar14)();
      return;
...

{
  ...
  if (pVVar4 == (Vector3__Array *)0x0) {
    ...
    while( true ) {
      ...
      bVar5 = pfVar3 < (float *)pVVar4->max_length;
      if (!(bool)bVar5) break;
  ...
  bVar10 = *(byte *)iVar9;
  cVar11 = *(char *)iVar9;
  *(byte *)iVar9 = cVar11 + extraout_CL + bVar5;
  *(char *)((int)pfVar3 + -0x57) =
       *(char *)((int)pfVar3 + -0x57) + (char)pVVar4 +
       (CARRY1(bVar10,extraout_CL) || CARRY1(cVar11 + extraout_CL,bVar5));
  pcVar12 = (code *)swi(3);
...
code_?:
  ...
  bVar10 = bVar9 - *(byte *)(iVar8 + -0x46ecefa9);
  bVar11 = bVar9 < *(byte *)(iVar8 + -0x46ecefa9) || bVar10 < bVar4;
  pbVar12 = (byte *)(extraout_ECX + -0x46);
  bVar9 = *pbVar12;
  bVar13 = *pbVar12;
  *pbVar12 = bVar13 + extraout_DL + bVar11;
  bVar11 = CARRY1(bStackY_49,(byte)iVar8) ||
           CARRY1(bStackY_49 + (byte)iVar8,
                  CARRY1(bVar9,extraout_DL) || CARRY1(bVar13 + extraout_DL,bVar11));
  pbVar12 = (byte *)(extraout_ECX + -0x44);
  bVar9 = *pbVar12;
  bVar14 = (byte)((uint)iVar8 >> 8);
  bVar13 = *pbVar12 + bVar14;
  *pbVar12 = bVar13 + bVar11;
  pcVar15 = (char *)(CONCAT22((short)((uint)unaff_EBX >> 0x10),
                             CONCAT11(bVar10 - bVar4,(char)unaff_EBX)) + -0x43);
  *pcVar15 = *pcVar15 + (char)((uint)extraout_ECX >> 8) +
            (CARRY1(bVar9,bVar14) || CARRY1(bVar13,bVar11));
  pcVar16 = (code *)swi(3);
  pVVar3 = (Vector2__Array *)(*pcVar16)();
  return pVVar3;
}
