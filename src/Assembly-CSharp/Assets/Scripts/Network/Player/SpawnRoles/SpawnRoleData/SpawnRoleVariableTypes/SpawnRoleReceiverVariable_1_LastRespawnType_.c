...
/* Void set_Value(LastRespawnType) */

void Assembly-CSharp.dll::Assets::Scripts::Network::Player::SpawnRoles::SpawnRoleData::
     SpawnRoleVariableTypes::SpawnRoleReceiverVariable`1[LastRespawnType]::
     SpawnRoleReceiverVariable_1_LastRespawnType__set_Value
               (SpawnRoleReceiverVariable_1_LastRespawnType_ *this,LastRespawnType__Enum value,
               MethodInfo *method)

{
  ...
  if (this_00 != (SpawnRoleDataReceiver *)0x0) {
    ...
    if ((this->fields).subscribableVariable != (SubscribableVariable_1_LastRespawnType_ *)0x0) {
