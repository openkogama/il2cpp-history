...

{
  ...
  pAVar1 = (AccessoryViewController_c *)FUN_?(TypeInfo__AccessoryViewController____c);
  TypeInfo__AccessoryViewController____c->static_fields->__9 = pAVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__AccessoryViewController____c->static_fields >> 0xc);
