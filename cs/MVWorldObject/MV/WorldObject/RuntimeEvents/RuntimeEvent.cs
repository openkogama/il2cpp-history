...
namespace MV.WorldObject.RuntimeEvents
{
	public abstract class RuntimeEvent
	{
		...
		[CompilerGenerated]
		private RuntimeEventType _RuntimeEventType_k__BackingField;
	
		// Properties
		public RuntimeEventType RuntimeEventType { [CompilerGenerated] get; [CompilerGenerated] protected set; }
