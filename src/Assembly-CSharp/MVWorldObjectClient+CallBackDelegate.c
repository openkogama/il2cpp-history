...
/* Void Invoke(MVWorldObjectClient) */

void Assembly-CSharp.dll::MVWorldObjectClient+CallBackDelegate::
     MVWorldObjectClient_CallBackDelegate_Invoke
               (MVWorldObjectClient_CallBackDelegate *this,MVWorldObjectClient *woc,
               MethodInfo *method)

{
  this_00 = (MVWorldObjectClient_CallBackDelegate *)(this->fields)._.prev;
  if (this_00 != (MVWorldObjectClient_CallBackDelegate *)0x0) {
    MVWorldObjectClient_CallBackDelegate_Invoke(this_00,woc,method);
  }
...
code_?:
    (*(code *)pMVar1)(pOVar2,woc,this_01);
    return;
  }
  if (cVar6 == '\x01') {
    if (((this_01->flags == 0xffff) ||
    ...
    if (pOVar2 != (Object *)0x0) {
      ...
      if (cVar6 == '\0') {
        if (cVar5 == '\0') {
          func_?(this_01->flags,pOVar2,woc);
          return;
        }
        pIVar8 = (Il2CppClass *)
...
code_?:
        (*(code *)*ppMVar12)(pOVar2,woc,ppMVar12[1]);
        return;
      }
...
code_?:
      ...
      (*(code *)*puVar15)(pOVar2,woc,puVar15);
      return;
    }
  }
    ...
    func_?(this_01->flags,woc);
    return;
  }
  (*(code *)pMVar1)(woc,this_01);
  return;
}
