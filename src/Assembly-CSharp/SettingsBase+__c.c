...
/* Void <Initialize>b__4_0(IUIStack, BaseEventData) */

void Assembly-CSharp.dll::SettingsBase+<>c::SettingsBase_c__Initialize_b__4_0
...

{
  ...
  if (handler != (IUIStack *)0x0) {
    ppIStack_1 = (IUIStack__Class **)0x10;
    pIStack_2 = handler;
...
/* Void <Initialize>b__5_0(IUIStack, BaseEventData) */

void Assembly-CSharp.dll::SettingsBase+<>c::SettingsBase_c__Initialize_b__5_0
               (SettingsBase_c *this,IUIStack *handler,BaseEventData *data,MethodInfo *method)
...
void Assembly-CSharp.dll::SettingsBase+<>c::SettingsBase_c__Update_b__9_0
               (SettingsBase_c *this,IUIStack *handler,BaseEventData *data,MethodInfo *method)
...

{
  ...
  value = (SettingsBase_c *)func_?(TypeInfo__SettingsBase____c);
  if (value != (SettingsBase_c *)0x0) {
