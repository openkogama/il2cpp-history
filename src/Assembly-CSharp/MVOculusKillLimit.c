...
code_?:
  ...
  IsolatedStorageException__ctor_1
            (this_01,StringLiteral_Couldn_t_find_OculusKillLimitCli,(MethodInfo *)0x0);
  pMStack3 = MethodInfo__MVOculusKillLimit__Destroy__;
  uStack4 = 0;
  func_?();
  pcVar5 = (code *)swi(3);
  (*pcVar5)();
...
code_?:
    ...
    iStack_1 = MVOculusKillLimit_get_KillLimit(this,(MethodInfo *)0x0);
...
code_?:
  ...
  mscorlib.dll::System::IO::IsolatedStorage::IsolatedStorageException::
  IsolatedStorageException__ctor_1
            (this_03,StringLiteral_Couldn_t_find_OculusKillLimitCli,(MethodInfo *)0x0);
  pMStack1 = MethodInfo__MVOculusKillLimit__OnDataUpdate__;
  uStack2 = 0;
  pIStack3 = this_03;
  func_?();
  pcVar4 = (code *)swi(3);
...

{
  ...
  if (this_00 != (PrefabPool *)0x0) {
    prefabObject = MVAvatar::MVAvatar_get_Shield((MVAvatar *)this_00,(MethodInfo *)0x0);
