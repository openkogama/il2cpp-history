...

{
  ...
  if ((pMVar1 == (MaterialLoader *)0x0) || (obj == (MeshRenderer *)0x0)) {
    FUN_?();
    pcVar2 = (code *)swi(3);
    (*pcVar2)();
    return;
  ...
  if (pMVar3 == (Material *)0x0) {
    ...
    pvVar5 = (pMVar3->fields)._.m_CachedPtr;
  }
  pcVar2 = pcRam_?;
  if ((pcRam_? == (code *)0x0) &&
    ...
    if (pCVar1 != (Camera *)0x0) {
      ...
      if (pCVar1 != (Camera *)0x0) {
        ...
        UnityEngine.CoreModule.dll::UnityEngine::RenderTexture::RenderTexture__ctor_9
                  (pRVar2,width,width,0x10,RenderTextureFormat__Enum_Default,(MethodInfo *)0x0);
        bVar3 = iRam_? != 0;
        (this->fields).renderTexture = pRVar2;
        if (bVar3) {
          uVar4 = (uint)((ulonglong)&(this->fields).renderTexture >> 0xc);
            ...
            if (pRVar2 != (RenderTexture *)0x0) {
              ...
              if (pCVar1 != (Camera *)0x0) {
                ...
                if (pRVar2 == (RenderTexture *)0x0) {
                  ...
                  pvVar11 = (pRVar2->fields)._._.m_CachedPtr;
                }
                pcVar9 = pcRam_?;
                if ((pcRam_? == (code *)0x0) &&
                   (pcVar9 = (code *)FUN_?(&UNK_?), pcVar9 == (code *)0x0)) {
...

{
  ...
  if (obj != (Camera *)0x0) {
    ...
    if (obj_00 != (RenderTexture *)0x0) {
      ...
      if (bVar4) {
        uVar5 = (uint)((ulonglong)&(this->fields).renderTexture >> 0xc);
...

{
  ...
  if (pTVar1 != (Transform *)0x0) {
    ...
    uVar3._0_4_ = (pVVar2->forwardVector).x;
    uVar3._4_4_ = (pVVar2->forwardVector).y;
    ...
    if (pTVar1 != (Transform *)0x0) {
      ...
      UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_Rotate_4
                (pTVar1,aVStack_7,fVar6 * _UNK_?,Space__Enum_Self,(MethodInfo *)0x0);
      return;
    }
  }
  FUN_?();
