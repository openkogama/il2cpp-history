...

{
  ...
  if ((iVar12 <= (pTVar1->fields)._to_5__3) && ((pTVar1->fields)._stopped_5__5 == 0)) {
    ...
    if (iVar12 == 3) {
      pTVar13 = (Text *)mscorlib.dll::System::Int32::Int32_ToString
                                  ((Int32 *)&(pTVar1->fields)._current_5__4,(MethodInfo *)0x0);
      if (unaff_ESI == (Text *)0x0) goto code_?;
      func_?(0x4b,unaff_ESI,pTVar13);
    ...
    pTVar13 = (Text *)mscorlib.dll::System::Int32::Int32_ToString(&IStack_2,(MethodInfo *)0x0);
    if (unaff_ESI == (Text *)0x0) goto code_?;
    func_?(0x4b,unaff_ESI,pTVar13);
    ...
    ProgressBarAndroid::ProgressBarAndroid_set_Progress
              ((ProgressBarAndroid *)(pTVar3->fields).tierProgressBar,fVar17,(MethodInfo *)method_00
              );
    ...
    if ((pTVar3->fields).unlockingTier != 0) {
      pRVar20 = (pTVar3->fields).lockImage;
      (pTVar3->fields).fromProgress = (float)(int)pTVar13;
      if ((pRVar20 == (RectTransform *)0x0) ||
         (pGVar21 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_gameObject
                              ((Component *)pRVar20,(MethodInfo *)0x0), pGVar21 == (GameObject *)0x0
         )) goto code_?;
...
code_?:
      ...
      if (bVar22 != 0) {
        ...
        pTVar13 = (Text *)(pTVar3->fields).unlockImage;
        if (fVar17 < 0.0) {
          fVar17 = 0.0;
        }
        ...
        UnityEngine.UIModule.dll::UnityEngine::CanvasGroup::CanvasGroup_set_alpha
                  ((CanvasGroup *)pTVar13,fVar17 * _UNK_? + _UNK_?,(MethodInfo *)0x0);
      ...
      if (iVar12 == (pTVar1->fields)._to_5__3) {
        ...
        pTVar13 = (Text *)(pTVar3->fields).lockImage;
        (pTVar3->fields).timer = 0.0;
        if ((pTVar13 == (Text *)0x0) ||
           (pGVar21 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_gameObject
                                ((Component *)pTVar13,(MethodInfo *)0x0), method_00 = pTVar13,
...
code_?:
    uVar28 = SUB42(method_00,0);
    cVar29 = '\0';
    func_?();
    in(0x44);
    ppMVar30 = &(unaff_ESI->fields)._.m_MaskMaterial;
    *(char *)ppMVar30 = *(char *)ppMVar30 + extraout_DL + cVar29;
    pcVar31 = (char *)((int)&unaff_ESI[-0x7996dd].fields._._.m_ColorTweenRunner + 1);
    *pcVar31 = *pcVar31 + extraout_CH;
    this_02 = (NotSupportedException *)func_?((char)uVar28 - (char)((ushort)uVar28 >> 8));
