...

{
  ...
  if (this_00 != (TeamTab *)0x0) {
    ...
    *ppLVar1 = this_02;
    ...
    index = 0;
    if (pLVar2 != (List_1_PlayerListHold_ScoreIconDef_ *)0x0) {
      while( true ) {
        ...
        pLVar2 = (this->fields).winningConditionIcons;
        index = index + 1;
        if (pLVar2 == (List_1_PlayerListHold_ScoreIconDef_ *)0x0) break;
      }
    }
  }
  func_?();
...

{
  ...
  iVar1 = playerElementHoldData.score;
  pPVar2 = this;
  iVar3 = 0;
  uVar4 = 0;
  ...
  while (MethodInfo__System__Collections__Generic__List<PlayerListHold::PlayerElementHoldData>__Add_PlayerListHold__PlayerElementHoldData_
    ...
    if (cVar7 == '\0') {
      ...
      this = (PlayerListHold *)CONCAT31(this._1_3_,(pPVar2->fields).typeToDisplay);
  ...
  while( true ) {
    ...
    if (bVar13 == 0) {
      pPVar16 = (PlayerListHold *)(this_01->fields).namespaces;
      if (pPVar16 == (PlayerListHold *)0x0) break;
      playerElementHoldData.playerElement =
           (PlayerElementHold *)pPVar16->klass[3]._0.byval_arg.data.typeHandle;
      this = pPVar16;
      playerElementHoldData.score = (int32_t)pSVar15;
