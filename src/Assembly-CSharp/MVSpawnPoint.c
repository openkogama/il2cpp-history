...
code_?:
  ...
  bVar12 = (byte)((uint)in_stack_13 >> 8);
  bVar14 = (byte)((uint)in_stack_15 >> 8);
  *(char *)(in_stack_16 + -0x75) =
       *(char *)(in_stack_16 + -0x75) + (char)in_stack_17 +
       (CARRY1(in_stack_18,bVar14) ||
       CARRY1(in_stack_18 + bVar14,
              CARRY1(bVar10,bVar12) ||
              CARRY1(bVar10 + bVar12,
                     CARRY1(extraout_CH,extraout_AH) || CARRY1(extraout_CH + extraout_AH,bVar7))));
  in(in_stack_17);
  switch(*(undefined4 *)(in_stack_16 + 8)) {
  case 0x27:
    return;
  case 0x28:
    return;
