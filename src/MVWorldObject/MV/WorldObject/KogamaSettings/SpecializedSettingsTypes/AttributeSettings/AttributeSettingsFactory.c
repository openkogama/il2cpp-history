...
code_?:
  ...
  func_?();
  uVar2 = in(0xef);
  bVar13 = (byte)((uint)uVar2 >> 8);
  bVar14 = (byte)((ushort)extraout_CX >> 8);
  bVar15 = CARRY1(bVar13,bVar14) || CARRY1(bVar13 + bVar14,bVar12);
  uVar2 = in(0xef);
  bVar14 = (byte)((uint)uVar2 >> 8);
  bVar13 = bVar14 + (byte)extraout_CX;
  cVar16 = (char)uVar2;
  out(0xef,cVar16);
  out(extraout_DX,CONCAT22((short)((uint)uVar2 >> 0x10),CONCAT11(bVar13 + bVar15,cVar16)));
  puVar17 = (undefined1 *)((int)&unaff_EDI[-0x3855c4]._1.thread_static_fields_size + 3);
  *puVar17 = *puVar17 + cVar16 +
            (CARRY1((byte)this_02,(byte)extraout_DX) ||
            CARRY1((byte)this_02 + (byte)extraout_DX,
                   CARRY1(bVar14,(byte)extraout_CX) || CARRY1(bVar13,bVar15)));
  pcVar18 = (code *)swi(3);
