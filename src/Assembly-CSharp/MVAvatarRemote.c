...
code_?:
    ...
    pUVar7 = TypeInfo__UnityEngine__Events__UnityAction<MVWorldObjectClient,_ScaleChangedEventArgs>;
    if (pUStack6 == (UnityAction_2_MVWorldObjectClient_ScaleChangedEventArgs___Class *)0x0) {
    ...
    *(UnityAction_2_MVWorldObjectClient_ScaleChangedEventArgs_ **)unaff_EDI = pUVar5;
    ...
    if ((bVar8 <= (this_02->klass->_1).naturalAligment) &&
       ((this_02->klass->_1).typeHierarchy[bVar8 - 1] == (Il2CppClass *)TypeInfo__MVNetworkListener)
       ) {
      ...
      if ((this_01 != (MVRuntimeDataVariable *)0x0) &&
        ...
        if (pAVar5 != (Avatar *)0x0) {
          ...
          if (pAVar5 != (Avatar *)0x0) {
            ...
            voxelHit_00.point.y = 3.4126443e-29;
