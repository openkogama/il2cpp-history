...
code_?:
                    /* WARNING: Could not recover jumptable at 0xADDR. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*pVVar5->methodPtr)(handler,4,pVVar5->method,pVVar5->methodPtr);
  return;
}
...

{
  ...
  pEVar1 = (EditModeClientShopItem_c *)FUN_?(TypeInfo__EditModeClientShopItem____c);
  TypeInfo__EditModeClientShopItem____c->static_fields->__9 = pEVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__EditModeClientShopItem____c->static_fields >> 0xc);
