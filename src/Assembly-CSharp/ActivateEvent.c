...

{
  ...
  uVar2 = (this->fields).activateTarget;
  uVar3 = 0;
  pIVar4 = x->klass;
  ...
  pIVar6 = (IActivateUIElement__VTable *)FUN_?(x);
code_?:
  UNRECOVERED_JUMPTABLE = (pIVar6->Activate).methodPtr;
                    /* WARNING: Could not recover jumptable at 0xADDR. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*UNRECOVERED_JUMPTABLE)(x,(ulonglong)uVar2,(pIVar6->Activate).method,UNRECOVERED_JUMPTABLE);
  return;
}
