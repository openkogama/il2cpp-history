...

{
              ...
              if (this_01 != (SettingsBase *)0x0) {
                ...
                if (pMVar10 != (MVNetworkGame *)0x0) {
                  ...
                  if (pMVar11 != (MVTeamManager *)0x0) {
                    this_03 = (pMVar11->fields).teamNames;
  ...
  uVar14 = func_?();
  bVar15 = (byte)uVar14;
  pcVar16 = (char *)((int)&this_03[-0x1bfa965].fields._freeList + 3);
  *pcVar16 = *pcVar16 + (char)((uint)uVar14 >> 8) +
            (CONCAT31((int3)((uint)uVar14 >> 8),
                      bVar15 + (9 < (bVar15 & 0xf) || ((uint)in_stack_6 & 0x10) != 0) * '\x06'
                      + (0x99 < bVar15 || ((uint)in_stack_6 & 1) != 0) * '`') < 0x3d27a210);
  pcVar17 = (code *)swi(3);
  (*pcVar17)();
  return;
}
