...
void Assembly-CSharp.dll::SettingsFactory+<>c__DisplayClass56_0::
     SettingsFactory_c_DisplayClass56_0__CreateSettingsDialog_b__0
               (SettingsFactory_c_DisplayClass56_0 *this,IUIStack *x,BaseEventData *y,
               MethodInfo *method)
