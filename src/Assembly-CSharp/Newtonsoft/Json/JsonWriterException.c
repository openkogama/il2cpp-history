...
void Assembly-CSharp.dll::Newtonsoft::Json::JsonWriterException::JsonWriterException__ctor
               (JsonWriterException *this,MethodInfo *method)
...
void Assembly-CSharp.dll::Newtonsoft::Json::JsonWriterException::JsonWriterException__ctor_1
               (JsonWriterException *this,String *message,MethodInfo *method)
...
void Assembly-CSharp.dll::Newtonsoft::Json::JsonWriterException::JsonWriterException__ctor_2
               (JsonWriterException *this,String *message,Exception *innerException,
               MethodInfo *method)
