...

{
  ...
  pFVar1 = (FirstTimeSystemPopupMovement_c *)
           FUN_?(TypeInfo__FirstTimeSystemPopupMovement____c);
  TypeInfo__FirstTimeSystemPopupMovement____c->static_fields->__9 = pFVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__FirstTimeSystemPopupMovement____c->static_fields >> 0xc);
