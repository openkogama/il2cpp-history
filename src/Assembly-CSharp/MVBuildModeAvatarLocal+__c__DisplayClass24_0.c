...
void Assembly-CSharp.dll::MVBuildModeAvatarLocal+<>c__DisplayClass24_0::
     MVBuildModeAvatarLocal_c_DisplayClass24_0__OnScaleChanged_b__0
               (MVBuildModeAvatarLocal_c_DisplayClass24_0 *this,SpawnRoleDataReceiver *receiver,
               MethodInfo *method)
