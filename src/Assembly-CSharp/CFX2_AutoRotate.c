...

{
  ...
  VStack_1.x = (this->fields).speed.x;
  VStack_1.y = (this->fields).speed.y;
  fVar2 = (this->fields).speed.z;
  pcVar3 = pcRam_?;
  if ((pcRam_? == (code *)0x0) &&
  ...
  VStack_1.y = VStack_1.y * fVar5;
  VStack_1.x = VStack_1.x * fVar5;
  UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_Rotate
            (this_00,&VStack_1,Space__Enum_Self,(MethodInfo *)0x0);
  return;
}
...

{
  ...
  (this->fields).speed.x = (float)(int)(uVar2 << 0x20);
  (this->fields).speed.y = (float)(int)((uVar2 << 0x20) >> 0x20);
