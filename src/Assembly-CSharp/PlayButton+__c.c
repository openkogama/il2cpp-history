...

{
  ...
  pPVar1 = (PlayButton_c *)FUN_?(TypeInfo__PlayButton____c);
  TypeInfo__PlayButton____c->static_fields->__9 = pPVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__PlayButton____c->static_fields >> 0xc);
