...

{
  ...
  if (pGVar1 != (GizmoLineSlider2DControllerData *)0x0) {
    ...
    if ((pGVar2 != (GizmoLineSlider2D *)0x0) &&
       ...
       pGVar3 != (GizmoLineSlider2DSettings *)0x0)) {
    ...
    if (this_01 != (GizmoLineSlider2D *)0x0) {
      ...
      if (this_00 != (TriangPrismShape3D *)0x0) {
        ...
        pGVar5 = (&(this_01->fields)._lookAndFeel)
                 [(this_01->fields)._sharedLookAndFeel != (GizmoLineSlider2DLookAndFeel *)0x0];
        if (pGVar5 != (GizmoLineSlider2DLookAndFeel *)0x0) {
          TriangPrismShape3D::TriangPrismShape3D_set_Width
                    (this_00,(pGVar5->fields)._boxThickness *
                             ((&(this_01->fields)._lookAndFeel)
                              [(this_01->fields)._sharedLookAndFeel !=
                               (GizmoLineSlider2DLookAndFeel *)0x0]->fields)._scale,
                     (MethodInfo *)0x0);
          pTVar6 = this_00;
