...
code_?:
    ...
    bVar17 = System.Core.dll::System::Collections::Generic::HashSet`1[System::UInt32]::
             HashSet_1_System_UInt32__Contains
                       ((HashSet_1_System_UInt32_ *)method_00,VStack_16.woId,
          ...
          if (this_03 != (HashSet_1_System_UInt32_ *)0x0) {
            ...
            while (bVar17 = System.Core.dll::System::Collections::Generic::
              ...
              *(undefined8 *)&pOVar41[1].monitor = uVar44;
              ...
              pOVar46 = (Object *)
                        (*pMStack_28->klass[1].vtable.OnInputStateChanged.methodPtr)
...

{
  ...
  *unaff_FS_OFFSET = &uStack_3;
  ...
  if ((wos->fields)._size == 1) {
    ...
    LStack_10._list = *(List_1_System_Object_ **)(*(int *)RVar9 + 0x1d4);
    pVVar11 = (Vector3 *)(**(code **)(*(int *)RVar9 + 0x1d0))();
  }
  else {
