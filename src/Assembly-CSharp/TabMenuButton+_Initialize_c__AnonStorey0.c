...
void Assembly-CSharp.dll::TabMenuButton+<Initialize>c__AnonStorey0::
     TabMenuButton_Initialize_c_AnonStorey0___m__0
               (TabMenuButton_Initialize_c_AnonStorey0 *this,MethodInfo *method)

{
  ...
  if (this_00 != (TabMenuButton *)0x0) {
    ...
    UnityAction_2_UnityEngine_SceneManagement_Scene_UnityEngine_SceneManagement_Scene___ctor
              (this_01,(Object *)this,
               MethodInfo__TabMenuButton___Initialize_c__AnonStorey0____m__1_UnityEngine__EventSystems__ITabSelected__UnityEngine__EventSystems__BaseEventData_
               ,
...
void Assembly-CSharp.dll::TabMenuButton+<Initialize>c__AnonStorey0::
     TabMenuButton_Initialize_c_AnonStorey0___m__1
               (TabMenuButton_Initialize_c_AnonStorey0 *this,ITabSelected *x,BaseEventData *y,
               MethodInfo *method)
