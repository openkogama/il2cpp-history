    ...
    if ((pGVar2 != (GizmoPlaneSlider3D *)0x0) &&
      ...
      if ((pGVar1 != (GizmoRATriangle3DBorderControllerData *)0x0) &&
        ...
        RightAngTriangle3D::RightAngTriangle3D_set_ExtrudeEps
                  ((RightAngTriangle3D *)this_01,value,(MethodInfo *)0x0);
        return;
      }
    }
  }
...

{
  pGVar1 = (this->fields)._._data;
  if (pGVar1 != (GizmoRATriangle3DBorderControllerData *)0x0) {
    pRVar2 = (pGVar1->fields).TargetTriangle;
