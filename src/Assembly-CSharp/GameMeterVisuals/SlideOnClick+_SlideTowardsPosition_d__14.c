...
code_?:
      func_?();
      *(char *)(extraout_EDX + -0x5fefb403) =
           *(char *)(extraout_EDX + -0x5fefb403) + (char)unaff_EBX + -1;
      *(char *)(unaff_EBX + 0xf) = *(char *)(unaff_EBX + 0xf) + -1;
      *(char *)(unaff_EBX + 0xf) = *(char *)(unaff_EBX + 0xf) + -1;
  ...
  case 1:
    ...
    fVar1 = fVar4 * (this_00->fields).lerpSpeed + fVar1;
  ...
  case 2:
    ...
    (this->fields).__1__state = -1;
    fVar4 = UnityEngine.CoreModule.dll::UnityEngine::Time::Time_1_get_deltaTime((MethodInfo *)0x0);
    (this->fields)._i_5__2 = fVar4 + fVar1;
    if (this_00 == (SlideOnClick *)0x0) goto code_?;
    goto code_?;
  case 3:
    (this->fields).__1__state = -1;
