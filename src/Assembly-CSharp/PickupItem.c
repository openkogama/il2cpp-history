...
code_?:
        ...
        bVar3 = (byte)((uint)unaff_EBX >> 8) ^
                 (byte)((uint)*(undefined4 *)(extraout_ECX + 0x699c5010 + (int)&stack0xfffffffc * 2)
                       >> 8);
        ...
        *puVar7 = (uint)(CONCAT14((int)lVar6 != lVar6,uVar8) >> 1);
        ...
        if (*(char *)&unaff_EBP[7].fields._.m_CachedPtr == '\0') {
          ...
          if (pTVar12 != (Transform *)0x0) {
            UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_SetParent_1
                      (pTVar12,(Transform *)unaff_EBP[4].klass,0,(MethodInfo *)0x0);
            pTVar12 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_transform
                                (unaff_EBP,(MethodInfo *)0x0);
            if (pTVar12 != (Transform *)0x0) {
              UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_set_localPosition
                        (pTVar12,*(Vector3 *)&unaff_EBP[4].monitor,(MethodInfo *)0x0);
              pTVar12 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_transform
                                  (unaff_EBP,(MethodInfo *)0x0);
              if (pTVar12 != (Transform *)0x0) {
                UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_set_localRotation
                          (pTVar12,*(Quaternion *)&unaff_EBP[5].monitor,(MethodInfo *)0x0);
                pTVar12 = UnityEngine.CoreModule.dll::UnityEngine::Component::
                          Component_get_transform(unaff_EBP,(MethodInfo *)0x0);
                if (pTVar12 != (Transform *)0x0) {
                  UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_set_localScale
                            (pTVar12,*(Vector3 *)&unaff_EBP[6].fields,(MethodInfo *)0x0);
                  return extraout_EAX;
                }
              }
            }
