    ...
    if (MVOperationCodes__Enum_GetThemesData < (byte)(undefined1)opCode) {
      if ((byte)(undefined1)opCode < MVOperationCodes__Enum_GetAvatarBodies) {
        ...
        if ((unaff_EDI == (Dictionary_2_System_Object_System_Object___Class *)0x0) ||
           (bVar2 = 0, pOVar5 == (Object *)0x0)) goto code_?;
        pIVar6 = (pOVar5->klass->_0).element_class;
        pIVar7 = (TypeInfo__System__Int32->_0).element_class;
        bVar2 = pIVar6 < pIVar7;
        if (pIVar6 != pIVar7) goto code_?;
        p_Var23 = (_union_86 *)func_?();
        (unaff_EDI->_0).byval_arg.data = *p_Var23;
        pMVar4 = MVGameControllerBase::MVGameControllerBase_get_Game((MethodInfo *)0x0);
        bVar2 = 0;
        if (pMVar4 == (MVNetworkGame *)0x0) goto code_?;
        pMVar1 = MVNetworkGame::MVNetworkGame_get_LocalPlayer(pMVar4,(MethodInfo *)0x0);
        ...
        bVar2 = 0;
        if (pMVar1 == (MVLocalPlayer *)0x0) goto code_?;
        pAVar8 = (pMVar1->fields)._.OnGoldAmountChange;
      }
      else {
        if ((undefined1)opCode == MVOperationCodes__Enum_VehicleEnergyUse) {
          ...
          if (pMVar4 != (MVNetworkGame *)0x0) {
            pMVar9 = (pMVar4->fields)._PlayerController_k__BackingField;
            bVar2 = 0;
            if (pMVar9 != (MVLocalObjectController *)0x0) {
              MVLocalObjectController::MVLocalObjectController_VehicleEnergyUseResponse
                        (pMVar9,returnCode == 0,returnValues,(MethodInfo *)0x0);
              return;
            }
          }
          goto code_?;
...
code_?:
    ...
    if (MVOperationCodes__Enum_SetFirstTimeEvent < (byte)(undefined1)opCode) {
      ...
      if ((undefined1)opCode == MVOperationCodes__Enum_UnEquipAccessory) {
        ...
        pAVar8 = (pMVar4->fields).OnAccessoryUnequipped;
        goto code_?;
      }
      ...
      pAVar12 = TypeInfo__ThemeSelection__CallbackHandler->static_fields->OnThemeDataReceived;
      bVar2 = 0;
      if (this_01 !=
...
code_?:
      ...
      if (pIVar6 == pIVar7) {
        ...
        bVar2 = 0;
        if (pMVar4 != (MVNetworkGame *)0x0) {
          pWVar14 = (pMVar4->fields).worldNetwork;
          bVar2 = 0;
    ...
    pOVar16 = mscorlib.dll::System::Collections::Generic::Dictionary`2[System::Byte,System::Object]
              ::Dictionary_2_System_Byte_System_Object__get_Item
                        (returnValues,0xdb,
                         MethodInfo__System__Collections__Generic__Dictionary<unsigned_char,_System::Object>__get_Item_unsigned_char_
                        );
    ...
    pIVar6 = (pOVar16->klass->_0).element_class;
    pIVar7 = (TypeInfo__System__Byte->_0).element_class;
    bVar2 = pIVar6 < pIVar7;
    if (pIVar6 != pIVar7) goto code_?;
    puVar17 = (undefined1 *)func_?();
    unaff_EBX = (Dictionary_2_System_Object_System_Object___Class *)
                CONCAT31((int3)((uint)unaff_EBX >> 8),*puVar17);
    bVar2 = 0;
    if (pOVar5 == (Object *)0x0) goto code_?;
    pIVar6 = (pOVar5->klass->_0).element_class;
    pIVar7 = (TypeInfo__System__Int32->_0).element_class;
    bVar2 = pIVar6 < pIVar7;
    if (pIVar6 == pIVar7) {
      pFVar18 = (FirstTimeEvent__Enum *)func_?();
      FirstTimeEventManager::FirstTimeEventManager_OnFirstTimeEventResponse
                (*pFVar18,(XPRewardType__Enum)unaff_EBX,(MethodInfo *)0x0);
      return;
    }
code_?:
    func_?();
...
code_?:
  ...
  if ((byte)(undefined1)opCode < MVOperationCodes__Enum_AddPrototypeToInventory) {
        ...
        if (pMVar4 != (MVNetworkGame *)0x0) {
          ...
          if (iVar10 != 0) {
            bVar3 = mscorlib.dll::System::String::String_IsNullOrEmpty
                               (*(String **)(iVar10 + 0x3c),(MethodInfo *)0x0);
            if (bVar3 != 0) {
              if ((TypeInfo__UnityEngine__Debug->_1).cctor_finished_or_no_cctor == 0) {
                func_?();
              }
            ...
            if ((iVar10 != 0) &&
              ...
              if (iVar10 != 0) {
                UnityEngine.UnityWebRequestModule.dll::UnityEngine::WWWForm::WWWForm_AddField_2
                          ((WWWForm *)unaff_EDI,StringLiteral_profile_id,*(int32_t *)(iVar10 + 0xc),
                           (MethodInfo *)0x0);
                iVar10 = func_?();
                bVar2 = 0;
                if (iVar10 != 0) {
                  ...
                  bVar2 = 0;
                  if (iVar10 != 0) {
                    pSVar11 = *(String **)(iVar10 + 0x3c);
                    this_04 = (PostRequest *)func_?();
                    PostRequest::PostRequest__ctor
                              (this_04,pSVar11,(WWWForm *)unaff_EDI,
    ...
    bVar2 = 0;
    if ((pMVar4 == (MVNetworkGame *)0x0) || (bVar2 = 0, pOVar5 == (Object *)0x0))
    goto code_?;
    pIVar6 = (pOVar5->klass->_0).element_class;
    pIVar7 = (TypeInfo__System__Int32->_0).element_class;
    bVar2 = pIVar6 < pIVar7;
...
code_?:
    ...
    pMVar19 = (pMVar4->fields).OnMarketPlaceActionComplete;
    goto code_?;
  }
...
code_?:
      ...
      pUVar21 = (pMVar1->fields)._._UserProfileData_k__BackingField;
      pOVar5 = mscorlib.dll::System::Collections::Generic::Dictionary`2[System::Byte,System::
                Object]::Dictionary_2_System_Byte_System_Object__get_Item
                          (returnValues,0x82,
                           MethodInfo__System__Collections__Generic__Dictionary<unsigned_char,_System::Object>__get_Item_unsigned_char_
      ...
      bVar2 = 0;
      if ((pUVar21 == (UserProfileData *)0x0) || (bVar2 = 0, pOVar5 == (Object *)0x0)) break;
      pIVar6 = (pOVar5->klass->_0).element_class;
      pIVar7 = (TypeInfo__System__Int32->_0).element_class;
      bVar2 = pIVar6 < pIVar7;
      if (pIVar6 == pIVar7) {
        piVar13 = (int32_t *)func_?();
        (pUVar21->fields).Gold = *piVar13;
        pMVar4 = MVGameControllerBase::MVGameControllerBase_get_Game((MethodInfo *)0x0);
        bVar2 = 0;
        if (pMVar4 == (MVNetworkGame *)0x0) break;
        pMVar1 = MVNetworkGame::MVNetworkGame_get_LocalPlayer(pMVar4,(MethodInfo *)0x0);
  ...
  case MVOperationCodes__Enum_AddWorldObjectToInventoryDev:
    ...
    bVar2 = 0;
    if ((pMVar4 == (MVNetworkGame *)0x0) || (bVar2 = 0, pOVar5 == (Object *)0x0)) break;
    pIVar6 = (pOVar5->klass->_0).element_class;
    pIVar7 = (TypeInfo__System__Int32->_0).element_class;
    bVar2 = pIVar6 < pIVar7;
    if (pIVar6 != pIVar7) goto code_?;
    ...
    pIVar6 = (((UserProfileData__Class *)(unaff_EDI->_0).image)->_0).element_class;
    pIVar7 = (TypeInfo__System__Int32->_0).element_class;
    bVar2 = pIVar6 < pIVar7;
    if (pIVar6 == pIVar7) {
      piVar13 = (int32_t *)func_?();
      MVNetworkGame::MVNetworkGame_OnAddWorldObjectToInventoryResponseDev
                (pMVar4,(int)returnCode,*piVar13,iVar23,(MethodInfo *)0x0);
      return;
    }
    goto code_?;
  case MVOperationCodes__Enum_SetActiveAvatar:
    ...
    bVar2 = 0;
    if (pMVar4 == (MVNetworkGame *)0x0) break;
    pAVar8 = (pMVar4->fields).OnActiveAvatarSet;
    goto code_?;
  case MVOperationCodes__Enum_AddItemToMarketPlace:
    ...
    if (returnCode == 0) {
      ...
      if (pIVar6 == pIVar7) {
        piVar13 = (int32_t *)func_?();
        unaff_EBX = (Dictionary_2_System_Object_System_Object___Class *)*piVar13;
        pOVar5 = mscorlib.dll::System::Collections::Generic::Dictionary`2[System::Byte,System::
                  Object]::Dictionary_2_System_Byte_System_Object__get_Item
                            (returnValues,0x87,
                             MethodInfo__System__Collections__Generic__Dictionary<unsigned_char,_System::Object>__get_Item_unsigned_char_
        ...
        if (pIVar6 == pIVar7) {
          ...
          PlayerShopInventoryRepository_UpdatePlayerShopInventoryID
                    (this_03,(int32_t)unaff_EBX,iVar23,(MethodInfo *)0x0);
          goto code_?;
        }
      }
      goto code_?;
...
code_?:
  ...
  case MVOperationCodes__Enum_SetAvatarAccessorySlot:
    ...
    bVar2 = 0;
    if (pMVar4 != (MVNetworkGame *)0x0) {
      pAVar24 = (pMVar4->fields).OnSetAvatarAccessoryResponse;
      if (pAVar24 != (Action_1_Boolean_ *)0x0) {
        (*(pAVar24->fields)._._.invoke_impl)((pAVar24->fields)._._.method_code,returnCode == 0);
      }
      if (returnCode == 0) {
        return;
      }
    ...
    if (pMVar4 != (MVNetworkGame *)0x0) {
      ...
      if (pMVar9 != (MVLocalObjectController *)0x0) {
        MVLocalObjectController::MVLocalObjectController_HandleAttachWorldObjectToSeat
                  (pMVar9,returnCode == 0,(MethodInfo *)0x0);
        return;
      }
    }
    break;
...
code_?:
  uVar25 = func_?();
  piVar26 = (int *)((ulonglong)uVar25 >> 0x20);
  bVar27 = *(byte *)((int)&(unaff_EBX->_0).image + ((uint)uVar25 & 0xff));
  pbVar28 = (byte *)((int)&unaff_EDI[-1].vtable.
                          System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Values.
                          method + 3);
  bVar29 = (byte)((uint)unaff_EBX >> 8);
  bVar30 = *pbVar28 + bVar29;
  bVar31 = CARRY1(*pbVar28,bVar29) || CARRY1(bVar30,bVar2);
  *pbVar28 = bVar30 + bVar2;
  bVar2 = (byte)((ulonglong)uVar25 >> 0x20);
  bVar29 = (byte)unaff_EBX + bVar2;
  bVar32 = CARRY1((byte)unaff_EBX,bVar2) || CARRY1(bVar29,bVar31);
  bVar29 = bVar29 + bVar31;
  iVar33 = CONCAT31((int3)((uint)unaff_EBX >> 8),bVar29);
  cVar34 = *(char *)(iVar33 + (uint)bVar27);
  iVar10 = CONCAT31((int3)((ulonglong)uVar25 >> 8),cVar34);
  pbVar28 = (byte *)(iVar33 + -0x20);
  bVar2 = *pbVar28;
  bVar30 = *pbVar28;
  *pbVar28 = bVar30 + bVar29 + bVar32;
  *extraout_ECX = *extraout_ECX + cVar34 + (CARRY1(bVar2,bVar29) || CARRY1(bVar30 + bVar29,bVar32))
  ;
  *(int *)(iVar10 + 0x7e + (int)piVar26) = (int)ROUND(extraout_ST0);
  *(int *)(iVar10 + -0x66 + (int)piVar26) = (int)ROUND(extraout_ST0);
  *(double *)(iVar10 + 0x5e + (int)piVar26) = (double)extraout_ST0;
  *(double *)(iVar10 + (int)piVar26) = (double)extraout_ST0;
  *piVar26 = *piVar26 + iVar10;
