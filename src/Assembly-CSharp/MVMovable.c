  ...
  *unaff_FS_OFFSET = &uStack_3;
  ...
  if (pMVar19 != (MVCubeModelInstance *)0x0) {
    ...
    if ((this_02->fields).pausedMovement == 0) {
      ...
      uStack_12._4_4_ = (List_1_T_Enumerator_System_Object_ *)(VStack_29.y * (float)uStack_20);
      fVar15 = (VStack_29.x * fStack_39 + VStack_29.z * uStack_20._4_4_ + VStack_29.y * fStack_21) -
               fStack_38 * (float)uStack_20;
      fVar14 = (fStack_38 * uStack_20._4_4_ +
               VStack_29.z * (float)uStack_20 + VStack_29.x * fStack_21) - VStack_29.y * fStack_39;
      fStack_38 = ((float)uStack_12._4_4_ + VStack_29.z * fStack_39 + fStack_38 * fStack_21) -
...

{
  ...
  *ppLVar1 = this_00;
  ...
  (this->fields).localPos.x = (pVVar3->zeroVector).x;
  (this->fields).localPos.y = fVar4;
  (this->fields).localPos.z = fVar5;
