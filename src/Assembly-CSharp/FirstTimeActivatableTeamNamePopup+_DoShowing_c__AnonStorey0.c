...
void Assembly-CSharp.dll::FirstTimeActivatableTeamNamePopup+<DoShowing>c__AnonStorey0::
     FirstTimeActivatableTeamNamePopup_DoShowing_c_AnonStorey0___m__0
               (FirstTimeActivatableTeamNamePopup_DoShowing_c_AnonStorey0 *this,
...

{
  ...
  if ((pFVar1 != (FirstTimeActivatableTeamNamePopup *)0x0) && (x != (IOpenClientShopTab *)0x0)) {
...
void Assembly-CSharp.dll::FirstTimeActivatableTeamNamePopup+<DoShowing>c__AnonStorey0::
     FirstTimeActivatableTeamNamePopup_DoShowing_c_AnonStorey0___m__1
               (FirstTimeActivatableTeamNamePopup_DoShowing_c_AnonStorey0 *this,
...

{
  ...
  pFVar1 = (this->fields)._this;
  if ((pFVar1 != (FirstTimeActivatableTeamNamePopup *)0x0) && (x != (IHighLightClientShopItem *)0x0)
     ) {
