...
void Assembly-CSharp.dll::AccessoryView+<Purchase>c__AnonStorey4::
     AccessoryView_Purchase_c_AnonStorey4___m__0
               (AccessoryView_Purchase_c_AnonStorey4 *this,IUIStack *x,BaseEventData *y,
               MethodInfo *method)
