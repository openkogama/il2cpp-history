...
code_?:
  bVar12 = 0;
  func_?();
  pbVar13 = (byte *)(extraout_ECX + -0x4cefb06f);
  bVar14 = *pbVar13;
  bVar15 = *pbVar13 + (byte)unaff_EBX;
  *pbVar13 = bVar15 + bVar12;
  *(char *)(unaff_EBX + -0x27efb06f) =
       *(char *)(unaff_EBX + -0x27efb06f) + extraout_DH +
       (CARRY1(bVar14,(byte)unaff_EBX) || CARRY1(bVar15,bVar12));
  pcVar16 = (code *)swi(3);
  (*pcVar16)();
  return;
}
