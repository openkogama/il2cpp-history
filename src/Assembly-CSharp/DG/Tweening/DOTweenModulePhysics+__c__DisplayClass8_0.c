...
void Assembly-CSharp.dll::DG::Tweening::DOTweenModulePhysics+<>c__DisplayClass8_0::
     DOTweenModulePhysics_c_DisplayClass8_0__DOLocalPath_b__1
               (DOTweenModulePhysics_c_DisplayClass8_0 *this,Vector3 *x,MethodInfo *method)
