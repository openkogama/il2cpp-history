...

{
  ...
  pAVar1 = (AdminToolController_c *)FUN_?(TypeInfo__AdminToolController____c);
  TypeInfo__AdminToolController____c->static_fields->__9 = pAVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__AdminToolController____c->static_fields >> 0xc);
