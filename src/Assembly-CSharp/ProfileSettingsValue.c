...

{
    ...
    if ((value->klass->_0).element_class ==
      ...
      if (value_00 == TargetFrameRateValue__Enum_Unlimited) {
        ...
        if (pOVar6 != (Object *)0x0) {
          ...
          if ((pOVar6 != (Object *)0x1) || (cVar8 = func_?(0), cVar8 != '\0')) {
            if ((TypeInfo__Assets__Scripts__ProfileSettings__ProfileSettingsManager->_1).
                cctor_finished_or_no_cctor == 0) {
              func_?(TypeInfo__Assets__Scripts__ProfileSettings__ProfileSettingsManager);
            }
  ...
  case 2:
    ...
    if ((value->klass->_0).element_class ==
      ...
      puVar9 = (undefined4 *)func_?(value);
      uStack_10 = *puVar9;
      EStack_11.klass = (Enum__Class *)TypeInfo__MV__WorldObject__MetaData__TextureQualityLevel;
      this_00 = &EStack_11;
...
code_?:
  ...
  case 3:
    ...
    if ((value->klass->_0).element_class == (TypeInfo__UnityEngine__FilterMode->_0).element_class) {
      puVar9 = (undefined4 *)func_?(value);
      uStack_12 = *puVar9;
      EStack_13.klass = (Enum__Class *)TypeInfo__UnityEngine__FilterMode;
      this_00 = &EStack_13;
  ...
  case 4:
    ...
    if ((value->klass->_0).element_class ==
      ...
      pSVar2 = mscorlib.dll::System::Enum::Enum_ToString(&EStack_15,(MethodInfo *)0x0);
      goto code_?;
    }
    break;
  case 5:
    ...
    if ((value->klass->_0).element_class ==
      ...
      pSVar2 = mscorlib.dll::System::Enum::Enum_ToString((Enum *)&pAStack_16,(MethodInfo *)0x0);
      goto code_?;
    }
    break;
  case 6:
