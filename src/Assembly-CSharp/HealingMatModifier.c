...

{
  ...
  if (this == (HealingMatModifier *)0x0) {
    FUN_?();
    pcVar1 = (code *)swi(3);
    (*pcVar1)();
    return;
...
{
  if (cRam_? == '\0') {
    FUN_?(&TypeInfo__HealingMatModifier___DoFadeAndDestroy_d__7);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
  pIVar1 = (IEnumerator *)FUN_?(TypeInfo__HealingMatModifier___DoFadeAndDestroy_d__7);
  bVar2 = iRam_? != 0;
    ...
    if (this_02 != (Transform *)0x0) {
      ...
      if (((pMVar1 != (MVAvatar *)0x0) && (pMVar2 = (pMVar1->fields).body, pMVar2 != (MVBody *)0x0))
        ...
        BlinkerBase::BlinkerBase_StartBlinking
                  ((BlinkerBase *)this_00,BlinkType__Enum_HealingMat,_UNK_?,
                   (MethodInfo *)0x0);
...
{
  if (target != (Avatar *)0x0) {
    Avatar::Avatar_StopBlinking(target,BlinkType__Enum_HealingMat,(MethodInfo *)0x0);
    ...
    if (pGVar1 != (GameObject *)0x0) {
      ...
      if (cVar5 == '\0') {
        ...
        if (this_01 != (Transform *)0x0) {
          ...
          lVar6 = FUN_?(TypeInfo__HealingMatModifier___DoFadeAndDestroy_d__7);
          bVar7 = iRam_? != 0;
          *(undefined4 *)(lVar6 + 0x10) = 0;
          *(HealingMatModifier **)(lVar6 + 0x20) = this;
          if (bVar7) {
