...
InteractionData *
Assembly-CSharp.dll::VehicleHitPackage::VehicleHitPackage_Create
...

{
  ...
  *(undefined2 *)&__return_storage_ptr__->field_0x12 = 0;
  ...
  MVWorldObject.dll::MV::WorldObject::InteractionData::InteractionData__ctor_5
            (&IStack_1,CONCAT31((int3)((ulonglong)impulse >> 8),0x1c),0.0,&VStack_2,
...
void Assembly-CSharp.dll::VehicleHitPackage::VehicleHitPackage_ParseAndHandlePackage
               (VehicleHitPackage *this,MVWorldObjectClient *worldObjectClient,MVPlayer *shooter,
...

{
  ...
  InteractionPackage::InteractionPackage_HandlePackage_3
            ((InteractionPackage *)this,worldObjectClient,shooter,&VStack_1,
