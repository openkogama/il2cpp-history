...
/* SpawnRoleReceiverVariable`1[System.Int32](SubscribableVariable`1[System.Int32],
...
void Assembly-CSharp.dll::Assets::Scripts::Network::Player::SpawnRoles::SpawnRoleData::
     ...
     SpawnRoleReceiverVariable_1_System_Int32___ctor
               (SpawnRoleReceiverVariable_1_System_Int32_ *this,
               SubscribableVariable_1_System_Int32_ *subscribableVariableExternal,
...

{
  ...
  if (subscribableVariableExternal != (SubscribableVariable_1_System_Int32_ *)0x0) {
    ...
    pSVar8 = (SubscribableVariable_1_System_Int32_ *)FUN_?(pvVar7);
    bVar1 = iRam_? != 0;
