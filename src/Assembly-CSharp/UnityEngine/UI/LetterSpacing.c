  ...
  if (this_01 != (Text *)0x0) {
    ...
    if ((this_03 != (TextGenerator *)0x0) &&
       (pIVar4 = UnityEngine.TextRenderingModule.dll::UnityEngine::TextGenerator::
                 TextGenerator_get_lines(this_03,(MethodInfo *)0x0), pIStack_5 = pIVar4,
       pIVar4 != (IList_1_UnityEngine_UILineInfo_ *)0x0)) {
      this_01 = (Text *)func_?();
      pIVar6 = (Il2CppClass *)TypeInfo__System__Collections__Generic__IList<UnityEngine::UILineInfo>
      ;
      pIVar7 = pIStack_5;
      while (this_01 = (Text *)((int)&this_01[-1].fields.m_TempVerts + 3),
            TypeInfo__System__Collections__Generic__IList<UnityEngine::UILineInfo> =
                 (IList_1_UnityEngine_UILineInfo___Class *)pIVar6, pIStack_5 = pIVar7,
            0 < (int)this_01) {
        pIStack_8 = pIVar4->klass;
        uVar9 = 0;
        ppSStack_10 = (String **)0x0;
        uVar11._0_1_ = (pIStack_8->_1).rank;
        uVar11._1_1_ = (pIStack_8->_1).minimumAlignment;
        pIStack_12 = (Il2CppClass *)(uint)uVar11;
        if (uVar11 != 0) {
          do {
            if (pIStack_8->interfaceOffsets[uVar9].interfaceType == pIVar6) {
...
code_?:
        ...
        unaff_EDI = (Il2CppClass *)(uint)uVar9;
        ...
        if (uVar9 != 0) {
          do {
            if (pIStack_8->interfaceOffsets[uVar11].interfaceType ==
                (Il2CppClass *)
                TypeInfo__System__Collections__Generic__IList<UnityEngine::UILineInfo>) {
              ppMVar13 = &(&(pIStack_5->klass->vtable).get_Item)
                         [pIStack_5->klass->interfaceOffsets[uVar11].offset].method;
              pIVar4 = pIStack_5;
              goto code_?;
            }
            uVar11 = uVar11 + 1;
      ...
      if (this_02 != (Il2CppClass *)0x0) {
        ...
        if (pSStack_21 != (String__Array *)0x0) {
          ...
          while( true ) {
            ...
            pIStack_5 = (IList_1_UnityEngine_UILineInfo_ *)(pSStack_31->fields)._stringLength;
            if (bStack_26 != 0) {
              unaff_EDI = (Il2CppClass *)
                          LetterSpacing_GetRegexMatchedTagCollection
                                    (this,pSStack_31,(int32_t *)&pIStack_5,(MethodInfo *)0x0);
              iVar27 = 0;
              iStack_28 = 0;
              pIStack_3 = unaff_EDI;
            ...
            pIVar4 = (IList_1_UnityEngine_UILineInfo_ *)0x0;
            pTStack_2 = (Text *)0x0;
            fStack_33 = (float)(int)((int)&pIStack_5[-1].monitor + 3) * fStack_24 * fStack_25;
            while (pIStack_5 = pIVar4, (int)pIVar4 < (pSStack_31->fields)._stringLength) {
              if (((bStack_26 == 0) || (iVar27 == 0)) ||
                 (*(IList_1_UnityEngine_UILineInfo_ **)(iVar27 + 8) != pIVar4)) {
                ...
                pIStack_12 = (Il2CppClass *)((int)this_01 * 6 + 5);
                if (verts == (List_1_UnityEngine_UIVertex_ *)0x0) goto code_?;
                if ((verts->fields)._size + -1 < (int)pIStack_12) {
                  return;
                }
                ...
                mscorlib.dll::System::Collections::Generic::List`1[UnityEngine::UIVertex]::
                List_1_UnityEngine_UIVertex__set_Item
                          (verts,(int32_t)pIStack_12,value_04,in_stack_79);
                this_01 = (Text *)((int)&this_01->klass + 1);
                iVar27 = iStack_28;
                unaff_EDI = pIStack_3;
code_?:
                pIVar4 = (IList_1_UnityEngine_UILineInfo_ *)((int)&pIStack_5->klass + 1);
                pTStack_2 = (Text *)((int)&pTStack_2->klass + 1);
              }
              else {
                this_01 = (Text *)((int)&this_01->klass + *(int *)(iVar27 + 0xc));
                pIStack_5 = (IList_1_UnityEngine_UILineInfo_ *)
                            ((int)pIVar4 + *(int *)(iVar27 + 0xc) + -1);
...
code_?:
  uVar46 = func_?();
  pbVar80 = (byte *)((ulonglong)uVar46 >> 0x20);
  pbVar81 = (byte *)uVar46;
  bVar82 = CARRY4((uint)unaff_EDI,(uint)&stack0xfffffffc) ||
           CARRY4((uint)(&stack0xfffffffc + (int)&unaff_EDI->image),(uint)bVar30);
  bVar30 = *pbVar81 + (byte)this_01;
  bVar83 = CARRY1(*pbVar81,(byte)this_01) || CARRY1(bVar30,bVar82);
  *pbVar81 = bVar30 + bVar82;
  bVar30 = *pbVar80;
  bVar84 = (byte)((ulonglong)uVar46 >> 8);
  bVar85 = *pbVar80 + bVar84;
  *pbVar80 = bVar85 + bVar83;
  cVar1 = (char)uVar46;
  *pbVar81 = *pbVar81 + cVar1 + (CARRY1(bVar30,bVar84) || CARRY1(bVar85,bVar83));
  *(byte **)pbVar80 = pbVar81 + *(int *)pbVar80;
  *extraout_ECX = *extraout_ECX + cVar1;
  *(int *)pbVar80 = *(int *)pbVar80 + CONCAT31((int3)((ulonglong)uVar46 >> 8),cVar1 + *pbVar81);
  pcVar86 = (code *)swi(3);
  (*pcVar86)();
  return;
}
