...

{
  ...
  pFVar1 = (FirstTimeSystemPopupMovementHeight_c *)
           FUN_?(TypeInfo__FirstTimeSystemPopupMovementHeight____c);
  TypeInfo__FirstTimeSystemPopupMovementHeight____c->static_fields->__9 = pFVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__FirstTimeSystemPopupMovementHeight____c->static_fields >>
                  0xc);
