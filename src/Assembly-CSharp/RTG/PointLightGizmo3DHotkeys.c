...
void Assembly-CSharp.dll::RTG::PointLightGizmo3DHotkeys::PointLightGizmo3DHotkeys__ctor
               (PointLightGizmo3DHotkeys *this,MethodInfo *method)

{
  ...
  if (this_00 != (Hotkeys *)0x0) {
    ...
    ((PointLightGizmo3DHotkeys__Fields *)method_00)->_enableSnapping = this_00;
