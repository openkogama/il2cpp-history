...
code_?:
      cVar3 = '\0';
      func_?();
      pcVar4 = (char *)(CONCAT22((short)((uint)extraout_ECX >> 0x10),
                                 CONCAT11(0x36,(char)extraout_ECX)) + 0x35);
      *pcVar4 = *pcVar4 + (char)unaff_EBX + cVar3;
      *(char *)(unaff_EBX + -0x4aefb8ca) =
           *(char *)(unaff_EBX + -0x4aefb8ca) + (char)((uint)unaff_EBX >> 8);
      pcVar5 = (code *)swi(3);
      (*pcVar5)();
      return;
    }
