...

{
  ...
  uVar8 = in(extraout_DX);
  in(CONCAT11((char)((ushort)extraout_DX >> 8) + (char)((uint)uVar8 >> 8) +
              (CARRY1(extraout_CL,bVar10) ||
              CARRY1(extraout_CL + bVar10,CARRY1(bVar9,unaff_BL) || CARRY1(bVar9 + unaff_BL,bVar3))
              ),(char)extraout_DX));
  pcVar11 = (code *)swi(3);
  (*pcVar11)();
  return;
