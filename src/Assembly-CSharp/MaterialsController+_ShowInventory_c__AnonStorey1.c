...
void Assembly-CSharp.dll::MaterialsController+<ShowInventory>c__AnonStorey1::
     MaterialsController_ShowInventory_c_AnonStorey1___m__0
               (MaterialsController_ShowInventory_c_AnonStorey1 *this,IUIStack *x,BaseEventData *y,
               MethodInfo *method)
