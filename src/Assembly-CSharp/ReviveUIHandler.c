...
code_?:
  uVar9 = func_?();
  puVar10 = (undefined1 *)((int)&unaff_EBX[-1]._1.genericContainerHandle + 3);
  *puVar10 = *puVar10 + (char)extraout_CX + (uVar9 < 0x3da3a810);
  *(char *)(uVar9 + 0xcc103da3) =
       *(char *)(uVar9 + 0xcc103da3) + (char)((ushort)extraout_CX >> 8) + (uVar9 < 0x3da37610);
  pcVar11 = (code *)swi(3);
  (*pcVar11)();
  return;
}
