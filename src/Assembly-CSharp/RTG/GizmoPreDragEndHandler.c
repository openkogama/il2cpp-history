...
IAsyncResult *
Assembly-CSharp.dll::RTG::GizmoPreDragEndHandler::GizmoPreDragEndHandler_BeginInvoke
          (GizmoPreDragEndHandler *this,Gizmo *gizmo,int32_t handleId,AsyncCallback *callback,
