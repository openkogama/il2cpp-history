...
void Assembly-CSharp.dll::SettingsInputFieldSlider+<>c__DisplayClass16_0::
     SettingsInputFieldSlider_c_DisplayClass16_0__ValueChanged_b__0
               (SettingsInputFieldSlider_c_DisplayClass16_0 *this,IHandleSettingChanged *handler,
...

{
  ...
  if (pSVar1 != (SettingsInputFieldSlider *)0x0) {
    this = (SettingsInputFieldSlider_c_DisplayClass16_0 *)(this->fields).floatValue;
