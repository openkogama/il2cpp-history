...

{
  ...
  pVVar6 = pVVar4;
  bVar7 = CubeModelChunk_AllFaceCornersIsTouchingCubeBorder
                    ((Face__Enum)pVVar4,(Vector3__Array **)&stack0xfffffff8,(MethodInfo *)0x0);
  if (bVar7 != 0) {
    if ((TypeInfo__MV__WorldObject__CubeBase->_1).cctor_finished_or_no_cctor == 0) {
...
code_?:
  uVar8 = 0x1057;
  func_?();
  func_?(CONCAT22(uVar8,in_CS));
  *(uint *)(unaff_EDI + 0x10) =
       *(uint *)(unaff_EDI + 0x10) << 1 |
       (uint)(CARRY1(extraout_CL,extraout_DL) || CARRY1(extraout_CL + extraout_DL,bVar4));
