...

{
    ...
    do {
      ...
      if (0 < (int)pIVar3) {
        do {
          ...
          func_?();
          iVar10 = iVar10 + 1;
        } while (iVar10 < (int)pIVar3);
      }
      iStack_9 = iStack_9 + 1;
    } while (iStack_9 < iVar5);
  }
  if ((this != (List_1_UnityEngine_UIElements_Internal_MultiColumnCollectionHeader_ViewState_ColumnState_
    ...
    if (iVar5 != 1 && -1 < iVar4) {
      ...
      do {
        if (0 < iVar2) {
          pIVar14 = (IEnumerable_1_System_Int32___Class *)((1 - (int)pIVar3) + (int)pIVar13);
          numStacks = 0;
          pIVar15 = pIVar13;
          ...
          do {
            ...
            (&pIVar12[2].klass)[(int)(pMVar11 + 1)] = pIVar15;
            if (pIVar12[1].monitor <= pMVar11 + 2) goto code_?;
            (&pIVar12[2].klass)[(int)(pMVar11 + 2)] = pIVar14;
            if (pIVar12[1].monitor <= pMVar11 + 3) goto code_?;
            (&pIVar12[2].klass)[(int)(pMVar11 + 3)] = pIVar15;
            if (pIVar12[1].monitor <= pMVar11 + 4) goto code_?;
            (&pIVar12[2].klass)[(int)(pMVar11 + 4)] =
                 (IEnumerable_1_System_Int32___Class *)((int)&(pIVar15->_0).image + 1);
            pMVar16 = pMVar11 + 5;
            pMVar11 = pMVar11 + 6;
            if (pIVar12[1].monitor <= pMVar16) goto code_?;
            (&pIVar12[2].klass)[(int)pMVar16] = pIVar14;
    ...
    if (this_01 !=
      ...
      if (0 < numBottomCapRings) {
        iVar4 = iVar2 + 1;
        iStack_6 = iStack_6 + iVar4 * (numBottomCapRings + 1);
        ...
        } while (iStack_17 < numBottomCapRings + 1);
        iVar5 = (this->fields)._size;
        mscorlib.dll::System::Collections::Generic::List`1[UnityEngine::Vector3]::
        List_1_UnityEngine_Vector3__AddRange
                  ((List_1_UnityEngine_Vector3_ *)this,pIVar7,
                   MethodInfo__System__Collections__Generic__List<UnityEngine::Vector3>__AddRange_System__Collections__Generic__IEnumerable<UnityEngine::Vector3>_
        ...
        pIVar12 = (IEnumerable_1_System_Int32_ *)func_?();
        bottomRadius = 0.0;
        pIVar3 = (IEnumerable_1_System_Int32___Class *)(iVar5 + 1);
        do {
          if (0 < iVar2) {
            numBottomCapRings = 0;
            pIVar13 = pIVar3;
            ...
            do {
              ...
              (&pIVar12[2].klass)[(int)pMVar16] =
                   (IEnumerable_1_System_Int32___Class *)((int)&pIVar18->image + iVar4);
              numBottomCapRings = numBottomCapRings + 1;
            } while (numBottomCapRings < iVar2);
          }
          bottomRadius = (float)((int)bottomRadius + 1);
          pIVar3 = (IEnumerable_1_System_Int32___Class *)((int)&(pIVar3->_0).image + iVar4);
      ...
      if (0 < numTopCapRings) {
        iVar4 = iVar2 + 1;
        iStack_6 = iStack_6 + iVar4 * (numTopCapRings + 1);
        pIVar7 = (IEnumerable_1_UnityEngine_Vector3_ *)func_?();
        pIVar8 = (IEnumerable_1_UnityEngine_Vector3_ *)func_?();
        numBottomCapRings = 0;
        do {
        ...
        pIVar3 = (IEnumerable_1_System_Int32___Class *)(this->fields)._size;
        mscorlib.dll::System::Collections::Generic::List`1[UnityEngine::Vector3]::
        List_1_UnityEngine_Vector3__AddRange
                  ((List_1_UnityEngine_Vector3_ *)this,pIVar7,
                   MethodInfo__System__Collections__Generic__List<UnityEngine::Vector3>__AddRange_System__Collections__Generic__IEnumerable<UnityEngine::Vector3>_
        ...
        do {
          pIVar3 = (IEnumerable_1_System_Int32___Class *)((int)&(pIVar3->_0).image + iVar4);
          if (0 < iVar2) {
            pIVar15 = (IEnumerable_1_System_Int32___Class *)((1 - iVar4) + (int)pIVar3);
            numSlices = 0;
            pIVar13 = pIVar3;
            if (pIVar12 == (IEnumerable_1_System_Int32_ *)0x0) goto code_?;
            do {
              ...
              (&pIVar12[2].klass)[(int)(pMVar11 + 1)] = pIVar13;
              if (pIVar12[1].monitor <= pMVar11 + 2) goto code_?;
              (&pIVar12[2].klass)[(int)(pMVar11 + 2)] = pIVar15;
              if (pIVar12[1].monitor <= pMVar11 + 3) goto code_?;
              ...
              pMVar11 = pMVar11 + 6;
              if (pIVar12[1].monitor <= pMVar16) goto code_?;
              (&pIVar12[2].klass)[(int)pMVar16] = pIVar15;
              pIVar13 = (IEnumerable_1_System_Int32___Class *)((int)&(pIVar13->_0).image + 1);
              pIVar15 = (IEnumerable_1_System_Int32___Class *)((int)&(pIVar15->_0).image + 1);
              numSlices = numSlices + 1;
            } while (numSlices < iVar2);
          }
          numBottomCapRings = numBottomCapRings + 1;
