                  ...
                  if (pOVar3[4].klass != (Object__Class *)0x0) {
                    ...
                    if (pOVar3[4].klass != (Object__Class *)0x0) {
                      UnityEngine.CoreModule.dll::UnityEngine::Camera::Camera_set_aspect
                                ((Camera *)pOVar3[4].klass,2.709805e+08 / (float)(int)pOVar2,
                                 (MethodInfo *)0x0);
                                              ...
                                              if (pOVar12 != (Object__Array *)0x0) {
                                                ...
                                                if ((pGVar1 != (GameObject *)0x0) &&
                                                  ...
                                                  if ((*(int *)(iVar24 + 0xc) == 0) ||
                                                     ...
                                                     *(uint *)(iVar24 + 0xc) < 2))
                                                  goto code_?;
                                                  pfVar29 = (float *)(iVar24 + 0x14);
                                                  *pfVar29 = fVar21 * fVar19;
                                                  if (*(uint *)(iVar24 + 0xc) < 3)
                                                  goto code_?;
