...

{
  ...
  bVar2 = Styles::Styles_HandleUnInitalized((MethodInfo *)0x0);
  if (bVar2 == 0) {
    return;
  }
  if (*(int *)&(TypeInfo__Styles->_1).field_0x1c == 0) {
      ...
      (pOVar3 = mscorlib.dll::System::Collections::Generic::Dictionary`2[System::Int32Enum,System::
                Object]::Dictionary_2_System_Int32Enum_System_Object__get_Item
                          ((Dictionary_2_System_Int32Enum_System_Object_ *)this_00,key,
                           MethodInfo__System__Collections__Generic__Dictionary<ColorStyle,_Styles::ColorStyleDef>__get_Item_ColorStyle_
                          ), pOVar3 != (Object *)0x0)) && (pGVar1 != (Graphic *)0x0)) {
    uStack_4 = *(undefined4 *)((longlong)&pOVar3[1].klass + 4);
    uStack_5 = *(undefined4 *)&pOVar3[1].monitor;
    uStack_6 = *(undefined4 *)((longlong)&pOVar3[1].monitor + 4);
    uStack_7 = *(undefined4 *)&pOVar3[2].klass;
    (*(pGVar1->klass->vtable).set_color.methodPtr)
              (pGVar1,&uStack_4,(pGVar1->klass->vtable).set_color.method);
    return;
  }
  FUN_?();
  pcVar8 = (code *)swi(3);
    ...
    if (((this_00 == (Dictionary_2_ColorStyle_Styles_ColorStyleDef_ *)0x0) ||
        (pOVar8 = mscorlib.dll::System::Collections::Generic::Dictionary`2[System::Int32Enum,System
                  ::Object]::Dictionary_2_System_Int32Enum_System_Object__get_Item
                            ((Dictionary_2_System_Int32Enum_System_Object_ *)this_00,key,
                             MethodInfo__System__Collections__Generic__Dictionary<ColorStyle,_Styles::ColorStyleDef>__get_Item_ColorStyle_
                            ), pOVar8 == (Object *)0x0)) || (pGVar1 == (Graphic *)0x0)) {
      FUN_?();
      pcVar9 = (code *)swi(3);
      (*pcVar9)();
      return;
    }
    uStack_10 = *(undefined4 *)((longlong)&pOVar8[1].klass + 4);
    uStack_11 = *(undefined4 *)&pOVar8[1].monitor;
    uStack_12 = *(undefined4 *)((longlong)&pOVar8[1].monitor + 4);
    uStack_13 = *(undefined4 *)&pOVar8[2].klass;
    (*(pGVar1->klass->vtable).set_color.methodPtr)
              (pGVar1,&uStack_10,(pGVar1->klass->vtable).set_color.method);
  }
  return;
}
...

{
  ...
  if (((this_00 != (Dictionary_2_ColorStyle_Styles_ColorStyleDef_ *)0x0) &&
      (pOVar3 = mscorlib.dll::System::Collections::Generic::Dictionary`2[System::Int32Enum,System::
                Object]::Dictionary_2_System_Int32Enum_System_Object__get_Item
                          ((Dictionary_2_System_Int32Enum_System_Object_ *)this_00,colorStyle,
                           MethodInfo__System__Collections__Generic__Dictionary<ColorStyle,_Styles::ColorStyleDef>__get_Item_ColorStyle_
                          ), pOVar3 != (Object *)0x0)) && (pGVar1 != (Graphic *)0x0)) {
    uStack_4 = *(undefined4 *)((longlong)&pOVar3[1].klass + 4);
    uStack_5 = *(undefined4 *)&pOVar3[1].monitor;
