...

{
  ...
  if ((pHVar1 != (HealthBar *)0x0) &&
    ...
    fStack_5 = pVVar2->x * (pHVar1->fields)._MaxHealth_k__BackingField;
    if ((pMVar4 != (MVAvatarRemote *)0x0) &&
       (pMVar6 = (pMVar4->fields)._.Health, pMVar6 != (MVRuntimeDataVariable_1_System_Single_ *)0x0)
       ) {
      ...
      if (this_00 != (MVAvatarRemote *)0x0) {
        MVAvatar::MVAvatar_TrySpawningHealParticles
                  ((MVAvatar *)this_00,fStack_5,(float)fVar7,(MethodInfo *)0x0);
        pHVar1 = (this->fields).healthBar;
        if (pHVar1 != (HealthBar *)0x0) {
          if (health != (Object *)0x0) {
            ...
            if ((health->klass->_0).element_class == (TypeInfo__System__Single->_0).element_class) {
              pfVar9 = (float *)func_?(health);
              HealthBar::HealthBar_SetScaleFromHealth(pHVar1,*pfVar9,(MethodInfo *)0x0);
              return;
            }
            goto code_?;
          }
