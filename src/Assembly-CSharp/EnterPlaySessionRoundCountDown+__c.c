...

{
  ...
  pEVar1 = (EnterPlaySessionRoundCountDown_c *)
           FUN_?(TypeInfo__EnterPlaySessionRoundCountDown____c);
  TypeInfo__EnterPlaySessionRoundCountDown____c->static_fields->__9 = pEVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__EnterPlaySessionRoundCountDown____c->static_fields >> 0xc);
