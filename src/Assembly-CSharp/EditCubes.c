                                      ...
                                      if (uStack_39 != (Vector3__Array *)0x0) {
                                        ...
                                        if (pGVar43 != (GameObject *)0x0) {
                                          ...
                                          if (pTVar31 != (Transform *)0x0) {
                                            value.y._0_2_ = SUB42((float)uVar105 * fVar38,0);
                                            value.x = (float)uVar104 * fVar38;
                                            value.y._2_2_ =
...
code_?:
  func_?();
  *extraout_ECX =
       *extraout_ECX + (char)((uint)&stack0xfffffffc >> 8) +
       (CARRY1(-bVar74,extraout_DH) || CARRY1(-bVar74 + extraout_DH,bVar74));
  pcVar112 = (code *)swi(3);
  (*pcVar112)();
  return;
}
