...
code_?:
          ...
          if ((vertexList->fields)._size != 0) {
            ...
            while( true ) {
              ...
              fVar25 = (this->fields).left.r;
              fVar26 = (this->fields).left.g;
              fVar27 = (this->fields).left.b;
              fVar28 = (this->fields).left.a;
              ...
              fVar25 = (((this->fields).right.r - fVar25) * fVar29 + fVar25) *
                       ((float)(*(uint *)((longlong)&pUVar5->vector[0].color.rgba + lVar10) & 0xff)
                       / fVar2);
              fVar30 = (((this->fields).right.g - fVar26) * fVar29 + fVar26) *
                       ((float)(uVar4 >> 8 & 0xff) / fVar2);
              fVar27 = (((this->fields).right.b - fVar27) * fVar29 + fVar27) *
                       ((float)(uVar4 >> 0x10 & 0xff) / fVar2);
              fVar26 = (((this->fields).right.a - fVar28) * fVar29 + fVar28) *
      ...
      aCStack_23[0].r = (this->fields).left.r;
      aCStack_23[0].g = (this->fields).left.g;
      aCStack_23[0].b = (this->fields).left.b;
      aCStack_23[0].a = (this->fields).left.a;
      GradientEffectHorizontal_SetVertexColor(this,vertexList,0,aCStack_23,(MethodInfo *)0x0);
      aCStack_23[0].r = (this->fields).left.r;
      aCStack_23[0].g = (this->fields).left.g;
      aCStack_23[0].b = (this->fields).left.b;
      aCStack_23[0].a = (this->fields).left.a;
      GradientEffectHorizontal_SetVertexColor(this,vertexList,1,aCStack_23,(MethodInfo *)0x0);
      aCStack_23[0].r = (this->fields).right.r;
      aCStack_23[0].g = (this->fields).right.g;
      aCStack_23[0].b = (this->fields).right.b;
      aCStack_23[0].a = (this->fields).right.a;
      GradientEffectHorizontal_SetVertexColor(this,vertexList,2,aCStack_23,(MethodInfo *)0x0);
      aCStack_23[0].r = (this->fields).right.r;
      aCStack_23[0].g = (this->fields).right.g;
      aCStack_23[0].b = (this->fields).right.b;
      aCStack_23[0].a = (this->fields).right.a;
      GradientEffectHorizontal_SetVertexColor(this,vertexList,3,aCStack_23,(MethodInfo *)0x0);
      aCStack_23[0].r = (this->fields).right.r;
      aCStack_23[0].g = (this->fields).right.g;
      aCStack_23[0].b = (this->fields).right.b;
      aCStack_23[0].a = (this->fields).right.a;
      GradientEffectHorizontal_SetVertexColor(this,vertexList,4,aCStack_23,(MethodInfo *)0x0);
      aCStack_23[0].r = (this->fields).left.r;
      aCStack_23[0].g = (this->fields).left.g;
      aCStack_23[0].b = (this->fields).left.b;
      aCStack_23[0].a = (this->fields).left.a;
      GradientEffectHorizontal_SetVertexColor(this,vertexList,5,aCStack_23,(MethodInfo *)0x0);
    }
  }
  return;
}
