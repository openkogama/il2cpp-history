  ...
  if (this_00 != (List_1_UnityEngine_Vector2_ *)0x0) {
    ...
    *piVar6 = *piVar6 + 1;
    ...
    if (pVVar7 != (Vector2__Array *)0x0) {
      ...
      puVar10 = (undefined *)(fVar1 + (this->fields)._height * 4.4340444e-29);
      piVar6 = &(this_00->fields)._version;
      *piVar6 = *piVar6 + 1;
      pVVar7 = (this_00->fields)._items;
      if (pVVar7 != (Vector2__Array *)0x0) {
        ...
        MethodInfo__System__Collections__Generic__List<UnityEngine::Vector2>__Add_UnityEngine__Vector2_
        ;
        fVar2 = (float)puStack_5 * (this->fields)._baseRadius + 4.4340932e-29;
  ...
  if (this_00 != (List_1_UnityEngine_Vector2_ *)0x0) {
    ...
    *piVar10 = *piVar10 + 1;
    ...
    if (pVVar11 != (Vector2__Array *)0x0) {
      ...
      fVar7 = fStack_4 * (this->fields)._baseRadius + 4.4342545e-29;
      piVar10 = &(this_00->fields)._version;
      *piVar10 = *piVar10 + 1;
      pVVar11 = (this_00->fields)._items;
      if (pVVar11 != (Vector2__Array *)0x0) {
  ...
  if (this_00 != (List_1_UnityEngine_Vector2_ *)0x0) {
    ...
    *piVar8 = *piVar8 + 1;
    ...
    if (pVVar9 != (Vector2__Array *)0x0) {
      ...
      ;
      fStack_5 = VVar3.y;
      fVar2 = fStack_5 * (this->fields)._height + 4.434391e-29;
