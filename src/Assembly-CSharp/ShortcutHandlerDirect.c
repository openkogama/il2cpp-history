...
void Assembly-CSharp.dll::ShortcutHandlerDirect::ShortcutHandlerDirect_Callback
               (ShortcutHandlerDirect *this,MethodInfo *method)

{
  ...
  if ((pTVar1->fields).waitingForToggleCallback == 0) {
    cVar3 = (*(pTVar1->klass->vtable).CurrentToggleState.methodPtr)
                      (pTVar1,(pTVar1->klass->vtable).CurrentToggleState.method);
    pTVar4 = (pTVar1->fields).toggleHandler;
    ...
    if (pTVar4 != (ToggleHandler *)0x0) {
      if (*(int *)&(TypeInfo__UnityEngine__Object->_1).field_0x1c == 0) {
        FUN_?();
      }
      if ((pTVar4->fields)._._._._.m_CachedPtr != (void *)0x0) {
        pTVar4 = (pTVar1->fields).toggleHandler;
        (pTVar1->fields).waitingForToggleCallback = 1;
        uVar5 = FUN_?(TypeInfo__UnityEngine__Events__UnityAction<bool>);
        FUN_?(uVar5,pTVar1,MethodInfo__ToggleStatHandlerBase__ToggleCallback_bool_);
        if (pTVar4 == (ToggleHandler *)0x0) {
          FUN_?();
          pcVar2 = (code *)swi(3);
          (*pcVar2)();
        ...
        (*(pTVar4->klass->vtable).__unknown.methodPtr)
                  (pTVar4,(ulonglong)(cVar3 == '\0'),uVar5,(pTVar4->klass->vtable).__unknown.method)
        ;
      }
    }
  }
...
void Assembly-CSharp.dll::ShortcutHandlerDirect::ShortcutHandlerDirect_RegisterShortcutKey
               (ShortcutHandlerDirect *this,MethodInfo *method)

{
  if (cRam_? == '\0') {
    ...
    UNLOCK();
    FUN_?(&
                  MethodInfo__ShortcutHandlerDirect___RegisterShortcutKey_b__9_0_UnityEngine__EventSystems__IShortcutKeyRegister__UnityEngine__EventSystems__BaseEventData_
                 );
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
...
void Assembly-CSharp.dll::ShortcutHandlerDirect::ShortcutHandlerDirect_Reset
               (ShortcutHandlerDirect *this,MethodInfo *method)

{
  if (cRam_? == '\0') {
    FUN_?(&
                  ToggleStatHandlerBase_MethodInfo__UnityEngine__Component__GetComponent<ToggleStatHandlerBase>__
                 );
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
  pTVar1 = (ToggleStatHandlerBase *)
           UnityEngine.CoreModule.dll::UnityEngine::Component::Component_GetComponent_1
                     ((Component *)this,
                      ToggleStatHandlerBase_MethodInfo__UnityEngine__Component__GetComponent<ToggleStatHandlerBase>__
                     );
  bVar2 = iRam_? != 0;
  (this->fields).toggleStatHandlerBase = pTVar1;
  if (bVar2) {
    uVar3 = (uint)((ulonglong)&(this->fields).toggleStatHandlerBase >> 0xc);
...
void Assembly-CSharp.dll::ShortcutHandlerDirect::ShortcutHandlerDirect_UnRegisterShortcutKey
               (ShortcutHandlerDirect *this,MethodInfo *method)

{
  if (cRam_? == '\0') {
    ...
    UNLOCK();
    FUN_?(&
                  MethodInfo__ShortcutHandlerDirect___UnRegisterShortcutKey_b__10_0_UnityEngine__EventSystems__IShortcutKeyUnRegister__UnityEngine__EventSystems__BaseEventData_
                 );
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
...
void Assembly-CSharp.dll::ShortcutHandlerDirect::ShortcutHandlerDirect__RegisterShortcutKey_b__9_0
               (ShortcutHandlerDirect *this,IShortcutKeyRegister *x,BaseEventData *y,
               MethodInfo *method)

{
  ...
  NavMesh_OnNavMeshPreUpdate__ctor
            (this_00,(Object *)this,(this->klass->vtable).Callback.method,(MethodInfo *)0x0);
...
void Assembly-CSharp.dll::ShortcutHandlerDirect::
     ShortcutHandlerDirect__UnRegisterShortcutKey_b__10_0
               (ShortcutHandlerDirect *this,IShortcutKeyUnRegister *x,BaseEventData *y,
               MethodInfo *method)
...
/* ShortcutHandlerDirect() */

void Assembly-CSharp.dll::ShortcutHandlerDirect::ShortcutHandlerDirect__ctor
               (ShortcutHandlerDirect *this,MethodInfo *method)

{
  bVar1 = cRam_? == '\0';
  (this->fields).keyState = 1;
  if (bVar1) {
    FUN_?(&TypeInfo__UnityEngine__Object);
    LOCK();
    UNLOCK();
