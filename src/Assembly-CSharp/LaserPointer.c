  ...
  case 0:
    ...
    if (((pRVar5 != (Renderer *)0x0) &&
        (UnityEngine.CoreModule.dll::UnityEngine::Renderer::Renderer_set_sharedMaterial
                   (pRVar5,*unaff_EBX,(MethodInfo *)0x0), pMVar4 != (MVMaterial *)0x0)) &&
...
code_?:
  cVar10 = '\0';
  func_?();
  sVar11 = ((ushort)unaff_ESI & 3) - (*(ushort *)&unaff_ESI->klass & 3);
  *(ushort *)&unaff_ESI->klass = *(short *)&unaff_ESI->klass + (ushort)(0 < sVar11) * sVar11;
  *(char *)(unaff_EBX + -0xbbe673) = *(char *)(unaff_EBX + -0xbbe673) + extraout_AH + cVar10;
  pcVar12 = (code *)swi(3);
  (*pcVar12)();
  return;
}
