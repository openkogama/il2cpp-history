...

{
  ...
  DesktopCubeModelingToolsController::DesktopCubeModelingToolsController_SetButtonTransparency
...
code_?:
  ...
  if (cVar4 != '\0') {
    ...
    auStackX_10[0] = 0;
    value = (Object *)FUN_?(TypeInfo__CubeModelingEvent,auStackX_10);
...
{
  (this->fields)._._ActiveTool_k__BackingField = 4;
  DesktopCubeModelingToolsController::DesktopCubeModelingToolsController_SetButtonTransparency
