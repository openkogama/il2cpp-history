...

{
  ...
  if ((this_01 == (MVWorldObjectClientManager *)0x0) ||
     (this_02 = (MVBlueprintBase *)
                MVWorldObjectClientManager::MVWorldObjectClientManager_GetWorldObject
                          (this_01,woID,(MethodInfo *)0x0), this_02 == (MVBlueprintBase *)0x0))
  goto code_?;
  if (((this_02->klass->_1).typeHierarchyDepth < (TypeInfo__MVBlueprintBase->_1).typeHierarchyDepth)
     || ((MVBlueprintBase__Class *)
         (this_02->klass->_1).typeHierarchy[(TypeInfo__MVBlueprintBase->_1).typeHierarchyDepth - 1]
         != TypeInfo__MVBlueprintBase)) goto code_?;
  pMVar1 = MVBlueprintBase::MVBlueprintBase_GetChild
                     (this_02,StringLiteral_CollectableInstance,(MethodInfo *)0x0);
  if (((pMVar1 == (MVWorldObjectClient *)0x0) ||
      (pDVar2 = (pMVar1->fields)._.data, pDVar2 == (Dictionary_2_System_Object_System_Object_ *)0x0)
  ...
  this_03 = (Dictionary_2_System_Text_RegularExpressions_Regex_CachedCodeEntryKey_System_Object_ *)
            func_?();
  if (this_03 ==
...
code_?:
    ...
    SettingsBase::SettingsBase_Initialize
              (_UNK_?,0xADDR,(GameObject *)pDVar2,
    ...
    if ((pOVar3->klass->_0).element_class == (TypeInfo__System__Boolean->_0).element_class) {
      ...
      SettingsToggle::SettingsToggle_Initialize
                (this_00,StringLiteral_hasIndicator,*pbVar4,(MethodInfo *)0x0);
      return;
    }
  }
  func_?();
