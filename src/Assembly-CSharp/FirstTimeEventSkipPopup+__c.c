...

{
  ...
  pFVar1 = (FirstTimeEventSkipPopup_c *)FUN_?(TypeInfo__FirstTimeEventSkipPopup____c);
  TypeInfo__FirstTimeEventSkipPopup____c->static_fields->__9 = pFVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__FirstTimeEventSkipPopup____c->static_fields >> 0xc);
