...
code_?:
  ...
  while (iVar1 != 0) {
    iVar1 = iVar1 + -1;
    uVar12 = in(uVar10);
    *(undefined1 *)&this->klass = uVar12;
    this = (ScoreBoardSingleBase *)((int)&this->klass + 1);
  }
  cVar13 = (char)((uint6)uVar9 >> 0x20);
  *pcVar11 = *pcVar11 - cVar13;
  uVar12 = in(uVar10);
  *(undefined1 *)&this->klass = uVar12;
  *pcVar11 = *pcVar11 - cVar13;
  iVar1 = 0;
  while (this = (ScoreBoardSingleBase *)((int)&this->klass + 1), iVar1 != 0) {
    iVar1 = iVar1 + -1;
    uVar12 = in(uVar10);
    *(undefined1 *)&this->klass = uVar12;
  }
