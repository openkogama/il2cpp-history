...
code_?:
    ...
    pUVar3 = (pIVar2->fields).OnPageTurned;
...
code_?:
    ...
    (pIVar2->fields).OnPageTurned = pUVar3;
    iVar7 = func_?();
          ...
          while (pMVar7 = (pMVar6->fields)._MaterialRepository_k__BackingField,
            ...
            if (bVar8 != 0) {
              ...
              MaterialViewItem::MaterialViewItem_Initialize
                        (pMVar10,0xdd,bVar8 == 0,texture2D,isAvailable,(uint8_t)uVar5 == uVar11,
                         (MethodInfo *)0x0);
