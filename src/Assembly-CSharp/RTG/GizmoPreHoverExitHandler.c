...
IAsyncResult *
Assembly-CSharp.dll::RTG::GizmoPreHoverExitHandler::GizmoPreHoverExitHandler_BeginInvoke
          (GizmoPreHoverExitHandler *this,Gizmo *gizmo,int32_t handleId,AsyncCallback *callback,
