...
code_?:
    ...
    pMVar4 = UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_get_localToWorldMatrix
                        ((Matrix4x4 *)&stack0xffffff00,pTVar3,(MethodInfo *)0x0);
    fVar5 = pMVar4->m00;
    fVar6 = pMVar4->m10;
    fVar7 = pMVar4->m20;
    fVar8 = pMVar4->m30;
    ...
    (pMVar21->localToWorld).m00 = fVar5;
    (pMVar21->localToWorld).m10 = fVar6;
    ...
    (pMVar21->worldToLocal).m12 = fVar5;
    (pMVar21->worldToLocal).m22 = fVar6;
    (pMVar21->worldToLocal).m32 = fVar7;
    (pMVar21->worldToLocal).m03 = fVar8;
    (pMVar21->worldToLocal).m13 = fVar9;
    (pMVar21->worldToLocal).m23 = fVar10;
    (pMVar21->worldToLocal).m33 = fVar11;
    pMVar4 = UnityEngine.CoreModule.dll::UnityEngine::Matrix4x4::Matrix4x4_TRS
                        ((Matrix4x4 *)&stack0xffffff00,position,rotation,radius,(MethodInfo *)0x0);
    fVar13 = pMVar4->m10;
    fVar14 = pMVar4->m20;
    fVar15 = pMVar4->m30;
    fVar16 = pMVar4->m01;
    ...
    (pMVar21->elipsoidSpaceToWorld).m12 = fVar5;
    (pMVar21->elipsoidSpaceToWorld).m22 = fVar6;
    (pMVar21->elipsoidSpaceToWorld).m32 = fVar7;
    (pMVar21->elipsoidSpaceToWorld).m03 = fVar8;
    (pMVar21->elipsoidSpaceToWorld).m13 = fVar9;
    (pMVar21->elipsoidSpaceToWorld).m23 = fVar10;
    (pMVar21->elipsoidSpaceToWorld).m33 = fVar11;
    pMVar4 = UnityEngine.CoreModule.dll::UnityEngine::Matrix4x4::Matrix4x4_get_inverse
                        ((Matrix4x4 *)&stack0xffffff00,
    ...
    (pMVar21->worldToElipsoidSpace).m12 = fVar5;
    (pMVar21->worldToElipsoidSpace).m22 = fVar6;
    (pMVar21->worldToElipsoidSpace).m32 = fVar7;
    (pMVar21->worldToElipsoidSpace).m03 = fVar8;
    (pMVar21->worldToElipsoidSpace).m13 = fVar9;
    (pMVar21->worldToElipsoidSpace).m23 = fVar10;
    (pMVar21->worldToElipsoidSpace).m33 = fVar11;
    ...
    (pMVar21->localToElipsoidSpace).m12 = fVar5;
    (pMVar21->localToElipsoidSpace).m22 = fVar6;
    (pMVar21->localToElipsoidSpace).m32 = fVar7;
    (pMVar21->localToElipsoidSpace).m03 = fVar8;
    (pMVar21->localToElipsoidSpace).m13 = fVar9;
    (pMVar21->localToElipsoidSpace).m23 = fVar10;
    (pMVar21->localToElipsoidSpace).m33 = fVar11;
    pVVar22 = UnityEngine.CoreModule.dll::UnityEngine::Matrix4x4::Matrix4x4_MultiplyPoint
    ...
    fVar13 = pVVar22->z;
    pMVar21 = TypeInfo__MVElipsoidOverlapCheck->static_fields;
    (pMVar21->localElipsoidPosition).x = pVVar22->x;
    ...
    fVar12 = (float)*puVar23 * _UNK_?;
    fVar24 = *(float *)(puVar23 + 1) * _UNK_?;
    fVar25 = (float)((ulonglong)*puVar23 >> 0x20) * _UNK_?;
    s.y = radius.y + fVar25;
    s.x = radius.x + fVar12;
    s.z = radius.z + fVar24;
    pMVar4 = UnityEngine.CoreModule.dll::UnityEngine::Matrix4x4::Matrix4x4_TRS
                        ((Matrix4x4 *)&stack0xffffff00,position,rotation,s,(MethodInfo *)0x0);
    fVar13 = pMVar4->m10;
    fVar14 = pMVar4->m20;
    fVar15 = pMVar4->m30;
    fVar16 = pMVar4->m01;
    ...
    (pMVar21->radiusExtendedElipsoidSpaceToWorld).m12 = fVar5;
    (pMVar21->radiusExtendedElipsoidSpaceToWorld).m22 = fVar6;
    (pMVar21->radiusExtendedElipsoidSpaceToWorld).m32 = fVar7;
    (pMVar21->radiusExtendedElipsoidSpaceToWorld).m03 = fVar8;
    (pMVar21->radiusExtendedElipsoidSpaceToWorld).m13 = fVar9;
    (pMVar21->radiusExtendedElipsoidSpaceToWorld).m23 = fVar10;
    (pMVar21->radiusExtendedElipsoidSpaceToWorld).m33 = fVar11;
    pMVar4 = UnityEngine.CoreModule.dll::UnityEngine::Matrix4x4::Matrix4x4_get_inverse
                        ((Matrix4x4 *)&stack0xffffff00,
    ...
    (pMVar21->worldToRadiusExtendedElipsoidSpace).m12 = fVar5;
    (pMVar21->worldToRadiusExtendedElipsoidSpace).m22 = fVar6;
    (pMVar21->worldToRadiusExtendedElipsoidSpace).m32 = fVar7;
    (pMVar21->worldToRadiusExtendedElipsoidSpace).m03 = fVar8;
    (pMVar21->worldToRadiusExtendedElipsoidSpace).m13 = fVar9;
    (pMVar21->worldToRadiusExtendedElipsoidSpace).m23 = fVar10;
    (pMVar21->worldToRadiusExtendedElipsoidSpace).m33 = fVar11;
    pMVar4 = UnityEngine.CoreModule.dll::UnityEngine::Matrix4x4::Matrix4x4_op_Multiply
                        ((Matrix4x4 *)&stack0xffffff00,
                         TypeInfo__MVElipsoidOverlapCheck->static_fields->
    ...
    (pMVar21->localToRadiusExtendedElipsoidSpace).m12 = fVar5;
    (pMVar21->localToRadiusExtendedElipsoidSpace).m22 = fVar6;
    (pMVar21->localToRadiusExtendedElipsoidSpace).m32 = fVar7;
    (pMVar21->localToRadiusExtendedElipsoidSpace).m03 = fVar8;
    (pMVar21->localToRadiusExtendedElipsoidSpace).m13 = fVar9;
    (pMVar21->localToRadiusExtendedElipsoidSpace).m23 = fVar10;
    (pMVar21->localToRadiusExtendedElipsoidSpace).m33 = fVar11;
    if (((radius.x - fVar12 <= 0.0) || (radius.y - fVar25 <= 0.0)) || (radius.z - fVar24 <= 0.0)) {
      if ((TypeInfo__MVElipsoidOverlapCheck->_1).cctor_finished_or_no_cctor == 0) {
      ...
      s_00.y = radius.y - fVar25;
      s_00.x = radius.x - fVar12;
      s_00.z = radius.z - fVar24;
      pMVar4 = UnityEngine.CoreModule.dll::UnityEngine::Matrix4x4::Matrix4x4_TRS
                          ((Matrix4x4 *)&stack0xffffff00,position,rotation,s_00,(MethodInfo *)0x0);
      fVar5 = pMVar4->m00;
      fVar6 = pMVar4->m10;
      fVar7 = pMVar4->m20;
      puVar26 = (undefined *)pMVar4->m30;
      fVar8 = pMVar4->m01;
      fVar9 = pMVar4->m11;
      fVar10 = pMVar4->m21;
      fVar11 = pMVar4->m31;
      ...
      pMVar21 = TypeInfo__MVElipsoidOverlapCheck->static_fields;
      (pMVar21->radiusReducedElipsoidSpaceToWorld).m00 = fVar5;
      (pMVar21->radiusReducedElipsoidSpaceToWorld).m10 = fVar6;
      (pMVar21->radiusReducedElipsoidSpaceToWorld).m20 = fVar7;
      (pMVar21->radiusReducedElipsoidSpaceToWorld).m30 = (float)puVar26;
      (pMVar21->radiusReducedElipsoidSpaceToWorld).m01 = fVar8;
      (pMVar21->radiusReducedElipsoidSpaceToWorld).m11 = fVar9;
      (pMVar21->radiusReducedElipsoidSpaceToWorld).m21 = fVar10;
      (pMVar21->radiusReducedElipsoidSpaceToWorld).m31 = fVar11;
      ...
      (pMVar21->worldToRadiusReducedElipsoidSpace).m12 = fVar5;
      (pMVar21->worldToRadiusReducedElipsoidSpace).m22 = fVar6;
      (pMVar21->worldToRadiusReducedElipsoidSpace).m32 = fVar7;
      (pMVar21->worldToRadiusReducedElipsoidSpace).m03 = fVar8;
      (pMVar21->worldToRadiusReducedElipsoidSpace).m13 = fVar9;
      (pMVar21->worldToRadiusReducedElipsoidSpace).m23 = fVar10;
      (pMVar21->worldToRadiusReducedElipsoidSpace).m33 = fVar11;
      ...
      (pMVar21->localToRadiusReducedElipsoidSpace).m12 = fVar5;
      (pMVar21->localToRadiusReducedElipsoidSpace).m22 = fVar6;
      (pMVar21->localToRadiusReducedElipsoidSpace).m32 = fVar7;
      (pMVar21->localToRadiusReducedElipsoidSpace).m03 = fVar8;
      (pMVar21->localToRadiusReducedElipsoidSpace).m13 = fVar9;
      (pMVar21->localToRadiusReducedElipsoidSpace).m23 = fVar10;
      (pMVar21->localToRadiusReducedElipsoidSpace).m33 = fVar11;
    ...
    fVar15 = pVVar22->z;
    iVar33 = func_?();
    tangent0.y = (float)uVar28;
    tangent0.x = (float)uVar27;
    tangent0.z = fVar13;
    tangent1.y = (float)uVar32;
    tangent1.x = (float)uVar31;
    tangent1.z = fVar15;
    iVar1 = iVar33;
    pVVar22 = MVElipsoidOverlapCheck_GetTangentNormal
                        ((Vector3 *)&stack0xffffffd0,tangent0,tangent1,(MethodInfo *)0x0);
    if (iVar33 == 0) goto code_?;
    fVar16 = pVVar22->z;
    if (*(int *)(iVar33 + 0xc) != 0) {
      *(undefined8 *)(iVar33 + 0x10) = *(undefined8 *)pVVar22;
      *(float *)(iVar33 + 0x18) = fVar16;
      tangent0_00.y = (float)uVar30;
      tangent0_00.x = (float)uVar29;
      tangent0_00.z = fVar14;
      tangent1_00.y = (float)uVar32;
      tangent1_00.x = (float)uVar31;
      tangent1_00.z = fVar15;
      pVVar22 = MVElipsoidOverlapCheck_GetTangentNormal
                          ((Vector3 *)&stack0xffffffd0,tangent0_00,tangent1_00,(MethodInfo *)0x0);
      fVar15 = pVVar22->z;
      if (1 < *(uint *)(iVar33 + 0xc)) {
        *(undefined8 *)(iVar33 + 0x1c) = *(undefined8 *)pVVar22;
        *(float *)(iVar33 + 0x24) = fVar15;
        tangent0_01.y = (float)uVar30;
        tangent0_01.x = (float)uVar29;
        tangent0_01.z = fVar14;
        tangent1_01.y = (float)uVar28;
        tangent1_01.x = (float)uVar27;
        tangent1_01.z = fVar13;
        pVVar22 = MVElipsoidOverlapCheck_GetTangentNormal
                            ((Vector3 *)&stack0xffffffd0,tangent0_01,tangent1_01,(MethodInfo *)0x0);
        fVar13 = pVVar22->z;
        if (2 < *(uint *)(iVar33 + 0xc)) {
          bVar34 = cRam_? == '\0';
          *(undefined8 *)(iVar33 + 0x28) = *(undefined8 *)pVVar22;
          *(float *)(iVar33 + 0x30) = fVar13;
          if (bVar34) {
            func_?();
            cRam_? = '\x01';
          }
          pVVar22 = (Vector3 *)(iVar33 + 0x10);
          for (uVar35 = 0; (int)uVar35 < *(int *)(iVar33 + 0xc); uVar35 = uVar35 + 1) {
            if ((TypeInfo__MVElipsoidOverlapCheck->_1).cctor_finished_or_no_cctor == 0) {
              func_?(TypeInfo__MVElipsoidOverlapCheck);
            }
            if (*(uint *)(iVar33 + 0xc) <= uVar35) goto code_?;
            pVVar36 = UnityEngine.CoreModule.dll::UnityEngine::Matrix4x4::Matrix4x4_MultiplyVector
                                ((Vector3 *)&stack0xffffffd0,
                                 &TypeInfo__MVElipsoidOverlapCheck->static_fields->worldToLocal,
                                 *pVVar22,(MethodInfo *)0x0);
            fVar14 = pVVar36->y;
            fVar13 = pVVar36->z;
            if (*(uint *)(iVar33 + 0xc) <= uVar35) goto code_?;
            pVVar22->x = pVVar36->x;
          ...
          fVar14 = 0.0;
          while( true ) {
            if (*(int *)(iVar33 + 0xc) <= (int)uVar35) {
              pVVar22 = UnityEngine.CoreModule.dll::UnityEngine::Matrix4x4::Matrix4x4_MultiplyPoint
                                  ((Vector3 *)&stack0xffffffd0,
                                   &TypeInfo__MVElipsoidOverlapCheck->static_fields->worldToLocal,
                                   position,(MethodInfo *)0x0);
              localElipsoidBounds.m_Extents.x = fStack_39;
              localElipsoidBounds.m_Center = *pVVar22;
              localElipsoidBounds.m_Extents.y = fStack_37;
              localElipsoidBounds.m_Extents.z = fStack_38;
              bVar40 = MVElipsoidOverlapCheck_ScanElipsoidBounds
                                 (localElipsoidBounds,chunk,cmb,elipsoidOverlapResult,
                                  (MethodInfo *)0x0);
              return bVar40;
            }
            if (*(uint *)(iVar33 + 0xc) <= uVar35) break;
            index = 0;
            iVar33 = iVar1;
            do {
              ...
              if (fVar15 < (float)((uint)fVar16 & _UNK_?)) {
                ...
                UnityEngine.CoreModule.dll::UnityEngine::Vector3::Vector3_set_Item
                          ((Vector3 *)&stack0xffffff74,index,(float)((uint)fVar15 & _UNK_?),
                           (MethodInfo *)0x0);
                fVar13 = fStack_39;
                fVar14 = fStack_37;
              }
