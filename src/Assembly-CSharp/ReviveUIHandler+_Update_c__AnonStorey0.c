...
void Assembly-CSharp.dll::ReviveUIHandler+<Update>c__AnonStorey0::
     ReviveUIHandler_Update_c_AnonStorey0___m__0
               (ReviveUIHandler_Update_c_AnonStorey0 *this,IUIStack *x,BaseEventData *y,
               MethodInfo *method)
