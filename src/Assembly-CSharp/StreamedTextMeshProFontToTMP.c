...
void Assembly-CSharp.dll::StreamedTextMeshProFontToTMP::StreamedTextMeshProFontToTMP_OnAssetSet
               (StreamedTextMeshProFontToTMP *this,MethodInfo *method)
...
void Assembly-CSharp.dll::StreamedTextMeshProFontToTMP::StreamedTextMeshProFontToTMP_Start
               (StreamedTextMeshProFontToTMP *this,MethodInfo *method)

{
  if (cRam_? == '\0') {
    FUN_?(&
                  TMPro__TextMeshPro_MethodInfo__UnityEngine__Component__GetComponent<TMPro::TextMeshPro>__
                 );
    LOCK();
    UNLOCK();
...
/* StreamedTextMeshProFontToTMP() */

void Assembly-CSharp.dll::StreamedTextMeshProFontToTMP::StreamedTextMeshProFontToTMP__ctor
               (StreamedTextMeshProFontToTMP *this,MethodInfo *method)
