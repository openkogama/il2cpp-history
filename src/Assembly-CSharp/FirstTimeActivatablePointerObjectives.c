...
{
  if (cRam_? == '\0') {
    FUN_?(&TypeInfo__FirstTimeActivatablePointerObjectives___CreateBubble_d__15);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
...

{
  ...
  if (this != (FirstTimeActivatablePointerObjectives *)0x0) {
...

{
  ...
  lVar2 = FUN_?(TypeInfo__FirstTimeActivatablePointerObjectives___CreateBubble_d__15);
  bVar1 = iRam_? != 0;
  *(undefined4 *)(lVar2 + 0x10) = 0;
  *(FirstTimeActivatablePointerObjectives **)(lVar2 + 0x20) = this;
  if (bVar1) {
  ...
  OVar11.m_CachedPtr = (this->fields)._._._._._._.m_CachedPtr;
  if (OVar11.m_CachedPtr == (void *)0x0) {
  ...
  pcRam_? = pcVar9;
                    /* WARNING: Could not recover jumptable at 0xADDR. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*pcRam_?)(OVar11.m_CachedPtr,lVar2);
  return;
}
  ...
  if ((this->fields).visible != 0) {
    ...
    if ((this->fields).isUpdating != 0) {
      ...
      if ((this->fields).visibleDuration <= fVar2) {
        ...
        FirstTimeEventManager::FirstTimeEventManager_SetFirstTimeEvent
                  ((this->fields)._._.firstTimeEvent,(MethodInfo *)0x0);
        FirstTimeActivatablePointerObjectives_Destroy(this,(MethodInfo *)0x0);
      }
    }
  }
  return;
