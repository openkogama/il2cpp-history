...

{
  ...
  if (((pMVar1 != (MVGameControllerBase *)0x0) &&
    ...
    bVar5 = iRam_? != 0;
    (this->fields).killClient = pKVar4;
    if (bVar5) {
      uVar6 = (uint)((ulonglong)&(this->fields).killClient >> 0xc);
...

{
  ...
  GameMeterKillBase::GameMeterKillBase_SetCount
            ((GameMeterKillBase *)this,
             (GameStatCounterType__Enum)CONCAT71((int7)((ulonglong)method >> 8),1),
  ...
  if (((pMVar1 != (MVGameControllerBase *)0x0) &&
    ...
    if (this_01 != (MVLocalPlayer *)0x0) {
      iVar4 = MVPlayer::MVPlayer_GetGameStat
                        ((MVPlayer *)this_01,
                         (GameStatCounterType__Enum)CONCAT71((int7)((ulonglong)uVar3 >> 8),1),
                         (MethodInfo *)0x0);
