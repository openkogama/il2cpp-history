...

{
  ...
  pAVar1 = (AvatarAccessoryErrorPopup_c *)FUN_?(TypeInfo__AvatarAccessoryErrorPopup____c);
  TypeInfo__AvatarAccessoryErrorPopup____c->static_fields->__9 = pAVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__AvatarAccessoryErrorPopup____c->static_fields >> 0xc);
