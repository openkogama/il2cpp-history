    ...
    if ((pSVar5->fields)._wireMode == 0) {
      ...
      if (pMVar10 != (MeshPool *)0x0) {
        ...
        if (pMVar10 != (MeshPool *)0x0) {
          ...
          pos_00.x = fStack_51;
          pos_00.z = fVar15;
          q_00.y = (fVar29 * in_stack_54 + fVar12 * in_stack_45 +
                   pQVar53->x * in_stack_46) - fVar28 * in_stack_55;
          q_00.x = (fVar29 * in_stack_55 + pQVar53->x * in_stack_45 +
                   fVar28 * in_stack_54) - fVar12 * in_stack_46;
          q_00.z = (fVar29 * in_stack_46 + fVar28 * in_stack_45 +
                   fVar12 * in_stack_55) - pQVar53->x * in_stack_54;
          q_00.w = ((fVar29 * in_stack_45 - pQVar53->x * in_stack_55) -
                   fVar12 * in_stack_54) - fVar28 * in_stack_46;
          s_00.y = fStack_49;
          s_00.x = fStack_48;
          s_00.z = fStack_50;
          ...
          if (pMVar10 != (MeshPool *)0x0) {
            ...
            fStack_4 = (fVar29 * fVar6 + pQVar53->x * (float)uStack_20 + fVar28 * fVar9) -
                        fVar12 * fVar8;
            QStack_2.x = (fVar29 * fVar9 + fVar12 * (float)uStack_20 + pQVar53->x * fVar8) -
                          fVar28 * fVar6;
            QStack_2.y = (fVar29 * fVar8 + fVar28 * (float)uStack_20 + fVar12 * fVar6) -
                          pQVar53->x * fVar9;
            puStack_57 = (undefined *)fStack_4;
            fVar6 = ((fVar29 * (float)uStack_20 - pQVar53->x * fVar6) - fVar12 * fVar9) -
                     fVar28 * fVar8;
            QStack_2.z = fVar6;
            pos_02.y = fStack_58;
            pos_02.x = fStack_59;
...
code_?:
      ...
      uStack_20._0_4_ = (float)auStack_19._4_4_ + QStack_2.x * fStack_7;
      pSVar5 = (this->fields)._wireRenderDesc;
      if (pSVar5 != (SphereShape3D_WireRenderDescriptor *)0x0) {
        iVar67 = 0;
        ...
        do {
          ...
          fVar28 = ((float)pGVar66 - fVar12 * QStack_2.z * fVar6) - fVar9;
          fVar29 = ((float)puVar32 - fVar12 * QStack_2.w * fVar6) - fVar8;
          fVar12 = ((float)uStack_20 - fVar12 * fStack_3 * fVar6) - (float)pMVar14;
      ...
      do {
        ...
        q.z = (in_stack_69 * fVar30 + fVar29 * in_stack_72 + fVar28 * in_stack_73)
              - in_stack_71 * pQVar53->x;
        ...
        s.z = fStack_51;
        pMVar16 = UnityEngine.CoreModule.dll::UnityEngine::Matrix4x4::Matrix4x4_TRS
                           ((Matrix4x4 *)((int)register0x00000010 + -0xd4),pos,q,s,(MethodInfo *)0x0
                           );
        fVar28 = pMVar16->m30;
...

{
  ...
  *(SphereShape3D_WireRenderDescriptor **)method_00 = value;
