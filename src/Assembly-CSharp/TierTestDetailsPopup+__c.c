...

{
  ...
  pTVar1 = (TierTestDetailsPopup_c *)FUN_?(TypeInfo__TierTestDetailsPopup____c);
  TypeInfo__TierTestDetailsPopup____c->static_fields->__9 = pTVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__TierTestDetailsPopup____c->static_fields >> 0xc);
