  ...
  if (selectionSet != (HashSet_1_System_Int32_ *)0x0) {
    pHVar4 = System.Core.dll::System::Collections::Generic::HashSet`1[System::UInt32]::
             HashSet_1_System_UInt32__GetEnumerator
                       ((HashSet_1_T_Enumerator_System_UInt32_ *)&stack0xffffffd8,
                        (HashSet_1_System_UInt32_ *)selectionSet,
    ...
    do {
      ...
      bVar5 = MVNetworkSelector_OwnershipTest(id,(MethodInfo *)0x0);
    } while (bVar5 != 0);
    uStack_1 = 0xffffffff;
    mscorlib.dll::System::ThrowHelper::ThrowHelper_1_IfNullAndNullsAreIllegalThenThrow_57
              ((Object *)&stack0xffffffc8,
  ...
  pHVar6 = System.Core.dll::System::Collections::Generic::HashSet`1[System::UInt32]::
           HashSet_1_System_UInt32__GetEnumerator
                     ((HashSet_1_T_Enumerator_System_UInt32_ *)&stack0xffffffd8,
                      ...
                      MethodInfo__System__Collections__Generic__HashSet<int>__GetEnumerator__);
  uStack_1 = 1;
  puVar7 = (undefined *)pHVar6->_current;
code_?:
  id = puVar7;
...

{
  ...
  this_00 = (Delegate *)func_?(TypeInfo__System__Collections__Generic__Queue<int>);
