...

{
  ...
  if ((pTVar1 != (TabMenu *)0x0) &&
    ...
    FirstTimeGuiHandler::FirstTimeGuiHandler_OpenTab(pFVar2,pGVar3,10,(MethodInfo *)0x0);
                            ...
                            ((Component *)this_00,(MethodInfo *)0x0), this_01 != (Transform *)0x0))
    {
      ...
      if ((pTVar1 != (TabMenu *)0x0) &&
        ...
        iVar4 = FirstTimeGuiHandler::FirstTimeGuiHandler_GetItemSlot
                          (pFVar2,MVWorldObjectDocumentationType__Enum_TriggerCube,pGVar3,10,
        ...
        if ((pTVar1 != (TabMenu *)0x0) &&
          ...
          FirstTimeGuiHandler::FirstTimeGuiHandler_HighlightInCategoryAtSlot
                    (pFVar2,pGVar3,10,iVar4,(MethodInfo *)0x0);
          return;
        }
      }
    }
...
{
  if (cRam_? == '\0') {
    pFStack_1 = (FirstTimeActivatableTriggerAreaInventoryHighlight *)
  ...
  pFStack_1 = (FirstTimeActivatableTriggerAreaInventoryHighlight *)&stack0xfffffffc;
    ...
    if (pGVar2 != (GameObject *)0x0) {
      ...
      if (this_01 != (InventorySlots *)0x0) {
        ...
        if (this_02 != (Transform *)0x0) {
          ...
          bVar6 = MVGameControllerBase::MVGameControllerBase_IsInCorrectInventory
