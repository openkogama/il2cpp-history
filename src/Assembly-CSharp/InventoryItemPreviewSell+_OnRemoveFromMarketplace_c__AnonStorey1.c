...
void Assembly-CSharp.dll::InventoryItemPreviewSell+<OnRemoveFromMarketplace>c__AnonStorey1::
     InventoryItemPreviewSell_OnRemoveFromMarketplace_c_AnonStorey1___m__0
               (InventoryItemPreviewSell_OnRemoveFromMarketplace_c_AnonStorey1 *this,
