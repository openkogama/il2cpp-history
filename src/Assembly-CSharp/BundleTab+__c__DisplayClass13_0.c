...
void Assembly-CSharp.dll::BundleTab+<>c__DisplayClass13_0::
     BundleTab_c_DisplayClass13_0__Initialize_b__0
               (BundleTab_c_DisplayClass13_0 *this,MethodInfo *method)

{
  if (cRam_? == '\0') {
    ...
    func_?(&
                    MethodInfo__BundleTab____c__DisplayClass13_0___Initialize_b__1_UnityEngine__EventSystems__ITabSelected__UnityEngine__EventSystems__BaseEventData_
                   );
    cRam_? = '\x01';
  }
...
void Assembly-CSharp.dll::BundleTab+<>c__DisplayClass13_0::
     BundleTab_c_DisplayClass13_0__Initialize_b__1
               (BundleTab_c_DisplayClass13_0 *this,ITabSelected *x,BaseEventData *y,
               MethodInfo *method)
