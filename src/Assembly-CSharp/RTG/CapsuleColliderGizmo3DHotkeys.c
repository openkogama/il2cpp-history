...
/* CapsuleColliderGizmo3DHotkeys() */

void Assembly-CSharp.dll::RTG::CapsuleColliderGizmo3DHotkeys::CapsuleColliderGizmo3DHotkeys__ctor
               (CapsuleColliderGizmo3DHotkeys *this,MethodInfo *method)
