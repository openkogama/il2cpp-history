...

{
  ...
  if (TypeInfo__GoogleMobileAds__Api__Mediation__AppLovin__AppLovin->static_fields->client !=
      (IAppLovinClient *)0x0) {
    pIStack_1 = TypeInfo__GoogleMobileAds__Common__Mediation__AppLovin__IAppLovinClient;
