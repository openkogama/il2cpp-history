...
code_?:
    ...
    TVar5.m_Index = extraout_EDX_00;
code_?:
    func_?(TVar5.m_Index,unaff_ESI.m_Index);
    pIVar6 = extraout_ECX;
  }
  else {
    ...
    cVar2 = '\0';
    uVar3 = TVar5.m_Index < 0;
    if (TVar5.m_Index == 0) goto code_?;
    pIVar7 = *(Il2CppClass **)(*(int *)TVar5.m_Index + 0x20);
    pIVar8 = (TypeInfo__System__Int32->_0).element_class;
    cVar2 = pIVar7 < pIVar8;
    uVar3 = (int)pIVar7 - (int)pIVar8 < 0;
    pIVar6 = TypeInfo__System__Int32;
    if (pIVar7 != pIVar8) {
code_?:
      func_?(TVar5.m_Index,pIVar6);
      goto code_?;
    }
    piVar9 = (int *)func_?(TVar5.m_Index);
    iVar10 = *piVar9;
    if (0xab < iVar10) {
      if (iVar10 == 0xb4) {
...
code_?:
      ...
      if (TVar5.m_Index != 0) {
        ...
        if (pMVar12 != (MVNetworkGame *)0x0) {
          ...
          if (pMVar13 != (MVLocalPlayer *)0x0) {
            if ((Dictionary_2_System_Object_System_Object___Class *)unaff_ESI.m_Index ==
                (Dictionary_2_System_Object_System_Object___Class *)
                (pMVar13->fields)._._ActorNr_k__BackingField) {
            ...
            if ((Dictionary_2_System_Object_System_Object___Class *)unaff_ESI.m_Index !=
                (Dictionary_2_System_Object_System_Object___Class *)0xffffffff) {
    ...
    case 7:
      ...
      pMVar14 = (MVSpawnPointBlue *)func_?(TypeInfo__MVSpawnPointBlue);
      MVSpawnPointBlue::MVSpawnPointBlue__ctor(pMVar14,this,worldObjects,(MethodInfo *)0x0);
      return (MVWorldObjectClient *)pMVar14;
    case 8:
      this_08 = (MVCubeModelPrototypeTerrain *)
                func_?(TypeInfo__MVCubeModelPrototypeTerrain);
    ...
    case 0x2d:
      ...
      bVar15 = (TypeInfo__System__Collections__Generic__Dictionary<System::Object,_System::Object>->
              _1).naturalAligment;
      bVar16 = *(byte *)(*(int *)TVar5.m_Index + 0xb8);
      cVar2 = bVar16 < bVar15;
      uVar3 = (char)(bVar16 - bVar15) < '\0';
      if (!(bool)cVar2) {
        pDVar4 = *(Dictionary_2_System_Object_System_Object___Class **)
                   (*(int *)(*(int *)TVar5.m_Index + 100) + -4 + (uint)bVar15 * 4);
        cVar2 = pDVar4 < 
                 TypeInfo__System__Collections__Generic__Dictionary<System::Object,_System::Object>;
        uVar3 = (int)pDVar4 -
                 (int)
        ...
        unaff_ESI = mscorlib.dll::System::Collections::Generic::Dictionary`2[System::
                    Object,UnityEngine::UIElements::TextureId]::
                    Dictionary_2_System_Object_UnityEngine_UIElements_TextureId__get_Item
                              (TVar5.m_Index,(Object *)StringLiteral_BlueprintData,
                               MethodInfo__System__Collections__Generic__Dictionary<System::Object,_System::Object>__get_Item_System__Object_
                              );
        ...
        bVar15 = (TypeInfo__System__Collections__Generic__Dictionary<System::Object,_System::Object>
                ->_1).naturalAligment;
        bVar16 = *(byte *)(*(int *)unaff_ESI.m_Index + 0xb8);
        cVar2 = bVar16 < bVar15;
        uVar3 = (char)(bVar16 - bVar15) < '\0';
        ...
        if (!(bool)cVar2) {
          pDVar18 = *(Dictionary_2_System_Object_System_Object___Class **)
                    (*(int *)(*(int *)unaff_ESI.m_Index + 100) + -4 + (uint)bVar15 * 4);
          cVar2 = pDVar18 < 
                   TypeInfo__System__Collections__Generic__Dictionary<System::Object,_System::Object>
          ;
          uVar3 = (int)pDVar18 -
          ...
          if (pDVar18 == 
            ...
            TVar5 = mscorlib.dll::System::Collections::Generic::Dictionary`2[System::
                     Object,UnityEngine::UIElements::TextureId]::
                     Dictionary_2_System_Object_UnityEngine_UIElements_TextureId__get_Item
                               (unaff_ESI.m_Index,(Object *)pSVar17,
                                MethodInfo__System__Collections__Generic__Dictionary<System::Object,_System::Object>__get_Item_System__Object_
                               );
            cVar2 = '\0';
            uVar3 = TVar5.m_Index < 0;
            if (TVar5.m_Index != 0) {
              ...
              cVar2 = pIVar7 < pIVar8;
              uVar3 = (int)pIVar7 - (int)pIVar8 < 0;
              pIVar6 = (Int32__Class *)TypeInfo__MV__WorldObject__BlueprintType;
              if (pIVar7 == pIVar8) {
                puVar19 = (undefined1 *)func_?(TVar5.m_Index);
                switch(*puVar19) {
                case 7:
                ...
                case 0xb:
                  ...
                  MVMovingPlatform::MVMovingPlatform__ctor
                            (this_36,this,worldObjects,(MethodInfo *)0x0);
                  return (MVWorldObjectClient *)this_36;
                case 0xc:
                  this_37 = (MVMovingPlatformGroup *)
                            func_?(TypeInfo__MVMovingPlatformGroup);
...
code_?:
    ...
    case 0x39:
      this_50 = (MVWorldObjectSpawnerVehicle *)
                func_?(TypeInfo__MVWorldObjectSpawnerVehicle);
    ...
    default:
      ...
      case 0x85:
        ...
        iVar10 = (pMVar13->fields)._._ActorNr_k__BackingField;
        cVar2 = '\0';
        uVar3 = unaff_ESI.m_Index < 0;
        if (unaff_ESI.m_Index == 0) goto code_?;
        pIVar7 = *(Il2CppClass **)(*(int *)unaff_ESI.m_Index + 0x20);
        pIVar8 = (TypeInfo__System__Int32->_0).element_class;
        cVar2 = pIVar7 < pIVar8;
        uVar3 = (int)pIVar7 - (int)pIVar8 < 0;
        pIVar6 = TypeInfo__System__Int32;
      ...
      case 0x9a:
        pMVar20 = (MVCostumeBaseBlueprint *)
                  func_?(
                                 TypeInfo__Assets__Scripts__WorldObjectTypes__MeleeWeapon__MVMeleeWeaponBaseBlueprint
                                 );
        Assets::Scripts::WorldObjectTypes::Costume::MVCostumeBaseBlueprint::
        MVCostumeBaseBlueprint__ctor(pMVar20,this,worldObjects,(MethodInfo *)0x0);
  ...
  func_?(unaff_ESI.m_Index,pIVar6);
  LOCK();
  uVar21 = *(undefined1 *)(extraout_ECX_00 + 0x10);
  *(undefined1 *)(extraout_ECX_00 + 0x10) = (char)extraout_EDX_01;
  UNLOCK();
  if ((bool)uVar3) {
    *(char *)(extraout_ECX_00 + -0x39efae79) =
         *(char *)(extraout_ECX_00 + -0x39efae79) + extraout_AH + cVar2;
    LOCK();
    *(uint *)(extraout_ECX_00 + 0x10) = CONCAT31((int3)((uint)extraout_EDX_01 >> 8),uVar21);
    UNLOCK();
                    /* WARNING: Bad instruction - Truncating control flow here */
    halt_baddata();
  }
code_?:
  pSVar17 = mscorlib.dll::System::Enum::Enum_ToString((Enum *)&stack0xffffffec,(MethodInfo *)0x0);
  pSVar17 = mscorlib.dll::System::String::String_Concat_3
