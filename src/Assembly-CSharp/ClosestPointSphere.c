...
{
  uStack_1._0_4_ = (this->fields).offset.x;
  uStack_1._4_4_ = (this->fields).offset.y;
  ...
  if (pTVar3 != (Transform *)0x0) {
    ...
    pcRam_? = pcVar7;
    (*pcRam_?)(pvVar6);
    fVar10 = (float)uStack_1 * (float)uStack_4;
    fVar11 = uStack_1._4_4_ * uStack_4._4_4_;
    fVar12 = (this->fields).radius;
    fVar2 = fVar2 * fStack_5;
    pTVar3 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_transform
                       ((Component *)this,(MethodInfo *)0x0);
    if (pTVar3 != (Transform *)0x0) {
      if (cRam_? == '\0') {
      ...
      if (pTVar3 != (Transform *)0x0) {
        ...
        if (pTVar3 != (Transform *)0x0) {
          ...
          uVar13 = spectator->x;
          uVar14 = spectator->y;
          fVar15 = spectator->z - fStack_5;
          fVar16 = (float)uVar14 - uStack_4._4_4_;
          fVar17 = (float)uVar13 - (float)uStack_4;
          uStack_1 = CONCAT44(fVar16,fVar17);
          fStack_18 = fVar15;
          fVar19 = (float)FUN_?(&uStack_1);
          if (_UNK_? < fVar19) {
            fVar15 = fVar15 / fVar19;
            uStack_4 = CONCAT44(fVar16 / fVar19,fVar17 / fVar19);
          }
          else {
            if (cRam_? == '\0') {
            ...
            uStack_4._0_4_ = (pVVar20->zeroVector).x;
            uStack_4._4_4_ = (pVVar20->zeroVector).y;
            fVar15 = (pVVar20->zeroVector).z;
          }
          __return_storage_ptr__->x = (float)uStack_4 * fVar12 + fVar10;
          __return_storage_ptr__->y = uStack_4._4_4_ * fVar12 + fVar11;
          __return_storage_ptr__->z = fVar15 * fVar12 + fVar2;
...

{
  ...
  uVar8 = (this->fields).offset.x;
  uVar9 = (this->fields).offset.y;
  fVar10 = (this->fields).radius;
  uStack_2 = CONCAT44(uStack_2._4_4_,fStack_6 + (this->fields).offset.z);
  uStack_1 = CONCAT44(uStack_5._4_4_ + (float)uVar9,(float)uStack_5 + (float)uVar8);
  pcVar3 = pcRam_?;
  if ((pcRam_? == (code *)0x0) &&
     (pcVar3 = (code *)FUN_?(&UNK_?), pcVar3 == (code *)0x0)) {
    uVar4 = func_?(&UNK_?);
