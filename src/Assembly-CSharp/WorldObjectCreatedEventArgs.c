...
/* WorldObjectCreatedEventArgs(MVWorldObjectClient) */

void Assembly-CSharp.dll::WorldObjectCreatedEventArgs::WorldObjectCreatedEventArgs__ctor
               (WorldObjectCreatedEventArgs *this,MVWorldObjectClient *wo,MethodInfo *method)
