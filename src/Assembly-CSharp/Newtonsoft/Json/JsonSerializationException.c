...
void Assembly-CSharp.dll::Newtonsoft::Json::JsonSerializationException::
     JsonSerializationException__ctor(JsonSerializationException *this,MethodInfo *method)
...
void Assembly-CSharp.dll::Newtonsoft::Json::JsonSerializationException::
     JsonSerializationException__ctor_1
               (JsonSerializationException *this,String *message,MethodInfo *method)
...
void Assembly-CSharp.dll::Newtonsoft::Json::JsonSerializationException::
     JsonSerializationException__ctor_2
               (JsonSerializationException *this,String *message,Exception *innerException,
               MethodInfo *method)
