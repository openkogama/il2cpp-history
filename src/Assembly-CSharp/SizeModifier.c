...

{
  ...
  value = (Object *)func_?(TypeInfo__SizeModifier___DoForSeconds_d__17);
  if (value != (Object *)0x0) {
    ...
    if ((pAVar4 != (AvatarBlobShadowController *)0x0) &&
      ...
      if (this_02 != (MVNetworkGame *)0x0) {
        ...
        if ((pMVar5 != (MVLocalPlayer *)0x0) &&
          ...
          (*(this->klass->vtable).Scale.methodPtr)();
          return;
        }
      }
    }
    ...
    if (pMVar5 != (MVAvatar *)0x0) {
      (*(pMVar5->klass->vtable).set_Scale.methodPtr)
                (pMVar5,CONCAT44((float)uVar4 * fVar1,(float)uVar3 * fVar1),
                 (this->fields).defaultScale.z * fVar1,(pMVar5->klass->vtable).set_Scale.method);
      return;
    }
  }
  func_?();
...

{
  ...
  if (pAVar5 != (Avatar *)0x0) {
    ...
    if (pMVar9 != (MVAvatar *)0x0) {
      (*(pMVar9->klass->vtable).set_Scale.methodPtr)
                (pMVar9,uStack_16,fVar14 * fVar1 + fVar8 * fVar3,
                 (pMVar9->klass->vtable).set_Scale.method);
      return;
    }
  }
  func_?();
