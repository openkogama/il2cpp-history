...

{
  ...
  pEVar1 = (ESWalkMode_c *)FUN_?(TypeInfo__ESWalkMode____c);
  TypeInfo__ESWalkMode____c->static_fields->__9 = pEVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__ESWalkMode____c->static_fields >> 0xc);
