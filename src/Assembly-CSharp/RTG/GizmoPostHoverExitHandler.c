...
IAsyncResult *
Assembly-CSharp.dll::RTG::GizmoPostHoverExitHandler::GizmoPostHoverExitHandler_BeginInvoke
          (GizmoPostHoverExitHandler *this,Gizmo *gizmo,int32_t handleId,AsyncCallback *callback,
