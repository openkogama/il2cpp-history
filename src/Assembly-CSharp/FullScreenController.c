            ...
            if (5 < values->max_length) {
              ...
              IStack_2.m_value =
                   UnityEngine.CoreModule.dll::UnityEngine::Screen::Screen_get_height
                             ((MethodInfo *)0x0);
              str3 = mscorlib.dll::System::Int32::Int32_ToString(&IStack_2,(MethodInfo *)0x0);
              pSVar1 = mscorlib.dll::System::String::String_Concat_5
                                 (StringLiteral_Screen__w_,pSVar1,StringLiteral___h_,str3,
                                  (MethodInfo *)0x0);
              FullScreenController_PrintLog(pSVar1,(MethodInfo *)0x0);
              ...
              TStack_4._id_k__BackingField = pRVar3->m_Width;
              TStack_4.m_Data = (Object *)pRVar3->m_Height;
              TStack_4.m_Children =
                   (IList_1_UnityEngine_UIElements_TreeViewItemData_1_System_Object_ *)
                   (pRVar3->m_RefreshRate).numerator;
              uStack_5 = (pRVar3->m_RefreshRate).denominator;
              IStack_2.m_value =
                   (int32_t)mscorlib.dll::System::Runtime::CompilerServices::Unsafe::
                            Unsafe_ReadUnaligned_6((uint8_t *)&TStack_4,(MethodInfo *)0x0);
              str1 = (MethodInfo *)
              ...
              IStack_2.m_value =
                   (int32_t)UnityEngine.UIElementsModule.dll::UnityEngine::UIElements::
                            ...
                            TreeViewItemData_1_System_Object__get_data(&TStack_4,(MethodInfo *)0x0)
              ;
              pSVar1 = mscorlib.dll::System::Int32::Int32_ToString(&IStack_2,(MethodInfo *)0x0);
              ...
              pSVar1 = mscorlib.dll::System::String::String_Concat_5
                                 (StringLiteral_CurrentResolution__w_,(String *)str1,
                                  StringLiteral___h_,pSVar1,(MethodInfo *)0x0);
              FullScreenController_PrintLog(pSVar1,(MethodInfo *)0x0);
...

{
  ...
  FullScreenController_PrintLog(pSVar1,(MethodInfo *)0x0);
  bVar2 = UnityEngine.CoreModule.dll::UnityEngine::Screen::Screen_get_fullScreen((MethodInfo *)0x0);
  uStack_3 = (undefined *)CONCAT13(bVar2,(undefined3)uStack_3);
  if ((TypeInfo__System__Boolean->_1).cctor_finished_or_no_cctor == 0) {
    func_?();
  }
  pSVar1 = mscorlib.dll::System::Boolean::Boolean_ToString
                     ((Boolean *)((int)&uStack_3 + 3),(MethodInfo *)0x0);
  ...
  FullScreenController_PrintLog(pSVar1,(MethodInfo *)0x0);
  SStack_4 = UnityEngine.CoreModule.dll::UnityEngine::Screen::Screen_get_orientation
                        ((MethodInfo *)0x0);
  EStack_5.klass = (Enum__Class *)TypeInfo__UnityEngine__ScreenOrientation;
  ...
  if (pSVar8 != (String__Array *)0x0) {
    ...
    pSStack9 = prefix;
    func_?();
    pSStack9 = StringLiteral____Screen_currentResolution___;
    if (pSVar8->max_length < 2) goto code_?;
    pSVar8->vector[1] = StringLiteral____Screen_currentResolution___;
    func_?();
    pRVar10 = UnityEngine.CoreModule.dll::UnityEngine::Screen::Screen_get_currentResolution
                       ((Resolution *)&stack0xffffffbc,(MethodInfo *)0x0);
    TStack_11._id_k__BackingField = pRVar10->m_Width;
    TStack_11.m_Data = (Object *)pRVar10->m_Height;
    TStack_11.m_Children =
         (IList_1_UnityEngine_UIElements_TreeViewItemData_1_System_Object_ *)
         (pRVar10->m_RefreshRate).numerator;
    uStack_12 = (pRVar10->m_RefreshRate).denominator;
    IStack_13.m_value =
         (int32_t)mscorlib.dll::System::Runtime::CompilerServices::Unsafe::Unsafe_ReadUnaligned_6
                            ((uint8_t *)&TStack_11,(MethodInfo *)0x0);
    pSStack9 = mscorlib.dll::System::Int32::Int32_ToString(&IStack_13,(MethodInfo *)0x0);
    if (pSVar8->max_length < 3) goto code_?;
    pSVar8->vector[2] = pSStack9;
    func_?();
    pSStack9 = ::StringLiteral___;
    ...
    if (pSVar8 != (String__Array *)0x0) {
      ...
      pSStack9 = prefix;
      func_?();
      pSStack9 = StringLiteral____Screen_width_height___;
      if (pSVar8->max_length < 2) goto code_?;
      ...
      if (pSVar8 != (String__Array *)0x0) {
        if (pSVar8->max_length != 0) {
          ...
          pSStack9 = prefix;
          func_?();
          pSStack9 = StringLiteral____OriginalSize___;
...

{
  ...
  values = (String__Array *)func_?(TypeInfo__System__String,6);
  pSVar1 = StringLiteral_FullScreenController___trying_to;
  if (values == (String__Array *)0x0) {
    func_?();
  }
  else if (values->max_length != 0) {
    ...
    pSVar1 = mscorlib.dll::System::Boolean::Boolean_ToString((Boolean *)&value,(MethodInfo *)0x0);
    if (1 < values->max_length) {
      values->vector[1] = pSVar1;
      func_?(values->vector + 1,pSVar1);
      pSVar1 = StringLiteral___IsFullscreenSupported_;
      if (2 < values->max_length) {
        ...
        if (3 < values->max_length) {
          ...
          if (4 < values->max_length) {
            ...
            if (5 < values->max_length) {
                ...
                if (bVar2 == 0) {
                  ...
                  if (TypeInfo__FullScreenController->static_fields->fakeFullscreen != 0) {
                    ...
                    pSVar1 = mscorlib.dll::System::Boolean::Boolean_ToString
                                       ((Boolean *)
                                        ...
                                        (MethodInfo *)0x0);
                    pSVar1 = mscorlib.dll::System::String::String_Concat_3
                                       (StringLiteral_Fake_fullscreen__trying_to_chang,pSVar1,
                                        (MethodInfo *)0x0);
                    FullScreenController_PrintLog(pSVar1,(MethodInfo *)0x0);
                    if (TypeInfo__FullScreenController->static_fields->fullScreen != 0) {
                      MVar3 = Misc::OrientationControl::OrientationControl_get_CurrentOrientation
                                        ((MethodInfo *)0x0);
                      ...
                      pTVar4 = FullScreenController_GetWidthHeight
                                         (MVar3,widthInput,heightInput,(MethodInfo *)0x0);
                      item1 = (int32_t *)&stack0xfffffff0;
                      mscorlib.dll::System::TupleExtensions::TupleExtensions_Deconstruct
                                (pTVar4,item1,(int32_t *)&stack0xfffffff4,
                                 void_MethodInfo__System__TupleExtensions__Deconstruct<int,_int>_System__Tuple<int,_int>__System__Int32___System__Int32__
                                );
                      UnityEngine.CoreModule.dll::UnityEngine::Screen::Screen_SetResolution_2
                                ((int32_t)pTVar4,(int32_t)item1,0,(MethodInfo *)0x0);
                      ...
                      BrowserComm+ToJavaScript::BrowserComm_ToJavaScript_ExternalCall
                                (StringLiteral_fakeFullScreenOn,pOVar5,(MethodInfo *)0x0);
                      return;
                    }
                    MVar3 = Misc::OrientationControl::OrientationControl_get_CurrentOrientation
                                      ((MethodInfo *)0x0);
                    ...
                    pTVar4 = FullScreenController_GetWidthHeight
                                       (MVar3,TypeInfo__FullScreenController->static_fields->
                                              screenWidthBeforeFullscreen,
                                        TypeInfo__FullScreenController->static_fields->
                                        screenHeightBeforeFullscreen,(MethodInfo *)0x0);
                    mscorlib.dll::System::TupleExtensions::TupleExtensions_Deconstruct
                              (pTVar4,(int32_t *)&stack0xfffffff4,(int32_t *)&stack0xfffffff0,
                               void_MethodInfo__System__TupleExtensions__Deconstruct<int,_int>_System__Tuple<int,_int>__System__Int32___System__Int32__
                              );
                    UnityEngine.CoreModule.dll::UnityEngine::Screen::Screen_SetResolution_2
                              ((int32_t)pTVar4,(int32_t)pTVar4,0,(MethodInfo *)0x0);
                    pOVar5 = (Object__Array *)func_?();
                    if ((TypeInfo__BrowserComm__ToJavaScript->_1).cctor_finished_or_no_cctor == 0) {
                      func_?();
                    }
                    BrowserComm+ToJavaScript::BrowserComm_ToJavaScript_ExternalCall
                              (StringLiteral_fakeFullScreenOff,pOVar5,(MethodInfo *)0x0);
                  }
                }
                else {
                  if ((TypeInfo__FullScreenController->_1).cctor_finished_or_no_cctor == 0) {
                  ...
                  pSVar1 = mscorlib.dll::System::Boolean::Boolean_ToString
                                     ((Boolean *)
                                      ...
                                      (MethodInfo *)0x0);
                  pSVar1 = mscorlib.dll::System::String::String_Concat_3
                                     (StringLiteral_Fullscreen_is_supported__trying_,pSVar1,
                                      (MethodInfo *)0x0);
                  FullScreenController_PrintLog(pSVar1,(MethodInfo *)0x0);
                  func_?();
                  TypeInfo__FullScreenController->static_fields->fullScreen = value;
                  if (TypeInfo__FullScreenController->static_fields->fullScreen == 0) {
                    ...
                    str3 = mscorlib.dll::System::Int32::Int32_ToString
                                     ((Int32 *)&TypeInfo__FullScreenController->static_fields->
                                                screenHeightBeforeFullscreen,(MethodInfo *)0x0);
                    pSVar1 = mscorlib.dll::System::String::String_Concat_5
                                       (StringLiteral_Fullscreen_supported__setting_fu,pSVar1,
                  ...
                  pRVar6 = UnityEngine.CoreModule.dll::UnityEngine::Screen::
                           Screen_get_currentResolution
                                     ((Resolution *)&stack0xffffffd0,(MethodInfo *)0x0);
                  iStack_7 = pRVar6->m_Width;
                  pOStack_8 = (Object *)pRVar6->m_Height;
                  width = mscorlib.dll::System::Runtime::CompilerServices::Unsafe::
                          Unsafe_ReadUnaligned_6((uint8_t *)&iStack_7,(MethodInfo *)0x0);
                  pRVar6 = UnityEngine.CoreModule.dll::UnityEngine::Screen::
                           Screen_get_currentResolution
                                     ((Resolution *)&stack0xffffffd0,(MethodInfo *)0x0);
                  iStack_7 = pRVar6->m_Width;
                  ...
                  height = UnityEngine.UIElementsModule.dll::UnityEngine::UIElements::
                           ...
                           TreeViewItemData_1_System_Object__get_data
                                     ((TreeViewItemData_1_System_Object_ *)&iStack_7,
                                      (MethodInfo *)0x0);
                  UnityEngine.CoreModule.dll::UnityEngine::Screen::Screen_SetResolution_2
              ...
              pSVar1 = mscorlib.dll::System::String::String_Concat_3
                                 (StringLiteral_Not_setting_fullscreen_as_it_has,pSVar1,
                                  (MethodInfo *)0x0);
              if ((TypeInfo__FullScreenController->_1).cctor_finished_or_no_cctor == 0) {
                func_?();
              }
