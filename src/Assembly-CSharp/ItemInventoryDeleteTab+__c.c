...

{
  ...
  pIVar1 = (ItemInventoryDeleteTab_c *)FUN_?(TypeInfo__ItemInventoryDeleteTab____c);
  TypeInfo__ItemInventoryDeleteTab____c->static_fields->__9 = pIVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__ItemInventoryDeleteTab____c->static_fields >> 0xc);
