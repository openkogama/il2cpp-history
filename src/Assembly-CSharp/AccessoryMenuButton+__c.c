...

{
  ...
  pAVar1 = (AccessoryMenuButton_c *)FUN_?(TypeInfo__AccessoryMenuButton____c);
  TypeInfo__AccessoryMenuButton____c->static_fields->__9 = pAVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__AccessoryMenuButton____c->static_fields >> 0xc);
