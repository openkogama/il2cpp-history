...
{
  if (cRam_? == '\0') {
    FUN_?(&TypeInfo__GameMeterVisuals__GameMeterUpdatedEffect___AnimateScale_d__6);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
...

{
  ...
  if (cVar4 != '\0') {
    ...
    *(undefined4 *)&routine[1].klass = 0;
    ...
    if (bVar5) {
      uVar6 = (uint)((ulonglong)(routine + 2) >> 0xc);
...

{
  ...
  if (this != (GameMeterUpdatedEffect *)0x0) {
    ...
    if ((this_00 != (RectTransform *)0x0) &&
      ...
      uStack_4._0_4_ = (this->fields).startSize.x;
      uStack_4._4_4_ = (this->fields).startSize.y;
      fStack_5 = (this->fields).startSize.z;
      if (cRam_? == '\0') {
        FUN_?(&
                      void__MethodInfo__UnityEngine__Object__MarshalledUnityObject__MarshalNotNull<UnityEngine::Transform>_UnityEngine__Transform_
                     );
...
{
  fVar1 = _UNK_?;
  (this->fields).startSize.x = _UNK_?;
  (this->fields).startSize.y = fVar1;
  (this->fields).startSize.z = fVar1;
  return;
}
