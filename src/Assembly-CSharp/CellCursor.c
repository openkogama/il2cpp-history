...

{
  ...
  if (method == (MethodInfo *)0x0) {
    uVar5 = func_?();
    bVar6 = *(uint *)(unaff_EDI + 0x45) < extraout_ECX;
    pbVar7 = (byte *)(unaff_EDI + 0x45 + extraout_ECX * 2);
    bVar8 = *pbVar7;
    bVar9 = *pbVar7 + (byte)uVar5;
    *pbVar7 = bVar9 + bVar6;
    bVar6 = CARRY1(in_stack_10,(byte)extraout_ECX) ||
             CARRY1(in_stack_10 + (byte)extraout_ECX,
                    CARRY1(bVar8,(byte)uVar5) || CARRY1(bVar9,bVar6));
    bVar11 = CARRY1(bRam_?,extraout_DL) || CARRY1(bRam_? + extraout_DL,bVar6);
    bRam_? = bRam_? + extraout_DL + bVar6;
    pbVar7 = (byte *)(extraout_ECX + 0x4f);
    bVar8 = *pbVar7;
    bVar12 = (byte)((ushort)uVar5 >> 8);
    bVar9 = *pbVar7;
    *pbVar7 = bVar9 + bVar12 + bVar11;
    bRam_? = bRam_? + bVar12 + (CARRY1(bVar8,bVar12) || CARRY1(bVar9 + bVar12,bVar11));
    pcVar13 = (code *)swi(3);
...

{
  ...
  bVar12 = 0;
  func_?();
  uVar3 = CONCAT11((char)((uint)extraout_EDX >> 8) + (char)extraout_EDX + (0x68 < bVar12),
                   (char)extraout_EDX);
  pcVar13 = (code *)swi(3);
  (*pcVar13)(uVar3,uVar3,(short)extraout_EDX,extraout_EDX);
  return;
}
