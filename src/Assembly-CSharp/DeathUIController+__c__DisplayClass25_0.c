...
void Assembly-CSharp.dll::DeathUIController+<>c__DisplayClass25_0::
     DeathUIController_c_DisplayClass25_0__ShowBoostMenu_b__0
               (DeathUIController_c_DisplayClass25_0 *this,IUIStack *x,BaseEventData *y,
               MethodInfo *method)
