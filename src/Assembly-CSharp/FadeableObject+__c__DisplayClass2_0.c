...
void Assembly-CSharp.dll::FadeableObject+<>c__DisplayClass2_0::
     FadeableObject_c_DisplayClass2_0__OnDestroy_b__0
               (FadeableObject_c_DisplayClass2_0 *this,IFadeParent *x,BaseEventData *y,
               MethodInfo *method)
        ...
        if (uVar9 != 0) {
          do {
            if (pIVar7->interfaceOffsets[uVar8].interfaceType ==
              ...
              pVVar10 = &(pIVar7->vtable).AddFadeMaterial +
                        (pIVar7->interfaceOffsets[uVar8].offset + 1);
              goto code_?;
            }
            uVar8 = uVar8 + 1;
          } while (uVar8 < uVar9);
        }
        pVVar10 = (VirtualInvokeData *)FUN_?(x,TypeInfo__IFadeParent,1,pMVar6,unaff_RDI);
code_?:
