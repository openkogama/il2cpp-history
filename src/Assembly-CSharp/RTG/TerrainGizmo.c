                  ...
                  while( true ) {
                    ...
                    if ((iVar13 >> ((byte)iVar21 & 0x1f) & 1U) != 0) {
                      ...
                      if (bVar15 == 0) {
                        ...
                        worldPosition_00.x = (float)uVar4 + 4.3024077e-29;
                        ...
                        value_00.x = (float)uVar4 + 4.3024077e-29;
              ...
              if (bVar18 == 0) {
                ...
                if ((float)pSStack_20 <= fVar29) {
                  ...
                  fStack_35 = (float)uStack_30 +
                              (float)pSStack_20 * (float)(undefined4)uStack_32 * offset;
    ...
    if (pLVar3 != (List_1_RTG_TerrainGizmoAffectedObject_ *)0x0) {
      ...
      *piVar5 = *piVar5 + 1;
      ...
      if ((pGVar6 != (Gizmo *)0x0) &&
        ...
        fVar8 = (pGVar7->fields)._position3D.x;
        ...
        fStack_1 = (pVVar10->rightVector).z;
        fStack_13 = fVar8 - (float)uVar11 * (this->fields)._radius;
        fStack_14 = fVar9 - fStack_1 * (this->fields)._radius;
        auStack_2._0_4_ = uVar11;
        auStack_2._4_4_ = uVar12;
        if (cRam_? == '\0') {
          func_?(&TypeInfo__UnityEngine__Vector3);
          cRam_? = '\x01';
        }
        uVar15 = (TypeInfo__UnityEngine__Vector3->static_fields->forwardVector).x;
        fStack_13 = fStack_13 - (float)uVar15 * (this->fields)._radius;
        fStack_14 = fStack_14 -
        ...
        if ((pGVar6 != (Gizmo *)0x0) &&
          ...
          auStack_2._0_4_ = uVar16;
          auStack_2._4_4_ = uVar17;
          if (cRam_? == '\0') {
            func_?(&TypeInfo__UnityEngine__Vector3);
            cRam_? = '\x01';
          }
          ...
          if (pTVar19 != (Terrain *)0x0) {
            ...
            if (pTVar20 != (Transform *)0x0) {
              ...
              uVar22 = pVVar21->x;
              fStack_13 = fStack_13 - (float)uVar22;
              fStack_14 = fStack_14 - pVVar21->z;
              pTVar19 = (this->fields)._targetTerrain;
              if (pTVar19 != (Terrain *)0x0) {
                ...
                if (pTVar20 != (Transform *)0x0) {
                  ...
                  if (pTVar19 != (Terrain *)0x0) {
                    ...
                    if (this_04 != (TerrainData *)0x0) {
                      ...
                      fStack_1 = (float)iVar23 * (fStack_13 / fStack_1);
                      if (cRam_? == '\0') {
                        func_?();
                        cRam_? = '\x01';
                      }
                      ...
                      iVar23 = UnityEngine.TerrainModule.dll::UnityEngine::TerrainData::
                               TerrainData_get_internalHeightmapResolution
                                         (this_04,(MethodInfo *)0x0);
                      register0x00001200 = (double)fStack_1;
                      ...
                      iVar25 = UnityEngine.TerrainModule.dll::UnityEngine::TerrainData::
                               TerrainData_get_internalHeightmapResolution
                                         (this_04,(MethodInfo *)0x0);
                      register0x00001200 = (double)((float)iVar23 * (float)this_04);
                      fVar24 = (float10)func_?();
                      unique0x0000aa00 = (double)fVar24;
                      iVar4 = (int)fVar24;
                      if (iVar4 < 0) {
                      ...
                      pTVar26 = TerrainGizmo_GetRadiusTickFromHandleId
                                          (this,0xADDR,(MethodInfo *)0x0);
                      if (pTVar26 != (TerrainGizmo_RadiusTick *)0x0) {
                        uVar27 = (pTVar26->fields).DragAxis.x;
                        uVar28 = (pTVar26->fields).DragAxis.y;
                        if ((this->fields)._sharedSettings == (TerrainGizmoSettings *)0x0) {
                          pTVar29 = (this->fields)._settings;
                          if (pTVar29 == (TerrainGizmoSettings *)0x0) goto code_?;
                        }
                        else {
                          pTVar29 = (this->fields)._sharedSettings;
                        }
                        this_01 = (this->fields)._radiusDrag;
                        if (this_01 == (GizmoSglAxisOffsetDrag3D *)0x0) goto code_?;
                        workData.Axis.x = (float)uVar27;
                        workData.DragOrigin = (pTVar26->fields).WorldPosition;
                        workData.Axis.y = (float)uVar28;
                        workData.Axis.z = (pTVar26->fields).DragAxis.z;
                        workData.SnapStep = (pTVar29->fields)._radiusSnapStep;
                      ...
                      if (this_02 != (GizmoCap3D *)0x0) {
                        puVar30 = UnityEngine.AndroidJNIModule.dll::UnityEngine::AndroidJavaObject::
