...
code_?:
  func_?();
  pcVar10 = (code *)swi(0xe8);
  (*pcVar10)();
  bVar11 = (byte)((uint)this >> 8);
  bVar12 = bVar11 + (byte)this;
  bVar13 = CARRY1(bVar11,(byte)this) || CARRY1(bVar12,bVar4);
  bVar12 = bVar12 + bVar4;
  iVar8 = func_?();
  pbVar14 = (byte *)(iVar8 + -0x12);
  bVar4 = *pbVar14;
  bVar11 = *pbVar14;
  *pbVar14 = bVar11 + extraout_DH + bVar13;
  bVar13 = CARRY1((byte)iVar8,extraout_DH) ||
           CARRY1((byte)iVar8 + extraout_DH,
                  CARRY1(bVar4,extraout_DH) || CARRY1(bVar11 + extraout_DH,bVar13));
  func_?();
  pbVar14 = (byte *)(extraout_EDX + -0x17);
  bVar4 = *pbVar14;
  bVar11 = *pbVar14 + bVar12;
  *pbVar14 = bVar11 + bVar13;
  *extraout_EDX = *extraout_EDX + extraout_CL + (CARRY1(bVar4,bVar12) || CARRY1(bVar11,bVar13));
