...

{
  ...
  bVar6 = 0;
  func_?();
  bVar7 = (byte)((uint)this_00 >> 8);
  pcVar8 = (char *)(CONCAT22((short)((uint)unaff_EDI >> 0x10),CONCAT11(0x4b,(char)unaff_EDI)) +
                   -0x49);
  *pcVar8 = *pcVar8 + bVar7 + (0xb4 < bVar7 || CARRY1(bVar7 + 0x4b,bVar6));
  pcVar9 = (code *)swi(3);
  bVar10 = (*pcVar9)();
  return bVar10;
}
