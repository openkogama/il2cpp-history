  ...
  *unaff_FS_OFFSET = &uStack_3;
  ...
  if (this_00 != (List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)0x0) {
    ...
    while( true ) {
      ...
      name = *(String **)((int)pOVar7 + 0x20);
      in_stack_8 = *(MethodInfo **)((int)pOVar7 + 0x24);
      path = *(String **)((int)pOVar7 + 0x28);
      materialSound = *(MaterialSound__Enum *)((int)pOVar7 + 0x2c);
      modifierPackageType = *(AvatarModifierPackageType__Enum *)((int)pOVar7 + 0x30);
      priceGold = *(int32_t *)((int)pOVar7 + 0x34);
      bVar6 = *(bool *)((int)pOVar7 + 0x38);
      ...
      physicalProperties->vector[0] = *(float *)((int)pOVar7 + 0xc);
      if (physicalProperties->max_length < 2) goto code_?;
      physicalProperties->vector[1] = *(float *)((int)pOVar7 + 0x10);
      if (physicalProperties->max_length < 3) goto code_?;
      physicalProperties->vector[2] = *(float *)((int)pOVar7 + 0x14);
      if (physicalProperties->max_length < 4) goto code_?;
      physicalProperties->vector[3] = *(float *)((int)pOVar7 + 0x18);
      if (physicalProperties->max_length < 5) goto code_?;
      physicalProperties->vector[4] = *(float *)((int)pOVar7 + 0x1c);
  ...
  if ((this->fields).dumpToSql != 0) {
    ...
    if (this_00 != (List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)0x0) {
      ...
      if (this_01 != (StreamWriter *)0x0) {
        ...
        uStack_1 = 4;
        if (this_01 != (StreamWriter *)0x0) {
          (*(this_01->klass->vtable).WriteLine_2.methodPtr)(this_01);
          uStack_1 = 0xffffffff;
          if (this_01 != (StreamWriter *)0x0) {
            func_?(0);
          }
...

{
  ...
  this_00 = (List_1_OverrideMaterial_ *)
            func_?(TypeInfo__System__Collections__Generic__List<OverrideMaterial>);
  if (this_00 != (List_1_OverrideMaterial_ *)0x0) {
