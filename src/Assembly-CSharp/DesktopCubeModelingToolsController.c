...

{
  ...
  if (this_00 == (Button *)0x0) {
    func_?();
    iVar2 = iRam_?;
    pbVar3 = (byte *)(unaff_EBX + -0x26efcc26);
    bVar4 = *pbVar3;
    bVar5 = *pbVar3;
    *pbVar3 = bVar5 + extraout_CH + bVar1;
    *(char *)(iVar2 + -0x33efcc26) =
         *(char *)(iVar2 + -0x33efcc26) + extraout_DH +
         (CARRY1(bVar4,extraout_CH) || CARRY1(bVar5 + extraout_CH,bVar1));
    pcVar6 = (code *)swi(3);
    (*pcVar6)();
    return;
  }
