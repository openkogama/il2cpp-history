...

{
  ...
  pAVar1 = (AvatarAccessoryPurchasePopup_c *)
           FUN_?(TypeInfo__AvatarAccessoryPurchasePopup____c);
  TypeInfo__AvatarAccessoryPurchasePopup____c->static_fields->__9 = pAVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__AvatarAccessoryPurchasePopup____c->static_fields >> 0xc);
