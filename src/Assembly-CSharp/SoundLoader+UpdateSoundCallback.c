...
void Assembly-CSharp.dll::SoundLoader+UpdateSoundCallback::SoundLoader_UpdateSoundCallback_Invoke
               (SoundLoader_UpdateSoundCallback *this,MethodInfo *method)

{
  this_00 = (SoundLoader_UpdateSoundCallback *)(this->fields)._.prev;
  if (this_00 != (SoundLoader_UpdateSoundCallback *)0x0) {
    SoundLoader_UpdateSoundCallback_Invoke(this_00,method);
  }
