...

{
  if ((this != (StreamedAssetToCallback_2_System_Object_System_Object_ *)0x0) &&
     (pAVar1 = (this->fields).onAssetSet, pAVar1 != (Action_1_Object_ *)0x0)) {
                    /* WARNING: Could not recover jumptable at 0xADDR. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(pAVar1->fields)._._.invoke_impl)
              ((pAVar1->fields)._._.method_code,(this->fields)._.asset,(pAVar1->fields)._._.method);
    return;
  }
  FUN_?();
  pcVar2 = (code *)swi(3);
...
{
  if (cRam_? == '\0') {
    FUN_?(&TypeInfo__StreamingAsset,method->klass->rgctx_data[5].rgctxDataDummy);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
