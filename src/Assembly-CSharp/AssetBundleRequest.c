...

{
  ...
  pSVar1 = mscorlib.dll::System::String::String_Concat_4
                     (pSVar1,StringLiteral__version_584768406,(MethodInfo *)0x0);
  if (cRam_? == '\0') {
    FUN_?(&TypeInfo__UnityEngine__Networking__DownloadHandlerAssetBundle,0x22dadb96,0,0);
    LOCK();
    UNLOCK();
  ...
  HStack_2.u64_0 = 0;
  HStack_2.u64_1 = 0x22dadb9600000000;
