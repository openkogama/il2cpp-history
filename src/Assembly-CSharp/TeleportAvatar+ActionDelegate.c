...
IAsyncResult *
Assembly-CSharp.dll::TeleportAvatar+ActionDelegate::TeleportAvatar_ActionDelegate_BeginInvoke
          (TeleportAvatar_ActionDelegate *this,float time,AsyncCallback *callback,Object *object,
          MethodInfo *method)
