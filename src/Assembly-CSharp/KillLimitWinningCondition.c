...
void Assembly-CSharp.dll::KillLimitWinningCondition::KillLimitWinningCondition_InitializeGameUI
               (KillLimitWinningCondition *this,RectTransform *lobbyState,MethodInfo *method)

{
  ...
  if (this_01 != (PrefabPool *)0x0) {
    ...
    if (this_02 != (WinningConditionManager *)0x0) {
      ...
      (this->fields).killLimit = (int32_t)pOVar1;
      if ((((uint)(TypeInfo__MVGameControllerBase->vtable).Equals.methodPtr & 0x2000000) != 0) &&
         ((TypeInfo__MVGameControllerBase->_1).cctor_started == 0)) {
        func_?();
      }
      ...
      if (pMVar2 != (MVNetworkGame *)0x0) {
        ...
        if (this_04 != (SkyParam *)0x0) {
          ...
          if (this_05 != (List_1_MV_WorldObject_MVTeam_ *)0x0) {
            ...
            if ((int)pOVar1 < 2) {
              ...
              iVar6 = MVWorldObject.dll::GameStatCounterManager::
                      GameStatCounterManager_GetActorCount
                                (pGVar3,GameStatCounterType__Enum_Kill,(MVTeam__Enum)pIVar5,
            ...
            value = (float)iVar6 / (float)(this->fields).killLimit;
            pOVar1 = (Object *)func_?();
            arg2 = (Object *)func_?();
...
void Assembly-CSharp.dll::KillLimitWinningCondition::KillLimitWinningCondition_RoundEndReset
               (KillLimitWinningCondition *this,MethodInfo *method)

{
  ...
  this = (KillLimitWinningCondition *)0x0;
  arg0 = (Object *)func_?(TypeInfo__System__Int32,&this);
  iStack_2 = (this_01->fields).killLimit;
  ...
  if (pTVar1 != (Text *)0x0) {
    ...
    if (this_00 != (ProgressBar *)0x0) {
      ProgressBar::ProgressBar_set_Progress
                (this_00,0.0 / (float)(this_01->fields).killLimit,(MethodInfo *)0x0);
...
void Assembly-CSharp.dll::KillLimitWinningCondition::KillLimitWinningCondition_UpdateValue
               (KillLimitWinningCondition *this,int32_t newValue,MethodInfo *method)
  ...
  if (this_01 != (PrefabPool *)0x0) {
    ...
    if (this_02 != (WinningConditionManager *)0x0) {
      ...
      if (this_03 == (TimeAttackFlagReachedClient *)0x0) {
        ...
        pOVar1 = System.dll::System::Collections::Generic::
                 ...
                 SortedList_2_TKey_TValue_ListValues_TKey_TValue_GetEnumerator_c_Iterator3_System_Single_System_Object__System_Collections_IEnumerator_get_Current
                           ((SortedList_2_TKey_TValue_ListValues_TKey_TValue_GetEnumerator_c_Iterator3_System_Single_System_Object_
                             *)this_03,(MethodInfo *)0x0);
        if (pOVar1 != (Object *)(this->fields).killLimit) {
          (this->fields).killLimit = (int32_t)pOVar1;
        }
      }
      ...
      if (pTVar2 != (Text *)0x0) {
        ...
        if (this_00 != (ProgressBar *)0x0) {
          ProgressBar::ProgressBar_set_Progress
                    (this_00,(float)newValue / (float)(this->fields).killLimit,(MethodInfo *)0x0);
          return;
        }
      }
    }
