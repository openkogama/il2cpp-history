...
code_?:
  pbVar12 = (byte *)func_?();
  bVar13 = CARRY1(*pbVar12,extraout_CH) ||
           CARRY1(*pbVar12 + extraout_CH,in_stack_14 < extraout_DL);
  ...
  *pbVar15 = bVar18 + extraout_CH + bVar13;
  pbVar12[0x55] =
       pbVar12[0x55] + extraout_CH +
       (CARRY1(bVar16,extraout_CH) || CARRY1(bVar18 + extraout_CH,bVar13));
  pcVar19 = (code *)swi(3);
  (*pcVar19)();
  return;
}
