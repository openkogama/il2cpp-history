...

{
  ...
  if (pHVar1 != (HackingToolDetector *)0x0) {
    ppAVar2 = &(pHVar1->fields).banList;
    *ppAVar2 = banList;
    func_?(ppAVar2,banList);
    ...
    if (this != (Object__Class *)0x0) {
      ...
      UnityEngine.CoreModule.dll::UnityEngine::MonoBehaviour::MonoBehaviour_StartCoroutine_Auto
                ((MonoBehaviour *)this,(IEnumerator *)pOVar3,(MethodInfo *)0x0);
      if ((TypeInfo__HackingToolDetector->_1).cctor_finished_or_no_cctor == 0) {
        func_?();
      }
      if (cRam_? == '\0') {
...

{
  ...
  DictionaryWithChangeEvent_2_TKey_TValue_OnDictionaryChangeDelegate_Unity_IL2CPP_Metadata_Il2CppFullySharedGenericType_Unity_IL2CPP_Metadata_Il2CppFullySharedGenericType___ctor
            (this_00,(Object *)this,
             MethodInfo__HackingToolDetector__TemporaryReportHandler_HackingToolDetector__HackingToolReport_
             ,(MethodInfo *)0x0);
  ppAVar3 = &(this->fields).onHackToolDetected;
  *ppAVar3 = (Action_1_HackingToolDetector_HackingToolReport_ *)this_00;
  func_?(ppAVar3,this_00);
  return;
}
...

{
  ...
  index = 2;
  cVar2 = (int)a < 0;
  uVar3 = a == (HackingToolDetector_HackingToolReport *)0x0;
  if (!(bool)uVar3) {
    switch((a->fields).kind) {
    case 0:
      index = 0;
      pSVar4 = (String__Array *)func_?(TypeInfo__System__String);
      cVar2 = (int)pSVar4 < 0;
      uVar3 = pSVar4 == (String__Array *)0x0;
      if (!(bool)uVar3) {
        ...
        pSVar4->vector[0] = StringLiteral_Running_process__;
        func_?(pSVar4->vector);
        pAVar7 = (a->fields).app;
        cVar2 = (int)pAVar7 < 0;
        uVar3 = pAVar7 == (ApplicationDesc *)0x0;
        if (!(bool)uVar3) {
          pSVar1 = (pAVar7->fields)._ExeCertSubjectName_k__BackingField;
          iVar5 = pSVar4->max_length;
          iVar8 = iVar5 - 1;
          uVar3 = iVar5 == 1;
code_?:
          cVar6 = SBORROW4(iVar5,1);
          cVar2 = iVar8 < 0;
          if (iVar5 == 0 || (bool)uVar3) goto code_?;
          pSVar4->vector[1] = pSVar1;
          func_?(pSVar4->vector + 1);
          uVar9 = pSVar4->max_length;
          cVar6 = SBORROW4(uVar9,2);
          cVar2 = (int)(uVar9 - 2) < 0;
          uVar3 = uVar9 == 2;
          if (uVar9 < 3) goto code_?;
          pSVar4->vector[2] = StringLiteral___associated_with__;
          func_?(pSVar4->vector + 2);
          pAVar7 = (a->fields).app;
          cVar2 = (int)pAVar7 < 0;
          uVar3 = pAVar7 == (ApplicationDesc *)0x0;
          if (!(bool)uVar3) {
            uVar9 = pSVar4->max_length;
            cVar6 = SBORROW4(uVar9,3);
            cVar2 = (int)(uVar9 - 3) < 0;
            uVar3 = uVar9 == 3;
            if (uVar9 < 4) goto code_?;
            pSVar4->vector[3] = (pAVar7->fields).programName;
            func_?(pSVar4->vector + 3);
            uVar9 = pSVar4->max_length;
            cVar6 = SBORROW4(uVar9,4);
            cVar2 = (int)(uVar9 - 4) < 0;
            uVar3 = uVar9 == 4;
            if (uVar9 < 5) goto code_?;
            ppSVar10 = pSVar4->vector + 4;
            pSVar1 = StringLiteral___detected_;
code_?:
            *ppSVar10 = pSVar1;
            func_?(ppSVar10);
            pSVar1 = mscorlib.dll::System::String::String_Concat_6(pSVar4,(MethodInfo *)0x0);
            goto code_?;
          }
        }
      }
    ...
    case 1:
      ...
      if (!(bool)uVar3) {
        ...
        if (!(bool)uVar3) {
          ...
          pSVar4->vector[1] = (pAVar7->fields)._ExeCertSubjectName_k__BackingField;
          func_?(pSVar4->vector + 1);
          uVar9 = pSVar4->max_length;
          cVar6 = SBORROW4(uVar9,2);
          cVar2 = (int)(uVar9 - 2) < 0;
          ...
          if (!(bool)uVar3) {
            ...
            uVar3 = uVar9 == 4;
            if (uVar9 < 5) goto code_?;
            pSVar4->vector[4] = StringLiteral___detected_as__;
            func_?(pSVar4->vector + 4);
            uVar9 = pSVar4->max_length;
            cVar6 = SBORROW4(uVar9,5);
            cVar2 = (int)(uVar9 - 5) < 0;
            uVar3 = uVar9 == 5;
            if (uVar9 < 6) goto code_?;
            pSVar4->vector[5] = (a->fields).exactFind;
            func_?(pSVar4->vector + 5);
            uVar9 = pSVar4->max_length;
            cVar6 = SBORROW4(uVar9,6);
            cVar2 = (int)(uVar9 - 6) < 0;
            uVar3 = uVar9 == 6;
            if (uVar9 < 7) goto code_?;
            pSVar4->vector[6] = ::StringLiteral__;
            func_?(pSVar4->vector + 6);
            pSVar1 = mscorlib.dll::System::String::String_Concat_6(pSVar4,(MethodInfo *)0x0);
            goto code_?;
          }
        }
    ...
    case 2:
      ...
      if (!(bool)uVar3) {
        cVar6 = '\0';
        cVar2 = (int)pSVar4->max_length < 0;
        uVar3 = 1;
        if (pSVar4->max_length == 0) goto code_?;
        pSVar4->vector[0] = StringLiteral_Registry_key__;
        func_?(pSVar4->vector);
        pAVar11 = (a->fields).foundKey;
        cVar2 = (int)pAVar11 < 0;
        uVar3 = pAVar11 == (ApplicationDesc_RegistryKey *)0x0;
        if (!(bool)uVar3) {
          pSVar1 = (pAVar11->fields).name;
          iVar5 = pSVar4->max_length;
          iVar8 = iVar5 - 1;
          uVar3 = iVar8 == 0;
          goto code_?;
    ...
    case 3:
      ...
      if (!(bool)uVar3) {
        ...
        if (!(bool)uVar3) {
          ...
          uVar3 = uVar9 == 1;
          if (uVar9 < 2) goto code_?;
          pSVar4->vector[1] = (pAVar11->fields).name;
          func_?(pSVar4->vector + 1);
          uVar9 = pSVar4->max_length;
          cVar6 = SBORROW4(uVar9,2);
          cVar2 = (int)(uVar9 - 2) < 0;
...
code_?:
      ...
      pBVar12 = (this->fields).alreadyReported;
      cVar2 = (int)pBVar12 < 0;
      uVar3 = pBVar12 == (BitArray *)0x0;
      if (!(bool)uVar3) {
        bVar13 = mscorlib.dll::System::Collections::BitArray::BitArray_get_Item
                          (pBVar12,index,(MethodInfo *)0x0);
        if (bVar13 != 0) {
          return;
        }
        if ((TypeInfo__UnityEngine__Debug->_1).cctor_finished_or_no_cctor == 0) {
        ...
        UnityEngine.CoreModule.dll::UnityEngine::Debug::Debug_2_Log
                  ((Object *)pSVar1,(MethodInfo *)0x0);
        EStack_14.klass = (Enum__Class *)TypeInfo__HackingToolDetector__ReportCategory;
        EStack_14.monitor = (MonitorData *)0xffffffff;
        iStack_15 = index;
        pSVar1 = mscorlib.dll::System::Enum::Enum_ToString(&EStack_14,(MethodInfo *)0x0);
        ...
        if (!(bool)uVar3) {
          mscorlib.dll::System::Collections::BitArray::BitArray_set_Item
                    (pBVar12,index,1,(MethodInfo *)0x0);
          if (index != 0) {
code_?:
            return;
          }
          ...
          this_00 = MVGameControllerBase::MVGameControllerBase_get_OperationRequests
                              ((MethodInfo *)0x0);
          cVar2 = (int)this_00 < 0;
          uVar3 = this_00 == (MVNetworkGame_OperationRequests *)0x0;
          if (!(bool)uVar3) {
...
code_?:
  ...
  if ((bool)uVar3 || cVar6 != cVar2) {
    puVar17 = (ushort *)
              CONCAT31((int3)((ulonglong)uVar16 >> 0x28),
                       (byte)((ulonglong)uVar16 >> 0x20) & *(byte *)uVar16);
    *puVar17 = *puVar17 + (ushort)(0 < (short)-(*puVar17 & 3)) * -(*puVar17 & 3);
    *(char *)(extraout_ECX + 100) = *(char *)(extraout_ECX + 100) + (char)((ulonglong)uVar16 >> 8);
    pcVar18 = (code *)swi(3);
    (*pcVar18)();
    return;
  }
  ...
  (**(code **)((int)&TypeInfo__HackingToolDetector + extraout_ECX))();
  return;
}
...

{
  ...
  ppBVar1 = &(this->fields).alreadyReported;
  *ppBVar1 = this_00;
  ...
  *ppOVar2 = value;
  ...
  ppTVar3 = &(this->fields).detectedHackingTools;
  *ppTVar3 = this_01;
  func_?(ppTVar3,this_01);
