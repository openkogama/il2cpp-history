...
code_?:
  ...
  func_?();
  iVar16 = func_?();
  pbVar17 = (byte *)(iVar16 + 0x4c);
  bVar18 = *pbVar17;
  bVar19 = *pbVar17;
  *pbVar17 = bVar19 + extraout_DH + bVar15;
  pcVar20 = (char *)((int)&pLVar1[3].monitor + 1);
  *pcVar20 = *pcVar20 + (char)((uint)&stack0xfffffffc >> 8) +
            (CARRY1(bVar18,extraout_DH) || CARRY1(bVar19 + extraout_DH,bVar15));
  pcVar21 = (code *)swi(3);
  bVar22 = (*pcVar21)();
  return bVar22;
}
