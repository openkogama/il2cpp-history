                    ...
                    if (pDVar1 != (Dictionary_2_System_Object_System_Object_ *)0x0) {
                      ...
                      if (pDVar1 != (Dictionary_2_System_Object_System_Object_ *)0x0) {
                        ...
                        if (pDVar1 != (Dictionary_2_System_Object_System_Object_ *)0x0) {
                          ...
                          pIVar7 = (ILogger *)(pVVar5->zeroVector).z;
                          pEVar3[1].monitor = (MonitorData *)(pVVar5->zeroVector).x;
                          pEVar3[1].fields.stateType = (int32_t)fVar6;
                          pEVar3[1].fields.logger = pIVar7;
                          if (cRam_? == '\0') {
                            func_?();
                            cRam_? = '\x01';
                          }
