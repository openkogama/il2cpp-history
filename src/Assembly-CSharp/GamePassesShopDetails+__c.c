...

{
  ...
  pGVar1 = (GamePassesShopDetails_c *)FUN_?(TypeInfo__GamePassesShopDetails____c);
  TypeInfo__GamePassesShopDetails____c->static_fields->__9 = pGVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__GamePassesShopDetails____c->static_fields >> 0xc);
