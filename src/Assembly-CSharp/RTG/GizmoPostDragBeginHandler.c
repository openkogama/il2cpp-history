...
IAsyncResult *
Assembly-CSharp.dll::RTG::GizmoPostDragBeginHandler::GizmoPostDragBeginHandler_BeginInvoke
          (GizmoPostDragBeginHandler *this,Gizmo *gizmo,int32_t handleId,AsyncCallback *callback,
