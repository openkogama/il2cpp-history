...
code_?:
  ...
  cVar19 = (char)unaff_ESI + '\x01';
  *(char *)(extraout_ECX + -0x79efb978) =
       *(char *)(extraout_ECX + -0x79efb978) + (char)iVar18 + cVar17;
  *(char *)((int)&(unaff_ESI->fields).pickedEdge + 1) = (char)iVar18;
  *(char *)(iVar18 + 0x10) = cVar19;
  *(char *)(iVar18 + 0x11) = cVar19;
  pcVar20 = (code *)swi(3);
  (*pcVar20)();
  return;
}
