...
bool Assembly-CSharp.dll::ActivateParticlesOnAnimation+<PlayParticles>d__4::
     ActivateParticlesOnAnimation_PlayParticles_d_4_MoveNext
...
void Assembly-CSharp.dll::ActivateParticlesOnAnimation+<PlayParticles>d__4::
     ActivateParticlesOnAnimation_PlayParticles_d_4_System_Collections_IEnumerator_Reset
               (ActivateParticlesOnAnimation_PlayParticles_d_4 *this,MethodInfo *method)
