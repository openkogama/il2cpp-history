...

{
  ...
  pIVar1 = TypeInfo__GoogleMobileAds__Api__Mediation__Vungle__Vungle->static_fields->client;
  if (pIVar1 == (IVungleClient *)0x0) {
    func_?();
    pcVar2 = (code *)swi(3);
    (*pcVar2)();
    return;
  ...
  if (uVar4 != 0) {
    do {
      if (pIVar1->klass->interfaceOffsets[uVar3].interfaceType ==
          (Il2CppClass *)TypeInfo__GoogleMobileAds__Common__Mediation__Vungle__IVungleClient) {
        pVVar5 = &(pIVar1->klass->vtable).UpdateConsentStatus +
  ...
  pVVar5 = (VirtualInvokeData *)
           func_?(pIVar1,
                           TypeInfo__GoogleMobileAds__Common__Mediation__Vungle__IVungleClient,0);
code_?:
  (*pVVar5->methodPtr)(pIVar1,consentStatus,consentMessageVersion,pVVar5->method);
  return;
}
  ...
  if (value != (Object *)0x0) {
    ...
    if (piVar2 != (int *)0x0) {
      ...
      TypeInfo__GoogleMobileAds__Api__Mediation__Vungle__Vungle->static_fields->client =
           (IVungleClient *)value;
      func_?(TypeInfo__GoogleMobileAds__Api__Mediation__Vungle__Vungle->static_fields);
      return;
    }
  }
  func_?();
