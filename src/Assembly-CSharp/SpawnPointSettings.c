...

{
  ...
  if (this_02 != (MVWorldObjectClientManager *)0x0) {
    ...
    if (pMVar1 != (MVWorldObject *)0x0) {
      if (((pMVar1->klass->_1).typeHierarchyDepth < (TypeInfo__MVSpawnPoint->_1).typeHierarchyDepth)
         || ((MVSpawnPoint__Class *)
             (pMVar1->klass->_1).typeHierarchy[(TypeInfo__MVSpawnPoint->_1).typeHierarchyDepth - 1]
        ...
        documentationType =
             (*(code *)pMVar1->klass[1]._1.static_fields_size)
                       (pMVar1,pMVar1->klass[1]._1.thread_static_fields_size);
        if (pSVar2 != (SettingsBase *)0x0) {
          ...
          if (this_00 != (Dictionary_2_System_Object_GUILoginHandler_PlanetData_ *)0x0) {
            ...
            uVar5 = CONCAT44(TypeInfo__System__Boolean,pOVar4);
            if ((this_01 != (SettingsToggle *)0x0) && (pOVar4 != (Object *)0x0)) {
              if ((pOVar4->klass->_0).element_class == (TypeInfo__System__Boolean->_0).element_class
                ...
                pbVar6 = (bool *)func_?(pOVar4);
                SettingsToggle::SettingsToggle_Initialize
                          (this_01,StringLiteral_onlyFirstSpawn,*pbVar6,(MethodInfo *)0x0);
                return;
              }
              goto code_?;
            }
