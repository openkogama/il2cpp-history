...

{
  ...
  pGVar1 = (GizmoController_c *)FUN_?(TypeInfo__GizmoController____c);
  TypeInfo__GizmoController____c->static_fields->__9 = pGVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__GizmoController____c->static_fields >> 0xc);
