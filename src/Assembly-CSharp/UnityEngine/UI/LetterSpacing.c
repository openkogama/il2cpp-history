...
code_?:
  ...
  pcVar82 = (char *)uVar48;
  pbVar83 = (byte *)(pcVar82 + -3);
  bVar84 = (byte)((uint)extraout_ECX >> 8);
  bVar85 = *pbVar83 + bVar84;
  bVar86 = CARRY1(*pbVar83,bVar84) || CARRY1(bVar85,bVar32);
  *pbVar83 = bVar85 + bVar32;
  pbVar83 = (byte *)((int)piVar22 + -3);
  bVar32 = *pbVar83;
  bVar84 = (byte)((ulonglong)uVar48 >> 0x28);
  bVar85 = *pbVar83 + bVar84;
  *pbVar83 = bVar85 + bVar86;
  cVar1 = (char)uVar48;
  *pcVar82 = *pcVar82 + cVar1 + (CARRY1(bVar32,bVar84) || CARRY1(bVar85,bVar86));
