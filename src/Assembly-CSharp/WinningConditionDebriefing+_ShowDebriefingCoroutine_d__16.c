...

{
  ...
  bVar8 = (byte)uVar6 - *(byte *)uVar6;
  iVar9 = CONCAT31((int3)((ulonglong)uVar6 >> 8),bVar8 - bVar5);
  *(char *)&unaff_ESI[0xe84130].klass =
       *(char *)&unaff_ESI[0xe84130].klass + (char)((uint)this_00 >> 8) +
       ((byte)uVar6 < *(byte *)uVar6 || bVar8 < bVar5);
  piVar2 = (int *)(iVar9 + -0x50 + iVar7);
  *piVar2 = *piVar2 + extraout_ECX;
  piVar2 = (int *)(iVar9 + -0x34 + iVar7);
  *piVar2 = *piVar2 + extraout_ECX;
  pcVar10 = (code *)swi(3);
  bVar11 = (*pcVar10)();
  return bVar11;
