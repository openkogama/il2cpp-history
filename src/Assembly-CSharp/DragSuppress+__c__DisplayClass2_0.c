...

{
  ...
  pIVar7 = (IBeginDragHandler__VTable *)
           FUN_?(handler,TypeInfo__UnityEngine__EventSystems__IBeginDragHandler,0,pPVar6,
                         unaff_RDI);
code_?:
  UNRECOVERED_JUMPTABLE = (pIVar7->OnBeginDrag).methodPtr;
                    /* WARNING: Could not recover jumptable at 0xADDR. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*UNRECOVERED_JUMPTABLE)(handler,pPVar2,(pIVar7->OnBeginDrag).method,UNRECOVERED_JUMPTABLE);
  return;
}
