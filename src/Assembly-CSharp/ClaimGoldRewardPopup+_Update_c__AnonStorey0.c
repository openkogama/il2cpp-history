...
void Assembly-CSharp.dll::ClaimGoldRewardPopup+<Update>c__AnonStorey0::
     ClaimGoldRewardPopup_Update_c_AnonStorey0___m__0
               (ClaimGoldRewardPopup_Update_c_AnonStorey0 *this,IUIStack *x,BaseEventData *y,
               MethodInfo *method)
