...
code_?:
      ...
      TVar7 = mscorlib.dll::System::Collections::Generic::Dictionary`2[System::Object,UnityEngine::
               UIElements::TextureId]::
               Dictionary_2_System_Object_UnityEngine_UIElements_TextureId__get_Item
                         (pDVar5,(Object *)StringLiteral_windSize,
                          MethodInfo__System__Collections__Generic__Dictionary<System::Object,_System::Object>__get_Item_System__Object_
                         );
      ...
      if (*(Il2CppClass **)(*(int *)TVar7.m_Index + 0x20) ==
        ...
        if (pDVar5 != (Dictionary_2_System_Object_UnityEngine_UIElements_TextureId_ *)0x0) {
          TVar7 = mscorlib.dll::System::Collections::Generic::Dictionary`2[System::
                   ...
                   Dictionary_2_System_Object_UnityEngine_UIElements_TextureId__get_Item
                             (pDVar5,(Object *)StringLiteral_windPitch,
                              MethodInfo__System__Collections__Generic__Dictionary<System::Object,_System::Object>__get_Item_System__Object_
                             );
          uVar6 = CONCAT44(TypeInfo__System__Single,TVar7.m_Index);
          if (TVar7.m_Index != 0) {
            if (*(Il2CppClass **)(*(int *)TVar7.m_Index + 0x20) !=
                (TypeInfo__System__Single->_0).element_class) goto code_?;
            pfVar8 = (float *)func_?(TVar7.m_Index);
            fVar9 = (this->fields).windAreaSize / _UNK_?;
            (this->fields).windPitch = *pfVar8;
            (this->fields).windStrength = fVar9 * _UNK_?;
            WindTurbine_Rescale(this,(MethodInfo *)0x0);
            WindTurbine_Rotate(this,(MethodInfo *)0x0);
            piVar10 = &(this->fields)._._.interactionFlags;
            *(uint *)piVar10 = (uint)*piVar10 | 0x8000;
            uVar11 = *(undefined4 *)((int)&(this->fields)._._.interactionFlags + 4);
            piVar10 = &(this->fields)._._.interactionFlags;
            *(uint *)piVar10 = (uint)*piVar10 | 0x10000;
            piVar10 = &(this->fields)._._.interactionFlags;
            *(uint *)piVar10 = (uint)*piVar10 | 0x200;
            pWVar3 = *ppWVar4;
            *(undefined4 *)((int)&(this->fields)._._.interactionFlags + 4) = uVar11;
            puVar12 = (uint *)((int)&(this->fields)._._.interactionFlags + 4);
            *puVar12 = *puVar12 | 8;
            iVar13 = (this->fields)._._.interactionFlags;
            puVar12 = (uint *)((int)&(this->fields)._._.interactionFlags + 4);
            *puVar12 = *puVar12 | 0x10;
            puVar12 = (uint *)((int)&(this->fields)._._.interactionFlags + 4);
            *puVar12 = *puVar12 | 0x20;
            *(int *)&(this->fields)._._.interactionFlags = (int)iVar13;
            piVar10 = &(this->fields)._._.interactionFlags;
            *(uint *)piVar10 = (uint)*piVar10 & 0xfffffeff;
            *(undefined4 *)((int)&(this->fields)._._.interactionFlags + 4) =
                 *(undefined4 *)((int)&(this->fields)._._.interactionFlags + 4);
            if (pWVar3 != (WindTurbineObject *)0x0) {
              pTVar14 = (pWVar3->fields).triggerBoxEvents;
              pEVar15 = (EventHandler_1_Object_ *)
                        func_?(TypeInfo__System__EventHandler<TriggerEventArgs>);
              ...
              if (pTVar14 != (TriggerBoxEvents *)0x0) {
                TriggerBoxEvents::TriggerBoxEvents_add_TriggerEnter
                          (pTVar14,(EventHandler_1_TriggerEventArgs_ *)pEVar15,(MethodInfo *)0x0);
                pWVar3 = *ppWVar4;
                if (pWVar3 != (WindTurbineObject *)0x0) {
                  pTVar14 = (pWVar3->fields).triggerBoxEvents;
                  pEVar15 = (EventHandler_1_Object_ *)
                  ...
                  if (pTVar14 != (TriggerBoxEvents *)0x0) {
                    ...
                    Int32,UnityEngine::TextCore::Text::TextResourceManager+FontAssetRef]::
                    Dictionary_2_System_Int32_UnityEngine_TextCore_Text_TextResourceManager_FontAssetRef___ctor
                              (this_01,
                               MethodInfo__System__Collections__Generic__Dictionary<int,_MVRigidBody>__Dictionary__
                              );
                    ppDVar16 = &(this->fields).affectedBodies;
                    *ppDVar16 = (Dictionary_2_System_Int32_MVRigidBody_ *)this_01;
                    func_?(ppDVar16,this_01);
                    (this->fields).isActive = 1;
                    return;
                  }
                }
...
code_?:
    ...
    bVar17 = (TypeInfo__WindTurbineObject->_1).naturalAligment;
    if (((((ObjectPrefab__Class *)pWVar3->klass)->_1).naturalAligment < bVar17) ||
       ((((ObjectPrefab__Class *)pWVar3->klass)->_1).typeHierarchy[bVar17 - 1] !=
        (Il2CppClass *)TypeInfo__WindTurbineObject)) goto code_?;
    (this->fields).windTurbineObject = pWVar3;
    bVar17 = (TypeInfo__WindTurbineObject->_1).naturalAligment;
    if ((bVar17 <= (((ObjectPrefab__Class *)pWVar3->klass)->_1).naturalAligment) &&
       ((((ObjectPrefab__Class *)pWVar3->klass)->_1).typeHierarchy[bVar17 - 1] ==
        (Il2CppClass *)TypeInfo__WindTurbineObject)) goto code_?;
  }
  func_?();
