...

{
  ...
  pSVar1 = (SpawnRoleSkillSelectionElement_c *)
           FUN_?(TypeInfo__SpawnRoleSkillSelectionElement____c);
  TypeInfo__SpawnRoleSkillSelectionElement____c->static_fields->__9 = pSVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__SpawnRoleSkillSelectionElement____c->static_fields >> 0xc);
