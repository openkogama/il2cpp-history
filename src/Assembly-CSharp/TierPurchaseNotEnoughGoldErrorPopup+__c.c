...

{
  ...
  pTVar1 = (TierPurchaseNotEnoughGoldErrorPopup_c *)
           FUN_?(TypeInfo__TierPurchaseNotEnoughGoldErrorPopup____c);
  TypeInfo__TierPurchaseNotEnoughGoldErrorPopup____c->static_fields->__9 = pTVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__TierPurchaseNotEnoughGoldErrorPopup____c->static_fields >>
                  0xc);
