...
public static class UpdateController
{
	...
	// Nested types
	[CompilerGenerated]
	private sealed class _RemoveUpdateObject_c__AnonStorey0
	{
		// Fields
		internal IUpdatecontrollerSubscriberUpdate obj;

		// Constructors
		public _RemoveUpdateObject_c__AnonStorey0();

		// Methods
		internal bool __m__0(PriorityDataUpdate x);
	}

	[CompilerGenerated]
	private sealed class _RemoveFixedUpdateObject_c__AnonStorey1
	{
		// Fields
		internal IUpdatecontrollerSubscriberFixedUpdate obj;

		// Constructors
		public _RemoveFixedUpdateObject_c__AnonStorey1();

		// Methods
		internal bool __m__0(PriorityDataFixedUpdate x);
	}

	[CompilerGenerated]
	private sealed class _RemoveLateUpdateObject_c__AnonStorey2
	{
		// Fields
		internal IUpdatecontrollerSubscriberLateUpdate obj;

		// Constructors
		public _RemoveLateUpdateObject_c__AnonStorey2();

		// Methods
		internal bool __m__0(PriorityDataLateUpdate x);
	}
