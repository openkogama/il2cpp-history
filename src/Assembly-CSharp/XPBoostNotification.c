...
code_?:
      ...
      pbVar8 = (byte *)CONCAT22((short)((uint)unaff_EBX >> 0x10),
                                CONCAT11(bVar5 + CARRY1(bStack_7,extraout_CL),bVar3));
      bVar5 = *pbVar8;
      bVar3 = *pbVar8;
      *pbVar8 = bVar3 + 0x47 + bVar6;
      cRam_? = cRam_? + (extraout_AH & 0x47) +
                     (0xb8 < bVar5 || CARRY1(bVar3 + 0x47,bVar6));
      pcVar9 = (code *)swi(3);
      (*pcVar9)();
      return;
    }
