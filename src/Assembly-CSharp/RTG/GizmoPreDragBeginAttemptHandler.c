...
IAsyncResult *
Assembly-CSharp.dll::RTG::GizmoPreDragBeginAttemptHandler::
GizmoPreDragBeginAttemptHandler_BeginInvoke
          (GizmoPreDragBeginAttemptHandler *this,Gizmo *gizmo,int32_t handleId,
