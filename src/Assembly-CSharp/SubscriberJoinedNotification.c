...
code_?:
      func_?();
      (this->fields)._.Type = (int32_t)method;
      *(undefined4 *)((int)&(this->fields)._.Type + 1) = in_stack_3;
      *(undefined4 *)((int)&(this->fields)._.Type + 1) = in_stack_4;
      pcVar5 = (code *)swi(3);
      (*pcVar5)();
      return;
    }
