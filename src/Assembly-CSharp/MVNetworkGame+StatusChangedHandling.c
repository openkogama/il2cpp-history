...

{
  ...
  if (this_00 != (MVNetworkGame_ReconnectWithAlternatePortHandler *)0x0) {
    bVar3 = MVNetworkGame+ReconnectWithAlternatePortHandler::
            MVNetworkGame_ReconnectWithAlternatePortHandler_IsHandling
                      (this_00,(StatusCode__Enum)method_00,(MethodInfo *)0x0);
    if (bVar3 != 0) {
      return;
    }
    if (cRam_? == '\0') {
    ...
    if ((((MVNetworkGame_StatusChangedHandling *)pMVar2)->fields).
      ...
      if (method_00 != (MethodInfo *)0x400) {
        if (method_00 == (MethodInfo *)0x401) {
          if (cRam_? == '\0') {
            func_?();
            cRam_? = '\x01';
          }
        ...
        pSVar1 = mscorlib.dll::System::Enum::Enum_ToString((Enum *)method_00,(MethodInfo *)0x0);
        pSVar1 = mscorlib.dll::System::String::String_Concat_3
...
code_?:
      if (0x16 < (int)method_00 - StatusCode__Enum_SecurityExceptionOnConnect)
      goto code_?;
    }
                    /* WARNING (jumptable): Sanity check requires truncation of jumptable */
                    /* WARNING: Could not find normalized switch variable to match jumptable */
    switch((&UNK_?)[(int)method_00]) {
    case 0:
      ...
      pMVar4 = (((MVNetworkGame_StatusChangedHandling *)pMVar2)->fields).networkGame;
      if (pMVar4 != (MVNetworkGame *)0x0) {
        ...
        coroutine = WaitForFrames::WaitForFrames_WithCallback(5,this_01,(MethodInfo *)0x0);
    ...
    case 1:
      ...
      if ((pMVar4 != (MVNetworkGame *)0x0) &&
        ...
        if (pMVar2 != (MVNetworkGame_OperationRequests *)0x0) {
          ...
          pMVar4 = (pMVar2->fields).networkGame;
          if (pMVar4 != (MVNetworkGame *)0x0) {
...
code_?:
  ...
  uVar6 = func_?();
  pcVar7 = (char *)uVar6;
  ppIVar8 = &method_00->klass;
  *(byte *)ppIVar8 = *(byte *)ppIVar8 ^ (byte)((ulonglong)uVar6 >> 8);
  puVar9 = &stack0xfffffffc;
  if (*(char *)ppIVar8 < '\x01') {
    pbVar10 = (byte *)segment(in_SS,(short)&stack0xfffffffc + (short)pMVar2 + 0x6730);
    bVar11 = *pbVar10;
    bVar12 = (byte)((ulonglong)uVar6 >> 0x28);
    *pbVar10 = *pbVar10 + bVar12;
    piVar13 = (int *)CONCAT31((int3)((ulonglong)uVar6 >> 0x28),
                              (char)((ulonglong)uVar6 >> 0x20) + (char)((uint)unaff_EBX >> 8) +
                              CARRY1(bVar11,bVar12));
    method_00->klass = (Il2CppClass *)((uint)method_00->klass ^ (uint)&this);
    *pcVar7 = *pcVar7 + (char)uVar6;
    *piVar13 = (int)(pcVar7 + *piVar13);
    *(char *)unaff_EBX = (char)*unaff_EBX + (char)uVar6;
    pcVar7 = pcVar7 + *unaff_EBX;
    *(char *)unaff_EBX = (char)*unaff_EBX + (char)pcVar7;
    pcVar7 = (char *)((int)(pcVar7 + *unaff_EBX + *unaff_EBX + *unaff_EBX) +
                      *(int *)(pcVar7 + *unaff_EBX + *unaff_EBX + *unaff_EBX));
  ...
  cRam_? = '\x01';
code_?:
  value = *(Object **)((int)register0x00000010 + 8);
  mscorlib.dll::System::ThrowHelper::ThrowHelper_1_IfNullAndNullsAreIllegalThenThrow_57
            (value,ExceptionArgument__Enum_obj,method_00);
  pOVar14 = *(Object__Class **)((int)register0x00000010 + 0xc);
  value[2].klass = pOVar14;
  func_?();
  method_01 = TypeInfo__MVNetworkGame__ReconnectWithAlternatePortHandler;
  value_00 = (Object__Class *)func_?();
  mscorlib.dll::System::ThrowHelper::ThrowHelper_1_IfNullAndNullsAreIllegalThenThrow_57
            ((Object *)value_00,ExceptionArgument__Enum_obj,(MethodInfo *)method_01);
  (value_00->_0).namespaze = (char *)pOVar14;
  func_?(&(value_00->_0).namespaze);
