...

{
  ...
  pIVar1 = (InEditMenu_c *)FUN_?(TypeInfo__InEditMenu____c);
  TypeInfo__InEditMenu____c->static_fields->__9 = pIVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__InEditMenu____c->static_fields >> 0xc);
