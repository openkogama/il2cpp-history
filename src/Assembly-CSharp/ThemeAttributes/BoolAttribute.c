...

{
  ...
  uVar1 = FUN_?(TypeInfo__System__Action<bool>);
...
code_?:
            (this->fields)._._.value = *(bool *)&pOVar9[1].klass;
            return;
          }
        }
        else {
...

{
  ...
  pAVar1 = (this->fields)._._.themeCallback;
  if (pAVar1 != (Action_1_Boolean_ *)0x0) {
                    /* WARNING: Could not recover jumptable at 0xADDR. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(pAVar1->fields)._._.invoke_impl)
              ((pAVar1->fields)._._.method_code,(this->fields)._._.value,(pAVar1->fields)._._.method
              );
    return;
  }
  FUN_?();
...
{
  if (cRam_? == '\0') {
    FUN_?(&MethodInfo__ThemeAttributes__NamedThemeAttribute<bool>__NamedThemeAttribute__);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
...
{
  abStackX_8[0] = (this->fields)._._.value;
  pOVar1 = (Object *)FUN_?(uRam_?,abStackX_8);
  return pOVar1;
}
