...
code_?:
        ...
        bVar4 = MVAvatarLocal::MVAvatarLocal_get_IsEnteringVehicle(this_03,(MethodInfo *)0x0);
        if (bVar4 == 0) {
          bVar4 = MVAvatar::MVAvatar_get_IsSeated((MVAvatar *)this_03,(MethodInfo *)0x0);
          if (bVar4 != 0) {
            MVAvatarLocal::MVAvatarLocal_LeaveVehicle(this_03,0,(MethodInfo *)0x0);
          }
          bVar4 = MVAvatarLocal::MVAvatarLocal_IsSpawnRoleActive(this_03,(MethodInfo *)0x0);
          if (bVar4 != 0) {
            ...
            if (this_00 != (List_1_System_Int32_ *)0x0) {
              ...
              if (this_01 != (Transform *)0x0) {
                ...
                pOVar14 = OVar8.klass;
                pMVar15 = OVar8.monitor;
                position.z = fVar7;
                position.x = (float)OVar8.klass;
                position.y = (float)OVar8.monitor;
                rotation.y = fVar11;
                rotation.x = fVar10;
                rotation.z = fVar12;
                rotation.w = fVar13;
                pOVar16 = UnityEngine.CoreModule.dll::UnityEngine::Object::Object_1_Instantiate_7
                                    ((Object *)original,position,rotation,
                                     TeleportAvatar_MethodInfo__UnityEngine__Object__Instantiate<TeleportAvatar>_TeleportAvatar__UnityEngine__Vector3__UnityEngine__Quaternion_
                                    );
                if (pOVar16 != (Object *)0x0) {
                  pOVar16[6].klass = (Object__Class *)(this->fields)._._._.id;
                  pOVar16[6].monitor = *(MonitorData **)(pMVar15 + 8);
                  pOVar16[5].monitor = (MonitorData *)this_03;
                  pMStack17 = this_03;
                  func_?();
                  puVar18 = (undefined8 *)func_?();
                  pMVar19 = *(MonitorData **)(puVar18 + 1);
                  *(undefined8 *)&pOVar16[2].monitor = *puVar18;
                  pOVar16[3].monitor = pMVar19;
                  pOVar16[4] = OVar6;
                  pOVar16[5].klass = pOVar14;
                  if (*(int *)(pMVar15 + 0xf8) != 0) {
                    pMStack17 =
                         (MVAvatarLocal *)
