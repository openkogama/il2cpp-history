...
code_?:
  uVar69 = func_?();
  piVar19 = (int *)((ulonglong)uVar69 >> 0x20);
  *(char *)&((Il2CppClass_0 *)&unaff_EDI->image)->image = (char)uVar69;
  pcVar85 = (char *)((uint)uVar69 | 0xdaf1050);
  extraout_ECX[0x10500d] = extraout_ECX[0x10500d] + (char)((uint)this_00 >> 8);
  *piVar19 = (int)(pcVar85 + *piVar19);
  *extraout_ECX = *extraout_ECX + (char)pcVar85;
  *piVar19 = *piVar19 + CONCAT31((int3)((uint)pcVar85 >> 8),(char)pcVar85 + *pcVar85);
  pcVar86 = (code *)swi(3);
  (*pcVar86)();
  return;
}
