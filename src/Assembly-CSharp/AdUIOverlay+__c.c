...

{
  ...
  pAVar1 = (AdUIOverlay_c *)FUN_?(TypeInfo__AdUIOverlay____c);
  TypeInfo__AdUIOverlay____c->static_fields->__9 = pAVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__AdUIOverlay____c->static_fields >> 0xc);
