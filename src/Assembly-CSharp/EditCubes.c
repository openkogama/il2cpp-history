...
code_?:
  iVar67 = func_?();
  bVar105 = *extraout_ECX;
  bVar106 = (byte)&stack0xfffffffc;
  *extraout_ECX = *extraout_ECX + bVar106;
  bVar107 = *(char *)&unaff_ESI->klass + (byte)iVar67;
  bVar37 = CARRY1(*(byte *)&unaff_ESI->klass,(byte)iVar67) || CARRY1(bVar107,CARRY1(bVar105,bVar106));
  *(byte *)&unaff_ESI->klass = bVar107 + CARRY1(bVar105,bVar106);
  pbVar108 = (byte *)(iVar67 + 0x2e);
  bVar105 = *pbVar108;
  bVar107 = *pbVar108;
  *pbVar108 = bVar107 + extraout_DL + bVar37;
  extraout_ECX[-0x33efbace] =
       extraout_ECX[-0x33efbace] + bVar106 +
       (CARRY1(bVar105,extraout_DL) || CARRY1(bVar107 + extraout_DL,bVar37));
  pcVar109 = (code *)swi(3);
  (*pcVar109)();
  return;
}
