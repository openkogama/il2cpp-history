...
code_?:
  func_?();
  bVar16 = (byte)extraout_EDX & *(byte *)(extraout_EDX + 0x40);
  pbVar17 = (byte *)((int)&pLVar1[3].fields.__1__state + 3);
  bVar18 = *pbVar17;
  bVar19 = (byte)((uint)extraout_EDX >> 8);
  *pbVar17 = *pbVar17 + bVar19;
  cRam_? = cRam_? + bVar19 +
                 (CARRY1(bVar16,(byte)&stack0xfffffffc) ||
                 CARRY1(bVar16 + (byte)&stack0xfffffffc,CARRY1(bVar18,bVar19)));
  pcVar20 = (code *)swi(3);
  bVar21 = (*pcVar20)();
  return bVar21;
}
