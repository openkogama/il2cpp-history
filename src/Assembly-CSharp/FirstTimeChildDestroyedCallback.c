...
void Assembly-CSharp.dll::FirstTimeChildDestroyedCallback::FirstTimeChildDestroyedCallback_OnDestroy
               (FirstTimeChildDestroyedCallback *this,MethodInfo *method)

{
  pAVar1 = (this->fields).Destroyed;
