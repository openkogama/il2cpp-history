...

{
  if (cRam_? == '\0') {
    ...
    LOCK();
    UNLOCK();
    FUN_?(&TypeInfo__ExitCubeModeling____c);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
  ...
  if (*(int *)&(TypeInfo__ExitCubeModeling____c->_1).field_0x1c == 0) {
    FUN_?(TypeInfo__ExitCubeModeling____c);
  }
  this_01 = TypeInfo__ExitCubeModeling____c->static_fields->__9__0_0;
  if (this_01 == (ExecuteEvents_EventFunction_1_IHandleCubeModelEdit_ *)0x0) {
    if (*(int *)&(TypeInfo__ExitCubeModeling____c->_1).field_0x1c == 0) {
      FUN_?(TypeInfo__ExitCubeModeling____c);
    }
    object = TypeInfo__ExitCubeModeling____c->static_fields->__9;
    this_01 = (ExecuteEvents_EventFunction_1_IHandleCubeModelEdit_ *)
              FUN_?(
                           TypeInfo__UnityEngine__EventSystems__ExecuteEvents__EventFunction<IHandleCubeModelEdit>
                           );
    ...
    ExecuteEvents_EventFunction_1_System_Object___ctor
              ((ExecuteEvents_EventFunction_1_System_Object_ *)this_01,(Object *)object,
               MethodInfo__ExitCubeModeling____c___Exit_b__0_0_IHandleCubeModelEdit__UnityEngine__EventSystems__BaseEventData_
               ,(MethodInfo *)0x0);
    TypeInfo__ExitCubeModeling____c->static_fields->__9__0_0 = this_01;
    if (iRam_? != 0) {
      uVar2 = (uint)((ulonglong)&TypeInfo__ExitCubeModeling____c->static_fields->__9__0_0 >> 0xc);
