...

{
  ...
  pSVar1 = StringLiteral_BUY_GOLD;
  if ((promotionActionType != PromotionActionType__Enum_GoldPurchase) &&
     (pSVar1 = StringLiteral_JOIN_THE_ELITE,
     promotionActionType != PromotionActionType__Enum_EliteSubscription)) {
    pSVar1 = StringLiteral_SIGN_UP;
  }
  if (cRam_? == '\0') {
...

{
  ...
  if (pLVar1 != (List_1_AdIntegration_InHouse_PromotionLooksData_LooksData_ *)0x0) {
    ...
    if (pPVar5 != (PromotionLooksData_LooksData__Array *)0x0) {
      if (uVar2 < (uint)pPVar5->max_length) {
        uVar6 = pPVar5->vector[(int)uVar2].promotionActionType;
        return uVar6;
      }
      FUN_?();
      pcVar3 = (code *)swi(3);
...

{
  ...
  if (pLVar1 != (List_1_AdIntegration_InHouse_PromotionLooksData_LooksData_ *)0x0) {
    ...
    if (pPVar5 != (PromotionLooksData_LooksData__Array *)0x0) {
      ...
      pIVar4 = pPVar5->vector[(int)uVar2].promotionImage;
...

{
  ...
  if (pLVar1 != (List_1_AdIntegration_InHouse_PromotionLooksData_LooksData_ *)0x0) {
    ...
    if (pPVar5 != (PromotionLooksData_LooksData__Array *)0x0) {
      ...
      pSVar4 = pPVar5->vector[(int)uVar2].promotionText;
      if (cRam_? == '\0') {
        FUN_?(&::StringLiteral__,0);
        LOCK();
        UNLOCK();
...

{
  ...
  if ((this->fields).initialized == 0) {
    ...
    uVar8 = uVar5;
    while (pLVar7 != (List_1_AdIntegration_InHouse_PromotionLooksData_LooksData_ *)0x0) {
      uVar3 = (uint)uVar8;
      ...
      pLVar7 = (this->fields).promotionData;
      if (pLVar7 == (List_1_AdIntegration_InHouse_PromotionLooksData_LooksData_ *)0x0) break;
      if ((uint)(pLVar7->fields)._size <= uVar3) goto code_?;
      pPVar9 = (pLVar7->fields)._items;
      if (pPVar9 == (PromotionLooksData_LooksData__Array *)0x0) break;
      if ((uint)pPVar9->max_length <= uVar3) goto code_?;
      cStack_10 = (char)*(undefined8 *)(&pPVar9->vector[0].validOnKogamaPortal + uVar5);
      if (cStack_10 != '\0') {
      ...
      if (pPVar9 == (PromotionLooksData_LooksData__Array *)0x0) break;
      if ((uint)pPVar9->max_length <= uVar3) goto code_?;
      if ((char)((ulonglong)*(undefined8 *)(&pPVar9->vector[0].validOnKogamaPortal + uVar5) >> 8)
          != '\0') {
