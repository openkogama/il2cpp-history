...

{
  ...
  if (this_00 != (SettingsBase *)0x0) {
    ...
    if (((this_03 != (MVWorldObjectClientManager *)0x0) &&
      ...
      *(MethodInfo **)unaff_EBX = method;
      ...
      if ((*(Outline **)unaff_EBX != (Outline *)0x0) &&
         (UnityEngine.CoreModule.dll::UnityEngine::Behaviour::Behaviour_set_enabled
                    ((Behaviour *)*(Outline **)unaff_EBX,0,(MethodInfo *)0x0),
         pOVar5 != (Object *)0x0)) {
        if ((pOVar5->klass->_0).element_class ==
          ...
          *(Outline **)unaff_EBX = pOVar8;
          ...
          if (*(Outline **)unaff_EBX != (Outline *)0x0) {
            UnityEngine.CoreModule.dll::UnityEngine::Behaviour::Behaviour_set_enabled
                      ((Behaviour *)*(Outline **)unaff_EBX,1,(MethodInfo *)0x0);
  ...
  uVar13 = func_?();
  pcVar14 = (char *)((uint)uVar13 - 0x13);
  *pcVar14 = *pcVar14 + (char)((ulonglong)uVar13 >> 0x28) +
            ((longlong)(int)((longlong)(int)&stack0xfffffffc * 0x3d) !=
            (longlong)(int)&stack0xfffffffc * 0x3d);
  pcVar14 = (char *)((int)((ulonglong)uVar13 >> 0x20) + -0x13);
  *pcVar14 = *pcVar14 + (char)((uint)unaff_EBX >> 8) + ((uint)uVar13 < 0x3ded7510);
  pcVar15 = (code *)swi(3);
  (*pcVar15)();
  return;
}
