      ...
      if ((pLVar6->fields)._size < 2) {
        ...
        value = MVWorldObject.dll::GameStatCounterManager::GameStatCounterManager_GetActorCount
                          (pGVar7,(GameStatCounterType__Enum)
                                  CONCAT71((int7)((ulonglong)uVar10 >> 8),1),team,
        ...
        value = MVWorldObject.dll::GameStatCounterManager::GameStatCounterManager_GetTeamCount
                          (pGVar7,(GameStatCounterType__Enum)
                                  CONCAT71((int7)((ulonglong)uVar10 >> 8),1),
                           (pMVar9->fields)._._Team_k__BackingField,(MethodInfo *)0x0);
      }
      pTVar11 = (this->fields).progress;
      value_00 = (float)value / (float)(this->fields).killLimit;
      if (cRam_? == '\0') {
...

{
  ...
  if (pTVar1 != (Text *)0x0) {
    ...
    if (pPVar3 != (ProgressBar *)0x0) {
      value = 0.0 / (float)(this->fields).killLimit;
      if (value < 0.0) {
        value = 0.0;
      }
      else if (_UNK_? < value) {
...

{
  ...
  if (((pMVar1 != (MVGameControllerBase *)0x0) &&
    ...
    else if (*(int *)&pOVar3[1].monitor != (this->fields).killLimit) {
      (this->fields).killLimit = *(int *)&pOVar3[1].monitor;
    }
    ...
    if (pTVar4 != (Text *)0x0) {
      ...
      if (pPVar6 != (ProgressBar *)0x0) {
        fVar7 = (float)newValue / (float)(this->fields).killLimit;
        if (fVar7 < 0.0) {
          fVar7 = 0.0;
        }
        else if (_UNK_? < fVar7) {
