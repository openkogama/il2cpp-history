...

{
  ...
  method_00 = TypeInfo__LobbyStateButton____c;
  value = (LobbyStateButton_c *)func_?();
  mscorlib.dll::System::ThrowHelper::ThrowHelper_1_IfNullAndNullsAreIllegalThenThrow_55
            ((Object *)value,ExceptionArgument__Enum_obj,(MethodInfo *)method_00);
  TypeInfo__LobbyStateButton____c->static_fields->__9 = value;
  func_?(TypeInfo__LobbyStateButton____c->static_fields,value);
  return;
}
