...

{
  ...
  pBVar1 = (BundlePurchasePopUp_c *)FUN_?(TypeInfo__BundlePurchasePopUp____c);
  TypeInfo__BundlePurchasePopUp____c->static_fields->__9 = pBVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__BundlePurchasePopUp____c->static_fields >> 0xc);
