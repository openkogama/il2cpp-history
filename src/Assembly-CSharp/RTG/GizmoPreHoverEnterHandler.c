...
IAsyncResult *
Assembly-CSharp.dll::RTG::GizmoPreHoverEnterHandler::GizmoPreHoverEnterHandler_BeginInvoke
          (GizmoPreHoverEnterHandler *this,Gizmo *gizmo,int32_t handleId,AsyncCallback *callback,
