...
void Assembly-CSharp.dll::RegisteredPromotionController+<PushPromotionSlide>c__AnonStorey0::
     RegisteredPromotionController_PushPromotionSlide_c_AnonStorey0___m__0
               (RegisteredPromotionController_PushPromotionSlide_c_AnonStorey0 *this,IUIStack *x,
