...
code_?:
    ...
    if (MVOperationCodes__Enum_GetThemesData < (byte)(undefined1)opCode) {
      if ((byte)(undefined1)opCode < MVOperationCodes__Enum_GetAvatarBodies) {
        ...
        (unaff_EDI->_0).byval_arg.data = *p_Var25;
        pMVar1 = MVGameControllerBase::MVGameControllerBase_get_Game((MethodInfo *)0x0);
        bVar2 = 0;
        if (pMVar1 == (MVNetworkGame *)0x0) goto code_?;
        pMVar19 = MVNetworkGame::MVNetworkGame_get_LocalPlayer(pMVar1,(MethodInfo *)0x0);
...
code_?:
  bVar31 = func_?();
  bVar32 = (byte)(extraout_CX >> 8);
  bVar33 = *(char *)&(unaff_EDI->_0).image + bVar32;
  bVar14 = CARRY1(*(byte *)&(unaff_EDI->_0).image,bVar32) || CARRY1(bVar33,bVar2);
  *(byte *)&(unaff_EDI->_0).image = bVar33 + bVar2;
  unaff_EBP->klass = (MVNetworkGame__Class *)unaff_EBX;
  puVar29 = (undefined1 *)((int)&unaff_EBX[0x25de84].vtable.Clear.method + 1);
  bVar34 = CARRY1(*puVar29,bVar31) || CARRY1(*puVar29 + bVar31,bVar14);
  *puVar29 = *puVar29 + bVar31 + bVar14;
  pIVar35 = &(unaff_EBX->_0).byval_arg;
  bVar2 = (byte)extraout_CX & 0x1f;
  uVar36 = CONCAT14(bVar34,(pIVar35->data).dummy);
  uVar37 = (ulonglong)uVar36 << bVar2 | (ulonglong)(uVar36 >> 0x21 - bVar2);
  (pIVar35->data).__klassIndex = (int32_t)uVar37;
  bVar14 = (extraout_CX & 0x1f) == 0;
  unaff_EBP[-1].fields.statusChangedHandling = (MVNetworkGame_StatusChangedHandling *)unaff_EBX;
  puVar29 = (undefined1 *)((int)&unaff_EBX[-0x1bffd9]._0.methods + 2);
  *puVar29 = *puVar29 + extraout_DH + (bVar14 * bVar34 | !bVar14 * ((uVar37 & 0x100000000) != 0));
  return;
}
