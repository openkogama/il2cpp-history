...

{
  ...
  fVar2 = (this->fields).activeDuration + duration;
  if (_UNK_? <= fVar2) {
    fVar2 = _UNK_?;
  }
...

{
  ...
  unaff_EBX = &(this->fields).currentCubeMaterial;
  *unaff_EBX = (pMVar1->fields)._CubeModelMaterial_k__BackingField;
  func_?();
  ...
  case 0:
    ...
    if (((pRVar4 != (Renderer *)0x0) &&
        (UnityEngine.CoreModule.dll::UnityEngine::Renderer::Renderer_set_sharedMaterial
                   (pRVar4,*unaff_EBX,(MethodInfo *)0x0), pMVar3 != (MVMaterial *)0x0)) &&
...
code_?:
  cVar9 = '\0';
  uVar10 = func_?();
  iVar11 = (int)((ulonglong)uVar10 >> 0x20);
  bVar12 = (byte)extraout_ECX & 0x1f;
  uVar13 = (uint)uVar10 << bVar12 | (uint)uVar10 >> 0x20 - bVar12;
  bVar14 = (extraout_ECX & 0x1f) == 0;
  bVar15 = bVar14 * cVar9 | !bVar14 * ((uVar13 & 1) != 0);
  bVar16 = (byte)((ulonglong)uVar10 >> 0x20);
  bVar12 = *(byte *)unaff_EBX + bVar16;
  bVar14 = CARRY1(*(byte *)unaff_EBX,bVar16) || CARRY1(bVar12,bVar15);
  *(byte *)unaff_EBX = bVar12 + bVar15;
  puVar17 = (uint *)(uVar13 + 0x6d + iVar11);
  uVar18 = (ulonglong)CONCAT14(bVar14,*puVar17) << 1;
  *puVar17 = (uint)uVar18 | (uint)bVar14;
  bVar14 = (uVar18 & 0x100000000) != 0;
  bVar12 = *(byte *)unaff_EBX;
  bVar15 = (byte)((uint)unaff_EBX >> 8);
  bVar16 = *(byte *)unaff_EBX + bVar15;
  *(byte *)unaff_EBX = bVar16 + bVar14;
  puVar17 = (uint *)(uVar13 + 0x49 + iVar11);
  *puVar17 = *puVar17 << 1 | (uint)(CARRY1(bVar12,bVar15) || CARRY1(bVar16,bVar14));
  pcVar19 = (code *)swi(3);
  (*pcVar19)();
  return;
}
...
code_?:
    ...
    if ((this_00->fields).isActive != 0) {
      ...
      uVar22 = pVVar15->x;
      uVar23 = pVVar15->y;
      uVar24 = (this_00->fields).relativeCurrentTargetPosition.x;
      uVar25 = (this_00->fields).relativeCurrentTargetPosition.y;
      if (pLVar21 == (LineRenderer *)0x0) goto code_?;
      position.y = (float)uVar25 + (float)uVar23;
      position.x = (float)uVar24 + (float)uVar22;
      position.z = (this_00->fields).relativeCurrentTargetPosition.z + pVVar15->z;
      UnityEngine.CoreModule.dll::UnityEngine::LineRenderer::LineRenderer_SetPosition
...
code_?:
  ...
  if (pLVar21 != (LineRenderer *)0x0) {
    ...
    if ((pLVar21 != (LineRenderer *)0x0) &&
      ...
      if ((this_00->fields).isLocal == 0) {
code_?:
        fVar28 = (this_00->fields).relativeCurrentTargetPosition.x;
        fVar29 = (this_00->fields).relativeCurrentTargetPosition.y;
        uVar30._0_4_ = pVVar2->x;
        uVar30._4_4_ = pVVar2->y;
        fVar4 = (this_00->fields).relativeTargetPosition.z;
        puVar8 = &UNK_?;
        fVar5 = UnityEngine.CoreModule.dll::UnityEngine::Time::Time_1_get_deltaTime
                          ((MethodInfo *)0x0);
        pLVar26 = (LaserPointer *)(fVar5 * _UNK_?);
        ...
        (this_00->fields).relativeCurrentTargetPosition.x =
             ((float)uVar30 - fVar28) * (float)pLVar26 + fVar28;
        (this_00->fields).relativeCurrentTargetPosition.y =
             (SUB84(uVar30,4) - fVar29) * (float)pLVar26 + fVar29;
        (this_00->fields).relativeCurrentTargetPosition.z =
             (fVar4 - (float)puVar8) * (float)pLVar26 + (float)puVar8;
        return;
      }
      pLVar21 = (this_00->fields).lineRenderer;
      if (pLVar21 != (LineRenderer *)0x0) {
        ...
        if ((pTVar1 != (Transform *)0x0) &&
          ...
          fVar9 = fVar9 + (float)uVar32 * _UNK_?;
          ...
          if (pTVar1 != (Transform *)0x0) {
            ...
            uVar33 = pVVar15->x;
            uVar34 = pVVar15->y;
            fVar5 = (float)this - (float)uVar33;
            fVar9 = fVar9 - (float)uVar34;
            ...
            if ((pTVar1 != (Transform *)0x0) &&
              ...
              forward.x = fVar5;
              forward.z = fVar4;
              pQVar36 = UnityEngine.CoreModule.dll::UnityEngine::Quaternion::Quaternion_LookRotation
              ...
              if (pTVar1 != (Transform *)0x0) {
                ...
                upwards.x = fVar10;
                upwards.z = fVar28;
                pQVar36 = UnityEngine.CoreModule.dll::UnityEngine::Quaternion::
                ...
                pVVar15 = UnityEngine.CoreModule.dll::UnityEngine::Quaternion::
                          Quaternion_op_Multiply_1
                                    ((Vector3 *)&stack0xffffffe0,rotation,
                                     ...
                                     (MethodInfo *)0x0);
                uVar38._0_4_ = pVVar15->x;
                uVar38._4_4_ = pVVar15->y;
                fVar5 = pVVar15->z;
                ...
                pVVar2->x = (float)uVar38 * fVar4;
                pVVar2->y = SUB84(uVar38,4) * fVar4;
