...
code_?:
      bVar1 = 0;
      func_?();
      bVar2 = (byte)((uint)extraout_EDX >> 8);
      bVar3 = (byte)extraout_EDX + bVar2;
      cVar4 = bVar3 + bVar1;
      pcVar5 = (char *)(CONCAT31((int3)((uint)extraout_EDX >> 8),cVar4) + 0x65);
      *pcVar5 = *pcVar5 + cVar4 + (CARRY1((byte)extraout_EDX,bVar2) || CARRY1(bVar3,bVar1));
      pcVar6 = (code *)swi(3);
