  ...
  if (pDStack_9 != (Dictionary_2_System_Object_System_Object_ *)0x0) {
    ...
    if (pDVar11 != (Dictionary_2_System_Object_System_Object_ *)0x0) {
      ...
      if (pDVar11 != (Dictionary_2_System_Object_System_Object_ *)0x0) {
        ...
        pDVar11 = (Dictionary_2_System_Object_System_Object_ *)(pCVar7->fields)._.table;
        pDStack_14 = (Dictionary_2_TKey_TValue_Enumerator_System_Object_System_Object_ *)0x3;
        pDStack_9 = (Dictionary_2_System_Object_System_Object_ *)func_?();
        pOStack_10 = (Object *)func_?();
        mscorlib.dll::System::ThrowHelper::ThrowHelper_1_IfNullAndNullsAreIllegalThenThrow_55
                  (pOStack_10,ExceptionArgument__Enum_obj,in_stack_6);
        if (pDVar11 != (Dictionary_2_System_Object_System_Object_ *)0x0) {
          mscorlib.dll::System::Collections::Generic::Dictionary`2[System::Object,System::Object]::
          Dictionary_2_System_Object_System_Object__Add
                    (pDVar11,(Object *)pDStack_9,pOStack_10,
          ...
          if (this_00 != (Dictionary_2_System_Object_IState_ *)0x0) {
            ...
            DStack_8._dictionary = (Dictionary_2_System_Object_System_Object_ *)pDVar15->_dictionary
            ;
            DStack_8._version = pDVar15->_version;
            DStack_8._index = pDVar15->_index;
            DStack_8._current.key = (Object *)(pDVar15->_current).key;
            DStack_8._16_8_ = *(undefined8 *)&(pDVar15->_current).value;
            uStack_16 = 0;
            uStack_1 = 1;
            pDStack_14 = &DStack_8;
            while( true ) {
              ...
              pOVar19 = DStack_8._current.value;
              ...
              if (((pOVar19->klass->_1).naturalAligment <
                   (TypeInfo__CubeModelTool->_1).naturalAligment) ||
                 ((pOVar19->klass->_1).typeHierarchy
                  [(TypeInfo__CubeModelTool->_1).naturalAligment - 1] !=
                  (Il2CppClass *)TypeInfo__CubeModelTool)) goto code_?;
              pOVar19[1].monitor = (MonitorData *)this;
            }
          }
        }
      }
