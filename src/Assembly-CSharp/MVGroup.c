  ...
  *unaff_FS_OFFSET = &uStack_3;
  ...
  if (pMVar4 == (MVWorldObjectClient *)0x0) {
    ...
    if (((pMVar4->klass->_1).naturalAligment < bVar5) ||
       ((MVGroup__Class *)(pMVar4->klass->_1).typeHierarchy[bVar5 - 1] != TypeInfo__MVGroup)) {
      func_?();
      goto code_?;
    }
  }
  ...
  if (this_00 != (List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)0x0) {
    ...
    while( true ) {
      ...
      (**(code **)(pMVar8->methodPointer + 0x240))();
    }
  }
code_?:
  func_?();
  ...
  if (woList != (List_1_MVWorldObjectClient_ *)0x0) {
    if ((woList->fields)._size == 0) {
      ...
      for (VStack_2.z = 1.4013e-45; (int)VStack_2.z < (woList->fields)._size;
        ...
        fStack_14 = BStack_9.m_Extents.z + 3.5359857e-29;
  ...
  if (this_00 != (MethodInfo *)0x0) {
    ...
    if (this_01 != (List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)0x0) {
      ...
      while( true ) {
        ...
        if (((*(byte *)(*(int *)RVar6 + 0xb8) < bVar8) ||
            (*(MVGroup__Class **)(*(int *)(*(int *)RVar6 + 100) + -4 + (uint)bVar8 * 4) !=
             TypeInfo__MVGroup)) || (RVar6 == (RegexCharClass_SingleRange)0x0)) {
          System.Core.dll::System::Collections::Generic::HashSet`1[System::Int32]::
          HashSet_1_System_Int32__System_Collections_Generic_ICollection_T__Add
          ...
          HashSet_1_System_Int32__UnionWith
                    ((HashSet_1_System_Int32_ *)this_00,(IEnumerable_1_System_Int32_ *)pHVar10,
                     MethodInfo__System__Collections__Generic__HashSet<int>__UnionWith_System__Collections__Generic__IEnumerable<int>_
                    );
        }
      }
    ...
    if (this_00 !=
      ...
      if (this_01 !=
        ...
        while( true ) {
          ...
          (*(code *)(DStack_8._currentValue)->klass[2]._1.cctor_started)
                    (DStack_8._currentValue,callBack,
                     (DStack_8._currentValue)->klass[2]._1.cctor_finished_or_no_cctor);
        }
      }
    }
  }
