...
code_?:
  pcVar6 = (char *)func_?();
  ppPVar7 = &(((MVNetworkGame_OperationRequests *)this)->fields).peer;
  *ppPVar7 = (PhotonPeer *)((uint)*ppPVar7 & 0xADDR);
  cVar8 = (char)pcVar6;
  *pcVar6 = *pcVar6 + cVar8;
  *extraout_ECX = *extraout_ECX + cVar8;
  piVar9 = (int *)(CONCAT31((int3)((uint)pcVar6 >> 8),cVar8 + *pcVar6) + *unaff_EBX);
  pcVar6 = (char *)((int)piVar9 + *unaff_EBX + *unaff_EBX + *unaff_EBX + *unaff_EBX + *piVar9);
  cVar8 = (char)pcVar6;
  *pcVar6 = *pcVar6 + cVar8;
  *pcVar6 = *pcVar6 + cVar8;
  *pcVar6 = *pcVar6 + cVar8;
