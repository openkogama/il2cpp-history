...
void Assembly-CSharp.dll::DG::Tweening::DOTweenModuleUnityVersion+<AsyncWaitForPosition>d__14::
     DOTweenModuleUnityVersion_AsyncWaitForPosition_d_14_MoveNext
               (DOTweenModuleUnityVersion_AsyncWaitForPosition_d_14 *this,MethodInfo *method)

{
  pDStackX_20 = this;
  if (cRam_? == '\0') {
    FUN_?(&
                  void_MethodInfo__System__Runtime__CompilerServices__AsyncTaskMethodBuilder__AwaitUnsafeOnCompleted<System::Runtime::CompilerServices::YieldAwaitable::YieldAwaiter,_DG::Tweening::DOTweenModuleUnityVersion::_AsyncWaitForPosition_d__14>_System__Runtime__CompilerServices__YieldAwaitable__YieldAwaiter___DG__Tweening__DOTweenModuleUnityVersion___AsyncWaitForPosition_d__14__
                 );
    LOCK();
    UNLOCK();
  ...
  if (pTVar1 != (Tween *)0x0) {
    if (((pTVar1->fields)._active_k__BackingField != 0) &&
       ((float)((pTVar1->fields).completedLoops + 1) * (pTVar1->fields)._position_k__BackingField <
        this->position)) {
...
void Assembly-CSharp.dll::DG::Tweening::DOTweenModuleUnityVersion+<AsyncWaitForPosition>d__14::
     DOTweenModuleUnityVersion_AsyncWaitForPosition_d_14_SetStateMachine
               (DOTweenModuleUnityVersion_AsyncWaitForPosition_d_14 *this,
