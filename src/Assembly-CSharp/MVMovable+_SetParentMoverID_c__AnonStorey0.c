...
bool Assembly-CSharp.dll::MVMovable+<SetParentMoverID>c__AnonStorey0::
     MVMovable_SetParentMoverID_c_AnonStorey0___m__0
               (MVMovable_SetParentMoverID_c_AnonStorey0 *this,
...

{
  ...
  if (this_00 != (Collection_1_VoxelHit_ *)0x0) {
    ...
    return pIVar1 == (IList_1_VoxelHit_ *)(this->fields).parentMoverID;
  }
  func_?();
  pcVar2 = (code *)swi(3);
  bVar3 = (*pcVar2)();
