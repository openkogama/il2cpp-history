...
void Assembly-CSharp.dll::ModalPopupCreator+<Create>c__AnonStorey0::
     ModalPopupCreator_Create_c_AnonStorey0___m__0
               (ModalPopupCreator_Create_c_AnonStorey0 *this,IUIStack *x,BaseEventData *y,
               MethodInfo *method)
