...

{
  ...
  pFVar1 = (FirstTimeActivatableElementBase_c *)
           FUN_?(TypeInfo__FirstTimeActivatableElementBase____c);
  TypeInfo__FirstTimeActivatableElementBase____c->static_fields->__9 = pFVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__FirstTimeActivatableElementBase____c->static_fields >> 0xc);
