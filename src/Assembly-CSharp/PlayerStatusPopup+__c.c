...
code_?:
  ...
  (*pVVar5->methodPtr)(x,0x40,pVVar5->method,pVVar5->methodPtr);
  return;
}
...

{
  ...
  pPVar1 = (PlayerStatusPopup_c *)FUN_?(TypeInfo__PlayerStatusPopup____c);
  TypeInfo__PlayerStatusPopup____c->static_fields->__9 = pPVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__PlayerStatusPopup____c->static_fields >> 0xc);
