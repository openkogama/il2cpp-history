...

{
  ...
  case Face__Enum_Top:
    ...
    bVar3 = uVar7 == 0;
    uVar4 = SBORROW4(uVar7,1);
    if (uVar7 < 2) goto code_?;
    uVar7 = pVVar1->max_length;
    bVar3 = uVar7 == 0;
    uVar4 = SBORROW4(uVar7,1);
  ...
  case Face__Enum_Bottom:
    ...
    uVar7 = pVVar2->max_length;
    bVar3 = uVar7 < 4;
    uVar4 = SBORROW4(uVar7,4);
    if (uVar7 < 5) goto code_?;
    bVar3 = 0;
    uVar4 = 0;
    fVar5 = pVVar2->vector[4].y;
    fVar6 = pVVar2->vector[4].z;
    if (pVVar1->max_length == 0) goto code_?;
    ...
    uVar7 = pVVar2->max_length;
    bVar3 = uVar7 < 5;
    uVar4 = SBORROW4(uVar7,5);
    if (uVar7 < 6) goto code_?;
    uVar7 = pVVar1->max_length;
    bVar3 = uVar7 == 0;
    uVar4 = SBORROW4(uVar7,1);
    fVar5 = pVVar2->vector[5].y;
    fVar6 = pVVar2->vector[5].z;
    if (uVar7 < 2) goto code_?;
    ...
    uVar7 = pVVar2->max_length;
    bVar3 = uVar7 < 6;
    uVar4 = SBORROW4(uVar7,6);
    if (uVar7 < 7) goto code_?;
    uVar7 = pVVar1->max_length;
    bVar3 = uVar7 < 2;
    uVar4 = SBORROW4(uVar7,2);
    fVar5 = pVVar2->vector[6].y;
    fVar6 = pVVar2->vector[6].z;
    if (uVar7 < 3) goto code_?;
    ...
    uVar7 = pVVar2->max_length;
    bVar3 = uVar7 < 7;
    uVar4 = SBORROW4(uVar7,7);
    if (uVar7 < 8) goto code_?;
    uVar8._0_4_ = pVVar2->vector[7].x;
    uVar8._4_4_ = pVVar2->vector[7].y;
    fVar6 = pVVar2->vector[7].z;
    break;
  case Face__Enum_Front:
    pVVar1 = *faceVertices;
    if ((pVVar1 == (Vector3__Array *)0x0) || (pVVar2 = *corners, pVVar2 == (Vector3__Array *)0x0))
...
code_?:
    uVar8 = func_?();
    pVVar2 = (Vector3__Array *)uVar8;
    if ((bool)uVar4) {
      pbVar9 = (byte *)((int)&pVVar2->vector[8].x + 2);
      bVar10 = *pbVar9;
      bVar11 = *pbVar9 + (byte)uVar8;
      *pbVar9 = bVar11 + bVar3;
      puVar12 = (uint *)(unaff_EBX + -0x26);
      uVar7 = (uint)(CARRY1(bVar10,(byte)uVar8) || CARRY1(bVar11,bVar3));
      bVar13 = (Vector3__Array **)*puVar12 < faceVertices || *puVar12 - (int)faceVertices < uVar7;
      *puVar12 = (*puVar12 - (int)faceVertices) - uVar7;
      bVar10 = (byte)((ulonglong)uVar8 >> 0x20);
      bVar11 = (byte)((ulonglong)uVar8 >> 0x28);
      bVar3 = bVar10 + bVar11;
      bVar14 = CARRY1(bVar3,bVar13);
      bVar15 = CARRY1(bVar10,bVar11) || bVar14;
      cVar16 = (char)((ulonglong)uVar8 >> 8);
      if (!CARRY1(bVar10,bVar11) && !bVar14) {
        *(char *)((int)faceVertices + 0xf) = *(char *)((int)faceVertices + 0xf) + cVar16 + bVar15;
        return;
      }
      bVar10 = (byte)unaff_EBX + (byte)extraout_ECX;
      if ((byte)(bVar10 + bVar15) == '\0') {
        return;
      }
      (&stack0x8b5510d6)[(int)faceVertices * 2] =
           (&stack0x8b5510d6)[(int)faceVertices * 2] + cVar16 +
           (CARRY1((byte)unaff_EBX,(byte)extraout_ECX) || CARRY1(bVar10,bVar15));
      in((short)CONCAT31((int3)((ulonglong)uVar8 >> 0x28),bVar3 + bVar13));
      uVar7 = 0;
      if (corners[3] == (Vector3__Array *)0x0) goto code_?;
      uVar17 = corners[3]->max_length;
      goto code_?;
    }
...
code_?:
  ...
  pVVar1->vector[3].x = (float)(int)uVar8;
  pVVar1->vector[3].y = (float)(int)((ulonglong)uVar8 >> 0x20);
  pVVar1->vector[3].z = fVar6;
code_?:
  return;
code_?:
