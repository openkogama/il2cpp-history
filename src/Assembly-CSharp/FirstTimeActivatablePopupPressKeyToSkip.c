...

{
  if (cRam_? == '\0') {
    ...
    func_?(&TypeInfo__FirstTimeActivatablePopupPressKeyToSkip____c);
    cRam_? = '\x01';
  }
  (this->fields).visible = 0;
  root = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_gameObject
                   ((Component *)this,(MethodInfo *)0x0);
  if ((TypeInfo__FirstTimeActivatablePopupPressKeyToSkip____c->_1).cctor_finished_or_no_cctor == 0)
  {
    func_?(TypeInfo__FirstTimeActivatablePopupPressKeyToSkip____c);
  }
  callbackFunction =
       TypeInfo__FirstTimeActivatablePopupPressKeyToSkip____c->static_fields->__9__10_0;
  if (callbackFunction == (ExecuteEvents_EventFunction_1_IUIStack_ *)0x0) {
    ...
    TypeInfo__FirstTimeActivatablePopupPressKeyToSkip____c->static_fields->__9__10_0 =
         callbackFunction;
    func_?(&TypeInfo__FirstTimeActivatablePopupPressKeyToSkip____c->static_fields->
                     __9__10_0,callbackFunction);
  }
...

{
  if (cRam_? == '\0') {
    ...
    func_?(&TypeInfo__FirstTimeActivatablePopupPressKeyToSkip____c__DisplayClass8_0);
...
{
  if (cRam_? == '\0') {
    func_?(&MethodInfo__System__Collections__Generic__List<KogamaControls>__get_Count__);
    func_?(&MethodInfo__System__Collections__Generic__List<KogamaControls>__get_Item_int_);
    ...
    if ((this->fields).minLifeTime <= fVar2) {
      ...
      while (pLVar3 != (List_1_KogamaControls_ *)0x0) {
        ...
        this_00 = (List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)
                  (this->fields).keysToDetect;
        if (this_00 == (List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)0x0)
        break;
        control = mscorlib.dll::System::Collections::Generic::List`1[System::Text::
        ...
        bVar4 = MVInputWrapper::MVInputWrapper_GetBooleanControlDown
                          ((KogamaControls__Enum)control,(MethodInfo *)0x0);
        if (bVar4 != 0) {
