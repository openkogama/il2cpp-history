...

{
  ...
  pSVar1 = (SpawnRoleTierSettings_c *)FUN_?(TypeInfo__SpawnRoleTierSettings____c);
  TypeInfo__SpawnRoleTierSettings____c->static_fields->__9 = pSVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__SpawnRoleTierSettings____c->static_fields >> 0xc);
