            ...
            if (pLVar3 != (List_1_GreyOutObjectScript_PickupOriginalMaterials_ *)0x0) {
              ...
              if (-1 < (int)index) {
                ...
                do {
                  ...
                  pGVar6 = (pLVar3->fields)._items;
                  if (pGVar6 == (GreyOutObjectScript_PickupOriginalMaterials__Array *)0x0)
                  goto code_?;
                  if ((uint)pGVar6->max_length <= index) {
                    FUN_?();
                    pcVar5 = (code *)swi(3);
                    (*pcVar5)();
                    return;
                  }
                  lVar7 = *(longlong *)((longlong)pGVar6->vector + lVar4 + -0x20);
...
code_?:
                    ...
                    if (*(longlong *)(lVar7 + 0x10) == 0) goto code_?;
                    if ((((pGVar1->fields).pickupOriginalMaterials ==
                          (List_1_GreyOutObjectScript_PickupOriginalMaterials_ *)0x0) ||
                        (lVar7 = FUN_?(), lVar7 == 0)) ||
                       (*(Component **)(lVar7 + 0x10) == (Component *)0x0))
                    goto code_?;
                    pGVar8 = UnityEngine.CoreModule.dll::UnityEngine::Component::
                             Component_get_gameObject
                                       (*(Component **)(lVar7 + 0x10),(MethodInfo *)0x0);
                    if (*(int *)&(TypeInfo__UnityEngine__Object->_1).field_0x1c == 0) {
                      FUN_?();
                    }
                    if (cRam_? == '\0') {
                    ...
                    pLVar3 = (pGVar1->fields).pickupOriginalMaterials;
                    if ((pLVar3 == (List_1_GreyOutObjectScript_PickupOriginalMaterials_ *)0x0) ||
                       (uVar9 = FUN_?(pLVar3,index),
                       pUVar2 == (UnityAction_1_System_Object_ *)0x0)) goto code_?;
                    (*(pUVar2->fields)._._.invoke_impl)
                              ((pUVar2->fields)._._.method_code,uVar9,(pUVar2->fields)._._.method);
                  }
                  lVar4 = lVar4 + -8;
                  index = index - 1;
                } while (-1 < (int)index);
...
code_?:
          ...
          if (pGVar1 != (GreyOutObjectScript *)0x0) {
            ...
            GreyOutObjectScript::GreyOutObjectScript_ExecuteOnMaterials
                      (pGVar1,(Action_1_GreyOutObjectScript_PickupOriginalMaterials_ *)pUVar2,
                       (MethodInfo *)0x0);
