...
bool Assembly-CSharp.dll::ProfileSettingsMenu+<MouseSetRoutine>d__13::
     ProfileSettingsMenu_MouseSetRoutine_d_13_MoveNext
               (ProfileSettingsMenu_MouseSetRoutine_d_13 *this,MethodInfo *method)
  ...
  if (iVar1 != 0) {
    ...
    if (((pPVar2 != (ProfileSettingsMenu *)0x0) &&
      ...
      if (pSVar3 != (SettingsSlider *)0x0) {
        ...
        pSVar3 = (pPVar2->fields).mouseSensitivitySlider;
        if (pSVar3 != (SettingsSlider *)0x0) {
          fStack_6 = (float)fVar5 * (pSVar3->fields).interval;
          fVar7 = _UNK_?;
...
void Assembly-CSharp.dll::ProfileSettingsMenu+<MouseSetRoutine>d__13::
     ProfileSettingsMenu_MouseSetRoutine_d_13_System_Collections_IEnumerator_Reset
               (ProfileSettingsMenu_MouseSetRoutine_d_13 *this,MethodInfo *method)

{
  ...
  func_?(&
                  MethodInfo__ProfileSettingsMenu___MouseSetRoutine_d__13__System_Collections_IEnumerator_Reset__
                 );
  func_?(this_00);
  pcVar2 = (code *)swi(3);
  (*pcVar2)();
