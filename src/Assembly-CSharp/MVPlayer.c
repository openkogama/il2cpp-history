  ...
  *ppUVar1 = userProfileData;
  ...
  if ((userProfileData != (UserProfileData *)0x0) &&
    ...
    *ppSVar3 = this_01;
    ...
    if (profileID < 1) {
      pUVar4 = (this->fields)._UserProfileData_k__BackingField;
      if ((pUVar4 == (UserProfileData *)0x0) ||
         (pSVar5 = (pUVar4->fields).UserName, pSVar5 == (String *)0x0)) goto code_?;
      bVar6 = mscorlib.dll::System::String::String_Contains
                        (pSVar5,StringLiteral_Tourist,(MethodInfo *)0x0);
      if (bVar6 != 0) {
        pSVar5 = TM::TM__(StringLiteral_Tourist,(MethodInfo *)0x0);
        pUVar4 = (this->fields)._UserProfileData_k__BackingField;
        if ((pUVar4 == (UserProfileData *)0x0) ||
           (this_00 = (pUVar4->fields).UserName, this_00 == (String *)0x0)) goto code_?;
        pSVar5 = mscorlib.dll::System::String::String_Replace_1
                           (this_00,StringLiteral_Tourist,pSVar5,(MethodInfo *)0x0);
        ppSVar7 = &(pUVar4->fields).UserName;
        *ppSVar7 = pSVar5;
        func_?(ppSVar7,pSVar5);
      }
    }
    ppSVar7 = &(this->fields)._RegionCode_k__BackingField;
    *ppSVar7 = regionCode;
    func_?(ppSVar7,regionCode);
    if (isReady == 0) {
      if (observer == 0) {
        return;
      }
