...
bool Assembly-CSharp.dll::Newtonsoft::Json::Linq::JToken+<AfterSelf>c__Iterator1::
     JToken_AfterSelf_c_Iterator1_MoveNext(JToken_AfterSelf_c_Iterator1 *this,MethodInfo *method)
...
void Assembly-CSharp.dll::Newtonsoft::Json::Linq::JToken+<AfterSelf>c__Iterator1::
     JToken_AfterSelf_c_Iterator1_Reset(JToken_AfterSelf_c_Iterator1 *this,MethodInfo *method)
...
Assembly-CSharp.dll::Newtonsoft::Json::Linq::JToken+<AfterSelf>c__Iterator1::
JToken_AfterSelf_c_Iterator1_System_Collections_Generic_IEnumerable_Newtonsoft_Json_Linq_JToken__GetEnumerator
          (JToken_AfterSelf_c_Iterator1 *this,MethodInfo *method)
...
IEnumerator *
Assembly-CSharp.dll::Newtonsoft::Json::Linq::JToken+<AfterSelf>c__Iterator1::
JToken_AfterSelf_c_Iterator1_System_Collections_IEnumerable_GetEnumerator
          (JToken_AfterSelf_c_Iterator1 *this,MethodInfo *method)
