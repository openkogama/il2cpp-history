...
code_?:
      ...
      while (-1 < (this->fields)._i_5__4) {
        ...
        fVar6 = (float)(this->fields)._i_5__4 / (float)(pAVar2->fields).Rows;
        (this->fields)._y_5__2 = fVar6;
        fVar6 = fVar6 * (pAVar2->fields).cellHeightMultiplier;
        (this->fields)._y_5__2 = fVar6;
        fVar3 = (float)(pAVar2->fields).spriteHeight;
        iVar1 = (pAVar2->fields).spriteUnusedPixelHeight;
        (this->fields)._j_5__5 = 0;
        (this->fields)._y_5__2 = (fVar3 * fVar6 + (float)iVar1) / fVar3;
code_?:
        if (pAVar2 == (AnimatedSpriteSheetTexture *)0x0) goto code_?;
