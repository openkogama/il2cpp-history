...
/* WorldObjectDestroyedEventArgs(Int32) */

void Assembly-CSharp.dll::WorldObjectDestroyedEventArgs::WorldObjectDestroyedEventArgs__ctor
               (WorldObjectDestroyedEventArgs *this,int32_t woID,MethodInfo *method)
