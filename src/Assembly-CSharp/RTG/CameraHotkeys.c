...

{
  ...
  if (pHVar1 != (Hotkeys *)0x0) {
    ...
    func_?(&(this->fields)._moveForward,pHVar1);
    pHVar1 = (Hotkeys *)func_?(TypeInfo__RTG__Hotkeys);
    ...
    if (pHVar1 != (Hotkeys *)0x0) {
      ...
      func_?(&(this->fields)._moveBack,pHVar1);
      pHVar1 = (Hotkeys *)func_?(TypeInfo__RTG__Hotkeys);
      ...
      if (pHVar1 != (Hotkeys *)0x0) {
        ...
        func_?(&(this->fields)._strafeLeft,pHVar1);
        pHVar1 = (Hotkeys *)func_?(TypeInfo__RTG__Hotkeys);
        ...
        if (pHVar1 != (Hotkeys *)0x0) {
          ...
          func_?(&(this->fields)._strafeRight,pHVar1);
          pHVar1 = (Hotkeys *)func_?(TypeInfo__RTG__Hotkeys);
          ...
          if (pHVar1 != (Hotkeys *)0x0) {
            ...
            func_?(&(this->fields)._moveUp,pHVar1);
            pHVar1 = (Hotkeys *)func_?(TypeInfo__RTG__Hotkeys);
            ...
            if (pHVar1 != (Hotkeys *)0x0) {
              ...
              func_?(&(this->fields)._moveDown,pHVar1);
              pHVar1 = (Hotkeys *)func_?(TypeInfo__RTG__Hotkeys);
              ...
              if (pHVar1 != (Hotkeys *)0x0) {
                ...
                if (pHVar1 != (Hotkeys *)0x0) {
                  ...
                  func_?(&(this->fields)._lookAround,pHVar1);
                  pHVar1 = (Hotkeys *)func_?(TypeInfo__RTG__Hotkeys);
                  ...
                  if (pHVar1 != (Hotkeys *)0x0) {
                    ...
                    func_?(&(this->fields)._orbit,pHVar1);
                    if (cRam_? == '\0') {
