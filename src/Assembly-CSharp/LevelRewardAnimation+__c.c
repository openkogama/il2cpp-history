...

{
  ...
  pLVar1 = (LevelRewardAnimation_c *)FUN_?(TypeInfo__LevelRewardAnimation____c);
  TypeInfo__LevelRewardAnimation____c->static_fields->__9 = pLVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__LevelRewardAnimation____c->static_fields >> 0xc);
