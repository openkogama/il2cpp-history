...
code_?:
      ...
      if (isLocal == 0) {
        ...
        pAVar6 = (Action_1_UnityEngine_UIElements_Internal_MultiColumnCollectionHeader_ViewState_ColumnState_
                   *)func_?();
...
code_?:
          ...
          if (pMVar8 != (MVPickupOwner *)0x0) {
            ...
            pVVar2 = MVPickupOwner::MVPickupOwner_get_LookDirection
                                ((Vector3 *)&stack0xffffffc8,pMVar8,(MethodInfo *)0x0);
            ...
            if (pMVar8 != (MVPickupOwner *)0x0) {
              speed = MVPickupOwner::MVPickupOwner_GetAbsolutProjectileSpeed
                                (pMVar8,(this->fields).rocketSpeed,(MethodInfo *)0x0);
              ...
              if (pMVar8 != (MVPickupOwner *)0x0) {
                ...
                if ((pCVar16 != (Camera *)0x0) &&
                   (pTVar1 = UnityEngine.CoreModule.dll::UnityEngine::Component::
                              Component_get_transform((Component *)pCVar16,(MethodInfo *)0x0),
                  ...
                  if ((pCVar16 != (Camera *)0x0) &&
                    ...
                    if (this_01 != (AudioManager *)0x0) {
                      ...
                      AudioManager::AudioManager_Play_2
                                (this_01,StringLiteral_rocket_fired,audioSource,position,
                                 (MethodInfo *)0x0);
                      ...
                      iVar19 = Assembly-CSharp-firstpass.dll::CodeStage::AntiCheat::ObscuredTypes::
                      ...
                      pOVar22 = Assembly-CSharp-firstpass.dll::CodeStage::AntiCheat::ObscuredTypes::
                                ObscuredInt::ObscuredInt_op_Implicit
                                          ((ObscuredInt *)&stack0xffffffc4,iVar19 + -1,
                                           (MethodInfo *)0x0);
            ...
            if (bVar13 != 0) {
              ...
              if (0.0 <= fStack_4) {
                ...
                pIVar33 = ProximityDamageAndImpulse::ProximityDamageAndImpulse_Create
                                    ((InteractionData *)auStack_19,fStack_4,impulse,
                ...
                if (iVar37 != 0) {
                  ...
                  func_?(0,TypeInfo__IBulletImpactVisualizer,iVar37,(int)uVar34,
                                  (int)((ulonglong)uVar34 >> 0x20),fVar28,uVar35,uVar36,puStack_40,
