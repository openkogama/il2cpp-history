    ...
    if (pAVar12 != (AnimationCurve *)0x0) {
      ...
      if (pGVar4 != (Graphic *)0x0) {
        ...
        if (pRVar5 != (RectTransform *)0x0) {
          fVar3 = 0.0;
          value_01.y = (float)(int)this_00->interfaceOffsets * fVar13;
          value_01.x = (float)(int)this_00->interfaceOffsets * fVar13;
          UnityEngine.CoreModule.dll::UnityEngine::RectTransform::RectTransform_set_sizeDelta
...
code_?:
  ...
  uVar19 = CONCAT31((int3)((uint)uVar16 >> 8),0x91);
  pcVar20 = (char *)(uVar19 - 0x6b);
  *pcVar20 = *pcVar20 + (char)((uint)uVar16 >> 8) + (uVar19 < 0x3d935010);
  pcVar21 = (code *)swi(3);
  bVar22 = (*pcVar21)();
  return bVar22;
}
