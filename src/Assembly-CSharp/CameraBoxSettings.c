...
void Assembly-CSharp.dll::CameraBoxSettings::CameraBoxSettings_Initialize
        ...
        if (this_05 != (Dictionary_2_System_Type_Pool_ *)0x0) {
          pPVar1 = mscorlib.dll::System::Collections::Generic::Dictionary`2[System::Type,Pool]::
                   Dictionary_2_System_Type_Pool__get_Item
                             (this_05,(Type *)StringLiteral_distanceToAvatar,
          ...
          fVar2 = mscorlib.dll::System::Convert::Convert_ToSingle_14
                            ((Object *)pPVar1,(MethodInfo *)0x0);
          if (this_01 != (SettingsSlider *)0x0) {
            SettingsSlider::SettingsSlider_Initialize
                      (this_01,StringLiteral_distanceToAvatar,fVar2,3.0,10.0,(MethodInfo *)0x0);
            ...
            if (this_02 != (SettingsInputFieldSlider *)0x0) {
              SettingsInputFieldSlider::SettingsInputFieldSlider_Initialize
                        (this_02,StringLiteral_distanceToAvatar,fVar2,(MethodInfo *)0x0);
              return;
            }
          }
        }
...
void Assembly-CSharp.dll::CameraBoxSettings::CameraBoxSettings_OnSettingChanged
