...
void Assembly-CSharp.dll::AdUIWithTimeout+<Update>c__AnonStorey0::
     AdUIWithTimeout_Update_c_AnonStorey0___m__0
               (AdUIWithTimeout_Update_c_AnonStorey0 *this,IUIStack *x,BaseEventData *y,
               MethodInfo *method)
