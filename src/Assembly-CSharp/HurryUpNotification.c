...
code_?:
      ...
      if (pAVar1 == (Action__Class *)0x0) {
        data[3].fields._values =
             (Dictionary_2_TKey_TValue_ValueCollection_System_Object_System_Object_ *)0x0;
        in_stack_11 = (Action__Class *)0x0;
        unaff_EDI = (Action_1_IWinningCondition___Class *)data;
code_?:
        in_stack_10 =
             (Action__Class *)
             &(((Dictionary_2_System_Object_System_Object_ *)((int)unaff_EDI + 0x90))->fields).
              _values;
        in_stack_12 = &UNK_?;
        func_?();
        return;
      ...
      in_stack_12 = &UNK_?;
      in_stack_10 = pAVar1;
      pDVar14 = (Dictionary_2_TKey_TValue_ValueCollection_System_Object_System_Object_ *)
                func_?();
      unaff_EDI = (Action_1_IWinningCondition___Class *)data;
      in_stack_11 = (Action__Class *)pAVar13;
      if (pDVar14 != (Dictionary_2_TKey_TValue_ValueCollection_System_Object_System_Object_ *)0x0) {
        data[3].fields._values = pDVar14;
