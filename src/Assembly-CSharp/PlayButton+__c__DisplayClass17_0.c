...
/* Void <OnEnable>b__0(IDeathPromotionSelector, BaseEventData) */

void Assembly-CSharp.dll::PlayButton+<>c__DisplayClass17_0::
     PlayButton_c_DisplayClass17_0__OnEnable_b__0
               (PlayButton_c_DisplayClass17_0 *this,IDeathPromotionSelector *x,BaseEventData *y,
               MethodInfo *method)
