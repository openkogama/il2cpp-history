...
void Assembly-CSharp.dll::FadeableAvatarObject+<OnDestroy>c__AnonStorey1::
     FadeableAvatarObject_OnDestroy_c_AnonStorey1___m__0
               (FadeableAvatarObject_OnDestroy_c_AnonStorey1 *this,IFadeParent *x,BaseEventData *y,
               MethodInfo *method)
