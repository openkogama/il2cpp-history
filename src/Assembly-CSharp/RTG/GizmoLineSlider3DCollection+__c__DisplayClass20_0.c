...

{
  if ((s0 != (GizmoLineSlider3D *)0x0) &&
     ((pGVar1 = (s0->fields)._sharedLookAndFeel, pGVar1 != (GizmoLineSlider3DLookAndFeel *)0x0 ||
      (pGVar1 = (s0->fields)._lookAndFeel, pGVar1 != (GizmoLineSlider3DLookAndFeel *)0x0)))) {
    fVar2 = _UNK_?;
    ...
    if ((s1 != (GizmoLineSlider3D *)0x0) &&
       ((pGVar1 = (s1->fields)._sharedLookAndFeel, pGVar1 != (GizmoLineSlider3DLookAndFeel *)0x0 ||
        (pGVar1 = (s1->fields)._lookAndFeel, pGVar1 != (GizmoLineSlider3DLookAndFeel *)0x0)))) {
      fVar2 = _UNK_?;
      if ((pGVar1->fields)._useZoomFactor != 0) {
