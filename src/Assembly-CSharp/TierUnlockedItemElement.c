...
code_?:
  ...
  *(int *)(unaff_EBX + 0x10) = (int)(&UNK_? + *(int *)(unaff_EBX + 0x10));
  pcVar11 = (char *)(iVar10 + -0x7d8cefbd + (uint)uVar9 * 4);
  *pcVar11 = *pcVar11 + extraout_CL + (*(uint *)(iVar10 + -0x7da9efbd) < (uint)uVar9);
  pcVar12 = (code *)swi(3);
  (*pcVar12)();
  return;
}
