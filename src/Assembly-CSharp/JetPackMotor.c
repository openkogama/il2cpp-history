...

{
  ...
  if (pMVar1 != (MVInteractableBase *)0x0) {
    pMVar2 = (pMVar1->klass->vtable).__unknown_6.method;
    (*(code *)pMVar2)(pMVar1,3,0x41400000,(pMVar1->klass->vtable).__unknown_7.methodPtr);
        ...
        if (this_01 != (VehicleEnergyContainer *)0x0) {
          ...
          if ((pSVar18 != (SmoothCharacterController *)0x0) &&
            ...
            if (this_02 != (Transform *)0x0) {
              ...
              fVar1 = fVar1 * fVar15 + 3.485874e-29;
  ...
  if (pVVar1 != (VehicleEnergyContainer *)0x0) {
    ...
    if (pDVar3 != (Dictionary_2_System_Int32_WorldObjectTypes_VehicleEnergy_VehicleEnergyRefillPrediction_
      ...
      if (bVar4 != 0) {
        ...
        fVar2 = (pVVar1->fields).energyStorage - (pVVar1->fields).originalEnergyStorage * fVar2;
  ...
  if (method_00 != (MethodInfo *)0x0) {
    if (method_00->name != (char *)0x0) {
      ...
      while( true ) {
        ...
        LStack_11._current.asset = (VisualTreeAsset *)((float)auStack_13._20_4_ + fStack_17);
        __return_storage_ptr__->x = (float)auStack_13._12_4_ + (float)(undefined4)uStack_16;
        __return_storage_ptr__->y = (float)auStack_13._16_4_ + (float)uStack_16._4_4_;
