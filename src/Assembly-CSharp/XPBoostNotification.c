...
code_?:
      ...
      *(char *)(extraout_EDX + -0x6befb892) =
           *(char *)(extraout_EDX + -0x6befb892) + (char)unaff_EBX +
           (CARRY1(bVar3,bVar5) || CARRY1(bVar9 + bVar5,bVar6));
  ...
  case 2:
    ...
    bVar6 = _UNK_? == 3.9330755e-29;
    bVar13 = 3.9330755e-29 < _UNK_?;
    goto code_?;
  case 3:
    if (0 < (this->fields).currentMemberBeingHighlighted) {
