...
void Assembly-CSharp.dll::ESSelection+<>c__DisplayClass14_0::
     ESSelection_c_DisplayClass14_0__Execute_b__0
               (ESSelection_c_DisplayClass14_0 *this,IModalPopupCreator *handler,BaseEventData *data
               ,MethodInfo *method)
