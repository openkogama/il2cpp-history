...
code_?:
  ...
  bVar12 = (byte)uVar10;
  bVar9 = 0x99 < bVar12 | bVar9;
  pcVar13 = (char *)CONCAT31((int3)((uint6)uVar10 >> 8),
                            bVar12 + (9 < (bVar12 & 0xf) | in_AF) * -6 + bVar9 * -0x60);
  out(uVar11,pcVar13);
  *extraout_ECX = *extraout_ECX + (char)((uint6)uVar10 >> 0x20) + bVar9;
  cVar14 = (char)((uint)extraout_ECX >> 8);
  *pcVar13 = *pcVar13 + cVar14;
  pcVar15 = (char *)((int)&bp[3].klass + 1);
