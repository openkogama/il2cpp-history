...
void Assembly-CSharp.dll::
     FirstTimeActivatableTriggerAreaInventoryHighlight+<GetItemSlot>c__AnonStorey1::
     FirstTimeActivatableTriggerAreaInventoryHighlight_GetItemSlot_c_AnonStorey1___m__0
               (FirstTimeActivatableTriggerAreaInventoryHighlight_GetItemSlot_c_AnonStorey1 *this,
