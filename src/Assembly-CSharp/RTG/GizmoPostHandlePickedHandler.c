...
IAsyncResult *
Assembly-CSharp.dll::RTG::GizmoPostHandlePickedHandler::GizmoPostHandlePickedHandler_BeginInvoke
          (GizmoPostHandlePickedHandler *this,Gizmo *gizmo,int32_t handleId,AsyncCallback *callback,
