...

{
  ...
  func_?();
  in(0xd4);
  bVar9 = CARRY1(in_stack_10,extraout_CH) || CARRY1(in_stack_10 + extraout_CH,bVar8);
  bVar8 = *(byte *)&unaff_ESI->klass;
  *(byte *)&unaff_ESI->klass = bVar8 + bVar9;
  *(char *)&unaff_ESI->klass = *(char *)&unaff_ESI->klass + CARRY1(bVar8,bVar9);
  pcVar11 = (code *)swi(3);
