...
void Assembly-CSharp.dll::DesktopLobbyStateController+<>c__DisplayClass19_0::
     DesktopLobbyStateController_c_DisplayClass19_0__CreateStartGoldRewardPopup_b__0
               (DesktopLobbyStateController_c_DisplayClass19_0 *this,IUIStack *x,BaseEventData *y,
               MethodInfo *method)
