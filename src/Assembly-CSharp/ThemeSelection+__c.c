...

{
  ...
  pTVar1 = (ThemeSelection_c *)FUN_?(TypeInfo__ThemeSelection____c);
  TypeInfo__ThemeSelection____c->static_fields->__9 = pTVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__ThemeSelection____c->static_fields >> 0xc);
