...
void Assembly-CSharp.dll::DG::Tweening::DOTweenModuleUnityVersion+<AsyncWaitForKill>d__12::
     DOTweenModuleUnityVersion_AsyncWaitForKill_d_12_MoveNext
               (DOTweenModuleUnityVersion_AsyncWaitForKill_d_12 *this,MethodInfo *method)

{
  pDStackX_20 = this;
  if (cRam_? == '\0') {
    FUN_?(&
                  void_MethodInfo__System__Runtime__CompilerServices__AsyncTaskMethodBuilder__AwaitUnsafeOnCompleted<System::Runtime::CompilerServices::YieldAwaitable::YieldAwaiter,_DG::Tweening::DOTweenModuleUnityVersion::_AsyncWaitForKill_d__12>_System__Runtime__CompilerServices__YieldAwaitable__YieldAwaiter___DG__Tweening__DOTweenModuleUnityVersion___AsyncWaitForKill_d__12__
                 );
    LOCK();
    UNLOCK();
...
void Assembly-CSharp.dll::DG::Tweening::DOTweenModuleUnityVersion+<AsyncWaitForKill>d__12::
     DOTweenModuleUnityVersion_AsyncWaitForKill_d_12_SetStateMachine
               (DOTweenModuleUnityVersion_AsyncWaitForKill_d_12 *this,
