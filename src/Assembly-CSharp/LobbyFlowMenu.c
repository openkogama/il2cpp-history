...

{
  ...
  *pbVar7 = bVar8 + bVar5;
  ...
  bVar8 = bVar5 + 0x2f;
  pcVar11 = (char *)((int)&value[0xfc20945].monitor + 3);
  *pcVar11 = *pcVar11 + '/' + (0xd0 < bVar5 || CARRY1(bVar8,bVar9));
  pbVar7 = (byte *)(CONCAT22((short)((uint)iVar10 >> 0x10),CONCAT11(bVar8 + bVar9,(char)iVar10)) +
                   0xf);
