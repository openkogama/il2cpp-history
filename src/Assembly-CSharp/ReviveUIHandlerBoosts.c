...

{
  ...
  uVar4 = func_?();
  pcVar5 = (char *)((int)&unaff_EDI[1].monitor + 2);
  *pcVar5 = *pcVar5 + (char)((uint)unaff_EBX >> 8) + (uVar4 < 0x3d6ea810);
  *(char *)(uVar4 + 0xcc103d6e) = *(char *)(uVar4 + 0xcc103d6e) + extraout_CH + (uVar4 < 0x3d6ea610)
  ;
  pcVar6 = (code *)swi(3);
  (*pcVar6)();
  return;
