...

{
  ...
  pMVar1 = (MaterialsController_c *)FUN_?(TypeInfo__MaterialsController____c);
  TypeInfo__MaterialsController____c->static_fields->__9 = pMVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__MaterialsController____c->static_fields >> 0xc);
