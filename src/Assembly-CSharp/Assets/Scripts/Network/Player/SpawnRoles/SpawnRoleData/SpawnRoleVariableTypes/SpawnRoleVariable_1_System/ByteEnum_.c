...

{
  ...
  if (((pSVar1 != (SubscribableVariable_1_System_ByteEnum_ *)0x0) &&
      (uVar2 = (pSVar1->fields)._.value, other != (SpawnRoleVariable_1_System_ByteEnum_ *)0x0)) &&
     (pSVar1 = (other->fields).subscribableVariable,
     pSVar1 != (SubscribableVariable_1_System_ByteEnum_ *)0x0)) {
    auStackX_8[0] = (pSVar1->fields)._.value;
    o2 = (Object *)FUN_?(method->klass->rgctx_data[9].rgctxDataDummy,auStackX_8);
...

{
  ...
  pSVar2 = (SubscribableVariable_1_System_ByteEnum_ *)FUN_?(pvVar1);
  bVar3 = iRam_? != 0;
  (pSVar2->fields)._.value = (uint8_t)value;
  ...
  this_00 = (UnityAction_1_System_ByteEnum_ *)FUN_?(pvVar1);
  ...
  do {
    ...
    if (pDVar12 == (Delegate *)0x0) {
      ...
      pAVar13 = (Action_1_ByteEnum_ *)FUN_?(pDVar12,pvVar1);
...

{
  if ((a != (SpawnRoleVariable_1_System_ByteEnum_ *)0x0) &&
    ...
    auStackX_10[0] = (pSVar1->fields)._.value;
    pIVar2 = method->klass;
    if ((pIVar2->field_0x135 & 1) == 0) {
      pIVar2 = (Il2CppClass *)FUN_?(pIVar2);
    }
    o2 = (Object *)FUN_?(pIVar2->rgctx_data[9].rgctxDataDummy,auStackX_10);
    pIVar2 = method->klass;
    if ((pIVar2->field_0x135 & 1) == 0) {
      pIVar2 = (Il2CppClass *)FUN_?(pIVar2);
    }
...

{
  if ((a != (SpawnRoleVariable_1_System_ByteEnum_ *)0x0) &&
    ...
    o2 = (Object *)FUN_?(pIVar2->rgctx_data[9].rgctxDataDummy,auStackX_8);
    pIVar2 = method->klass;
    if ((pIVar2->field_0x135 & 1) == 0) {
      pIVar2 = (Il2CppClass *)FUN_?(pIVar2);
    }
...

{
  if ((a != (SpawnRoleVariable_1_System_ByteEnum_ *)0x0) &&
    ...
    if ((b != (SpawnRoleVariable_1_System_ByteEnum_ *)0x0) &&
      ...
      o2 = (Object *)FUN_?(pIVar3->rgctx_data[9].rgctxDataDummy,auStackX_8);
      pIVar3 = method->klass;
      if ((pIVar3->field_0x135 & 1) == 0) {
        pIVar3 = (Il2CppClass *)FUN_?(pIVar3);
      }
...

{
  ...
  if ((a != (SpawnRoleVariable_1_System_ByteEnum_ *)0x0) &&
    ...
    if ((b != (SpawnRoleVariable_1_System_ByteEnum_ *)0x0) &&
      ...
      auStackX_8[0] = (pSVar3->fields)._.value;
      pIVar1 = pMVar2->klass;
      if ((pIVar1->field_0x135 & 1) == 0) {
        pIVar1 = (Il2CppClass *)FUN_?(pIVar1);
      }
      o2 = (Object *)FUN_?(pIVar1->rgctx_data[9].rgctxDataDummy,auStackX_8);
      pIVar1 = pMVar2->klass;
      if ((pIVar1->field_0x135 & 1) == 0) {
        pIVar1 = (Il2CppClass *)FUN_?(pIVar1);
      }
