            ...
            if (*ppMVar3 != (MeshRenderer *)0x0) {
              ...
              if (*ppMVar3 != (MeshRenderer *)0x0) {
                ...
                if (this_02 != (Material *)0x0) {
                  pCVar4 = UnityEngine.CoreModule.dll::UnityEngine::Material::Material_GetColor_1
                                     ((Color *)&stack0xffffffec,this_02,
                                      TypeInfo__CellCursorCubeLineMesh->static_fields->ColorID,
                                      (MethodInfo *)0x0);
                  (this->fields).baseAlpha = pCVar4->a;
                  if (this_01 != (MeshFilter *)0x0) {
                    ...
                    SharedCubeFunctions::SharedCubeFunctions_AddCubeMeshCubeLines
                              (mesh,cubeCorners,0.0,(MethodInfo *)0x0);
                    return;
                  }
                }
              }
