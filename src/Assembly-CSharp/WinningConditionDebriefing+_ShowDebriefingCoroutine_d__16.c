...

{
  ...
  uVar7 = 0x104b;
  func_?();
  fVar8 = (float10)func_?(CONCAT22(uVar7,in_CS));
  *(char *)(extraout_EDX + 0x30104bda) =
       *(char *)(extraout_EDX + 0x30104bda) + (char)((uint)this_00 >> 8) + cVar6;
  (this_00->_0).byval_arg.data.__klassIndex = (int)fVar8;
  pcVar9 = (code *)swi(3);
  bVar10 = (*pcVar9)();
  return bVar10;
}
