        ...
        if ((pLVar4->fields)._size < 2) {
          ...
          IStack_5.m_value =
               MVWorldObject.dll::GameStatCounterManager::GameStatCounterManager_GetActorCount
                         ((GameStatCounterManager *)lobbyState,GameStatCounterType__Enum_Collectible
          ...
          IStack_5.m_value =
               MVWorldObject.dll::GameStatCounterManager::GameStatCounterManager_GetTeamCount
                         (this_02,GameStatCounterType__Enum_Collectible,(MVTeam__Enum)lobbyState,
                          (MethodInfo *)0x0);
        }
        pTVar7 = (this->fields).progress;
        value = (float)IStack_5.m_value / (float)(this->fields).amountOfStars;
