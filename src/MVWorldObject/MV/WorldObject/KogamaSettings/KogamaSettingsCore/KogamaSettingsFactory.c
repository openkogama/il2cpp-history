  ...
  case 0:
    ...
    if (pIVar4 == pIVar5) {
      ...
      KogamaSettingTypes::KogamaSettingBoolBase::KogamaSettingBoolBase__ctor
                (this,(String *)unaff_EBX,*pbVar7,parent,(MethodInfo *)0x0);
      ...
      if (valuePair.value != (Object *)0x0) {
        ...
        if (pIVar4 == pIVar5) {
          ...
          KogamaSettingNumericBase_1_System_Single___ctor
                    (unaff_EBX,key,*pfVar13,(float)piVar10,(float)piVar11,parent,pMVar12);
      ...
      if (valuePair.value != (Object *)0x0) {
        ...
        if (pIVar4 == pIVar5) {
          ...
          KogamaSettingNumericBase_1_System_Int32___ctor
                    (this_00,(String *)unaff_EBX,*piVar14,(int32_t)piVar10,(int32_t)piVar11,parent,
                     pMVar12);
      ...
      if (valuePair.value != (Object *)0x0) {
        ...
        if (pIVar4 == pIVar5) {
          ...
          KogamaSettingTypes::KogamaSettingEnumBase::KogamaSettingEnumBase__ctor
                    (this_01,(String *)unaff_EBX,*piVar14,(int32_t)piVar10,(int32_t)piVar11,parent,
                     (MethodInfo *)0x0);
...
code_?:
  iVar2 = func_?(kogamaSettingBasePrototype,pKVar8);
  LOCK();
  pbVar15 = (byte *)((int)&(((Single__Class *)((int)kogamaSettingBasePrototype + 0x6d10efc8))->_1).
                          element_size + 1);
  bVar16 = *pbVar15;
  bVar17 = *pbVar15 + extraout_DL + 1U;
  *pbVar15 = bVar17 + bVar6;
  UNLOCK();
  LOCK();
  *(char *)(iVar2 + 0x1f10f053) =
       *(char *)(iVar2 + 0x1f10f053) + cVar1 +
       (CARRY1(bVar16,extraout_DL + 1U) || CARRY1(bVar17,bVar6));
  UNLOCK();
