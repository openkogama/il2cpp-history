...
code_?:
  ...
  pCVar3 = Styles::Styles_GetColor(pCVar3,(ColorStyle__Enum)colorStyle,(MethodInfo *)0x0);
  CStack_8.r = pCVar3->a;
  cVar2 = (int)pIVar1 < 0;
  this = (TierUnlockedItemElement *)0x0;
  if (pIVar1 != (Image *)0x0) {
    CStack_8.g = (float)(pIVar1->klass->vtable).get_raycastTarget.methodPtr;
...
code_?:
  cVar9 = '\0';
  bVar10 = 0;
  CStack_8.g = (float)&UNK_?;
  iVar11 = func_?();
  if (cVar9 == cVar2) {
    pbVar12 = (byte *)(iVar11 + 0x18b91047 + unaff_EBX);
    bVar13 = (byte)unaff_EBX;
    bVar14 = CARRY1(*pbVar12,bVar13) || CARRY1(*pbVar12 + bVar13,bVar10);
    *pbVar12 = *pbVar12 + bVar13 + bVar10;
    pcVar15 = (char *)((int)&(this->fields).objectPreviewerPrefab + 2);
    *pcVar15 = (*pcVar15 - (byte)iVar11) -
              (CARRY1(extraout_DH,extraout_DL) || CARRY1(extraout_DH + extraout_DL,bVar14));
    pcVar15 = (char *)((int)&(this->fields).objectPreviewerPrefab + 3);
    *pcVar15 = (*pcVar15 - ((byte)iVar11 | 0x19)) - CARRY1(bVar13,extraout_DH + extraout_DL + bVar14);
    pcVar16 = (code *)swi(3);
    (*pcVar16)();
    return;
  }
