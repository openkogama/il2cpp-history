...

{
  ...
  if (collectibleClientState == MVCollectible_CollectibleClientState__Enum_ReShowing) {
    ...
    pcRam_? = pcVar1;
    fVar3 = (float)(*pcRam_?)();
    (this->fields).reshowingStartTime = fVar3;
  }
  return;
}
...

{
  if (((this->fields).state == 0) || ((this->fields).state == 3)) {
    ...
    uVar2._0_4_ = (pVVar8->upVector).x;
    uVar2._4_4_ = (pVVar8->upVector).y;
    fVar3 = (pVVar8->upVector).z;
    pcVar1 = pcRam_?;
    if ((pcRam_? == (code *)0x0) &&
       (pcVar1 = (code *)FUN_?(&UNK_?), pcVar1 == (code *)0x0)) {
      uVar2 = func_?(&UNK_?);
...
code_?:
    ...
    UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_Rotate_4
              (pTVar4,aVStack_10,fVar9 * (this->fields).rotationSpeed * _UNK_?,
    ...
    if ((this->fields).state == 1) {
      ...
      fVar3 = UnityEngine.CoreModule.dll::UnityEngine::Time::Time_1_get_realtimeSinceStartup
                        ((MethodInfo *)0x0);
      fVar3 = (fVar3 - (this->fields).reshowingStartTime) * _UNK_?;
      fVar3 = fVar3 + fVar3;
      pTVar4 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_transform
                         ((Component *)this,(MethodInfo *)0x0);
      if (pTVar4 == (Transform *)0x0) {
