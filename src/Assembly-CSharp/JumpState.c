...

{
  ...
  if ((canWaterJump & (bVar3 ^ 1)) == 0) {
    ...
    if ((wallJumpPossible & (bVar3 ^ 1)) != 0) {
      puVar7 = (undefined8 *)func_?(auStack_8,0);
      uVar9 = (this->fields).latestSlopeDir.x;
      uVar10 = (this->fields).latestSlopeDir.y;
      ...
      fStack_12 = (float)uVar11;
      fStack_13 = (float)((ulonglong)uVar11 >> 0x20);
      if ((TypeInfo__System__Math->_1).cctor_finished_or_no_cctor == 0) {
        func_?(TypeInfo__System__Math);
      }
      pMVar14 = TypeInfo__System__Math;
      dVar15 = (double)(((float)uVar9 * (float)uVar9 + (float)uVar10 * (float)uVar10 + fVar6 * fVar6
                        ) * (fStack_13 * fStack_13 + fStack_12 * fStack_12 + fVar5 * fVar5));
      if (dVar15 < 0.0) {
        func_?();
      }
      else {
      ...
      if ((float)dVar15 < _UNK_?) {
        fVar6 = 0.0;
      }
      else {
        fStack_16 = ((float)uVar10 * fStack_13 + (float)uVar9 * fStack_12 + fVar5 * fVar6) /
                    (float)dVar15;
        fVar6 = _UNK_?;
        if ((fStack_16 < _UNK_?) || (fVar6 = _UNK_?, _UNK_? < fStack_16)) {
          fStack_16 = fVar6;
        }
        if ((pMVar14->_1).cctor_finished_or_no_cctor == 0) {
          func_?(pMVar14);
        }
        dVar15 = (double)fStack_16;
        func_?();
        fVar6 = (float)dVar15 * _UNK_?;
      }
      pfVar4 = &(this->fields).wallJumpAngleMin;
      if ((*pfVar4 <= fVar6 && fVar6 != *pfVar4) && (fVar6 < (this->fields).wallJumpAngleMax)) {
        fVar6 = (this->fields).latestSlopeDir.z;
        uVar17 = (this->fields).latestSlopeDir.x;
        uVar18 = (this->fields).latestSlopeDir.y;
        puVar7 = (undefined8 *)func_?(auStack_8,0);
        fVar5 = *(float *)(puVar7 + 1);
        fStack_19 = (float)*puVar7;
        fStack_20 = (float)((ulonglong)*puVar7 >> 0x20);
        (this->fields).latestSlopeDir.x = fStack_19 + (float)uVar17;
        (this->fields).latestSlopeDir.y = fStack_20 + (float)uVar18;
        (this->fields).latestSlopeDir.z = fVar5 + fVar6;
        UnityEngine.CoreModule.dll::UnityEngine::Vector3::Vector3_Normalize_1
  ...
  fVar5 = (pVVar21->upVector).y;
  fVar6 = (pVVar21->upVector).z;
  __return_storage_ptr__->x = (pVVar21->upVector).x;
  __return_storage_ptr__->y = fVar5;
  __return_storage_ptr__->z = fVar6;
  return __return_storage_ptr__;
}
