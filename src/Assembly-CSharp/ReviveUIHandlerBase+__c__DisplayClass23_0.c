...

{
  if (cRam_? == '\0') {
    ...
    LOCK();
    UNLOCK();
    FUN_?(&MethodInfo__ReviveUIHandlerBase____c__DisplayClass23_0___OnWatchAdClicked_b__1__)
    ;
    LOCK();
    UNLOCK();
...

{
  ...
  pGVar2 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_gameObject
                     ((Component *)this_00,(MethodInfo *)0x0);
  if (*(int *)&(TypeInfo__ReviveUIHandlerBase____c->_1).field_0x1c == 0) {
    FUN_?(TypeInfo__ReviveUIHandlerBase____c);
  }
  this_02 = TypeInfo__ReviveUIHandlerBase____c->static_fields->__9__23_2;
  if (this_02 == (ExecuteEvents_EventFunction_1_IUIStack_ *)0x0) {
    ...
    ExecuteEvents_EventFunction_1_System_Object___ctor
              ((ExecuteEvents_EventFunction_1_System_Object_ *)this_02,(Object *)object,
               MethodInfo__ReviveUIHandlerBase____c___OnWatchAdClicked_b__23_2_UnityEngine__EventSystems__IUIStack__UnityEngine__EventSystems__BaseEventData_
               ,(MethodInfo *)0x0);
    TypeInfo__ReviveUIHandlerBase____c->static_fields->__9__23_2 = this_02;
    if (iRam_? != 0) {
      uVar3 = (uint)((ulonglong)&TypeInfo__ReviveUIHandlerBase____c->static_fields->__9__23_2 >>
                     0xc);
