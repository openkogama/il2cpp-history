...

{
  ...
  if (((pMVar2 != (MVGameControllerBase *)0x0) &&
    ...
    bVar5 = cRam_? == '\0';
    (this->fields).amountOfStars = iVar1;
    if (bVar5) {
      FUN_?(&TypeInfo__MVGameControllerBase);
      LOCK();
      UNLOCK();
      ...
      if ((pLVar6->fields)._size < 2) {
        ...
        value = MVWorldObject.dll::GameStatCounterManager::GameStatCounterManager_GetActorCount
                          (pGVar7,(GameStatCounterType__Enum)
                                  CONCAT71((int7)((ulonglong)uVar10 >> 8),3),team,
        ...
        value = MVWorldObject.dll::GameStatCounterManager::GameStatCounterManager_GetTeamCount
                          (pGVar7,(GameStatCounterType__Enum)
                                  CONCAT71((int7)((ulonglong)uVar10 >> 8),3),
                           (pMVar9->fields)._._Team_k__BackingField,(MethodInfo *)0x0);
      }
      pTVar11 = (this->fields).progress;
      value_00 = (float)value / (float)(this->fields).amountOfStars;
      if (cRam_? == '\0') {
...

{
  ...
  if (((pMVar1 != (MVGameControllerBase *)0x0) &&
    ...
    else if (*(int *)&pOVar3[1].monitor != (this->fields).amountOfStars) {
      (this->fields).amountOfStars = *(int *)&pOVar3[1].monitor;
    }
    ...
    if (pTVar4 != (Text *)0x0) {
      ...
      if (pPVar6 != (ProgressBar *)0x0) {
        fVar7 = (float)newValue / (float)(this->fields).amountOfStars;
        if (fVar7 < 0.0) {
          fVar7 = 0.0;
        }
        else if (_UNK_? < fVar7) {
