  ...
  if ((iVar6 <= (this->fields)._to_5__3) && ((this->fields)._stopped_5__5 == 0)) {
    ...
    *(float *)unaff_ESI = (float)fVar16;
    ...
    if (bVar20 != 0) {
      ...
      euler.z = fVar15 * (pTVar2->fields).intensity * _UNK_? * _UNK_?;
...
code_?:
    cVar27 = '\0';
    uVar28 = func_?();
    *(int *)&unaff_ESI[3].fields = *(int *)&unaff_ESI[3].fields + 1;
    pbVar29 = (byte *)((int)uVar28 + -0x1e +
                     CONCAT22((short)((ulonglong)uVar28 >> 0x30),
                              CONCAT11((char)((ulonglong)uVar28 >> 0x28) + extraout_CL + cVar27,
                                       (char)((ulonglong)uVar28 >> 0x20))));
    bVar30 = *pbVar29;
    *pbVar29 = *pbVar29 + 0x80;
    pfVar31 = &(pTVar2->fields).timer + (int)uVar28;
    *(char *)pfVar31 = *(char *)pfVar31 + (char)((ulonglong)uVar28 >> 8) + (0x7f < bVar30);
    pcVar32 = (code *)swi(3);
    bVar20 = (*pcVar32)();
    return bVar20;
  }
