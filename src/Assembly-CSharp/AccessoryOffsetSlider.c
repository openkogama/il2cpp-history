      ...
      if (this_01 != (MVWorldObjectClientManager *)0x0) {
        ...
        if ((this->fields).isInPreview == 0) {
          if (pMVar13 != (MVBody *)0x0) {
            ...
            fVar18 = BodyAccessoriesController::BodyAccessoriesController_GetOffset
...

{
  ...
  if ((this->fields).isInPreview == 0) {
    if (avatarBody != (MVBody *)0x0) {
      ...
      fVar7 = BodyAccessoriesController::BodyAccessoriesController_GetOffset
...

{
  ...
  if (pSVar1 != (Slider *)0x0) {
    yOffset = (float)(*(pSVar1->klass->vtable).get_value.methodPtr)
    ...
    if (pMVar2 != (MVBody *)0x0) {
      if ((pMVar2->fields).previewBodyAccessoriesController == (BodyAccessoriesController *)0x0) {
        ...
        BodyAccessoriesController::BodyAccessoriesController_ApplyAccessoryOffset
                  (pBVar3,yOffset,slot,(MethodInfo *)0x0);
        pBVar3 = (pMVar2->fields).bodyAccessoriesController;
      }
      else {
...
{
  if (cRam_? == '\0') {
    FUN_?(&MethodInfo__AccessoryOffsetSlider__Initialize_MVBody_);
    LOCK();
    UNLOCK();
