...
void Assembly-CSharp.dll::FadeableObject+<Start>c__AnonStorey0::
     FadeableObject_Start_c_AnonStorey0___m__0
               (FadeableObject_Start_c_AnonStorey0 *this,IFadeParent *x,BaseEventData *y,
               MethodInfo *method)
