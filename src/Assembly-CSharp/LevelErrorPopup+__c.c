...

{
  ...
  pLVar1 = (LevelErrorPopup_c *)FUN_?(TypeInfo__LevelErrorPopup____c);
  TypeInfo__LevelErrorPopup____c->static_fields->__9 = pLVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__LevelErrorPopup____c->static_fields >> 0xc);
