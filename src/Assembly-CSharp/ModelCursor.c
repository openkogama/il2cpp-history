...

{
  ...
  if (movingEdgeCube != (CubePickingInfo *)0x0) {
    ...
    if (pVVar4 != (Vector3__Array *)0x0) {
      uVar5 = pVVar4->max_length;
      if ((uVar5 == 0) || (uVar5 < 2)) goto code_?;
      uVar6 = pVVar4->vector[1].x;
      uVar7 = pVVar4->vector[1].y;
      uVar8 = pVVar4->vector[0].x;
      uVar9 = pVVar4->vector[0].y;
      if (uVar5 < 3) goto code_?;
      uVar10 = pVVar4->vector[2].x;
      uVar11 = pVVar4->vector[2].y;
      if (uVar5 < 4) goto code_?;
      uVar12 = pVVar4->vector[3].x;
      uVar13 = pVVar4->vector[3].y;
      fStack_14 = ((float)uVar12 + (float)uVar10 + (float)uVar6 + (float)uVar8) * _UNK_?;
      fStack_15 = ((float)uVar13 + (float)uVar11 + (float)uVar7 + (float)uVar9) * _UNK_?;
      pCStack_16 = (Cube__Class *)
                   ((pVVar4->vector[3].z +
                    pVVar4->vector[2].z + pVVar4->vector[1].z + pVVar4->vector[0].z) *
                   _UNK_?);
      edge = (movingEdgeCube->fields).pickedEdge;
      if (edge == Edge__Enum_None) {
        ppVVar17 = (Vector3__Class **)pCStack_16;
        if (cRam_? == '\0') {
          func_?();
          ppVVar17 = &TypeInfo__UnityEngine__Vector3;
          cRam_? = '\x01';
        }
        ...
        VVar22.y = fStack_15;
        VVar22.x = fStack_14;
        VVar22.z = (float)pCStack_16;
        end_00.z = fVar21 + (float)ppVVar17;
        end_00.x = (float)uVar19 + fStack_14;
        end_00.y = (float)uVar20 + fStack_15;
        ...
        UnityEngine.CoreModule.dll::UnityEngine::Debug::Debug_2_DrawLine_1
                  (VVar22,end_00,color_00,(MethodInfo *)0x0);
code_?:
           ...
           this_00 != (GameEventManager_AvatarCommandsBuildModeManager_LaserCommandsManager *)0x0))
        {
          to.y = fStack_15;
          to.x = fStack_14;
          to.z._0_2_ = (short)pCStack_16;
          to.z._2_2_ = (short)((uint)pCStack_16 >> 0x10);
          GameEventManager+AvatarCommandsBuildModeManager+LaserCommandsManager::
          GameEventManager_AvatarCommandsBuildModeManager_LaserCommandsManager_UpdatePosition
        ...
        if ((movingEdgeCube->fields).pickedEdgeIndex0 == 0) {
          if (pVVar4 != (Vector3__Array *)0x0) {
            if ((movingEdgeCube->fields).pickedEdgeIndex1 == 0) {
              ...
              fStack_31 = ((float)uVar26 + (float)uVar28) * _UNK_?;
            }
            else {
              if (pVVar4->max_length < 2) goto code_?;
              uVar32 = pVVar4->vector[1].x;
              uVar33 = pVVar4->vector[1].y;
              fStack_29 = pVVar4->vector[1].z;
              fStack_30 = (float)uVar32;
              fStack_31 = (float)uVar33;
            }
code_?:
            pCStack_16 = (Cube__Class *)
                         (fStack_29 + ((float)pCStack_16 - fStack_29) * _UNK_?);
            fStack_14 = fStack_30 + (fStack_14 - fStack_30) * _UNK_?;
            fStack_15 = fStack_31 + (fStack_15 - fStack_31) * _UNK_?;
            goto code_?;
          }
        }
        else if (pVVar4 != (Vector3__Array *)0x0) {
          if (pVVar4->max_length == 0) goto code_?;
          pVVar34 = pVVar4->vector;
          uVar35 = pVVar34->x;
          uVar36 = pVVar34->y;
          fStack_29 = pVVar4->vector[0].z;
          VVar22 = *pVVar34;
          uVar37 = pVVar4->vector[0].x;
          uVar38 = pVVar4->vector[0].y;
          if (cRam_? == '\0') {
          ...
          end.z = fStack_29 + fVar21;
          end.x = (float)uVar37 + (float)uVar39;
          end.y = (float)uVar38 + (float)uVar40;
          color.g = (float)_UNK_?;
          color.r = (float)_UNK_?;
          color.b = (float)_UNK_?;
          color.a = _UNK_?;
          UnityEngine.CoreModule.dll::UnityEngine::Debug::Debug_2_DrawLine_1
                    (VVar22,end,color,(MethodInfo *)0x0);
          fStack_30 = (float)uVar35;
          fStack_31 = (float)uVar36;
          goto code_?;
        }
      }
    }
...

{
  ...
  if (pPVar1 != (PrefabPool *)0x0) {
    ...
    ppCVar2 = &(this->fields).errorCursor;
    *ppCVar2 = this_00;
    func_?(ppCVar2,this_00);
    return;
  }
  func_?();
  pcVar3 = (code *)swi(3);
      ...
      if (*(List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ **)
        ...
        while( true ) {
          ...
          if (((RegexCharClass_SingleRange)LStack_5._current == (RegexCharClass_SingleRange)0x0) ||
             (*(GameObject **)((int)LStack_5._current + 0x1c) == (GameObject *)0x0)) break;
          UnityEngine.CoreModule.dll::UnityEngine::GameObject::GameObject_SetActive
                    (*(GameObject **)((int)LStack_5._current + 0x1c),in_stack_7,
                     (MethodInfo *)0x0);
        }
      }
      func_?();
