...
code_?:
  ...
  if (extraout_ECX == 1 || &stack0x00000000 != (undefined1 *)0x5) {
    pbVar15 = (byte *)(extraout_ECX + -0x20);
    bVar16 = (byte)((uint6)uVar13 >> 8);
    bVar17 = *pbVar15 + bVar16;
    bVar18 = CARRY1(*pbVar15,bVar16) || CARRY1(bVar17,bVar11);
    *pbVar15 = bVar17 + bVar11;
    out(uVar14,(char)uVar13);
    pbVar15 = (byte *)((int)uVar13 + -0x1f);
    bVar11 = *pbVar15;
    bVar17 = *pbVar15;
    *pbVar15 = bVar17 + bVar1 + bVar18;
    out(uVar14,(char)uVar13);
    pcVar19 = (char *)((int)&bp[-0x33ef112].klass + 2);
    *pcVar19 = *pcVar19 + bVar1 + (CARRY1(bVar11,bVar1) || CARRY1(bVar17 + bVar1,bVar18));
    pcVar20 = (code *)swi(3);
    pDVar2 = (Dictionary_2_System_Object_System_Object_ *)(*pcVar20)();
    return pDVar2;
  }
  (*(code *)((int)&bp[5].fields._position + 2))(CONCAT22(uVar12,in_CS));
code_?:
