  ...
  if ((value != (MVNetworkGame *)0x0) &&
    ...
    case RewardedAdResult__Enum_RewardNotUnlocked:
      ...
      if (value != (MVNetworkGame *)0x0) {
        ...
        pEVar5 = (value->fields).ReceivedItemFromQuery;
        ...
        if (pIVar6 != (IAdManager *)0x0) {
          ...
          if (pEVar5 != (EventHandler_1_ReceivedItemFromQueryEventArgs_ *)0x0) {
            NotificationPopup::NotificationPopup_Initialize
                      ((NotificationPopup *)pEVar5,(String *)0x0,header,(MethodInfo *)0x0);
            pGVar4 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_gameObject
                               ((Component *)this,(MethodInfo *)0x0);
            callbackFunction =
...
code_?:
  ...
  *(undefined1 *)((int)&this->klass + 1) = *(undefined1 *)((int)&value->klass + 1);
  pcVar9 = (code *)swi(3);
  (*pcVar9)();
  return;
}
