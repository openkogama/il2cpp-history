...
/* SpawnRoleDataMediator+SpawnRoleVariableInternal`1[System.Int32](Int32) */

void Assembly-CSharp.dll::Assets::Scripts::Network::Player::SpawnRoles::SpawnRoleData::Mediator::
     SpawnRoleDataMediator+SpawnRoleVariableInternal`1[System::Int32]::
     SpawnRoleDataMediator_SpawnRoleVariableInternal_1_System_Int32___ctor
               (SpawnRoleDataMediator_SpawnRoleVariableInternal_1_System_Int32_ *this,int32_t value,
               MethodInfo *method)

{
  ...
  pSVar3 = (SubscribableVariable_1_System_Int32_ *)FUN_?(pvVar2);
  bVar4 = iRam_? != 0;
  ...
  do {
    ...
    if (pDVar11 == (Delegate *)0x0) {
      ...
      pAVar12 = (Action_1_Int32_ *)FUN_?(pDVar11,pvVar2);
