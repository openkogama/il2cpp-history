...

{
  ...
  if (pTVar2 != (Text *)0x0) {
    ...
    this_00 = &(pSVar1->fields).spawnRoleCost;
    if (cRam_? == '\0') {
      func_?(&::StringLiteral__);
      cRam_? = '\x01';
    }
    this_01 = (ProgressBarAndroid *)(pSVar1->fields).progressBar;
    *this_00 = iVar4;
    newTier = 100;
    if ((pSVar1->fields).currentTier == 0) {
      if (this_01 != (ProgressBarAndroid *)0x0) {
        ProgressBarAndroid::ProgressBarAndroid_set_Progress
                  (this_01,(float)iVar4 / _UNK_?,(MethodInfo *)0x0);
        ...
        if (pTVar2 != (Text *)0x0) {
          pTVar6 = pTVar2->klass;
          in_stack_7 = (pTVar6->vtable).CalculateLayoutInputHorizontal_1.methodPtr;
          in_stack_8 = pTVar2;
          goto code_?;
        }
      }
