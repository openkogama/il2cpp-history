...

{
  ...
  pPVar1 = (PlayerListButton_c *)FUN_?(TypeInfo__PlayerListButton____c);
  TypeInfo__PlayerListButton____c->static_fields->__9 = pPVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__PlayerListButton____c->static_fields >> 0xc);
