...

{
  ...
  UnityEngine.CoreModule.dll::UnityEngine::Vector3::Vector3__ctor
            ((Vector3 *)&stack0xffffffd8,(this->fields)._origin.x,(this->fields)._origin.y,0.0,
             (MethodInfo *)0x0);
  angle = (this->fields)._degreeAngleFromStart;
  if (cRam_? == '\0') {
    func_?();
    cRam_? = '\x01';
  }
  pQVar4 = UnityEngine.CoreModule.dll::UnityEngine::Quaternion::Quaternion_AngleAxis
                     ((Quaternion *)&stack0xffffffd4,angle,
  ...
  uVar6 = pVVar5->x;
  uVar7 = pVVar5->y;
  (this->fields)._endPoint.x = (float)uVar6 + fVar2;
  (this->fields)._endPoint.y = (float)uVar7 + fVar3;
  return;
}
  ...
  if (((this->fields)._forceShortestArc == 0) &&
    ...
    bVar1 = ArcMath::ArcMath_LgArcContains2DPoint
                      (point,(this->fields)._origin,(this->fields)._startPoint,
                       (this->fields)._degreeAngleFromStart,(this->fields)._epsilon,
                       (MethodInfo *)0x0);
    return bVar1;
  }
...

{
  ...
  pLVar6 = PrimitiveFactory::PrimitiveFactory_Generate2DArcBorderPoints
                     (*pVVar1,*pVVar3,(this->fields)._degreeAngleFromStart,
                      ...
                      (MethodInfo *)0x0);
  (this->fields)._borderPoints = pLVar6;
  func_?(&(this->fields)._borderPoints,pLVar6);
  pRVar7 = RectEx::RectEx_FromPoints
                     (&RStack_2,(IEnumerable_1_UnityEngine_Vector2_ *)(this->fields)._borderPoints,
                      (MethodInfo *)0x0);
  fVar8 = pRVar7->m_XMin;
  fVar9 = pRVar7->m_YMin;
  fVar10 = pRVar7->m_Width;
  fVar11 = pRVar7->m_Height;
  (this->fields)._areBorderPointsDirty = 0;
  (this->fields)._rect.m_XMin = fVar8;
  (this->fields)._rect.m_YMin = fVar9;
  (this->fields)._rect.m_Width = fVar10;
  (this->fields)._rect.m_Height = fVar11;
  return;
}
...

{
  ...
  startPoint.x = (this->fields)._startPoint.x - (this->fields)._origin.x;
  (this->fields)._startPoint.y = startPoint.y;
  startPoint.y = (this->fields)._startPoint.y - (this->fields)._origin.y;
  startPoint = (Vector2)func_?(&startPoint,0);
  fVar3 = (this->fields)._radius;
  (this->fields)._startPoint.x = startPoint.x * (this->fields)._radius + fVar1;
  (this->fields)._startPoint.y = startPoint.y * fVar3 + fVar2;
...
{
  uStack_1._0_4_ = (this->fields)._startPoint.x - (this->fields)._origin.x;
  uStack_1._4_4_ = (this->fields)._startPoint.y - (this->fields)._origin.y;
  uStack_1 = func_?(&uStack_1,0);
  fVar2 = (this->fields)._radius;
  fVar3 = (this->fields)._radius;
  (this->fields)._origin.x = value.x;
  (this->fields)._origin.y = value.y;
  fVar4 = (this->fields)._origin.y;
  (this->fields)._startPoint.x = (float)uStack_1 * fVar2 + (this->fields)._origin.x;
  (this->fields)._startPoint.y = (float)((ulonglong)uStack_1 >> 0x20) * fVar3 + fVar4;
  ArcShape2D_CalculateEndPoint(this,(MethodInfo *)0x0);
  (this->fields)._areBorderPointsDirty = 1;
  return;
}
...

{
  ...
  (this->fields)._startPoint.x = (float)uStack_1 * (this->fields)._radius + fVar2;
  (this->fields)._startPoint.y = (float)((ulonglong)uStack_1 >> 0x20) * fVar4 + fVar3;
  ArcShape2D_CalculateEndPoint(this,(MethodInfo *)0x0);
  (this->fields)._areBorderPointsDirty = 1;
  return;
}
