...

{
  ...
  pWVar1 = (WinningConditionDebriefing_c *)FUN_?(TypeInfo__WinningConditionDebriefing____c);
  TypeInfo__WinningConditionDebriefing____c->static_fields->__9 = pWVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__WinningConditionDebriefing____c->static_fields >> 0xc);
