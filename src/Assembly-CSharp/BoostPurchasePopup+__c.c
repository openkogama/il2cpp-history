...

{
  ...
  pBVar1 = (BoostPurchasePopup_c *)FUN_?(TypeInfo__BoostPurchasePopup____c);
  TypeInfo__BoostPurchasePopup____c->static_fields->__9 = pBVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__BoostPurchasePopup____c->static_fields >> 0xc);
