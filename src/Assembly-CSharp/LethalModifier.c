...
{
  if (cRam_? == '\0') {
    func_?(&TypeInfo__LethalModifier___DoFadeAndDestroy_d__7);
    cRam_? = '\x01';
  }
  value = (Object *)func_?(TypeInfo__LethalModifier___DoFadeAndDestroy_d__7);
  if (value != (Object *)0x0) {
...

{
  ...
  if (((target != (Avatar *)0x0) && (pMVar1 = (target->fields).mvAvatar, pMVar1 != (MVAvatar *)0x0))
    ...
    this_02 = MVBody::MVBody_get_BodyData(pMVar2,(MethodInfo *)0x0);
    if (this_02 != (BodyData *)0x0) {
      parent = BodyData::BodyData_GetPartBone
                         (this_02,BodyData_PartIndex__Enum_Head,(MethodInfo *)0x0);
...

{
  if (((target != (Avatar *)0x0) && (pMVar1 = (target->fields).mvAvatar, pMVar1 != (MVAvatar *)0x0))
    ...
    MVBody::MVBody_StopBlinking(this_00,BlinkType__Enum_Lethal,(MethodInfo *)0x0);
