...
code_?:
  ...
  case 2:
    ...
    if ((pAVar8 == (AnimationCurve *)0x0) ||
       ...
       unaff_EDI == (XPBoostNotification *)0x0)) goto code_?;
    UnityEngine.UIModule.dll::UnityEngine::CanvasGroup::CanvasGroup_set_alpha
              ((CanvasGroup *)unaff_EDI,fVar1,(MethodInfo *)0x0);
