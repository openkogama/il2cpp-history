...

{
  ...
  *ppCVar2 = pCVar1;
  ...
  pVVar18 = UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_get_forward
                      ((Vector3 *)pWVar17,pTVar14,(MethodInfo *)0x0);
  uVar19 = pVVar18->x;
  uVar20 = pVVar18->y;
  fVar10 = pVVar18->z;
  ...
  pVVar18 = UnityEngine.UIElementsModule.dll::UnityEngine::UIElements::DefaultEventSystem+Input::
  ...
  pVVar18 = ESInsert_ComputeSnapPosition
  ...
  if ((pMVar8 == (MVWorldObjectClient *)0x0) ||
     (pGVar31 = (pMVar8->fields).gameObject, pGVar31 == (GameObject *)0x0)) goto code_?;
...
code_?:
    ...
    if (((pMVar8->klass->_1).naturalAligment < bVar33) ||
       ((MVGroup__Class *)(pMVar8->klass->_1).typeHierarchy[bVar33 - 1] != TypeInfo__MVGroup))
    goto code_?;
    pMVar34 = (MVGroup *)
  ...
  pMVar8 = EditorStateMachine::EditorStateMachine_get_SingleSelectedWO(e,(MethodInfo *)0x0);
  if ((pMVar8 != (MVWorldObjectClient *)0x0) &&
     (pGVar31 = (pMVar8->fields).gameObject, pGVar31 != (GameObject *)0x0)) {
    iVar36 = UnityEngine.CoreModule.dll::UnityEngine::GameObject::GameObject_get_layer
...
code_?:
    ...
    pVVar11 = UnityEngine.UIElementsModule.dll::UnityEngine::UIElements::DefaultEventSystem+Input::
              DefaultEventSystem_Input_get_mousePosition
                        ((Vector3 *)&QStack_7,(DefaultEventSystem_Input *)0x0,method_00);
    ...
    fVar17 = (pRVar28->m_Origin).x;
    fVar18 = (pRVar28->m_Origin).y;
    pMVar1 = (MVWorldObjectClient *)(pRVar28->m_Origin).z;
    pMVar29 = EditorStateMachine::EditorStateMachine_get_SingleSelectedWO(e,(MethodInfo *)0x0);
    ...
    pVVar11 = ESInsert_ComputeSnapPosition
                        ((Vector3 *)&QStack_7,this,pMVar29,originalPos,(MethodInfo *)0x0);
    uVar30 = pVVar11->x;
    uVar31 = pVVar11->y;
    ...
    VStack_32.z = pVVar11->z - (float)pMVar1;
    VStack_32.x = (float)uVar30 - fVar17;
    VStack_32.y = (float)uVar31 - fVar18;
    pMStack_14 = pMVar1;
    pMStack_16 = (MVWorldObjectClient *)VStack_32.z;
    puVar33 = (undefined8 *)func_?();
    uStack_15 = *puVar33;
    pMStack_16 = *(MVWorldObjectClient **)(puVar33 + 1);
    fVar34 = (float10)func_?(&QStack_7.y,0);
    pMStack_6 = (MVWorldObjectClient *)(float)fVar34;
    fVar34 = (float10)func_?(&VStack_32,0);
    pMStack_4 = (MVWorldObjectClient *)(float)fVar34;
    fVar17 = UnityEngine.CoreModule.dll::UnityEngine::Time::Time_1_get_deltaTime((MethodInfo *)0x0);
    ...
    bVar5 = DrawPlane::DrawPlane_Pick(&VStack_32,(MethodInfo *)0x0);
    ...
    pSVar35 = MVGameControllerBase::MVGameControllerBase_get_SpawnRoleDataMediatorLocal
                        ((MethodInfo *)0x0);
    if ((pSVar35 == (SpawnRoleDataMediator *)0x0) ||
       (this_01 = (SpawnRoleVariable_1_UnityEngine_Vector3_ *)(pSVar35->fields).position,
    ...
    if (uStack_15._4_4_ <= (float)pMStack_27) {
      puVar33 = (undefined8 *)func_?(&QStack_7);
      uStack_13 = *puVar33;
      pMStack_14 = *(MVWorldObjectClient **)(puVar33 + 1);
    }
    else {
      puVar33 = (undefined8 *)func_?(&QStack_7);
      uStack_13._0_4_ = (float)*puVar33;
      uStack_13._4_4_ = (float)((ulonglong)*puVar33 >> 0x20);
      pMStack_14 = (MVWorldObjectClient *)
                   (*(uint *)(puVar33 + 1) ^
                   __0B8F1B2A03256530B29F55A9640DB5F499BCAA95602DE832E800B6D1563C9B86_Field);
      uStack_13 = CONCAT44((uint)uStack_13._4_4_ ^
                           __0B8F1B2A03256530B29F55A9640DB5F499BCAA95602DE832E800B6D1563C9B86_Field,
    ...
    uVar36 = pVVar11->x;
    uVar37 = pVVar11->y;
    fVar18 = VStack_32.x - (float)uVar36;
    fVar17 = VStack_32.y - (float)uVar37;
    QStack_7.w = VStack_32.z - pVVar11->z;
    RStack_12.m_Origin.x = VStack_32.x;
    RStack_12.m_Origin.y = VStack_32.y;
    RStack_12.m_Origin.z = 0.0;
    RStack_12.m_Direction.x = 0.0;
    pMStack_4 = (MVWorldObjectClient *)VStack_32.z;
...
code_?:
  ...
  if (((pGVar38 != (GameEventManager *)0x0) &&
    ...
    if (pMVar29 != (MVWorldObjectClient *)0x0) {
      pIStack_40 = (pMVar29->klass->vtable).set_WorldPosition.methodPtr;
      RStack_12.m_Direction.y = (float)&RStack_12.m_Origin.z;
      RStack_12.m_Direction.x = (float)&UNK_?;
      RStack_12.m_Direction.z = (float)pMVar29;
      puVar33 = (undefined8 *)(*(code *)(pMVar29->klass->vtable).get_WorldPosition_1.method)();
      uStack_13 = *puVar33;
      pMStack_14 = *(MVWorldObjectClient **)(puVar33 + 1);
      fVar17 = UnityEngine.CoreModule.dll::UnityEngine::Time::Time_1_get_deltaTime
                         ((MethodInfo *)0x0);
      pMStack_6 = (MVWorldObjectClient *)(fVar17 * _UNK_?);
      if ((float)pMStack_6 < 0.0) {
        pMVar29 = (MVWorldObjectClient *)0x0;
      }
      else {
        pMVar29 = pMStack_6;
        if ((float)_UNK_? < (float)pMStack_6) {
      ...
      VStack_32.x = ((float)uStack_15 - (float)uStack_13) * (float)pMVar29 + (float)uStack_13;
      VStack_32.y = (uStack_15._4_4_ - uStack_13._4_4_) * (float)pMVar29 + uStack_13._4_4_;
      VStack_32.z = ((float)pMStack_16 - (float)pMStack_14) * (float)pMVar29 + (float)pMStack_14;
      if (pMVar1 != (MVWorldObjectClient *)0x0) {
        (*(code *)(pMVar1->klass->vtable).set_SyncPos.method)
                  (pMVar1,VStack_32.x,VStack_32.y,VStack_32.z,
        ...
        if (pMVar1 != (MVWorldObjectClient *)0x0) {
          ...
          pCStack_41 = pCStack_3->klass;
          if (pCStack_41 != (Camera__Class *)0x0) {
            pMStack_27 = (MVWorldObjectClient *)&(pCStack_41->_0).byval_arg;
            for (; (int)pMStack_4 < (int)(pCStack_41->_0).namespaze;
                pMStack_4 = (MVWorldObjectClient *)((int)&pMStack_4->klass + 1)) {
              if ((MVWorldObjectClient *)(pCStack_41->_0).namespaze <= pMStack_4)
              goto code_?;
              ...
              while( true ) {
                ...
                iVar42 = UnityEngine.CoreModule.dll::UnityEngine::Mesh::Mesh_get_subMeshCount
                                   (this_04,(MethodInfo *)0x0);
                if (iVar42 <= submeshIndex) break;
                pMStack_43 = UnityEngine.CoreModule.dll::UnityEngine::MeshFilter::
                             MeshFilter_get_sharedMesh((MeshFilter *)this_03,(MethodInfo *)0x0);
                ...
                pMVar44 = UnityEngine.CoreModule.dll::UnityEngine::Transform::
                          Transform_get_localToWorldMatrix
                                    ((Matrix4x4 *)&stack0xffffff10,pTVar24,(MethodInfo *)0x0);
                RStack_12.m_Origin.z = pMVar44->m00;
                RStack_12.m_Direction.x = pMVar44->m10;
                RStack_12.m_Direction.y = pMVar44->m20;
                RStack_12.m_Direction.z = pMVar44->m30;
                QStack_7.x = pMVar44->m01;
                QStack_7.y = pMVar44->m11;
                QStack_7.z = pMVar44->m21;
                QStack_7.w = pMVar44->m31;
                fStack_45 = pMVar44->m02;
                uStack_15._0_4_ = pMVar44->m12;
                uStack_15._4_4_ = pMVar44->m22;
                pMStack_16 = (MVWorldObjectClient *)pMVar44->m32;
                fStack_46 = pMVar44->m03;
                uStack_13._0_4_ = pMVar44->m13;
                uStack_13._4_4_ = pMVar44->m23;
                pMStack_14 = (MVWorldObjectClient *)pMVar44->m33;
                material = (this->fields).previewMaterial;
                pMStack_6 = (MVWorldObjectClient *)
            ...
            if ((this->fields).pointerWasUp == 0) {
              ...
              if (bVar5 != 0) {
                if ((this->fields).isNewPrototype == 0) {
                  pCStack_41 = (Camera__Class *)0x2f;
                  pOVar47 = (Object *)func_?(TypeInfo__EditorEvent,&pCStack_41);
                  FSMEntity::FSMEntity_set_Event((FSMEntity *)e,pOVar47,(MethodInfo *)0x0);
                ...
                if (this_05 != (MainCameraManager *)0x0) {
                  ...
                  pMVar1 = EditorStateMachine::EditorStateMachine_get_SingleSelectedWO
                                      (e,(MethodInfo *)0x0);
                  if (pCStack_41 != (Camera__Class *)0x0) {
                    func_?(0xd,pCStack_41,pMVar1,0x40000000,0,0,0,0,0,0);
                    pMStack_43 = (Mesh *)0x0;
                    pOVar47 = (Object *)func_?(TypeInfo__EditorEvent,&pMStack_43);
                    FSMEntity::FSMEntity_set_Event((FSMEntity *)e,pOVar47,(MethodInfo *)0x0);
                    goto code_?;
                  }
                }
