...

{
  ...
  if ((this->fields).repeatRotationFromAngle != 0) {
    ...
    pQVar4 = UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_get_rotation
                       ((Quaternion *)&stack0xffffffd0,pTVar3,(MethodInfo *)0x0);
    pVVar5 = UnityEngine.CoreModule.dll::UnityEngine::Quaternion::Quaternion_Internal_ToEulerRad
                       ((Vector3 *)&puStack_6,*pQVar4,(MethodInfo *)0x0);
    uVar7 = pVVar5->x;
    uVar8 = pVVar5->y;
    euler.y = (float)uVar8 * _UNK_?;
    euler.x = (float)uVar7 * _UNK_?;
  ...
  if ((double)(float)((uint)(fVar9 - fVar1) & _UNK_?) <= _UNK_?) {
    return;
  }
  (this->fields).lastRotationUpdate = fVar9;
  pTVar3 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_transform
                     ((Component *)this,(MethodInfo *)0x0);
  if (cRam_? == '\0') {
    func_?();
  ...
  if (pTVar3 != (Transform *)0x0) {
    UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_Rotate_4
              (pTVar3,TypeInfo__UnityEngine__Vector3->static_fields->forwardVector,fVar9,
