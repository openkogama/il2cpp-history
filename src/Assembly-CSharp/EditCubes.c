                                    ...
                                    *piVar97 = *piVar97 + 1;
                                    ...
                                    if (!(bool)cVar21) {
                                      if (uVar76 < pMVar98->max_length) {
                                        ...
                                        bVar75 = uVar76 < pMVar98->max_length;
                                        cVar21 = uVar76 == pMVar98->max_length;
                                        if (!(bool)bVar75) goto code_?;
...
code_?:
  ...
  if (extraout_ECX == 1 || cVar21 != '\0') {
    ...
    bVar115 = extraout_DH + bVar114;
    bVar38 = CARRY1(extraout_DH,bVar114) || CARRY1(bVar115,bVar75);
    bVar114 = (byte)uVar113 + 0xbb;
    pcVar116 = (char *)CONCAT31((int3)((uint)uVar113 >> 8),bVar114 - bVar38);
    *pcVar116 = *pcVar116 + bVar115 + bVar75 + ((byte)uVar113 < 0x45 || bVar114 < bVar38);
  }
  pcVar117 = (code *)swi(3);
  (*pcVar117)();
  return;
