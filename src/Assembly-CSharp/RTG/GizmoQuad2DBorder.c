...
{
  if (cRam_? == '\0') {
    FUN_?(&TypeInfo__RTG__IGizmoQuad2DBorderController);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
  ...
  if (pGVar1 != (GizmoPlaneSlider2D *)0x0) {
    ...
    if ((lVar2 != 0) &&
       (pIVar3 = (this->fields)._controllers, pIVar3 != (IGizmoQuad2DBorderController__Array *)0x0))
    {
      uVar4 = *(uint *)(lVar2 + 0x78);
...
code_?:
      ...
      if (pIVar3->vector[(int)uVar4] != (IGizmoQuad2DBorderController *)0x0) {
        FUN_?(0,TypeInfo__RTG__IGizmoQuad2DBorderController);
        pGVar1 = (this->fields)._planeSlider;
        if (pGVar1 != (GizmoPlaneSlider2D *)0x0) {
          uVar4 = 0x110;
          if ((pGVar1->fields)._sharedLookAndFeel == (GizmoPlaneSlider2DLookAndFeel *)0x0) {
          ...
          if ((lVar2 != 0) &&
             ...
             pIVar3 != (IGizmoQuad2DBorderController__Array *)0x0)) {
            uVar4 = *(uint *)(lVar2 + 0x78);
            if ((uint)pIVar3->max_length <= uVar4) goto code_?;
            pIVar6 = pIVar3->vector[(int)uVar4];
            if (pIVar6 != (IGizmoQuad2DBorderController *)0x0) {
              uVar7 = 0;
              pIVar8 = pIVar6->klass;
...

{
  ...
  uVar3 = (this->fields)._borderQuadIndex;
  if (cRam_? == '\0') {
    FUN_?();
    LOCK();
    UNLOCK();
  ...
  if (pLVar4 != (List_1_RTG_GizmoHandleShape2D_ *)0x0) {
    ...
    if (pGVar5 != (GizmoHandleShape2D__Array *)0x0) {
      ...
      if (pGVar5->vector[(int)uVar3] != (GizmoHandleShape2D *)0x0) {
...

{
  if (cRam_? == '\0') {
    ...
    LOCK();
    UNLOCK();
    FUN_?(&TypeInfo__RTG__GizmoQuad2DBorderControllerData);
    LOCK();
    UNLOCK();
    FUN_?(&TypeRef__RTG__GizmoQuad2DBorderType);
    LOCK();
    UNLOCK();
    FUN_?(&MethodInfo__RTG__GizmoQuad2DBorder__OnGizmoPreUpdateBegin_RTG__Gizmo_);
    LOCK();
    UNLOCK();
    FUN_?(&TypeInfo__RTG__GizmoThinQuad2DBorderController);
    LOCK();
    UNLOCK();
    FUN_?(&TypeInfo__RTG__IGizmoQuad2DBorderController);
    LOCK();
  ...
  pGVar7 = (GizmoQuad2DBorderControllerData *)
            FUN_?(TypeInfo__RTG__GizmoQuad2DBorderControllerData);
  bVar2 = iRam_? != 0;
  ...
  pIVar8 = TypeRef__RTG__GizmoQuad2DBorderType;
  if (*(int *)(lRam_? + 0xe4) == 0) {
    FUN_?();
  }
  plVar9 = (longlong *)0x0;
  ...
  if (this_00 != (Array *)0x0) {
    ...
    pIVar13 = (IGizmoQuad2DBorderController__Array *)
              FUN_?(TypeInfo__RTG__IGizmoQuad2DBorderController,iVar12);
      ...
      if (pQVar1 != (QuadShape2D *)0x0) {
        ...
        if (pGVar7 != (GizmoQuad2DBorderControllerData *)0x0) {
          ...
          if (pGVar7 != (GizmoQuad2DBorderControllerData *)0x0) {
            ...
            pGVar7 = (this->fields)._controllerData;
            if (pGVar7 != (GizmoQuad2DBorderControllerData *)0x0) {
              (pGVar7->fields).BorderQuad = (this->fields)._borderQuad;
              iVar14 = 0;
              if (iVar15 != 0) {
                uVar3 = (uint)((ulonglong)&(pGVar7->fields).BorderQuad >> 0xc);
                lVar4 = (ulonglong)((uVar3 & 0x1fffff) >> 6) * 8;
                do {
                  uVar5 = *(ulonglong *)(lVar4 + 0xADDR);
                  puVar6 = (ulonglong *)(lVar4 + 0xADDR);
              ...
              pGVar7 = (this->fields)._controllerData;
              if (((pGVar7 != (GizmoQuad2DBorderControllerData *)0x0) &&
                  ((pGVar7->fields).BorderQuadIndex = (this->fields)._borderQuadIndex,
                  targetHandle != (GizmoHandle *)0x0)) &&
                 (pGVar7 = (this->fields)._controllerData,
                 pGVar7 != (GizmoQuad2DBorderControllerData *)0x0)) {
                ...
                if (pGVar7 != (GizmoQuad2DBorderControllerData *)0x0) {
                  ...
                  pGVar7 = (this->fields)._controllerData;
                  if (pGVar7 != (GizmoQuad2DBorderControllerData *)0x0) {
                    (pGVar7->fields).TargetQuad = (this->fields)._targetQuad;
                    if (iVar14 != 0) {
                      uVar3 = (uint)((ulonglong)&(pGVar7->fields).TargetQuad >> 0xc);
                      lVar4 = (ulonglong)((uVar3 & 0x1fffff) >> 6) * 8;
                      do {
                        uVar5 = *(ulonglong *)(lVar4 + 0xADDR);
                        puVar6 = (ulonglong *)(lVar4 + 0xADDR);
                    ...
                    pIVar17 = (IGizmoQuad2DBorderController__Class *)(this->fields)._controllerData;
                    pIVar18 = (IGizmoQuad2DBorderController *)
                              FUN_?(TypeInfo__RTG__GizmoThinQuad2DBorderController);
                    bVar2 = iRam_? != 0;
                    ...
                    if (pIVar13 != (IGizmoQuad2DBorderController__Array *)0x0) {
