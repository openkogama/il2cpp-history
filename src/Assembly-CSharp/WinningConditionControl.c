...

{
  ...
  *pbVar9 = *pbVar9 + bVar12;
  ...
  bVar14 = in(0x28);
  bVar15 = (byte)((uint)pSVar7 >> 8);
  bVar16 = CARRY1(bVar14,bVar15) || CARRY1(bVar14 + bVar15,CARRY1(bVar11,bVar12));
  bVar11 = bVar14 + bVar15 + CARRY1(bVar11,bVar12);
  piVar17 = (int *)CONCAT31(uVar13,bVar11);
  if (extraout_ECX != 0) {
    bVar18 = CARRY1(bVar11,bVar15) || CARRY1(bVar11 + bVar15,bVar16);
    bVar11 = bVar11 + bVar15 + bVar16;
    if (extraout_ECX == 0) {
      bVar16 = bVar11 < 0x53;
    }
    else {
      bVar16 = CARRY1(bVar11,bVar15) || CARRY1(bVar11 + bVar15,bVar18);
      bVar11 = bVar11 + bVar15 + bVar18;
      if (extraout_ECX != 0) {
        bVar18 = CARRY1(bVar11,bVar15) || CARRY1(bVar11 + bVar15,bVar16);
        bVar11 = bVar11 + bVar15 + bVar16;
        if (extraout_ECX == 0) {
          return (String *)CONCAT31(uVar13,bVar11);
        }
        bVar19 = CARRY1(bVar11,bVar15) || CARRY1(bVar11 + bVar15,bVar18);
        cVar20 = bVar11 + bVar15 + bVar18;
        piVar17 = (int *)CONCAT31(uVar13,cVar20);
        if (extraout_ECX != 0) {
          *pbVar9 = *pbVar9 + bVar12 + bVar19;
          in(0x28);
          pcVar10 = (code *)swi(3);
          pSVar1 = (String *)(*pcVar10)();
          return pSVar1;
        }
        if (-1 < cVar20) goto code_?;
        *piVar17 = *piVar17 + (int)piVar17;
        pWVar21 = (WinningConditionManager *)((uint)piVar17 ^ 0xADDR);
        puVar22 = (undefined1 *)0x0;
        goto code_?;
      }
    }
    bVar19 = CARRY4(CONCAT31(uVar13,bVar11),(uint)&stack0xfffffffc) ||
             CARRY4((uint)(&stack0xfffffffc + CONCAT31(uVar13,bVar11)),(uint)bVar16);
    piVar17 = (int *)CONCAT31((int3)((uint)(&stack0xfffffffc + CONCAT31(uVar13,bVar11) + bVar16) >> 8
                                    ),(char)pSVar7);
    LOCK();
    piVar17[0x1e] = piVar17[0x1e] + 1;
    UNLOCK();
code_?:
                    /* WARNING: Could not recover jumptable at 0xADDR. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    pSVar1 = (String *)
             (**(code **)((int)piVar17 + (int)register0x00000010 + (uint)bVar19 + -0x54))();
    return pSVar1;
  }
  *(undefined1 *)&pSVar1->klass = uRam_?;
  *piVar17 = (int)piVar17 + (uint)bVar16 + *piVar17;
  if (*piVar17 == 0) {
    func_?();
    func_?();
    func_?();
  ...
  puVar22 = (undefined1 *)score;
  *(undefined1 *)score = 0;
  pMVar23 = MVGameControllerBase::MVGameControllerBase_get_Game((MethodInfo *)0x0);
  if ((pMVar23 == (MVNetworkGame *)0x0) ||
     (pWVar21 = (pMVar23->fields)._WinningConditionManager_k__BackingField,
     pWVar21 == (WinningConditionManager *)0x0)) goto code_?;
  in_stack_24 =
       FlagReachedClient_MethodInfo__WinningConditionManager__GetSingletonWinnerConditionByType<FlagReachedClient>__
  ;
code_?:
  pOVar25 = MVWorldObject.dll::WinningConditionManager::
            WinningConditionManager_GetSingletonWinnerConditionByType(pWVar21,in_stack_24);
  if (pOVar25 != (Object *)0x0) {
    *puVar22 = 2;
    return (String *)CONCAT31((int3)((uint)pOVar25 >> 8),1);
  }
  pMVar23 = MVGameControllerBase::MVGameControllerBase_get_Game((MethodInfo *)0x0);
  if ((pMVar23 != (MVNetworkGame *)0x0) &&
     (pWVar21 = (pMVar23->fields)._WinningConditionManager_k__BackingField,
     pWVar21 != (WinningConditionManager *)0x0)) {
    pOVar25 = MVWorldObject.dll::WinningConditionManager::
              WinningConditionManager_GetSingletonWinnerConditionByType
                        (pWVar21,
