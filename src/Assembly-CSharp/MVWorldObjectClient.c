...
code_?:
  ...
  if ((this_00 == (MVWorldObjectClientManager *)0x0) ||
    ...
    func_?();
    *(byte *)&this->klass =
         *(char *)&this->klass + unaff_DI + extraout_DL + bVar3 +
         (CARRY1(extraout_CH,extraout_DL) ||
         CARRY1(extraout_CH + extraout_DL,
                CARRY1(unaff_DI,extraout_DL) || CARRY1(unaff_DI + extraout_DL,bVar3)));
    pcVar4 = (code *)swi(3);
...
{
  if ((((InteractionFlags__Enum)(this->fields).eliteRequiredFlags & flag) == flag) &&
...
code_?:
    if (state == 0) {
      if (iVar1 == 0) goto code_?;
      pMVar6 = *(Material **)(iVar1 + 0x248);
    }
    else {
      if (iVar1 == 0) goto code_?;
      pMVar6 = *(Material **)(iVar1 + 0x24c);
    }
  }
  else {
    if (iVar1 == 1) {
  ...
  if (package != (Dictionary_2_System_Object_System_Object_ *)0x0) {
    ...
    while( true ) {
      ...
      if (*pcVar15 == '\0') {
        ...
        func_?(0x3e,this,auStack_7._4_4_,iStack_18,uStack_19,pOStack_20,iStack_17,p);
      }
      else {
        if ((TypeInfo__UnityEngine__Debug->_1).cctor_finished_or_no_cctor == 0) {
          func_?(TypeInfo__UnityEngine__Debug);
