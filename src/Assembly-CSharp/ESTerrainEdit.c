...
code_?:
    ...
    if ((pMVar1->fields).isLogicRendered != 0) {
      ...
      if (bVar3 != 0) {
        _selectionAllowedByLogicEnabled = _UNK_?;
        if (didHitObject != 0) {
          _selectionAllowedByLogicEnabled = hitDistance;
        }
        pMVar1 = MVGameControllerBase::MVGameControllerBase_get_MainCameraManager((MethodInfo *)0x0)
        ;
        if (pMVar1 != (MainCameraManager *)0x0) {
          ...
          if (this_00 != (Camera *)0x0) {
            ...
            iVar11 = LayerUtil::LayerUtil_GetLayerNumber(LayerFlags__Enum_Logic,(MethodInfo *)0x0);
            ...
            UnityEngine.PhysicsModule.dll::UnityEngine::Physics::Physics_Raycast_13
                      (ray,(RaycastHit *)&stack0xffffffa8,INFINITY,1 << ((byte)iVar11 & 0x1f),
                       (MethodInfo *)0x0);
            pCVar12 = UnityEngine.PhysicsModule.dll::UnityEngine::RaycastHit::
                      RaycastHit_get_collider((RaycastHit *)&stack0xffffffa8,(MethodInfo *)0x0);
            ...
            fVar13 = RTG::SphereTreeNode`1[System::Object]::
                     SphereTreeNode_1_System_Object__get_Radius
                               ((SphereTreeNode_1_System_Object_ *)&stack0xffffffa8,
                                (MethodInfo *)0x0);
            RStack_5.m_Direction.z = fVar13;
            if (_selectionAllowedByLogicEnabled <= fVar13) {
              return 0;
            }
            pCVar12 = UnityEngine.PhysicsModule.dll::UnityEngine::RaycastHit::
                      RaycastHit_get_collider((RaycastHit *)&stack0xffffffa8,(MethodInfo *)0x0);
