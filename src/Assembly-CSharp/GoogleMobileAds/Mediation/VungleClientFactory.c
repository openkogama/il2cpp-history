...
/* IVungleClient CreateVungleClient() */

IVungleClient *
Assembly-CSharp.dll::GoogleMobileAds::Mediation::VungleClientFactory::
VungleClientFactory_CreateVungleClient(MethodInfo *method)

{
  ...
  if (value != (Object *)0x0) {
    ...
    if (piVar2 != (int *)0x0) {
      ...
      return (IVungleClient *)value;
    }
  }
  func_?();
  pcVar4 = (code *)swi(3);
  pIVar5 = (IVungleClient *)(*pcVar4)();
  return pIVar5;
}
