...

{
  ...
  while( true ) {
    ...
    default:
      ...
      func_?();
      cVar4 = (undefined1 *)0xffffffc7 < &stack0xffffffdc;
      func_?();
      goto code_?;
    }
    cVar4 = '\0';
    if (pBVar1 == (Byte__Array *)0x0) break;
    cVar4 = (uint)IStack_2.m_value < pBVar1->max_length;
    if (!(bool)cVar4) {
code_?:
      func_?();
      break;
  ...
  uVar5 = func_?();
  pcVar6 = (char *)((int)&unaff_ESI[-5].monitor + 3);
  *pcVar6 = *pcVar6 + (char)((ulonglong)uVar5 >> 8) + cVar4;
  uVar7 = in((short)CONCAT31((int3)((ulonglong)uVar5 >> 0x28),
                             (byte)((ulonglong)uVar5 >> 0x20) & *(byte *)uVar5));
  *unaff_EDI = uVar7;
  pcVar6 = (char *)((int)unaff_EDI + (int)unaff_ESI * 4 + 0x26);
  *pcVar6 = *pcVar6 + (char)((ulonglong)uVar5 >> 0x28);
  pcVar8 = (code *)swi(3);
...
code_?:
    ...
    while( true ) {
      ...
      do {
        ...
        if (pBVar1->max_length <= uVar14 + uVar2 * 4) goto code_?;
        pBVar1->vector[uVar14 + uVar2 * 4] = *(uint8_t *)(iVar12 + 0x10 + uVar14);
        uVar14 = uVar14 + 1;
      } while ((int)uVar14 < 4);
      uVar2 = uVar2 + 1;
