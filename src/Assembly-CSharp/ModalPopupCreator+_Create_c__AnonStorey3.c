...
void Assembly-CSharp.dll::ModalPopupCreator+<Create>c__AnonStorey3::
     ModalPopupCreator_Create_c_AnonStorey3___m__0
               (ModalPopupCreator_Create_c_AnonStorey3 *this,IUIStack *x,BaseEventData *y,
               MethodInfo *method)
