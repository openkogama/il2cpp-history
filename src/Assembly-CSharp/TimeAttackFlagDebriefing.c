...

{
  ...
  if (pFVar2 != (FlagDebriefingControl *)0x0) {
    ...
    if (pIVar4 != (IPlayModeUI *)0x0) {
      func_?(8,TypeInfo__IPlayModeUI,pIVar4);
...

{
  ...
  if (((this->fields).isDebriefingOn == 0) && (uVar1 == GameStatCounterType__Enum_TimeAttackFlag)) {
    ...
    func_?(8,TypeInfo__IPlayModeUI,pIVar2,1);
    (this->fields).shouldStartFlagCountdown = 1;
  }
  return;
}
            ...
            if (TypeInfo__MVGameControllerBase->static_fields->_EditModeUI_k__BackingField !=
              ...
              if (cVar6 != '\0') {
                ...
                if (((this->fields).isDebriefingOn == 0) &&
                  ...
                  func_?(8,TypeInfo__IPlayModeUI,pIVar8,1);
                  (this->fields).shouldStartFlagCountdown = 1;
                }
              }
            }
  ...
  if ((this->fields).isWaitingForStart == 0) {
    ...
    if (fVar2 < fVar3) {
      ...
      if ((pMVar5->fields).currentGameState != 2) {
        ...
        if (pIVar8 == (IPlayModeUI *)0x0) goto code_?;
        func_?(8,TypeInfo__IPlayModeUI,pIVar8,this);
      }
    }
  }
