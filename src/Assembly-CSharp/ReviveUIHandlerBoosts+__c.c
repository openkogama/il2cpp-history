...

{
  ...
  pRVar1 = (ReviveUIHandlerBoosts_c *)FUN_?(TypeInfo__ReviveUIHandlerBoosts____c);
  TypeInfo__ReviveUIHandlerBoosts____c->static_fields->__9 = pRVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__ReviveUIHandlerBoosts____c->static_fields >> 0xc);
