...
void Assembly-CSharp.dll::RTG::Tut_6_CustomWorldPivot::Tut_6_CustomWorldPivot_OnSelectionChanged
               (Tut_6_CustomWorldPivot *this,MethodInfo *method)
...
GameObject *
Assembly-CSharp.dll::RTG::Tut_6_CustomWorldPivot::Tut_6_CustomWorldPivot_PickGameObject
          (Tut_6_CustomWorldPivot *this,MethodInfo *method)
...
void Assembly-CSharp.dll::RTG::Tut_6_CustomWorldPivot::Tut_6_CustomWorldPivot_SetTransformPivot
               (Tut_6_CustomWorldPivot *this,GizmoObjectTransformPivot__Enum transformPivot,
               MethodInfo *method)

{
  ...
  if (pOVar1 != (ObjectTransformGizmo *)0x0) {
    ObjectTransformGizmo::ObjectTransformGizmo_SetTransformPivot
              (pOVar1,transformPivot,(MethodInfo *)0x0);
...
void Assembly-CSharp.dll::RTG::Tut_6_CustomWorldPivot::Tut_6_CustomWorldPivot_SetTransformSpace
               (Tut_6_CustomWorldPivot *this,GizmoSpace__Enum transformSpace,MethodInfo *method)

{
  pOVar1 = (this->fields)._objectMoveGizmo;
  if (pOVar1 != (ObjectTransformGizmo *)0x0) {
    ObjectTransformGizmo::ObjectTransformGizmo_SetTransformSpace
              (pOVar1,transformSpace,(MethodInfo *)0x0);
    pOVar1 = (this->fields)._objectRotationGizmo;
    if (pOVar1 != (ObjectTransformGizmo *)0x0) {
      ObjectTransformGizmo::ObjectTransformGizmo_SetTransformSpace
                (pOVar1,transformSpace,(MethodInfo *)0x0);
...
/* Void SetWorkGizmoId(Tut_6_CustomWorldPivot+GizmoId) */

void Assembly-CSharp.dll::RTG::Tut_6_CustomWorldPivot::Tut_6_CustomWorldPivot_SetWorkGizmoId
               (Tut_6_CustomWorldPivot *this,Tut_6_CustomWorldPivot_GizmoId__Enum gizmoId,
               MethodInfo *method)

{
  ...
  if (gizmoId == Tut_6_CustomWorldPivot_GizmoId__Enum_Move) {
    pOVar1 = (this->fields)._objectMoveGizmo;
code_?:
    ...
    if (gizmoId == Tut_6_CustomWorldPivot_GizmoId__Enum_Rotate) {
      pOVar1 = (this->fields)._objectRotationGizmo;
      goto code_?;
    }
    if (gizmoId == Tut_6_CustomWorldPivot_GizmoId__Enum_Scale) {
      pOVar1 = (this->fields)._objectScaleGizmo;
      goto code_?;
    }
    if (gizmoId == Tut_6_CustomWorldPivot_GizmoId__Enum_Universal) {
      pOVar1 = (this->fields)._objectUniversalGizmo;
      goto code_?;
    }
  }
...
void Assembly-CSharp.dll::RTG::Tut_6_CustomWorldPivot::Tut_6_CustomWorldPivot_Start
               (Tut_6_CustomWorldPivot *this,MethodInfo *method)
...
void Assembly-CSharp.dll::RTG::Tut_6_CustomWorldPivot::Tut_6_CustomWorldPivot_Update
               (Tut_6_CustomWorldPivot *this,MethodInfo *method)
...
code_?:
    Tut_6_CustomWorldPivot_SetTransformSpace(this,transformSpace,method_00);
  }
...
code_?:
  ...
  if (bVar1 == 0) {
    ...
    if (bVar1 != 0) {
      Tut_6_CustomWorldPivot_SetWorkGizmoId
                (this,Tut_6_CustomWorldPivot_GizmoId__Enum_Rotate,(MethodInfo *)0x0);
      return;
    }
    bVar1 = RTInput::RTInput_WasKeyPressedThisFrame(KeyCode__Enum_R,(MethodInfo *)0x0);
    if (bVar1 != 0) {
      Tut_6_CustomWorldPivot_SetWorkGizmoId
                (this,Tut_6_CustomWorldPivot_GizmoId__Enum_Scale,(MethodInfo *)0x0);
      return;
    }
    bVar1 = RTInput::RTInput_WasKeyPressedThisFrame(KeyCode__Enum_T,(MethodInfo *)0x0);
    if (bVar1 != 0) {
      Tut_6_CustomWorldPivot_SetWorkGizmoId
                (this,Tut_6_CustomWorldPivot_GizmoId__Enum_Universal,(MethodInfo *)0x0);
      return;
    }
  }
  else {
    Tut_6_CustomWorldPivot_SetWorkGizmoId
              (this,Tut_6_CustomWorldPivot_GizmoId__Enum_Move,(MethodInfo *)0x0);
  }
  return;
}
...
void Assembly-CSharp.dll::RTG::Tut_6_CustomWorldPivot::Tut_6_CustomWorldPivot__ctor
               (Tut_6_CustomWorldPivot *this,MethodInfo *method)
