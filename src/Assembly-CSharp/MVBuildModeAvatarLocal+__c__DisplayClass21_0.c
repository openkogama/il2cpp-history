...
void Assembly-CSharp.dll::MVBuildModeAvatarLocal+<>c__DisplayClass21_0::
     MVBuildModeAvatarLocal_c_DisplayClass21_0__OnPositionChanged_b__0
               (MVBuildModeAvatarLocal_c_DisplayClass21_0 *this,SpawnRoleDataReceiver *receiver,
               MethodInfo *method)
