...
void Assembly-CSharp.dll::TierPurchasePopup+<ProductPurchaseResponseHandler>c__AnonStorey0::
     TierPurchasePopup_ProductPurchaseResponseHandler_c_AnonStorey0___m__0
               (TierPurchasePopup_ProductPurchaseResponseHandler_c_AnonStorey0 *this,
