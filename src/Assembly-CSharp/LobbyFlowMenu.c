...

{
  ...
  bVar4 = 0;
  func_?();
  bVar5 = (byte)((uint)callbackFunction_00 >> 8);
  *(char *)&value[0xbc20936].monitor =
       *(char *)&value[0xbc20936].monitor + 'I' +
       (CARRY1(extraout_DH,(byte)callbackFunction_00) ||
       CARRY1(extraout_DH + (byte)callbackFunction_00,
              CARRY1((byte)this,bVar5) || CARRY1((byte)this + bVar5,bVar4)));
  pcVar6 = (code *)swi(3);
  (*pcVar6)();
  return;
}
