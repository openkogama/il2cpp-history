...

{
  ...
  bVar6 = Cube::Cube_IsFaceBoxSideAligened(cube,(Face__Enum)face,(MethodInfo *)0x0);
  if (bVar6 != 0) {
    if ((TypeInfo__MV__WorldObject__IntVector->_1).cctor_finished_or_no_cctor == 0) {
      func_?(TypeInfo__MV__WorldObject__IntVector);
    }
    ...
    uVar7 = (undefined2)((uint)puVar4 >> 0x10);
    switch(method->name) {
    case (char *)0x0:
      break;
    case (char *)0x1:
      break;
    case (char *)0x2:
      puVar4 = (undefined *)CONCAT22(uVar7,0xffff);
      break;
    case (char *)0x3:
      puVar4 = (undefined *)CONCAT22(uVar7,1);
      break;
    case (char *)0x4:
      iVar3 = -1;
      break;
    ...
    iVar8 = (int16_t)puVar4;
    pIVar9 = method[1].methodPointer;
    ...
    IVar5 = MVWorldObject.dll::MV::WorldObject::IntVector::IntVector_op_Addition
                      (i1,i2,(MethodInfo *)CONCAT22((short)((uint)puVar4 >> 0x10),iVar8));
    this->klass = (CellCursor__Class *)*IVar5._0_4_;
    *(undefined2 *)&this->monitor = *(undefined2 *)(IVar5._0_4_ + 1);
...

{
  ...
  if (cVar12 == '\x01') {
    ...
    uVar2 = extraout_CX;
    bVar15 = extraout_AH_00;
  }
  bVar16 = (byte)uVar2;
  bVar17 = (byte)((ushort)uVar2 >> 8);
  bVar18 = CARRY1(bVar17,bVar16) || CARRY1(bVar17 + bVar16,bVar13);
  pcVar14 = (code *)swi(4);
  if (SCARRY1(bVar17,bVar16) != SCARRY1(bVar17 + bVar16,bVar13)) {
    (*pcVar14)();
    uVar3 = extraout_DX_01;
    bVar16 = extraout_CL;
    bVar15 = extraout_AH_01;
  }
  bVar17 = (byte)uVar3;
  bVar19 = (byte)((ushort)uVar3 >> 8);
  bVar13 = bVar19 + bVar17;
  bVar20 = CARRY1(bVar19,bVar17) || CARRY1(bVar13,bVar18);
  cVar12 = bVar13 + bVar18;
  pcVar14 = (code *)swi(4);
  if (SCARRY1(bVar19,bVar17) != SCARRY1(bVar13,bVar18)) {
    (*pcVar14)();
    bVar16 = extraout_CL_00;
    cVar12 = extraout_DH;
    bVar15 = extraout_AH_02;
  }
  cVar21 = CARRY1(bVar16,bVar15) || CARRY1(bVar16 + bVar15,bVar20);
  pcVar14 = (code *)swi(4);
  if (SCARRY1(bVar16,bVar15) != SCARRY1(bVar16 + bVar15,bVar20)) {
    (*pcVar14)();
    bVar15 = extraout_AH_03;
    cVar12 = extraout_DH_00;
  }
  pcVar14 = (code *)swi(4);
  if (SCARRY1(cVar12,bVar15) != SCARRY1(cVar12 + bVar15,cVar21)) {
    (*pcVar14)();
  }
  pcVar14 = (code *)swi(3);
  (*pcVar14)();
