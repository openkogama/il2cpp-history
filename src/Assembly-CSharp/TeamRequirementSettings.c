...

{
  ...
  uVar13 = func_?();
  bVar14 = pDRam3d194710 < this_02;
  uVar15 = (int)pDRam3d194710 - (int)this_02;
  pDRam3d194710 =
       (Dictionary_2_MV_WorldObject_MVTeam_System_String_ *)(uVar15 - (uVar13 < 0x42103d19));
  pcVar16 = (char *)((int)&(unaff_EBX->fields)._._.m_CanvasRenderer + extraout_ECX + 1);
  *pcVar16 = *pcVar16 + (char)extraout_ECX + (bVar14 || uVar15 < (uVar13 < 0x42103d19));
  pcVar17 = (code *)swi(3);
  (*pcVar17)();
  return;
}
...

{
  ...
  func_?();
  LOCK();
  unaff_EDI[0x7a39182].klass = unaff_EBX;
  UNLOCK();
  *(char *)(extraout_ECX + -0x69efc2e4) =
       *(char *)(extraout_ECX + -0x69efc2e4) + extraout_DL + cVar3;
  pcVar8 = (code *)swi(3);
  (*pcVar8)();
  return;
}
