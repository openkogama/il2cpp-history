...
void Assembly-CSharp.dll::RTG::PostObjectTransformsChangedAction::
     PostObjectTransformsChangedAction_Execute
               (PostObjectTransformsChangedAction *this,MethodInfo *method)
...
void Assembly-CSharp.dll::RTG::PostObjectTransformsChangedAction::
     PostObjectTransformsChangedAction_Redo
               (PostObjectTransformsChangedAction *this,MethodInfo *method)

{
  ...
  if ((List_1_RTG_LocalTransformSnapshot_ *)LStack_1._list ==
      (List_1_RTG_LocalTransformSnapshot_ *)0x0) {
    FUN_?();
    pcVar2 = (code *)swi(3);
    (*pcVar2)();
    return;
  ...
  pLStack_8 = (List_1_T_Enumerator_System_Object_ *)
               ((ulonglong)
                (uint)(((List_1_RTG_LocalTransformSnapshot_ *)LStack_1._list)->fields)._version <<
               0x20);
  uStack_9 = 0;
  ...
  while( true ) {
    ...
    if ((LocalTransformSnapshot *)LStack_1._current == (LocalTransformSnapshot *)0x0) break;
    LocalTransformSnapshot::LocalTransformSnapshot_Apply
              ((LocalTransformSnapshot *)LStack_1._current,(MethodInfo *)0x0);
  }
  FUN_?();
  FUN_?();
  pcVar2 = (code *)swi(3);
...
void Assembly-CSharp.dll::RTG::PostObjectTransformsChangedAction::
     PostObjectTransformsChangedAction_Undo
               (PostObjectTransformsChangedAction *this,MethodInfo *method)
...
/* PostObjectTransformsChangedAction(List`1[RTG.LocalTransformSnapshot],
   List`1[RTG.LocalTransformSnapshot]) */

void Assembly-CSharp.dll::RTG::PostObjectTransformsChangedAction::
     PostObjectTransformsChangedAction__ctor
               (PostObjectTransformsChangedAction *this,
