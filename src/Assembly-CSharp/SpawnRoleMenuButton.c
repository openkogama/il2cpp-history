        ...
        if ((pMVar1 != (MVNetworkGame *)0x0) &&
          ...
          if (pGRam00000010 != (GameObject *)0x0) {
            UnityEngine.CoreModule.dll::UnityEngine::GameObject::GameObject_SetActive
                      (pGRam00000010,iVar4 < 2 && 0 < iVar3,(MethodInfo *)0x0);
            return;
          }
        }
      }
...

{
  ...
  value = (Object *)func_?(TypeInfo__SpawnRoleMenuButton____c__DisplayClass6_0);
  if (value != (Object *)0x0) {
    ...
    if ((pMVar2 != (MVLocalPlayer *)0x0) && (pOVar1 != (Object__Class *)0x0)) {
      ...
      if (callbackFunction == (ExecuteEvents_EventFunction_1_IUIStack_ *)0x0) {
        ...
        func_?(&TypeInfo__SpawnRoleMenuButton____c->static_fields->__9__6_0,
                        callbackFunction);
      }
