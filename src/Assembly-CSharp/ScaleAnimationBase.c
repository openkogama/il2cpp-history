...
bool Assembly-CSharp.dll::ScaleAnimationBase::ScaleAnimationBase_IsPlaying
...

{
  if (cRam_? == '\0') {
    ...
    LOCK();
    UNLOCK();
    FUN_?(&StringLiteral_Target_already_set);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
  ...
  if (pTVar1 != (Transform *)0x0) {
    ...
    if ((pTVar1->fields)._._.m_CachedPtr != (void *)0x0) {
      ...
      pSVar2 = StringLiteral_Target_already_set;
      if (cRam_? == '\0') {
  ...
  if (bVar6) {
    uVar7 = (uint)((ulonglong)&(this->fields).target >> 0xc);
  ...
  fStack_11 = 0.0;
  pvVar12 = (target->fields)._._.m_CachedPtr;
  if (pvVar12 == (void *)0x0) {
  ...
  pcRam_? = pcVar4;
  (*pcRam_?)(pvVar12,&pSStack_5);
  *(String **)&(this->fields).originalScale = pSStack_5;
  (this->fields).originalScale.z = fStack_11;
  return;
}
...

{
  ...
  uStack_2._0_4_ = (this->fields).originalScale.x;
  uStack_2._4_4_ = (this->fields).originalScale.y;
  fStack_3 = (this->fields).originalScale.z;
  if (cRam_? == '\0') {
    FUN_?(&
                  void__MethodInfo__UnityEngine__Object__MarshalledUnityObject__MarshalNotNull<UnityEngine::Transform>_UnityEngine__Transform_
                 );
...

{
  ...
  (this->fields).originalScale.x = (pVVar2->oneVector).x;
