...
InteractionData *
Assembly-CSharp.dll::GrowthGunHitPackage::GrowthGunHitPackage_Create
...

{
  ...
  *(undefined2 *)&__return_storage_ptr__->field_0x12 = 0;
  MVWorldObject.dll::MV::WorldObject::InteractionData::InteractionData__ctor
            (__return_storage_ptr__,InteractionPackageType__Enum_GrowthGunHit,(MethodInfo *)0x0);
...
void Assembly-CSharp.dll::GrowthGunHitPackage::GrowthGunHitPackage_ParseAndHandlePackage
               (GrowthGunHitPackage *this,MVWorldObjectClient *worldObjectClient,MVPlayer *shooter,
...

{
  InteractionPackage::InteractionPackage_HandlePackage_6
            ((InteractionPackage *)this,worldObjectClient,shooter,
             AvatarModifierPackageType__Enum_Enlarged,(MethodInfo *)0x0);
  return;
}
