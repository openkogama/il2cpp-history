  ...
  if (this_02 != (Transform *)0x0) {
    ...
    if (this_00 != (TargetRotation *)0x0) {
      ...
      if (targetTransform != (ProtectedTransform *)0x0) {
        ...
        ;
        value_00.y = (fVar4 * fVar22 + fVar8 * 3.229288e-29 + fVar9 * fVar3) - fVar5 * fVar7;
        value_00.x = (fVar22 * fVar3 + fVar7 * 3.229288e-29 + fVar8 * fVar5) - fVar9 * fVar4;
        value_00.z = (fVar5 * fVar22 + fVar9 * 3.229288e-29 + fVar4 * fVar7) - fVar8 * fVar3;
        value_00.w = ((fVar22 * 3.229288e-29 - fVar3 * fVar7) - fVar4 * fVar8) - fVar9 * fVar5
        ;
