...

{
  ...
  if (pPVar1 != (PickupItem *)0x0) {
    ...
    if (((pPVar1 != (PickupItem *)0x0) &&
      ...
      ppUVar6 = &(pMVar4->fields).ScaleChanged;
      ...
      if (unaff_ESI == (MVPickupOwner *)0x0) {
        *ppUVar6 = (UnityAction_2_MVWorldObjectClient_ScaleChangedEventArgs_ *)0x0;
        pMStack7 = (MVPickupOwner *)ppUVar6;
        pUStack8 =
...
code_?:
    ...
    if (unaff_ESI == (MVPickupOwner *)0x0) {
      pMStack6 = (MVPickupOwner *)&(unaff_EDI->_1).cctor_finished_or_no_cctor;
      *(uint32_t *)pMStack6 = 0;
      pUStack7 = (UnityAction_2_MVWorldObjectClient_ScaleChangedEventArgs___Class *)unaff_ESI
      ;
      func_?();
      return;
    }
    ...
    unaff_EDI = (UnityAction_2_MVWorldObjectClient_ScaleChangedEventArgs___Class *)
                &(unaff_EDI->_1).cctor_finished_or_no_cctor;
    *(uint32_t *)unaff_EDI = uVar8;
    ...
    pUStack7 =
         (UnityAction_2_MVWorldObjectClient_ScaleChangedEventArgs___Class *)func_?();
    if (pUStack7 != (UnityAction_2_MVWorldObjectClient_ScaleChangedEventArgs___Class *)0x0) {
      pMStack6 = (MVPickupOwner *)unaff_EDI;
      func_?();
      return;
    }
  }
  pMStack6 = unaff_ESI;
  pUStack7 = (UnityAction_2_MVWorldObjectClient_ScaleChangedEventArgs___Class *)this;
  func_?();
  pUStack7 = unaff_EDI;
code_?:
  pMStack6 = unaff_ESI;
