  ...
  if ((((pMVar1 != (MVGameControllerBase *)0x0) &&
    ...
    if ((materialList != (Dictionary_2_System_Object_System_Object_ *)0x0) &&
      ...
      while (lVar21 = CONCAT44(fStack_16,fStack_15), lVar21 != 0) {
        ...
        method = (MethodInfo *)pDRam0000000182db23e8;
        ...
        pOVar27 = (Object *)FUN_?(pDRam0000000182db23e8,auStackX_20);
        method = 
        MethodInfo__System__Collections__Generic__Dictionary<System::Object,_System::Object>__get_Item_System__Object_
        ;
        ...
        if (pSVar29 != (String *)0x0) {
          if (pSVar29->klass == pSRam0000000182db2460) {
            pSVar24 = pSVar29;
          }
        ...
        method = (MethodInfo *)pDRam0000000182db2418;
        ...
        if (bVar5 == 0) {
          ...
          method = (MethodInfo *)pDRam0000000182db23f8;
          if (pOVar27 == (Object *)0x0) goto code_?;
          if ((pOVar27->klass->_0).element_class !=
              (Il2CppClass *)
