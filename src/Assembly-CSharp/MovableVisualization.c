...

{
  ...
  if ((pMVar1 != (MVCubeModelBase *)0x0) &&
    ...
    if ((pMVar1 != (MVCubeModelBase *)0x0) &&
      ...
      fStack_8 = pQVar7->z;
      fStack_9 = pQVar7->w;
      this_01 = (MovableVisualization_Package *)
                func_?(TypeInfo__MovableVisualization__Package);
      position.z = fVar6;
      position.x = (float)(undefined4)uStack_5;
      position.y = (float)uStack_5._4_4_;
      rotation.y = (float)auStack_4._4_4_;
      rotation.x = (float)auStack_4._0_4_;
      rotation.z = fStack_8;
      rotation.w = fStack_9;
      MovableVisualization+Package::MovableVisualization_Package__ctor
                (this_01,position,rotation,(MethodInfo *)0x0);
      if (this_00 != (Queue_1_MovableVisualization_Package_ *)0x0) {
        mscorlib.dll::System::Collections::Generic::Queue`1[System::Object]::
        Queue_1_System_Object__Enqueue
                  ((Queue_1_System_Object_ *)this_00,(Object *)this_01,
                   MethodInfo__System__Collections__Generic__Queue<MovableVisualization::Package>__Enqueue_MovableVisualization__Package_
                  );
        return;
      }
