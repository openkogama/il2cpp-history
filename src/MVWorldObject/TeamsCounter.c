...

{
  ...
  *score = 0;
  ...
  bVar19 = CARRY1(*pbVar17,(byte)unaff_EBX) || CARRY1(bVar18,bVar15);
  *pbVar17 = bVar18 + bVar15;
  uVar20 = (uint)uVar16 + 0xe2f0ef24;
  bVar15 = (char)uVar20 - bVar19;
  uVar21 = *(uint *)(auStack_9 + unaff_EBX * 8 + -0xc);
  *(uint *)(auStack_9 + unaff_EBX * 8 + -0xc) =
       (uint)(CONCAT14((uint)uVar16 < 0x1d0f10dc || uVar20 < bVar19,uVar21) >> 1);
  bVar19 = (uVar21 & 1) != 0;
  bVar22 = (byte)((ulonglong)uVar16 >> 0x20);
  bVar18 = extraout_CL + bVar22;
  *unaff_EDI = *unaff_EDI + bVar18 + bVar19 +
               (bVar15 < 0xdc ||
               (byte)(bVar15 + 0x24) < (CARRY1(extraout_CL,bVar22) || CARRY1(bVar18,bVar19)));
