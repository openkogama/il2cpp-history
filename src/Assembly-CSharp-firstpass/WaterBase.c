...

{
  ...
  if (pMVar1 != (Material *)0x0) {
    ...
    if ((pMVar1->fields)._.m_CachedPtr != (void *)0x0) {
      WaterBase_UpdateShader(this,(MethodInfo *)0x0);
    }
  }
  return;
}
...

{
  if (cRam_? == '\0') {
    ...
    LOCK();
    UNLOCK();
    FUN_?(&StringLiteral_WATER_EDGEBLEND_OFF);
    LOCK();
    UNLOCK();
    FUN_?(&StringLiteral_WATER_EDGEBLEND_ON);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
  ...
  if ((this->fields).edgeBlend == 0) {
    ...
    pSVar1 = StringLiteral_WATER_EDGEBLEND_ON;
    if (cRam_? == '\0') {
    ...
    if (pSVar1 != (String *)0x0) {
      if ((pSVar1->fields)._stringLength == 0) {
        ...
        puStack_2 = &(pSVar1->fields)._firstChar;
        if (iVar6 == 0) {
          puStack_2 = (uint16_t *)0x0;
        }
  ...
  if (pCVar9 != (Camera *)0x0) {
    ...
    if ((pCVar9->fields)._._._.m_CachedPtr != (void *)0x0) {
      pCVar9 = UnityEngine.CoreModule.dll::UnityEngine::Camera::Camera_get_main((MethodInfo *)0x0);
      if (pCVar9 != (Camera *)0x0) {
        DVar10 = UnityEngine.CoreModule.dll::UnityEngine::Camera::Camera_get_depthTextureMode
                          (pCVar9,(MethodInfo *)0x0);
        if (cRam_? == '\0') {
          FUN_?(&
                        void__MethodInfo__UnityEngine__Object__MarshalledUnityObject__MarshalNotNull<UnityEngine::Camera>_UnityEngine__Camera_
                        ,DVar10 | DepthTextureMode__Enum_Depth,0);
          LOCK();
          UNLOCK();
          cRam_? = '\x01';
        }
        ...
        pvVar11 = (pCVar9->fields)._._._.m_CachedPtr;
        if (pvVar11 == (void *)0x0) {
        ...
        (*pcRam_?)(pvVar11,DVar10 | DepthTextureMode__Enum_Depth);
        return;
      }
code_?:
      FUN_?();
...

{
  ...
  if (currentCam != (Camera *)0x0) {
    ...
    if (((currentCam->fields)._._._.m_CachedPtr != (void *)0x0) && ((this->fields).edgeBlend != 0))
    {
      DVar1 = UnityEngine.CoreModule.dll::UnityEngine::Camera::Camera_get_depthTextureMode
                        (currentCam,(MethodInfo *)0x0);
      UnityEngine.CoreModule.dll::UnityEngine::Camera::Camera_set_depthTextureMode
                (currentCam,DVar1 | DepthTextureMode__Enum_Depth,(MethodInfo *)0x0);
    }
  }
  return;
}
