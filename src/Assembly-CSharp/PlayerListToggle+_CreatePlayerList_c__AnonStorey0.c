...
void Assembly-CSharp.dll::PlayerListToggle+<CreatePlayerList>c__AnonStorey0::
     PlayerListToggle_CreatePlayerList_c_AnonStorey0___m__0
               (PlayerListToggle_CreatePlayerList_c_AnonStorey0 *this,IUIStack *x,BaseEventData *y,
               MethodInfo *method)
