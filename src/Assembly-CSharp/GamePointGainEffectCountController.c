...

{
  ...
  bVar14 = *(uint *)(unaff_EBX + -0x7c9aefbe) < (uint)uVar12;
  pbVar15 = (byte *)(iVar13 + -0x7c);
  bVar16 = *pbVar15;
  bVar17 = *pbVar15;
  *pbVar15 = bVar17 + extraout_CH + bVar14;
  pcVar18 = (char *)(iVar13 + 2);
  *pcVar18 = *pcVar18 + (char)((uint)unaff_EBX >> 8) +
             (CARRY1(bVar16,extraout_CH) || CARRY1(bVar17 + extraout_CH,bVar14));
  pcVar19 = (code *)swi(3);
  (*pcVar19)();
  return;
}
