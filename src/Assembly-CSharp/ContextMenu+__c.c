...

{
  ...
  pCVar1 = (ContextMenu_c *)FUN_?(TypeInfo__ContextMenu____c);
  TypeInfo__ContextMenu____c->static_fields->__9 = pCVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__ContextMenu____c->static_fields >> 0xc);
