...
code_?:
  ...
  if ((int)pSVar10->max_length <= iVar11) {
    ...
    pfVar23 = (float *)func_?();
    SettingsSlider::SettingsSlider_Initialize
              (pSVar20,StringLiteral_RecoilStrength,*pfVar23,fStack_22,4.012614e-29,(MethodInfo *)0x0
              );
    ...
    pfVar23 = (float *)func_?();
    SettingsSlider::SettingsSlider_Initialize
              (pSVar20,StringLiteral_AttackCooldown,*pfVar23,4.0125998e-29,(float)pDVar2,
               (MethodInfo *)0x0);
