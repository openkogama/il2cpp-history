...
code_?:
  ...
  *(byte *)&unaff_ESI->klass = bVar12 + bVar7;
  if (SCARRY1(cVar11,bVar10) == SCARRY1(bVar12,bVar7)) {
    ...
    uVar9 = *(undefined6 *)(&unaff_ESI->klass + (int)uVar9 * 2);
    *(int *)(unaff_EBX + 0xf530c45) = *(int *)(unaff_EBX + 0xf530c45) + extraout_ECX;
    this = (IndexOutOfRangeException *)&unaff_EDI->monitor;
    pbVar16 = (byte *)((int)&unaff_ESI[5].monitor + 3);
    *pbVar16 = *pbVar16 << 1 |
              (IndexOutOfRangeException__Class *)(&uRam_? + (int)uVar9) < unaff_EDI->klass;
  }
  pBVar1 = (Byte__Array *)func_?();
  uVar17 = 0;
  fVar3 = color.r;
...
code_?:
    ...
    while( true ) {
      if (*(int *)((int)color.r + 0xc) <= (int)uVar17) {
        return pBVar1;
      }
      uVar8 = uVar17 < *(uint *)((int)color.r + 0xc);
      if (!(bool)uVar8) break;
      pBVar18 = *(Byte__Array__Class **)((int)fVar3 + 0x1c);
      if (cRam_? == '\0') {
        func_?();
        cRam_? = '\x01';
      }
      pBVar19 = (Byte__Array__Class *)0x4;
      pBVar20 = (Byte__Array__Class *)&UNK_?;
      ...
      do {
        ...
        uVar8 = &pSVar4->klass + uVar17 < (undefined1 *)pBVar1->max_length;
        if (!(bool)uVar8) goto code_?;
        *(uint8_t *)((int)&pSVar4->klass + (int)(pBVar1->vector + uVar17 * 4)) =
...
code_?:
  uVar23 = func_?();
  uVar24 = (uint)((ulonglong)uVar23 >> 0x20);
  iVar25 = (int)uVar23;
  if (!(bool)uVar8) {
    pcVar26 = (char *)(uVar24 + 0x72a31023 + (int)pBVar1 * 2);
    *pcVar26 = *pcVar26 + (char)uVar17;
    uVar24 = uVar24 & unaff_EBP;
    *(byte *)&this->klass = (byte)&stack0xfffffffc;
  }
  *(char *)(iVar25 + -0x75) =
       *(char *)(iVar25 + -0x75) + (char)uVar24 +
       ((bool)uVar8 && CARRY1((byte)unaff_EBP,(byte)&stack0xfffffffc));
  in((short)uVar24);
  *unaff_FS_OFFSET = &stack0xffffffe8;
  bVar13 = cRam_? == '\0';
  *(undefined1 **)(iVar25 + -0x10) = &stack0xffffffe8;
  if (bVar13) {
    func_?();
    func_?();
    func_?();
  ...
  *(undefined4 *)(iVar25 + -0x18) = 0;
  if (pTVar28 != (Texture2D *)0x0) {
    ...
    if (pTVar29 == (Texture2D *)0x0) {
      ...
      *(SHA1CryptoServiceProvider **)(iVar25 + -0x14) = this_00;
      *(undefined4 *)(iVar25 + -0x24) = 0;
      *(int *)(iVar25 + -0x20) = iVar25 + -0x14;
      ...
      *(undefined1 *)(iVar25 + -4) = 1;
      if (this_00 != (SHA1CryptoServiceProvider *)0x0) {
        ...
        *(undefined4 *)(iVar25 + -4) = 0xffffffff;
        *(Byte__Array **)(iVar25 + -0x18) = pBVar1;
        IStack_2.m_value = *(int *)(iVar25 + -0x14);
        if (IStack_2.m_value != 0) {
          func_?();
          *unaff_FS_OFFSET = *(undefined4 *)(iVar25 + -0xc);
          return pBVar1;
        }
        *unaff_FS_OFFSET = *(undefined4 *)(iVar25 + -0xc);
        return pBVar1;
