...
void Assembly-CSharp.dll::FadeableAvatarObject+<AddMaterialsToAvatarFader>c__AnonStorey0::
     FadeableAvatarObject_AddMaterialsToAvatarFader_c_AnonStorey0___m__0
               (FadeableAvatarObject_AddMaterialsToAvatarFader_c_AnonStorey0 *this,IFadeParent *x,
