...
code_?:
    ...
    case MVOperationCodes__Enum_TransferWorldObjectsToGroup:
      ...
      if (((pMVar1 != (MVNetworkGame *)0x0) &&
        ...
        pUVar16 = (UxmlObjectListAttributeDescription_1_System_Object_ *)
                  func_?(TypeInfo__OnTransferWosResponseEventArgs);
        if (cRam_? == '\0') {
        ...
        UxmlObjectListAttributeDescription_1_System_Object___ctor(pUVar16,(MethodInfo *)0x0);
        *(bool *)&(pUVar16->fields)._._defaultValue_k__BackingField = returnCode == 0;
        (*(pEVar15->fields)._._.invoke_impl)
                  ((pEVar15->fields)._._.method_code,pMVar14,pUVar16,(pEVar15->fields)._._.method);
        return;
      }
      break;
      ...
      if ((pOVar6->klass->_0).element_class == (TypeInfo__System__Int32->_0).element_class) {
        ...
        if ((pMVar1 != (MVNetworkGame *)0x0) &&
          ...
          if (pMVar14 != (MVWorldObjectClientManagerNetwork *)0x0) {
            ...
            UxmlObjectListAttributeDescription`1[System::Object]::
            UxmlObjectListAttributeDescription_1_System_Object___ctor(pUVar16,(MethodInfo *)0x0);
            *(bool *)&pUVar16[1].klass = returnCode == 0;
            (pUVar16->fields)._._defaultValue_k__BackingField = pLVar25;
            pEVar26 = (pMVar14->fields)._.CloneWorldObjectTreeResponse;
            if (pEVar26 != (EventHandler_1_CloneWorldObjectTreeResponseEventArgs_ *)0x0) {
              (*(pEVar26->fields)._._.invoke_impl)
                        ((pEVar26->fields)._._.method_code,pMVar14,pUVar16,(pEVar26->fields)._._.method
                        );
              return;
            }
          }
