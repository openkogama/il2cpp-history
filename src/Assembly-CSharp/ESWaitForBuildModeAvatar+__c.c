...

{
  ...
  pEVar1 = (ESWaitForBuildModeAvatar_c *)FUN_?(TypeInfo__ESWaitForBuildModeAvatar____c);
  TypeInfo__ESWaitForBuildModeAvatar____c->static_fields->__9 = pEVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__ESWaitForBuildModeAvatar____c->static_fields >> 0xc);
