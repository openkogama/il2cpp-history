    ...
    if (pDVar7 != (Dictionary_2_System_UInt32_System_Object_ *)0x0) {
      ...
      while (bVar21 = mscorlib.dll::System::Collections::Generic::
        ...
        if (0 < *(int *)&aDStack_20[0]._current.value[1].monitor) {
          ...
          bVar21 = TierUnlockedPopupContentLoot_IsTierItemALootItem(this,item,(MethodInfo *)0x0);
          if (bVar21 != 0) {
            if (pDVar8 ==
      ...
      if ((pDVar8 !=
           (Dictionary_2_UnityEngine_UIElements_TypeConverterRegistry_ConverterKey_System_Object_ *)
           0x0) && (pDVar22 = mscorlib.dll::System::Collections::Generic::Dictionary`2[UnityEngine::
                    ...
                    *)0x0)) {
        pDVar8 = (pDVar22->fields)._dictionary;
        ppDStack_16 = (Dictionary_2_UnityEngine_UIElements_TypeConverterRegistry_ConverterKey_System_Object_
                       **)0x0;
        uStack_18 = 0;
        if (iRam_? != 0) {
        ...
        while (pDStack_1 !=
          ...
          do {
            ...
            pDVar25 = (pDStack_1->fields)._entries;
            lVar11 = (longlong)(int)uStack_2;
            uVar9 = uStack_2 + 1;
            if (pDVar25 == (Dictionary_2_TKey_TValue_Entry_UnityEngine_UIElements_TypeConverterRegistry_ConverterKey_System_Object___Array
                           *)0x0) goto code_?;
            bVar14 = (uint)pDVar25->max_length <= uStack_2;
            uStack_2 = uVar9;
            if (bVar14) goto code_?;
          } while ((&pDVar25->vector[0].hashCode)[lVar11 * 6] < 0);
          lStack_4 = *(longlong *)((longlong)&pDVar25->vector[0].key + lVar11 * 0x18 + 8);
          func_?();
...

{
  ...
  TierUnlockedPopupContentBase::TierUnlockedPopupContentBase_Initialize
            ((TierUnlockedPopupContentBase *)this,unlockedGamePassTier,onDisplayDoneCallback,
             (MethodInfo *)0x0);
  if (cRam_? == '\0') {
    FUN_?(&StringLiteral_x_0__IN_GAME_LOOT_UNLOCKED_);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
  pSVar1 = TM::TM__(StringLiteral_x_0__IN_GAME_LOOT_UNLOCKED_,(MethodInfo *)0x0);
  pTVar2 = (this->fields)._.titleText;
  aiStackX_10[0] = TierUnlockedPopupContentLoot_GetItemAmount(this,(MethodInfo *)0x0);
...

{
  ...
  pSVar1 = TM::TM__(StringLiteral_x_0__IN_GAME_LOOT_UNLOCKED_,(MethodInfo *)0x0);
  pTVar2 = (this->fields)._.titleText;
  aiStackX_8[0] = TierUnlockedPopupContentLoot_GetItemAmount(this,(MethodInfo *)0x0);
