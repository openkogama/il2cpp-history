...

{
  ...
  uVar1._0_4_ = (this->fields).aroundVector.x;
  uVar1._4_4_ = (this->fields).aroundVector.y;
  fVar2 = (this->fields).aroundVector.z;
  ...
  aVStack_6[0]._0_8_ = uVar1;
  aVStack_6[0].z = fVar2;
  UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_Rotate_4
            (this_00,aVStack_6,fVar5 * fVar3,Space__Enum_Self,(MethodInfo *)0x0);
  return;
}
...

{
  ...
  (this->fields).aroundVector.x = (float)(int)(uVar2 << 0x20);
  (this->fields).aroundVector.y = (float)(int)((uVar2 << 0x20) >> 0x20);
...
code_?:
            if (pMVar15 != (MethodInfo *)0x0) {
              if ((*pMVar15->name == '.') && ((pMVar15->flags & 0x800) != 0)) {
                ppMVar16 = ppMVar4;
                while (pcVar17 = (char *)((longlong)ppMVar16 + 0xADDR),
                      ppMVar16 = (MethodInfo **)((longlong)ppMVar16 + 1),
                      *pcVar17 == (pMVar15->name + -1)[(longlong)ppMVar16]) {
