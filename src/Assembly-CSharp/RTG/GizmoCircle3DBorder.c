      ...
      if (lVar4 != 0) {
        ...
        if (pGVar2 != (GizmoPlaneSlider3D *)0x0) {
          ...
          if ((lVar4 != 0) &&
             ...
             pIVar6 != (IGizmoCircle3DBorderController__Array *)0x0)) {
            uVar7 = *(uint *)(lVar4 + 0xa0);
            ...
            if (pIVar9 != (IGizmoCircle3DBorderController *)0x0) {
              ...
              ppIVar13 = (Il2CppMethodPointer *)
                        FUN_?(pIVar9,TypeInfo__RTG__IGizmoCircle3DBorderController,2);
code_?:
