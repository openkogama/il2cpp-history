...
code_?:
  ...
  if (pDVar20 != (Dictionary_2_System_Object_System_Object_ *)0x0) {
    ...
    if ((bVar16 != 0) && (apOStackX_10[0] != (Object *)0x0)) {
      pOVar17 = pOVar2;
      if (apOStackX_10[0]->klass == pORam0000000182dbddc8) {
        pOVar17 = apOStackX_10[0];
      }
      if (pOVar17 != (Object *)0x0) {
        if ((apOStackX_10[0]->klass->_0).element_class != (pORam0000000182dbddc8->_0).element_class)
        {
          FUN_?(apOStackX_10[0]);
          pcVar18 = (code *)swi(3);
          pHVar19 = (HoverCraftVisualization_HoverCraftVisualizationSettings *)(*pcVar18)();
    ...
    if (pDVar20 != (Dictionary_2_System_Object_System_Object_ *)0x0) {
      ...
      if (bVar16 != 0) {
        if (pOStackX_20 != (Object *)0x0) {
          if (pOStackX_20->klass == pORam0000000182dbdd78) {
            pOVar2 = pOStackX_20;
          }
          if (pOVar2 != (Object *)0x0) {
            if ((pOStackX_20->klass->_0).element_class != (pORam0000000182dbdd78->_0).element_class)
            {
              FUN_?(pOStackX_20);
              pcVar18 = (code *)swi(3);
              pHVar19 = (HoverCraftVisualization_HoverCraftVisualizationSettings *)(*pcVar18)();
      ...
      if (pMVar15 != (MVRuntimeDataVariable *)0x0) {
        ...
        if ((pMVar5 != (MVCubeModelInstance *)0x0) &&
          ...
          *piVar20 = *piVar20 | 0x10;
          ...
          {
            if (apMStack_2[0]->klass == pMRam0000000182dbddc8) {
              pMVar1 = apMStack_2[0];
            }
            if (pMVar1 != (MVCubeModelInstance *)0x0) {
              if ((apMStack_2[0]->klass->_0).element_class !=
                  (pMRam0000000182dbddc8->_0).element_class) {
                FUN_?(apMStack_2[0]);
                pcVar7 = (code *)swi(3);
                (*pcVar7)();
                return;
