...

{
  ...
  *unaff_FS_OFFSET = &uStack_3;
  ...
  if (cRam_? == '\0') {
    ...
    func_?(&
                    MethodInfo__System__Collections__Generic__List<RTG::LocalGizmoTransformSnapshot>__GetEnumerator__
                   );
    cRam_? = '\x01';
    puVar5 = puStack_4;
  }
  ...
  if (this_00 != (List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)0x0) {
    ...
    while( true ) {
      ...
      LocalGizmoTransformSnapshot::LocalGizmoTransformSnapshot_Apply
                ((LocalGizmoTransformSnapshot *)LStack_6._current,(MethodInfo *)0x0);
    }
  }
  func_?();
  pcVar10 = (code *)swi(3);
...

{
  ...
  pLStack2 = pLVar1;
  func_?();
  collection = TypeInfo__System__Collections__Generic__List<RTG::LocalGizmoTransformSnapshot>;
  pLVar1 = (List_1_RTG_LocalGizmoTransformSnapshot_ *)func_?();
  mscorlib.dll::System::Collections::Generic::List`1[System::Object]::List_1_System_Object___ctor_1
