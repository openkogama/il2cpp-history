...

{
  ...
  if (pTVar1 != (Transform *)0x0) {
    ...
    if (pMVar4 != (MVPickupOwner *)0x0) {
      ...
      color._0_12_ = (Vector3)ZEXT812(0);
      auVar6._4_8_ = 0;
      auVar6._0_4_ = fVar3;
      color.value.b = 0.0;
      color.value.a = 0.0;
      pPVar7 = OneShotPooledParticleSystem::OneShotPooledParticleSystem_Instantiate_1
                          (PoolEnums__Enum_HealRaySparks,(Vector3)(auVar6 << 0x40),*pQVar5,
                           (Nullable_1_Single_)0x0,color,(MethodInfo *)0x0);
      ppPVar8 = &(this->fields).hitParticles;
      *ppPVar8 = pPVar7;
      func_?();
      pPVar7 = *ppPVar8;
      if (pPVar7 != (ParticleSystem *)0x0) {
        ...
        if (pMVar4 != (MVPickupOwner *)0x0) {
          ...
          if (pPVar7 != (ParticleSystem *)0x0) {
            ...
            ppPVar10 = &(this->fields).particleRenderer;
            *ppPVar10 = pPVar9;
            func_?();
            if (*ppPVar10 != (ParticleSystemRenderer *)0x0) {
              pMVar11 = UnityEngine.CoreModule.dll::UnityEngine::Renderer::Renderer_get_material
                                  ((Renderer *)*ppPVar10,(MethodInfo *)0x0);
              (this->fields).normalRayMaterial = pMVar11;
              func_?();
              if (*ppPVar10 != (ParticleSystemRenderer *)0x0) {
                UnityEngine.CoreModule.dll::UnityEngine::Renderer::Renderer_set_sharedMaterial
                          ((Renderer *)*ppPVar10,(this->fields).ZIgnoreMaterial,(MethodInfo *)0x0);
                ppTVar12 = &(this->fields)._.muzzlePoint;
                (this->fields).remoteMuzzlePoint = (this->fields)._.muzzlePoint;
                func_?();
                (this->fields).remoteParticleSystem = *ppPVar8;
                func_?();
                pTVar1 = (this->fields).localMuzzePoint;
                *ppTVar12 = pTVar1;
                func_?(ppTVar12,pTVar1);
...
code_?:
    ...
    if (((bVar9 <= (this->klass->_1).naturalAligment) &&
      ...
      *(GameObject **)unaff_EBX = (GameObject *)(pPVar3->fields).maxLockOnRange;
