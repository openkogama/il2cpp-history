    ...
    if (uVar5 != 0) {
      do {
        if (*(IDragInputReciever__Class **)(*(int *)(*(int *)RVar3 + 0x58) + (uint)uVar4 * 8) ==
          ...
          puVar6 = (undefined4 *)
                   (*(int *)RVar3 +
                   (*(int *)(*(int *)(*(int *)RVar3 + 0x58) + 4 + (uint)uVar4 * 8) + 0x18) * 8);
          goto code_?;
        }
        uVar4 = uVar4 + 1;
      } while (uVar4 < uVar5);
    ...
    if (uVar5 != 0) {
      do {
        if (*(IDragInputReciever__Class **)(*(int *)(*(int *)RVar3 + 0x58) + (uint)uVar4 * 8) ==
          ...
          puVar6 = (undefined4 *)
                   (*(int *)RVar3 +
                   (*(int *)(*(int *)(*(int *)RVar3 + 0x58) + 4 + (uint)uVar4 * 8) + 0x1a) * 8);
          goto code_?;
        }
        uVar4 = uVar4 + 1;
      } while (uVar4 < uVar5);
    ...
    if (uVar5 != 0) {
      do {
        if (*(IDragInputReciever__Class **)(*(int *)(*(int *)RVar3 + 0x58) + (uint)uVar4 * 8) ==
          ...
          puVar6 = (undefined4 *)
                   (*(int *)RVar3 +
                   (*(int *)(*(int *)(*(int *)RVar3 + 0x58) + 4 + (uint)uVar4 * 8) + 0x19) * 8);
          goto code_?;
        }
        uVar4 = uVar4 + 1;
      } while (uVar4 < uVar5);
