...

{
  ...
  pEVar1 = (EnterPlayModeButton_c *)FUN_?(TypeInfo__EnterPlayModeButton____c);
  TypeInfo__EnterPlayModeButton____c->static_fields->__9 = pEVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__EnterPlayModeButton____c->static_fields >> 0xc);
