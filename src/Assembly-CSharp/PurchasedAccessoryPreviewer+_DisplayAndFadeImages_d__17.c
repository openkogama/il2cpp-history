...
code_?:
  ...
  uVar6 = func_?();
  iVar5 = uVar6 - *extraout_ECX;
  *(char *)(iVar5 + 0x73104301) =
       *(char *)(iVar5 + 0x73104301) + (char)iVar5 + (uVar6 < *extraout_ECX);
  piVar10 = (int *)(unaff_EBX + 1 +
                  CONCAT31((int3)((uint)iVar5 >> 8),(char)iVar5 + *(char *)(unaff_EBX + 0x11)) * 2
                  );
  *piVar10 = *piVar10 + -0x333333f0;
  pcVar11 = (code *)swi(3);
  bVar12 = (*pcVar11)();
  return bVar12;
}
