...
code_?:
  ...
  uVar7 = func_?();
  *(char *)(unaff_EBX + -0x5eefbce2) =
       *(char *)(unaff_EBX + -0x5eefbce2) + extraout_DL +
       (uVar7 < 0x1da01043 || uVar7 + 0xe25fefbd < (uint)bVar2);
  *(byte *)(unaff_EBX + 0x10) = *(byte *)(unaff_EBX + 0x10) & (char)(uVar7 + 0xe25fefbd) - bVar2;
  pcVar11 = (code *)swi(3);
  bVar12 = (*pcVar11)();
  return bVar12;
}
