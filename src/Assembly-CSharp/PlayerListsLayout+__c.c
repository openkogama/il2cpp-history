...

{
  ...
  pPVar1 = (PlayerListsLayout_c *)FUN_?(TypeInfo__PlayerListsLayout____c);
  TypeInfo__PlayerListsLayout____c->static_fields->__9 = pPVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__PlayerListsLayout____c->static_fields >> 0xc);
