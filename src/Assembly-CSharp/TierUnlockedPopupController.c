...

{
  ...
  if (0 < iVar3) {
    ...
    (*(code *)(pIVar6->klass->vtable).set_color.method)
              (pIVar6,(*(float *)((int)RVar8 + 0x10) - (float)pMVar12) * fVar1 + (float)pMVar12,
               (*(float *)((int)RVar8 + 0x14) - fVar9) * fVar1 + fVar9,
               (*(float *)((int)RVar8 + 0x18) - fVar10) * fVar1 + fVar10,
               (*(float *)((int)RVar8 + 0x1c) - fVar11) * fVar1 + fVar11,
