...

{
  ...
  if (this_01 != (List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)0x0) {
    while (index < (this_01->fields)._size) {
      ...
      this_01 = (List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)
                (this->fields).nonLayoutTabButtons;
      if (*(int *)((int)RVar1 + 8) == categoryIndex) {
        if ((this_01 != (List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)0x0) &&
           (RVar1 = mscorlib.dll::System::Collections::Generic::List`1[System::Text::
                    RegularExpressions::RegexCharClass+SingleRange]::
                    List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange__get_Item
    ...
    if (this_03 != (Component *)0x0) {
      (*this_03->klass[1]._0.gc_desc)(this_03,categoryIndex,categoryName,this_03->klass[1]._0.name);
  ...
  *unaff_FS_OFFSET = (float)&fStack_3;
  ...
  if (pTStack_7 != (Text *)0x0) {
    ...
    if (this_02 != (List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)0x0) {
      while (index < (this_02->fields)._size) {
        if ((this_02 == (List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)0x0) ||
