...
{
  fVar1 = _UNK_?;
  fVar2 = (this->fields).rollTimer;
  if (_UNK_? <= fVar2) {
    pRVar3 = (this->fields).rollingDigitTransform;
    ...
    pvVar4 = (pRVar3->fields)._._._.m_CachedPtr;
    if (pvVar4 == (void *)0x0) {
      UnityEngine.CoreModule.dll::UnityEngine::Bindings::ThrowHelper::
    ...
    (*pcRam_?)(pvVar4);
    pRVar3 = (this->fields).rollingDigitTransform;
    lStack_7 = (ulonglong)(uint)(this->fields).targetPosY << 0x20;
    ...
    fVar9 = (this->fields).rollingSpeed;
    pcVar5 = pcRam_?;
    if ((pcRam_? == (code *)0x0) &&
       (pcVar5 = (code *)FUN_?(&UNK_?), pcVar5 == (code *)0x0)) {
      uVar6 = func_?(&UNK_?);
    ...
    pcRam_? = pcVar5;
    fVar10 = (float)(*pcRam_?)();
    fVar11 = (this->fields).currNumPos;
    fVar2 = fVar10 * fVar9 + fVar2;
    (this->fields).rollTimer = fVar2;
    if (fVar2 < 0.0) {
      fVar2 = 0.0;
    }
    else if (fVar1 < fVar2) {
    ...
    pRVar3 = (this->fields).rollingDigitTransform;
    (this->fields).currPos = ((this->fields).targetPosY - fVar11) * fVar2 + fVar11;
    if (pRVar3 == (RectTransform *)0x0) {
code_?:
      FUN_?();
      pcVar5 = (code *)swi(3);
    ...
    (*pcRam_?)(pvVar4);
    pRVar3 = (this->fields).rollingDigitTransform;
    lStack_7 = (ulonglong)(uint)(this->fields).currPos << 0x20;
    if (pRVar3 == (RectTransform *)0x0) {
      FUN_?();
      pcVar5 = (code *)swi(3);
      (*pcVar5)();
...

{
  ...
  if (pRVar1 != (RectTransform *)0x0) {
    ...
    fVar7 = (float)((uint)(this->fields).firstNumPosY & _UNK_?);
    (this->fields).targetNumber = value;
    (this->fields).targetPosY = (float)(value + 1) * (this->fields).digitSize - fVar7;
    return;
  }
code_?:
  FUN_?();
