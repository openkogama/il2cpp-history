...

{
  ...
  if (pMVar1 != (MVAvatarLocal *)0x0) {
    puVar2 = (undefined8 *)
             (*(pMVar1->klass->vtable).get_Position.methodPtr)
                       (aVStack_3,pMVar1,(pMVar1->klass->vtable).get_Position.method);
    uVar4 = *puVar2;
    ...
    if (pTVar8 != (Transform *)0x0) {
      ...
      pcRam_? = pcVar11;
      (*pcRam_?)(pvVar10);
      aVStack_3[0].x = (this->fields).offset.x;
      aVStack_3[0].y = (this->fields).offset.y;
      fVar12 = (float)auStack_9._4_4_ + (float)auStack_9._4_4_;
      fVar13 = (float)auStack_9._8_4_ + (float)auStack_9._8_4_;
      fVar14 = (float)auStack_9._0_4_ * ((float)auStack_9._0_4_ + (float)auStack_9._0_4_);
      fVar15 = fStack_16 * ((float)auStack_9._0_4_ + (float)auStack_9._0_4_);
      fVar17 = (this->fields).offset.z;
      uVar18._0_4_ = (_UNK_? -
                     ((float)auStack_9._8_4_ * fVar13 + (float)auStack_9._4_4_ * fVar12)) *
                     aVStack_3[0].x +
                     ((float)auStack_9._0_4_ * fVar12 - fStack_16 * fVar13) * aVStack_3[0].y +
                     (fStack_16 * fVar12 + (float)auStack_9._0_4_ * fVar13) * fVar17 + VStack_6.x;
      fVar19 = ((float)auStack_9._0_4_ * fVar13 - fStack_16 * fVar12) * aVStack_3[0].x +
               (fVar15 + (float)auStack_9._4_4_ * fVar13) * aVStack_3[0].y +
               (_UNK_? - ((float)auStack_9._4_4_ * fVar12 + fVar14)) * fVar17 + fVar5;
      if (pTVar7 != (Transform *)0x0) {
        uVar18._4_4_ = (_UNK_? - ((float)auStack_9._8_4_ * fVar13 + fVar14)) *
                       aVStack_3[0].y +
                       (fStack_16 * fVar13 + (float)auStack_9._0_4_ * fVar12) * aVStack_3[0].x +
                       ((float)auStack_9._4_4_ * fVar13 - fVar15) * fVar17 + VStack_6.y;
        ...
        pMVar1 = (this->fields).avatarLocal;
        if (((pMVar1 != (MVAvatarLocal *)0x0) &&
            (pMVar20 = (pMVar1->fields)._.SpawnRoleModeTypes, pMVar20 != (MVRuntimeDataVariable *)0x0)
          ...
          if (((ulonglong)pOVar21[1].klass & 4) == 0) {
            ...
            pcRam_? = pcVar11;
            (*pcRam_?)(pvVar10,&VStack_6);
            aVStack_3[0].x = VStack_6.x;
            aVStack_3[0].y = VStack_6.y;
            stack0xffffffffffffff30 = CONCAT44(fStack_16,fVar5);
            aVStack_3[0].z = VStack_6.z;
            auStack_9._0_8_ = uVar4;
            pVVar22 = TimeAttackFlagCountdownCamera_PositionAfterCollision
                                (&VStack_6,this,aVStack_3,(Vector3 *)auStack_9,(MethodInfo *)0x0)
            ;
            if (pTVar7 == (Transform *)0x0) {
              FUN_?();
              pcVar11 = (code *)swi(3);
            ...
            aVStack_3[0].x = pVVar22->x;
            aVStack_3[0].y = pVVar22->y;
            aVStack_3[0].z = pVVar22->z;
            if (cRam_? == '\0') {
              FUN_?(&
                            void__MethodInfo__UnityEngine__Object__MarshalledUnityObject__MarshalNotNull<UnityEngine::Transform>_UnityEngine__Transform_
                           );
