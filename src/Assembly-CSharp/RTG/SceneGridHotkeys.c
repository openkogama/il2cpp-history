...

{
  ...
  if (pHVar2 != (Hotkeys *)0x0) {
    ...
    (this->fields)._gridUp = pHVar2;
    func_?(&(this->fields)._gridUp,pHVar2);
    HVar1.CanHaveMouseButtons = 0;
    pHVar2 = (Hotkeys *)func_?(TypeInfo__RTG__Hotkeys);
    ...
    if (pHVar2 != (Hotkeys *)0x0) {
      ...
      (this->fields)._gridDown = pHVar2;
      func_?(&(this->fields)._gridDown,pHVar2);
      HVar1.CanHaveMouseButtons = 0;
      pHVar2 = (Hotkeys *)func_?(TypeInfo__RTG__Hotkeys);
      ...
      if (pHVar2 != (Hotkeys *)0x0) {
        ...
        (this->fields)._snapToCursorPickPoint = pHVar2;
        func_?(&(this->fields)._snapToCursorPickPoint,pHVar2);
