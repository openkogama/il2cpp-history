...

{
  ...
  pBVar1 = (BriefingPlayButton_c *)FUN_?(TypeInfo__BriefingPlayButton____c);
  TypeInfo__BriefingPlayButton____c->static_fields->__9 = pBVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__BriefingPlayButton____c->static_fields >> 0xc);
