...
code_?:
      ...
      cVar5 = *pcVar4;
      *pcVar4 = *pcVar4 << 1;
      *(char *)(extraout_ECX + 0x2d10475f) =
           *(char *)(extraout_ECX + 0x2d10475f) + (char)((uint)extraout_ECX >> 8) + (cVar5 < '\0');
      pSStack_6 = this;
    ...
    bVar17 = UnityEngine.CoreModule.dll::UnityEngine::GameObject::GameObject_get_activeSelf
  ...
  case 4:
    ...
    if ((pAVar18 == (AnimationCurve *)0x0) ||
       (fVar1 = UnityEngine.CoreModule.dll::UnityEngine::AnimationCurve::AnimationCurve_Evaluate
                          (pAVar18,fVar1,(MethodInfo *)0x0), unaff_EDI == (CanvasGroup *)0x0))
    goto code_?;
    UnityEngine.UIModule.dll::UnityEngine::CanvasGroup::CanvasGroup_set_alpha
              (unaff_EDI,fVar1,(MethodInfo *)0x0);
