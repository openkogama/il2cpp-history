...
code_?:
  func_?();
  lVar6 = (longlong)in_stack_7 * 0x3e556910;
  bVar8 = (int)lVar6 != lVar6;
  pbVar9 = (byte *)(extraout_ECX + 0x55);
  bVar10 = *pbVar9;
  bVar11 = (byte)((uint)extraout_ECX >> 8);
  bVar12 = *pbVar9;
  *pbVar9 = bVar12 + bVar11 + bVar8;
  *(char *)(extraout_ECX + 0x55) =
       *(char *)(extraout_ECX + 0x55) + bVar11 +
       (CARRY1(bVar10,bVar11) || CARRY1(bVar12 + bVar11,bVar8));
  pcVar13 = (code *)swi(3);
  (*pcVar13)();
  return;
}
