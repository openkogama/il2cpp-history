...

{
  ...
  if (this_00 == (Button *)0x0) {
    func_?();
    this[1].klass =
         (DesktopCubeModelingToolsController__Class *)((uint)this[1].klass ^ (uint)extraout_EDX);
    *(char *)&this->klass = *(char *)&this->klass + (char)((uint)extraout_EDX >> 8);
    *(char *)(extraout_ECX + 0x56) =
         *(char *)(extraout_ECX + 0x56) + (char)((uint)extraout_ECX >> 8) +
         (extraout_EDX < this[1].klass);
    pcVar1 = (code *)swi(3);
    (*pcVar1)(this);
    return;
  }
...

{
  ...
  if ((pCVar1 != (CubeModelingStateMachine *)0x0) &&
    ...
    if ((pBVar5 != (Button *)0x0) &&
       (unityEventBase = (InvokableCall__Class *)(pBVar5->fields).m_OnClick,
      ...
      pIVar7 = ((UnityEventBase__Fields *)&(unityEventBase->_0).name)->m_Calls;
      ...
      this = (DesktopCubeModelingToolsController *)unityEventBase;
