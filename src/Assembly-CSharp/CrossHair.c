...

{
  ...
  if (pIVar1 != (Image *)0x0) {
    ...
    puVar4 = (undefined4 *)(*(pIVar1->klass->vtable).get_color.methodPtr)(&pMStack_3,pIVar1);
    pIVar1 = (this->fields).crossHairHitEnemyIndicator;
    uStack_5 = puVar4[1];
    uStack_6 = puVar4[2];
    uStack_7 = 0;
    if (pIVar1 != (Image *)0x0) {
      pMStack_3 = (pIVar1->klass->vtable).set_color.method;
      (*(pIVar1->klass->vtable).set_color.methodPtr)(pIVar1,*puVar4,uStack_5,uStack_6,0);
...

{
  ...
  uVar5 = puVar2[2];
  uVar6 = puVar2[3];
  fVar7 = (float10)(*(pickupItem->klass->vtable).get_ChargeState.methodPtr)
  ...
  if (IStack_1.m_value == 0) {
    ...
    if ((bVar10 == 0) ||
       (bVar10 = PickupItem::PickupItem_get_IsAmmoEmpty(pickupItem,(MethodInfo *)0x0), bVar10 != 0))
    goto code_?;
code_?:
    pTVar9 = (this->fields).ammoCount;
    if (pTVar9 == (Text *)0x0) goto code_?;
    pTVar11 = pTVar9->klass;
    pMVar12 = (pTVar11->vtable).set_text.method;
    pSVar13 = StringLiteral_u221E;
  }
  else {
code_?:
    cVar14 = (*(pickupItem->klass->vtable).get_HasUnlimitedAmmo.methodPtr)
  ...
  (*(pTVar11->vtable).set_text.methodPtr)(pTVar9,pSVar13,pMVar12);
    ...
    if (bVar10 == 0) {
      ...
      if ((pTVar9 == (Text *)0x0) ||
         (pGVar15 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_gameObject
                              ((Component *)pTVar9,(MethodInfo *)0x0), pGVar15 == (GameObject *)0x0
         )) goto code_?;
  ...
  if (fVar8 <= 0.0) {
    pIVar16 = (this->fields).chargeFill;
    (this->fields).isFillOn = 1;
    if (pIVar16 == (Image *)0x0) goto code_?;
    bVar10 = UnityEngine.CoreModule.dll::UnityEngine::Behaviour::Behaviour_get_isActiveAndEnabled
    ...
    if (bVar10 != 0) {
      ...
      if ((pIVar16 == (Image *)0x0) ||
         (pGVar15 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_gameObject
                              ((Component *)pIVar16,(MethodInfo *)0x0), pGVar15 == (GameObject *)0x0)
         ) goto code_?;
      uVar4 = 0;
      uVar3 = 0;
      UnityEngine.CoreModule.dll::UnityEngine::GameObject::GameObject_SetActive
  ...
  pIVar16 = (this->fields).crossHair;
  if ((TypeInfo__UnityEngine__Object->_1).cctor_finished_or_no_cctor == 0) {
    func_?(TypeInfo__UnityEngine__Object);
  }
  bVar10 = UnityEngine.CoreModule.dll::UnityEngine::Object::Object_1_op_Inequality
                    ((Object_1 *)pIVar16,(Object_1 *)0x0,(MethodInfo *)0x0);
  if (bVar10 != 0) {
    pIVar16 = (this->fields).crossHair;
    if (pIVar16 == (Image *)0x0) goto code_?;
    (*(pIVar16->klass->vtable).set_color.methodPtr)
              (pIVar16,uVar3,uVar4,uVar5,uVar6,(pIVar16->klass->vtable).set_color.method);
  }
  if (fVar8 <= _UNK_?) {
    return;
  }
  pIVar16 = (this->fields).chargeFill;
  if (pIVar16 != (Image *)0x0) {
    UnityEngine.UI.dll::UnityEngine::UI::Image::Image_set_fillAmount(pIVar16,fVar8,(MethodInfo *)0x0)
    ;
    pIVar16 = (this->fields).chargeFill;
    if (pIVar16 != (Image *)0x0) {
      UnityEngine.CoreModule.dll::UnityEngine::Behaviour::Behaviour_set_enabled
                ((Behaviour *)pIVar16,(this->fields).isFillOn,(MethodInfo *)0x0);
      if (fVar8 < _UNK_?) {
        return;
      }
      ...
      fVar17 = UnityEngine.CoreModule.dll::UnityEngine::Time::Time_1_get_deltaTime
                         ((MethodInfo *)0x0);
      fVar17 = fVar17 + fVar8;
      pfVar18 = &(this->fields).toggleInterval;
      (this->fields).timeSinceLastToggle = fVar17;
      if (fVar17 < *pfVar18 || fVar17 == *pfVar18) {
        return;
      }
