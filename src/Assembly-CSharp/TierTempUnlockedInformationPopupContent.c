...

{
  TierUnlockedPopupContentBase::TierUnlockedPopupContentBase_Initialize
            ((TierUnlockedPopupContentBase *)this,unlockedGamePassTier & 0xff,onDisplayDoneCallback,
             (MethodInfo *)0x0);
  pSVar1 = TM::TM__((this->fields).tempUnlockInformation,(MethodInfo *)0x0);
  pTVar2 = (this->fields).tempUnlockInformationText;
  aGStackX_10[0] = unlockedGamePassTier & 0xff;
  arg0 = (Object *)FUN_?(uRam_?,aGStackX_10);
...
{
  if (cRam_? == '\0') {
    FUN_?(&StringLiteral_Game_Tier__0__is_now_available_u);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
  ...
  if (bVar1) {
    uVar2 = (uint)((ulonglong)&(this->fields).tempUnlockInformation >> 0xc);
