...
IAsyncResult *
Assembly-CSharp.dll::RTG::GizmoPostDragUpdateHandler::GizmoPostDragUpdateHandler_BeginInvoke
          (GizmoPostDragUpdateHandler *this,Gizmo *gizmo,int32_t handleId,AsyncCallback *callback,
