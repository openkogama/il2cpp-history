...

{
  ...
  if ((pTVar2 != (TabMenu *)0x0) &&
    ...
    FirstTimeGuiHandler::FirstTimeGuiHandler_OpenTab(pFVar1,pGVar3,8,(MethodInfo *)0x0);
    ...
    if ((this_00 != (InventorySlots *)0x0) &&
      ...
      if ((pTVar2 != (TabMenu *)0x0) &&
        ...
        itemSlot = FirstTimeGuiHandler::FirstTimeGuiHandler_GetItemSlot
                             (pFVar1,MVWorldObjectDocumentationType__Enum_AvatarClass,pGVar3,8,
        ...
        if ((pTVar2 != (TabMenu *)0x0) &&
          ...
          FirstTimeGuiHandler::FirstTimeGuiHandler_HighlightInCategoryAtSlot
                    (pFVar1,pGVar3,8,itemSlot,(MethodInfo *)0x0);
          return;
        }
      }
    }
...

{
  ...
  if (firstTimeState != (FirstTimeState *)0x0) {
    ...
    if (this != (FirstTimeActivatableSpawnRolesInventoryHighlight *)0x0) {
    ...
    if (pGVar2 != (GameObject *)0x0) {
      ...
      if (this_01 != (InventorySlots *)0x0) {
        ...
        if (this_03 != (Transform *)0x0) {
          ...
          return (bVar5 ^ 1) & bVar6 & (this->fields).insideInventory & bVar1;
        }
      }
    }
  }
