...

{
  ...
  pPVar1 = (PlayerInventoryController_c *)FUN_?(TypeInfo__PlayerInventoryController____c);
  TypeInfo__PlayerInventoryController____c->static_fields->__9 = pPVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__PlayerInventoryController____c->static_fields >> 0xc);
