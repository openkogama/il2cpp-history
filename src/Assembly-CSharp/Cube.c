...

{
  ...
  case Face__Enum_Left:
    ...
    __return_storage_ptr__->y = (float)(int)(uVar3 >> 0x20);
    __return_storage_ptr__->z = 0.0;
    return __return_storage_ptr__;
  case Face__Enum_Right:
    uVar3 = (ulonglong)_UNK_?;
  ...
  *(undefined1 *)(unaff_EDI + 1) = *(undefined1 *)&this->klass;
  cRam_? = cRam_? + (char)((uint)extraout_ECX >> 8) +
                 ((int)((ulonglong)uVar4 *
                        (ulonglong)*(uint *)(extraout_ECX + 0x69a51210 + (int)&stack0xfffffffc * 2)
                       >> 0x20) != 0);
  *(undefined4 *)((int)unaff_EDI + 5) = *(undefined4 *)((int)&this->klass + 1);
  ...
  iVar5 = (int)(short)((uint)unaff_retaddr >> 0x10);
  if ((TypeInfo__Cube->_1).cctor_finished_or_no_cctor == 0) {
    func_?(TypeInfo__Cube);
  }
  pVVar6 = Cube_GetEdge(in_stack_7,(Face__Enum)uVar1,(Edge__Enum)((ulonglong)uVar1 >> 0x20)
                        ,(MethodInfo *)0x0);
  if ((this_00 != (GameObject *)0x0) &&
     (pTVar8 = UnityEngine.CoreModule.dll::UnityEngine::GameObject::GameObject_get_transform
                         (this_00,(MethodInfo *)0x0), pVVar6 != (Vector3__Array *)0x0)) {
    if (pVVar6->max_length == 0) goto code_?;
    uVar9 = pVVar6->vector[0].x;
    uVar10 = pVVar6->vector[0].y;
    if (pTVar8 != (Transform *)0x0) {
      position.y = (float)uVar10 + (float)iVar5;
      position.x = (float)uVar9 + (float)(int)(short)unaff_retaddr;
      position.z = pVVar6->vector[0].z + (float)(int)(short)__return_storage_ptr__;
      pVVar11 = UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_TransformPoint
                         ((Vector3 *)&stack0xffffffdc,pTVar8,position,(MethodInfo *)0x0);
      fVar12 = pVVar11->y;
      fVar13 = pVVar11->z;
      if (pVVar6->max_length == 0) goto code_?;
      iVar14 = 0;
      pVVar6->vector[0].x = pVVar11->x;
      pVVar6->vector[0].y = fVar12;
      pVVar6->vector[0].z = fVar13;
      pTVar8 = UnityEngine.CoreModule.dll::UnityEngine::GameObject::GameObject_get_transform
                         (this_00,(MethodInfo *)0x0);
      if (*(uint *)(iVar14 + 0xc) < 2) goto code_?;
      fVar12 = (float)*(undefined8 *)(iVar14 + 0x1c) + (float)(int)(short)unaff_retaddr;
      fVar13 = (float)((ulonglong)*(undefined8 *)(iVar14 + 0x1c) >> 0x20) + (float)iVar5;
      if (pTVar8 != (Transform *)0x0) {
        uVar1 = CONCAT44(fVar13,fVar12);
        position_00.z = *(float *)(iVar14 + 0x24) + (float)(int)(short)__return_storage_ptr__;
        position_00.x = fVar12;
        position_00.y = fVar13;
        pVVar11 = UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_TransformPoint
                           ((Vector3 *)&stack0xffffffdc,pTVar8,position_00,(MethodInfo *)0x0);
        fVar12 = pVVar11->y;
        fVar13 = pVVar11->z;
        pVVar15 = (Vector3 *)((ulonglong)uVar1 >> 0x20);
        if (1 < (uint)pVVar15[1].x) {
          pVVar15[2].y = pVVar11->x;
          pVVar15[2].z = fVar12;
          pVVar15[3].x = fVar13;
          return pVVar15;
        }
...
code_?:
  ...
  *(char *)pfVar9 =
       *(char *)pfVar9 + (char)((uint6)uVar6 >> 0x28) +
       (CARRY1(extraout_CL,bVar8) || CARRY1(extraout_CL + bVar8,bVar5));
