...

{
  ...
  if (pMVar4 != (MVPickupOwner *)0x0) {
    ...
    bVar21 = CollisionDetection::CollisionDetection_MVHit_1
                       (ray,(VoxelHit *)auStack_22,(float)pMStack_19,
    ...
    if (pMVar4 != (MVPickupOwner *)0x0) {
      if ((pMVar4->fields)._IsLocal_k__BackingField != 0) {
        ...
        pIStack_24 = (IBulletImpactVisualizer__Class *)
                    CollisionDetection::CollisionDetection_MVSphereCastAll
                              (ray_00,(float)pIStack_24,(float)pMStack_19,ignoreWoIds,
                               1 << ((byte)iVar20 & 0x1f),(MethodInfo *)0x0);
        this_01.First = 0;
        this_01.Last = 0;
        if (pIStack_24 == (IBulletImpactVisualizer__Class *)0x0) goto code_?;
        for (; (int)this_01 < (int)(pIStack_24->_0).namespaze;
          ...
          pMVar37 = MVWorldObjectClientManager::MVWorldObjectClientManager_GetWorldObject
                              (pMStack_19,(int32_t)pGStack_29,(MethodInfo *)0x0);
        ...
        for (; (int)pMStack_19 < (this_02->fields)._size;
          ...
          if (bVar21 != 0) {
            ...
            if ((pMVar38 == (MVNetworkGame *)0x0) ||
               (this_03 = MVNetworkGame::MVNetworkGame_get_LocalPlayer(pMVar38,(MethodInfo *)0x0),
            ...
            if (bVar21 == 0) {
              ...
              pIVar42 = ImpulseHitPackage::ImpulseHitPackage_Create
              ...
              if (iVar48 != 0) {
                ...
                if ((pMVar49 == (MVPickupOwner *)0x0) ||
                   (pMVar50 = (pMVar49->fields)._.worldObjectParent,
                   pMVar50 == (MVWorldObjectClient *)0x0)) goto code_?;
                ...
                iVar48 = func_?(this_01,TypeInfo__IBulletImpactVisualizer);
                if (iVar48 == 0) goto code_?;
                func_?(0,TypeInfo__IBulletImpactVisualizer,iVar48,pIVar47,pMVar4,fVar6,
                                fVar43,fVar44,fVar45,uVar46,0,uStack_51,uStack_52,uStack_53,uStack_54
                                ,uStack_55,uStack_56,uStack_57,uStack_58,uStack_59,uStack_60,
                                (float)uStack_9,uStack_9._4_4_,fStack_10,fStack_2,
                                CONCAT44(fStack_1,fStack_3),pMStack_41,0);
              }
            }
          }
        }
        pMVar4 = (this->fields)._.owner;
        if ((pMVar4 == (MVPickupOwner *)0x0) ||
           (pTVar61 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_transform
                                ((Component *)pMVar4,(MethodInfo *)0x0),
           pTVar61 == (Transform *)0x0)) goto code_?;
        pVVar7 = UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_get_position
                            (&VStack_14,pTVar61,(MethodInfo *)0x0);
        VStack_8.x = pVVar7->x;
        VStack_8.y = pVVar7->y;
        VStack_8.z = pVVar7->z;
        if (cRam_? == '\0') {
        ...
        VStack_8.z = VStack_8.z + fStack_40 * _UNK_?;
        fVar63 = (float10)func_?((int)uStack_5,(int)((ulonglong)uStack_5 >> 0x20),
                                          pGStack_23,
                                          VStack_8.x + (float)(undefined4)uStack_39 * _UNK_?
                                         );
        if ((float)fVar63 < _UNK_?) {
          fVar6 = (float)fVar63 * _UNK_?;
          if (fVar6 <= _UNK_?) {
            fVar6 = _UNK_?;
          }
          ...
          if (_UNK_? < impulseMagnitude) {
            pMVar38 = MVGameControllerBase::MVGameControllerBase_get_Game((MethodInfo *)0x0);
            if ((pMVar38 == (MVNetworkGame *)0x0) ||
               (pWVar64 = (pMVar38->fields).worldNetwork, pWVar64 == (WorldNetwork *)0x0))
            goto code_?;
      ...
      if (((pPVar65 != (PrefabPool *)0x0) &&
          (this_00 = (pPVar65->fields).enumPoolManager, this_00 != (EnumPoolManager *)0x0)) &&
         (this_01 = (RegexCharClass_SingleRange)
        ...
        if ((pTVar61 != (Transform *)0x0) &&
           (pVVar7 = UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_get_position
                                (&VStack_14,pTVar61,(MethodInfo *)0x0), this_05 != (Transform *)0x0)
           ) {
