...

{
  ...
  if (IStack_1.m_value == 0) {
    ...
    if ((bVar10 == 0) ||
       (pSVar11 = System.Core.dll::System::Linq::Expressions::LambdaExpression::
                 LambdaExpression_get_Name((LambdaExpression *)pickupItem,(MethodInfo *)0x0),
       (char)pSVar11 != '\0')) goto code_?;
code_?:
    pTVar9 = (this->fields).ammoCount;
    if (pTVar9 == (Text *)0x0) goto code_?;
    pTVar12 = pTVar9->klass;
    pIVar13 = (pTVar12->vtable).CalculateLayoutInputHorizontal_1.methodPtr;
    pSVar11 = StringLiteral_u221E;
  }
  else {
code_?:
    ...
    pTVar9 = (this->fields).ammoCount;
    pSVar11 = mscorlib.dll::System::Int32::Int32_ToString(&IStack_1,(MethodInfo *)0x0);
    if (pTVar9 == (Text *)0x0) goto code_?;
    pTVar12 = pTVar9->klass;
    pIVar13 = (pTVar12->vtable).CalculateLayoutInputHorizontal_1.methodPtr;
  }
  (*(code *)(pTVar12->vtable).set_text.method)(pTVar9,pSVar11,pIVar13);
  ...
  if (bVar10 != 0) {
    pIVar16 = (this->fields).crossHair;
    if (pIVar16 == (Image *)0x0) goto code_?;
    (*(code *)(pIVar16->klass->vtable).set_color.method)
              (pIVar16,uVar3,uVar4,uVar5,uVar6,(pIVar16->klass->vtable).get_raycastTarget.methodPtr
              );
  }
  if (fVar8 <= _UNK_?) {
    return;
