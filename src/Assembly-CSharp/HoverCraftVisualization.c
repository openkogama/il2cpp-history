...

{
  ...
  if (pTVar5 != (Transform *)0x0) {
    ...
    fVar2 = _UNK_?;
    fVar3 = (this->fields).rollSpeed * fVar3;
    if (fVar3 < 0.0) {
      fVar3 = 0.0;
    }
    else if (_UNK_? < fVar3) {
...

{
  ...
  if (pTVar1 != (Transform *)0x0) {
    ...
    fStack_12 = (this->fields).signedAcceleration * fStack_12;
    ...
    fStack_14 = UnityEngine.CoreModule.dll::UnityEngine::Time::Time_1_get_deltaTime
                          ((MethodInfo *)0x0);
    fVar3 = (this->fields).pitchSpeedTime * fStack_14;
    if (fVar3 < 0.0) {
      fVar3 = 0.0;
    }
    else if (_UNK_? < fVar3) {
...
code_?:
  ...
  if (pPVar2 != (ParticleSystem *)0x0) {
    ...
    if (pPVar2 != (ParticleSystem *)0x0) {
      ...
      UnityEngine.ParticleSystemModule.dll::UnityEngine::ParticleSystem+MainModule::
      ParticleSystem_MainModule_set_startSizeMultiplier_Injected
                ((ParticleSystem_MainModule *)&stack0xffffffec,_UNK_? * 3.4842083e-29,
                 (MethodInfo *)0x0);
      return;
    }
  }
