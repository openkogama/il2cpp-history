...
IAsyncResult *
Assembly-CSharp.dll::RTG::GizmoPostDragEndHandler::GizmoPostDragEndHandler_BeginInvoke
          (GizmoPostDragEndHandler *this,Gizmo *gizmo,int32_t handleId,AsyncCallback *callback,
