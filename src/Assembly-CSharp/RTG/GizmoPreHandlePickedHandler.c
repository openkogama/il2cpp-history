...
IAsyncResult *
Assembly-CSharp.dll::RTG::GizmoPreHandlePickedHandler::GizmoPreHandlePickedHandler_BeginInvoke
          (GizmoPreHandlePickedHandler *this,Gizmo *gizmo,int32_t handleId,AsyncCallback *callback,
