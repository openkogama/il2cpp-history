...

{
  ...
  pTVar1 = (TouristPromotion_c *)FUN_?(TypeInfo__TouristPromotion____c);
  TypeInfo__TouristPromotion____c->static_fields->__9 = pTVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__TouristPromotion____c->static_fields >> 0xc);
