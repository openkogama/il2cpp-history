...
void Assembly-CSharp.dll::TouristAdController+<>c__DisplayClass16_1::
     TouristAdController_c_DisplayClass16_1__ShowPromotion_b__1
               (TouristAdController_c_DisplayClass16_1 *this,IUIStack *x,BaseEventData *_,
               MethodInfo *method)
