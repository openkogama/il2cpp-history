...

{
  ...
  if (len < 0x10) {
    ...
    uStack_5 = seed + 0x85ebca77;
    uStack_6 = seed + 0x61c8864f;
    uVar7 = 0;
    ...
    do {
      ...
      uVar9 = uStack_5 >> 0x13 | uStack_5 * 0x2000;
      uStack_5 = uVar9 * -0x61c8864f;
      ...
      uStack_6 = uStack_6 +
                  CONCAT31(CONCAT21(CONCAT11(buf->vector[uVar7 + 0xf],buf->vector[uVar7 + 0xe]),
                                    buf->vector[uVar7 + 0xd]),buf->vector[uVar7 + 0xc]) *
                  -0x7a143589;
      uVar11 = uStack_6 >> 0x13 | uStack_6 * 0x2000;
      uStack_6 = uVar11 * -0x61c8864f;
      uVar7 = uVar1;
    } while ((int)uVar1 <= len + -0x10);
    iVar2 = (uStack_6 >> 0xe | uVar11 * -0x193c0000) + (uStack_3 >> 0x14 | uVar10 * 0x779b1000) +
            (uStack_5 >> 0x19 | uVar9 * 0x1bbcd880) + (uStack_4 >> 0x1f | uVar8 * 0x3c6ef362);
  }
  uVar7 = iVar2 + len;
  if ((int)uVar1 <= len + -4) {
    uVar8 = uVar1;
    if (buf == (Byte__Array *)0x0) goto code_?;
    do {
      if (((buf->max_length <= uVar8) || (buf->max_length <= uVar8 + 1)) ||
         ((buf->max_length <= uVar8 + 2 || (uVar1 = uVar8 + 4, buf->max_length <= uVar8 + 3))))
      goto code_?;
      uVar7 = uVar7 + CONCAT31(CONCAT21(CONCAT11(buf->vector[uVar8 + 3],buf->vector[uVar8 + 2]),
                                        buf->vector[uVar8 + 1]),buf->vector[uVar8]) * -0x3d4d51c3;
