...

{
  ...
  pAVar1 = (AvatarShopController_c *)FUN_?(TypeInfo__AvatarShopController____c);
  TypeInfo__AvatarShopController____c->static_fields->__9 = pAVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__AvatarShopController____c->static_fields >> 0xc);
