...
code_?:
  ...
  bVar15 = *(byte *)&this->klass < bVar14;
  *(byte *)&this->klass = *(char *)&this->klass - bVar14;
  bVar16 = CARRY1(*pbVar13,extraout_CH) || CARRY1(*pbVar13 + extraout_CH,bVar15);
  *pbVar13 = *pbVar13 + extraout_CH + bVar15;
  pbVar17 = (byte *)(unaff_EBX + 0x1f);
  bVar14 = (byte)pbVar13;
  bVar15 = CARRY1(*pbVar17,bVar14) || CARRY1(*pbVar17 + bVar14,bVar16);
  *pbVar17 = *pbVar17 + bVar14 + bVar16;
  pbVar17 = (byte *)(unaff_EBX + 0x1f);
  bVar16 = CARRY1(*pbVar17,bVar14) || CARRY1(*pbVar17 + bVar14,bVar15);
  *pbVar17 = *pbVar17 + bVar14 + bVar15;
  pbVar17 = pbVar13 + 0x1f;
  bVar14 = *pbVar17;
  bVar18 = *pbVar17;
  *pbVar17 = bVar18 + extraout_CH + bVar16;
  pbVar13[0x1f] =
       pbVar13[0x1f] + extraout_CH +
       (CARRY1(bVar14,extraout_CH) || CARRY1(bVar18 + extraout_CH,bVar16));
  pcVar19 = (code *)swi(3);
  (*pcVar19)();
  return;
}
