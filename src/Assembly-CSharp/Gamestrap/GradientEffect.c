    ...
    if (3 < (int)pOVar4) {
      ...
      if (pOVar4 == (Object *)0x6) {
        ...
        while( true ) {
          ...
          fVar30 = pCVar27->b;
          fVar31 = pCVar27->a;
          in_stack_28 = (MethodInfo *)(pGVar1->fields).top.b;
          pCVar27 = UnityEngine.CoreModule.dll::UnityEngine::Color::Color_Lerp
                              ((Color *)&stack0xffffff28,(pGVar1->fields).top,
                               (pGVar1->fields).bottom,(fVar9 - fVar6) / (fVar7 - fVar6),
                               (MethodInfo *)0x0);
          a.g = fVar29;
          a.r = (float)method_00;
          a.b = fVar30;
          ...
          this = (GradientEffect *)((int)&this->klass + 1);
        }
      }
    }
  }
