...
/* KogamaSettingWrapperBase(String, KogamaSettingsCollectionBase) */
...
void MVWorldObject.dll::MV::WorldObject::KogamaSettings::KogamaSettingsCore::KogamaSettingTypes::
     KogamaSettingWrapperBase::KogamaSettingWrapperBase__ctor
               (KogamaSettingWrapperBase *this,String *key,KogamaSettingsCollectionBase *parent,
               MethodInfo *method)

{
  iVar1 = iRam_?;
  (this->fields)._Parent_k__BackingField = parent;
  if (iVar1 != 0) {
