...

{
  ...
  if (pPVar2 != (ParticleSystem *)0x0) {
    ...
    pPVar2 = (pAVar1->fields).xpParticleSystem;
    if (pPVar2 != (ParticleSystem *)0x0) {
      this = (AvatarPooledXPParticles *)
             UnityEngine.ParticleSystemModule.dll::UnityEngine::ParticleSystem::
             ParticleSystem_get_collision(pPVar2,(MethodInfo *)0x0);
      pPVar3 = UnityEngine.ParticleSystemModule.dll::UnityEngine::ParticleSystem+EmissionModule::
      ...
      pTStack_4 = (ThemeAttribute_1_System_Single___Class *)pPVar3->m_Mode;
      uVar5 = pPVar3->m_CurveMin;
      uVar6 = pPVar3->m_CurveMax;
      uVar7 = pPVar3->m_ConstantMin;
      uVar8 = pPVar3->m_ConstantMax;
      ...
      if (pPVar2 != (ParticleSystem *)0x0) {
        ...
        ThemeAttributes::ThemeAttribute`1[System::Single]::ThemeAttribute_1_System_Single__get_Value
                  ((ThemeAttribute_1_System_Single_ *)&pTStack_4,(MethodInfo *)0x0);
        auVar10._12_8_ = 0;
