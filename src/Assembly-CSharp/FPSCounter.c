...

{
  ...
  fVar4 = (float)(*pcRam_?)();
  fVar4 = fVar4 + fVar1;
  pfVar5 = &(this->fields).frameUpdateRate;
  (this->fields).currTime = fVar4;
  if (fVar4 < *pfVar5 || fVar4 == *pfVar5) {
    return;
  }
  pTVar6 = (this->fields).fpsText;
  if (cRam_? == '\0') {
  ...
  pSVar7 = StringLiteral_F0;
  pFVar8 = TypeInfo__FpsCounter->static_fields->instance;
  if (pFVar8 != (FpsCounter *)0x0) {
    fVar1 = (pFVar8->fields).fps;
    if (cRam_? == '\0') {
      FUN_?();
      LOCK();
      UNLOCK();
    ...
    pSVar7 = mscorlib.dll::System::Number::Number_FormatSingle(fVar1,pSVar7,info,(MethodInfo *)0x0);
    if (pTVar6 != (Text *)0x0) {
