...

{
  ...
  pcRam_? = pcVar2;
  fVar4 = (float)(*pcVar1)();
  pSVar5 = (this->fields).scrollRect;
  (this->fields).dragStart = fVar4;
  ...
  (*(pSVar5->klass->vtable).OnBeginDrag_1.methodPtr)
            (pSVar5,eventData,(pSVar5->klass->vtable).OnBeginDrag_1.method);
  return;
}
...

{
  ...
  if (pSVar1 != (ScrollRect *)0x0) {
                    /* WARNING: Could not recover jumptable at 0xADDR. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(pSVar1->klass->vtable).OnDrag_1.methodPtr)
              (pSVar1,eventData,(pSVar1->klass->vtable).OnDrag_1.method);
    return;
  }
  FUN_?();
  pcVar2 = (code *)swi(3);
...

{
  ...
  pcRam_? = pcVar2;
  fVar4 = (float)(*pcVar1)();
  if ((fVar4 - (this->fields).dragStart < _UNK_?) &&
     (pUVar5 = (this->fields).OnClick, pUVar5 != (UnityAction *)0x0)) {
  ...
  if (pSVar6 == (ScrollRect *)0x0) {
    ...
    return;
                    ...
                    /* WARNING: Could not recover jumptable at 0xADDR. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(pSVar6->klass->vtable).OnEndDrag_1.methodPtr)
            (pSVar6,eventData,(pSVar6->klass->vtable).OnEndDrag_1.method);
  return;
}
