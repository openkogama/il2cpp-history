...

{
  ...
  pSVar3 = (SubscribableVariable_1_System_Int32Enum_ *)FUN_?(pvVar2);
  bVar4 = iRam_? != 0;
  ...
  do {
    ...
    if (pDVar12 == (Delegate *)0x0) {
      ...
      pAVar13 = (Action_1_Int32Enum_ *)FUN_?(pDVar12,pvVar2);
