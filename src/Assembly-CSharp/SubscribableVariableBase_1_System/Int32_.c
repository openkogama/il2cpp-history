...

{
  ...
  if (other != (SubscribableVariableBase_1_System_Int32_ *)0x0) {
    ...
    bVar3 = mscorlib.dll::System::Int32::Int32_Equals
                      ((Int32 *)this_00,obj,pMVar1->klass->rgctx_data[8].method);
    return bVar3;
  }
  func_?();
  pcVar4 = (code *)swi(3);
...

{
  ...
  if (a != (SubscribableVariableBase_1_System_Int32_ *)0x0) {
    ...
    bVar4 = mscorlib.dll::System::Int32::Int32_Equals((Int32 *)&b,obj,pIVar2->rgctx_data[8].method);
    return bVar4;
  }
  func_?();
  pcVar5 = (code *)swi(3);
  ...
  if (a != (SubscribableVariableBase_1_System_Int32_ *)0x0) {
    ...
    if (b != (SubscribableVariableBase_1_System_Int32_ *)0x0) {
      ...
      bVar4 = mscorlib.dll::System::Int32::Int32_Equals
                        ((Int32 *)this,obj,pIVar2->rgctx_data[8].method);
      return bVar4;
    }
  }
  func_?();
