...
code_?:
  ...
  sVar13 = ((ushort)team & 3) - (*(ushort *)&team->klass & 3);
  *(ushort *)&team->klass = *(short *)&team->klass + (ushort)(0 < sVar13) * sVar13;
  *extraout_EDX = *extraout_EDX + (char)extraout_EDX + cVar7;
  in_AF = 9 < (bVar12 & 0xf) | in_AF;
  bVar12 = bVar12 + in_AF * -6 & 0xf;
  *extraout_EDX = *extraout_EDX + extraout_CH + in_AF;
  in_AF = 9 < bVar12 | in_AF;
  extraout_EDX[100] = extraout_EDX[100] + (bVar12 + in_AF * -6 & 0xf) + in_AF;
  pcVar14 = (code *)swi(3);
  (*pcVar14)();
  return;
}
