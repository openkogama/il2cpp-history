...
/* UnlockMaterialException() */

void Assembly-CSharp.dll::UnityEngine::EventSystems::EditorStateMachine::CubeModelingStateMachine::
     UnlockMaterialException::UnlockMaterialException__ctor
               (UnlockMaterialException *this,MethodInfo *method)
