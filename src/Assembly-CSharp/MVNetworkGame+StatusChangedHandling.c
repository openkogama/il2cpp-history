...
code_?:
  bVar7 = 0;
  func_?();
  pbVar8 = (byte *)((int)&(((Dictionary_2_System_Byte_System_Object_ *)(returnCode + -0x30))->fields
                          )._comparer + 2);
  bVar9 = *pbVar8;
  bVar10 = *pbVar8;
  *pbVar8 = bVar10 + unaff_BL + bVar7;
  *(char *)(extraout_EDX + -0x25efac0d) =
       *(char *)(extraout_EDX + -0x25efac0d) + (char)extraout_EDX +
