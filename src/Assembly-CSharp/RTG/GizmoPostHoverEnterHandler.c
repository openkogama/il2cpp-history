...
IAsyncResult *
Assembly-CSharp.dll::RTG::GizmoPostHoverEnterHandler::GizmoPostHoverEnterHandler_BeginInvoke
          (GizmoPostHoverEnterHandler *this,Gizmo *gizmo,int32_t handleId,AsyncCallback *callback,
