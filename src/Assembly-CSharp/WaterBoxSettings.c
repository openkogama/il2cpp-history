...

{
  if (cRam_? == '\0') {
    ...
    LOCK();
    UNLOCK();
    FUN_?(&FBFE4CA61EC299680879894A16CA776F81F23454312659AC8736249AA1E9722B_Field);
    LOCK();
    UNLOCK();
  ...
  if (this_00 != (SettingsBase *)0x0) {
    ...
    if (woID == -1) {
      ...
      if (this_03 ==
           ...
           *)0x0) goto code_?;
      uVar2 = CONCAT71((int7)(uVar2 >> 8),2);
      mscorlib.dll::System::Collections::Generic::Dictionary`2[System::Object,System::Object]::
      Dictionary_2_System_Object_System_Object__TryInsert
                ((Dictionary_2_System_Object_System_Object_ *)this_03,
                 (Object *)StringLiteral_waterColor,(Object *)array,(InsertionBehavior__Enum)uVar2,
                 MethodInfo__System__Collections__Generic__Dictionary<System::Object,_System::Object>__Add_System__Object__System__Object_
      ...
      if (*(int *)(lRam_? + 0x28) < 0) {
        if ((*(longlong *)(lRam_? + 0x60) == 0) ||
           (pOVar4 = pOVar1, (*(byte *)(lRam_? + 0x135) & 8) == 0)) {
          pOVar4 = (Object *)FUN_?(lRam_?);
          FUN_?(pOVar4 + 1,&uStackX_10,(longlong)*(int *)(lVar3 + 0xf8) + -0x10);
          if (iRam_? != 0) {
            uVar5 = (uint)((ulonglong)(pOVar4 + 1) >> 0xc);
            uVar6 = (ulonglong)((uVar5 & 0x1fffff) >> 6);
            uVar2 = (ulonglong)(uVar5 & 0x3f);
            do {
        ...
        pOVar4 = (Object *)((ulonglong)uStackX_11 << 8);
      }
      uVar2 = CONCAT71((int7)(uVar2 >> 8),2);
      mscorlib.dll::System::Collections::Generic::Dictionary`2[System::Object,System::Object]::
      Dictionary_2_System_Object_System_Object__TryInsert
      ...
      if (((this_02 == (MVWorldObjectClientManager *)0x0) ||
          (pMVar10 = MVWorldObjectClientManager::MVWorldObjectClientManager_GetWorldObjectClient
                              (this_02,woID,(MethodInfo *)0x0), pMVar10 == (MVWorldObjectClient *)0x0
          )) || (this_03 = (Dictionary_2_System_Object_UnityEngine_UIElements_UIR_UIRenderDevice_DisableForceGammaMaterial_
    ...
    if (pOVar4 == (Object *)0x0) {
      ...
      pSVar12 = (Single__Array *)FUN_?(pOVar4,TypeInfo__System__Single);
      ...
      (this->fields).color = pSVar12;
      pSVar11 = TypeInfo__System__Single;
      lVar3 = FUN_?(pOVar4,TypeInfo__System__Single);
      if (lVar3 == 0) {
        FUN_?(pOVar4,pSVar11);
        pcVar13 = (code *)swi(3);
        (*pcVar13)();
    ...
    if (iRam_? != 0) {
      uVar5 = (uint)((ulonglong)&(this->fields).color >> 0xc);
      uVar6 = (ulonglong)((uVar5 & 0x1fffff) >> 6);
      do {
        uVar7 = *(ulonglong *)(uVar6 * 8 + 0xADDR);
        puVar8 = (ulonglong *)(uVar6 * 8 + 0xADDR);
    ...
    maxValue = _UNK_?;
    pSVar12 = (this->fields).color;
    pSVar14 = (this->fields).colorR;
    if (pSVar12 != (Single__Array *)0x0) {
      if ((int)pSVar12->max_length == 0) goto code_?;
      if (pSVar14 != (SettingsSlider *)0x0) {
        SettingsSlider::SettingsSlider_Initialize
                  (pSVar14,StringLiteral_colorR,pSVar12->vector[0],0.0,_UNK_?,
                   (MethodInfo *)0x0);
        pSVar12 = (this->fields).color;
        pSVar14 = (this->fields).colorG;
        if (pSVar12 != (Single__Array *)0x0) {
          if ((uint)pSVar12->max_length < 2) goto code_?;
          if (pSVar14 != (SettingsSlider *)0x0) {
            SettingsSlider::SettingsSlider_Initialize
                      (pSVar14,StringLiteral_colorG,pSVar12->vector[1],0.0,maxValue,(MethodInfo *)0x0
                      );
            pSVar12 = (this->fields).color;
            pSVar14 = (this->fields).colorB;
            if (pSVar12 != (Single__Array *)0x0) {
              if ((uint)pSVar12->max_length < 3) goto code_?;
              if (pSVar14 != (SettingsSlider *)0x0) {
                SettingsSlider::SettingsSlider_Initialize
                          (pSVar14,StringLiteral_colorB,pSVar12->vector[2],0.0,maxValue,
                           (MethodInfo *)0x0);
                ...
                if (iVar15 < 0) {
                  ...
                  Object]::Dictionary_2_System_Object_System_Object__TryInsert
                            ((Dictionary_2_System_Object_System_Object_ *)this_03,
                             (Object *)StringLiteral_lethal,pOVar1,
                             (InsertionBehavior__Enum)CONCAT71((int7)(uVar2 >> 8),1),
                             MethodInfo__System__Collections__Generic__Dictionary<System::Object,_System::Object>__set_Item_System__Object__System__Object_
                             ->klass->rgctx_data[0x22].method);
                }
                ...
                if ((this_01 != (SettingsToggle *)0x0) && (pOVar1 != (Object *)0x0)) {
                  ...
                  SettingsToggle::SettingsToggle_Initialize
                            (this_01,StringLiteral_lethal,*(bool *)&pOVar1[1].klass,
                             (MethodInfo *)0x0);
                  pSVar12 = (this->fields).color;
                  pIVar16 = (this->fields).preview;
                  if (pSVar12 != (Single__Array *)0x0) {
                    if (((int)pSVar12->max_length == 0) ||
                       (fStack_17 = pSVar12->vector[0], (uint)pSVar12->max_length < 2)) {
code_?:
                      FUN_?();
                      pcVar13 = (code *)swi(3);
                      (*pcVar13)();
                    ...
                    fStack_18 = pSVar12->vector[1];
                    if (pSVar12 != (Single__Array *)0x0) {
                      if ((uint)pSVar12->max_length < 3) goto code_?;
                      fStack_19 = pSVar12->vector[2];
                      if (pIVar16 != (Image *)0x0) {
                        uStack_20 = 0x3f800000;
                        (*(pIVar16->klass->vtable).set_color.methodPtr)
                                  (pIVar16,&fStack_17,(pIVar16->klass->vtable).set_color.method);
                        return;
                      }
                    }
                  }
...
code_?:
  ...
  if (cRam_? == '\0') {
    FUN_?(&StringLiteral_waterColor,0);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
  ...
  if (pSVar4 != (SettingsBase *)0x0) {
    SettingsBase::SettingsBase_OnSettingChanged
              (pSVar4,StringLiteral_waterColor,(Object *)(this->fields).color,(MethodInfo *)0x0);
    pSVar2 = (this->fields).color;
