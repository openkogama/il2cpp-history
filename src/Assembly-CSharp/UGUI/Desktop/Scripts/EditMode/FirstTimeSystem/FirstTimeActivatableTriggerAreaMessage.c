...
void Assembly-CSharp.dll::UGUI::Desktop::Scripts::EditMode::FirstTimeSystem::
     FirstTimeActivatableTriggerAreaMessage::FirstTimeActivatableTriggerAreaMessage_Register
               (FirstTimeActivatableTriggerAreaMessage *this,MethodInfo *method)

{
  if (cRam_? == '\0') {
    ...
    func_?(&
                    MethodInfo__UGUI__Desktop__Scripts__EditMode__FirstTimeSystem__FirstTimeActivatableTriggerAreaMessage___Register_b__4_0_UnityEngine__EventSystems__IFirstTimeElementActivator__UnityEngine__EventSystems__BaseEventData_
                   );
    cRam_? = '\x01';
  }
...
void Assembly-CSharp.dll::UGUI::Desktop::Scripts::EditMode::FirstTimeSystem::
     FirstTimeActivatableTriggerAreaMessage::FirstTimeActivatableTriggerAreaMessage__Register_b__4_0
               (FirstTimeActivatableTriggerAreaMessage *this,IFirstTimeElementActivator *x,
               BaseEventData *y,MethodInfo *method)

{
  if (cRam_? == '\0') {
    pFStack_1 = (FirstTimeActivatableTriggerAreaMessage *)
  ...
  pFStack_1 = (FirstTimeActivatableTriggerAreaMessage *)&stack0xfffffffc;
...
/* FirstTimeActivatableTriggerAreaMessage() */

void Assembly-CSharp.dll::UGUI::Desktop::Scripts::EditMode::FirstTimeSystem::
     FirstTimeActivatableTriggerAreaMessage::FirstTimeActivatableTriggerAreaMessage__ctor
               (FirstTimeActivatableTriggerAreaMessage *this,MethodInfo *method)
...
bool Assembly-CSharp.dll::UGUI::Desktop::Scripts::EditMode::FirstTimeSystem::
     FirstTimeActivatableTriggerAreaMessage::FirstTimeActivatableTriggerAreaMessage_get_CanShow
               (FirstTimeActivatableTriggerAreaMessage *this,MethodInfo *method)
