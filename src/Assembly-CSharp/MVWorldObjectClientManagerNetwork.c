  ...
  if (pDVar6 != (Dictionary_2_UnityEngine_UIElements_StyleSheets_StyleSheetCache_SheetHandleKey_System_Object_
    ...
    if (this_00 !=
      ...
      while( true ) {
        ...
        (*(code *)(DStack_9._currentValue)->klass[2].vtable.Equals.method)
                  (DStack_9._currentValue,
                   (DStack_9._currentValue)->klass[2].vtable.Finalize.methodPtr);
      }
      uStack_1 = 0xffffffff;
...
code_?:
    ...
    pMVar4 = (MVAvatar__Class *)(((MVVehicleBase__Class *)worldObjectID)->_0).image;
    bVar3 = (TypeInfo__MVAvatar->_1).naturalAligment;
    if (((bVar3 <= (pMVar4->_1).naturalAligment) &&
        ((MVAvatar__Class *)(pMVar4->_1).typeHierarchy[bVar3 - 1] == TypeInfo__MVAvatar)) &&
    ...
    if (method_00 != (MethodInfo *)0x0) {
      ...
      while( true ) {
        ...
        if ((DStack_10._currentValue[5].klass == (Object__Class *)profileID) &&
          ...
          func_?(0x31,DStack_10._currentValue);
          iVar6 = iVar6 + 1;
          iStack_7 = iVar6;
        }
      }
...
code_?:
    ...
    while( true ) {
      ...
      (*(code *)pIVar5[0x13].nameToClassHashTable)(pMVar2,*piVar4,pIVar5[0x13].codeGenModule);
      uVar3 = uVar3 + 1;
      piVar4 = piVar4 + 1;
    }
    func_?();
