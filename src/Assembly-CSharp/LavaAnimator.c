...
{
  if (cRam_? == '\0') {
    FUN_?(&StringLiteral__NoiseATex);
    LOCK();
    UNLOCK();
    FUN_?(&StringLiteral__NoiseBTex);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
  ...
  if (pMVar1 != (Material *)0x0) {
    iVar3 = UnityEngine.CoreModule.dll::UnityEngine::Shader::Shader_PropertyToID
                      (StringLiteral__NoiseATex,(MethodInfo *)0x0);
    ...
    if (pMVar1 != (Material *)0x0) {
      iVar3 = UnityEngine.CoreModule.dll::UnityEngine::Shader::Shader_PropertyToID
                        (StringLiteral__NoiseBTex,(MethodInfo *)0x0);
      aVStack_4[0] = VVar2;
      if (cRam_? == '\0') {
        FUN_?(&
...

{
  ...
  if (pMVar1 != (Material *)0x0) {
    iVar2 = UnityEngine.CoreModule.dll::UnityEngine::Shader::Shader_PropertyToID
                      (StringLiteral__NoiseATex,(MethodInfo *)0x0);
    VVar3 = UnityEngine.CoreModule.dll::UnityEngine::Material::Material_GetTextureOffset_1
                      (pMVar1,iVar2,(MethodInfo *)0x0);
    fVar4 = (this->fields).speedA.x;
    fVar5 = (this->fields).speedA.y;
    pcVar6 = pcRam_?;
    if ((pcRam_? == (code *)0x0) &&
    ...
    iVar2 = UnityEngine.CoreModule.dll::UnityEngine::Shader::Shader_PropertyToID
                      (StringLiteral__NoiseATex,(MethodInfo *)0x0);
    VVar3.y = fVar5 * fVar8 * fVar10 + fStackX_c;
    VVar3.x = fVar4 * fVar8 * fVar9 + fStackX_8;
    UnityEngine.CoreModule.dll::UnityEngine::Material::Material_SetTextureOffsetImpl
              (pMVar1,iVar2,VVar3,(MethodInfo *)0x0);
    pMVar1 = (this->fields)._.targetMaterial;
    if (pMVar1 != (Material *)0x0) {
      iVar2 = UnityEngine.CoreModule.dll::UnityEngine::Shader::Shader_PropertyToID
                        (StringLiteral__NoiseBTex,(MethodInfo *)0x0);
      ...
      iVar2 = UnityEngine.CoreModule.dll::UnityEngine::Shader::Shader_PropertyToID
                        (StringLiteral__NoiseBTex,(MethodInfo *)0x0);
      auStack_11[0] =
           CONCAT44(fVar5 * fVar8 * fVar10 + fStackX_c,fVar4 * fVar8 * fVar9 + fStackX_8);
      if (cRam_? == '\0') {
        FUN_?(&
                      void__MethodInfo__UnityEngine__Object__MarshalledUnityObject__MarshalNotNull<UnityEngine::Material>_UnityEngine__Material_
                      ,iVar2,auStack_11[0],0);
        LOCK();
        UNLOCK();
        FUN_?(&TypeInfo__UnityEngine__Material);
        LOCK();
      ...
      pvVar12 = (pMVar1->fields)._.m_CachedPtr;
      if (pvVar12 == (void *)0x0) {
        UnityEngine.CoreModule.dll::UnityEngine::Bindings::ThrowHelper::
        ThrowHelper_2_ThrowNullReferenceException((Object *)pMVar1,(MethodInfo *)0x0);
        pcVar6 = (code *)swi(3);
      ...
      pcRam_? = pcVar6;
      (*pcRam_?)(pvVar12,iVar2,auStack_11);
      return;
    }
  }
  FUN_?();
