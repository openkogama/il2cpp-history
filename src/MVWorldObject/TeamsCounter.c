...

{
  ...
  *score = 0;
  ...
  cVar10 = (int)this_00 < 0;
  bVar11 = this_00 == (Dictionary_2_MV_WorldObject_MVTeam_TeamCounter_ *)0x0;
  if (!bVar11) {
    ...
    cVar10 = (int)pOVar12 < 0;
    bVar11 = pOVar12 == (Object *)0x0;
    if (!bVar11) {
      this_02 = pOVar12[1].klass;
      cVar10 = (int)this_02 < 0;
      bVar11 = this_02 == (Object__Class *)0x0;
      if (!bVar11) {
        ...
        uStack_14 = 0;
        auStack_7._24_4_ = pDVar13->_dictionary;
        _Stack_34 = (_union_154)pDVar13->_version;
        _Stack_30 = (_union_155)pDVar13->_index;
        uStack_8 = (pDVar13->_current).key;
        uStack_9 = *(undefined8 *)&(pDVar13->_current).value;
        uStack_1 = 1;
        pOStack_15 = unaff_ESI;
        while( true ) {
          do {
          ...
          if (0 < iVar17) {
            ...
            case GameStatCounterType__Enum_TimeAttackFlag:
              if (((*score < 0) || (iVar17 < *score)) || (*score == 0)) {
                *score = iVar17;
              }
            }
          }
  ...
  uVar20 = func_?();
  pcVar21 = (char *)uVar20;
  if (bVar11 || cVar18 != cVar10) {
    if (0 < (int)((uint)pcVar21 & 0xa94110dc)) {
      *pcVar21 = *pcVar21 + (char)uVar20;
      return;
    }
    if (cRam_? == '\0') {
  ...
  pVVar22 = &unaff_ESI[-1].vtable.Finalize;
  pVVar22->methodPtr = pVVar22->methodPtr + (uint)bVar19 + (int)((ulonglong)uVar20 >> 0x20);
  out((short)((ulonglong)uVar20 >> 0x20),(char)uVar20);
  unaff_EBX[0x19d902e].token = unaff_EBX[0x19d902e].token + 1;
  do {
