...
code_?:
    uVar31 = func_?();
    pTVar32 = (TierOnDeathProgress__Class *)uVar31;
    bVar33 = pTVar32 < pTVar3->klass;
    pbVar34 = (byte *)(extraout_ECX + -0x6aefbbe8);
    bVar35 = (byte)uVar31;
    bVar36 = CARRY1(*pbVar34,bVar35) || CARRY1(*pbVar34 + bVar35,bVar33);
    *pbVar34 = *pbVar34 + bVar35 + bVar33;
    pbVar34 = (byte *)((int)&(pTVar32->_0).this_arg.data + (int)((ulonglong)uVar31 >> 0x20));
    bVar33 = *pbVar34 < bVar35 || (byte)(*pbVar34 - bVar35) < bVar36;
    *pbVar34 = (*pbVar34 - bVar35) - bVar36;
    ppMVar37 = &(unaff_ESI->fields)._.m_MaskMaterial;
    bVar38 = (byte)((ulonglong)uVar31 >> 0x20);
    bVar39 = *(char *)ppMVar37 + bVar38;
    bVar36 = CARRY1(*(byte *)ppMVar37,bVar38) || CARRY1(bVar39,bVar33);
    *(byte *)ppMVar37 = bVar39 + bVar33;
    bVar39 = bVar35 - 0x27;
    bVar33 = 0x26 < bVar35 || CARRY1(bVar39,bVar36);
    cVar4 = bVar39 + bVar36;
    iVar13 = CONCAT31((int3)((ulonglong)uVar31 >> 8),cVar4);
    uVar40 = (uint)bVar33;
    cVar41 = SCARRY4(iVar13,(int)&stack0xfffffffc) !=
             SCARRY4((int)(&stack0xfffffffc + iVar13),uVar40);
    puVar42 = &stack0xfffffffc + iVar13 + uVar40;
    cVar43 = (int)puVar42 < 0;
    bVar44 = puVar42 == (undefined1 *)0x0;
    (**(code **)(puVar42 + -0x18))
              ((ushort)(in_NT & 1) * 0x4000 |
               (ushort)(SCARRY1(bVar35,-0x27) != SCARRY1(bVar39,bVar36)) * 0x800 |
               (ushort)(in_IF & 1) * 0x200 | (ushort)(in_TF & 1) * 0x100 |
               (ushort)(cVar4 < '\0') * 0x80 | (ushort)(cVar4 == '\0') * 0x40 |
               (ushort)(in_AF & 1) * 0x10 | (ushort)((POPCOUNT(cVar4) & 1U) == 0) * 4 |
               (ushort)bVar33);
    if (!bVar44 && cVar41 == cVar43) {
      mscorlib.dll::System::NotSupportedException::NotSupportedException__ctor
                ((NotSupportedException *)unaff_ESI,(MethodInfo *)0x0);
      uVar18 = func_?(0x3c60);
      func_?((short)unaff_ESI,uVar18);
      pcVar45 = (code *)swi(3);
      bVar25 = (*pcVar45)();
      return bVar25;
    }
