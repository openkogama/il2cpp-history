...
void Assembly-CSharp.dll::ESSelection+<Execute>c__AnonStorey0::
     ESSelection_Execute_c_AnonStorey0___m__0
               (ESSelection_Execute_c_AnonStorey0 *this,IModalPopupCreator *handler,
