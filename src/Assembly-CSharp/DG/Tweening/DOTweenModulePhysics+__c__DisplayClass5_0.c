...
/* Quaternion <DOLookAt>b__0() */

Quaternion *
Assembly-CSharp.dll::DG::Tweening::DOTweenModulePhysics+<>c__DisplayClass5_0::
DOTweenModulePhysics_c_DisplayClass5_0__DOLookAt_b__0
          (Quaternion *__return_storage_ptr__,DOTweenModulePhysics_c_DisplayClass5_0 *this,
          MethodInfo *method)
