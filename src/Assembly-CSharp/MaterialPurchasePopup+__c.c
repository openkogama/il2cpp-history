...

{
  ...
  pMVar1 = (MaterialPurchasePopup_c *)FUN_?(TypeInfo__MaterialPurchasePopup____c);
  TypeInfo__MaterialPurchasePopup____c->static_fields->__9 = pMVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__MaterialPurchasePopup____c->static_fields >> 0xc);
