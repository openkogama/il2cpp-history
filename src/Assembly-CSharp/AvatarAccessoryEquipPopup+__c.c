...

{
  ...
  pAVar1 = (AvatarAccessoryEquipPopup_c *)FUN_?(TypeInfo__AvatarAccessoryEquipPopup____c);
  TypeInfo__AvatarAccessoryEquipPopup____c->static_fields->__9 = pAVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__AvatarAccessoryEquipPopup____c->static_fields >> 0xc);
