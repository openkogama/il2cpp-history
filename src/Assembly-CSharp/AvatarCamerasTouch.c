...

{
  ...
  if (pAVar1 != (AndroidFirstPersonCamera *)0x0) {
    ...
    if (bVar2) {
      uVar3 = (uint)((ulonglong)&(pAVar1->fields)._.localAvatar >> 0xc);
    ...
    pAVar7 = (this->fields).thirdPersonMobileCamera;
    if (pAVar7 != (AndroidThirdPersonCamera *)0x0) {
      if (cRam_? == '\0') {
      ...
      bVar2 = iRam_? != 0;
      (pAVar7->fields).avatarLocal = avatarLocal;
      if (bVar2) {
        uVar3 = (uint)((ulonglong)&(pAVar7->fields).avatarLocal >> 0xc);
        uVar4 = (ulonglong)((uVar3 & 0x1fffff) >> 6);
        do {
          uVar5 = *(ulonglong *)(uVar4 * 8 + 0xADDR);
          puVar6 = (ulonglong *)(uVar4 * 8 + 0xADDR);
      ...
      fVar8 = (pAVar7->fields).lookAtOffset.x;
      fVar9 = (pAVar7->fields).lookAtOffset.y;
      fVar10 = (pAVar7->fields).lookAtOffset.z;
      pAVar11 = (AvatarCameraDistTransparency *)
                FUN_?(TypeInfo__AvatarCameraDistTransparency);
      if (cRam_? == '\0') {
      ...
      bVar2 = iRam_? != 0;
      (pAVar11->fields).camMoveTowardsOffset.x = fVar8;
      (pAVar11->fields).camMoveTowardsOffset.y = fVar9;
      (pAVar11->fields).camMoveTowardsOffset.z = fVar10;
      (pAVar11->fields).fadeStartBase = 4.0;
      (pAVar11->fields).fadeEndBase = 2.0;
      (pAVar11->fields).prevDist = -1.0;
      (pAVar11->fields).fadeStartDistance = 2.0;
      (pAVar11->fields).fadeEndDistance = 1.0;
      (pAVar7->fields).avatarCameraDistTransparency = pAVar11;
      if (bVar2) {
        uVar3 = (uint)((ulonglong)&(pAVar7->fields).avatarCameraDistTransparency >> 0xc);
        uVar4 = (ulonglong)((uVar3 & 0x1fffff) >> 6);
        do {
          uVar5 = *(ulonglong *)(uVar4 * 8 + 0xADDR);
          puVar6 = (ulonglong *)(uVar4 * 8 + 0xADDR);
      ...
      pLVar12 = (this->fields).lobbyStateCamera;
      if (pLVar12 != (LobbyStateCamera *)0x0) {
        LobbyStateCamera::LobbyStateCamera_Initialize(pLVar12,avatarLocal,(MethodInfo *)0x0);
        iVar13 = iRam_?;
        pTVar14 = (this->fields).timeAttackFlagDebriefingCamera;
        if (pTVar14 != (TimeAttackFlagDebriefingCamera *)0x0) {
          (pTVar14->fields).avatarLocal = avatarLocal;
          if (iVar13 != 0) {
            uVar3 = (uint)((ulonglong)&(pTVar14->fields).avatarLocal >> 0xc);
            uVar4 = (ulonglong)((uVar3 & 0x1fffff) >> 6);
            do {
              uVar5 = *(ulonglong *)(uVar4 * 8 + 0xADDR);
              puVar6 = (ulonglong *)(uVar4 * 8 + 0xADDR);
          ...
          pTVar15 = (this->fields).timeAttackFlagCountdownCamera;
          if (pTVar15 != (TimeAttackFlagCountdownCamera *)0x0) {
            (pTVar15->fields).avatarLocal = avatarLocal;
            if (iVar13 != 0) {
              uVar3 = (uint)((ulonglong)&(pTVar15->fields).avatarLocal >> 0xc);
              uVar4 = (ulonglong)((uVar3 & 0x1fffff) >> 6);
              do {
                uVar5 = *(ulonglong *)(uVar4 * 8 + 0xADDR);
                puVar6 = (ulonglong *)(uVar4 * 8 + 0xADDR);
            ...
            pGVar16 = (this->fields).ghostCamera;
            if (pGVar16 != (GhostCamera *)0x0) {
              GhostCamera::GhostCamera_Initialize(pGVar16,avatarLocal,(MethodInfo *)0x0);
              pDVar17 = (this->fields).deadCamera;
              if (pDVar17 != (DeadCamera *)0x0) {
                bVar2 = iRam_? != 0;
                (pDVar17->fields).avatarLocal = avatarLocal;
                if (bVar2) {
                  uVar3 = (uint)((ulonglong)&(pDVar17->fields).avatarLocal >> 0xc);
                  uVar4 = (ulonglong)((uVar3 & 0x1fffff) >> 6);
                  do {
                    uVar5 = *(ulonglong *)(uVar4 * 8 + 0xADDR);
                    puVar6 = (ulonglong *)(uVar4 * 8 + 0xADDR);
                ...
                pAVar18 = (this->fields).avatarCamerasWrapper;
                pAVar1 = (this->fields).firstPersonMobileCamera;
                if (pAVar18 != (AvatarCamerasWrapper *)0x0) {
                  if (cRam_? == '\0') {
                    FUN_?(&
                  ...
                  pDVar19 = (pAVar18->fields).avatarCameras;
                  if ((pAVar1 != (AndroidFirstPersonCamera *)0x0) &&
                     (IVar20 = (*(pAVar1->klass->vtable).get_CameraType.methodPtr)
                                         (pAVar1,(pAVar1->klass->vtable).get_CameraType.method),
                     pDVar19 != (Dictionary_2_CameraType_MVCameraBase_ *)0x0)) {
                    pMVar21 = MethodInfo__System__Collections__Generic__Dictionary<CameraType,_MVCameraBase>__Add_CameraType__MVCameraBase_
                              ->klass->rgctx_data[0x22].method;
                    mscorlib.dll::System::Collections::Generic::Dictionary`2[System::
                    Int32Enum,System::Object]::
                    Dictionary_2_System_Int32Enum_System_Object__TryInsert
                              ((Dictionary_2_System_Int32Enum_System_Object_ *)pDVar19,IVar20,
                               (Object *)pAVar1,
                    ...
                    if (pAVar18 != (AvatarCamerasWrapper *)0x0) {
                      ...
                      pDVar19 = (pAVar18->fields).avatarCameras;
                      if ((pAVar7 != (AndroidThirdPersonCamera *)0x0) &&
                         (IVar20 = (*(pAVar7->klass->vtable).get_CameraType.methodPtr)
                                             (pAVar7,(pAVar7->klass->vtable).get_CameraType.method),
                         pDVar19 != (Dictionary_2_CameraType_MVCameraBase_ *)0x0)) {
                        pMVar21 = MethodInfo__System__Collections__Generic__Dictionary<CameraType,_MVCameraBase>__Add_CameraType__MVCameraBase_
                                  ->klass->rgctx_data[0x22].method;
                        mscorlib.dll::System::Collections::Generic::Dictionary`2[System::
                        ...
                        if (pAVar18 != (AvatarCamerasWrapper *)0x0) {
                          ...
                          pDVar19 = (pAVar18->fields).avatarCameras;
                          if ((pLVar12 != (LobbyStateCamera *)0x0) &&
                             (IVar20 = (*(pLVar12->klass->vtable).get_CameraType.methodPtr)
                                                 (pLVar12,(pLVar12->klass->vtable).get_CameraType.
                                                         method),
                             pDVar19 != (Dictionary_2_CameraType_MVCameraBase_ *)0x0)) {
                            pMVar21 = MethodInfo__System__Collections__Generic__Dictionary<CameraType,_MVCameraBase>__Add_CameraType__MVCameraBase_
                                      ->klass->rgctx_data[0x22].method;
                            ...
                            Int32Enum,System::Object]::
                            Dictionary_2_System_Int32Enum_System_Object__TryInsert
                                      ((Dictionary_2_System_Int32Enum_System_Object_ *)pDVar19,
                                       IVar20,(Object *)pLVar12,
                                       (InsertionBehavior__Enum)
                                       CONCAT71((int7)((ulonglong)pMVar21 >> 8),2),pMVar21);
                            pAVar18 = (this->fields).avatarCamerasWrapper;
                            pTVar14 = (this->fields).timeAttackFlagDebriefingCamera;
                            if (pAVar18 != (AvatarCamerasWrapper *)0x0) {
                              ...
                              pDVar19 = (pAVar18->fields).avatarCameras;
                              if ((pTVar14 != (TimeAttackFlagDebriefingCamera *)0x0) &&
                                 (IVar20 = (*(pTVar14->klass->vtable).get_CameraType.methodPtr)
                                                     (pTVar14,(pTVar14->klass->vtable).get_CameraType.
                                                             method),
                                 pDVar19 != (Dictionary_2_CameraType_MVCameraBase_ *)0x0)) {
                                pMVar21 = MethodInfo__System__Collections__Generic__Dictionary<CameraType,_MVCameraBase>__Add_CameraType__MVCameraBase_
                                          ->klass->rgctx_data[0x22].method;
                                ...
                                if (pAVar18 != (AvatarCamerasWrapper *)0x0) {
                                  ...
                                  pDVar19 = (pAVar18->fields).avatarCameras;
                                  if ((pTVar15 != (TimeAttackFlagCountdownCamera *)0x0) &&
                                     (IVar20 = (*(pTVar15->klass->vtable).get_CameraType.methodPtr)
                                                         (pTVar15,(pTVar15->klass->vtable).
                                    ...
                                    if (pAVar18 != (AvatarCamerasWrapper *)0x0) {
                                      ...
                                      pDVar19 = (pAVar18->fields).avatarCameras;
                                      if ((pGVar16 != (GhostCamera *)0x0) &&
                                         (IVar20 = (*(pGVar16->klass->vtable).get_CameraType.
                                                     methodPtr)(pGVar16,(pGVar16->klass->vtable).
                                                                       get_CameraType.method),
                                         pDVar19 != (Dictionary_2_CameraType_MVCameraBase_ *)0x0)) {
                                        pMVar21 = MethodInfo__System__Collections__Generic__Dictionary<CameraType,_MVCameraBase>__Add_CameraType__MVCameraBase_
                                                  ->klass->rgctx_data[0x22].method;
                                        ...
                                        Dictionary_2_System_Int32Enum_System_Object__TryInsert
                                                  ((Dictionary_2_System_Int32Enum_System_Object_ *)
                                                   pDVar19,IVar20,(Object *)pGVar16,
                                                   (InsertionBehavior__Enum)
                                                   CONCAT71((int7)((ulonglong)pMVar21 >> 8),2),
                                                   pMVar21);
                                        pAVar18 = (this->fields).avatarCamerasWrapper;
                                        pDVar17 = (this->fields).deadCamera;
                                        if (pAVar18 != (AvatarCamerasWrapper *)0x0) {
                                          ...
                                          pDVar19 = (pAVar18->fields).avatarCameras;
                                          if ((pDVar17 != (DeadCamera *)0x0) &&
                                             (IVar20 = (*(pDVar17->klass->vtable).get_CameraType.
                                                         methodPtr)(pDVar17,(pDVar17->klass->vtable)
                                                                            .get_CameraType.method),
                                             pDVar19 != (Dictionary_2_CameraType_MVCameraBase_ *)0x0
                                             )) {
                                            pMVar21 = 
                                            ...
                                            if ((pAVar18 != (AvatarCamerasWrapper *)0x0) &&
                                              ...
                                              if (pMVar22 != (MainCameraManager *)0x0) {
                                                if ((pMVar22->fields).cameraController ==
                                                  ...
                                                  MainCameraManager_SetCameraController
                                                            (pMVar22,(this->fields).cameraController
                                                             ,(MethodInfo *)0x0);
                                                }
                                                return;
                                              }
