...

{
  ...
  bVar5 = 0;
  uVar6 = func_?();
  bVar7 = (byte)((uint6)uVar6 >> 0x28);
  bVar8 = bVar7 - *(char *)&(this_00->_0).image;
  pcVar9 = (char *)((int)&unaff_ESI[0xe84128].fields._._.original_method_info + 3);
  *pcVar9 = *pcVar9 + (char)((uint)this_00 >> 8) +
            (bVar7 < *(byte *)&(this_00->_0).image || bVar8 < bVar5);
  pcVar9 = (char *)(((uint)uVar6 ^ 0x4a) + 0xcc104a34);
  *pcVar9 = *pcVar9 + (char)(CONCAT11(bVar8 - bVar5,(char)((uint6)uVar6 >> 0x20)) - 1 >> 8);
  pcVar10 = (code *)swi(3);
  bVar11 = (*pcVar10)();
  return bVar11;
}
