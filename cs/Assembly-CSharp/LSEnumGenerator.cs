...
public static class LSEnumGenerator
{
	...
	// Methods
	public static string Generate(System.Type type, Func<string, string> customStringCallback);
	private static string GenerateEnumCode(System.Type type, Func<string, string> customStringCallback);
}
