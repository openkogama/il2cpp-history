...

{
  ...
  pSVar1 = (SpawnRoleMenu_c *)FUN_?(TypeInfo__SpawnRoleMenu____c);
  TypeInfo__SpawnRoleMenu____c->static_fields->__9 = pSVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__SpawnRoleMenu____c->static_fields >> 0xc);
