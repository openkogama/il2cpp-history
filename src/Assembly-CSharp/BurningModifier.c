...
{
  if (cRam_? == '\0') {
    FUN_?(&TypeInfo__BurningModifier___DoFadeAndDestroy_d__7);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
  pIVar1 = (IEnumerator *)FUN_?(TypeInfo__BurningModifier___DoFadeAndDestroy_d__7);
  bVar2 = iRam_? != 0;
  ...
  if (pGVar1 != (GameObject *)0x0) {
    ...
    if (cVar5 == '\0') {
      ...
      if (this_01 != (Transform *)0x0) {
        ...
        lVar6 = FUN_?(TypeInfo__BurningModifier___DoFadeAndDestroy_d__7);
        bVar7 = iRam_? != 0;
        *(undefined4 *)(lVar6 + 0x10) = 0;
        *(BurningModifier **)(lVar6 + 0x20) = this;
        if (bVar7) {
