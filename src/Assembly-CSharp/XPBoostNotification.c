...
code_?:
      ...
      bVar4 = CARRY1(bStack_5,bVar3) ||
               CARRY1(bStack_5 + bVar3,
                      this < *(XPBoostNotification **)((int)&unaff_EDI[-0x62f3ea5].monitor + 1));
