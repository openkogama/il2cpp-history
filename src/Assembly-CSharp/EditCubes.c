...
code_?:
                        ...
                        if ((this->fields).edgeHasMoved == 0) {
                          ...
                          ScrollRect_set_onValueChanged
                                    ((ScrollRect *)e,(ScrollRect_ScrollRectEvent *)pCVar24,
                                     (MethodInfo *)0x0);
                          pCVar24 = (e->fields)._SelectedCube_k__BackingField;
                          if (pCVar24 != (CubePickingInfo *)0x0) {
...
code_?:
                                ...
                                if (pVVar65 != (Vector3__Array *)0x0) {
                                  ...
                                  uVar73 = pVVar65->max_length;
                                  cVar72 = uVar73 == 0;
                                  uVar60 = SBORROW4(uVar73,1);
                                  if (uVar73 < 2) goto code_?;
                                  VStack_28.x = pVVar65->vector[1].x;
                                  VStack_28.y = pVVar65->vector[1].y;
                                  VStack_28.z = pVVar65->vector[1].z;
                                  uVar74 = pVVar65->vector[0].x;
                                  uVar75 = pVVar65->vector[0].y;
                                  fVar3 = VStack_28.x + (float)uVar74;
                                  fVar38 = VStack_28.y + (float)uVar75;
                                  fVar68 = VStack_28.z + pVVar65->vector[0].z;
                                  uVar73 = pVVar65->max_length;
                                  cVar72 = uVar73 < 2;
                                  uVar60 = SBORROW4(uVar73,2);
                                  if (uVar73 < 3) goto code_?;
                                  ...
                                  uVar73 = pVVar65->max_length;
                                  cVar72 = uVar73 < 3;
                                  uVar60 = SBORROW4(uVar73,3);
                                  if (uVar73 < 4) goto code_?;
                                  ...
                                  if (pVVar47->vector[0].x == 0.0) {
                                    ...
                                    pVVar77 = TypeInfo__UnityEngine__Vector3->static_fields;
                                    uVar78 = (pVVar77->upVector).x;
                                    uVar79 = (pVVar77->upVector).y;
                                    VStack_28.z = (pVVar77->upVector).z + (float)pVStack_21;
                                    VStack_28.y = (float)uVar79 + (float)pVStack_23;
                                    VStack_28.x = (float)uVar78 + fVar3;
                                    if ((TypeInfo__UnityEngine__Debug->_1).
                                        cctor_finished_or_no_cctor == 0) {
                                      func_?();
                                    }
                                    start_00.y._0_1_ = (char)pVVar66;
                                    start_00.x = fStack_76;
...
code_?:
                                    ...
                                    pCVar51 = (Cube *)(((MVCubeModelBase__Fields *)&pVVar47->bounds)
                                                      ->_)._.id;
                                    fStack_80 = (float)pVVar47->max_length;
                                    ...
                                    pVVar65 = Cube::Cube_GetEdgeVerticesWorld
                                                        ((GameObject *)unaff_ESI,pCVar51,
                                                         (Face__Enum)fStack_80,(Edge__Enum)fVar38,
                                    ...
                                    if (*(bool *)&pVVar47->vector[0].y == 0) {
                                      if (pVVar65 != (Vector3__Array *)0x0) {
                                        if (*(char *)((int)&pVVar47->vector[0].y + 1) == '\0') {
                                          ...
                                          VStack_28.x = pVVar65->vector[1].x;
                                          VStack_28.y = pVVar65->vector[1].y;
                                          uVar81 = pVVar65->vector[0].x;
                                          uVar82 = pVVar65->vector[0].y;
                                          fVar83 = (pVVar65->vector[1].z + pVVar65->vector[0].z) *
                                                   _UNK_?;
                                          fStack_76 = (VStack_28.x + (float)uVar81) * _UNK_?;
                                          fVar84 = (VStack_28.y + (float)uVar82) * _UNK_?;
                                        }
                                        else {
                                          uVar73 = pVVar65->max_length;
                                          cVar72 = uVar73 == 0;
                                          uVar60 = SBORROW4(uVar73,1);
                                          if (uVar73 < 2) goto code_?;
                                          uVar85 = pVVar65->vector[1].x;
                                          fVar84 = pVVar65->vector[1].y;
                                          fVar83 = pVVar65->vector[1].z;
                                          fStack_76 = (float)uVar85;
                                        }
code_?:
                                        pVVar65 = (Vector3__Array *)
                                                  (((float)pVStack_21 - fVar83) * _UNK_? +
                                                  fVar83);
                                        fStack_76 = (fVar3 - fStack_76) * _UNK_? + fStack_76
                                        ;
                                        pVVar66 = (Vector3__Array *)
                                                  (((float)pVStack_23 - fVar84) * _UNK_? +
                                                  fVar84);
                                        VStack_28.z = (float)pVVar65;
                                        goto code_?;
                                      }
                                      ...
                                      uVar60 = 0;
                                      if (pVVar65->max_length == 0) goto code_?;
                                      uVar86 = pVVar65->vector[0].x;
                                      uVar87 = pVVar65->vector[0].y;
                                      fVar83 = pVVar65->vector[0].z;
                                      iStack_88 = (int16_t)uVar87;
                                      iStack_54 = (int16_t)((uint)uVar87 >> 0x10);
                                      ...
                                      pVVar77 = TypeInfo__UnityEngine__Vector3->static_fields;
                                      uVar90 = (pVVar77->upVector).x;
                                      uVar91 = (pVVar77->upVector).y;
                                      VStack_28.z = (pVVar77->upVector).z + fVar89;
                                      VStack_28.y = (float)uVar91 + fVar68;
                                      VStack_28.x = (float)uVar90 + fVar38;
                                      if ((TypeInfo__UnityEngine__Debug->_1).
                                          cctor_finished_or_no_cctor == 0) {
                                        func_?();
                                      }
                                      start.y._0_2_ = iStack_88;
                                      start.x = fVar84;
...
joined_?:
                      ...
                      if (uStack_25 != (IndentArea *)0x0) {
                        ...
                        fStack_92 = (float)pVVar47->max_length;
                        fVar3 = pVVar47->vector[2].z;
                        ...
                        uStack_39 = Cube::Cube_GetFaceVerticesWorld
                                              ((GameObject *)unaff_ESI,pCVar51,(Face__Enum)fStack_92
                        ...
                        if ((((pGVar43 != (GameObject *)0x0) &&
                          ...
                          uVar73 = unaff_ESI->max_length;
                          if (iVar67 != 0) {
                            if (uVar73 < *(uint *)(iVar67 + 0xc)) {
                              unaff_ESI->max_length = uVar73 + 1;
                              cVar72 = uVar73 < *(uint *)(iVar67 + 0xc);
                              uVar60 = SBORROW4(uVar73,*(uint *)(iVar67 + 0xc));
                              if (!(bool)cVar72) goto code_?;
                              *(undefined4 *)(iVar67 + 0x10 + uVar73 * 4) = 0;
                            }
                            else {
                            ...
                            if (iVar67 != 0) {
                              if (uVar73 < *(uint *)(iVar67 + 0xc)) {
                                ...
                                uVar60 = SBORROW4(uVar73,*(uint *)(iVar67 + 0xc));
                                if (!(bool)cVar72) goto code_?;
                                *(undefined4 *)(iVar67 + 0x10 + uVar73 * 4) = 3;
                              }
                              else {
                                mscorlib.dll::System::Collections::Generic::List`1[System::Int32]::
                                List_1_System_Int32__AddWithResize
                              ...
                              if (iVar67 != 0) {
                                if (uVar73 < *(uint *)(iVar67 + 0xc)) {
                                  ...
                                  uVar60 = SBORROW4(uVar73,*(uint *)(iVar67 + 0xc));
                                  if (!(bool)cVar72) goto code_?;
                                  *(undefined4 *)(iVar67 + 0x10 + uVar73 * 4) = 2;
                                }
                                else {
                                  mscorlib.dll::System::Collections::Generic::List`1[System::Int32]
                                  ::List_1_System_Int32__AddWithResize
                                ...
                                if (iVar67 != 0) {
                                  ...
                                  if (iVar67 != 0) {
                                    if (uVar73 < *(uint *)(iVar67 + 0xc)) {
                                      ...
                                      uVar60 = SBORROW4(uVar73,*(uint *)(iVar67 + 0xc));
                                      if (!(bool)cVar72) goto code_?;
                                      *(undefined4 *)(iVar67 + 0x10 + uVar73 * 4) = 1;
                                    }
                                    else {
                                      mscorlib.dll::System::Collections::Generic::List`1[System::
                                      Int32]::List_1_System_Int32__AddWithResize
                                    ...
                                    if (iVar67 != 0) {
                                      ...
                                      ;
                                      value_01 = IndentArea::IndentArea_SetUVs
                                                           (uStack_25,(MethodInfo *)0x0);
                                      UnityEngine.CoreModule.dll::UnityEngine::Mesh::Mesh_set_uv
                                                ((Mesh *)pVVar65,value_01,(MethodInfo *)0x0);
                                      value_02 = mscorlib.dll::System::Collections::Generic::
                                      ...
                                      UnityEngine.CoreModule.dll::UnityEngine::Mesh::
                                      Mesh_set_triangles((Mesh *)pVVar65,(Int32__Array *)value_02,
                                                         (MethodInfo *)0x0);
                                      UnityEngine.CoreModule.dll::UnityEngine::Mesh::
                                      ...
                                      if (uStack_39 != (Vector3__Array *)0x0) {
                                        ...
                                        if (pGVar43 != (GameObject *)0x0) {
                                          ...
                                          pVVar77 = TypeInfo__UnityEngine__Vector3->static_fields;
                                          uVar99 = (pVVar77->oneVector).x;
                                          uVar100 = (pVVar77->oneVector).y;
                                          fVar38 = (uStack_25->fields).size;
                                          fVar68 = (pVVar77->oneVector).z * fVar38;
                                          if (pTVar31 != (Transform *)0x0) {
                                            value.y._0_2_ = SUB42((float)uVar100 * fVar38,0);
                                            value.x = (float)uVar99 * fVar38;
                                            value.y._2_2_ =
                                                 (short)((uint)((float)uVar100 * fVar38) >> 0x10);
                                            value.z._0_1_ = SUB41(fVar68,0);
                                            value.z._1_1_ = (char)((uint)fVar68 >> 8);
                                            value.z._2_2_ = (short)((uint)fVar68 >> 0x10);
                                                      ...
                                                      if (pTVar31 != (Transform *)0x0) {
                                                        ...
                                                        if (pGVar43 != (GameObject *)0x0) {
                                                          ...
                                                          if (pTVar31 != (Transform *)0x0) {
                                                            ...
                                                            value_00.z._0_2_ = SUB42(VStack_28.z,0);
                                                            value_00.z._2_2_ =
...
code_?:
  func_?();
  if (!(bool)uVar60) {
    pfVar106 = &unaff_ESI[-1].vector[0x1c].z;
