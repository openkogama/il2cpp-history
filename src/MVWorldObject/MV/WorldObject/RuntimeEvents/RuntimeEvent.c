...

{
  if (bytePacker == (BytePacker *)0x0) {
    ...
    piVar3 = (int *)((uint)uVar1 ^ 0xc610dc8f);
    *(char *)((int)extraout_ECX + 0x10dc8f) =
         *(char *)((int)extraout_ECX + 0x10dc8f) + (char)((uint)unaff_EBX >> 8);
    *(char *)extraout_ECX = (char)*extraout_ECX + (char)piVar3;
    *piVar3 = *piVar3 + (int)piVar3;
    *extraout_ECX = *extraout_ECX + (int)piVar3;
    *extraout_ECX = *extraout_ECX + (int)piVar3;
