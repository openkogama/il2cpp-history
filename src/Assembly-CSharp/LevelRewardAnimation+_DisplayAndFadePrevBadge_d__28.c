...

{
  ...
  in_AF = 0;
  if (_UNK_? <= fVar2 / *(float *)&(this_00->_0).byval_arg.attrs) {
...
code_?:
          ...
          in_AF = 0;
          if (_UNK_? <= fVar12 / (float)(this_00->_0).fields) {
            pCVar5 = (Component *)(this_00->_0).byval_arg.data.typeHandle;
            if (pCVar5 != (Component *)0x0) {
              pTVar6 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_transform
                                  (pCVar5,(MethodInfo *)0x0);
...
code_?:
  uVar15 = func_?();
  *(byte *)&pLVar1->klass = *(byte *)&pLVar1->klass | extraout_DL;
  in_AF = 9 < ((byte)uVar15 & 0xf) | in_AF;
  bVar16 = ((byte)uVar15 + in_AF * -6 & 0xf) + extraout_CH + in_AF;
  bVar17 = 9 < (bVar16 & 0xf) | in_AF;
  uVar18 = CONCAT31((int3)((uint)uVar15 >> 8),bVar16 + bVar17 * -6) & 0xffff000f;
  pcVar19 = (char *)(CONCAT22((short)(uVar18 >> 0x10),
                             CONCAT11(((char)((uint)uVar15 >> 8) - in_AF) - bVar17,(char)uVar18)) +
                   0x19);
  *pcVar19 = *pcVar19 + (char)((uint)&stack0xfffffffc >> 8) + bVar17;
  pcVar20 = (code *)swi(3);
  bVar21 = (*pcVar20)();
  return bVar21;
}
