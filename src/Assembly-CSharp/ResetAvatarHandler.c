            ...
            if (pRVar1 != (RawImage *)0x0) {
              (*(pRVar1->klass->vtable).set_color.methodPtr)
                        (pRVar1,_UNK_?,_UNK_?,_UNK_?,_UNK_?,
                         (pRVar1->klass->vtable).set_color.method);
...

{
  ...
  value = (Object *)func_?(TypeInfo__ResetAvatarHandler____c__DisplayClass26_0);
  if (value != (Object *)0x0) {
  ...
  if (currentBody != (MVBody *)0x0) {
    ...
    if (this_02 != (UnityAction_2_System_Object_System_Object_ *)0x0) {
      ...
      if (pMVar3 != (MVNetworkGame *)0x0) {
        MVNetworkGame::MVNetworkGame_add_ReceivedItemFromQuery
                  (pMVar3,(EventHandler_1_ReceivedItemFromQueryEventArgs_ *)this_02,
                   (MethodInfo *)0x0);
        pMVar3 = MVGameControllerBase::MVGameControllerBase_get_Game((MethodInfo *)0x0);
        if ((pMVar3 != (MVNetworkGame *)0x0) &&
