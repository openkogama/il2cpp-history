...

{
  ...
  if (*(int *)&(TypeInfo__MaterialButton____c->_1).field_0x1c == 0) {
    FUN_?(TypeInfo__MaterialButton____c);
  }
  this_01 = TypeInfo__MaterialButton____c->static_fields->__9__0_0;
  if (this_01 == (ExecuteEvents_EventFunction_1_IHandleMaterial_ *)0x0) {
    if (*(int *)&(TypeInfo__MaterialButton____c->_1).field_0x1c == 0) {
      FUN_?(TypeInfo__MaterialButton____c);
    }
    object = TypeInfo__MaterialButton____c->static_fields->__9;
    this_01 = (ExecuteEvents_EventFunction_1_IHandleMaterial_ *)
              FUN_?(
                           TypeInfo__UnityEngine__EventSystems__ExecuteEvents__EventFunction<UnityEngine::EventSystems::IHandleMaterial>
                           );
    ...
    ExecuteEvents_EventFunction_1_System_Object___ctor
              ((ExecuteEvents_EventFunction_1_System_Object_ *)this_01,(Object *)object,
               MethodInfo__MaterialButton____c___Execute_b__0_0_UnityEngine__EventSystems__IHandleMaterial__UnityEngine__EventSystems__BaseEventData_
               ,(MethodInfo *)0x0);
    TypeInfo__MaterialButton____c->static_fields->__9__0_0 = this_01;
    if (iRam_? != 0) {
      uVar2 = (uint)((ulonglong)&TypeInfo__MaterialButton____c->static_fields->__9__0_0 >> 0xc);
