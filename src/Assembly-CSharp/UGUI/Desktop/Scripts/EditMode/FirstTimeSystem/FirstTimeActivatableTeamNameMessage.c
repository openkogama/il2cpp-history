  ...
  if (this_00 != (WorldObjectTypeInShopChecker *)0x0) {
    ...
    if (pGVar2 != (GameObject *)0x0) {
      ...
      if ((((pMVar8 != (MVGameControllerBase *)0x0) &&
          ...
          (this_01 = (pMVar9->fields).teamManager, this_01 != (MVTeamManager *)0x0)) &&
         (pLVar10 = MVTeamManager::MVTeamManager_GetTeamList(this_01,(MethodInfo *)0x0),
         pLVar10 != (List_1_MV_WorldObject_MVTeam_ *)0x0)) {
        bVar11 = 0;
        if (1 < (pLVar10->fields)._size) {
          bVar11 = bVar3 ^ 1;
        }
        return bVar11 & (this->fields).inventoryButton & bVar7 & bVar1;
      }
    }
  }
  FUN_?();
