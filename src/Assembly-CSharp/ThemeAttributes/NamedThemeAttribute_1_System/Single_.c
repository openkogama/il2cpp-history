...
void Assembly-CSharp.dll::ThemeAttributes::NamedThemeAttribute`1[System::Single]::
     NamedThemeAttribute_1_System_Single__Initialize
               (NamedThemeAttribute_1_System_Single_ *this,SettingsWrapper *settings,String *key,
...
void Assembly-CSharp.dll::ThemeAttributes::NamedThemeAttribute`1[System::Single]::
     NamedThemeAttribute_1_System_Single__LanguageLoadedCallback
...
void Assembly-CSharp.dll::ThemeAttributes::NamedThemeAttribute`1[System::Single]::
     NamedThemeAttribute_1_System_Single__OnValidate
               (NamedThemeAttribute_1_System_Single_ *this,MethodInfo *method)
...
String * Assembly-CSharp.dll::ThemeAttributes::NamedThemeAttribute`1[System::Single]::
         NamedThemeAttribute_1_System_Single__Validate
                   (NamedThemeAttribute_1_System_Single_ *this,String *str,MethodInfo *method)
