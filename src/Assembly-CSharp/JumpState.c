...

{
  ...
  if (((bVar4 == 0) && ((this->fields).jumping != 0)) && ((this->fields).holdingJumpButton != 0)) {
    ...
    pMVar19 = (interactableLocal->klass->vtable).__unknown_8.method;
    fStack_20 = density;
...
code_?:
  ...
  uStack_22 = 0;
  fStack_10 = 0.0;
  auStack_6._0_4_ = (interactableLocal->klass->vtable).__unknown_8.method;
  ...
  auStack_24._0_4_ = (interactableLocal->klass->vtable).__unknown_8.method;
  cVar25 = '\0';
...

{
  ...
  if (bVar4 == 0) {
    ...
    if (bVar4 != 0) {
      ...
      pVVar8 = RTG::TriangPrismShape3D::TriangPrismShape3D_get_ModelUp
                          ((Vector3 *)&fStack_9,(MethodInfo *)0x0);
      uVar10 = pVVar8->x;
      uVar11 = pVVar8->y;
      fVar6 = pVVar8->z;
      if (cRam_? == '\0') {
      ...
      fVar12 = fStack_9 * fStack_9;
      if ((TypeInfo__System__Math->_1).cctor_finished_or_no_cctor == 0) {
        func_?(TypeInfo__System__Math);
      }
      pMVar13 = TypeInfo__System__Math;
      dVar14 = (double)((fVar7 * fVar7 + fVar12 + unaff_EBP * unaff_EBP) *
      ...
      if ((float)dVar14 < _UNK_?) {
        fVar6 = 0.0;
      }
      else {
        fStack_15 = (fStack_9 * (float)uVar11 + fVar7 * (float)uVar10 + fVar6 * unaff_EBP) /
                    (float)dVar14;
        fVar6 = _UNK_?;
        if ((fStack_15 < _UNK_?) || (fVar6 = _UNK_?, _UNK_? < fStack_15)) {
          fStack_15 = fVar6;
        }
        if ((pMVar13->_1).cctor_finished_or_no_cctor == 0) {
          func_?(pMVar13);
        }
        dVar14 = (double)fStack_15;
        func_?();
        fVar6 = (float)dVar14 * _UNK_?;
      }
      pfVar5 = &(this->fields).wallJumpAngleMin;
      if ((*pfVar5 <= fVar6 && fVar6 != *pfVar5) && (fVar6 < (this->fields).wallJumpAngleMax)) {
        fVar6 = (this->fields).latestSlopeDir.z;
        pVVar8 = RTG::TriangPrismShape3D::TriangPrismShape3D_get_ModelUp
                            ((Vector3 *)&stack0x00000000,(MethodInfo *)0x0);
        uVar16 = pVVar8->x;
        uVar17 = pVVar8->y;
        pVVar8 = (Vector3 *)(pVVar8->z + fStack_9);
        pVVar2->x = (float)uVar16 + fVar6;
        pVVar2->y = (float)uVar17 + fVar7;
        (this->fields).latestSlopeDir.z = (float)pVVar8;
        UnityEngine.CoreModule.dll::UnityEngine::Vector3::Vector3_Normalize_1
  ...
  fVar6 = (pVVar18->upVector).y;
  fVar7 = (pVVar18->upVector).z;
  __return_storage_ptr__->x = (pVVar18->upVector).x;
  __return_storage_ptr__->y = fVar6;
  __return_storage_ptr__->z = fVar7;
  return __return_storage_ptr__;
}
