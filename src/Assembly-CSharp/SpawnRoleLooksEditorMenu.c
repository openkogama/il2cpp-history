...

{
  ...
  ppAVar7 = &(spawnRole->fields).OnRedoObjectLinks;
...

{
  ...
  if (value != (Object *)0x0) {
    ...
    pOVar1 = pOVar2->klass;
    pIVar5 = (Il2CppClass *)(this->fields).spawnRoleId;
    if (pOVar1 != (Object__Class *)0x0) {
      ...
      UnityEngine.CoreModule.dll::UnityEngine::Events::UnityAction`2[System::Object,System::Object]
      ::UnityAction_2_System_Object_System_Object___ctor
                ((UnityAction_2_System_Object_System_Object_ *)pEVar4,(Object *)pOVar1,
                 MethodInfo__SpawnRoleAvatarSelectionMenu___Initialize_b__9_0_UnityEngine__EventSystems__IHandleSpawnRoleAvatarSelectionData__UnityEngine__EventSystems__BaseEventData_
                 ,(MethodInfo *)0x0);
      if ((TypeInfo__UnityEngine__EventSystems__ExecuteEvents->_1).cctor_finished_or_no_cctor == 0)
      {
...

{
  ...
  obj = (Action__Class *)(this->fields).spawnRolePreviewer;
  if ((TypeInfo__UnityEngine__Object->_1).cctor_finished_or_no_cctor == 0) {
    func_?(TypeInfo__UnityEngine__Object);
  }
  ...
  if (pMVar1 == (MVAvatarSpawnRoleCreator *)0x0) {
    ...
    _pAStack0000000c = CONCAT44(TypeInfo__System__Action,pAStack2);
    if (pAStack2 == (Action *)0x0) {
      pAVar4 = (Action *)0x0;
      (pMVar1->fields).OnBodyUpdate = (Action *)0x0;
code_?:
      pAStack2 = (Action *)&(pMVar1->fields).OnBodyUpdate;
...

{
  ...
  if (spawnRolePreviewObject != (GameObject *)0x0) {
    ...
    SharedCubeFunctions::SharedCubeFunctions_SetLayerRecursively(pTVar4,0,(MethodInfo *)0x0);
