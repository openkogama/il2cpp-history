...

{
  ...
  pVVar2 = pVVar1;
  bVar4 = CubeModelChunk_AllFaceCornersIsTouchingCubeBorder
  ...
  case (Vector3__Array *)0x1:
    ...
    do {
      ...
      if ((float)in_stack_5->klass !=
          *(float *)((int)pVVar6 + (3U - (int)pVVar1) * 0xc + 0x10)) {
        return;
      }
      pVStack7 = pVVar1;
      iVar8 = func_?();
...
code_?:
      ...
      if (iVar8 == 0) {
        ...
        while( true ) {
          ...
          fVar18 = UnityEngine.CoreModule.dll::UnityEngine::Vector3::Vector3_get_Item
                             ((Vector3 *)&stack0xffffffe8,(int32_t)pVVar6,(MethodInfo *)0x0);
          pVVar6 = in_stack_3;
      ...
      *pbVar15 = bVar21 + bVar12;
      ...
      bVar12 = CARRY1(bVar22,(byte)iVar8) ||
               CARRY1(bVar22 + (byte)iVar8,CARRY1(bVar20,(byte)extraout_CX) || CARRY1(bVar21,bVar12))
      ;
...

{
  ...
  bVar9 = bRam_? < bVar8;
  pbVar10 = (byte *)(uVar3 + 0x2d);
  bVar11 = *pbVar10;
  bVar12 = *pbVar10 + (byte)extraout_CX;
  *pbVar10 = bVar12 + bVar9;
  bVar9 = CARRY1(in_stack_13,(byte)pVVar4) ||
           CARRY1(in_stack_13 + (byte)pVVar4,
                  CARRY1(bVar11,(byte)extraout_CX) || CARRY1(bVar12,bVar9));
...
code_?:
  uVar7 = func_?();
  if ((bool)uVar5) {
    puVar8 = (ushort *)((int)&faceVertices[-1].vector[0x1a].z + 1);
    *puVar8 = *puVar8 + (ushort)(0 < (short)-(*puVar8 & 3)) * -(*puVar8 & 3);
                    /* WARNING: Could not recover jumptable at 0xADDR. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    pVVar1 = (Vector2__Array *)(**(code **)((int)uVar7 + -8))();
    return pVVar1;
  }
  bVar9 = *unaff_EDI;
  bVar10 = (byte)((uint)unaff_ESI >> 8);
  *unaff_EDI = *unaff_EDI + bVar10;
  bVar11 = (byte)((uint)unaff_EBX >> 8);
  bVar12 = (byte)((ushort)extraout_CX >> 8);
  pcVar13 = (char *)(unaff_EBX + (int)faceVertices * 2);
  *pcVar13 = *pcVar13 + (char)extraout_CX +
            (CARRY1(in_stack_14,bVar12) ||
            CARRY1(in_stack_14 + bVar12,
                   CARRY1(unaff_BP,bVar11) || CARRY1(unaff_BP + bVar11,CARRY1(bVar9,bVar10))));
  in((short)((uint6)uVar7 >> 0x20) + 1);
  if (cRam_? == '\0') {
    func_?();
    func_?();
    pDStack_15 = (Dictionary_2_System_Text_RegularExpressions_Regex_CachedCodeEntryKey_System_Object_
                  *)&UNK_?;
    func_?();
    pDStack_15 = (Dictionary_2_System_Text_RegularExpressions_Regex_CachedCodeEntryKey_System_Object_
                  *)&
  ...
  if (*(Dictionary_2_UnityEngine_UIElements_StyleSheets_StyleSheetCache_SheetHandleKey_System_Object_
    ...
    if (iVar16 < 1) {
      ...
      faceVertices->klass = *(Vector3__Array__Class **)&pIVar17->One;
      *(int16_t *)&faceVertices->monitor = (pIVar17->One).z;
        ...
        (Dictionary_2_System_Text_RegularExpressions_Regex_CachedCodeEntryKey_System_Object_ *)0x0)
    {
      ...
      faceVertices->klass = (Vector3__Array__Class *)(pDVar18->_current).key._options;
      *(undefined2 *)&faceVertices->monitor = uVar19;
      return (Vector2__Array *)faceVertices;
    }
  }
  func_?();
  pcVar20 = (code *)swi(3);
  pVVar1 = (Vector2__Array *)(*pcVar20)();
  return pVVar1;
}
