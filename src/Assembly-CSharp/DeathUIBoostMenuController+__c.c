...
/* DeathUIBoostMenuController+<>c() */

void Assembly-CSharp.dll::DeathUIBoostMenuController+<>c::DeathUIBoostMenuController_c__cctor
               (MethodInfo *method)

{
  ...
  pDVar1 = (DeathUIBoostMenuController_c *)FUN_?(TypeInfo__DeathUIBoostMenuController____c);
  TypeInfo__DeathUIBoostMenuController____c->static_fields->__9 = pDVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__DeathUIBoostMenuController____c->static_fields >> 0xc);
