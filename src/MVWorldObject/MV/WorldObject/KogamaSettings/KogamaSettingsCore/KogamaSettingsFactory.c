      ...
      if (valuePair.value != (Object *)0x0) {
        if (((valuePair.value)->klass->_0).element_class ==
          ...
          KogamaSettingNumericBase_1_System_Single___ctor
                    (unaff_EBX,(String *)unaff_EDI,*pfVar10,(float)piVar7,(float)piVar8,parent,
                     pMVar9);
      ...
      if (valuePair.value != (Object *)0x0) {
        if (((valuePair.value)->klass->_0).element_class ==
          ...
          KogamaSettingNumericBase_1_System_Int32___ctor
                     ...
                     *piVar11,(int32_t)piVar7,(int32_t)piVar8,parent,pMVar9);
          return (KogamaSettingValueWrapperBase *)unaff_EDI;
        }
        goto code_?;
      }
      ...
      if (valuePair.value != (Object *)0x0) {
        if (((valuePair.value)->klass->_0).element_class ==
          ...
          KogamaSettingTypes::KogamaSettingEnumBase::KogamaSettingEnumBase__ctor
                    ((KogamaSettingEnumBase *)unaff_EDI,(String *)unaff_EBX,*piVar11,
                     (int32_t)piVar7,(int32_t)piVar8,parent,(MethodInfo *)0x0);
          return (KogamaSettingValueWrapperBase *)unaff_EDI;
        }
        goto code_?;
      }
...
code_?:
  ...
  *(char *)piVar7 = (char)*piVar7 + (char)uVar1;
  puVar12 = (undefined1 *)((int)&(unaff_EDI->_0).interopData + 3);
  *puVar12 = *puVar12 + (char)((ushort)uVar1 >> 8) + ((byte)piVar7 < 0xdb);
