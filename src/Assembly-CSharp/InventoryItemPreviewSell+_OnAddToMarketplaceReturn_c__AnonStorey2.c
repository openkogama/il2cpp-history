...
void Assembly-CSharp.dll::InventoryItemPreviewSell+<OnAddToMarketplaceReturn>c__AnonStorey2::
     InventoryItemPreviewSell_OnAddToMarketplaceReturn_c_AnonStorey2___m__0
               (InventoryItemPreviewSell_OnAddToMarketplaceReturn_c_AnonStorey2 *this,
