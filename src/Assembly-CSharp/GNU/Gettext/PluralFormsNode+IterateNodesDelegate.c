...
/* Void Invoke(PluralFormsNode) */

void Assembly-CSharp.dll::GNU::Gettext::PluralFormsNode+IterateNodesDelegate::
     PluralFormsNode_IterateNodesDelegate_Invoke
               (PluralFormsNode_IterateNodesDelegate *this,PluralFormsNode *node,MethodInfo *method)

{
  this_00 = (PluralFormsNode_IterateNodesDelegate *)(this->fields)._.prev;
  if (this_00 != (PluralFormsNode_IterateNodesDelegate *)0x0) {
    PluralFormsNode_IterateNodesDelegate_Invoke(this_00,node,method);
  }
...
code_?:
    (*(code *)pMVar1)(pOVar2,node,this_01);
    return;
  }
  if (cVar6 == '\x01') {
    if (((this_01->flags == 0xffff) ||
      ...
      if (cVar6 == '\0') {
        if (cVar5 == '\0') {
          (*(code *)(&(pOVar2->klass->vtable).Equals)[this_01->flags].method)
                    (pOVar2,node,(&(pOVar2->klass->vtable).Finalize)[this_01->flags].methodPtr);
          return;
        }
        pIVar9 = (Il2CppClass *)
...
code_?:
        (*(code *)*ppMVar13)(pOVar2,node,ppMVar13[1]);
        return;
      }
...
code_?:
      ...
      (*(code *)*puVar17)(pOVar2,node,puVar17);
      return;
    }
  }
    ...
    if (cVar6 == '\0') {
      if (cVar5 != '\0') {
        pOVar2 = mscorlib.dll::System::Collections::Generic::
                 ...
                 KeyValuePair_2_WinningConditionType_System_Object__get_Value
                           ((KeyValuePair_2_WinningConditionType_System_Object_ *)this_01,pMVar1);
        func_?(this_01->flags,pOVar2,node);
        return;
      }
      func_?(this_01->flags,node);
      return;
    }
    uVar14 = (uint)this_01->flags;
    if (cVar5 == '\0') {
      puVar17 = (undefined4 *)
               func_?((&(node->klass->vtable).Finalize)[uVar14].methodPtr,this_01);
      (*(code *)*puVar17)(node,puVar17);
      return;
    }
    pPVar18 = node->klass;
    uVar12 = 0;
    uVar10._0_1_ = (pPVar18->_1).rank;
    uVar10._1_1_ = (pPVar18->_1).minimumAlignment;
    pMVar1 = this_01;
    if (uVar10 != 0) {
      do {
        if (pPVar18->interfaceOffsets[uVar12].interfaceType == (Il2CppClass *)this_01->name) {
          ppMVar13 = &(&(node->klass->vtable).Equals)
                     [(uint)pMVar4->flags + node->klass->interfaceOffsets[uVar12].offset].method;
          goto code_?;
        }
        uVar12 = uVar12 + 1;
      } while (uVar12 < uVar10);
    ...
    pMVar4 = pMVar1;
    ppMVar13 = (MethodInfo **)func_?(node,(Il2CppClass *)this_01->name,uVar14);
code_?:
    puVar17 = (undefined4 *)func_?(ppMVar13[1],pMVar4);
    (*(code *)*puVar17)(node,puVar17);
    return;
  }
  (*(code *)pMVar1)(node,this_01);
  return;
}
