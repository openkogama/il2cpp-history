...
void Assembly-CSharp.dll::RTG::Tut_2_MultipleTargetObjects::
     Tut_2_MultipleTargetObjects_OnSelectionChanged
               (Tut_2_MultipleTargetObjects *this,MethodInfo *method)
  ...
  if (pLVar1 != (List_1_UnityEngine_GameObject_ *)0x0) {
    if ((pLVar1->fields)._size == 0) {
      ...
      if (((pOVar2 != (ObjectTransformGizmo *)0x0) &&
        ...
        ppQVar5 = (Quaternion__Class **)this;
        if (cRam_? == '\0') {
        ...
        if (*(DataTable **)(in_stack_6 + 8) != (DataTable *)0x0) {
          ...
          if (*(int *)(in_stack_6 + 8) != 0) {
            ...
            if (*(int *)(in_stack_6 + 0x44) == 0) {
              if (cRam_? == '\0') {
                ppQVar5 = &TypeInfo__UnityEngine__Quaternion;
              ...
              if ((TypeInfo__UnityEngine__Object->_1).cctor_finished_or_no_cctor == 0) {
                ppQVar5 = (Quaternion__Class **)TypeInfo__UnityEngine__Object;
                func_?(TypeInfo__UnityEngine__Object);
              }
              ...
              if (bVar7 == 0) {
                ...
                pQVar8 = UnityEngine.CoreModule.dll::UnityEngine::Transform::Transform_get_rotation
                                   ((Quaternion *)&stack0x00000000,this_01,(MethodInfo *)0x0);
              }
              else {
                pQVar8 = MVWorldObject.dll::MV::WorldObject::MVWorldObject::
                         MVWorldObject_get_WorldRotation
                                   ((Quaternion *)&stack0x00000000,(MVWorldObject *)0x0,method_00);
              }
              if (this_00 != (GizmoTransform *)0x0) {
...
GameObject *
Assembly-CSharp.dll::RTG::Tut_2_MultipleTargetObjects::Tut_2_MultipleTargetObjects_PickGameObject
          (Tut_2_MultipleTargetObjects *this,MethodInfo *method)
...
/* Void SetWorkGizmoId(Tut_2_MultipleTargetObjects+GizmoId) */

void Assembly-CSharp.dll::RTG::Tut_2_MultipleTargetObjects::
     Tut_2_MultipleTargetObjects_SetWorkGizmoId
               (Tut_2_MultipleTargetObjects *this,Tut_2_MultipleTargetObjects_GizmoId__Enum gizmoId,
               MethodInfo *method)

{
  ...
  if (gizmoId == Tut_2_MultipleTargetObjects_GizmoId__Enum_Move) {
    pOVar1 = (this->fields)._objectMoveGizmo;
code_?:
    ...
    if (gizmoId == Tut_2_MultipleTargetObjects_GizmoId__Enum_Rotate) {
      pOVar1 = (this->fields)._objectRotationGizmo;
      goto code_?;
    }
    if (gizmoId == Tut_2_MultipleTargetObjects_GizmoId__Enum_Scale) {
      pOVar1 = (this->fields)._objectScaleGizmo;
      goto code_?;
    }
    if (gizmoId == Tut_2_MultipleTargetObjects_GizmoId__Enum_Universal) {
      pOVar1 = (this->fields)._objectUniversalGizmo;
      goto code_?;
    }
  }
  ...
  if (pLVar3 != (List_1_UnityEngine_GameObject_ *)0x0) {
    ...
    if ((pOVar1 != (ObjectTransformGizmo *)0x0) &&
      ...
      pOVar1 = (this->fields)._workGizmo;
      if (pOVar1 != (ObjectTransformGizmo *)0x0) {
        ObjectTransformGizmo::ObjectTransformGizmo_RefreshPositionAndRotation
...
void Assembly-CSharp.dll::RTG::Tut_2_MultipleTargetObjects::Tut_2_MultipleTargetObjects_Start
               (Tut_2_MultipleTargetObjects *this,MethodInfo *method)
...
void Assembly-CSharp.dll::RTG::Tut_2_MultipleTargetObjects::Tut_2_MultipleTargetObjects_Update
               (Tut_2_MultipleTargetObjects *this,MethodInfo *method)
    ...
    if (pOVar2 != (Object *)0x0) {
      ...
      if (this_00 != (Camera *)0x0) {
        ...
        if (bVar1 == 0) {
          ...
          else if (pLVar11 != (List_1_UnityEngine_GameObject_ *)0x0) {
...
code_?:
  ...
  if (bVar1 == 0) {
    ...
    if (bVar1 != 0) {
      Tut_2_MultipleTargetObjects_SetWorkGizmoId
                (this,Tut_2_MultipleTargetObjects_GizmoId__Enum_Rotate,(MethodInfo *)0x0);
      return;
    }
    bVar1 = RTInput::RTInput_WasKeyPressedThisFrame(KeyCode__Enum_R,(MethodInfo *)0x0);
    if (bVar1 != 0) {
      Tut_2_MultipleTargetObjects_SetWorkGizmoId
                (this,Tut_2_MultipleTargetObjects_GizmoId__Enum_Scale,(MethodInfo *)0x0);
      return;
    }
    bVar1 = RTInput::RTInput_WasKeyPressedThisFrame(KeyCode__Enum_T,(MethodInfo *)0x0);
    if (bVar1 != 0) {
      Tut_2_MultipleTargetObjects_SetWorkGizmoId
                (this,Tut_2_MultipleTargetObjects_GizmoId__Enum_Universal,(MethodInfo *)0x0);
      return;
    }
  }
  else {
    Tut_2_MultipleTargetObjects_SetWorkGizmoId
              (this,Tut_2_MultipleTargetObjects_GizmoId__Enum_Move,(MethodInfo *)0x0);
  }
  return;
}
...
void Assembly-CSharp.dll::RTG::Tut_2_MultipleTargetObjects::Tut_2_MultipleTargetObjects__ctor
               (Tut_2_MultipleTargetObjects *this,MethodInfo *method)
