  ...
  if (pTVar6 != (TimeoutMap *)0x0) {
    ...
    if (this_00 != (HashSet_1_System_UInt32_ *)0x0) {
      ...
      while( true ) {
        ...
        puVar15 = (undefined8 *)func_?();
        uVar21 = *puVar15;
        fStack_22 = *(float *)(puVar15 + 1);
        uStack_23._4_4_ = (float)((ulonglong)uVar21 >> 0x20);
        uStack_23._0_4_ = (float)uVar21;
        fStack_24 = fStack_17 - (fStack_20 - fStack_22);
        uStack_25 = CONCAT44(uStack_16._4_4_ - (uStack_19._4_4_ - uStack_23._4_4_),
                             (float)uStack_16 - ((float)uStack_19 - (float)uStack_23));
        uStack_23 = uVar21;
        puVar15 = (undefined8 *)func_?();
        uVar21 = *puVar15;
        fStack_26 = *(float *)(puVar15 + 1);
        uStack_27._4_4_ = (float)((ulonglong)uVar21 >> 0x20);
        fStack_28 = (this->fields).impulseStrength;
        uStack_27._0_4_ = (float)uVar21;
