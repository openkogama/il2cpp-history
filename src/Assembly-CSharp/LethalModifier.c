...
void Assembly-CSharp.dll::LethalModifier::LethalModifier_Destroy
               (LethalModifier *this,MethodInfo *method)
...
IEnumerator *
Assembly-CSharp.dll::LethalModifier::LethalModifier_DoFadeAndDestroy
          (LethalModifier *this,MethodInfo *method)

{
  ...
  method_00 = TypeInfo__LethalModifier___DoFadeAndDestroy_c__Iterator0;
...
void Assembly-CSharp.dll::LethalModifier::LethalModifier_OnActivated
               (LethalModifier *this,Avatar_1 *target,MethodInfo *method)
    ...
    if (this_03 != (MVBody *)0x0) {
      ...
      if (this_04 != (BodyData *)0x0) {
        ...
        if (this_02 != (Transform *)0x0) {
          ...
          Avatar::Avatar_1_StartBlinking(target,BlinkType__Enum_Lethal,INFINITY,(MethodInfo *)0x0);
...
void Assembly-CSharp.dll::LethalModifier::LethalModifier_OnDeactivated
               (LethalModifier *this,Avatar_1 *target,MethodInfo *method)

{
  if (target != (Avatar_1 *)0x0) {
    Avatar::Avatar_1_StopBlinking(target,BlinkType__Enum_Lethal,(MethodInfo *)0x0);
...
void Assembly-CSharp.dll::LethalModifier::LethalModifier_OnDisable
               (LethalModifier *this,MethodInfo *method)
...
Assembly-CSharp.dll::LethalModifier::LethalModifier_get_ModifierType
          (LethalModifier *this,MethodInfo *method)

{
  return AvatarModifierPackageType__Enum_Lethal;
}
