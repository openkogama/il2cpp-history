...
code_?:
    ...
    if (((pAVar11 == (Avatar *)0x0) ||
        (pMVar3 = (pAVar11->fields).mvAvatar, pMVar3 == (MVAvatar *)0x0)) ||
       (pMVar9 = (pMVar3->fields).Health, pMVar9 == (MVRuntimeDataVariable_1_System_Single_ *)0x0))
    goto code_?;
    pMVar12 = (pMVar9->fields)._.OnChange;
    ...
    if (pDVar14 == (Delegate *)0x0) {
      (pMVar12->fields)._._.method_code = (void *)0x0;
code_?:
      func_?();
      ...
      if (pRVar15 != (RotatingShieldLine *)0x0) {
        ...
        pTVar2 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_transform
                            ((Component *)this,(MethodInfo *)0x0);
        pAVar11 = (this->fields)._.owner;
        if ((((pAVar11 != (Avatar *)0x0) &&
             (pMVar3 = (pAVar11->fields).mvAvatar, pMVar3 != (MVAvatar *)0x0)) &&
            (pMVar4 = (pMVar3->fields).body, pMVar4 != (MVBody *)0x0)) &&
           (((pMVar16 = (pMVar4->fields).bodyObject, pMVar16 != (MVBodyObject *)0x0 &&
             (this_01 = (pMVar16->fields).bodyData, this_01 != (BodyData *)0x0)) &&
          ...
          if (((pAVar11 != (Avatar *)0x0) &&
              (pMVar3 = (pAVar11->fields).mvAvatar, pMVar3 != (MVAvatar *)0x0)) &&
             (pMVar17 = (pMVar3->fields).SpawnRoleModeTypes, pMVar17 != (MVRuntimeDataVariable *)0x0
             )) {
            pMVar12 = (pMVar17->fields).OnChange;
            pVVar13 = (VideoCapture_OnVideoCaptureResourceCreatedCallback *)func_?();
            UnityEngine.CoreModule.dll::UnityEngine::Windows::WebCam::
            VideoCapture+OnVideoCaptureResourceCreatedCallback::
            VideoCapture_OnVideoCaptureResourceCreatedCallback__ctor
            ...
            if (pDVar14 == (Delegate *)0x0) {
              ...
              (pMVar12->fields)._._.method_code = pDVar18;
              pDVar18 = (Delegate *)0x0;
              if ((MVRuntimeDataVariable_OnChangeDelegate__Class *)pDVar14->klass ==
                  TypeInfo__MVRuntimeDataVariable__OnChangeDelegate) {
                pDVar18 = pDVar14;
