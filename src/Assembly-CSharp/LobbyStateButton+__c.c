...
void Assembly-CSharp.dll::LobbyStateButton+<>c::LobbyStateButton_c__cctor(MethodInfo *method)

{
  ...
  pLVar1 = (LobbyStateButton_c *)FUN_?(TypeInfo__LobbyStateButton____c);
  TypeInfo__LobbyStateButton____c->static_fields->__9 = pLVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__LobbyStateButton____c->static_fields >> 0xc);
