    ...
    if (this_00 !=
      ...
      if (this_01 !=
        ...
        while( true ) {
          ...
          (*(code *)(DStack_10._currentValue)->klass[3]._1.typeHierarchy)
                    (DStack_10._currentValue,(DStack_10._currentValue)->klass[3]._1.unity_user_data)
          ;
        }
      }
    }
    ...
    if (this_00 !=
      ...
      if (this_01 !=
        ...
        while( true ) {
          ...
          if (DStack_10._currentValue == (Object *)0x0) break;
          (*(code *)(DStack_10._currentValue)->klass[2]._1.element_size)();
        }
      }
    }
  }
...
code_?:
    ...
    pGVar5 = (pPVar4->fields).mvMovingPlatformGroupPrefab;
    if (cRam_? == '\0') {
      func_?(&
    ...
    ppDVar6 = &(this->fields)._.idChildMap;
    *ppDVar6 = (Dictionary_2_System_Object_System_Object_ *)this_01;
    func_?(ppDVar6,this_01);
    MVGroup::MVGroup__ctor((MVGroup *)this,data,pGVar5,worldObjects,(MethodInfo *)0x0);
...
code_?:
      func_?();
      pGVar5 = (this->fields)._._._.gameObject;
      if (pGVar5 != (GameObject *)0x0) {
        ...
        ppLVar9 = &(this->fields).lineRenderer;
        *ppLVar9 = pLVar8;
        func_?(ppLVar9,pLVar8);
        piVar10 = &(this->fields)._._._.interactionFlags;
        *(uint *)piVar10 = (uint)*piVar10 | 0x9000;
        uVar11 = *(undefined4 *)((int)&(this->fields)._._._.interactionFlags + 4);
        piVar12 = &(this->fields)._._._.previewLayerMask;
    ...
    bVar13 = (TypeInfo__System__Collections__Generic__Dictionary<System::Object,_System::Object>->_1)
            .naturalAligment;
    if ((*(byte *)(*(int *)TVar7.m_Index + 0xb8) < bVar13) ||
       (*(Dictionary_2_System_Object_System_Object___Class **)
         (*(int *)(*(int *)TVar7.m_Index + 100) + -4 + (uint)bVar13 * 4) !=
        TypeInfo__System__Collections__Generic__Dictionary<System::Object,_System::Object>))
    goto code_?;
    (this->fields).nextNodeMap = (Dictionary_2_System_Object_System_Object_ *)TVar7.m_Index;
    bVar13 = (TypeInfo__System__Collections__Generic__Dictionary<System::Object,_System::Object>->_1)
            .naturalAligment;
    if ((bVar13 <= *(byte *)(*(int *)TVar7.m_Index + 0xb8)) &&
       (*(Dictionary_2_System_Object_System_Object___Class **)
         (*(int *)(*(int *)TVar7.m_Index + 100) + -4 + (uint)bVar13 * 4) ==
        TypeInfo__System__Collections__Generic__Dictionary<System::Object,_System::Object>))
    goto code_?;
