...

{
  ...
  pTVar1 = (TierBoostStateHandler_c *)FUN_?(TypeInfo__TierBoostStateHandler____c);
  TypeInfo__TierBoostStateHandler____c->static_fields->__9 = pTVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__TierBoostStateHandler____c->static_fields >> 0xc);
