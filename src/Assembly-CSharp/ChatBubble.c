      ...
      if (pTVar1 != (Transform *)0x0) {
        ...
        if ((pCVar2 != (ChatAnchor *)0x0) &&
          ...
          if (pTVar1 != (Transform *)0x0) {
            ...
            uVar7 = pVVar3->x;
            uVar8 = pVVar3->y;
            fVar9 = (float)uVar4 - (3.5587258e-29 - (float)uVar7);
            fVar10 = SUB84(uVar4,4) - (3.5587327e-29 - (float)uVar8);
            ...
            if ((pCVar2 != (ChatAnchor *)0x0) &&
              ...
              if (pTVar1 != (Transform *)0x0) {
                ...
                uVar14 = pVVar3->x;
                uVar15 = pVVar3->y;
                fVar9 = (float)uVar13 - ((float)uVar14 + 3.5587258e-29);
                fVar10 = SUB84(uVar13,4) - ((float)uVar15 + 3.5587327e-29);
                fVar5 = fVar5 - ((float)puVar6 + pVVar3->z);
                pCVar2 = (this->fields).anchor;
                ...
                if ((pCVar2 != (ChatAnchor *)0x0) &&
                  ...
                  if (pTVar1 != (Transform *)0x0) {
                    ...
                    uVar17 = pVVar3->x;
                    uVar18 = pVVar3->y;
                    fVar9 = (float)uVar16 - (3.5587258e-29 - (float)uVar17);
                    fVar19 = SUB84(uVar16,4) - (3.5587327e-29 - (float)uVar18);
          ...
          if (pRVar2 != (RectTransform *)0x0) {
            ...
            RectTransform_SetSizeWithCurrentAnchors
                      (pRVar2,RectTransform_Axis__Enum_Vertical,
                       (fVar5 - 3.5592955e-29) + pRVar3->m_Height,(MethodInfo *)0x0);
            return 1;
          }
        }
      }
          ...
          if (pRVar3 != (RectTransform *)0x0) {
            ...
            RectTransform_SetSizeWithCurrentAnchors
                      (pRVar3,RectTransform_Axis__Enum_Horizontal,
                       ((float)&stack0xffffffd4 - 3.5593846e-29) + pRVar7->m_Width,(MethodInfo *)0x0
                      );
            ChatBubble_PerformAutoHeight(this,(MethodInfo *)0x0);
            return;
          }
          ...
          if (pRVar2 != (RectTransform *)0x0) {
            ...
            RectTransform_SetSizeWithCurrentAnchors
                      (pRVar2,RectTransform_Axis__Enum_Horizontal,
                       (fVar5 - 3.5594842e-29) + pRVar3->m_Width,(MethodInfo *)0x0);
            return 1;
          }
        }
      }
...
code_?:
  iVar13 = func_?();
  puVar14 = (uint *)((CONCAT31((int3)((uint)iVar13 >> 8),
                              (byte)iVar13 | *(byte *)(iVar13 + -0x7f6fefcc)) ^ 0x10) +
                   in_stack_15);
  *puVar14 = *puVar14 ^ 0xADDR;
  pcVar16 = (code *)swi(3);
  (*pcVar16)();
  return;
}
...
code_?:
  uVar3 = func_?();
  LOCK();
  puVar4 = (undefined1 *)((int)uVar3 + (int)((ulonglong)uVar3 >> 0x20));
  uVar5 = *puVar4;
  *puVar4 = (char)((ulonglong)uVar3 >> 0x28);
  UNLOCK();
  LOCK();
  *(undefined1 *)
   ((int)uVar3 +
   CONCAT22((short)((ulonglong)uVar3 >> 0x30),CONCAT11(uVar5,(char)((ulonglong)uVar3 >> 0x20)))) =
       uVar5;
  UNLOCK();
  pcVar6 = (code *)swi(3);
  (*pcVar6)();
