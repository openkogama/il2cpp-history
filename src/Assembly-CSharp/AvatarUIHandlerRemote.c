...

{
  ...
  if (bVar3 != 0) {
    in_stack_4 = 0;
    in_stack_5 = (MVPlayerContainer *)&UNK_?;
    pMVar1 = MVGameControllerBase::MVGameControllerBase_get_Game((MethodInfo *)0x0);
    unaff_ESI = this;
    if (pMVar1 == (MVNetworkGame *)0x0) goto code_?;
    pMVar2 = (pMVar1->fields).playerContainer;
    if (pMVar2 == (MVPlayerContainer *)0x0) goto code_?;
    in_stack_4 = (this->fields)._.ownerActorNr;
    unaff_EDI = MVPlayerContainer::MVPlayerContainer_GetPlayerUnsafe
                          (pMVar2,in_stack_4,(MethodInfo *)0x0);
    in_stack_5 = pMVar2;
    if (unaff_EDI == (MVPlayer *)0x0) goto code_?;
    pUVar6 = (unaff_EDI->fields)._UserProfileData_k__BackingField;
    ...
    if (1 < iVar9) {
      ...
      case 0:
        in_stack_5 = (MVPlayerContainer *)0x0;
        in_stack_4 = 0;
        break;
      case 1:
        in_stack_4 = 0;
      ...
      case 2:
        ...
        break;
      case 3:
        in_stack_4 = 0x3f6bebec;
        uVar7 = 0x3c808081;
      }
    }
    while (this_02 = (unaff_ESI->fields).avatarNameMaterial, in_stack_8 = fStack10,
...
code_?:
      ...
      uVar13 = func_?();
      if (bVar11) {
        *(char *)(extraout_ECX + -0x6eefd152) =
             *(char *)(extraout_ECX + -0x6eefd152) + (byte)uVar13 + cVar12;
        *(char *)(extraout_ECX + -0x33efd152) =
             *(char *)(extraout_ECX + -0x33efd152) + (char)((ushort)uVar13 >> 8) +
             ((byte)uVar13 < *(byte *)&unaff_EDI->klass);
        pcVar14 = (code *)swi(3);
        (*pcVar14)();
        return;
      }
code_?:
    ...
    value.g = (float)in_stack_4;
    value.r = (float)in_stack_5;
    value.b = (float)uVar7;
    value.a = fStack10;
    UnityEngine.CoreModule.dll::UnityEngine::Material::Material_set_color
