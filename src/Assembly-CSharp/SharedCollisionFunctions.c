    ...
    if (0 < hitAmount) {
      ...
      do {
        ...
        pPStack_4 = (PhysicsCollisionDatasWrapper *)
                    RTG::SphereTreeNode`1[System::Object]::
                    SphereTreeNode_1_System_Object__get_Radius(this_00,(MethodInfo *)0x0);
...

{
  ...
  ppLVar2 = (List_1_PhysicsCollisionData_ **)&value->name;
  *ppLVar2 = (List_1_PhysicsCollisionData_ *)this_01;
  ...
  while (this != (List_1_PhysicsCollisionData_ *)0x0) {
    ...
    this_02 = (List_1_PhysicsCollisionData___Class *)*ppLVar2;
    ...
    iVar3 = iVar3 + 1;
    ppLVar2 = (List_1_PhysicsCollisionData_ **)&pMVar1->name;
    method_01 = this_02;
    this = *ppLVar2;
  }
  func_?();
