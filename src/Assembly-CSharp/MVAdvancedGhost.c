...

{
  ...
  if (this_00 != (AdvancedGhostBehaviour *)0x0) {
    ...
    if (this_01 != (Transform *)0x0) {
      ...
      fVar4 = pVVar1->z;
      if (cRam_? == '\0') {
        VStack_2.x = 3.3446888e-29;
        VStack_2.y = 2.4431413e-28;
        func_?();
        cRam_? = '\x01';
      }
...
code_?:
    ...
    *ppAVar9 = pAVar8;
    ...
    Func_1_System_Threading_Tasks_VoidTaskResult___ctor
              (this_03,(Object *)pCVar6,MethodInfo__ClientSideNPCInteractable__IsDead__,
               (MethodInfo *)0x0);
    if (pAVar8 == (AdvancedGhostBehaviour *)0x0) goto code_?;
    AdvancedGhostBehaviour::AdvancedGhostBehaviour_Init
              (pAVar8,(MVCubeModelBase *)pMStack_1,advancedGhostMotor,(Func_1_Boolean_ *)this_03,
    ...
    *ppAVar10 = this_04;
    ...
    if (MVar11 == MVGameMode__Enum_Edit) {
      ...
      pDVar13 = mscorlib.dll::System::Delegate::Delegate_Combine
                          ((Delegate *)pUVar12,(Delegate *)this_05,(MethodInfo *)0x0);
    ...
    if ((pAVar2 != (AdvancedGhostBehaviour *)0x0) && (TVar3.m_Index != 0)) {
      ...
      *(undefined3 *)&(pAVar2->fields).speed.field_0x11 = uVar11;
      ...
      (pAVar2->fields).perceptionRadius =
           (pAVar2->fields).speedPerceptionFactor * (float)this + fVar9;
      pDVar1 = (Dictionary_2_System_Object_UnityEngine_UIElements_TextureId_ *)
