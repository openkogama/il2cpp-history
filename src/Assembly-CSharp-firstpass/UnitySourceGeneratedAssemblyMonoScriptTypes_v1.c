...

{
  if (cRam_? == '\0') {
    ...
    func_?(&_8B5849F4618721830F1DE9511F27C52AEFCEDE525D7F4AA1C8C5F7B2ADB5E5DF_Field);
    func_?(&_9E73BE037E90043CA39B9BE1A6E8E6671255D39D59759C26CBAC22DA9D5208DE_Field);
    cRam_? = '\x01';
  }
  ...
  *(undefined4 *)&__return_storage_ptr__->IsEditorOnly = 0;
  pBVar1 = (Byte__Array *)func_?(TypeInfo__System__Byte,0xd21);
  ...
  pBVar1 = (Byte__Array *)func_?(TypeInfo__System__Byte,0x84f);
  mscorlib.dll::System::Runtime::CompilerServices::RuntimeHelpers::RuntimeHelpers_InitializeArray_1
            ((Array *)pBVar1,
