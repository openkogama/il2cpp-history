...

{
  ...
  face_00 = MVWorldObject.dll::MV::WorldObject::CubeBase::CubeBase_FaceFlagToFace
                      (0,(MethodInfo *)0x0);
  if (*neighborCube == (Cube *)0x0) goto code_?;
  faceFlagOpposite._0_1_ = 0xee;
  ...
  cube = (Cube **)&UNK_?;
  pVVar3 = Cube::Cube_GetFace_1((Vector3__Array *)neighborCube,face_00,(MethodInfo *)0x0);
  if ((TypeInfo__CubeModelChunk->_1).cctor_finished_or_no_cctor == 0) {
    func_?();
  }
  bVar2 = CubeModelChunk_AllFaceCornersIsTouchingCubeBorder
                    (face_00,(Vector3__Array **)&stack0xfffffff4,(MethodInfo *)0x0);
  if (bVar2 == 0) {
    return;
  }
  switch(face) {
  ...
  case Face__Enum_Bottom:
    ...
    do {
      ...
      bVar6 = uVar4 < pVVar1->max_length;
      if (!(bool)bVar6) goto code_?;
      if (pVVar3 == (Vector3__Array *)0x0) goto code_?;
      bVar6 = 3 - uVar4 < pVVar3->max_length;
      if (!(bool)bVar6) goto code_?;
      if (pVVar5->x != *(float *)((int)pVVar3 + (3 - uVar4) * 0xc + 0x10)) {
        return;
      }
      puStack7 = (undefined *)uVar4;
      iVar8 = func_?();
  ...
  case Face__Enum_Back:
    ...
    fVar11 = *pfVar10;
    pfVar10 = (float *)func_?();
    bVar12 = NAN(fVar11) || NAN(*pfVar10);
    bVar13 = fVar11 == *pfVar10;
    break;
  ...
  case Face__Enum_Right:
    ...
    fVar11 = *(float *)(iVar8 + 8);
    iVar8 = func_?();
    bVar12 = NAN(fVar11) || NAN(*(float *)(iVar8 + 8));
    bVar13 = fVar11 == *(float *)(iVar8 + 8);
    break;
  default:
    goto code_?;
  }
...
code_?:
      ...
      out(uVar16,(char)uVar15);
      bVar17 = (byte)((uint6)uVar15 >> 8);
      bVar18 = extraout_CL + bVar17;
      out(uVar16,(char)uVar15);
      pcVar19 = (char *)((int)uVar15 + -0x77ef9710);
      *pcVar19 = *pcVar19 + bVar18 + bVar6 + (CARRY1(extraout_CL,bVar17) || CARRY1(bVar18,bVar6));
...

{
  ...
  bVar10 = bVar8 - bVar9;
  iVar11 = CONCAT31((int3)((uint)extraout_EDX >> 8),bVar10);
  bVar12 = (byte)((uint)pVVar4 >> 8);
  bVar13 = *pbVar3 + bVar12;
  bVar14 = CARRY1(*pbVar3,bVar12) || CARRY1(bVar13,bVar8 < bVar9);
  *pbVar3 = bVar13 + (bVar8 < bVar9);
  pbVar15 = (byte *)(iVar11 + 0x68 + (int)pbVar3 * 8);
  bVar13 = *pbVar15;
  bVar8 = *pbVar15;
  *pbVar15 = bVar8 + bVar10 + bVar14;
  pcVar16 = (char *)(iVar11 + 0x68 + (int)pbVar3 * 8);
  *pcVar16 = *pcVar16 + (char)pVVar4 + (CARRY1(bVar13,bVar10) || CARRY1(bVar8 + bVar10,bVar14));
  pcVar17 = (code *)swi(3);
  bVar18 = (*pcVar17)(0x68f22f10);
  return bVar18;
}
