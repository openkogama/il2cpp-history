...

{
  ...
  if (bVar2 != 0) {
    ...
    (pAVar1->fields).wantsVisible = !isPlayMode;
    ...
    UnityEngine.CoreModule.dll::UnityEngine::GameObject::GameObject_SetActive
              (this_01,bVar2 != 0,(MethodInfo *)0x0);
  }
  ...
  if (this_00 != (AdvancedGhostBehaviour *)0x0) {
    ...
    if (pAVar3 != (AdvancedGhostCubeModelWrapper *)0x0) {
      if ((pAVar3->fields).cubeModelIsBeingEdited == 0) {
        return;
      }
      ...
      if (pAVar3 != (AdvancedGhostCubeModelWrapper *)0x0) {
        ...
        pAVar3 = (this->fields).editableCubeModelWrapper;
        if (((pAVar3 != (AdvancedGhostCubeModelWrapper *)0x0) &&
            (pMVar4 = (pAVar3->fields)._.cubeModelBase, pMVar4 != (MVCubeModelInstance *)0x0)) &&
           ((pMVar4->fields)._._.gameObject != (GameObject *)0x0)) {
          if (pcRam_? == (code *)0x0) {
            pcRam_? = (code *)func_?();
          }
          (*pcRam_?)();
...

{
  ...
  if (this_00 != (AdvancedGhostBehaviour *)0x0) {
    ...
    if (this_01 != (Transform *)0x0) {
      ...
      fVar4 = pVVar1->z;
      if (cRam_? == '\0') {
        VStack_2.x = 3.346711e-29;
        VStack_2.y = 2.446402e-28;
        func_?();
        cRam_? = '\x01';
      }
...
code_?:
  ...
  func_?(&(this->fields).interactionHandler,pCVar3);
  ...
  pCVar3 = (this->fields).interactionHandler;
  if (pCVar3 == (ClientSideNPCInteractionHandler *)0x0) goto code_?;
  pGVar2 = (pCVar3->fields).attachmentObjectForHealRay;
  (this->fields).attachmentObject = pGVar2;
  func_?(&(this->fields).attachmentObject,pGVar2);
  pGVar2 = (this->fields)._._._.gameObject;
  if (pGVar2 == (GameObject *)0x0) goto code_?;
  pCVar4 = (ClientSideNPCInteractable *)
           UnityEngine.CoreModule.dll::UnityEngine::GameObject::GameObject_AddComponent_1
                     (pGVar2,
                      ClientSideNPCInteractable_MethodInfo__UnityEngine__GameObject__AddComponent<ClientSideNPCInteractable>__
                     );
  (this->fields).interactable = pCVar4;
  func_?(&(this->fields).interactable,pCVar4);
  pCVar4 = (this->fields).interactable;
  ...
  mscorlib.dll::System::Action`3[Single,Object,ByteEnum]::Action_3_Single_Object_ByteEnum___ctor
            (this_02,(Object *)this,
             MethodInfo__MVAdvancedGhost__ReceiveDamage_float__MVPlayer__MV__Common__PlayerKilledByType_
             ,(MethodInfo *)0x0);
  if (pCVar4 == (ClientSideNPCInteractable *)0x0) goto code_?;
  ClientSideNPCInteractable::ClientSideNPCInteractable_Init
            (pCVar4,(Action_3_Single_MVPlayer_MV_Common_PlayerKilledByType_ *)this_02,
             (MethodInfo *)0x0);
  pGVar2 = (this->fields)._._._.gameObject;
  if (pGVar2 == (GameObject *)0x0) goto code_?;
  advancedGhostMotor =
  ...
  pGVar2 = (this->fields)._._._.gameObject;
  if (pGVar2 == (GameObject *)0x0) goto code_?;
  pAVar5 = (AdvancedGhostBehaviour *)
           UnityEngine.CoreModule.dll::UnityEngine::GameObject::GameObject_GetComponentInChildren_1
                     (pGVar2,
                      AdvancedGhostBehaviour_MethodInfo__UnityEngine__GameObject__GetComponentInChildren<AdvancedGhostBehaviour>__
                     );
  (this->fields).advancedGhostBehaviour = pAVar5;
  func_?(&(this->fields).advancedGhostBehaviour,pAVar5);
  pAVar5 = (this->fields).advancedGhostBehaviour;
  pCVar4 = (this->fields).interactable;
  ...
  Func_1_System_Threading_Tasks_VoidTaskResult___ctor
            (this_03,(Object *)pCVar4,MethodInfo__ClientSideNPCInteractable__IsDead__,
             (MethodInfo *)0x0);
  if (pAVar5 == (AdvancedGhostBehaviour *)0x0) goto code_?;
  AdvancedGhostBehaviour::AdvancedGhostBehaviour_Init
            (pAVar5,(MVCubeModelBase *)pMStack_1,advancedGhostMotor,(Func_1_Boolean_ *)this_03,
             (this->fields)._._._._.id,(MethodInfo *)0x0);
  pAVar5 = (this->fields).advancedGhostBehaviour;
  if ((pAVar5 == (AdvancedGhostBehaviour *)0x0) ||
     (this_00 = (pAVar5->fields).GhostVisualization, this_00 == (AdvancedGhostVisualizaton *)0x0))
  goto code_?;
  transformParent =
  ...
  AdvancedGhostCubeModelWrapper::AdvancedGhostCubeModelWrapper__ctor
            (this_04,pMStack_1,transformParent,(MethodInfo *)0x0);
  ...
  pAVar5 = (this->fields).advancedGhostBehaviour;
  if ((pAVar5 == (AdvancedGhostBehaviour *)0x0) || (advancedGhostMotor == (AdvancedGhostMotor *)0x0)
     ) goto code_?;
  AdvancedGhostMotor::AdvancedGhostMotor_Init
            (advancedGhostMotor,pGVar2,(MVInteractableBase *)(this->fields).interactable,
             (pAVar5->fields).cullingSubscriberBase,(MethodInfo *)0x0);
  ...
  if (MVar6 == MVGameMode__Enum_Edit) {
    ...
    pDVar8 = mscorlib.dll::System::Delegate::Delegate_Combine
                       ((Delegate *)pUVar7,(Delegate *)this_05,(MethodInfo *)0x0);
...
code_?:
  ...
  if ((pMVar10 != (MVNetworkGame *)0x0) &&
     (this_01 = (pMVar10->fields)._GameStateController_k__BackingField,
...

{
  ...
  if (pDVar1 != (Dictionary_2_System_Object_UnityEngine_UIElements_TextureId_ *)0x0) {
    ...
    if ((pAVar2 != (AdvancedGhostBehaviour *)0x0) && (TVar3.m_Index != 0)) {
      ...
      AdvancedGhostBehaviour::AdvancedGhostBehaviour_set_Speed(pAVar2,*pfVar5,(MethodInfo *)0x0);
      pDVar1 = (Dictionary_2_System_Object_UnityEngine_UIElements_TextureId_ *)
      ...
      if (pDVar1 != (Dictionary_2_System_Object_UnityEngine_UIElements_TextureId_ *)0x0) {
        ...
        if ((pAVar2 != (AdvancedGhostBehaviour *)0x0) && (TVar3.m_Index != 0)) {
          if (*(Il2CppClass **)(*(int *)TVar3.m_Index + 0x20) !=
              (TypeInfo__System__Single->_0).element_class) goto code_?;
          pfVar5 = (float *)func_?(TVar3.m_Index);
          (pAVar2->fields).radius = *pfVar5;
          pAVar6 = (this_01->fields).advancedGhostIcon;
          if ((TypeInfo__UnityEngine__Object->_1).cctor_finished_or_no_cctor == 0) {
            func_?(TypeInfo__UnityEngine__Object);
          }
...
code_?:
              MVar10 = MVAdvancedGhost_get_Team(this_01,(MethodInfo *)0x0);
              if (MVar10 == MVTeam__Enum_None) {
                ...
                MVar10 = MVAdvancedGhost_get_Team(this_01,(MethodInfo *)0x0);
                pAVar11 = (this_01->fields).advGhostObject;
                if ((pAVar11 != (AdvancedGhostObject *)0x0) &&
                   (pAVar12 = (pAVar11->fields).tintObject, pAVar12 != (AdvancedGhostTintObject *)0x0))
                {
                  (*(code *)(pAVar12->klass->vtable).TeamTint.method)(pAVar12,MVar10);
                  pAVar2 = (this_01->fields).advancedGhostBehaviour;
                  if (pAVar2 != (AdvancedGhostBehaviour *)0x0) {
                    AdvancedGhostBehaviour::AdvancedGhostBehaviour_set_Team
                              (pAVar2,MVar10,(MethodInfo *)0x0);
                    pCVar13 = (this_01->fields).interactionHandler;
                    if (pCVar13 != (ClientSideNPCInteractionHandler *)0x0) {
                      (pCVar13->fields).team = MVar10;
                      MVar9 = MVGameControllerBase::MVGameControllerBase_get_GameMode
                                         ((MethodInfo *)0x0);
                      if (MVar9 == MVGameMode__Enum_Edit) {
                        pAVar6 = (this_01->fields).advancedGhostIcon;
                        if (pAVar6 == (AdvancedGhostIcon *)0x0) goto code_?;
                        AdvancedGhostIcon::AdvancedGhostIcon_set_Team
                                  (pAVar6,MVar10,(MethodInfo *)0x0);
                      }
code_?:
                      pAVar2 = (this_01->fields).advancedGhostBehaviour;
                      if (pAVar2 != (AdvancedGhostBehaviour *)0x0) {
                          ...
                          if (pDVar1 != (Dictionary_2_System_Object_UnityEngine_UIElements_TextureId_
                            ...
                            if ((pAVar2 != (AdvancedGhostBehaviour *)0x0) && (TVar3.m_Index != 0)) {
                              if (*(Il2CppClass **)(*(int *)TVar3.m_Index + 0x20) ==
                                ...
                                piVar14 = (int32_t *)func_?(TVar3.m_Index);
                                AdvancedGhostBehaviour::AdvancedGhostBehaviour_set_Lives
                                          (pAVar2,*piVar14,(MethodInfo *)0x0);
                                return;
                              }
                              goto code_?;
                            }
...

{
  ...
  if (this_00 != (ClientSideNPCInteractable *)0x0) {
    ...
    if (pPVar3 != (PrefabPool *)0x0) {
      particlePrefab = (pPVar3->fields).particleExplosion;
      pAVar1 = (this->fields).advancedGhostBehaviour;
...

{
  ...
  if ((pAVar1 != (AdvancedGhostObject *)0x0) &&
    ...
    this_00 = (this->fields).advancedGhostBehaviour;
    if (this_00 != (AdvancedGhostBehaviour *)0x0) {
      AdvancedGhostBehaviour::AdvancedGhostBehaviour_set_Team(this_00,team,(MethodInfo *)0x0);
      pCVar3 = (this->fields).interactionHandler;
      if (pCVar3 != (ClientSideNPCInteractionHandler *)0x0) {
        (pCVar3->fields).team = team;
        MVar4 = MVGameControllerBase::MVGameControllerBase_get_GameMode((MethodInfo *)0x0);
        if (MVar4 == MVGameMode__Enum_Edit) {
          this_01 = (this->fields).advancedGhostIcon;
          if (this_01 == (AdvancedGhostIcon *)0x0) goto code_?;
          AdvancedGhostIcon::AdvancedGhostIcon_set_Team(this_01,team,(MethodInfo *)0x0);
        }
        return;
      }
    }
