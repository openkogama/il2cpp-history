...

{
  ...
  pFVar1 = (FirstTimeElementActivator_c *)FUN_?(TypeInfo__FirstTimeElementActivator____c);
  TypeInfo__FirstTimeElementActivator____c->static_fields->__9 = pFVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__FirstTimeElementActivator____c->static_fields >> 0xc);
