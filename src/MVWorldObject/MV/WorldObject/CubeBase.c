...
code_?:
  ...
  *extraout_ECX = *extraout_ECX + bVar7;
  ...
  bVar10 = bVar9 + bVar8;
  bVar11 = CARRY1(bVar9,bVar8) || CARRY1(bVar10,CARRY1(bVar6,bVar7));
  uVar12 = CONCAT11(bVar10 + CARRY1(bVar6,bVar7),bVar8);
  uVar13 = in(uVar12);
  pVVar14 = pVVar1[0x47b8e9].vector + 0x1a;
  bVar6 = *(byte *)&pVVar14->x;
  bVar7 = (byte)((uint)uVar13 >> 8);
  bVar10 = *(char *)&pVVar14->x + bVar7;
  *(byte *)&pVVar14->x = bVar10 + bVar11;
  uVar13 = in(uVar12);
  *(char *)corners = *(char *)corners + (char)uVar13 + (CARRY1(bVar6,bVar7) || CARRY1(bVar10,bVar11));
  in((short)corners);
  pcVar15 = (code *)swi(3);
  (*pcVar15)();
  return;
