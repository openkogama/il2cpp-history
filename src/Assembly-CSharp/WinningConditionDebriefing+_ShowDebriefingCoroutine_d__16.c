...

{
  ...
  func_?();
  puVar6 = (undefined1 *)((int)&this_00[-0x7de654]._1.cctor_thread + 1);
  pcVar7 = (char *)(CONCAT31((int3)((uint)extraout_EDX >> 8),(byte)extraout_EDX - *puVar6) + -0x6c);
  *pcVar7 = *pcVar7 + extraout_CL + -1 + ((byte)extraout_EDX < (byte)*puVar6);
  pcVar8 = (code *)swi(3);
  bVar9 = (*pcVar8)();
  return bVar9;
}
