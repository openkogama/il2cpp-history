...

{
  if (cRam_? == '\0') {
    ...
    LOCK();
    UNLOCK();
    FUN_?(&TypeInfo__ClientShopButton____c);
    LOCK();
    UNLOCK();
    cRam_? = '\x01';
  }
  ...
  if (*(int *)&(TypeInfo__ClientShopButton____c->_1).field_0x1c == 0) {
    FUN_?(TypeInfo__ClientShopButton____c);
  }
  this_01 = TypeInfo__ClientShopButton____c->static_fields->__9__0_0;
  if (this_01 == (ExecuteEvents_EventFunction_1_IOpenClientShop_ *)0x0) {
    if (*(int *)&(TypeInfo__ClientShopButton____c->_1).field_0x1c == 0) {
      FUN_?(TypeInfo__ClientShopButton____c);
    }
    object = TypeInfo__ClientShopButton____c->static_fields->__9;
    this_01 = (ExecuteEvents_EventFunction_1_IOpenClientShop_ *)
              FUN_?(
                           TypeInfo__UnityEngine__EventSystems__ExecuteEvents__EventFunction<UnityEngine::EventSystems::IOpenClientShop>
                           );
    ...
    ExecuteEvents_EventFunction_1_System_Object___ctor
              ((ExecuteEvents_EventFunction_1_System_Object_ *)this_01,(Object *)object,
               MethodInfo__ClientShopButton____c___OnClick_b__0_0_UnityEngine__EventSystems__IOpenClientShop__UnityEngine__EventSystems__BaseEventData_
               ,(MethodInfo *)0x0);
    TypeInfo__ClientShopButton____c->static_fields->__9__0_0 = this_01;
    if (iRam_? != 0) {
      uVar2 = (uint)((ulonglong)&TypeInfo__ClientShopButton____c->static_fields->__9__0_0 >> 0xc);
