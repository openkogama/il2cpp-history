...

{
  ...
  pMStack_2 = (pMVar1->klass->vtable).__unknown_8.method;
  ...
  if (0.0 < (this->fields)._.DirectInputMoveMap.z) {
    ...
    if ((float)pQVar20 < (float)pMStack_2) {
      pQStack_6 = pQVar20;
      fVar29 = UnityEngine.CoreModule.dll::UnityEngine::Time::Time_1_get_fixedDeltaTime
                         ((MethodInfo *)0x0);
  ...
  if (*pfVar44 <= 0.0 && *pfVar44 != 0.0) {
    ...
    if (_UNK_? < (float)pQVar20) {
      ...
      fVar30 = UnityEngine.CoreModule.dll::UnityEngine::Time::Time_1_get_fixedDeltaTime
                         ((MethodInfo *)0x0);
      fVar29 = _UNK_?;
      (this->fields).speed = (float)pQStack_6 - fVar30 * _UNK_?;
    }
    pfVar44 = &(this->fields).speed;
    if (*pfVar44 <= fVar29 && fVar29 != *pfVar44) {
