...

{
  ...
  bVar15 = CARRY1(bVar13,extraout_CH) || CARRY1(bVar14,bVar5);
  bVar13 = (byte)((ulonglong)uVar12 >> 0x20);
  pbVar16 = (byte *)CONCAT22((short)((ulonglong)uVar12 >> 0x30),CONCAT11(bVar14 + bVar5,bVar13));
  bVar5 = *pbVar16 + (byte)uVar12;
  bVar17 = CARRY1(*pbVar16,(byte)uVar12) || CARRY1(bVar5,bVar15);
  *pbVar16 = bVar5 + bVar15;
  bVar5 = *pbVar3;
  bVar14 = *pbVar3;
  *pbVar3 = bVar14 + bVar13 + bVar17;
  cRam_? = cRam_? + unaff_BL + (CARRY1(bVar5,bVar13) || CARRY1(bVar14 + bVar13,bVar17));
  pcVar18 = (code *)swi(3);
  bVar19 = (*pcVar18)();
  return bVar19;
}
