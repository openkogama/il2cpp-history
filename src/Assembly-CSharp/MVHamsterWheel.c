...

{
  ...
  if (pGVar1 != (GameObject *)0x0) {
    ...
    if (this_01 != (SmoothCharacterController *)0x0) {
      ...
      unaff_EDI = (MvCharacterController *)0x0;
      if (pMVar2 != (MvCharacterController *)0x0) {
        center.y = (float)uVar5 * _UNK_?;
        center.x = (float)uVar4 * _UNK_?;
        center.z = (pVVar3->upVector).z * _UNK_?;
        MvCharacterController::MvCharacterController_Init(pMVar2,1.5,3.0,center,(MethodInfo *)0x0);
        unaff_EDI = (this_01->fields).controller;
        pHVar6 = MVWorldObjectClient::MVWorldObjectClient_get_WorldIDsRecursive
                           ((MVWorldObjectClient *)this,(MethodInfo *)0x0);
        if (unaff_EDI != (MvCharacterController *)0x0) {
          (unaff_EDI->fields).IgnoreWoIds = pHVar6;
          func_?();
          pGVar1 = (this->fields)._._._._._.gameObject;
          if (pGVar1 != (GameObject *)0x0) {
               ...
               this_00 != (List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)0x0))
            {
              ...
              if (RVar8 != (RegexCharClass_SingleRange)0x0) {
                unaff_EDI = *(MvCharacterController **)((int)RVar8 + 0x14);
                iVar9 = func_?(unaff_EDI,TypeInfo__IVehicleCamera);
                if (iVar9 == 0) {
                ...
                if (pMVar2 != (MvCharacterController *)0x0) {
                  ...
                  if (unaff_EDI == (MvCharacterController *)0x0) {
                    ...
                    fVar11 = (float)func_?(unaff_EDI,TypeInfo__IVehicleCamera);
                    if (fVar11 == 0.0) goto code_?;
                  }
                  (pMVar2->fields).radiusBase.x = fVar11;
                  func_?(&(pMVar2->fields).radiusBase,fVar11);
                  this_02 = (MVSimpleOneSeatVehicle_LocalObjectsSimpleVehicle *)
                            func_?(TypeInfo__MVHamsterWheel__LocalObjectsHamsterWheel);
                  unaff_EDI = pMVar2;
                  if (this_02 != (MVSimpleOneSeatVehicle_LocalObjectsSimpleVehicle *)0x0) {
                    MVSimpleOneSeatVehicle+LocalObjectsSimpleVehicle::
                    MVSimpleOneSeatVehicle_LocalObjectsSimpleVehicle__ctor
                              (this_02,(MVSimpleOneSeatVehicle *)this,this_01,
                               (SimpleVehicleMotorBase *)pMVar2,(MethodInfo *)0x0);
...
code_?:
    ...
    (this->fields).IsMovingForward = pMVar3;
    func_?(&(this->fields).IsMovingForward,pMVar3);
    pMVar1 = (this->fields)._._._._._.runtimeDataVariables;
    if (pMVar1 == (MVRuntimeDataVariables *)0x0) goto code_?;
    pMVar3 = MVRuntimeDataVariables::MVRuntimeDataVariables_New
                       (pMVar1,StringLiteral_isMovingBackwards,2.0,0,(MethodInfo *)0x0);
    (this->fields).IsMovingBackwards = pMVar3;
    func_?(&(this->fields).IsMovingBackwards,pMVar3);
    pMVar1 = (this->fields)._._._._._.runtimeDataVariables;
    if (pMVar1 == (MVRuntimeDataVariables *)0x0) goto code_?;
    pMVar3 = MVRuntimeDataVariables::MVRuntimeDataVariables_New
                       (pMVar1,StringLiteral_isGrounded,2.0,0,(MethodInfo *)0x0);
    (this->fields).IsGrounded = pMVar3;
    func_?(&(this->fields).IsGrounded,pMVar3);
    ...
    cVar5 = (*(this->klass->vtable).get_IsInSpawner.methodPtr)
    ...
    if (cVar5 == '\0') {
      ...
      if (pGVar4 != (GameObject *)0x0) {
        ...
        if (this_00 != (HamsterWheelVisualization *)0x0) {
          ...
          this_01 = (CullingSubscriberDynamic *)func_?(TypeInfo__CullingSubscriberDynamic);
          unaff_EBX = (MVRuntimeDataVariable *)0x0;
          if (this_01 != (CullingSubscriberDynamic *)0x0) {
            ...
            func_?(&(this->fields).cullingSubscriberDynamic,this_01);
...
code_?:
    unaff_EBX = (this->fields)._._.IsVehicleDead;
    if (unaff_EBX == (MVRuntimeDataVariable *)0x0) goto code_?;
    pMVar6 = (unaff_EBX->fields).OnChange;
    ...
    pMVar7 = (MVRuntimeDataVariable_OnChangeDelegate *)
             mscorlib.dll::System::Delegate::Delegate_Combine
                       ((Delegate *)pMVar6,(Delegate *)this_02,(MethodInfo *)0x0);
    uVar8 = CONCAT44(TypeInfo__MVRuntimeDataVariable__OnChangeDelegate,pMVar7);
    pMVar6 = (MVRuntimeDataVariable_OnChangeDelegate *)0x0;
    if (pMVar7 == (MVRuntimeDataVariable_OnChangeDelegate *)0x0) {
      (unaff_EBX->fields).OnChange = (MVRuntimeDataVariable_OnChangeDelegate *)0x0;
    }
    else {
      ...
      (unaff_EBX->fields).OnChange = pMVar6;
      uVar8 = CONCAT44(TypeInfo__MVRuntimeDataVariable__OnChangeDelegate,pMVar7);
      pMVar6 = (MVRuntimeDataVariable_OnChangeDelegate *)0x0;
      if (pMVar7->klass == TypeInfo__MVRuntimeDataVariable__OnChangeDelegate) {
        pMVar6 = pMVar7;
    ...
    func_?(&(unaff_EBX->fields).OnChange,pMVar6);
    if (this_00 == (HamsterWheelVisualization *)0x0) goto code_?;
    pGVar4 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_gameObject
                       ((Component *)this_00,(MethodInfo *)0x0);
    if (pGVar4 == (GameObject *)0x0) goto code_?;
    ...
    unaff_EBX = (MVRuntimeDataVariable *)(this->fields)._._._._._._.type;
    ...
    this_03 = MVWorldObject.dll::MV::WorldObject::RuntimeVariablesRepository::
              RuntimeVariablesRepository_GetRuntimeVariables
                        ((WorldObjectType__Enum)unaff_EBX,(MethodInfo *)0x0);
    if (this_03 == (Dictionary_2_System_Object_System_Object_ *)0x0) goto code_?;
    unaff_EBX = (MVRuntimeDataVariable *)
    ...
    pMVar3 = (this->fields).IsMovingForward;
    ...
    if ((((Object__Class *)unaff_EBX->klass)->_0).element_class ==
        (TypeInfo__System__Single->_0).element_class) {
      pfVar9 = (float *)func_?(unaff_EBX);
      HamsterWheelVisualization::HamsterWheelVisualization_Init
                (this_00,vehicleSeatManager,*pfVar9,health,pMVar3,isMovingBackwards,isGrounded,
                 isInSpawner,(MethodInfo *)0x0);
      (this->fields)._._.visualization = (VehicleVisualizationBase *)this_00;
      func_?(&(this->fields)._._.visualization,this_00);
      return;
    }
  }
  uVar8 = func_?(unaff_EBX,pSVar2);
code_?:
  func_?(uVar8);
  pcVar10 = (code *)swi(3);
  (*pcVar10)();
...

{
  ...
  if (isDead != (Object *)0x0) {
    ...
    if ((pGVar7 != (GameObject *)0x0) &&
      ...
      puVar10 = (undefined *)pQVar9->x;
      ppVVar11 = (Vector3__Class **)pQVar9->y;
      fVar12 = pQVar9->z;
      fVar13 = pQVar9->w;
      if (cRam_? == '\0') {
      ...
      rotation.y = (float)ppVVar11;
      rotation.x = (float)puVar10;
      rotation.z = fVar12;
      rotation.w = fVar13;
      pVVar14 = UnityEngine.CoreModule.dll::UnityEngine::Quaternion::Quaternion_op_Multiply_1
                          ((Vector3 *)&stack0xffffffcc,rotation,
                           TypeInfo__UnityEngine__Vector3->static_fields->forwardVector,
                           (MethodInfo *)0x0);
      uVar15 = pVVar14->x;
      uVar16 = pVVar14->y;
      fVar12 = (float)uVar15 + (float)uVar4;
      fVar13 = (float)uVar16 + (float)uVar5;
      ...
      if ((this->fields)._._.localObjects == (MVVehicleBase_LocalObjectsBase *)0x0) {
        ...
        if (pPVar17 != (PrefabPool *)0x0) {
          ...
          if ((pGVar7 != (GameObject *)0x0) &&
            ...
            uVar20 = pVVar14->y;
            fVar21 = pVVar14->z;
            fVar22 = (this->fields).deathExplosionDamageValue;
            fVar23 = (this->fields).deathExplosionRadius;
            fVar24 = (this->fields).deathExplosionImpulse;
            if ((TypeInfo__SharedWorldObjectGameplayFunctions__Explosion->_1).
                cctor_finished_or_no_cctor == 0) {
              func_?();
            }
            position_00.y = (float)uVar20 + fVar13;
            position_00.x = (float)uVar19 + fVar12;
            ...
            SharedWorldObjectGameplayFunctions_Explosion_Explode
                      (pPVar18,position_00,fVar22,fVar23,fVar24,1,(ExplosionEvent *)0x0,ignoreIDs,
                       (MethodInfo *)0x0);
            return;
          }
        }
        ...
        if ((pGVar7 != (GameObject *)0x0) &&
          ...
          if (this_00 != (ExplosionEvent *)0x0) {
            worldPosition.z = fVar22 + fVar6;
            worldPosition.x = (float)uVar25 + fVar12;
            worldPosition.y = (float)uVar26 + fVar13;
            ...
            if (pPVar17 != (PrefabPool *)0x0) {
              ...
              if ((pGVar7 != (GameObject *)0x0) &&
                ...
                position.y = (float)uVar28 + fVar13;
                position.x = (float)uVar27 + fVar12;
                position.z = fVar21 + fVar6;
                SharedWorldObjectGameplayFunctions+Explosion::
                SharedWorldObjectGameplayFunctions_Explosion_Explode
                          (pPVar18,position,fVar22,fVar23,fVar24,0,this_00,ignoreIDs,(MethodInfo *)0x0
                          );
                return;
              }
            }
