...
code_?:
    ...
    if (pDVar8 == (Delegate *)0x0) {
      (pAVar7->vtable).Equals.method = (MethodInfo *)0x0;
code_?:
      func_?();
code_?:
    ...
    pMVar9 = (MethodInfo *)func_?();
    if (pMVar9 == (MethodInfo *)0x0) goto code_?;
    (pAVar7->vtable).Equals.method = pMVar9;
    iVar10 = func_?();
...
code_?:
    ...
    if (unaff_ESI == (Delegate *)0x0) {
      pDStack5 = (Delegate *)&(pMVar1->fields).OnWinningConditionFulfilled;
      *(Action_1_IWinningCondition_ **)pDStack5 = (Action_1_IWinningCondition_ *)0x0;
    ...
    unaff_EDI = (Action_1_IWinningCondition___Class *)&(pMVar1->fields).OnWinningConditionFulfilled;
    *(Action_1_IWinningCondition_ **)unaff_EDI = pAVar4;
    ...
    if (pAStack6 != (Action_1_IWinningCondition___Class *)0x0) {
      pDStack5 = (Delegate *)unaff_EDI;
      func_?();
      return;
    }
  }
  pDStack5 = unaff_ESI;
  pAStack6 = (Action_1_IWinningCondition___Class *)this;
  func_?();
code_?:
  pDStack5 = unaff_ESI;
  pAStack6 = unaff_EDI;
...
code_?:
      ppMVar3 = &(this->fields).pickupObject;
      func_?(ppMVar3);
      ...
      *(undefined4 *)((int)&(this->fields)._._.interactionFlags + 4) = uVar4;
      if (*ppMVar3 != (MVGameCoinObject *)0x0) {
        pTVar6 = ((*ppMVar3)->fields).triggerBoxEvents;
        if ((TypeInfo__UnityEngine__Object->_1).cctor_finished_or_no_cctor == 0) {
          func_?(TypeInfo__UnityEngine__Object);
        }
...
code_?:
            if ((this->fields).isVisible == 0) {
              if ((*ppMVar3 == (MVGameCoinObject *)0x0) ||
                 (this_00 = ((*ppMVar3)->fields).pickupItem, this_00 == (GreyOutObjectScript *)0x0)
                 ) goto code_?;
              GreyOutObjectScript::GreyOutObjectScript_GreyIn(this_00,(MethodInfo *)0x0);
              (this->fields).isVisible = 1;
            }
            ...
            if ((pMVar10 != (MVNetworkGame *)0x0) &&
               (this_01 = (pMVar10->fields)._GameCoinManager_k__BackingField,
        ...
        else if (*ppMVar3 != (MVGameCoinObject *)0x0) {
          pTVar6 = ((*ppMVar3)->fields).triggerBoxEvents;
          ...
          if (pTVar6 != (TriggerBoxEvents *)0x0) {
            TriggerBoxEvents::TriggerBoxEvents_add_TriggerEnter
                      (pTVar6,(EventHandler_1_TriggerEventArgs_ *)this_02,(MethodInfo *)0x0);
            goto code_?;
          }
        }
      }
    ...
    bVar11 = (TypeInfo__MVGameCoinObject->_1).naturalAligment;
