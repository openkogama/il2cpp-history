...
void Assembly-CSharp.dll::FirstTimeActivatableTeamNamePopup+<GetItemSlot>c__AnonStorey1::
     FirstTimeActivatableTeamNamePopup_GetItemSlot_c_AnonStorey1___m__0
               (FirstTimeActivatableTeamNamePopup_GetItemSlot_c_AnonStorey1 *this,
...

{
  ...
  if (pFVar1 != (FirstTimeActivatableTeamNamePopup *)0x0) {
