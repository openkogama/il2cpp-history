...

{
  ...
  (pAVar1->fields).pitchRotation.x = fVar3;
  (pAVar1->fields).pitchRotation.y = fVar4;
  (pAVar1->fields).pitchRotation.z = fVar5;
  (pAVar1->fields).pitchRotation.w = fVar6;
  mscorlib.dll::System::ThrowHelper::ThrowHelper_1_IfNullAndNullsAreIllegalThenThrow_55
            ((Object *)pAVar1,ExceptionArgument__Enum_obj,(MethodInfo *)enabledChangeHandler);
...
code_?:
    ...
    pAVar7 = (AvatarLimbManagerLocal_AvatarPointingHandlerLocal *)
             func_?(TypeInfo__AvatarLimbManagerLocal__AvatarPointingHandlerLocal);
    if (cRam_? == '\0') {
      func_?();
      cRam_? = '\x01';
    ...
    fVar4 = (pQVar2->identityQuaternion).z;
    fVar5 = (pQVar2->identityQuaternion).w;
    (pAVar7->fields).yawRotation.x = (pQVar2->identityQuaternion).x;
    (pAVar7->fields).yawRotation.y = fVar3;
    (pAVar7->fields).yawRotation.z = fVar4;
    (pAVar7->fields).yawRotation.w = fVar5;
    if (cRam_? == '\0') {
      func_?();
      cRam_? = '\x01';
    }
    ...
    (pAVar7->fields)._.shouldPoint = 1;
    (pAVar7->fields)._.isActive = 1;
    (pAVar7->fields).pitchRotation.x = fVar3;
    (pAVar7->fields).pitchRotation.y = fVar4;
    (pAVar7->fields).pitchRotation.z = fVar5;
    (pAVar7->fields).pitchRotation.w = fVar6;
    mscorlib.dll::System::ThrowHelper::ThrowHelper_1_IfNullAndNullsAreIllegalThenThrow_55
              ((Object *)pAVar7,ExceptionArgument__Enum_obj,in_stack_8);
    (this->fields).pointingHandler = pAVar7;
    func_?();
    pAVar7 = (this->fields).pointingHandler;
    if (pAVar7 == (AvatarLimbManagerLocal_AvatarPointingHandlerLocal *)0x0) goto code_?;
    (*(code *)(pAVar7->klass->vtable).Initialize.method)();
    pAVar9 = (AvatarLimbManager_AvatarEmoteHandler *)func_?();
    if (cRam_? == '\0') {
      func_?();
      func_?();
      cRam_? = '\x01';
    ...
    pAVar9[1].klass = this_00;
    func_?();
    AvatarLimbManager+AvatarEmoteHandler::AvatarLimbManager_AvatarEmoteHandler__ctor
              (pAVar9,(MethodInfo *)0x0);
    (this->fields)._.emoteHandler = pAVar9;
    func_?();
    pAVar9 = (this->fields)._.emoteHandler;
    if (pAVar9 == (AvatarLimbManager_AvatarEmoteHandler *)0x0) goto code_?;
    AvatarLimbManager+AvatarEmoteHandler::AvatarLimbManager_AvatarEmoteHandler_Initialize
              (pAVar9,(AvatarLimbManager *)this,(this->fields)._.lookDirectionHandler,
    ...
    pAVar10 = (AvatarLimbManagerLocal_AvatarLimbDataManagerLocal *)func_?();
    mscorlib.dll::System::ThrowHelper::ThrowHelper_1_IfNullAndNullsAreIllegalThenThrow_55
              ((Object *)pAVar10,ExceptionArgument__Enum_obj,(MethodInfo *)method_00);
    (this->fields).dataManager = pAVar10;
    func_?();
    pAVar10 = (this->fields).dataManager;
    if (pAVar10 == (AvatarLimbManagerLocal_AvatarLimbDataManagerLocal *)0x0) goto code_?;
    (pAVar10->fields).limbRotationRuntimeData = (LimbRotationRuntimeData *)method_00;
    func_?();
...
code_?:
      func_?();
      pDVar11 = this_01[1].fields._._.method_ptr;
      ...
      if (pDVar11 != (Delegate *)0x0) {
        pvVar12 = (void *)func_?();
        if (pvVar12 != (void *)0x0) {
          this_01[1].fields._._.method_ptr = pvVar12;
          iVar13 = func_?();
...
code_?:
      func_?();
      pvVar12 = (this_01->fields)._._.method;
      if (pvVar12 == (void *)0x0) goto code_?;
      pDVar11 = *(Delegate **)((int)pvVar12 + 0x18);
      ...
      pDVar11 = mscorlib.dll::System::Delegate::Delegate_Combine
                          (pDVar11,(Delegate *)this_03,(MethodInfo *)0x0);
      if (pDVar11 == (Delegate *)0x0) {
        _UNK_? = 0;
code_?:
        func_?();
        pMVar14 = (this_01->fields)._._.original_method_info;
        if (pMVar14 == (MethodInfo_1 *)0x0) goto code_?;
        pDVar11 = (Delegate *)pMVar14[7].monitor;
        ...
        UnityAction_1_UnityEngine_Color___ctor
                  (pUVar15,(Object *)this_01,
                   MethodInfo__AvatarLimbManagerLocal__SynchronizeHeadRotation_UnityEngine__Quaternion_
                   ,(MethodInfo *)0x0);
        pDVar11 = mscorlib.dll::System::Delegate::Delegate_Combine
                            (pDVar11,(Delegate *)pUVar15,(MethodInfo *)0x0);
        if (pDVar11 == (Delegate *)0x0) {
          _UNK_? = 0;
code_?:
          func_?();
          iVar13 = *(int *)&(this_01->fields)._._.method_is_virtual;
          if (iVar13 == 0) goto code_?;
          pDVar11 = *(Delegate **)(iVar13 + 0x5c);
          pUVar15 = (UnityAction_1_UnityEngine_Color_ *)func_?();
          UnityEngine.CoreModule.dll::UnityEngine::Events::UnityAction`1[UnityEngine::Color]::
          UnityAction_1_UnityEngine_Color___ctor
                    (pUVar15,(Object *)this_01,
          ...
          pvVar12 = (this_01->fields)._._.method;
          if (pvVar12 == (void *)0x0) goto code_?;
          pDVar11 = *(Delegate **)((int)pvVar12 + 0x1c);
...
code_?:
            ChatCommandManager::ChatCommandManager_UpdateChatCommandCallback
                      (ChatCommand__Enum_StartShake,pAVar16,(MethodInfo *)0x0);
            pAVar16 = ChatCommandManager::ChatCommandManager_GetChatCommandCallback
            ...
            ChatCommandManager::ChatCommandManager_UpdateChatCommandCallback
                      (ChatCommand__Enum_StartNod,pAVar16,(MethodInfo *)0x0);
            pAVar16 = ChatCommandManager::ChatCommandManager_GetChatCommandCallback
...
code_?:
              ChatCommandManager::ChatCommandManager_UpdateChatCommandCallback
                        (ChatCommand__Enum_StartWave,pAVar16,(MethodInfo *)0x0);
              return;
            }
            if (pAVar18->klass == TypeInfo__System__Action) {
              pAVar16 = pAVar18;
    ...
    pMVar19 = (MonitorData *)func_?();
    if (pMVar19 != (MonitorData *)0x0) {
      this_01[1].monitor = pMVar19;
      iVar13 = func_?();
      if (iVar13 == 0) goto code_?;
      goto code_?;
    }
...

{
  ...
  pAVar1 = TypeInfo__AvatarLimbManagerLocal__AvatarEmoteHandlerLocal;
...
code_?:
    pEStack_2 = (EmoteTypes__Enum__Class *)pAVar1;
    func_?(this_00);
    pcVar3 = (code *)swi(3);
    (*pcVar3)();
    return;
  ...
  EVar4 = emoteType & 0xff;
  if (EVar4 == EmoteTypes__Enum_Shake) {
    if (cRam_? == '\0') {
    ...
    pDVar5 = (this_00->fields)._.emoteDatas;
    if (pDVar5 != (Dictionary_2_EmoteTypes_AvatarLimbManager_EmoteData_ *)0x0) {
      pOVar6 = mscorlib.dll::System::Collections::Generic::Dictionary`2[System::ByteEnum,System::
               Object]::Dictionary_2_System_ByteEnum_System_Object__get_Item
                         ((Dictionary_2_System_ByteEnum_System_Object_ *)pDVar5,1,
                          MethodInfo__System__Collections__Generic__Dictionary<EmoteTypes,_AvatarLimbManager::EmoteData>__get_Item_EmoteTypes_
                         );
      if ((this_00->fields)._.isActive == 0) {
        return;
      }
      if ((this_00->fields)._.currentRunningEmoteData == (AvatarLimbManager_EmoteData *)0x0) {
code_?:
...
code_?:
          ...
          if (((pOVar6 != (Object *)0x0) &&
              (pOVar9 = pOVar6[1].klass, pOVar9 != (Object__Class *)0x0)) &&
             (unaff_EDI != (AvatarLimbManagerLocal__Class *)0x0)) {
            uVar10._0_2_ = (unaff_EDI->_0).byval_arg.attrs;
            uVar10._2_1_ = (unaff_EDI->_0).byval_arg.type;
            uVar10._3_1_ = (unaff_EDI->_0).byval_arg.field_0x7;
            uVar11._0_2_ = (pOVar9->_0).this_arg.attrs;
            uVar11._2_1_ = (pOVar9->_0).this_arg.type;
            uVar11._3_1_ = (pOVar9->_0).this_arg.field_0x7;
            (*(code *)(unaff_EDI->_0).namespaze)((unaff_EDI->_0).element_class,uVar11,uVar10);
            return;
          }
        }
      }
      else if (pOVar6 != (Object *)0x0) {
        if (*(short *)&pOVar6[1].monitor <=
            (((this_00->fields)._.currentRunningEmoteData)->fields).priority) {
          return;
        }
        pAVar12 = (((this_00->fields)._.currentRunningEmoteData)->fields).emote;
        if (pAVar12 != (AvatarLimbManager_AvatarEmote *)0x0) {
          (*(code *)(pAVar12->klass->vtable).StopEmote.method)(pAVar12,pAVar12->klass[1]._0.image);
          goto code_?;
        }
      }
    }
    ...
    if (EVar4 != EmoteTypes__Enum_Nod) {
      if (EVar4 == EmoteTypes__Enum_Wave) {
      ...
      pEStack_2 = TypeInfo__EmoteTypes;
      pSVar13 = mscorlib.dll::System::Enum::Enum_ToString((Enum *)&pEStack_2,(MethodInfo *)0x0);
      pSVar13 = mscorlib.dll::System::String::String_Concat_4
                         (StringLiteral_Could_not_start_and_network_,pSVar13,
    ...
    if (pDVar5 != (Dictionary_2_EmoteTypes_AvatarLimbManager_EmoteData_ *)0x0) {
      pOVar6 = mscorlib.dll::System::Collections::Generic::Dictionary`2[System::ByteEnum,System::
               Object]::Dictionary_2_System_ByteEnum_System_Object__get_Item
                         ((Dictionary_2_System_ByteEnum_System_Object_ *)pDVar5,2,
                          MethodInfo__System__Collections__Generic__Dictionary<EmoteTypes,_AvatarLimbManager::EmoteData>__get_Item_EmoteTypes_
                         );
      if ((this_00->fields)._.isActive == 0) {
        return;
            ...
            if (pAVar6 != (AvatarLimbManagerLocal_AvatarHeadRotationHandlerLocal *)0x0) {
              ...
              if (pAVar16 != (AvatarLimbManagerLocal_AvatarPointingHandlerLocal *)0x0) {
                ...
                if (pAVar17 != (AvatarLimbManagerLocal_AvatarPointingRotationCalculator *)0x0) {
                  ...
                  localDirection.x = QStack_19.z;
                  localDirection.y = QStack_19.w;
                  this = (AvatarLimbManagerLocal *)
