...

{
  ...
  if (bVar1 == 0) {
    if (x != (Object_1 *)0x0) {
      bodyData = x[3].klass;
      this_00 = (BodyAccessoriesController *)func_?();
      BodyAccessoriesController::BodyAccessoriesController__ctor
                (this_00,bodyWoId,(BodyData *)bodyData,accessoryData,1,(MethodInfo *)0x0);
      ppBVar2 = &(this->fields).bodyAccessoriesController;
      *ppBVar2 = this_00;
      func_?(ppBVar2,this_00);
      if (*ppBVar2 != (BodyAccessoriesController *)0x0) {
        BodyAccessoriesController::BodyAccessoriesController_set_AccessoryMoveOverride
                  (*ppBVar2,1,(MethodInfo *)0x0);
        if (*ppBVar2 != (BodyAccessoriesController *)0x0) {
          BodyAccessoriesController::BodyAccessoriesController_RefreshAccessories
                    (*ppBVar2,accessoryData,(MethodInfo *)0x0);
          return;
        }
      }
    }
