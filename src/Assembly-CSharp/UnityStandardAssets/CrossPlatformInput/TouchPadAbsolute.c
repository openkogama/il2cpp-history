...

{
  ...
  if (pCVar2 != (CrossPlatformInputManager_VirtualAxis *)0x0) {
    ...
    if (pCVar2 != (CrossPlatformInputManager_VirtualAxis *)0x0) {
      ...
      func_?(&(this->fields).verticalVirtualAxis,pCVar2);
      return;
    }
  }
  func_?();
...

{
  ...
  if (pTVar2 == (Touch__Array *)0x0) {
    ...
    while( true ) {
      ...
      pvVar21 = mscorlib.dll::System::Runtime::CompilerServices::Unsafe::Unsafe_ReadUnaligned_7
...

{
  ...
  if (pTStack_3 != (Touch__Array *)0x0) {
    ...
    while( true ) {
      ...
      pvVar22 = mscorlib.dll::System::Runtime::CompilerServices::Unsafe::Unsafe_ReadUnaligned_7
