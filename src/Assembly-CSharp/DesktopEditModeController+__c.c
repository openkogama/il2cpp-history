...

{
  ...
  pDVar1 = (DesktopEditModeController_c *)FUN_?(TypeInfo__DesktopEditModeController____c);
  TypeInfo__DesktopEditModeController____c->static_fields->__9 = pDVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__DesktopEditModeController____c->static_fields >> 0xc);
