...

{
  if (cRam_? == '\0') {
    ...
    func_?(&StringLiteral_plasma_canon);
    ...
    func_?(&StringLiteral_potato_canon);
    ...
    if (pOVar2 != (Object *)0x0) {
      ...
      if (pDVar1 != (Dictionary_2_System_Object_UnityEngine_UIElements_StyleComplexSelector_PseudoStateData_
        ...
        if (pDVar1 != (Dictionary_2_System_Object_UnityEngine_UIElements_StyleComplexSelector_PseudoStateData_
          ...
          pSVar9 = StringLiteral_semi_auto;
          if (pSVar8 != (String__Array *)0x0) {
            if (pSVar8->max_length == 0) goto code_?;
            pSVar8->vector[0] = StringLiteral_semi_auto;
            func_?(pSVar8->vector,pSVar9);
            pSVar9 = StringLiteral_full_auto;
            if (pSVar8->max_length < 2) goto code_?;
            pSVar8->vector[1] = StringLiteral_full_auto;
            func_?(pSVar8->vector + 1,pSVar9);
            pSVar9 = StringLiteral_burst;
            if (pSVar8->max_length < 3) goto code_?;
            pSVar8->vector[2] = StringLiteral_burst;
            ...
            if (pSVar8 != (String__Array *)0x0) {
              ...
              func_?(pSVar8->vector,pSVar9);
              pSVar9 = StringLiteral_pistol;
              if (pSVar8->max_length < 2) goto code_?;
              pSVar8->vector[1] = StringLiteral_pistol;
              func_?(pSVar8->vector + 1,pSVar9);
              pSVar9 = StringLiteral_small_pistol;
              if (pSVar8->max_length < 3) goto code_?;
              pSVar8->vector[2] = StringLiteral_small_pistol;
              func_?(pSVar8->vector + 2,pSVar9);
              pSVar9 = StringLiteral_silenced_pistol;
              if (pSVar8->max_length < 4) goto code_?;
              pSVar8->vector[3] = StringLiteral_silenced_pistol;
              func_?(pSVar8->vector + 3,pSVar9);
              pSVar9 = StringLiteral_revolver;
              if (pSVar8->max_length < 5) goto code_?;
              pSVar8->vector[4] = StringLiteral_revolver;
              func_?(pSVar8->vector + 4,pSVar9);
              pSVar9 = StringLiteral_heavy_revolver;
              if (pSVar8->max_length < 6) goto code_?;
              pSVar8->vector[5] = StringLiteral_heavy_revolver;
              func_?(pSVar8->vector + 5,pSVar9);
              pSVar9 = StringLiteral_automatic_rifle;
              if (pSVar8->max_length < 7) goto code_?;
              pSVar8->vector[6] = StringLiteral_automatic_rifle;
              func_?(pSVar8->vector + 6,pSVar9);
              pSVar9 = StringLiteral_heavy_automatic_rifle;
              if (pSVar8->max_length < 8) goto code_?;
              pSVar8->vector[7] = StringLiteral_heavy_automatic_rifle;
              func_?(pSVar8->vector + 7,pSVar9);
              pSVar9 = StringLiteral_machine_gun;
              if (pSVar8->max_length < 9) goto code_?;
              pSVar8->vector[8] = StringLiteral_machine_gun;
              func_?(pSVar8->vector + 8,pSVar9);
              pSVar9 = StringLiteral_heavy_machine_gun;
              if (pSVar8->max_length < 10) goto code_?;
              pSVar8->vector[9] = StringLiteral_heavy_machine_gun;
              func_?(pSVar8->vector + 9,pSVar9);
              pSVar9 = StringLiteral_minigun;
              if (pSVar8->max_length < 0xb) goto code_?;
              pSVar8->vector[10] = StringLiteral_minigun;
              func_?(pSVar8->vector + 10,pSVar9);
              pSVar9 = StringLiteral_smg;
              if (pSVar8->max_length < 0xc) goto code_?;
              pSVar8->vector[0xb] = StringLiteral_smg;
              func_?(pSVar8->vector + 0xb,pSVar9);
              pSVar9 = StringLiteral_heavy_smg;
              if (pSVar8->max_length < 0xd) goto code_?;
              pSVar8->vector[0xc] = StringLiteral_heavy_smg;
              func_?(pSVar8->vector + 0xc,pSVar9);
              pSVar9 = StringLiteral_light_smg;
              if (pSVar8->max_length < 0xe) goto code_?;
              pSVar8->vector[0xd] = StringLiteral_light_smg;
              func_?(pSVar8->vector + 0xd,pSVar9);
              pSVar9 = StringLiteral_small_smg;
              if (pSVar8->max_length < 0xf) goto code_?;
              pSVar8->vector[0xe] = StringLiteral_small_smg;
              func_?(pSVar8->vector + 0xe,pSVar9);
              pSVar9 = StringLiteral_silenced_smg;
              if (pSVar8->max_length < 0x10) goto code_?;
              pSVar8->vector[0xf] = StringLiteral_silenced_smg;
              func_?(pSVar8->vector + 0xf,pSVar9);
              pSVar9 = StringLiteral_bazooka;
              if (pSVar8->max_length < 0x11) goto code_?;
              pSVar8->vector[0x10] = StringLiteral_bazooka;
              func_?(pSVar8->vector + 0x10,pSVar9);
              pSVar9 = StringLiteral_shotgun;
              if (pSVar8->max_length < 0x12) goto code_?;
              pSVar8->vector[0x11] = StringLiteral_shotgun;
              func_?(pSVar8->vector + 0x11,pSVar9);
              pSVar9 = StringLiteral_rail_gun;
              if (pSVar8->max_length < 0x13) goto code_?;
              pSVar8->vector[0x12] = StringLiteral_rail_gun;
              func_?(pSVar8->vector + 0x12,pSVar9);
              pSVar9 = StringLiteral_flamethrower;
              if (pSVar8->max_length < 0x14) goto code_?;
              pSVar8->vector[0x13] = StringLiteral_flamethrower;
              func_?(pSVar8->vector + 0x13,pSVar9);
              pSVar9 = StringLiteral_sniper;
              if (pSVar8->max_length < 0x15) goto code_?;
              pSVar8->vector[0x14] = StringLiteral_sniper;
              func_?(pSVar8->vector + 0x14,pSVar9);
              pSVar9 = StringLiteral_laser_gun;
              if (pSVar8->max_length < 0x16) goto code_?;
              pSVar8->vector[0x15] = StringLiteral_laser_gun;
              func_?(pSVar8->vector + 0x15,pSVar9);
              pSVar9 = StringLiteral_blaster;
              if (pSVar8->max_length < 0x17) goto code_?;
              pSVar8->vector[0x16] = StringLiteral_blaster;
              func_?(pSVar8->vector + 0x16,pSVar9);
              pSVar9 = StringLiteral_burst_blaster;
              if (pSVar8->max_length < 0x18) goto code_?;
              pSVar8->vector[0x17] = StringLiteral_burst_blaster;
              func_?(pSVar8->vector + 0x17,pSVar9);
              pSVar9 = StringLiteral_heavy_blaster;
              if (pSVar8->max_length < 0x19) goto code_?;
              pSVar8->vector[0x18] = StringLiteral_heavy_blaster;
              func_?(pSVar8->vector + 0x18,pSVar9);
              pSVar9 = StringLiteral_plasma_canon;
              if (pSVar8->max_length < 0x1a) goto code_?;
              pSVar8->vector[0x19] = StringLiteral_plasma_canon;
              func_?(pSVar8->vector + 0x19,pSVar9);
              pSVar9 = StringLiteral_musket;
              if (pSVar8->max_length < 0x1b) goto code_?;
              pSVar8->vector[0x1a] = StringLiteral_musket;
              func_?(pSVar8->vector + 0x1a,pSVar9);
              pSVar9 = StringLiteral_canon;
              if (pSVar8->max_length < 0x1c) goto code_?;
              pSVar8->vector[0x1b] = StringLiteral_canon;
              func_?(pSVar8->vector + 0x1b,pSVar9);
              pSVar9 = StringLiteral_air_canon;
              if (pSVar8->max_length < 0x1d) goto code_?;
              pSVar8->vector[0x1c] = StringLiteral_air_canon;
              func_?(pSVar8->vector + 0x1c,pSVar9);
              pSVar9 = StringLiteral_potato_canon;
              if (pSVar8->max_length < 0x1e) goto code_?;
              pSVar8->vector[0x1d] = StringLiteral_potato_canon;
              func_?(pSVar8->vector + 0x1d,pSVar9);
              pSVar9 = StringLiteral_spell_wave;
              if (pSVar8->max_length < 0x1f) goto code_?;
              pSVar8->vector[0x1e] = StringLiteral_spell_wave;
              func_?(pSVar8->vector + 0x1e,pSVar9);
              pSVar9 = StringLiteral_spell_flare;
              if (pSVar8->max_length < 0x20) goto code_?;
              pSVar8->vector[0x1f] = StringLiteral_spell_flare;
              func_?(pSVar8->vector + 0x1f,pSVar9);
              pSVar9 = StringLiteral_spell_burst;
              if (pSVar8->max_length < 0x21) goto code_?;
              pSVar8[1].klass = (String__Array__Class *)StringLiteral_spell_burst;
              func_?(pSVar8 + 1,pSVar9);
              pSVar9 = StringLiteral_spell_rocket;
              if (pSVar8->max_length < 0x22) goto code_?;
              pSVar8[1].monitor = (MonitorData *)StringLiteral_spell_rocket;
              func_?(&pSVar8[1].monitor,pSVar9);
              pSVar9 = StringLiteral_woosh;
              if (pSVar8->max_length < 0x23) goto code_?;
              pSVar8[1].bounds = (Il2CppArrayBounds *)StringLiteral_woosh;
              func_?(&pSVar8[1].bounds,pSVar9);
              pSVar9 = StringLiteral_spinning;
              if (pSVar8->max_length < 0x24) goto code_?;
              pSVar8[1].max_length = (il2cpp_array_size_t)StringLiteral_spinning;
              ...
              if (pSVar8 != (String__Array *)0x0) {
                ...
                pSVar8->vector[0] = StringLiteral_none;
                func_?(pSVar8->vector,pSVar9);
                pSVar9 = StringLiteral_bullet;
                if (pSVar8->max_length < 2) goto code_?;
                pSVar8->vector[1] = StringLiteral_bullet;
                func_?(pSVar8->vector + 1,pSVar9);
                pSVar9 = StringLiteral_light_bullet;
                if (pSVar8->max_length < 3) goto code_?;
                pSVar8->vector[2] = StringLiteral_light_bullet;
                func_?(pSVar8->vector + 2,pSVar9);
                pSVar9 = StringLiteral_ricochet;
                if (pSVar8->max_length < 4) goto code_?;
                pSVar8->vector[3] = StringLiteral_ricochet;
                func_?(pSVar8->vector + 3,pSVar9);
                pSVar9 = StringLiteral_metal_clash;
                if (pSVar8->max_length < 5) goto code_?;
                pSVar8->vector[4] = StringLiteral_metal_clash;
                func_?(pSVar8->vector + 4,pSVar9);
                pSVar9 = StringLiteral_arrow;
                if (pSVar8->max_length < 6) goto code_?;
                pSVar8->vector[5] = StringLiteral_arrow;
                func_?(pSVar8->vector + 5,pSVar9);
                pSVar9 = StringLiteral_slap;
                if (pSVar8->max_length < 7) goto code_?;
                pSVar8->vector[6] = StringLiteral_slap;
                func_?(pSVar8->vector + 6,pSVar9);
                pSVar9 = StringLiteral_bonk;
                if (pSVar8->max_length < 8) goto code_?;
                pSVar8->vector[7] = StringLiteral_bonk;
                func_?(pSVar8->vector + 7,pSVar9);
                pSVar9 = StringLiteral_punch;
                if (pSVar8->max_length < 9) goto code_?;
                pSVar8->vector[8] = StringLiteral_punch;
                func_?(pSVar8->vector + 8,pSVar9);
                pSVar9 = StringLiteral_heavy_thud;
                if (pSVar8->max_length < 10) goto code_?;
                pSVar8->vector[9] = StringLiteral_heavy_thud;
                func_?(pSVar8->vector + 9,pSVar9);
                pSVar9 = StringLiteral_explosion;
                if (pSVar8->max_length < 0xb) goto code_?;
                pSVar8->vector[10] = StringLiteral_explosion;
                func_?(pSVar8->vector + 10,pSVar9);
                pSVar9 = StringLiteral_pop;
                if (pSVar8->max_length < 0xc) goto code_?;
                pSVar8->vector[0xb] = StringLiteral_pop;
                func_?(pSVar8->vector + 0xb,pSVar9);
                pSVar9 = StringLiteral_laser;
                if (pSVar8->max_length < 0xd) goto code_?;
                pSVar8->vector[0xc] = StringLiteral_laser;
                func_?(pSVar8->vector + 0xc,pSVar9);
                pSVar9 = StringLiteral_slash;
                if (pSVar8->max_length < 0xe) goto code_?;
                pSVar8->vector[0xd] = StringLiteral_slash;
                func_?(pSVar8->vector + 0xd,pSVar9);
                TypeInfo__Assets__Scripts__WorldObjectTypes__CustomGun__CustomGunData->static_fields
                ...
                if (pSVar8 != (String__Array *)0x0) {
                  if (pSVar8->max_length != 0) {
                    pSVar8->vector[0] = StringLiteral_none;
                    func_?(pSVar8->vector,pSVar9);
                    pSVar9 = StringLiteral_mini_gun;
                    if (1 < pSVar8->max_length) {
                      pSVar8->vector[1] = StringLiteral_mini_gun;
                      func_?(pSVar8->vector + 1,pSVar9);
                      pSVar9 = StringLiteral_electric;
                      if (2 < pSVar8->max_length) {
                        pSVar8->vector[2] = StringLiteral_electric;
                        func_?(pSVar8->vector + 2,pSVar9);
                        pSVar9 = StringLiteral_railgun;
                        if (3 < pSVar8->max_length) {
                          pSVar8->vector[3] = StringLiteral_railgun;
                          func_?(pSVar8->vector + 3,pSVar9);
                          pSVar9 = StringLiteral_engine;
                          if (4 < pSVar8->max_length) {
                            pSVar8->vector[4] = StringLiteral_engine;
                            func_?(pSVar8->vector + 4,pSVar9);
                            pSVar9 = StringLiteral_wind_up_toy;
                            if (5 < pSVar8->max_length) {
                              pSVar8->vector[5] = StringLiteral_wind_up_toy;
                              func_?(pSVar8->vector + 5,pSVar9);
                              pSVar9 = StringLiteral_oculus;
                              if (6 < pSVar8->max_length) {
                                pSVar8->vector[6] = StringLiteral_oculus;
                                func_?(pSVar8->vector + 6,pSVar9);
                                pSVar9 = StringLiteral_boiling;
                                if (7 < pSVar8->max_length) {
                                  pSVar8->vector[7] = StringLiteral_boiling;
                                  func_?(pSVar8->vector + 7,pSVar9);
                                  pSVar9 = StringLiteral_sci_fi;
                                  if (8 < pSVar8->max_length) {
                                    pSVar8->vector[8] = StringLiteral_sci_fi;
                                    func_?(pSVar8->vector + 8,pSVar9);
                                    pSVar9 = StringLiteral_magical;
                                    if (9 < pSVar8->max_length) {
                                      pSVar8->vector[9] = StringLiteral_magical;
                                      func_?(pSVar8->vector + 9,pSVar9);
                                      pSVar9 = StringLiteral_microwave;
                                      if (10 < pSVar8->max_length) {
                                        pSVar8->vector[10] = StringLiteral_microwave;
                                        func_?(pSVar8->vector + 10,pSVar9);
                                        pSVar9 = StringLiteral_screwdriver;
                                        if (0xb < pSVar8->max_length) {
                                          pSVar8->vector[0xb] = StringLiteral_screwdriver;
                                          func_?(pSVar8->vector + 0xb,pSVar9);
                                          TypeInfo__Assets__Scripts__WorldObjectTypes__CustomGun__CustomGunData
