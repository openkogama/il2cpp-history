...
code_?:
  ...
  iVar5 = func_?();
  pbVar10 = (byte *)(iVar5 + 0x6a);
  bVar11 = *pbVar10;
  bVar12 = (byte)((uint)iVar5 >> 8);
  *pbVar10 = *pbVar10 + bVar12;
  pbVar10 = (byte *)(unaff_EBX + 0x6b);
  bVar13 = *pbVar10;
  bVar14 = *pbVar10 + extraout_DL + 1U;
  *pbVar10 = bVar14 + CARRY1(bVar11,bVar12);
  *(char *)(extraout_ECX + 0x6d) =
       *(char *)(extraout_ECX + 0x6d) + bVar12 +
       (CARRY1(bVar13,extraout_DL + 1U) || CARRY1(bVar14,CARRY1(bVar11,bVar12)));
  pcVar15 = (code *)swi(3);
  bVar16 = (*pcVar15)();
  return bVar16;
}
