...

{
  ...
  if (bVar2 != 0) {
    ...
    NavMesh_OnNavMeshPreUpdate__ctor
              (pNVar4,(Object *)this,MethodInfo__ThemeSelection___CreateThemeButtons_b__21_0__,
               (MethodInfo *)0x0);
    if (this_00 == (Component__Class *)0x0) goto code_?;
    UnityEngine.CoreModule.dll::UnityEngine::Events::UnityEvent::UnityEvent_AddListener
              ((UnityEvent *)this_00,(UnityAction *)pNVar4,(MethodInfo *)0x0);
  }
  ...
  if (data != (ThemeData__Array *)0x0) {
    ...
    while( true ) {
      ...
      goto code_?;
      this_02[1].fields._._defaultValue_k__BackingField = (List_1_System_Object_ *)selectionMenu;
      func_?(&this_02[1].fields,selectionMenu);
      pTVar8 = (selectionMenu->fields).buttonPrefab;
      if ((TypeInfo__UnityEngine__Object->_1).cctor_finished_or_no_cctor == 0) {
        func_?(TypeInfo__UnityEngine__Object);
      }
      ...
      func_?(&this_02->fields,pLVar9);
      pLVar9 = (this_02->fields)._._defaultValue_k__BackingField;
      ...
      if (pTVar7 == (ThemeData *)0x0) goto code_?;
      bVar2 = mscorlib.dll::System::String::String_op_Equality
                        (a,(pTVar7->fields).themeIdentifier,(MethodInfo *)0x0);
      if (bVar2 == 0) {
        pUVar10 = (UnityAction__Class *)(pTVar7->fields).themeIdentifier;
        this_02[1].klass = (UxmlObjectListAttributeDescription_1_System_Object___Class *)pUVar10;
        pUVar11 = this_02 + 1;
        func_?();
        this_02[1].monitor = (MonitorData *)pTVar7;
        func_?(&this_02[1].monitor,pTVar7);
        pNVar4 = (NavMesh_OnNavMeshPreUpdate *)
                 func_?(TypeInfo__UnityEngine__Events__UnityAction);
        UnityEngine.AIModule.dll::UnityEngine::AI::NavMesh+OnNavMeshPreUpdate::
        NavMesh_OnNavMeshPreUpdate__ctor
                  (pNVar4,(Object *)this_02,
                   MethodInfo__ThemeSelection____c__DisplayClass21_0___CreateThemeButtons_b__2__,
                   (MethodInfo *)0x0);
        pTVar1 = (selectionMenu->fields).themeRepo;
        pTVar8 = (ThemeSelectionButton *)(this_02->fields)._._defaultValue_k__BackingField;
        if (pTVar1 == (ThemeRepository *)0x0) goto code_?;
        themePrefab = ThemeRepository::ThemeRepository_GetThemePrefab
                                (pTVar1,(pTVar7->fields).themeIdentifier,(MethodInfo *)0x0);
        if (pTVar8 == (ThemeSelectionButton *)0x0) goto code_?;
        this._0_1_ = 0;
      }
      else {
        pUVar11 = (UxmlObjectListAttributeDescription_1_System_Object_ *)&UNK_?;
      ...
      ThemeSelectionButton::ThemeSelectionButton_Initialize
                (pTVar8,selectionMenu,themePrefab,(UnityAction *)pNVar4,(pTVar7->fields).priceGold,
                 (pTVar7->fields).levelRequirement,(bool)this,(MethodInfo *)0x0);
      puVar5 = (undefined1 *)((int)&(pUVar10->_0).image + 1);
      ppTVar6 = (ThemeData **)&pUVar11->monitor;
    }
    func_?();
  }
code_?:
