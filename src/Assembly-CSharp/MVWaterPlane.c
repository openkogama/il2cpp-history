...
code_?:
  ...
  if (this_00 != (WaterPlaneManager *)0x0) {
    ppMVar1 = &(this_00->fields).waterPlaneLogicCube;
    *ppMVar1 = (MVWaterPlane *)0x0;
    ...
    if (pTVar2 != (Transform *)0x0) {
      ...
      pTVar2 = (this_00->fields).underwaterCameraPlane;
      if (pTVar2 != (Transform *)0x0) {
        pTVar2 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_transform
...
code_?:
    ...
    if (iVar12 != 0) {
      ...
      lVar2 = lVar4;
      if (((uVar13 == 0) || (uVar14 = *(undefined4 *)(iVar12 + 0x10), uVar13 < 2)) ||
         (uVar15 = *(undefined4 *)(iVar12 + 0x14), uVar13 < 3)) goto code_?;
      uVar16 = *(undefined4 *)(iVar12 + 0x18);
      ...
      pRVar18 = (((WaterPlaneManager *)unaff_EBX.m_Index)->fields).underwaterCameraPlaneRenderer;
      ...
      if ((pWVar10 == (Water *)0x0) ||
         (pRVar18 = (pWVar10->fields).meshRenderer, pRVar18 == (Renderer *)0x0)) goto code_?;
      lVar2 = uVar11 << 0x20;
      puVar20 = &UNK_?;
      pMVar19 = UnityEngine.CoreModule.dll::UnityEngine::Renderer::Renderer_get_material
      ...
      if (pRVar22->max_length != 0) {
        if (pRVar22->vector[0] != (Renderer *)0x0) {
          ...
          uVar13 = *(uint *)(iVar12 + 0xc);
          if (((uVar13 == 0) || (uVar13 < 2)) || (uVar13 < 3)) goto code_?;
...

{
  ...
  if (pPVar1 != (PrefabPool *)0x0) {
    ...
    if ((pOVar2 != (ObjectPrefab *)0x0) &&
      ...
      this_01 = ((pOVar2->fields).meshRenderers)->vector[0];
            ...
            if (this_02 != (GameObject *)0x0) {
              ...
              if (this_04 != (Transform *)0x0) {
                ...
                pWVar15 = MVGameControllerBase::MVGameControllerBase_get_WaterPlaneManager
                                    ((MethodInfo *)0x0);
                ppWVar16 = &(this->fields).waterManager;
                *ppWVar16 = pWVar15;
                func_?(ppWVar16,pWVar15);
