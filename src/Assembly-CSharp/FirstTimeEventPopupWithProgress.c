...

{
  ...
  pNVar2 = mscorlib.dll::System::Globalization::NumberFormatInfo::NumberFormatInfo_get_CurrentInfo
                     ((MethodInfo *)0x0);
  if (*(int *)&(TypeInfo__System__Number->_1).field_0x1c == 0) {
    FUN_?();
  }
  pSVar3 = mscorlib.dll::System::Number::Number_FormatSingle
                     (current,(String *)0x0,pNVar2,(MethodInfo *)0x0);
  if (cRam_? == '\0') {
    FUN_?();
    LOCK();
    UNLOCK();
  ...
  str2 = mscorlib.dll::System::Number::Number_FormatSingle
                   (max,(String *)0x0,pNVar2,(MethodInfo *)0x0);
...

{
  ...
  if (fVar1 != (this->fields).interpolateToSize) {
