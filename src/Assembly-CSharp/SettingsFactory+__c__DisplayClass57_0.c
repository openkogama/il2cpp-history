...
void Assembly-CSharp.dll::SettingsFactory+<>c__DisplayClass57_0::
     SettingsFactory_c_DisplayClass57_0__CreateSettingsDialog_b__0
               (SettingsFactory_c_DisplayClass57_0 *this,IUIStack *x,BaseEventData *y,
               MethodInfo *method)
