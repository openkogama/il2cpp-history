...
/* Void <Purchase>b__0(IUIStack, BaseEventData) */

void Assembly-CSharp.dll::AccessoryView+<>c__DisplayClass48_0::
     AccessoryView_c_DisplayClass48_0__Purchase_b__0
               (AccessoryView_c_DisplayClass48_0 *this,IUIStack *x,BaseEventData *y,
               MethodInfo *method)
