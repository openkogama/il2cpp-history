...
bool Assembly-CSharp.dll::PlayerRepository+<GetItemsByItemCategory>c__AnonStorey0::
     PlayerRepository_GetItemsByItemCategory_c_AnonStorey0___m__0
               (PlayerRepository_GetItemsByItemCategory_c_AnonStorey0 *this,
