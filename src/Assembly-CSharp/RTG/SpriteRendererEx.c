...
code_?:
    ...
    if (this != (Sprite *)0x0) {
      ...
      bVar6 = UnityEngine.CoreModule.dll::UnityEngine::Object::Object_1_op_Equality
                         ((Object_1 *)pTStack_7,(Object_1 *)0x0,(MethodInfo *)0x0);
      if (bVar6 != 0) goto code_?;
      this_00 = UnityEngine.CoreModule.dll::UnityEngine::Component::Component_get_transform
                          ((Component *)spriteRenderer,(MethodInfo *)0x0);
      if (this_00 != (Transform *)0x0) {
        pVVar8 = UnityEngine.CoreModule.dll::UnityEngine::Transform::
                  Transform_InverseTransformPoint(&VStack_9,this_00,worldPos,(MethodInfo *)0x0);
        uVar10 = pVVar8->x;
        uVar11 = pVVar8->y;
        fStack_12 = pVVar8->z;
        ...
        pVVar8 = UnityEngine.CoreModule.dll::UnityEngine::Vector3::Vector3_Normalize
                            (&VStack_9,TypeInfo__UnityEngine__Vector3->static_fields->forwardVector
                             ,(MethodInfo *)0x0);
        CStack_15.r = pVVar8->x;
        CStack_15.g = pVVar8->y;
        CStack_15.b = pVVar8->z;
        fVar16 = fStack_12 * CStack_15.b + fStack_14 * CStack_15.g + fStack_13 * CStack_15.r + 0.0;
        fVar17 = fStack_14 - CStack_15.g * fVar16;
        VStack_9.z = fStack_12 - CStack_15.b * fVar16;
        fStack_18 = fStack_13 - CStack_15.r * fVar16;
        pAVar19 = SpriteRendererEx_GetModelSpaceAABB(&AStack_20,spriteRenderer,(MethodInfo *)0x0);
        fStack_12 = 1.0;
        AStack_21._size.x = (pAVar19->_size).x;
        AStack_21._size.y = (pAVar19->_size).y;
        AStack_21._center.y = (pAVar19->_center).y;
        AStack_21._center.z = (pAVar19->_center).z;
        AStack_21._isValid = pAVar19->_isValid;
        AStack_21._25_3_ = *(undefined3 *)&pAVar19->field_0x19;
        AStack_21._center.x = (float)((ulonglong)*(undefined8 *)&(pAVar19->_size).z >> 0x20);
        AStack_21._size.z = 1.0;
        point.y = fVar17;
        point.x = fStack_18;
        point.z = VStack_9.z;
        bVar6 = AABB::AABB_ContainsPoint(&AStack_21,point,(MethodInfo *)0x0);
        if (bVar6 == 0) goto code_?;
        pVVar8 = AABB::AABB_get_Min(&VStack_9,&AStack_21,(MethodInfo *)0x0);
        uVar22 = pVVar8->x;
        uVar23 = pVVar8->y;
        fStack_12 = pVVar8->z;
        fVar16 = CStack_15.b * fStack_12 + CStack_15.g * (float)uVar23 + CStack_15.r * (float)uVar22 +
                 0.0;
        uVar24 = pVVar8->x;
        uVar25 = pVVar8->y;
        fVar26 = CStack_15.g * fVar16;
        fStack_18 = fStack_18 - ((float)uVar24 - CStack_15.r * fVar16);
        fStack_13 = (float)uVar24;
        fStack_14 = (float)uVar25;
        fStack_12 = UnityEngine.CoreModule.dll::UnityEngine::Sprite::Sprite_get_pixelsPerUnit
                              (this,(MethodInfo *)0x0);
        fStack_27 = UnityEngine.CoreModule.dll::UnityEngine::Sprite::Sprite_get_pixelsPerUnit
                              (this,(MethodInfo *)0x0);
        fVar16 = (fVar17 - ((float)uVar25 - fVar26)) * fStack_27;
        fStack_18 = fStack_18 * fStack_12;
        VVar28 = UnityEngine.CoreModule.dll::UnityEngine::Sprite::Sprite_get_textureRectOffset
                           (this,(MethodInfo *)0x0);
        fVar16 = fStack_12 + fVar16;
        fStack_14 = VVar28.x;
        fStack_12 = VVar28.y;
        uStack_1 = 0;
        if (pTStack_7 != (Texture2D *)0x0) {
          pCVar29 = UnityEngine.CoreModule.dll::UnityEngine::Texture2D::Texture2D_GetPixel
                              (&CStack_15,pTStack_7,(int)(fStack_18 + fStack_14 + _UNK_?),
                               (int)(fVar16 + _UNK_?),(MethodInfo *)0x0);
