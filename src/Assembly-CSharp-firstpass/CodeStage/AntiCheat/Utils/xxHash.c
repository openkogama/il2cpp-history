...

{
  ...
  if (len < 0x10) {
    ...
    do {
      ...
      uVar8 = uVar1 * 0x2000 | uVar1 >> 0x13;
      iStack_4 = uVar8 * -0x61c8864f;
      ...
      uVar9 = uStack_6 * 0x2000 | uStack_6 >> 0x13;
      ...
      uVar10 = uStack_3 * 0x2000 | uStack_3 >> 0x13;
      ...
      uVar11 = uVar5 * 0x2000 | uVar5 >> 0x13;
      uVar5 = uVar11 * -0x61c8864f;
      uVar7 = uVar1;
    } while ((int)uVar1 <= len + -0x10);
    iVar2 = (uVar5 >> 0xe | uVar11 * -0x193c0000) + (uVar10 * 0x779b1000 | uStack_3 >> 0x14) +
            (uVar9 * 0x1bbcd880 | uStack_6 >> 0x19) + (uVar8 * 0x3c6ef362 | (uint)(iStack_4 < 0));
  }
  uVar5 = iVar2 + len;
  if ((int)uVar1 <= len + -4) {
    uVar7 = uVar1;
