...

{
  ...
  case 2:
    ...
    cVar3 = pAVar5 == (AnimationCurve *)0x0;
    if (!(bool)cVar3) {
      fVar1 = UnityEngine.CoreModule.dll::UnityEngine::AnimationCurve::AnimationCurve_Evaluate
                         (pAVar5,_UNK_? - fVar1,(MethodInfo *)0x0);
      cVar3 = unaff_EDI == (CanvasGroup *)0x0;
      if (!(bool)cVar3) {
        UnityEngine.UIModule.dll::UnityEngine::CanvasGroup::CanvasGroup_set_alpha
...
code_?:
  ...
  uVar7 = func_?();
  bVar8 = bVar6;
  if (extraout_ECX == 1 || cVar3 != '\0') {
    unaff_EDI = (CanvasGroup *)((int)&unaff_EDI->klass + 1);
    pbVar9 = (byte *)(extraout_ECX + 0x3d104705);
    bVar8 = CARRY1(*pbVar9,unaff_BH) || CARRY1(*pbVar9 + unaff_BH,bVar6);
    *pbVar9 = *pbVar9 + unaff_BH + bVar6;
  }
  bVar6 = (byte)((ushort)uVar7 >> 8);
  *(byte *)&this->klass =
       *(char *)&this->klass + (byte)uVar7 +
       (CARRY1(extraout_DH,bVar6) || CARRY1(extraout_DH + bVar6,bVar8));
  pbVar9 = (byte *)((int)&unaff_EDI[1].monitor + 2);
  *pbVar9 = *pbVar9 | (byte)uVar7;
  if (extraout_ECX == 2 || *pbVar9 == 0) {
    pcVar10 = (code *)swi(3);
    (*pcVar10)();
    return;
  }
  if ((GameObject *)in_stack_11[0xb] == (GameObject *)0x0) {
code_?:
    func_?();
    pcVar10 = (code *)swi(3);
    (*pcVar10)();
  ...
  bVar4 = UnityEngine.CoreModule.dll::UnityEngine::GameObject::GameObject_get_activeSelf
                    ((GameObject *)in_stack_11[0xb],(MethodInfo *)0x0);
  if (bVar4 != 0) {
    if ((GameObject *)in_stack_11[0xb] == (GameObject *)0x0) goto code_?;
    UnityEngine.CoreModule.dll::UnityEngine::GameObject::GameObject_SetActive
              ((GameObject *)in_stack_11[0xb],0,(MethodInfo *)0x0);
  }
  if (_UNK_? < in_stack_12) {
    *(undefined1 *)(in_stack_11 + 0x11) = 2;
    fVar1 = UnityEngine.CoreModule.dll::UnityEngine::Time::Time_1_get_time((MethodInfo *)0x0);
    in_stack_11[0x10] = (int)fVar1;
    if ((GameObject *)in_stack_11[0xb] == (GameObject *)0x0) goto code_?;
    UnityEngine.CoreModule.dll::UnityEngine::GameObject::GameObject_SetActive
              ((GameObject *)in_stack_11[0xb],1,(MethodInfo *)0x0);
    (**(code **)(*in_stack_11 + 0xf0))();
  }
  return;
}
