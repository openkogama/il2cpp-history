...

{
  ...
  pSVar1 = (StartGoldRewardPopup_c *)FUN_?(TypeInfo__StartGoldRewardPopup____c);
  TypeInfo__StartGoldRewardPopup____c->static_fields->__9 = pSVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__StartGoldRewardPopup____c->static_fields >> 0xc);
