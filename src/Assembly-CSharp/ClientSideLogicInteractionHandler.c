...
/* ClientSideLogicInteractionHandler() */

void Assembly-CSharp.dll::ClientSideLogicInteractionHandler::ClientSideLogicInteractionHandler__ctor
               (ClientSideLogicInteractionHandler *this,MethodInfo *method)
