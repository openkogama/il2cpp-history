...
code_?:
  ...
  uVar11 = func_?();
  uVar6 = (uint)uVar11;
  bVar12 = uVar6 < *(uint *)((int)((ulonglong)uVar11 >> 0x20) + 0x43);
  pbVar13 = (byte *)(uVar6 + 0x83104342);
  bVar14 = *pbVar13;
  bVar15 = (byte)((ulonglong)uVar11 >> 0x20);
  bVar16 = *pbVar13;
  *pbVar13 = bVar16 + bVar15 + bVar12;
  *(char *)(extraout_ECX + -0x33efbcbb) =
       *(char *)(extraout_ECX + -0x33efbcbb) + bVar15 +
       (CARRY1(bVar14,bVar15) || CARRY1(bVar16 + bVar15,bVar12));
  pcVar17 = (code *)swi(3);
  bVar18 = (*pcVar17)();
  return bVar18;
}
