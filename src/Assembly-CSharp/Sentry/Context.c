...
code_?:
  bVar12 = 0;
  iVar13 = func_?();
  pbVar14 = (byte *)(unaff_EBX + -0x7cefb06f);
  bVar15 = *pbVar14;
  bVar16 = *pbVar14 + (byte)extraout_CX;
  *pbVar14 = bVar16 + bVar12;
  *(char *)(iVar13 + -0x57efb06f) =
       *(char *)(iVar13 + -0x57efb06f) + (char)((ushort)extraout_CX >> 8) +
       (CARRY1(bVar15,(byte)extraout_CX) || CARRY1(bVar16,bVar12));
  pcVar17 = (code *)swi(3);
  (*pcVar17)();
  return;
}
