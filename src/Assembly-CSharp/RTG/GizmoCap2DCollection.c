...

{
  ...
  if ((cap != (GizmoCap2D *)0x0) &&
     ...
     pDVar1 != (Dictionary_2_System_Int32_RTG_GizmoCap2D_ *)0x0)) {
    ...
    if (this_00 != (List_1_RTG_GizmoCap2D_ *)0x0) {
      ...
      pvVar2 = UnityEngine.AndroidJNIModule.dll::UnityEngine::AndroidJavaObject::
               AndroidJavaObject__GetRawClass((AndroidJavaObject *)cap,(MethodInfo *)0x0);
      if (pDVar1 != (Dictionary_2_System_Int32_RTG_GizmoCap2D_ *)0x0) {
  ...
  *unaff_FS_OFFSET = &uStack_3;
  ...
  if (this_00 != (List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)0x0) {
    ...
    while( true ) {
      ...
      if ((RegexCharClass_SingleRange)LStack_8._current == (RegexCharClass_SingleRange)0x0) break;
      (**(code **)(*(int *)LStack_8._current + 0x120))
                (LStack_8._current,camera,*(undefined4 *)(*(int *)LStack_8._current + 0x124));
    }
  }
  func_?();
  pcVar10 = (code *)swi(3);
  ...
  if (this_00 != (List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)0x0) {
    ...
    while( true ) {
      ...
      if (((RegexCharClass_SingleRange)LStack_8._current == (RegexCharClass_SingleRange)0x0) ||
         (*(int *)((int)LStack_8._current + 0xc) == 0)) break;
      puVar10 = (undefined4 *)(*(int *)((int)LStack_8._current + 0xc) + 0x2c);
      *puVar10 = dragSession;
      func_?(puVar10,dragSession);
    }
  }
  func_?();
  pcVar11 = (code *)swi(3);
  ...
  *unaff_FS_OFFSET = &uStack_3;
  ...
  if (this_00 != (List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)0x0) {
    ...
    while( true ) {
      ...
      if ((RegexCharClass_SingleRange)LStack_8._current == (RegexCharClass_SingleRange)0x0) break;
      GizmoCap::GizmoCap_SetHoverable((GizmoCap *)LStack_8._current,hoverable,(MethodInfo *)0x0);
    }
  }
  func_?();
  pcVar10 = (code *)swi(3);
