...
void Assembly-CSharp.dll::DG::Tweening::DOTweenModuleUnityVersion+<AsyncWaitForCompletion>d__10::
     DOTweenModuleUnityVersion_AsyncWaitForCompletion_d_10_MoveNext
               (DOTweenModuleUnityVersion_AsyncWaitForCompletion_d_10 *this,MethodInfo *method)

{
  pDStackX_20 = this;
  if (cRam_? == '\0') {
    FUN_?(&
                  void_MethodInfo__System__Runtime__CompilerServices__AsyncTaskMethodBuilder__AwaitUnsafeOnCompleted<System::Runtime::CompilerServices::YieldAwaitable::YieldAwaiter,_DG::Tweening::DOTweenModuleUnityVersion::_AsyncWaitForCompletion_d__10>_System__Runtime__CompilerServices__YieldAwaitable__YieldAwaiter___DG__Tweening__DOTweenModuleUnityVersion___AsyncWaitForCompletion_d__10__
                 );
    LOCK();
    UNLOCK();
  ...
  pTVar1 = this->t;
  if (pTVar1 != (Tween *)0x0) {
    if (((pTVar1->fields)._active_k__BackingField != 0) && ((pTVar1->fields).isComplete == 0)) {
...
void Assembly-CSharp.dll::DG::Tweening::DOTweenModuleUnityVersion+<AsyncWaitForCompletion>d__10::
     DOTweenModuleUnityVersion_AsyncWaitForCompletion_d_10_SetStateMachine
               (DOTweenModuleUnityVersion_AsyncWaitForCompletion_d_10 *this,
