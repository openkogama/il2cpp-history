...

{
  ...
  pFVar1 = (FirstTimeActivatableLogicPointer_c *)
           FUN_?(TypeInfo__FirstTimeActivatableLogicPointer____c);
  TypeInfo__FirstTimeActivatableLogicPointer____c->static_fields->__9 = pFVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__FirstTimeActivatableLogicPointer____c->static_fields >> 0xc)
    ;
