...

{
  ...
  pTVar1 = (TierLockedDetailsPopup_c *)FUN_?(TypeInfo__TierLockedDetailsPopup____c);
  TypeInfo__TierLockedDetailsPopup____c->static_fields->__9 = pTVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__TierLockedDetailsPopup____c->static_fields >> 0xc);
