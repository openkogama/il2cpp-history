...
code_?:
    ...
    if (*(Il2CppClass **)(*(int *)TVar4.m_Index + 0x20) ==
      ...
      if ((char)this_00[1].fields._firstChar != '\0') {
        ...
        pOVar8[1].klass = (Object__Class *)TVar5.m_Index;
        func_?();
        pOVar8[1].monitor = (MonitorData *)&UNK_?;
        *(Object **)&this_00[2].fields._firstChar = pOVar8;
        func_?();
    ...
    if ((Object__Class *)TVar5.m_Index != (Object__Class *)0x0) goto code_?;
  }
  func_?();
code_?:
  func_?();
                                    ...
                                    if (pLVar1 != (LimbRotationRuntimeData *)0x0) {
                                      ...
                                      if (pMVar7 != (MVRuntimeDataVariables *)0x0) {
                                        pMVar10 = MVRuntimeDataVariables::MVRuntimeDataVariables_New
                                                  ...
                                                  (MethodInfo *)0x0);
                                        if (pLVar1 != (LimbRotationRuntimeData *)0x0) {
                                          (pLVar1->fields).HasHandEquippableItem = pMVar10;
                                          func_?();
                                          pMVar7 = (this->fields)._._.runtimeDataVariables;
                                          pLVar1 = *ppLVar2;
                                          if (pMVar7 != (MVRuntimeDataVariables *)0x0) {
