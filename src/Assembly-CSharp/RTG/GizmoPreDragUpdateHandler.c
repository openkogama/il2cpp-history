...
IAsyncResult *
Assembly-CSharp.dll::RTG::GizmoPreDragUpdateHandler::GizmoPreDragUpdateHandler_BeginInvoke
          (GizmoPreDragUpdateHandler *this,Gizmo *gizmo,int32_t handleId,AsyncCallback *callback,
