...

{
  ...
  pGVar1 = (GamePassesHighScoreList_c *)FUN_?(TypeInfo__GamePassesHighScoreList____c);
  TypeInfo__GamePassesHighScoreList____c->static_fields->__9 = pGVar1;
  if (iRam_? != 0) {
    uVar2 = (uint)((ulonglong)TypeInfo__GamePassesHighScoreList____c->static_fields >> 0xc);
