...
void Assembly-CSharp.dll::DG::Tweening::DOTweenModuleUnityVersion+<AsyncWaitForRewind>d__11::
     DOTweenModuleUnityVersion_AsyncWaitForRewind_d_11_MoveNext
               (DOTweenModuleUnityVersion_AsyncWaitForRewind_d_11 *this,MethodInfo *method)

{
  pDStackX_20 = this;
  if (cRam_? == '\0') {
    FUN_?(&
                  void_MethodInfo__System__Runtime__CompilerServices__AsyncTaskMethodBuilder__AwaitUnsafeOnCompleted<System::Runtime::CompilerServices::YieldAwaitable::YieldAwaiter,_DG::Tweening::DOTweenModuleUnityVersion::_AsyncWaitForRewind_d__11>_System__Runtime__CompilerServices__YieldAwaitable__YieldAwaiter___DG__Tweening__DOTweenModuleUnityVersion___AsyncWaitForRewind_d__11__
                 );
    LOCK();
    UNLOCK();
  ...
  if (this->__1__state == 0) {
    *(undefined1 *)&this[1].__1__state = 0;
    this->__1__state = -1;
  ...
  if (pTVar1 != (Tween *)0x0) {
    if (((pTVar1->fields)._active_k__BackingField != 0) &&
       (((pTVar1->fields)._playedOnce_k__BackingField == 0 ||
        (0.0 < (float)((pTVar1->fields).completedLoops + 1) *
               (pTVar1->fields)._position_k__BackingField)))) {
...
void Assembly-CSharp.dll::DG::Tweening::DOTweenModuleUnityVersion+<AsyncWaitForRewind>d__11::
     DOTweenModuleUnityVersion_AsyncWaitForRewind_d_11_SetStateMachine
               (DOTweenModuleUnityVersion_AsyncWaitForRewind_d_11 *this,
