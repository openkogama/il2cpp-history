...
IAsyncResult *
Assembly-CSharp.dll::MoveAnimationBase+OnMoveAnimationStoppedDelegate::
MoveAnimationBase_OnMoveAnimationStoppedDelegate_BeginInvoke
          (MoveAnimationBase_OnMoveAnimationStoppedDelegate *this,float extraTime,
