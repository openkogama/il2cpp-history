...
code_?:
  bVar16 = 0;
  uVar1 = func_?();
  pbVar17 = (byte *)(extraout_ECX + -0x69efc186);
  bVar18 = *pbVar17 + (byte)extraout_DX;
  bVar19 = CARRY1(*pbVar17,(byte)extraout_DX) || CARRY1(bVar18,bVar16);
  *pbVar17 = bVar18 + bVar16;
  if ((POPCOUNT(*pbVar17) & 1U) == 0) {
    pcVar20 = (code *)swi(3);
    (*pcVar20)();
    return;
  }
  pbVar17 = (byte *)((int)&unaff_ESI[-0x151fee3].fields.normal.z + 2);
  bVar18 = *pbVar17;
  ...
  *pbVar17 = bVar16 + bVar19;
  ...
  else if ((POPCOUNT((char)((ushort)extraout_DX >> 8) + (char)uVar1 +
                     (CARRY1(bVar18,bVar21) || CARRY1(bVar16,bVar19))) & 1U) != 0) {
    pcVar20 = (code *)swi(3);
    (*pcVar20)();
    return;
  }
...
code_?:
  ...
  if (pPVar22 != (PrefabPool *)0x0) {
    material = (pPVar22->fields).cellCursorMaterial;
