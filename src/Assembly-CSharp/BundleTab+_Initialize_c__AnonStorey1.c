...
void Assembly-CSharp.dll::BundleTab+<Initialize>c__AnonStorey1::
     BundleTab_Initialize_c_AnonStorey1___m__0
               (BundleTab_Initialize_c_AnonStorey1 *this,MethodInfo *method)

{
  ...
  if (this_00 != (BundleTab *)0x0) {
    ...
    UnityAction_2_UnityEngine_SceneManagement_Scene_UnityEngine_SceneManagement_Scene___ctor
              (this_01,(Object *)this,
               MethodInfo__BundleTab___Initialize_c__AnonStorey1____m__1_UnityEngine__EventSystems__ITabSelected__UnityEngine__EventSystems__BaseEventData_
               ,
...
void Assembly-CSharp.dll::BundleTab+<Initialize>c__AnonStorey1::
     BundleTab_Initialize_c_AnonStorey1___m__1
               (BundleTab_Initialize_c_AnonStorey1 *this,ITabSelected *x,BaseEventData *y,
               MethodInfo *method)
