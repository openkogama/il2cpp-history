...

{
  ...
  if ((pMVar2 != (MVMovingPlatformGroup *)0x0) &&
    ...
    puVar4 = (undefined8 *)func_?(&stack0xffffffe0);
    fVar5 = *(float *)(puVar4 + 1);
    uStack_6._0_4_ = (float)*puVar4;
    uStack_6._4_4_ = (float)((ulonglong)*puVar4 >> 0x20);
    if ((TypeInfo__Extensions->_1).cctor_finished_or_no_cctor == 0) {
      func_?(TypeInfo__Extensions);
    }
    vec.z = fVar5 * fVar1;
    vec.x = (float)uStack_6 * fVar1;
    vec.y = uStack_6._4_4_ * fVar1;
