...

{
  ...
  *score = 0;
  ...
  bVar15 = 0;
  func_?();
  unaff_ESI[-5].monitor = (MonitorData *)method_00;
  pbVar16 = (byte *)(extraout_EDX + -0x70ef23ba);
  bVar17 = *pbVar16;
  bVar18 = *pbVar16;
  *pbVar16 = bVar18 + unaff_BL + bVar15;
  *(int *)((int)&unaff_ESI[-5].monitor + 3) = extraout_ECX;
  *(char *)(extraout_ECX + 0x46) =
       *(char *)(extraout_ECX + 0x46) + (char)extraout_EDX +
       (CARRY1(bVar17,unaff_BL) || CARRY1(bVar18 + unaff_BL,bVar15));
  func_?(in_CS);
  if (cRam_? == '\0') {
  ...
  pDVar7 = (this->fields).teamCounters;
  this_00 = (HighScores *)
            func_?(TypeInfo__HighScores,unaff_EDI,
                            (undefined1 *)((int)&unaff_ESI->klass + 3));
