...

{
  ...
  if (itemData != (Dictionary_2_System_Object_System_Object_ *)0x0) {
    ...
    if (TVar1.m_Index != 0) {
      ...
      value = *pfVar3;
      if (mimMaxFunc != (Func_2_String_ValueTuple_2_Single_Single_ *)0x0) {
        uVar2 = (*(mimMaxFunc->fields)._._.invoke_impl)
                          ((mimMaxFunc->fields)._._.method_code,key,(mimMaxFunc->fields)._._.method)
        ;
...
{
  SettingsInputFieldSlider_Initialize_1(this,key,(float)value,(MethodInfo *)0x0);
  return;
}
...

{
  if (cRam_? == '\0') {
    ...
    func_?(&TypeInfo__SettingsInputFieldSlider____c__DisplayClass18_0);
    func_?(&::StringLiteral__);
    func_?(&::StringLiteral__);
    cRam_? = '\x01';
  }
  method_00 = TypeInfo__SettingsInputFieldSlider____c__DisplayClass18_0;
  ...
  if (value_00 != (Object *)0x0) {
    ...
    if ((value != (String *)0x0) &&
      ...
      bVar3 = mscorlib.dll::System::String::String_op_Inequality
                        ((this->fields).suffix,::StringLiteral__,(MethodInfo *)0x0);
      ...
      pIVar2 = (this->fields).inputField;
      pSVar4 = mscorlib.dll::System::String::String_Concat_3(value,pSVar4,(MethodInfo *)0x0);
      if (pIVar2 != (InputField *)0x0) {
        UnityEngine.UI.dll::UnityEngine::UI::InputField::InputField_set_text
                  (pIVar2,pSVar4,(MethodInfo *)0x0);
        pSVar5 = (this->fields).settingsSlider;
        if ((pSVar5 != (SettingsSlider *)0x0) &&
           (pSVar6 = (pSVar5->fields).slider, pSVar6 != (Slider *)0x0)) {
          (*(code *)(pSVar6->klass->vtable).set_value.method)
                    (pSVar6,value_00[1].monitor,
                     (pSVar6->klass->vtable).SetValueWithoutNotify.methodPtr);
