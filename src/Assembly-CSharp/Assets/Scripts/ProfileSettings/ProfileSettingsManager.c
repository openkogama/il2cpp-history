...

{
  ...
  if (profileSettingsState != (ProfileSettingsState *)0x0) {
    ...
    if (pMVar6 != (MaterialLoader *)0x0) {
      ...
      pMVar6 = MVGameControllerBase::MVGameControllerBase_get_MaterialLoader((MethodInfo *)0x0);
      if ((pMVar6 != (MaterialLoader *)0x0) &&
         (pMVar8 = (pMVar6->fields)._CubeModelMaterial_k__BackingField, pMVar8 != (Material *)0x0))
      {
        ...
        if (pTVar9 != (Texture *)0x0) {
          ...
          ;
          if ((pMVar6 != (MaterialLoader *)0x0) &&
             (pMVar8 = (pMVar6->fields)._CubeModelMaterial_k__BackingField,
             pMVar8 != (Material *)0x0)) {
            pTVar9 = UnityEngine.CoreModule.dll::UnityEngine::Material::Material_get_mainTexture
                                (pMVar8,(MethodInfo *)0x0);
            if (cRam_? == '\0') {
  ...
  uVar10 = func_?();
  bVar11 = (unaff_EDI & 1) != 0;
  pbVar12 = (byte *)((int)((ulonglong)uVar10 >> 0x20) + -99);
  bVar13 = *pbVar12 + (byte)uVar10;
  bVar14 = CARRY1(*pbVar12,(byte)uVar10) || CARRY1(bVar13,bVar11);
  *pbVar12 = bVar13 + bVar11;
  pbVar12 = (byte *)(extraout_ECX + -99);
  bVar13 = *pbVar12;
  bVar15 = *pbVar12 + (byte)extraout_ECX;
  *pbVar12 = bVar15 + bVar14;
  pcVar16 = (char *)((int)uVar10 + -99);
  *pcVar16 = *pcVar16 + (char)((ulonglong)uVar10 >> 0x20) +
            (CARRY1(bVar13,(byte)extraout_ECX) || CARRY1(bVar15,bVar14));
  pcVar17 = (code *)swi(3);
  (*pcVar17)();
  return;
}
...

{
  ...
  bVar10 = 0;
  uRam_? = func_?();
  pbVar11 = (byte *)((int)&unaff_EDI->klass + 1);
  *(undefined1 *)&unaff_EDI->klass = *(undefined1 *)&this_00->klass;
  bVar12 = (byte)extraout_ECX + unaff_BH;
  bVar13 = CARRY1((byte)extraout_ECX,unaff_BH) || CARRY1(bVar12,bVar10);
  bVar14 = *pbVar11;
  bVar15 = (byte)uRam_?;
  bVar16 = *pbVar11 + bVar15;
  *pbVar11 = bVar16 + bVar13;
  *pbVar11 = *(byte *)((int)&this_00->klass + 1);
  bVar17 = (byte)((uint)extraout_ECX >> 8);
  bVar13 = CARRY1(in_stack_18,bVar17) ||
           CARRY1(in_stack_18 + bVar17,CARRY1(bVar14,bVar15) || CARRY1(bVar16,bVar13));
  *(undefined1 *)((int)&unaff_EDI->klass + 2) = *(undefined1 *)((int)&this_00->klass + 2);
  pbVar11 = (byte *)(CONCAT31((int3)((uint)extraout_ECX >> 8),bVar12 + bVar10) + -0x67efaf5c);
  bVar14 = *pbVar11;
  bVar12 = *pbVar11;
  *pbVar11 = bVar12 + extraout_DL + bVar13;
  *(undefined1 *)((int)&unaff_EDI->klass + 3) = *(undefined1 *)((int)&this_00->klass + 3);
  ppMVar19 = &unaff_EDI[-0xcd9191].fields.cubeModelMaterialSM2;
  *(char *)ppMVar19 =
       *(char *)ppMVar19 + unaff_BL +
       (CARRY1(bVar14,extraout_DL) || CARRY1(bVar12 + extraout_DL,bVar13));
...
code_?:
  ...
  *(char *)(extraout_ECX + 0x2f1050ae) =
       *(char *)(extraout_ECX + 0x2f1050ae) + unaff_BL + ((byte)uVar11 < *unaff_EDI);
  *(char *)(extraout_EDX + -0x33efaf51) =
       *(char *)(extraout_EDX + -0x33efaf51) + (char)extraout_EDX +
       (uVar11 < *(uint *)(unaff_EDI + 1));
  pcVar12 = (code *)swi(3);
