...
void Assembly-CSharp.dll::ContinueTierBoostPopup+<>c__DisplayClass29_0::
     ContinueTierBoostPopup_c_DisplayClass29_0__ShowTierUnlock_b__0
               (ContinueTierBoostPopup_c_DisplayClass29_0 *this,IUIStack *x,BaseEventData *y,
               MethodInfo *method)
