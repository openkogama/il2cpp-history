...

{
  ...
  func_?();
  *(uint *)(extraout_ECX + 0x10) = *(uint *)(extraout_ECX + 0x10) >> 0x14;
  *(uint *)(extraout_ECX + 0x10) = *(uint *)(extraout_ECX + 0x10) >> 0x1c;
  *(uint *)(extraout_ECX + 0x10) = *(uint *)(extraout_ECX + 0x10) >> 0xc;
  pcVar8 = (code *)swi(3);
  bVar9 = (*pcVar8)();
  return bVar9;
}
...
code_?:
      ...
      if (faceVertices->max_length != 0) {
        ...
        in_XMM1_Da = faceVertices->vector[0].z;
        in_XMM1_Db = 0.0;
        in_XMM1_Dc = 0.0;
        in_XMM1_Dd = 0.0;
        if (pVVar1->max_length != 0) {
          pVVar1->vector[0].x = faceVertices->vector[0].x;
          pVVar1->vector[0].y = in_XMM1_Da;
          cVar5 = (int)(faceVertices->max_length - 1) < 0;
          if (1 < faceVertices->max_length) {
            cVar5 = (int)(pVVar1->max_length - 1) < 0;
            in_XMM1_Da = faceVertices->vector[1].z;
            in_XMM1_Db = 0.0;
            in_XMM1_Dc = 0.0;
            in_XMM1_Dd = 0.0;
            if (1 < pVVar1->max_length) {
              pVVar1->vector[1].x = faceVertices->vector[1].x;
              pVVar1->vector[1].y = in_XMM1_Da;
              cVar5 = (int)(faceVertices->max_length - 2) < 0;
              if (2 < faceVertices->max_length) {
                cVar5 = (int)(pVVar1->max_length - 2) < 0;
                in_XMM1_Da = faceVertices->vector[2].z;
                in_XMM1_Db = 0.0;
                in_XMM1_Dc = 0.0;
                in_XMM1_Dd = 0.0;
                if (2 < pVVar1->max_length) {
                  pVVar1->vector[2].x = faceVertices->vector[2].x;
                  pVVar1->vector[2].y = in_XMM1_Da;
                  cVar5 = (int)(faceVertices->max_length - 3) < 0;
                  if (3 < faceVertices->max_length) {
                    cVar5 = (int)(pVVar1->max_length - 3) < 0;
                    in_XMM1_Da = faceVertices->vector[3].z;
                    in_XMM1_Db = 0.0;
                    in_XMM1_Dc = 0.0;
                    in_XMM1_Dd = 0.0;
                    if (3 < pVVar1->max_length) {
                      pVVar1->vector[3].x = faceVertices->vector[3].x;
                      pVVar1->vector[3].y = in_XMM1_Da;
                      goto code_?;
                    }
                  }
                }
  ...
  case Face__Enum_Bottom:
    ...
    if (faceVertices->max_length != 0) {
      cVar5 = (int)pVVar1->max_length < 0;
      in_XMM1_Da = faceVertices->vector[0].x;
      in_XMM1_Db = 0.0;
      in_XMM1_Dc = 0.0;
      in_XMM1_Dd = 0.0;
      fVar4 = faceVertices->vector[0].z;
      if (pVVar1->max_length != 0) {
        in_XMM1_Da = (float)((uint)in_XMM1_Da ^
        ...
        pVVar1->vector[0].x = in_XMM1_Da;
        cVar5 = (int)(faceVertices->max_length - 1) < 0;
        if (1 < faceVertices->max_length) {
          cVar5 = (int)(pVVar1->max_length - 1) < 0;
          in_XMM1_Da = faceVertices->vector[1].x;
          in_XMM1_Db = 0.0;
          in_XMM1_Dc = 0.0;
          in_XMM1_Dd = 0.0;
          fVar4 = faceVertices->vector[1].z;
          if (1 < pVVar1->max_length) {
            in_XMM1_Da = (float)((uint)in_XMM1_Da ^ uVar2);
            in_XMM1_Db = 0.0;
            in_XMM1_Dc = 0.0;
            in_XMM1_Dd = 0.0;
            pVVar1->vector[1].y = fVar4;
            pVVar1->vector[1].x = in_XMM1_Da;
            cVar5 = (int)(faceVertices->max_length - 2) < 0;
            if (2 < faceVertices->max_length) {
              cVar5 = (int)(pVVar1->max_length - 2) < 0;
              in_XMM1_Da = faceVertices->vector[2].x;
              in_XMM1_Db = 0.0;
              in_XMM1_Dc = 0.0;
              in_XMM1_Dd = 0.0;
              ...
              if (2 < pVVar1->max_length) {
                ...
                pVVar1->vector[2].x = in_XMM1_Da;
                cVar5 = (int)(faceVertices->max_length - 3) < 0;
                if (3 < faceVertices->max_length) {
                  fVar4 = faceVertices->vector[3].z;
code_?:
                  in_XMM1_Da = faceVertices->vector[3].x;
code_?:
                  in_XMM1_Dd = 0.0;
                  in_XMM1_Dc = 0.0;
                  in_XMM1_Db = 0.0;
  ...
  case Face__Enum_Front:
    ...
    if (faceVertices->max_length != 0) {
      cVar5 = (int)pVVar1->max_length < 0;
      in_XMM1_Da = faceVertices->vector[0].y;
      in_XMM1_Db = 0.0;
      in_XMM1_Dc = 0.0;
      in_XMM1_Dd = 0.0;
      if (pVVar1->max_length != 0) {
        ...
        if (1 < faceVertices->max_length) {
          cVar5 = (int)(pVVar1->max_length - 1) < 0;
          in_XMM1_Da = faceVertices->vector[1].y;
          in_XMM1_Db = 0.0;
          in_XMM1_Dc = 0.0;
          in_XMM1_Dd = 0.0;
          if (1 < pVVar1->max_length) {
            ...
            if (2 < faceVertices->max_length) {
              cVar5 = (int)(pVVar1->max_length - 2) < 0;
              in_XMM1_Da = faceVertices->vector[2].y;
              in_XMM1_Db = 0.0;
              in_XMM1_Dc = 0.0;
              in_XMM1_Dd = 0.0;
              if (2 < pVVar1->max_length) {
                ...
                if (3 < faceVertices->max_length) {
                  cVar5 = (int)(pVVar1->max_length - 3) < 0;
                  in_XMM1_Da = faceVertices->vector[3].y;
                  in_XMM1_Db = 0.0;
                  in_XMM1_Dc = 0.0;
                  in_XMM1_Dd = 0.0;
                  if (3 < pVVar1->max_length) {
...
code_?:
    ...
    if (pVVar1->max_length != 0) {
      ...
      in_XMM1_Dc = 0.0;
      in_XMM1_Dd = 0.0;
      in_XMM1_Da = fVar4 + pVVar1->vector[0].x;
      pVVar1->vector[0].x = in_XMM1_Da;
      ...
      if (1 < pVVar1->max_length) {
        ...
        in_XMM1_Dc = 0.0;
        in_XMM1_Dd = 0.0;
        in_XMM1_Da = fVar4 + pVVar1->vector[1].x;
        ...
        if (2 < pVVar1->max_length) {
          ...
          in_XMM1_Dc = 0.0;
          in_XMM1_Dd = 0.0;
          in_XMM1_Da = fVar4 + pVVar1->vector[2].x;
          ...
          if (3 < pVVar1->max_length) {
            ...
            if (pVVar1->max_length != 0) {
              ...
              in_XMM1_Dc = 0.0;
              in_XMM1_Dd = 0.0;
              in_XMM1_Da = pVVar1->vector[0].y * fVar4;
              ...
              if (1 < pVVar1->max_length) {
                ...
                in_XMM1_Dc = 0.0;
                in_XMM1_Dd = 0.0;
                in_XMM1_Da = pVVar1->vector[1].y * fVar4;
                ...
                if (2 < pVVar1->max_length) {
                  ...
                  in_XMM1_Dc = 0.0;
                  in_XMM1_Dd = 0.0;
                  in_XMM1_Da = pVVar1->vector[2].y * fVar4;
                  pVVar1->vector[2].x = pVVar1->vector[2].x * fVar4;
                  pVVar1->vector[2].y = in_XMM1_Da;
                  cVar5 = (int)(pVVar1->max_length - 3) < 0;
                  if (3 < pVVar1->max_length) goto code_?;
                }
              }
            }
          }
  ...
  pVVar1 = (Vector2__Array *)func_?();
  if (extraout_ECX == 1) {
    lVar7 = (longlong)(int)pVVar1->klass * 0xADDR;
    uVar8 = (undefined3)((uint)pVVar1 >> 8);
    pVVar1 = (Vector2__Array *)CONCAT31(uVar8,-((int)lVar7 != lVar7));
    lVar7 = (longlong)(int)pVVar1->klass * 0xADDR;
    if (((int)lVar7 != lVar7) == (bool)cVar5) {
      bVar9 = in((short)pVVar1->klass * -0x74ab);
      piVar10 = (int *)CONCAT31(uVar8,bVar9);
      *(byte *)((int)piVar10 + -0x420edbc3) = *(byte *)((int)piVar10 + -0x420edbc3) & bVar9;
      *piVar10 = *piVar10 + (int)piVar10;
      if (*piVar10 == 0) {
        ...
        ;
        func_?();
        ppIStack_12 = &TypeInfo__MV__WorldObject__IntVector;
    ...
    pVVar1->vector[3].y = in_XMM1_Da;
    pVVar1->vector[4].x = in_XMM1_Db;
    pVVar1->vector[4].y = in_XMM1_Dc;
    pVVar1->vector[5].x = in_XMM1_Dd;
  }
code_?:
