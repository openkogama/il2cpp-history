...
void Assembly-CSharp.dll::TouristAdController+<ShowPromotion>c__AnonStorey0::
     TouristAdController_ShowPromotion_c_AnonStorey0___m__0
               (TouristAdController_ShowPromotion_c_AnonStorey0 *this,IUIStack *x,BaseEventData *y,
               MethodInfo *method)
