...

{
  ...
  obj = (this->fields).material;
  pTVar1 = (this->fields)._.asset;
  if (obj == (Material *)0x0) {
    FUN_?();
    pcVar2 = (code *)swi(3);
    (*pcVar2)();
  ...
  iVar3 = UnityEngine.CoreModule.dll::UnityEngine::Shader::Shader_PropertyToID
                    ((this->fields).shaderTextureVariableName,(MethodInfo *)0x0);
  if (cRam_? == '\0') {
    FUN_?(&
...

{
  ...
  if (pOVar2 != (Object *)0x0) {
    ...
    if (pOVar2[1].klass != (Object__Class *)0x0) {
      ...
      if (bVar4) {
        uVar5 = (uint)((ulonglong)&(this->fields).material >> 0xc);
...

{
  ...
  if (bVar1) {
    uVar2 = (uint)((ulonglong)&(this->fields).shaderTextureVariableName >> 0xc);
