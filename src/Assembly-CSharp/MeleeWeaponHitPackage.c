...
InteractionData *
Assembly-CSharp.dll::MeleeWeaponHitPackage::MeleeWeaponHitPackage_Create
...

{
  ...
  *(undefined2 *)&__return_storage_ptr__->field_0x12 = 0;
  ...
  MVWorldObject.dll::MV::WorldObject::InteractionData::InteractionData__ctor_5
            (__return_storage_ptr__,CONCAT31((int3)((uint)in_EDX >> 8),5),damage,&VStack_1,
             CONCAT31((int3)((uint)in_stack_2 >> 8),7),(MethodInfo *)0x0);
...
void Assembly-CSharp.dll::MeleeWeaponHitPackage::MeleeWeaponHitPackage_ParseAndHandlePackage
               (MeleeWeaponHitPackage *this,MVWorldObjectClient *worldObjectClient,MVPlayer *shooter
...

{
  ...
  InteractionPackage::InteractionPackage_HandlePackage
            ((InteractionPackage *)this,worldObjectClient,shooter,interactionStruct->damage,
             CONCAT31((int3)((uint)in_stack_2 >> 8),7),&VStack_1,
