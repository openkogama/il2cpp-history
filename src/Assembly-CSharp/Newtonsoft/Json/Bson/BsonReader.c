...

{
  ...
  *unaff_FS_OFFSET = &uStack_2;
  ...
  default:
    ...
    func_?(args);
    func_?(0);
    pSVar6 = (String *)func_?(&StringLiteral_Unexpected_state___0_);
    pSVar6 = Json::Utilities::StringUtils::StringUtils_FormatWith
                       (pSVar6,(IFormatProvider *)provider,args,(MethodInfo *)0x0);
    func_?();
    this_00 = (JsonReaderException *)func_?();
    func_?();
    JsonReaderException::JsonReaderException__ctor_1(this_00,pSVar6,(MethodInfo *)0x0);
    func_?();
    iVar7 = func_?();
    piVar8 = &(provider->fields).parent_lcid;
    *piVar8 = *piVar8 + iVar7;
    pcVar9 = (code *)swi(3);
    bVar4 = (*pcVar9)();
    return bVar4;
...

{
  if (cRam_? == '\0') {
    ...
    func_?(&StringLiteral__scope);
    func_?(&StringLiteral__code);
    cRam_? = '\x01';
  }
  switch((this->fields)._bsonReaderState) {
  case 4:
    (*(this->klass->vtable).SetToken.methodPtr)
              (this,4,StringLiteral__code,(this->klass->vtable).SetToken.method);
  ...
  case 5:
    ...
    (*(this->klass->vtable).SetToken.methodPtr)(this,9,pSVar1,(this->klass->vtable).SetToken.method)
    ;
  ...
  case 6:
    ...
    newContext = (BsonReader_ContainerContext *)
                 func_?(TypeInfo__Newtonsoft__Json__Bson__BsonReader__ContainerContext);
    unaff_EDI = (byte *)0x0;
  ...
  default:
    ...
    uVar5 = func_?(&MethodInfo__Newtonsoft__Json__Bson__BsonReader__ReadCodeWScope__);
    func_?(this,uVar5);
  }
  bVar6 = func_?();
  bVar7 = bVar6 < *unaff_EDI;
  if ((char)*unaff_EDI <= (char)bVar6) {
    pcVar8 = (code *)swi(3);
    bVar3 = (*pcVar8)();
    return bVar3;
  }
  ...
  bVar6 = bVar10 + bVar9;
  bVar11 = CARRY1(bVar10,bVar9) || CARRY1(bVar6,bVar7);
  cVar12 = bVar6 + bVar7;
  if ((SCARRY1(bVar10,bVar9) != SCARRY1(bVar6,bVar7)) == cVar12 < '\0') {
    pcVar8 = (code *)swi(3);
    bVar3 = (*pcVar8)();
    return bVar3;
  }
  ...
  bVar7 = CARRY1(*extraout_ECX,bVar13) || CARRY1(bVar10,bVar11);
  *extraout_ECX = bVar10 + bVar11;
  if (*extraout_ECX == 0 ||
      (SCARRY1(bVar6,bVar13) != SCARRY1(bVar10,bVar11)) != (char)*extraout_ECX < '\0') {
    pcVar8 = (code *)swi(3);
    bVar3 = (*pcVar8)();
    return bVar3;
  }
  pbVar14 = (byte *)(CONCAT22((short)((uint)extraout_EDX >> 0x10),CONCAT11(cVar12,bVar9)) + 0x7e);
  bVar6 = *pbVar14;
  bVar10 = (byte)((uint)unaff_EBX >> 8);
  bVar9 = *pbVar14 + bVar10;
  *pbVar14 = bVar9 + bVar7;
  pcVar15 = (char *)((int)&(((ArgumentException__Fields *)&this[-0xa63242].fields._)->_)._.
                          _stackTrace + 2);
  *pcVar15 = *pcVar15 + cVar12 + (CARRY1(bVar6,bVar10) || CARRY1(bVar9,bVar7));
  pcVar8 = (code *)swi(3);
  bVar3 = (*pcVar8)();
  return bVar3;
}
...

{
  ...
  case 0:
    ...
    pBVar2 = (BsonReader_ContainerContext *)
             func_?(TypeInfo__Newtonsoft__Json__Bson__BsonReader__ContainerContext);
    if (pBVar2 != (BsonReader_ContainerContext *)0x0) {
      mscorlib.dll::System::ThrowHelper::ThrowHelper_1_IfNullAndNullsAreIllegalThenThrow_23
                ((Object *)pBVar2,ExceptionArgument__Enum_obj,unaff_EBP);
      (pBVar2->fields).Type = (bVar1 != 0) + 3;
      BsonReader_PushContext(this,pBVar2,(MethodInfo *)0x0);
      iVar3 = BsonReader_ReadInt32(this,(MethodInfo *)0x0);
      (pBVar2->fields).Length = iVar3;
      return 1;
    }
    break;
  case 1:
  ...
  case 8:
    ...
    iVar4 = (pBVar2->fields).Length + -1;
    iVar5 = (pBVar2->fields).Position;
    if (iVar5 < iVar4) {
      if ((pBVar2->fields).Type == 4) {
    ...
    pLVar8 = (this->fields)._stack;
    if (pLVar8 != (List_1_Newtonsoft_Json_Bson_BsonReader_ContainerContext_ *)0x0) {
      mscorlib.dll::System::Collections::Generic::List`1[System::Object]::
      List_1_System_Object__RemoveAt
                ((List_1_System_Object_ *)(this->fields)._stack,(pLVar8->fields)._size + -1,
                 MethodInfo__System__Collections__Generic__List<Newtonsoft::Json::Bson::BsonReader::ContainerContext>__RemoveAt_int_
                );
      pLVar8 = (this->fields)._stack;
      if (pLVar8 != (List_1_Newtonsoft_Json_Bson_BsonReader_ContainerContext_ *)0x0) {
        if ((pLVar8->fields)._size == 0) {
          ...
          RVar9 = mscorlib.dll::System::Collections::Generic::List`1[System::Text::
                  ...
                  List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange__get_Item
                            ((List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ *)
                             (this->fields)._stack,(pLVar8->fields)._size + -1,
                             MethodInfo__System__Collections__Generic__List<Newtonsoft::Json::Bson::BsonReader::ContainerContext>__get_Item_int_
                            );
        }
        (this->fields)._currentContext = (BsonReader_ContainerContext *)RVar9;
        func_?();
        if ((this->fields)._currentContext != (BsonReader_ContainerContext *)0x0) {
          pBVar10 = (this->fields)._currentContext;
          (pBVar10->fields).Position = (pBVar10->fields).Position + (pBVar2->fields).Length;
        }
        JsonReader::JsonReader_SetToken
                  ((JsonReader *)this,((pBVar2->fields).Type != 3) + JsonToken__Enum_EndObject,
                   (MethodInfo *)0x0);
        return 1;
      }
    }
  ...
  default:
    ...
    uVar11 = func_?(&MethodInfo__Newtonsoft__Json__Bson__BsonReader__ReadNormal__);
    func_?(this_00,uVar11);
code_?:
    uVar11 = func_?(&TypeInfo__Newtonsoft__Json__JsonReaderException);
    pJVar12 = (JsonReaderException *)func_?(uVar11);
    func_?(pJVar12);
    pMVar13 = (MethodInfo *)0x0;
    pSVar6 = (String *)func_?(&StringLiteral_Read_past_end_of_current_contain);
    JsonReaderException::JsonReaderException__ctor_1(pJVar12,pSVar6,pMVar13);
    uVar11 = func_?(&MethodInfo__Newtonsoft__Json__Bson__BsonReader__ReadNormal__);
    func_?(pJVar12,uVar11);
  }
  func_?();
code_?:
  uVar11 = func_?(&TypeInfo__Newtonsoft__Json__JsonReaderException);
  ...
  func_?(pJVar12);
  pMVar13 = (MethodInfo *)0x0;
  pSVar6 = (String *)func_?(&StringLiteral_Unexpected_end_of_object_byte_va);
  JsonReaderException::JsonReaderException__ctor_1(pJVar12,pSVar6,pMVar13);
...

{
  ...
  case 1:
    ...
    if (pBVar2 != (BsonReader_ContainerContext *)0x0) {
      ...
      *piVar3 = *piVar3 + 8;
      pBVar4 = (this->fields)._reader;
      if (pBVar4 != (BinaryReader *)0x0) {
        type = (BsonType__Enum)(pBVar4->klass->vtable).ReadDouble.methodPtr;
        fVar5 = (float10)(*(code *)type)(pBVar4,(pBVar4->klass->vtable).ReadDouble.method);
        uStack_6 = (double)fVar5;
        uVar7 = func_?(TypeInfo__System__Double,&uStack_6);
        func_?(0xf,this,8,uVar7);
        return;
      }
    }
    break;
  case 2:
  case 0xe:
    pSVar8 = BsonReader_ReadLengthString(this,(MethodInfo *)0x0);
    (*(this->klass->vtable).SetToken.methodPtr)
              (this,9,pSVar8,(this->klass->vtable).SetToken.method);
    return;
  case 3:
    JsonReader::JsonReader_SetToken
              ((JsonReader *)this,JsonToken__Enum_StartObject,(MethodInfo *)0x0);
    pBVar2 = (BsonReader_ContainerContext *)func_?();
    pBVar1 = (BsonReader *)0x0;
    if (pBVar2 != (BsonReader_ContainerContext *)0x0) {
      mscorlib.dll::System::ThrowHelper::ThrowHelper_1_IfNullAndNullsAreIllegalThenThrow_23
                ((Object *)pBVar2,ExceptionArgument__Enum_obj,unaff_EDI);
      (pBVar2->fields).Type = 3;
      BsonReader_PushContext(this,pBVar2,(MethodInfo *)0x0);
      iVar9 = BsonReader_ReadInt32(this,(MethodInfo *)0x0);
      (pBVar2->fields).Length = iVar9;
      return;
    }
    break;
  case 4:
  ...
  case 5:
    ...
    if (pBVar2 != (BsonReader_ContainerContext *)0x0) {
      ...
      *piVar3 = *piVar3 + 4;
      pBVar4 = (this->fields)._reader;
      if (pBVar4 != (BinaryReader *)0x0) {
        iVar10 = (*(pBVar4->klass->vtable).ReadInt32.methodPtr)
                           (pBVar4,(pBVar4->klass->vtable).ReadInt32.method);
        pBVar2 = (this->fields)._currentContext;
        if (pBVar2 != (BsonReader_ContainerContext *)0x0) {
          piVar3 = &(pBVar2->fields).Position;
          *piVar3 = *piVar3 + 1;
          pBVar4 = (this->fields)._reader;
          if (pBVar4 != (BinaryReader *)0x0) {
            cVar11 = (*(pBVar4->klass->vtable).ReadByte.methodPtr)
                               (pBVar4,(pBVar4->klass->vtable).ReadByte.method);
            if ((cVar11 == '\x02') && ((this->fields)._jsonNet35BinaryCompatibility == 0)) {
              pBVar2 = (this->fields)._currentContext;
            ...
            if (pBVar2 != (BsonReader_ContainerContext *)0x0) {
              ...
              *piVar3 = *piVar3 + iVar10;
              pBVar4 = (this->fields)._reader;
              if (pBVar4 != (BinaryReader *)0x0) {
                uVar7 = (*(pBVar4->klass->vtable).ReadBytes.methodPtr)
                                   (pBVar4,iVar10,(pBVar4->klass->vtable).ReadBytes.method);
                func_?(0xf,this,0x11,uVar7);
                return;
              }
            }
          }
  ...
  case 6:
    ...
    return;
  case 7:
    pBVar12 = BsonReader_ReadBytes(this,0xc,(MethodInfo *)0x0);
    func_?(0xf,this,0x11,pBVar12);
    return;
  case 8:
    uVar13 = BsonReader_ReadByte(this,(MethodInfo *)0x0);
    uStack_6._0_5_ = CONCAT14(uVar13,(MonitorData *)uStack_6);
    if ((TypeInfo__System__Convert->_1).cctor_finished_or_no_cctor == 0) {
      func_?(TypeInfo__System__Convert);
    }
    bVar14 = mscorlib.dll::System::Convert::Convert_ToBoolean_2
                      ((uint8_t)((ulonglong)uStack_6 >> 0x20),(MethodInfo *)0x0);
    type = CONCAT13(bVar14,(undefined3)type);
    uVar7 = func_?(TypeInfo__System__Boolean,(byte *)((int)&type + 3));
    func_?(0xf,this,10,uVar7);
    return;
  case 9:
    ...
    iVar10 = (this->fields)._dateTimeKindHandling;
    if (iVar10 == 0) {
    ...
    uStack_6 = (double)CONCAT44((int)(value._dateData >> 0x20),&uStack_6);
    func_?();
    func_?(0xf,this);
    return;
  case 10:
    ...
    return;
  case 0xb:
    pSVar8 = BsonReader_ReadString(this,(MethodInfo *)0x0);
    pSVar16 = BsonReader_ReadString(this,(MethodInfo *)0x0);
    pSVar8 = mscorlib.dll::System::String::String_Concat_5
                        (::StringLiteral__,pSVar8,::StringLiteral__,pSVar16,(MethodInfo *)0x0);
    func_?(0xf,this,9,pSVar8);
    return;
  case 0xc:
    JsonReader::JsonReader_SetToken
              ((JsonReader *)this,JsonToken__Enum_StartObject,(MethodInfo *)0x0);
  ...
  case 0x10:
    iVar9 = BsonReader_ReadInt32(this,(MethodInfo *)0x0);
    uStack_6 = (double)(longlong)iVar9;
    uVar7 = func_?(TypeInfo__System__Int64,&uStack_6);
    func_?(0xf,this,7,uVar7);
    return;
  case 0x11:
  case 0x12:
    uStack_6 = (double)BsonReader_ReadInt64(this,(MethodInfo *)0x0);
    uVar7 = func_?(TypeInfo__System__Int64,&uStack_6);
    (*(this->klass->vtable).SetToken.methodPtr)(this,7,uVar7,(this->klass->vtable).SetToken.method)
    ;
    return;
  default:
    uVar7 = func_?(&TypeInfo__Newtonsoft__Json__Bson__BsonType);
    func_?(uVar7);
    pSVar8 = mscorlib.dll::System::Enum::Enum_ToString((Enum *)auStack_15,(MethodInfo *)0x0);
    pMVar17 = (MethodInfo *)0x0;
    pSVar16 = (String *)func_?(&StringLiteral_Unexpected_BsonType_value__);
    pBVar1 = (BsonReader *)mscorlib.dll::System::String::String_Concat_3(pSVar16,pSVar8,pMVar17);
    uVar7 = func_?();
    this_00 = (ArgumentOutOfRangeException *)func_?(uVar7);
    func_?(this_00);
    pMVar17 = (MethodInfo *)0x0;
    message = pBVar1;
    pSVar8 = (String *)func_?(&StringLiteral_type);
    mscorlib.dll::System::ArgumentOutOfRangeException::ArgumentOutOfRangeException__ctor_2
              (this_00,pSVar8,(String *)message,pMVar17);
    uVar7 = func_?();
    uStack_6 = (double)CONCAT44(uVar7,this_00);
    func_?();
  }
  iVar10 = func_?();
  pbVar18 = (byte *)(iVar10 + -0x7472efb5);
  bVar19 = *pbVar18;
  *pbVar18 = *pbVar18 + extraout_CL;
  bVar20 = (char)unaff_EBX - 1;
  pbVar18 = (byte *)(iVar10 + -0x78);
  bVar21 = *pbVar18 + bVar20;
  bVar22 = CARRY1(*pbVar18,bVar20) || CARRY1(bVar21,CARRY1(bVar19,extraout_CL));
  *pbVar18 = bVar21 + CARRY1(bVar19,extraout_CL);
  pbVar23 = &pBVar1[-0x263242].fields._._CloseInput_k__BackingField;
  bVar21 = (byte)((uint)iVar10 >> 8);
  bVar19 = *pbVar23 + bVar21;
  cVar11 = CARRY1(*pbVar23,bVar21) || CARRY1(bVar19,bVar22);
  *pbVar23 = bVar19 + bVar22;
  *(byte *)(unaff_EBX + 0xe) = extraout_CL;
  pcVar24 = (code *)swi(0x89);
  uVar25 = (*pcVar24)();
  pcVar26 = (char *)CONCAT31((int3)((uint)extraout_EDX >> 8),
                             (char)extraout_EDX + (char)((ushort)uVar25 >> 8) + cVar11);
  *(uint *)(unaff_EBX + 0xd) = extraout_ECX;
  *pcVar26 = *pcVar26 + (char)uVar25 + CARRY4(extraout_ECX,*(uint *)(pcVar26 + -0x75a7efb5));
  out(*(undefined1 *)&pBVar1->klass,(short)pcVar26);
  *(undefined2 *)(unaff_EBX + 0xb) = in_CS;
  *(undefined2 *)(unaff_EBX + 0xb) = in_CS;
  pcVar24 = (code *)swi(3);
  (*pcVar24)();
  return;
